---
name: awesome-aitools-agents
description: "This file provides context and instructions for AI coding agents (e.g., Cursor, Aider, Claude Code, Windsurf) to help them understand this repository more effectively. It follows the AGENTS.md standard."
category: ai-agents-and-harness
source_repo: ikaijua/Awesome-AITools
source_path: "AGENTS.md"
source_url: https://github.com/ikaijua/Awesome-AITools/blob/HEAD/AGENTS.md
---
...
**Source:** [`ikaijua/Awesome-AITools`](https://github.com/ikaijua/Awesome-AITools) → `AGENTS.md`
