...
description: "Rules for applying flexbox math in production front-end work."
category: ai-agents-and-harness
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/LVTD-LLC/skills/skills/flexbox-math/references/flex-distribution/rules.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/LVTD-LLC/skills/skills/flexbox-math/references/flex-distribution/rules.md
---
# Flexbox Math Rules
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/LVTD-LLC/skills/skills/flexbox-math/references/flex-distribution/rules.md`
