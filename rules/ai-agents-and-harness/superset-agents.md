...
description: "Guidelines for organizing the Superset mobile app mostly follow repo's patterns, with some caveats:"
category: ai-agents-and-harness
source_repo: superset-sh/superset
source_path: "apps/mobile/AGENTS.md"
source_url: https://github.com/superset-sh/superset/blob/HEAD/apps/mobile/AGENTS.md
---
...
**Source:** [`superset-sh/superset`](https://github.com/superset-sh/superset) → `apps/mobile/AGENTS.md`

**Also appears in:** `per-simmons/damon-ade/apps/mobile/AGENTS.md`
