...
description: "Tento repozitár obsahuje komplexný kurz s 21 lekciami, ktorý učí základy Generatívnej AI a vývoj aplikácií. Kurz je určený pre začiatočníkov a pokrýva všetko od základných konceptov až po vytváranie aplikácií pripravených na produkciu."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/sk/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/sk/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/sk/AGENTS.md`
