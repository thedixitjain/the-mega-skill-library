---
name: ecc-agents
description: "~/.claude/agents/ dizininde bulunur:"
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: "docs/tr/rules/common/agents.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/rules/common/agents.md
---
# Agent Orkestrasyonu
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/rules/common/agents.md`
