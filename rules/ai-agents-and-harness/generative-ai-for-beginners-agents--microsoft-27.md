...
description: "Repositori ini mengandungi kurikulum 21 pelajaran yang komprehensif yang mengajar asas Generative AI dan pembangunan aplikasi. Kursus ini direka untuk pemula dan merangkumi segala-galanya dari konsep asas hingga membina aplikasi sedia produksi."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/ms/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/ms/AGENTS.md
---
# AGEN
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/ms/AGENTS.md`
