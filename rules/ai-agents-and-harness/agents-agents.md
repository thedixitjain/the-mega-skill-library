---
name: agents-agents
description: "Production-ready agentic-workflow building blocks: 94 plugins (90 local + 4 external), 203 agents, 175 skills, 109 commands. Native source-of-truth for Claude Code; also consumed by OpenAI Codex CLI, Cursor, OpenCode, and Gemini CLI from a single Markdown source."
category: ai-agents-and-harness
source_repo: wshobson/agents
source_path: "AGENTS.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/AGENTS.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `AGENTS.md`
