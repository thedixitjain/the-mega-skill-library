...
description: "Deze repository bevat een uitgebreid curriculum van 21 lessen die de basisprincipes en applicatieontwikkeling van Generative AI onderwijzen. De cursus is ontworpen voor beginners en behandelt alles van basisconcepten tot het bouwen van productieklare applicaties."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/nl/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/nl/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/nl/AGENTS.md`
