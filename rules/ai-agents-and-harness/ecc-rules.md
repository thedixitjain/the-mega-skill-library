---
name: ecc-rules
description: "- Delegate to specialized agents for domain tasks. - Write tests before implementation and verify critical paths. - Validate inputs and keep security checks intact. - Prefer immutable updates over mutating shared state. - Follow established repository patterns before inventing new ones. - Keep contributions focused, reviewable, and well-described."
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: "RULES.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/RULES.md
---
# Rules
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `RULES.md`
