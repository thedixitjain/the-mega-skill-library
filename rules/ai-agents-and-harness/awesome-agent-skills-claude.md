---
name: awesome-agent-skills-claude
...
source_url: https://github.com/libukai/awesome-agent-skills/blob/HEAD/CLAUDE.md
---
...
**Source:** [`libukai/awesome-agent-skills`](https://github.com/libukai/awesome-agent-skills) → `CLAUDE.md`
