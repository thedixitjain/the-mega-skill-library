...
source_url: https://github.com/prompt-security/clawsec/blob/HEAD/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`prompt-security/clawsec`](https://github.com/prompt-security/clawsec) → `CLAUDE.md`
