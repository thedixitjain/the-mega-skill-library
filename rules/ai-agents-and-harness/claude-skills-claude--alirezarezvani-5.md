...
description: "This guide explains how to use the standards library for consistent quality across all skills and agents."
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "standards/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/standards/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `standards/CLAUDE.md`
