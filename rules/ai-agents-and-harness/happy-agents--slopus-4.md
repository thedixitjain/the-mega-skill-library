---
name: happy-agents
description: "- one primary integration test file per agent - keep that file next to the agent code - use 2-3 long integration tests per agent - mocked tests do not count as acceptance - do not build a generic layer-1 framework directory - test the real agent surface directly"
category: ai-agents-and-harness
source_repo: slopus/happy
source_path: "packages/happy-cli/agents.md"
source_url: https://github.com/slopus/happy/blob/HEAD/packages/happy-cli/agents.md
---
...
**Source:** [`slopus/happy`](https://github.com/slopus/happy) → `packages/happy-cli/agents.md`
