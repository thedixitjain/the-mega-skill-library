...
description: "These pointers tell agents where the user's personal context files live. Read only the file(s) needed to answer a question; do not load all of them by default."
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "skills/setup-my-iq/assets/templates/AGENTS.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/setup-my-iq/assets/templates/AGENTS.md
---
# AGENTS
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/setup-my-iq/assets/templates/AGENTS.md`
