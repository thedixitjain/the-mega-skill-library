...
description: "Este repositório contém um currículo abrangente de 21 aulas ensinando fundamentos de IA Generativa e desenvolvimento de aplicações. O curso é projetado para iniciantes e cobre tudo, desde conceitos básicos até a construção de aplicações prontas para produção."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/pt-BR/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/pt-BR/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/pt-BR/AGENTS.md`
