---
name: planning-with-files-agents
...
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/AGENTS.md
---
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `AGENTS.md`
