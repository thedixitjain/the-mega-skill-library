---
name: gortex-agents
description: "gortex install (once per machine) and gortex init (once per repo) auto-configure Gortex for every AI coding assistant detected on your machine. Nineteen adapters ship today."
category: ai-agents-and-harness
source_repo: zzet/gortex
source_path: "docs/agents.md"
source_url: https://github.com/zzet/gortex/blob/HEAD/docs/agents.md
---
# Agent Integrations
...
**Source:** [`zzet/gortex`](https://github.com/zzet/gortex) → `docs/agents.md`
