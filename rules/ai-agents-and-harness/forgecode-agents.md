...
source_url: https://github.com/tailcallhq/forgecode/blob/HEAD/AGENTS.md
---
# Agent Guidelines
...
**Source:** [`tailcallhq/forgecode`](https://github.com/tailcallhq/forgecode) → `AGENTS.md`
