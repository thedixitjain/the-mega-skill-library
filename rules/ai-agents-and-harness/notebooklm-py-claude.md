---
name: notebooklm-py-claude
description: "Guidance for Claude Code working in this repo. Also follow the file/naming conventions in CONTRIBUTING.md."
category: ai-agents-and-harness
source_repo: teng-lin/notebooklm-py
source_path: "CLAUDE.md"
source_url: https://github.com/teng-lin/notebooklm-py/blob/HEAD/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`teng-lin/notebooklm-py`](https://github.com/teng-lin/notebooklm-py) → `CLAUDE.md`
