...
description: "This plugin helps you curate Claude Code's auto-memory into durable project knowledge."
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "engineering-team/self-improving-agent/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering-team/self-improving-agent/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering-team/self-improving-agent/CLAUDE.md`
