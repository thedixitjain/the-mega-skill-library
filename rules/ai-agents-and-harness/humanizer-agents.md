...
source_url: https://github.com/blader/humanizer/blob/HEAD/AGENTS.md
---
# AGENTS.md
...
**Source:** [`blader/humanizer`](https://github.com/blader/humanizer) → `AGENTS.md`
