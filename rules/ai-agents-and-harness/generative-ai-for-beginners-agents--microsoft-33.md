...
description: "Dis repository get full 21-lesson curriculum wey dey teach Generative AI basics and how to develop app dem. Di course na for beginners and e cover everything from basic tins go reach how to build app wey ready for production."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/pcm/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/pcm/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/pcm/AGENTS.md`
