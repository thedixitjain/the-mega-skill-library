---
name: agents-gemini
description: "gemini extensions install https://github.com/wshobson/agents cd ~/.gemini/extensions/claude-code-workflows make generate HARNESS=gemini"
category: ai-agents-and-harness
source_repo: wshobson/agents
source_path: "GEMINI.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/GEMINI.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `GEMINI.md`
