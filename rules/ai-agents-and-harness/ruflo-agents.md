---
name: ruflo-agents
description: "╔═══════════════════════════════════════════════════════════════════════════╗ ║ 1. claude-flow = LEDGER (tracks state, stores memory, coordinates) ║ ║ 2. Codex = EXECUTOR (writes code, runs commands, creates files) ║ ║ 3. NEVER stop after calling claude-flow - IMMEDIATELY continue working ║ ║ 4. If you need something BUILT/EXECUTED, YOU do it, not claude-flow ║ ║ 5. ALWAYS search memory BEFORE starting: memory search --query \"task\" ║"
category: ai-agents-and-harness
source_repo: ruvnet/ruflo
source_path: "AGENTS.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/AGENTS.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `AGENTS.md`
