...
description: "Scheduled deployment: cron → CMA session with sentry-cli and a vault env-var credential → triage report in /mnt/session/outputs/."
category: ai-agents-and-harness
source_repo: anthropics/claude-cookbooks
source_path: "managed_agents/sentry/CLAUDE.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/managed_agents/sentry/CLAUDE.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `managed_agents/sentry/CLAUDE.md`
