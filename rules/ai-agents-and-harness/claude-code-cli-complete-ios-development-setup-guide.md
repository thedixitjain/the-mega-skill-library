---
name: claude-code-cli-complete-ios-development-setup-guide
description: "1. Installation 2. Configuration Hierarchy 3. CLAUDE.md Setup for iOS Projects 4. PRD-Driven Development Workflow 5. Extended Thinking & Ultrathink 6. Plan Mode Configuration 7. XcodeBuildMCP Integration"
category: ai-agents-and-harness
source_repo: keskinonur/claude-code-ios-dev-guide
source_path: "README.md"
source_url: https://github.com/keskinonur/claude-code-ios-dev-guide/blob/HEAD/README.md
---
...
**Source:** [`keskinonur/claude-code-ios-dev-guide`](https://github.com/keskinonur/claude-code-ios-dev-guide) → `README.md`
