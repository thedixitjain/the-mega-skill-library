---
name: ecc-instructions
description: "This document consolidates the core rules and guidelines from the Claude Code configuration for use with OpenCode."
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: ".opencode/instructions/INSTRUCTIONS.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/instructions/INSTRUCTIONS.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/instructions/INSTRUCTIONS.md`
