...
description: "מאגר זה מכיל תכנית לימודים מקיפה בעלת 21 שיעורים המלמדת יסודות של בינה מלאכותית יוצרת ופיתוח יישומים. הקורס מיועד למתחילים וכולל הכל, מרעיונות בסיסיים ועד לבניית יישומים מוכנים לייצור."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/he/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/he/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/he/AGENTS.md`
