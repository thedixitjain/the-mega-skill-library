---
name: skills-agents
description: "A repository of skills, prompts, and MCP configurations for AI coding agents working with Azure SDKs and Microsoft AI Foundry services."
category: ai-agents-and-harness
source_repo: microsoft/skills
source_path: "Agents.md"
source_url: https://github.com/microsoft/skills/blob/HEAD/Agents.md
---
# Agent Skills
...
**Source:** [`microsoft/skills`](https://github.com/microsoft/skills) → `Agents.md`
