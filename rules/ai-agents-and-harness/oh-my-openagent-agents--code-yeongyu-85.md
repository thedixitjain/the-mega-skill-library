...
description: "Persistent per-thread goal tracking as a Pi extension, vendored from the standalone code-yeongyu/pi-goal repository into this monorepo as @oh-my-opencode/pi-goal (private workspace package, Adapter layer: Pi-harness-coupled)."
category: ai-agents-and-harness
source_repo: code-yeongyu/oh-my-openagent
source_path: "packages/pi-goal/AGENTS.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/pi-goal/AGENTS.md
---
# pi-goal
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/pi-goal/AGENTS.md`
