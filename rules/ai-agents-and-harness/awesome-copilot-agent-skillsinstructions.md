---
name: awesome-copilot-agent-skillsinstructions
description: "Guidelines for creating high-quality Agent Skills for GitHub Copilot"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "instructions/agent-skills.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/agent-skills.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/agent-skills.instructions.md`
