...
description: "本存儲庫包含「AI 初學者代理人」——一個全面的教育課程，教授建立 AI 代理人所需的一切。課程包含 18 課題（編號 00-18），涵蓋基礎知識、設計模式、框架、生產部署、本地/裝置代理人，以及 AI 代理人的安全性。"
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/zh-HK/AGENTS.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/zh-HK/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/zh-HK/AGENTS.md`
