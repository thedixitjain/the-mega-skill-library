---
name: skill-seekers-agents
description: "Comprehensive reference for AI coding agents. Skill Seekers is a Python CLI tool (v3.6.0) that converts documentation sites, GitHub repos, PDFs, videos, notebooks, wikis, and more into AI-ready skills for 21+ LLM platforms and RAG pipelines."
category: ai-agents-and-harness
source_repo: yusufkaraaslan/Skill_Seekers
source_path: "AGENTS.md"
source_url: https://github.com/yusufkaraaslan/Skill_Seekers/blob/HEAD/AGENTS.md
---
...
**Source:** [`yusufkaraaslan/Skill_Seekers`](https://github.com/yusufkaraaslan/Skill_Seekers) → `AGENTS.md`
