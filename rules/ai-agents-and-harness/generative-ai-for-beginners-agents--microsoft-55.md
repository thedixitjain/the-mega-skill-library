...
description: "本儲存庫包含完整的 21 課程綱要，教授生成式 AI 基礎及應用開發。此課程為初學者設計，涵蓋從基礎概念到構建可用於生產的應用程式。"
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/zh-TW/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/zh-TW/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/zh-TW/AGENTS.md`
