...
source_url: https://github.com/different-ai/openwork/blob/HEAD/AGENTS.md
---
# AGENTS.md
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `AGENTS.md`
