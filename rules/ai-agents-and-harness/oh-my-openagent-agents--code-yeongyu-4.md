...
description: "Node-side launch surface for every public CLI alias. The root shim resolves a platform package and spawns its generated bin/oh-my-opencode.js launcher payload; it is not the TypeScript CLI implementation."
category: ai-agents-and-harness
source_repo: code-yeongyu/oh-my-openagent
source_path: "bin/AGENTS.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/bin/AGENTS.md
---
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `bin/AGENTS.md`
