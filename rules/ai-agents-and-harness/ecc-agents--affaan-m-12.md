...
source_path: "docs/zh-TW/rules/agents.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-TW/rules/agents.md
---
# Agent 協調
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-TW/rules/agents.md`
