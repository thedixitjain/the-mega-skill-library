---
name: awesome-pi-agent-agents
description: "You are maintaining the awesome-pi-agent curated list of pi coding agent resources."
category: ai-agents-and-harness
source_repo: qualisero/awesome-pi-agent
source_path: ".pi/agent/AGENTS.md"
source_url: https://github.com/qualisero/awesome-pi-agent/blob/HEAD/.pi/agent/AGENTS.md
---
...
**Source:** [`qualisero/awesome-pi-agent`](https://github.com/qualisero/awesome-pi-agent) → `.pi/agent/AGENTS.md`
