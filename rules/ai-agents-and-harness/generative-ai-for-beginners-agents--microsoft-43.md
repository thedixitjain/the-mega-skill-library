...
description: "Hifadhidata hii ina mtaala kamili wa masomo 21 unaofundisha misingi ya AI Inayotengeneza na maendeleo ya matumizi. Kozi hii imeundwa kwa wanaoanza na inashughulikia kila kitu kutoka dhana za msingi hadi kujenga programu za tayari kutumika."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/sw/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/sw/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/sw/AGENTS.md`
