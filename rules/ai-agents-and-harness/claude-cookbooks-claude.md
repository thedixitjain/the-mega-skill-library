...
description: "- Company: TechStart Inc - Stage: Series A (Closed $10M in January 2024) - Industry: B2B SaaS - AI-powered developer tools - Founded: 2022 - HQ: San Francisco, CA"
category: ai-agents-and-harness
source_repo: anthropics/claude-cookbooks
source_path: "claude_agent_sdk/chief_of_staff_agent/CLAUDE.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/claude_agent_sdk/chief_of_staff_agent/CLAUDE.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `claude_agent_sdk/chief_of_staff_agent/CLAUDE.md`
