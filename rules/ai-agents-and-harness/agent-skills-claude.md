...
description: "This is the agent-skills project — a collection of production-grade engineering skills for AI coding agents."
category: ai-agents-and-harness
source_repo: addyosmani/agent-skills
source_path: "CLAUDE.md"
source_url: https://github.com/addyosmani/agent-skills/blob/HEAD/CLAUDE.md
---
# agent-skills
...
**Source:** [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills) → `CLAUDE.md`
