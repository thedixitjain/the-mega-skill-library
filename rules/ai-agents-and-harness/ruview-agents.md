---
name: ruview-agents
description: "Project rules for Codex (and any agent) working in the ruvnet/RuView / wifi-densepose repo. Mirrors the Claude Code ruview plugin."
category: ai-agents-and-harness
source_repo: ruvnet/RuView
source_path: "plugins/ruview/codex/AGENTS.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/plugins/ruview/codex/AGENTS.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `plugins/ruview/codex/AGENTS.md`
