...
source_url: https://github.com/phuryn/pm-skills/blob/HEAD/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`phuryn/pm-skills`](https://github.com/phuryn/pm-skills) → `CLAUDE.md`
