---
name: awesome-cursorrules-tokrepo-agent-discovery-cursorrules-prompt-f
...
source_path: "rules/tokrepo-agent-discovery-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/tokrepo-agent-discovery-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/tokrepo-agent-discovery-cursorrules-prompt-file.mdc`
