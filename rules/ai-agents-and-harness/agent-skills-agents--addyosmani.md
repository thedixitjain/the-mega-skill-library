...
source_url: https://github.com/addyosmani/agent-skills/blob/HEAD/docs/agents.md
---
# Agent Personas
...
**Source:** [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills) → `docs/agents.md`
