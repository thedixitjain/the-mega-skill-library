---
name: awesome-copilot-agentsinstructions
description: "Guidelines for creating custom agent files for GitHub Copilot"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "instructions/agents.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/agents.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/agents.instructions.md`
