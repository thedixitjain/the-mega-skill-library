...
description: "Ang repositoryong ito ay naglalaman ng \"AI Agents para sa Mga Nagsisimula\" - isang komprehensibong kursong pang-edukasyon na nagtuturo ng lahat ng kinakailangan upang makagawa ng AI Agents. Ang kurso ay binubuo ng 18 na leksiyon (may bilang 00-18) na sumasaklaw sa mga pundasyon, disenyo ng mga pattern, mga framework, pag-deploy sa produksyon, mga lokal/on-device na agents, at seguridad ng mga AI agents."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/tl/AGENTS.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/tl/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/tl/AGENTS.md`
