...
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/AGENTS.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `AGENTS.md`
