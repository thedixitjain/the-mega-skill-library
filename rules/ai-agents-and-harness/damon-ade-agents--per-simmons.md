...
source_url: https://github.com/per-simmons/damon-ade/blob/HEAD/apps/desktop/AGENTS.md
---
...
**Source:** [`per-simmons/damon-ade`](https://github.com/per-simmons/damon-ade) → `apps/desktop/AGENTS.md`
