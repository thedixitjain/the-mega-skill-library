...
description: "To repozytorium zawiera kompleksowy program nauczania składający się z 21 lekcji uczących podstaw Generative AI oraz tworzenia aplikacji. Kurs jest przeznaczony dla początkujących i obejmuje wszystko, od podstawowych koncepcji po budowę gotowych do produkcji aplikacji."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/pl/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/pl/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/pl/AGENTS.md`
