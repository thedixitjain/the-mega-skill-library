...
description: "Questo repository contiene un curriculum completo di 21 lezioni che insegna le basi dell'IA Generativa e lo sviluppo di applicazioni. Il corso è progettato per principianti e copre tutto, dai concetti di base alla creazione di applicazioni pronte per la produzione."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/it/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/it/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/it/AGENTS.md`
