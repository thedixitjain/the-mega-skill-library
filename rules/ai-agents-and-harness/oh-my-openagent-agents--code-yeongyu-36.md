...
source_path: "packages/omo-opencode/src/cli/config-manager/AGENTS.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/omo-opencode/src/cli/config-manager/AGENTS.md
---
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/omo-opencode/src/cli/config-manager/AGENTS.md`
