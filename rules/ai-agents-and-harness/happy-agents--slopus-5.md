---
name: happy-agents
description: "Stress tests that run against a real multi-replica Happy server on minikube."
category: ai-agents-and-harness
source_repo: slopus/happy
source_path: "packages/happy-server/deploy/integration-tests/AGENTS.md"
source_url: https://github.com/slopus/happy/blob/HEAD/packages/happy-server/deploy/integration-tests/AGENTS.md
---
# Integration Tests
...
**Source:** [`slopus/happy`](https://github.com/slopus/happy) → `packages/happy-server/deploy/integration-tests/AGENTS.md`
