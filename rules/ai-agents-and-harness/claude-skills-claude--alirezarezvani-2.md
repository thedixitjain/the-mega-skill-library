...
description: "This plugin enables multi-agent collaboration. Spawn N parallel subagents that compete on the same task, evaluate results, and merge the winner."
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "engineering/agenthub/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/agenthub/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/agenthub/CLAUDE.md`
