...
description: "此儲存庫包含完整的 21 課課程，教授生成式 AI 的基礎與應用開發。該課程專為初學者設計，覆蓋從基本概念到建置可投入生產的應用程式。"
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/zh-MO/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/zh-MO/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/zh-MO/AGENTS.md`
