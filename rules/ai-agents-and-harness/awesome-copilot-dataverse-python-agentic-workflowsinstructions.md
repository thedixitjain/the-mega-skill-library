---
name: awesome-copilot-dataverse-python-agentic-workflowsinstructions
description: "Status: This feature is in Public Preview as of December 2025 Availability: General Availability (GA) date TBD Documentation: Complete implementation details forthcoming"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "instructions/dataverse-python-agentic-workflows.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/dataverse-python-agentic-workflows.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/dataverse-python-agentic-workflows.instructions.md`
