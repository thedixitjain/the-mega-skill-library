...
description: "Stateless webhook bridge: Linear AgentSessionEvent → CMA session (with routing metadata) → session.statusidled webhook → createAgentActivity reply."
category: ai-agents-and-harness
source_repo: anthropics/claude-cookbooks
source_path: "managed_agents/linear/CLAUDE.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/managed_agents/linear/CLAUDE.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `managed_agents/linear/CLAUDE.md`
