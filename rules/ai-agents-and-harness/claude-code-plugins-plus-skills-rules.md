---
name: claude-code-plugins-plus-skills-rules
description: "This repo is the Tons of Skills marketplace for Claude Code plugins and skills (live at https://tonsofskills.com). It is three things at once:"
category: ai-agents-and-harness
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: ".greptile/rules.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/.greptile/rules.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `.greptile/rules.md`
