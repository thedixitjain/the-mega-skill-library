...
description: "Dette repository indeholder en omfattende 21-lektioners undervisningsplan, der lærer Generativ AI grundlæggende og applikationsudvikling. Kurset er designet til begyndere og dækker alt fra grundlæggende begreber til opbygning af produktionsklare applikationer."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/da/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/da/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/da/AGENTS.md`
