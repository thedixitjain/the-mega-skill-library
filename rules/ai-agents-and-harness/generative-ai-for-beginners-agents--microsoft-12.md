...
description: "Tämä varasto sisältää kattavan 21 oppitunnin opetussuunnitelman, joka opettaa generatiivisen tekoälyn perusteet ja sovelluskehityksen. Kurssi on suunnattu aloittelijoille ja kattaa kaiken peruskäsitteistä tuotantovalmiiden sovellusten rakentamiseen."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/fi/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/fi/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/fi/AGENTS.md`
