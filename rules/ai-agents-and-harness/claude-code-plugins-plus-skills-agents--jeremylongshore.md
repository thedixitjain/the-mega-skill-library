---
name: claude-code-plugins-plus-skills-agents
...
source_path: "marketplace/src/content/docs/concepts/agents.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/marketplace/src/content/docs/concepts/agents.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `marketplace/src/content/docs/concepts/agents.md`
