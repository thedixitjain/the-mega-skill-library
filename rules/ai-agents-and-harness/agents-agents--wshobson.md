---
name: agents-agents
description: "Complete reference for all 203 local specialized AI agents organized by category with model assignments."
category: ai-agents-and-harness
source_repo: wshobson/agents
source_path: "docs/agents.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/docs/agents.md
---
# Agent Reference
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `docs/agents.md`
