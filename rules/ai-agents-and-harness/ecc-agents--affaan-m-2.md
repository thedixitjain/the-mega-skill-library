---
name: ecc-agents
description: "Este es un plugin de IA para codificación listo para producción que proporciona 63 agentes especializados, 249 skills, 79 comandos y flujos de trabajo de hooks automatizados para el desarrollo de software."
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: "docs/es/AGENTS.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/AGENTS.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/AGENTS.md`
