...
description: "このリポジトリには、生成AIの基本とアプリケーション開発を教える包括的な21レッスンのカリキュラムが含まれています。このコースは初心者向けで、基本概念から本番準備が整ったアプリケーションの構築までをカバーしています。"
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/ja/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/ja/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/ja/AGENTS.md`
