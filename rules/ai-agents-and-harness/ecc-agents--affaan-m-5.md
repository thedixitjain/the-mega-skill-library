---
name: ecc-agents
description: "~/.claude/agents/ に配置:"
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/rules/common/agents.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/rules/common/agents.md
---
# Agent オーケストレーション
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/rules/common/agents.md`
