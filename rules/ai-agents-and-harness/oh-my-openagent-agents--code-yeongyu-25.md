...
source_path: "packages/omo-codex/plugin/components/lazycodex-executor-verify/AGENTS.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/omo-codex/plugin/components/lazycodex-executor-verify/AGENTS.md
---
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/omo-codex/plugin/components/lazycodex-executor-verify/AGENTS.md`
