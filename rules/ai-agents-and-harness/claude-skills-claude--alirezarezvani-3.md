...
description: "This plugin runs autonomous experiment loops that optimize any file by a measurable metric."
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "engineering/autoresearch-agent/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/autoresearch-agent/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/autoresearch-agent/CLAUDE.md`
