---
name: skill-seekers-claude
description: "This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository."
category: ai-agents-and-harness
source_repo: yusufkaraaslan/Skill_Seekers
source_path: "CLAUDE.md"
source_url: https://github.com/yusufkaraaslan/Skill_Seekers/blob/HEAD/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`yusufkaraaslan/Skill_Seekers`](https://github.com/yusufkaraaslan/Skill_Seekers) → `CLAUDE.md`
