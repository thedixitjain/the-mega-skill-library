...
description: "Ovaj spremište sadrži sveobuhvatan kurikulum od 21 lekcije koji podučava osnove Generativne AI i razvoj aplikacija. Tečaj je dizajniran za početnike i pokriva sve od osnovnih koncepata do izrade aplikacija spremnih za produkciju."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/hr/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/hr/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/hr/AGENTS.md`
