...
description: "- Name Anthropic SDK client instances client — e.g. const client = new Anthropic(); in TypeScript, client = Anthropic() in Python. This applies to source files and code snippets in READMEs and guides alike. - Never use the \"CMA\" acronym. Write \"Managed Agents\" or \"Claude Managed Agents\" in prose and comments, and spell it out in identifiers, file names, and log prefixes (e.g. managed-agents.ts, not cma.ts; [managed-agent], not [cma])."
category: ai-agents-and-harness
source_repo: anthropics/claude-quickstarts
source_path: "CLAUDE.md"
source_url: https://github.com/anthropics/claude-quickstarts/blob/HEAD/CLAUDE.md
---
...
**Source:** [`anthropics/claude-quickstarts`](https://github.com/anthropics/claude-quickstarts) → `CLAUDE.md`
