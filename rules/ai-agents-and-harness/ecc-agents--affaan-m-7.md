---
name: ecc-agents
description: "Localizados em ~/.claude/agents/:"
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: "docs/pt-BR/rules/agents.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/rules/agents.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/rules/agents.md`
