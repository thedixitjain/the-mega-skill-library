...
description: "Hifadhidata hii ina \"Wakala wa AI kwa Waanzilishi\" - kozi kamili ya elimu inayofundisha kila kinachohitajika kujenga Wakala wa AI. Kozi ina masomo 18 (yenye nambari 00-18) ikijumuisha misingi, mifumo ya muundo, fremu za kazi, utoaji wa uzalishaji, wakala wa eneo la ndani/kwenye kifaa, na usalama wa wakala wa AI."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/sw/AGENTS.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/sw/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/sw/AGENTS.md`
