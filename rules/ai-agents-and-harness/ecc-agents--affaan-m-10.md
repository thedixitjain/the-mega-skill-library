---
name: ecc-agents
description: "这是一个生产就绪的 AI 编码插件，提供 67 个专业代理、281 项技能、94 条命令以及自动化钩子工作流，用于软件开发。"
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/AGENTS.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/AGENTS.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/AGENTS.md`
