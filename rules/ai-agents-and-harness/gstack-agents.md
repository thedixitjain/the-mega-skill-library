---
name: gstack-agents
description: "gstack is a collection of SKILL.md files that give AI agents structured roles for software development. Each skill is a specialist: CEO reviewer, eng manager, designer, QA lead, release engineer, debugger, and more."
category: ai-agents-and-harness
source_repo: garrytan/gstack
source_path: "AGENTS.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/AGENTS.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `AGENTS.md`
