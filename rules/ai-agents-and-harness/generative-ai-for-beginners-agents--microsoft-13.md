...
description: "Ce dépôt contient un programme complet de 21 leçons pour enseigner les fondamentaux de l'IA générative et le développement d'applications. Le cours est conçu pour les débutants et couvre tout, des concepts de base à la création d'applications prêtes pour la production."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/fr/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/fr/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/fr/AGENTS.md`
