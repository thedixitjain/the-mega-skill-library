---
name: ecc-agents
description: "~/.claude/agents/에 위치:"
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: "docs/ko-KR/rules/agents.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/rules/agents.md
---
# 에이전트 오케스트레이션
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/rules/agents.md`
