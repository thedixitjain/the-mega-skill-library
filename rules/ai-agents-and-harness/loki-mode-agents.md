...
description: "Complete specifications for all 41 specialized agent roles in Loki Mode (37 domain agents + 4 orchestration agents). These are prompt-defined role specifications the orchestrator adopts per phase, not separate processes."
category: ai-agents-and-harness
source_repo: asklokesh/loki-mode
source_path: "references/agents.md"
source_url: https://github.com/asklokesh/loki-mode/blob/HEAD/references/agents.md
---
...
**Source:** [`asklokesh/loki-mode`](https://github.com/asklokesh/loki-mode) → `references/agents.md`
