...
description: "Ez a tároló egy átfogó, 21 leckéből álló tananyagot tartalmaz, amely a Generatív mesterséges intelligencia alapjait és alkalmazásfejlesztést tanít. A tanfolyam kezdőknek készült, és mindent lefed az alapvető fogalmaktól a gyártásra kész alkalmazások létrehozásáig."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/hu/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/hu/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/hu/AGENTS.md`
