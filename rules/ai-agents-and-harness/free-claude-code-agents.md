...
**Source:** [`Alishahryar1/free-claude-code`](https://github.com/Alishahryar1/free-claude-code) → `AGENTS.md`

**Also appears in:** `Alishahryar1/free-claude-code/CLAUDE.md`
