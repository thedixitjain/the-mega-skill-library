...
description: "This guide explains the template system for agents, commands, and standardized workflows."
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "templates/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/templates/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `templates/CLAUDE.md`
