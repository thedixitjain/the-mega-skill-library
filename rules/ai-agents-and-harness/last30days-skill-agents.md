---
name: last30days-skill-agents
description: "Agent Skills package for researching any topic across Reddit, X, YouTube, and web. Installable across Claude Code (most common host), Codex, Cursor, GitHub Copilot, Gemini CLI, Grok (xAI), and 50+ other Agent Skills hosts. Python scripts with multi-source search aggregation."
category: ai-agents-and-harness
source_repo: mvanhorn/last30days-skill
source_path: "AGENTS.md"
source_url: https://github.com/mvanhorn/last30days-skill/blob/HEAD/AGENTS.md
---
# last30days Skill
...
**Source:** [`mvanhorn/last30days-skill`](https://github.com/mvanhorn/last30days-skill) → `AGENTS.md`
