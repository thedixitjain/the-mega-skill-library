...
description: "Repositori ini berisi \"Agen AI untuk Pemula\" - sebuah kursus edukasi komprehensif yang mengajarkan segala hal yang dibutuhkan untuk membangun Agen AI. Kursus ini terdiri dari 18 pelajaran (dinomori 00-18) yang mencakup dasar-dasar, pola desain, kerangka kerja, penerapan produksi, agen lokal/pada perangkat, dan keamanan agen AI."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/id/AGENTS.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/id/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/id/AGENTS.md`
