...
description: "本文档列出 ../creative-design.md 所依赖的 harness 专属工具，供你在 Claude Code 中运行时使用。主提示词只命名能力（\"向用户提问\"、\"展示文件\"等）；本文档给出确切的 Claude Code 工具、签名与调用方式。通用工具（Bash、Read/Write/Edit/Glob、gh）在任何环境都相同，不在此覆盖。"
category: ai-agents-and-harness
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/zlsbksdxl/codex-lark/skills/lark-apps/creative-design/references/claude.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/zlsbksdxl/codex-lark/skills/lark-apps/creative-design/references/claude.md
---
# Claude Code 工具参考
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/zlsbksdxl/codex-lark/skills/lark-apps/creative-design/references/claude.md`
