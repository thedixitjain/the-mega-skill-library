---
name: happy-agents
description: "This is a test fixture, not a real product. It exists so we can exercise coding agents (Claude Code, OpenCode, Codex, Happy, etc.) against a small but realistic codebase and observe their protocol behavior end to end."
category: ai-agents-and-harness
source_repo: slopus/happy
source_path: "environments/lab-rat-todo-project/agents.md"
source_url: https://github.com/slopus/happy/blob/HEAD/environments/lab-rat-todo-project/agents.md
---
...
**Source:** [`slopus/happy`](https://github.com/slopus/happy) → `environments/lab-rat-todo-project/agents.md`
