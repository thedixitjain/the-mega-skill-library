---
name: context-mode-copilot-instructions
description: "context-mode MCP tools available. Rules protect context window from flooding. One unrouted command dumps 56 KB into context."
category: ai-agents-and-harness
source_repo: mksglu/context-mode
source_path: "configs/vscode-copilot/copilot-instructions.md"
source_url: https://github.com/mksglu/context-mode/blob/HEAD/configs/vscode-copilot/copilot-instructions.md
---
...
**Source:** [`mksglu/context-mode`](https://github.com/mksglu/context-mode) → `configs/vscode-copilot/copilot-instructions.md`

**Also appears in:** `mksglu/context-mode/configs/jetbrains-copilot/copilot-instructions.md`
