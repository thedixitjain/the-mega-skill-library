---
name: claude-code-mastery-claude
description: "This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository."
category: ai-agents-and-harness
source_repo: TheDecipherist/claude-code-mastery
source_path: "CLAUDE.md"
source_url: https://github.com/TheDecipherist/claude-code-mastery/blob/HEAD/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`TheDecipherist/claude-code-mastery`](https://github.com/TheDecipherist/claude-code-mastery) → `CLAUDE.md`
