...
description: "Mandatory conventions for the claude-code-skills repository. Every contributor — human or AI coding agent — must follow these rules. PRs that violate them will be closed."
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "CONVENTIONS.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/CONVENTIONS.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `CONVENTIONS.md`
