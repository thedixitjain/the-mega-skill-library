---
name: oh-my-openagent-claude
description: "Observed Claude formats:"
category: ai-agents-and-harness
source_repo: code-yeongyu/oh-my-openagent
source_path: "packages/shared-skills/skills/coding-agent-sessions/references/claude.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/shared-skills/skills/coding-agent-sessions/references/claude.md
---
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/shared-skills/skills/coding-agent-sessions/references/claude.md`
