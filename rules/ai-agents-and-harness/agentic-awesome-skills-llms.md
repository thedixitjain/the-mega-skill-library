---
name: agentic-awesome-skills-llms
description: "- Current release: V15.5.1. - Release boundary: V15.5.1 includes AAS Core under the Agent-First Preview; pin this exact version when configuring the local MCP. - Skill count: 1,991+. - Primary product: AAS Core preview, exposed through the aas CLI and local aas-mcp stdio server. - Agent tools: searchskills, getskill, composestack, inspectstack, diffstack, exportselectionevidence, and inspectselectionevidence."
category: ai-agents-and-harness
source_repo: sickn33/agentic-awesome-skills
source_path: "apps/web-app/public/llms.txt"
source_url: https://github.com/sickn33/agentic-awesome-skills/blob/HEAD/apps/web-app/public/llms.txt
---
# Agentic Awesome Skills

> AAS Core is a local, agent-first control plane for complete catalog discovery, agent-owned skill selection, stack validation, and planning, backed by 1,991+ agentic SKILL.md playbooks.

## Key Facts

- Current release: V15.5.1.
- Release boundary: V15.5.1 includes AAS Core under the Agent-First Preview; pin this exact version when configuring the local MCP.
- Skill count: 1,991+.
...
- The 1,991+ skill catalog, specialized plugins, bundles, and workflows are supporting discovery and distribution surfaces.
...
- Bundles guide: https://github.com/sickn33/agentic-awesome-skills/blob/main/docs/users/bundles.md
- Workflows guide: https://github.com/sickn33/agentic-awesome-skills/blob/main/docs/users/workflows.md
- Stable manifest docs: https://github.com/sickn33/agentic-awesome-skills/blob/main/docs/users/discovery-manifest.md
- Credits and sources: https://github.com/sickn33/agentic-awesome-skills#credits--sources
...
**Source:** [`sickn33/agentic-awesome-skills`](https://github.com/sickn33/agentic-awesome-skills) → `apps/web-app/public/llms.txt`
