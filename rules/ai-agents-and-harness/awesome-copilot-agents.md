...
description: "The Awesome GitHub Copilot repository is a community-driven collection of custom agents and instructions designed to enhance GitHub Copilot experiences across various domains, languages, and use cases. The project includes:"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "AGENTS.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/AGENTS.md
---
# AGENTS.md
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `AGENTS.md`
