---
name: ecc-agents
description: "Bu, yazılım geliştirme için 28 özel agent, 116 skill, 59 command ve otomatik hook iş akışları sağlayan üretime hazır bir AI kodlama eklentisidir."
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: "docs/tr/AGENTS.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/AGENTS.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/AGENTS.md`
