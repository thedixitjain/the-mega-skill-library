...
description: "See hoidla sisaldab põhjalikku 21-peatükilist õppekava, mis õpetab Generatiivse tehisintellekti põhitõdesid ja rakenduste arendamist. Kursus on mõeldud algajatele ja käsitleb kõike alates põhimõistetest kuni tootmisvalmis rakenduste ehitamiseni."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/et/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/et/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/et/AGENTS.md`
