---
name: claude-skills-claude
description: "A complete virtual board of directors: 28 skills covering 10 executive roles, orchestration, cross-cutting capabilities, and culture & collaboration frameworks — plus the new c-level-agents plugin layer that surfaces 8 cs- persona agents and 17 /cs: slash commands on top of the skills."
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "c-level-advisor/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/c-level-advisor/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `c-level-advisor/CLAUDE.md`
