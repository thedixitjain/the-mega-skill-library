---
name: ccprompts-claude
description: "This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository."
category: ai-agents-and-harness
source_repo: ursisterbtw/ccprompts
source_path: "CLAUDE.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `CLAUDE.md`
