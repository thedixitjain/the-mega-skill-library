---
name: gbrain-agents
description: "This is your install + operating protocol. Claude Code reads ./CLAUDE.md automatically. Everyone else (Codex, Cursor, OpenClaw, Aider, Continue, or an LLM fetching via URL): start here."
category: ai-agents-and-harness
source_repo: garrytan/gbrain
source_path: "AGENTS.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/AGENTS.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `AGENTS.md`
