---
name: scientific-agent-skills-agents
description: "This repository is a collection of Agent Skills for science and research. Every skill lives in its own directory under skills/ and must conform to the open Agent Skills specification."
category: ai-agents-and-harness
source_repo: K-Dense-AI/scientific-agent-skills
source_path: "AGENTS.md"
source_url: https://github.com/K-Dense-AI/scientific-agent-skills/blob/HEAD/AGENTS.md
---
# Repository Guidance
...
**Source:** [`K-Dense-AI/scientific-agent-skills`](https://github.com/K-Dense-AI/scientific-agent-skills) → `AGENTS.md`
