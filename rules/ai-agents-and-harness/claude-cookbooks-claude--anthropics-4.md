...
description: "Stateless webhook bridge: Slack appmention → CMA session (with routing metadata) → session.statusidled webhook → chat.postMessage in-thread."
category: ai-agents-and-harness
source_repo: anthropics/claude-cookbooks
source_path: "managed_agents/slack/CLAUDE.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/managed_agents/slack/CLAUDE.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `managed_agents/slack/CLAUDE.md`
