...
description: "Šiame saugykloje yra išsamus 21 pamokos kursas, mokantis Generatyvinio DI pagrindų ir taikomųjų programų kūrimo. Kursas skirtas pradedantiesiems ir apima viską nuo pagrindinių koncepcijų iki gamybai paruoštų programų kūrimo."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/lt/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/lt/AGENTS.md
---
# AGENTAI.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/lt/AGENTS.md`
