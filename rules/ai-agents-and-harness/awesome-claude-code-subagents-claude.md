---
name: awesome-claude-code-subagents-claude
description: "This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository."
category: ai-agents-and-harness
source_repo: VoltAgent/awesome-claude-code-subagents
source_path: "CLAUDE.md"
source_url: https://github.com/VoltAgent/awesome-claude-code-subagents/blob/HEAD/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`VoltAgent/awesome-claude-code-subagents`](https://github.com/VoltAgent/awesome-claude-code-subagents) → `CLAUDE.md`
