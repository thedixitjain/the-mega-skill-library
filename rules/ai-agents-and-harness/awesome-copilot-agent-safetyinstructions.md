---
name: awesome-copilot-agent-safetyinstructions
...
source_path: "instructions/agent-safety.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/agent-safety.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/agent-safety.instructions.md`
