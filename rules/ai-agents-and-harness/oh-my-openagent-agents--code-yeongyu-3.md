...
description: "Checked-in JSON artifacts consumed by editors, CLIs, installers, and published packages. This directory is output, not the source of configuration or help contracts."
category: ai-agents-and-harness
source_repo: code-yeongyu/oh-my-openagent
source_path: "assets/AGENTS.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/assets/AGENTS.md
---
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `assets/AGENTS.md`
