---
name: agent-reach-claude
description: "Agent Reach — Python CLI + library that gives AI agents read/search access to 13 internet platforms. Positioning: installer + doctor + config tool. NOT a wrapper — after install, agents call upstream tools directly. Repo: github.com/Panniantong/Agent-Reach | License: MIT | Version: 1.5.0"
category: ai-agents-and-harness
source_repo: Panniantong/Agent-Reach
source_path: "CLAUDE.md"
source_url: https://github.com/Panniantong/Agent-Reach/blob/HEAD/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`Panniantong/Agent-Reach`](https://github.com/Panniantong/Agent-Reach) → `CLAUDE.md`
