...
description: "URL retrieval as a Pi extension, vendored from the standalone code-yeongyu/pi-webfetch repository into this monorepo as @oh-my-opencode/pi-webfetch (private workspace package, Adapter layer: Pi-harness-coupled)."
category: ai-agents-and-harness
source_repo: code-yeongyu/oh-my-openagent
source_path: "packages/pi-webfetch/AGENTS.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/pi-webfetch/AGENTS.md
---
# pi-webfetch
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/pi-webfetch/AGENTS.md`
