---
name: openclaude-agents
description: "This guide is for AI coding agents working in the OpenClaude repository. Read it before changing code, and also follow CONTRIBUTING.md for contributor policy, PR expectations, review follow-up, and project scope."
category: ai-agents-and-harness
source_repo: Gitlawb/openclaude
source_path: "AGENTS.md"
source_url: https://github.com/Gitlawb/openclaude/blob/HEAD/AGENTS.md
---
...
**Source:** [`Gitlawb/openclaude`](https://github.com/Gitlawb/openclaude) → `AGENTS.md`
