---
name: loki-mode-agents
description: "Claude Code's Task tool has these subagenttypes: - general-purpose - Most work (implementation, review, testing) - Explore - Codebase exploration and search - Plan - Architecture and planning - Bash - Command execution - platform-orchestrator - Deployment and service management"
category: ai-agents-and-harness
source_repo: asklokesh/loki-mode
source_path: "skills/agents.md"
source_url: https://github.com/asklokesh/loki-mode/blob/HEAD/skills/agents.md
---
...
**Source:** [`asklokesh/loki-mode`](https://github.com/asklokesh/loki-mode) → `skills/agents.md`
