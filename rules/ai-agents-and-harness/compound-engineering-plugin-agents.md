---
name: compound-engineering-plugin-agents
description: "This repository is the root of the compound-engineering coding-agent plugin and the marketplace/catalog metadata used to distribute it."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "AGENTS.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/AGENTS.md
---
# Agent Instructions
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `AGENTS.md`
