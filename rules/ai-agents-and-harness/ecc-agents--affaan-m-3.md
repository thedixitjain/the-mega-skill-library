---
name: ecc-agents
description: "Ubicados en ~/.claude/agents/:"
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: "docs/es/rules/common/agents.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/rules/common/agents.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/rules/common/agents.md`
