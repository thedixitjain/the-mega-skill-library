---
name: ruflo-claude
description: "When starting work on complex tasks, Claude Code MUST automatically:"
category: ai-agents-and-harness
source_repo: ruvnet/ruflo
source_path: "v3/@claude-flow/cli/CLAUDE.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/v3/@claude-flow/cli/CLAUDE.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `v3/@claude-flow/cli/CLAUDE.md`
