...
description: "ဤ repository တွင် Generative AI အခြေခံနှင့် အပလီကေးရှင်းဖွံ့ဖြိုးမှုကို သင်ကြားသည့် အပတ် ၂၁ အပိုင်းများပါဝင်သော ကျယ်ပြန့်သော သင်တန်းအစီအစဉ်ရှိသည်။ သင်တန်းသည် စတင်သင်ယူသူများအတွက်ဒီဇိုင်းချပြီး အခြေခံအယူအဆများမှ ထုတ်လုပ်မှုအသင့်အပလီကေးရှင်းများ တည်ဆောက်ခြင်းအထိအားလုံးပါဝင်သည်။"
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/my/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/my/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/my/AGENTS.md`
