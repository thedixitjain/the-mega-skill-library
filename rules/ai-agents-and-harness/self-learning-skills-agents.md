---
name: self-learning-skills-agents
description: "This file makes any coding agent self-improving: recognize a hard-won \"golden path\" during a task and persist it so the next session starts already knowing it, instead of rediscovering how to reach the DB, where the creds live, how to deploy, or how to verify a change live."
category: ai-agents-and-harness
source_repo: Kulaxyz/self-learning-skills
source_path: "AGENTS.md"
source_url: https://github.com/Kulaxyz/self-learning-skills/blob/HEAD/AGENTS.md
---
...
**Source:** [`Kulaxyz/self-learning-skills`](https://github.com/Kulaxyz/self-learning-skills) → `AGENTS.md`
