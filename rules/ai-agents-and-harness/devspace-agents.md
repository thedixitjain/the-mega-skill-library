---
name: devspace-agents
description: "This project exposes a local development workspace over MCP so ChatGPT, Claude, or another MCP-capable host can operate directly on this machine's approved development directories."
category: ai-agents-and-harness
source_repo: Waishnav/devspace
source_path: "AGENTS.md"
source_url: https://github.com/Waishnav/devspace/blob/HEAD/AGENTS.md
---
# DevSpace
...
**Source:** [`Waishnav/devspace`](https://github.com/Waishnav/devspace) → `AGENTS.md`
