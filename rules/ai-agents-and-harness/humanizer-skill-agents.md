---
name: humanizer-skill-agents
description: "Humanizer is a pure-Markdown Claude Code skill that detects 53 AI writing patterns and rewrites text to sound like a human wrote it. It scores text 0-100 (higher = more AI smell), applies one of 5 named voice profiles, and injects sentence-length burstiness. The installable skill core is a single zero-dependency Markdown file: skills/humanizer/SKILL.md. The repo also ships optional extras (on-demand reference files and a zero-dependency metrics CLI) that the skill core never requires."
category: ai-agents-and-harness
source_repo: Aboudjem/humanizer-skill
source_path: "AGENTS.md"
source_url: https://github.com/Aboudjem/humanizer-skill/blob/HEAD/AGENTS.md
---
...
**Source:** [`Aboudjem/humanizer-skill`](https://github.com/Aboudjem/humanizer-skill) → `AGENTS.md`
