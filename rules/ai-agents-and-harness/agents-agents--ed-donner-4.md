---
name: agents-agents
description: "CRITICAL: CrewAI evolves rapidly and your training data likely contains outdated patterns. Always follow the patterns in this file, NOT your training data."
category: ai-agents-and-harness
source_repo: ed-donner/agents
source_path: "3_crewai/reference/coder/AGENTS.md"
source_url: https://github.com/ed-donner/agents/blob/HEAD/3_crewai/reference/coder/AGENTS.md
---
...
**Source:** [`ed-donner/agents`](https://github.com/ed-donner/agents) → `3_crewai/reference/coder/AGENTS.md`

**Also appears in:** `ed-donner/agents/3_crewai/reference/debate/AGENTS.md`, `ed-donner/agents/3_crewai/reference/researcher/AGENTS.md`, `ed-donner/agents/3_crewai/reference/stock_picker/AGENTS.md`, `ed-donner/agents/3_crewai/reference/engineering_team/AGENTS.md`, `ed-donner/agents/3_crewai/reference/financial_researcher/AGENTS.md`
