...
source_url: https://github.com/humanlayer/12-factor-agents/blob/HEAD/CLAUDE.md
---
...
**Source:** [`humanlayer/12-factor-agents`](https://github.com/humanlayer/12-factor-agents) → `CLAUDE.md`
