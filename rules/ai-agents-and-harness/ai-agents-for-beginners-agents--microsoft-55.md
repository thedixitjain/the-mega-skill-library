...
description: "此儲存庫包含「初學者的 AI 代理人」— 一門全面的教育課程，教授構建 AI 代理人所需的一切。該課程包含18個課程（編號00-18），涵蓋基礎知識、設計模式、框架、正式部署、本地/裝置代理人以及 AI 代理人的安全性。"
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/zh-TW/AGENTS.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/zh-TW/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/zh-TW/AGENTS.md`
