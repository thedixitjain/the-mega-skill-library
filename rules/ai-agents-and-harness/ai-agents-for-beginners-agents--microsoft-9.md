...
description: "Este repositorio contiene \"Agentes de IA para Principiantes\" - un curso educativo integral que enseña todo lo necesario para construir Agentes de IA. El curso consta de 18 lecciones (numeradas 00-18) que cubren fundamentos, patrones de diseño, frameworks, despliegue en producción, agentes locales/en dispositivo y seguridad de los agentes de IA."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/es/AGENTS.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/es/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/es/AGENTS.md`
