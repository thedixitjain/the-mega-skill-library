---
name: codex-skills-agents
description: "- bin/codexskills.js is the CLI entry point (Node.js CommonJS). - skills/<skill-name>/ holds individual skills. Each skill must include SKILL.md and may add scripts/, references/, or assets/ as needed (e.g., skills/context7/.env.example). - README.md documents available skills and install usage. - codex-plan.md is internal planning/notes."
category: ai-agents-and-harness
source_repo: am-will/codex-skills
source_path: "AGENTS.md"
source_url: https://github.com/am-will/codex-skills/blob/HEAD/AGENTS.md
---
...
**Source:** [`am-will/codex-skills`](https://github.com/am-will/codex-skills) → `AGENTS.md`
