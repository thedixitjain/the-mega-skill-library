---
name: generative-ai-for-beginners-agents
description: "Acest depozit conține un curriculum cuprinzător de 21 de lecții care predau noțiunile fundamentale ale Inteligenței Artificiale Generative și dezvoltarea aplicațiilor. Cursul este conceput pentru începători și acoperă totul, de la conceptele de bază până la construirea aplicațiilor gata de producție."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/ro/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/ro/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/ro/AGENTS.md`
