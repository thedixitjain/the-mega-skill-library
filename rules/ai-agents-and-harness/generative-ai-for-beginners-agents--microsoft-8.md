...
description: "This repository offers a comprehensive 21-lesson curriculum on Generative AI fundamentals and application development. The course is tailored for beginners, covering everything from foundational concepts to creating production-ready applications."
category: ai-agents-and-harness
source_repo: microsoft/generative-ai-for-beginners
source_path: "translations/en/AGENTS.md"
source_url: https://github.com/microsoft/generative-ai-for-beginners/blob/HEAD/translations/en/AGENTS.md
---
# AGENTS.md
...
**Source:** [`microsoft/generative-ai-for-beginners`](https://github.com/microsoft/generative-ai-for-beginners) → `translations/en/AGENTS.md`
