...
description: "Complete specifications for all 37 specialized agent types in the Loki Mode multi-agent system."
category: ai-agents-and-harness
source_repo: sickn33/agentic-awesome-skills
source_path: "skills/loki-mode/references/agents.md"
source_url: https://github.com/sickn33/agentic-awesome-skills/blob/HEAD/skills/loki-mode/references/agents.md
---
...
**Source:** [`sickn33/agentic-awesome-skills`](https://github.com/sickn33/agentic-awesome-skills) → `skills/loki-mode/references/agents.md`

**Also appears in:** `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills-claude/skills/loki-mode/references/agents.md`
