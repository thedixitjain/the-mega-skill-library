---
name: context-engineering-claude
description: "This document provides a comprehensive framework of cognitive tools, protocol shells, reasoning templates, and workflows for Claude Code. Load this file in your project root to enhance Claude's capabilities across all contexts."
category: ai-agents-and-harness
source_repo: jasontang-ai/Context-Engineering
source_path: "CLAUDE.md"
source_url: https://github.com/jasontang-ai/Context-Engineering/blob/HEAD/CLAUDE.md
---
...
**Source:** [`jasontang-ai/Context-Engineering`](https://github.com/jasontang-ai/Context-Engineering) → `CLAUDE.md`
