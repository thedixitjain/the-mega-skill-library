...
description: "This directory contains 44 marketing skills organized into 8 specialist pods (Content, SEO + AEO, CRO, Channels, Growth, Intelligence, Sales enablement, Marketing ops)."
category: marketing-and-growth
source_repo: alirezarezvani/claude-skills
source_path: "marketing-skill/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/marketing-skill/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `marketing-skill/CLAUDE.md`
