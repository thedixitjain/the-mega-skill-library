---
name: awesome-copilot-caveman-modeinstructions
...
source_path: "instructions/caveman-mode.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/caveman-mode.instructions.md
---
# Caveman Mode
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/caveman-mode.instructions.md`
