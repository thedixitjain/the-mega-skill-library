---
name: obey-the-pragmatic-programmer-by-andrew-hunt-and-david-thomas
description: "This repository follows The Pragmatic Programmer in the sense of Andrew Hunt and David Thomas: work pragmatically, take responsibility for quality, automate what is repetitive, and keep code and process adaptable."
category: general-purpose
source_repo: ciembor/agent-rules-books
source_path: "the-pragmatic-programmer/the-pragmatic-programmer.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/the-pragmatic-programmer/the-pragmatic-programmer.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `the-pragmatic-programmer/the-pragmatic-programmer.md`
