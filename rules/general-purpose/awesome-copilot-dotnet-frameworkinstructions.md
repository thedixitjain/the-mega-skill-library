---
name: awesome-copilot-dotnet-frameworkinstructions
...
source_path: "instructions/dotnet-framework.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/dotnet-framework.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/dotnet-framework.instructions.md`
