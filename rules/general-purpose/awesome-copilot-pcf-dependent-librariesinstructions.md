---
name: awesome-copilot-pcf-dependent-librariesinstructions
description: "Using dependent libraries in PCF components"
category: general-purpose
source_repo: github/awesome-copilot
source_path: "instructions/pcf-dependent-libraries.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/pcf-dependent-libraries.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/pcf-dependent-libraries.instructions.md`
