---
name: awesome-copilot-pcf-model-driven-appsinstructions
description: "Code components for model-driven apps implementation and configuration"
category: general-purpose
source_repo: github/awesome-copilot
source_path: "instructions/pcf-model-driven-apps.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/pcf-model-driven-apps.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/pcf-model-driven-apps.instructions.md`
