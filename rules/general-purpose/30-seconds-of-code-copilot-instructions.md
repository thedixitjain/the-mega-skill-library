---
name: 30-seconds-of-code-copilot-instructions
description: "- Use ES6 syntax for all JavaScript code. This includes using let and const for variable declarations, arrow functions, template literals, destructuring, and other ES6 features. - Use semicolons at the end of each statement. - Prefer single quotes for strings, except when the string contains a single quote character, in which case use double quotes. Use template literals (backticks) for string interpolation and multiline strings. Avoid using string concatenation with +."
category: general-purpose
source_repo: Chalarangelo/30-seconds-of-code
source_path: ".github/copilot-instructions.md"
source_url: https://github.com/Chalarangelo/30-seconds-of-code/blob/HEAD/.github/copilot-instructions.md
---
# JavaScript
...
**Source:** [`Chalarangelo/30-seconds-of-code`](https://github.com/Chalarangelo/30-seconds-of-code) → `.github/copilot-instructions.md`
