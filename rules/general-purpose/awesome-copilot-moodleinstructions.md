---
name: awesome-copilot-moodleinstructions
...
source_path: "instructions/moodle.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/moodle.instructions.md
---
# Project Context
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/moodle.instructions.md`
