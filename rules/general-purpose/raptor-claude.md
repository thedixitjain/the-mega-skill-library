---
name: raptor-claude
description: "Safe operations (install, scan, read, generate): DO IT. Dangerous operations (apply patches, delete, git push): ASK FIRST."
category: general-purpose
source_repo: gadievron/raptor
source_path: "CLAUDE.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/CLAUDE.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `CLAUDE.md`
