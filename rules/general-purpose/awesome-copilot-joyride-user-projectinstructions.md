---
name: awesome-copilot-joyride-user-projectinstructions
...
source_path: "instructions/joyride-user-project.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/joyride-user-project.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/joyride-user-project.instructions.md`
