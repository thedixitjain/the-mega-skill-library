---
name: context-engineering-gemini
...
source_url: https://github.com/jasontang-ai/Context-Engineering/blob/HEAD/GEMINI.md
---
...
**Source:** [`jasontang-ai/Context-Engineering`](https://github.com/jasontang-ai/Context-Engineering) → `GEMINI.md`
