...
description: "Use as a general engineering operating style when the goal is accountable delivery, adaptability, fast feedback, and code that remains easy to change."
category: general-purpose
source_repo: ciembor/agent-rules-books
source_path: "the-pragmatic-programmer/the-pragmatic-programmer.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/the-pragmatic-programmer/the-pragmatic-programmer.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `the-pragmatic-programmer/the-pragmatic-programmer.mini.md`
