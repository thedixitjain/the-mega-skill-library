---
name: obey-release-it-by-michael-t-nygard
description: "This repository follows Release It! in the sense of Michael Nygard: design and implement software that survives production reality - failures, overload, latency, partial outages, bad data, hostile traffic, and operational mistakes."
category: general-purpose
source_repo: ciembor/agent-rules-books
source_path: "release-it/release-it.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/release-it/release-it.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `release-it/release-it.md`
