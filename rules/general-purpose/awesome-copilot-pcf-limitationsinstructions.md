---
name: awesome-copilot-pcf-limitationsinstructions
description: "Limitations and restrictions of Power Apps Component Framework"
category: general-purpose
source_repo: github/awesome-copilot
source_path: "instructions/pcf-limitations.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/pcf-limitations.instructions.md
---
# Limitations
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/pcf-limitations.instructions.md`
