---
name: awesome-copilot-langchain-pythoninstructions
description: "Instructions for using LangChain with Python"
category: general-purpose
source_repo: github/awesome-copilot
source_path: "instructions/langchain-python.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/langchain-python.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/langchain-python.instructions.md`
