...
description: "This file provides domain-specific guidance for skills in markdown-html/."
category: general-purpose
source_repo: alirezarezvani/claude-skills
source_path: "markdown-html/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/markdown-html/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `markdown-html/CLAUDE.md`
