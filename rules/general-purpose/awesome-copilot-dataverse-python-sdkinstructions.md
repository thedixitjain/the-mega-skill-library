---
name: awesome-copilot-dataverse-python-sdkinstructions
description: "This instruction summarizes Microsoft Learn guidance for the Dataverse SDK for Python (preview) and provides copyable snippets."
category: general-purpose
source_repo: github/awesome-copilot
source_path: "instructions/dataverse-python-sdk.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/dataverse-python-sdk.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/dataverse-python-sdk.instructions.md`
