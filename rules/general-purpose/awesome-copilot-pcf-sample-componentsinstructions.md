---
name: awesome-copilot-pcf-sample-componentsinstructions
...
source_path: "instructions/pcf-sample-components.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/pcf-sample-components.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/pcf-sample-components.instructions.md`
