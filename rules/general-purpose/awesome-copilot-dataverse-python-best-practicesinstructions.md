---
name: awesome-copilot-dataverse-python-best-practicesinstructions
description: "Production-ready patterns and best practices extracted from Microsoft's official PowerPlatform-DataverseClient-Python repository, examples, and recommended workflows."
category: general-purpose
source_repo: github/awesome-copilot
source_path: "instructions/dataverse-python-best-practices.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/dataverse-python-best-practices.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/dataverse-python-best-practices.instructions.md`
