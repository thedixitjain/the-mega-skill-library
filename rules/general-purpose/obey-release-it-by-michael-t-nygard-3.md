...
description: "Use when operational survivability matters and context is tight."
category: general-purpose
source_repo: ciembor/agent-rules-books
source_path: "_rule-workbench/release-it/nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/_rule-workbench/release-it/nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `_rule-workbench/release-it/nano.md`
