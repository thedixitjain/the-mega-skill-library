...
description: "Use when you need a compact always-on engineering bias toward accountability, adaptability, and fast feedback."
category: general-purpose
source_repo: ciembor/agent-rules-books
source_path: "the-pragmatic-programmer/the-pragmatic-programmer.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/the-pragmatic-programmer/the-pragmatic-programmer.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `the-pragmatic-programmer/the-pragmatic-programmer.nano.md`
