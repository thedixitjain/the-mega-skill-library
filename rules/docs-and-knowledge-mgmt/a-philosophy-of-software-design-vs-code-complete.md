---
name: a-philosophy-of-software-design-vs-code-complete
description: "Status: reviewed Research basis: mini-only"
category: docs-and-knowledge-mgmt
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/a-philosophy-of-software-design/code-complete.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/a-philosophy-of-software-design/code-complete.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/a-philosophy-of-software-design/code-complete.md`
