---
name: claude-skills-llms
description: "This file follows the llms.txt convention. For a full, self-contained description of the entire repository, see llms-full.txt."
category: docs-and-knowledge-mgmt
source_repo: alirezarezvani/claude-skills
source_path: "docs/llms.txt"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/llms.txt
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/llms.txt`
