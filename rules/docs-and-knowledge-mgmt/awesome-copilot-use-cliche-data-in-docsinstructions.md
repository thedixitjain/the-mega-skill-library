---
name: awesome-copilot-use-cliche-data-in-docsinstructions
...
source_path: "instructions/use-cliche-data-in-docs.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/use-cliche-data-in-docs.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/use-cliche-data-in-docs.instructions.md`
