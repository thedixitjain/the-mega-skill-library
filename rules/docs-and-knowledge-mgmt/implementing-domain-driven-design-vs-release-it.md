---
name: implementing-domain-driven-design-vs-release-it
description: "Status: reviewed Research basis: mini-only"
category: docs-and-knowledge-mgmt
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/implementing-domain-driven-design/release-it.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/implementing-domain-driven-design/release-it.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/implementing-domain-driven-design/release-it.md`
