---
name: implementing-domain-driven-design-vs-the-pragmatic-programmer
description: "Status: reviewed Research basis: mini-only"
category: docs-and-knowledge-mgmt
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/implementing-domain-driven-design/the-pragmatic-programmer.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/implementing-domain-driven-design/the-pragmatic-programmer.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/implementing-domain-driven-design/the-pragmatic-programmer.md`
