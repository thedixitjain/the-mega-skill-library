---
name: ecc-claude
description: "このファイルは、このリポジトリのコードを操作する際にClaude Code (claude.ai/code) にガイダンスを提供します。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/CLAUDE.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/CLAUDE.md`
