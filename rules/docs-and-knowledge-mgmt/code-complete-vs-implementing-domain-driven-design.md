---
name: code-complete-vs-implementing-domain-driven-design
description: "Status: reviewed Research basis: mini-only"
category: docs-and-knowledge-mgmt
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/code-complete/implementing-domain-driven-design.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/code-complete/implementing-domain-driven-design.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/code-complete/implementing-domain-driven-design.md`
