---
name: code-complete-vs-domain-driven-design-distilled
description: "Status: reviewed Research basis: mini-only"
category: docs-and-knowledge-mgmt
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/code-complete/domain-driven-design-distilled.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/code-complete/domain-driven-design-distilled.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/code-complete/domain-driven-design-distilled.md`
