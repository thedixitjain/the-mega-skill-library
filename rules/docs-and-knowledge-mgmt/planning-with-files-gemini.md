---
name: planning-with-files-gemini
description: "This guide explains how to install and use planning-with-files with Gemini CLI."
category: docs-and-knowledge-mgmt
source_repo: OthmanAdi/planning-with-files
source_path: "docs/gemini.md"
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/docs/gemini.md
---
# Gemini CLI Setup
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `docs/gemini.md`
