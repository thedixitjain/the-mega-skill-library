---
name: awesome-copilot-update-docs-on-code-changeinstructions
...
source_path: "instructions/update-docs-on-code-change.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/update-docs-on-code-change.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/update-docs-on-code-change.instructions.md`
