...
source_path: "docs/es/CLAUDE.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/CLAUDE.md`
