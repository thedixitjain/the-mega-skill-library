---
name: designing-data-intensive-applications-vs-release-it
description: "Status: reviewed Research basis: mini-plus-external"
category: docs-and-knowledge-mgmt
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/designing-data-intensive-applications/release-it.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/designing-data-intensive-applications/release-it.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/designing-data-intensive-applications/release-it.md`
