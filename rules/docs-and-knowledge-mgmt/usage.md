---
name: usage
description: "This repository ships three versions of every rule set:"
category: docs-and-knowledge-mgmt
source_repo: ciembor/agent-rules-books
source_path: "docs/USAGE.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/USAGE.md
---
# Usage
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/USAGE.md`
