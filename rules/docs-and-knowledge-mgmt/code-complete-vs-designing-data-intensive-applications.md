---
name: code-complete-vs-designing-data-intensive-applications
description: "Status: reviewed Research basis: mini-only"
category: docs-and-knowledge-mgmt
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/code-complete/designing-data-intensive-applications.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/code-complete/designing-data-intensive-applications.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/code-complete/designing-data-intensive-applications.md`
