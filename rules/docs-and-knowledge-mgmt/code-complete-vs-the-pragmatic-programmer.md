---
name: code-complete-vs-the-pragmatic-programmer
description: "Status: reviewed Research basis: mini-plus-external"
category: docs-and-knowledge-mgmt
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/code-complete/the-pragmatic-programmer.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/code-complete/the-pragmatic-programmer.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/code-complete/the-pragmatic-programmer.md`
