...
description: "This is a comprehensive Jupyter notebook cookbook demonstrating Claude's Skills feature for document generation (Excel, PowerPoint, PDF). It's designed for developers learning to integrate Skills into their applications."
category: data-science-and-ml
source_repo: anthropics/claude-cookbooks
source_path: "skills/CLAUDE.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/skills/CLAUDE.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `skills/CLAUDE.md`
