---
name: awesome-copilot-wordpressinstructions
description: "Coding, security, and testing rules for WordPress plugins and themes"
category: testing-and-qa
source_repo: github/awesome-copilot
source_path: "instructions/wordpress.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/wordpress.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/wordpress.instructions.md`
