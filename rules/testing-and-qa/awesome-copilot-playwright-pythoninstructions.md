---
name: awesome-copilot-playwright-pythoninstructions
...
source_path: "instructions/playwright-python.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/playwright-python.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/playwright-python.instructions.md`
