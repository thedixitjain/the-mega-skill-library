---
name: awesome-cursorrules-jest-unit-testing-cursorrules-prompt-file
description: "Cursor rules for Jest development with unit testing."
category: testing-and-qa
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/jest-unit-testing-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/jest-unit-testing-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/jest-unit-testing-cursorrules-prompt-file.mdc`
