---
name: gstack-claude
description: "bun install # install dependencies bun test # run free tests (browse + snapshot + skill validation) bun run test:evals # run paid evals: LLM judge + E2E (diff-based, ~$4/run max) bun run test:evals:all # run ALL paid evals regardless of diff bun run test:gate # run gate-tier tests only (CI default, blocks merge) bun run test:periodic # run periodic-tier tests only (weekly cron / manual)"
category: testing-and-qa
source_repo: garrytan/gstack
source_path: "CLAUDE.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/CLAUDE.md
---
# gstack development
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `CLAUDE.md`
