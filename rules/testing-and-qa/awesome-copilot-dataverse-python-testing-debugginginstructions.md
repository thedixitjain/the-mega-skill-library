---
name: awesome-copilot-dataverse-python-testing-debugginginstructions
description: "Based on official Azure Functions and pytest testing patterns."
category: testing-and-qa
source_repo: github/awesome-copilot
source_path: "instructions/dataverse-python-testing-debugging.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/dataverse-python-testing-debugging.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/dataverse-python-testing-debugging.instructions.md`
