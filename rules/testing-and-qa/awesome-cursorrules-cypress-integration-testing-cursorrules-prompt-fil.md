---
name: awesome-cursorrules-cypress-integration-testing-cursorrules-prom
description: "Cursor rules for Cypress development with integration testing."
category: testing-and-qa
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/cypress-integration-testing-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/cypress-integration-testing-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/cypress-integration-testing-cursorrules-prompt-file.mdc`
