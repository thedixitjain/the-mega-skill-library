---
name: skills-design
description: "Design features by defining properties upfront as executable specifications, before implementation."
category: testing-and-qa
source_repo: trailofbits/skills
source_path: "plugins/property-based-testing/skills/property-based-testing/references/design.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/property-based-testing/skills/property-based-testing/references/design.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/property-based-testing/skills/property-based-testing/references/design.md`
