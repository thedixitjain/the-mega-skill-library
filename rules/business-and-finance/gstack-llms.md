---
name: gstack-llms
description: "Conventions: - Skills are invoked by name (e.g. /ship, /plan-ceo-review). - Browse commands run as browse <command> [args] (or $B shorthand). - Design commands run as design <command> [args] (or $D). - Project-specific config lives in CLAUDE.md. Always read it first."
category: business-and-finance
source_repo: garrytan/gstack
source_path: "gstack/llms.txt"
source_url: https://github.com/garrytan/gstack/blob/HEAD/gstack/llms.txt
---
# gstack
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `gstack/llms.txt`
