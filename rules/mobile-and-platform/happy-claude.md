---
name: happy-claude
description: "The daemon is a persistent background process that manages Happy sessions, enables remote control from the mobile app, and handles auto-updates when the CLI version changes."
category: mobile-and-platform
source_repo: slopus/happy
source_path: "packages/happy-cli/src/daemon/CLAUDE.md"
source_url: https://github.com/slopus/happy/blob/HEAD/packages/happy-cli/src/daemon/CLAUDE.md
---
...
**Source:** [`slopus/happy`](https://github.com/slopus/happy) → `packages/happy-cli/src/daemon/CLAUDE.md`
