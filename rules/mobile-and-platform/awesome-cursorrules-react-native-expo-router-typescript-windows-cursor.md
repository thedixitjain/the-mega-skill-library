---
name: awesome-cursorrules-react-native-expo-router-typescript-windows
description: "Cursor rules for React Native Expo Router Typescript Windows."
category: mobile-and-platform
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/react-native-expo-router-typescript-windows-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/react-native-expo-router-typescript-windows-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/react-native-expo-router-typescript-windows-cursorrules-prompt-file.mdc`
