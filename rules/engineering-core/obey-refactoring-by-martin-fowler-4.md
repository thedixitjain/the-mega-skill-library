---
name: obey-refactoring-by-martin-fowler
description: "Use when changing existing code, preparing a feature or bug fix, reviewing cleanup, or reducing structural friction without intending to change observable behavior."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "_rule-workbench/refactoring/mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/_rule-workbench/refactoring/mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `_rule-workbench/refactoring/mini.md`
