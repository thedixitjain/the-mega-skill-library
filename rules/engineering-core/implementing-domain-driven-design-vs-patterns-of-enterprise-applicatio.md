---
name: implementing-domain-driven-design-vs-patterns-of-enterprise-appl
description: "Status: reviewed Research basis: mini-plus-external"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/implementing-domain-driven-design/patterns-of-enterprise-application-architecture.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/implementing-domain-driven-design/patterns-of-enterprise-application-architecture.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/implementing-domain-driven-design/patterns-of-enterprise-application-architecture.md`
