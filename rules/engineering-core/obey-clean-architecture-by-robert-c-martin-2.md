...
description: "Use when adding, changing, reviewing, or refactoring code whose business rules should survive changes in frameworks, databases, delivery mechanisms, services, devices, vendors, deployment shape, or schedule pressure."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "clean-architecture/clean-architecture.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/clean-architecture/clean-architecture.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `clean-architecture/clean-architecture.mini.md`
