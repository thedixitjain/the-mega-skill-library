---
name: obey-refactoringguru
description: "Use when changing existing code where code smells, refactoring technique choice, behavior preservation, and cleanup scope control matter."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "refactoring-guru/refactoring-guru.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/refactoring-guru/refactoring-guru.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `refactoring-guru/refactoring-guru.mini.md`
