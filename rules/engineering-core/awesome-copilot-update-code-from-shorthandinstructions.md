---
name: awesome-copilot-update-code-from-shorthandinstructions
...
source_path: "instructions/update-code-from-shorthand.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/update-code-from-shorthand.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/update-code-from-shorthand.instructions.md`
