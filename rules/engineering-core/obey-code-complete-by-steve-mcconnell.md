---
name: obey-code-complete-by-steve-mcconnell
description: "This repository follows Code Complete in the sense of Steve McConnell: apply disciplined software construction practices that reduce defects, improve readability, and produce robust code under real-world constraints."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "code-complete/code-complete.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/code-complete/code-complete.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `code-complete/code-complete.md`
