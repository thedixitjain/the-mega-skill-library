---
name: clean-code-vs-domain-driven-design-distilled
description: "Status: reviewed Research basis: mini-only"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/clean-code/domain-driven-design-distilled.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/clean-code/domain-driven-design-distilled.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/clean-code/domain-driven-design-distilled.md`
