---
name: awesome-copilot-dotnet-architecture-good-practicesinstructions
description: "DDD and .NET architecture guidelines"
category: engineering-core
source_repo: github/awesome-copilot
source_path: "instructions/dotnet-architecture-good-practices.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/dotnet-architecture-good-practices.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/dotnet-architecture-good-practices.instructions.md`
