...
description: "Use when changing code that is expensive to change safely because behavior is unclear, tests are weak or missing, dependencies are hidden, or runtime/framework setup blocks local feedback."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "working-effectively-with-legacy-code/working-effectively-with-legacy-code.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/working-effectively-with-legacy-code/working-effectively-with-legacy-code.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `working-effectively-with-legacy-code/working-effectively-with-legacy-code.mini.md`
