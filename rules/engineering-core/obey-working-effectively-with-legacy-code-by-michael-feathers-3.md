...
description: "Use when changing poorly tested or poorly understood code under a tight context budget."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "working-effectively-with-legacy-code/working-effectively-with-legacy-code.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/working-effectively-with-legacy-code/working-effectively-with-legacy-code.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `working-effectively-with-legacy-code/working-effectively-with-legacy-code.nano.md`
