...
description: "- Formatter: [TOOL + CONFIG FILE] - Linter: [TOOL + CONFIG FILE] - Most relevant enforced rules: [RULE1], [RULE2], [RULE3] - Run commands: [COMMANDS]"
category: engineering-core
source_repo: github/awesome-copilot
source_path: "skills/acquire-codebase-knowledge/assets/templates/CONVENTIONS.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/acquire-codebase-knowledge/assets/templates/CONVENTIONS.md
---
# Coding Conventions
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/acquire-codebase-knowledge/assets/templates/CONVENTIONS.md`
