---
name: refactoring-vs-release-it
description: "Status: reviewed Research basis: mini-only"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/refactoring/release-it.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/refactoring/release-it.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/refactoring/release-it.md`
