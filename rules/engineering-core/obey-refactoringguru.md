...
description: "This rule set is derived from the public Refactoring.Guru refactoring material:"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "refactoring-guru/refactoring-guru.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/refactoring-guru/refactoring-guru.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `refactoring-guru/refactoring-guru.md`
