---
name: code-complete-vs-patterns-of-enterprise-application-architecture
description: "Status: reviewed Research basis: mini-only"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/code-complete/patterns-of-enterprise-application-architecture.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/code-complete/patterns-of-enterprise-application-architecture.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/code-complete/patterns-of-enterprise-application-architecture.md`
