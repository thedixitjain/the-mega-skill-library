...
source_path: "refactoring/refactoring.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/refactoring/refactoring.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `refactoring/refactoring.nano.md`
