...
description: "This repository follows the discipline of Refactoring in the sense of Martin Fowler: improve the internal structure of code without changing its observable behavior."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "refactoring/refactoring.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/refactoring/refactoring.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `refactoring/refactoring.md`
