---
name: clean-code-vs-the-pragmatic-programmer
description: "Status: reviewed Research basis: mini-plus-external"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/clean-code/the-pragmatic-programmer.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/clean-code/the-pragmatic-programmer.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/clean-code/the-pragmatic-programmer.md`
