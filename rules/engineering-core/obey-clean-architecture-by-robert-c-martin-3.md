...
description: "Use when tight context still needs to prevent framework-first design, database-shaped policy, layer bypass, or fake boundaries."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "clean-architecture/clean-architecture.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/clean-architecture/clean-architecture.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `clean-architecture/clean-architecture.nano.md`
