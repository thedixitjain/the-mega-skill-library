...
source_path: "code-complete/code-complete.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/code-complete/code-complete.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `code-complete/code-complete.mini.md`
