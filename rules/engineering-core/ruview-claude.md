---
name: ruview-claude
description: "WiFi-based human pose estimation using Channel State Information (CSI). Dual codebase: Python v1 (v1/) and Rust port (v2/)."
category: engineering-core
source_repo: ruvnet/RuView
source_path: "CLAUDE.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/CLAUDE.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `CLAUDE.md`
