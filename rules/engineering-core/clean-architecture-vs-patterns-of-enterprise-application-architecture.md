---
name: clean-architecture-vs-patterns-of-enterprise-application-archite
description: "Status: reviewed Research basis: mini-plus-external"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/clean-architecture/patterns-of-enterprise-application-architecture.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/clean-architecture/patterns-of-enterprise-application-architecture.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/clean-architecture/patterns-of-enterprise-application-architecture.md`
