...
source_path: "_rule-workbench/patterns-of-enterprise-application-architecture/mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/_rule-workbench/patterns-of-enterprise-application-architecture/mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `_rule-workbench/patterns-of-enterprise-application-architecture/mini.md`
