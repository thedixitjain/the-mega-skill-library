---
name: awesome-copilot-dataverse-python-performance-optimizationinstruc
description: "Based on official Microsoft Dataverse and Azure SDK performance guidance."
category: engineering-core
source_repo: github/awesome-copilot
source_path: "instructions/dataverse-python-performance-optimization.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/dataverse-python-performance-optimization.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/dataverse-python-performance-optimization.instructions.md`
