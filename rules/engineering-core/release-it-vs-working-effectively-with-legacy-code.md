---
name: release-it-vs-working-effectively-with-legacy-code
description: "Status: reviewed Research basis: mini-only"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/release-it/working-effectively-with-legacy-code.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/release-it/working-effectively-with-legacy-code.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/release-it/working-effectively-with-legacy-code.md`
