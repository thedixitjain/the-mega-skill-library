...
description: "Use as a compact always-on rule set for changing existing code under tight context."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "_rule-workbench/refactoring/nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/_rule-workbench/refactoring/nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `_rule-workbench/refactoring/nano.md`
