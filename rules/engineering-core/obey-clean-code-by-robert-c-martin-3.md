...
source_path: "clean-code/clean-code.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/clean-code/clean-code.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `clean-code/clean-code.nano.md`
