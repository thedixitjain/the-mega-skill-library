...
source_path: "refactoring/refactoring.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/refactoring/refactoring.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `refactoring/refactoring.mini.md`
