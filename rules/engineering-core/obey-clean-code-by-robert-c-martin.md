...
description: "This file defines mandatory working rules for this repository. Follow these instructions before making any code, test, refactor, review, or documentation change."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "clean-code/clean-code.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/clean-code/clean-code.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `clean-code/clean-code.md`
