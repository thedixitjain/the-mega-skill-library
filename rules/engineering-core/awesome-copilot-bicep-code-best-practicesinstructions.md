---
name: awesome-copilot-bicep-code-best-practicesinstructions
description: "Infrastructure as Code with Bicep"
category: engineering-core
source_repo: github/awesome-copilot
source_path: "instructions/bicep-code-best-practices.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/bicep-code-best-practices.instructions.md
---
## Naming Conventions
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/bicep-code-best-practices.instructions.md`
