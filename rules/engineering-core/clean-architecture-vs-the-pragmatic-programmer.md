---
name: clean-architecture-vs-the-pragmatic-programmer
description: "Status: reviewed Research basis: mini-only"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/clean-architecture/the-pragmatic-programmer.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/clean-architecture/the-pragmatic-programmer.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/clean-architecture/the-pragmatic-programmer.md`
