...
description: "Use when readability, local reasoning, and maintainable code shape are the main concerns, especially during everyday implementation and review."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "_rule-workbench/clean-code/mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/_rule-workbench/clean-code/mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `_rule-workbench/clean-code/mini.md`
