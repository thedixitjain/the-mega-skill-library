...
description: "Use when implementing, changing, reviewing, debugging, refactoring, or tuning production code where construction discipline must reduce defects and keep code easy to inspect."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "_rule-workbench/code-complete/mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/_rule-workbench/code-complete/mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `_rule-workbench/code-complete/mini.md`
