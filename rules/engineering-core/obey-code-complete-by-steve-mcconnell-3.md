...
source_path: "code-complete/code-complete.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/code-complete/code-complete.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `code-complete/code-complete.nano.md`
