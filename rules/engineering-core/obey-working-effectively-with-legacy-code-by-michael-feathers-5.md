...
source_path: "_rule-workbench/working-effectively-with-legacy-code/nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/_rule-workbench/working-effectively-with-legacy-code/nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `_rule-workbench/working-effectively-with-legacy-code/nano.md`
