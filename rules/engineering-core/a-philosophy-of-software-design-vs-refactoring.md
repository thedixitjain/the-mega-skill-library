---
name: a-philosophy-of-software-design-vs-refactoring
description: "Status: reviewed Research basis: mini-plus-external"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/a-philosophy-of-software-design/refactoring.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/a-philosophy-of-software-design/refactoring.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/a-philosophy-of-software-design/refactoring.md`
