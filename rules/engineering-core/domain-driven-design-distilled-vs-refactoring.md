---
name: domain-driven-design-distilled-vs-refactoring
description: "Status: reviewed Research basis: mini-only"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/domain-driven-design-distilled/refactoring.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/domain-driven-design-distilled/refactoring.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/domain-driven-design-distilled/refactoring.md`
