---
name: a-philosophy-of-software-design-vs-patterns-of-enterprise-applic
description: "Status: reviewed Research basis: mini-only"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/a-philosophy-of-software-design/patterns-of-enterprise-application-architecture.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/a-philosophy-of-software-design/patterns-of-enterprise-application-architecture.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/a-philosophy-of-software-design/patterns-of-enterprise-application-architecture.md`
