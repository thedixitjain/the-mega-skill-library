---
name: awesome-copilot-power-apps-code-appsinstructions
...
source_path: "instructions/power-apps-code-apps.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/power-apps-code-apps.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/power-apps-code-apps.instructions.md`
