---
name: patterns-of-enterprise-application-architecture-vs-working-effec
description: "Status: reviewed Research basis: mini-only"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/patterns-of-enterprise-application-architecture/working-effectively-with-legacy-code.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/patterns-of-enterprise-application-architecture/working-effectively-with-legacy-code.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/patterns-of-enterprise-application-architecture/working-effectively-with-legacy-code.md`
