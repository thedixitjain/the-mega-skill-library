---
name: awesome-copilot-dataverse-python-real-world-usecasesinstructions
description: "Based on official Dataverse data migration and integration patterns."
category: engineering-core
source_repo: github/awesome-copilot
source_path: "instructions/dataverse-python-real-world-usecases.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/dataverse-python-real-world-usecases.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/dataverse-python-real-world-usecases.instructions.md`
