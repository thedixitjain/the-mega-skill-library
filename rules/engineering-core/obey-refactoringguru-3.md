...
description: "Use as a compact always-on bias for safe, smell-driven refactoring during existing-code changes."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "refactoring-guru/refactoring-guru.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/refactoring-guru/refactoring-guru.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `refactoring-guru/refactoring-guru.nano.md`
