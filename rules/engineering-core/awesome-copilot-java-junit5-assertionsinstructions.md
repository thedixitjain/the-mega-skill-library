---
name: awesome-copilot-java-junit5-assertionsinstructions
...
source_path: "instructions/java-junit5-assertions.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/java-junit5-assertions.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/java-junit5-assertions.instructions.md`
