...
description: "Use as a compact always-on construction discipline for implementation, review, debugging, refactoring, and tuning."
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "_rule-workbench/code-complete/nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/_rule-workbench/code-complete/nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `_rule-workbench/code-complete/nano.md`
