---
name: refactoring-vs-refactoringguru
description: "Status: reviewed Research basis: mini-plus-external"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/refactoring/refactoring-guru.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/refactoring/refactoring-guru.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/refactoring/refactoring-guru.md`
