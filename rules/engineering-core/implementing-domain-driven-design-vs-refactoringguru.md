---
name: implementing-domain-driven-design-vs-refactoringguru
description: "Status: reviewed Research basis: mini-only"
category: engineering-core
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/implementing-domain-driven-design/refactoring-guru.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/implementing-domain-driven-design/refactoring-guru.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/implementing-domain-driven-design/refactoring-guru.md`
