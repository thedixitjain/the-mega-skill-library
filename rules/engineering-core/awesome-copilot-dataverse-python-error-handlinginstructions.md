---
name: awesome-copilot-dataverse-python-error-handlinginstructions
description: "Based on official Microsoft documentation for Azure SDK error handling patterns and Dataverse SDK specifics."
category: engineering-core
source_repo: github/awesome-copilot
source_path: "instructions/dataverse-python-error-handling.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/dataverse-python-error-handling.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/dataverse-python-error-handling.instructions.md`
