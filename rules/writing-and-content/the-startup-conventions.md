---
name: the-startup-conventions
description: "The definitive reference for skill structure. Apply when creating, converting, or auditing skills."
category: writing-and-content
source_repo: rsmdt/the-startup
source_path: "plugins/start/skills/writing-skills/reference/conventions.md"
source_url: https://github.com/rsmdt/the-startup/blob/HEAD/plugins/start/skills/writing-skills/reference/conventions.md
---
...
**Source:** [`rsmdt/the-startup`](https://github.com/rsmdt/the-startup) → `plugins/start/skills/writing-skills/reference/conventions.md`
