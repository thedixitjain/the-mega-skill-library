...
description: "When writing or editing game code in this directory, follow these standards."
category: writing-and-content
source_repo: Donchitos/Claude-Code-Game-Studios
source_path: "src/CLAUDE.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/src/CLAUDE.md
---
# Source Directory
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `src/CLAUDE.md`
