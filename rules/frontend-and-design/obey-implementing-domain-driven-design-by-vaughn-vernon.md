---
name: obey-implementing-domain-driven-design-by-vaughn-vernon
description: "This repository follows Implementing Domain-Driven Design in the practical style of Vaughn Vernon: apply DDD operationally, with explicit bounded contexts, disciplined aggregates, and implementation patterns that survive real systems."
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "implementing-domain-driven-design/implementing-domain-driven-design.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/implementing-domain-driven-design/implementing-domain-driven-design.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `implementing-domain-driven-design/implementing-domain-driven-design.md`
