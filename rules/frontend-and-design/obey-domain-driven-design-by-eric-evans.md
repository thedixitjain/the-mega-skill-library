...
description: "This repository follows Domain-Driven Design. All code generation, modification, and review must optimize for: - a precise model of the domain - a shared ubiquitous language - explicit bounded contexts - rich domain behavior where complexity exists - disciplined aggregate design - protection of invariants - clear separation between domain model and supporting infrastructure"
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "domain-driven-design/domain-driven-design.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/domain-driven-design/domain-driven-design.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `domain-driven-design/domain-driven-design.md`
