---
name: awesome-copilot-power-apps-canvas-yamlinstructions
...
source_path: "instructions/power-apps-canvas-yaml.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/power-apps-canvas-yaml.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/power-apps-canvas-yaml.instructions.md`
