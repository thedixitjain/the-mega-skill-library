---
name: agents-design
description: "Build a simple in-memory account management system for a trading simulation platform."
category: frontend-and-design
source_repo: ed-donner/agents
source_path: "3_crewai/reference/engineering_team/sandbox_claude/design.md"
source_url: https://github.com/ed-donner/agents/blob/HEAD/3_crewai/reference/engineering_team/sandbox_claude/design.md
---
...
**Source:** [`ed-donner/agents`](https://github.com/ed-donner/agents) → `3_crewai/reference/engineering_team/sandbox_claude/design.md`
