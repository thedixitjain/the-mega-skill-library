---
name: awesome-copilot-pcf-fluent-modern-theminginstructions
description: "Style components with modern theming using Fluent UI"
category: frontend-and-design
source_repo: github/awesome-copilot
source_path: "instructions/pcf-fluent-modern-theming.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/pcf-fluent-modern-theming.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/pcf-fluent-modern-theming.instructions.md`
