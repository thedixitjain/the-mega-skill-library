...
description: "Use as always-on DDD guidance when domain language, invariants, lifecycle, or integration boundaries affect implementation choices."
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "domain-driven-design/domain-driven-design.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/domain-driven-design/domain-driven-design.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `domain-driven-design/domain-driven-design.nano.md`
