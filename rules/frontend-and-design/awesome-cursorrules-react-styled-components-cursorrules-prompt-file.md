---
name: awesome-cursorrules-react-styled-components-cursorrules-prompt-f
description: "Cursor rules for React development with Styled Components integration."
category: frontend-and-design
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/react-styled-components-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/react-styled-components-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/react-styled-components-cursorrules-prompt-file.mdc`
