---
name: ag-ui-rules
description: "Full detail for every rule in ../SKILL.md: what to look for, the exceptions, and a BAD→GOOD example where one clarifies the rule. Severity legend: ❌ must fix · ⚠️ should fix · 💡 optional polish."
category: frontend-and-design
source_repo: ag-ui-protocol/ag-ui
source_path: ".github/skills/agui-dotnet-code-review/references/rules.md"
source_url: https://github.com/ag-ui-protocol/ag-ui/blob/HEAD/.github/skills/agui-dotnet-code-review/references/rules.md
---
...
**Source:** [`ag-ui-protocol/ag-ui`](https://github.com/ag-ui-protocol/ag-ui) → `.github/skills/agui-dotnet-code-review/references/rules.md`
