...
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/design/CLAUDE.md
---
# Design Directory
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `design/CLAUDE.md`
