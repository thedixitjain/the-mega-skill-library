---
name: taste-skill-llms
description: "taste-skill: The default design skill (v2 experimental). Read the brief, infer the design language, tune three dials (VARIANCE / MOTION / DENSITY), and ship landing pages, portfolios, and redesigns that do not look templated. Brief inference, design-system map, em-dash ban, GSAP code skeletons, hard-rules pre-flight check. Actively iterating toward v2.0.0 stable. taste-skill-v1: The original v1 of taste-skill, preserved for projects depending on its exact behavior. The current default is design-taste-frontend (v2 experimental)."
category: frontend-and-design
source_repo: Leonxlnx/taste-skill
source_path: "skills/llms.txt"
source_url: https://github.com/Leonxlnx/taste-skill/blob/HEAD/skills/llms.txt
---
...
**Source:** [`Leonxlnx/taste-skill`](https://github.com/Leonxlnx/taste-skill) → `skills/llms.txt`
