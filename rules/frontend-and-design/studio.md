...
source_path: "bold-template-pack/templates/studio/design.md"
source_url: https://github.com/zarazhangrui/frontend-slides/blob/HEAD/bold-template-pack/templates/studio/design.md
---
...
**Source:** [`zarazhangrui/frontend-slides`](https://github.com/zarazhangrui/frontend-slides) → `bold-template-pack/templates/studio/design.md`

**Also appears in:** `zarazhangrui/frontend-slides/plugins/frontend-slides/skills/frontend-slides/bold-template-pack/templates/studio/design.md`, `hashgraph-online/awesome-codex-plugins/plugins/beefiker/superloopy/skills/superloopy-slides/bold-template-pack/templates/studio/design.md`
