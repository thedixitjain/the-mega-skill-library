---
name: awesome-cursorrules-nextjs-typescript-tailwind-cursorrules-promp
description: "Cursor rules for Next.js development with TypeScript and Tailwind CSS integration."
category: frontend-and-design
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/nextjs-typescript-tailwind-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/nextjs-typescript-tailwind-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/nextjs-typescript-tailwind-cursorrules-prompt-file.mdc`
