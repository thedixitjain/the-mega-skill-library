...
description: "The platform currently operates as a single-tenant system. All users share one database schema, one set of API keys, and one billing account. The authentication system issues JWTs without tenant context. The admin dashboard displays aggregate metrics only."
category: frontend-and-design
source_repo: asklokesh/loki-mode
source_path: "examples/openspec/complex-feature/design.md"
source_url: https://github.com/asklokesh/loki-mode/blob/HEAD/examples/openspec/complex-feature/design.md
---
## Context
...
**Source:** [`asklokesh/loki-mode`](https://github.com/asklokesh/loki-mode) → `examples/openspec/complex-feature/design.md`
