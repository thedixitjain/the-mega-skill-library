---
name: awesome-cursorrules-tailwind-react-firebase-cursorrules-prompt-f
description: "Cursor rules for Tailwind development with React and Firebase integration."
category: frontend-and-design
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/tailwind-react-firebase-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/tailwind-react-firebase-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/tailwind-react-firebase-cursorrules-prompt-file.mdc`
