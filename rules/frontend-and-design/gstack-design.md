---
name: gstack-design
description: "- What this is: Community website for gstack — a CLI tool that turns Claude Code into a virtual engineering team - Who it's for: Developers discovering gstack, existing community members - Space/industry: Developer tools (peers: Linear, Raycast, Warp, Zed) - Project type: Community dashboard + marketing site"
category: frontend-and-design
source_repo: garrytan/gstack
source_path: "DESIGN.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/DESIGN.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `DESIGN.md`
