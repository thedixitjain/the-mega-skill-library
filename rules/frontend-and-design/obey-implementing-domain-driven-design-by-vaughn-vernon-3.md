...
description: "Use when tight context still needs DDD guardrails for context leakage, fake tactical patterns, Aggregate sprawl, and cross-context model coupling."
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "implementing-domain-driven-design/implementing-domain-driven-design.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/implementing-domain-driven-design/implementing-domain-driven-design.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `implementing-domain-driven-design/implementing-domain-driven-design.nano.md`
