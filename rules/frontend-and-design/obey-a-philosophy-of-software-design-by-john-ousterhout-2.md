...
description: "Use for module design, API changes, decomposition, refactoring, naming, comments, tests, performance work, and changes that feel awkward or spread complexity across files."
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "a-philosophy-of-software-design/a-philosophy-of-software-design.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/a-philosophy-of-software-design/a-philosophy-of-software-design.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `a-philosophy-of-software-design/a-philosophy-of-software-design.mini.md`
