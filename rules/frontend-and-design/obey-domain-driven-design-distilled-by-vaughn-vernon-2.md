---
name: obey-domain-driven-design-distilled-by-vaughn-vernon
description: "Use when business software has enough domain complexity, language ambiguity, strategic differentiation, or integration risk that modeling changes implementation decisions, but the project still needs the smallest effective DDD practice rather than ceremony."
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "domain-driven-design-distilled/domain-driven-design-distilled.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/domain-driven-design-distilled/domain-driven-design-distilled.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `domain-driven-design-distilled/domain-driven-design-distilled.mini.md`
