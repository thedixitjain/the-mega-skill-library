---
name: obey-domain-driven-design-by-eric-evans
description: "Use when business complexity, model language, lifecycle rules, or cross-team/system boundaries shape the design more than generic technical organization."
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "domain-driven-design/domain-driven-design.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/domain-driven-design/domain-driven-design.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `domain-driven-design/domain-driven-design.mini.md`
