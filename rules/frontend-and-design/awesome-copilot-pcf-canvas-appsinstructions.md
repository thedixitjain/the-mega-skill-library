---
name: awesome-copilot-pcf-canvas-appsinstructions
...
source_path: "instructions/pcf-canvas-apps.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/pcf-canvas-apps.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/pcf-canvas-apps.instructions.md`
