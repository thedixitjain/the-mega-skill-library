...
description: "Rules for applying frontend math foundations in production front-end work."
category: frontend-and-design
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/LVTD-LLC/skills/skills/frontend-math-foundations/references/math-foundations/rules.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/LVTD-LLC/skills/skills/frontend-math-foundations/references/math-foundations/rules.md
---
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/LVTD-LLC/skills/skills/frontend-math-foundations/references/math-foundations/rules.md`
