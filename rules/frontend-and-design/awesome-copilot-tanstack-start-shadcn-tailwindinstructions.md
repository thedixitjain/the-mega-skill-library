---
name: awesome-copilot-tanstack-start-shadcn-tailwindinstructions
description: "Guidelines for building TanStack Start applications"
category: frontend-and-design
source_repo: github/awesome-copilot
source_path: "instructions/tanstack-start-shadcn-tailwind.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/tanstack-start-shadcn-tailwind.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/tanstack-start-shadcn-tailwind.instructions.md`
