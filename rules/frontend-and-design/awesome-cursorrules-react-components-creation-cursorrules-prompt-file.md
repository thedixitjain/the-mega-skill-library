---
name: awesome-cursorrules-react-components-creation-cursorrules-prompt
description: "Cursor rules for React component creation and development."
category: frontend-and-design
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/react-components-creation-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/react-components-creation-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/react-components-creation-cursorrules-prompt-file.mdc`
