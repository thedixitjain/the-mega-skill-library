---
name: awesome-cursorrules-nextjs-tailwind-typescript-apps-cursorrules
description: "Cursor rules for Next.js development with Tailwind CSS and TypeScript integration."
category: frontend-and-design
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/nextjs-tailwind-typescript-apps-cursorrules-prompt.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/nextjs-tailwind-typescript-apps-cursorrules-prompt.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/nextjs-tailwind-typescript-apps-cursorrules-prompt.mdc`
