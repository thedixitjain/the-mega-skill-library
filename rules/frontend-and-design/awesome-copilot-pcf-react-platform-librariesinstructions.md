---
name: awesome-copilot-pcf-react-platform-librariesinstructions
description: "React controls and platform libraries for PCF components"
category: frontend-and-design
source_repo: github/awesome-copilot
source_path: "instructions/pcf-react-platform-libraries.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/pcf-react-platform-libraries.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/pcf-react-platform-libraries.instructions.md`
