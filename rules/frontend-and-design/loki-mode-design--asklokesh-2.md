...
description: "The application currently uses hardcoded color values in CSS stylesheets. There is no theming infrastructure. The settings page has three sections (Account, Notifications, Privacy) arranged in a vertical layout."
category: frontend-and-design
source_repo: asklokesh/loki-mode
source_path: "examples/openspec/standard-feature/design.md"
source_url: https://github.com/asklokesh/loki-mode/blob/HEAD/examples/openspec/standard-feature/design.md
---
## Context
...
**Source:** [`asklokesh/loki-mode`](https://github.com/asklokesh/loki-mode) → `examples/openspec/standard-feature/design.md`
