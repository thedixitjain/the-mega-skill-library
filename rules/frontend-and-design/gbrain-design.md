---
name: gbrain-design
description: "The design system source of truth for gbrain. Born from the de facto tokens that landed in admin/src/index.css during the v0.26.0 admin SPA work and formalized during the v0.36.1.0 Hindsight calibration wave's design review."
category: frontend-and-design
source_repo: garrytan/gbrain
source_path: "DESIGN.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/DESIGN.md
---
# DESIGN.md
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `DESIGN.md`
