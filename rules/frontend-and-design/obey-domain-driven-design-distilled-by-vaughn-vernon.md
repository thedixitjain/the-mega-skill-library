...
description: "This repository follows Domain-Driven Design Distilled: use the smallest effective set of DDD practices to model the business meaning clearly and deliver results quickly."
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "domain-driven-design-distilled/domain-driven-design-distilled.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/domain-driven-design-distilled/domain-driven-design-distilled.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `domain-driven-design-distilled/domain-driven-design-distilled.md`
