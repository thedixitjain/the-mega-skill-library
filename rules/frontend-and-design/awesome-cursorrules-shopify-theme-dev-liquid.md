---
name: awesome-cursorrules-shopify-theme-dev-liquid
description: "Best practices for Shopify theme development with Liquid, JavaScript, and CSS"
category: frontend-and-design
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/shopify-theme-dev-liquid.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/shopify-theme-dev-liquid.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/shopify-theme-dev-liquid.mdc`
