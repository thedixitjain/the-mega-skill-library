...
description: "Use when DDD implementation choices affect bounded contexts, language, aggregates, repositories, events, application services, package structure, or cross-context integration."
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "implementing-domain-driven-design/implementing-domain-driven-design.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/implementing-domain-driven-design/implementing-domain-driven-design.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `implementing-domain-driven-design/implementing-domain-driven-design.mini.md`
