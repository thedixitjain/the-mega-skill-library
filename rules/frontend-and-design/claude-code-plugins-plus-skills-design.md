---
name: claude-code-plugins-plus-skills-design
description: "Family: Data-Dense Pro (Bloomberg-terminal-for-AI-tools). Source: rohitg00/awesome-claude-design/design-md/data-dense/."
category: frontend-and-design
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "marketplace/DESIGN.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/marketplace/DESIGN.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `marketplace/DESIGN.md`
