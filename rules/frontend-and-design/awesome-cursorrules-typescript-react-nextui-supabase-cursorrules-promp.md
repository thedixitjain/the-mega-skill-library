---
name: awesome-cursorrules-typescript-react-nextui-supabase-cursorrules
description: "Cursor rules for TypeScript development with React, NextUI, and Supabase integration."
category: frontend-and-design
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/typescript-react-nextui-supabase-cursorrules-promp.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/typescript-react-nextui-supabase-cursorrules-promp.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/typescript-react-nextui-supabase-cursorrules-promp.mdc`
