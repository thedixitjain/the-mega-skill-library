---
name: caveman-claude
description: "README = product front door. Non-technical people read it to decide if caveman worth install. Treat like UI copy."
category: frontend-and-design
source_repo: JuliusBrussee/caveman
source_path: "CLAUDE.md"
source_url: https://github.com/JuliusBrussee/caveman/blob/HEAD/CLAUDE.md
---
# CLAUDE.md — caveman
...
**Source:** [`JuliusBrussee/caveman`](https://github.com/JuliusBrussee/caveman) → `CLAUDE.md`
