---
name: loki-mode-design
description: "The REST API (v2) has 80+ endpoints across 12 resource types. Mobile clients over-fetch by an average of 40% due to fixed response shapes. Three v1 endpoints remain deployed but have zero traffic. The client SDK is used by 15 internal services and 3 external partners."
category: frontend-and-design
source_repo: asklokesh/loki-mode
source_path: "examples/openspec/brownfield-delta/design.md"
source_url: https://github.com/asklokesh/loki-mode/blob/HEAD/examples/openspec/brownfield-delta/design.md
---
## Context
...
**Source:** [`asklokesh/loki-mode`](https://github.com/asklokesh/loki-mode) → `examples/openspec/brownfield-delta/design.md`
