---
name: awesome-cursorrules-react-mobx-cursorrules-prompt-file
description: "Cursor rules for React development with MobX integration."
category: frontend-and-design
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/react-mobx-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/react-mobx-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/react-mobx-cursorrules-prompt-file.mdc`
