...
description: "Use when the main risk is accidental complexity, shallow abstractions, leaky interfaces, or tactical patches."
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "a-philosophy-of-software-design/a-philosophy-of-software-design.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/a-philosophy-of-software-design/a-philosophy-of-software-design.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `a-philosophy-of-software-design/a-philosophy-of-software-design.nano.md`
