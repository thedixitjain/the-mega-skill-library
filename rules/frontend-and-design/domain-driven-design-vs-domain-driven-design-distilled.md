---
name: domain-driven-design-vs-domain-driven-design-distilled
description: "Status: reviewed Research basis: mini-plus-external"
category: frontend-and-design
source_repo: ciembor/agent-rules-books
source_path: "docs/compatibility/domain-driven-design/domain-driven-design-distilled.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/docs/compatibility/domain-driven-design/domain-driven-design-distilled.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `docs/compatibility/domain-driven-design/domain-driven-design-distilled.md`
