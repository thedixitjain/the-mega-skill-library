---
name: awesome-copilot-memory-bankinstructions
...
source_path: "instructions/memory-bank.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/memory-bank.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/memory-bank.instructions.md`
