---
name: ecc-gemini
description: "This file provides Gemini CLI with the baseline ECC workflow, review standards, and security checks for repositories that install the Gemini target."
category: security-and-compliance
source_repo: affaan-m/ECC
source_path: ".gemini/GEMINI.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.gemini/GEMINI.md
---
# ECC for Gemini CLI
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.gemini/GEMINI.md`
