---
name: awesome-cursorrules-kubestellar-console
description: "KubeStellar Console — Multi-cluster Kubernetes dashboard development rules"
category: devops-and-infra
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/kubestellar-console.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/kubestellar-console.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/kubestellar-console.mdc`
