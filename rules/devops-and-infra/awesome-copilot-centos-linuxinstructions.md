---
name: awesome-copilot-centos-linuxinstructions
...
source_path: "instructions/centos-linux.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/centos-linux.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/centos-linux.instructions.md`
