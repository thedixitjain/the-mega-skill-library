---
name: awesome-cursorrules-elixir-phoenix-docker-setup-cursorrules-prom
description: "Cursor rules for Elixir development with Phoenix and Docker integration."
category: devops-and-infra
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/elixir-phoenix-docker-setup-cursorrules-prompt-fil.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/elixir-phoenix-docker-setup-cursorrules-prompt-fil.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/elixir-phoenix-docker-setup-cursorrules-prompt-fil.mdc`
