---
name: awesome-copilot-debian-linuxinstructions
...
source_path: "instructions/debian-linux.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/debian-linux.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/debian-linux.instructions.md`
