---
name: awesome-cursorrules-docker
description: "Docker production rules. Pinned versions, multi-stage builds, non-root user, minimal attack surface."
category: devops-and-infra
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/docker.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/docker.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/docker.mdc`
