...
source_path: "release-it/release-it.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/release-it/release-it.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `release-it/release-it.mini.md`
