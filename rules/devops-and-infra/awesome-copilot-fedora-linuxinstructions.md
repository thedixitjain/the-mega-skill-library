---
name: awesome-copilot-fedora-linuxinstructions
...
source_path: "instructions/fedora-linux.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/fedora-linux.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/fedora-linux.instructions.md`
