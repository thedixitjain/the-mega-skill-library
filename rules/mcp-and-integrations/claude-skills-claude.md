...
description: "This guide covers the 9 production-ready project management skills, 15 Python automation tools, and bundled Atlassian Remote MCP integration (.mcp.json ships with the plugin — OAuth handled by Claude Code, no env vars required)."
category: mcp-and-integrations
source_repo: alirezarezvani/claude-skills
source_path: "project-management/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/project-management/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `project-management/CLAUDE.md`
