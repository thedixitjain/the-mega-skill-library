---
name: awesome-copilot-csharp-mcp-serverinstructions
...
source_path: "instructions/csharp-mcp-server.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/csharp-mcp-server.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/csharp-mcp-server.instructions.md`
