---
name: awesome-copilot-php-mcp-serverinstructions
...
source_path: "instructions/php-mcp-server.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/php-mcp-server.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/php-mcp-server.instructions.md`
