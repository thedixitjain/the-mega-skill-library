---
name: awesome-copilot-quarkus-mcp-server-sseinstructions
...
source_path: "instructions/quarkus-mcp-server-sse.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/quarkus-mcp-server-sse.instructions.md
---
# Quarkus MCP Server
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/quarkus-mcp-server-sse.instructions.md`
