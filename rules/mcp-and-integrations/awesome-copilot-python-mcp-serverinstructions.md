---
name: awesome-copilot-python-mcp-serverinstructions
...
source_path: "instructions/python-mcp-server.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/python-mcp-server.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/python-mcp-server.instructions.md`
