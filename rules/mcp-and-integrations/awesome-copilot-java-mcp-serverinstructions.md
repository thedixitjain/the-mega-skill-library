---
name: awesome-copilot-java-mcp-serverinstructions
...
source_path: "instructions/java-mcp-server.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/java-mcp-server.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/java-mcp-server.instructions.md`
