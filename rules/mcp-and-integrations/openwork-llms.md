---
name: openwork-llms
description: "- Chat with AI about local files — summarize, transform, organize, or generate new ones - Configure any model and provider that OpenCode supports, with the user's own API keys - Install skills to add capabilities and plugins for advanced features like scheduling or browser automation - Connect MCP servers to expose external tools to the agent - Ship reusable agent setups across a team, with guardrails and policy"
category: mcp-and-integrations
source_repo: different-ai/openwork
source_path: "ee/apps/landing/public/llms.txt"
source_url: https://github.com/different-ai/openwork/blob/HEAD/ee/apps/landing/public/llms.txt
---
# OpenWork
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `ee/apps/landing/public/llms.txt`
