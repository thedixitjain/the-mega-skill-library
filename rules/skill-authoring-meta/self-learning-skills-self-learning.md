---
name: self-learning-skills-self-learning
...
source_path: ".cursor/rules/self-learning.mdc"
source_url: https://github.com/Kulaxyz/self-learning-skills/blob/HEAD/.cursor/rules/self-learning.mdc
---
...
1. **A passing check** — the path was actually verified (test passed, clean exit,
   green build, reproduced repro). "Seemed to work" doesn't count.
...
**Source:** [`Kulaxyz/self-learning-skills`](https://github.com/Kulaxyz/self-learning-skills) → `.cursor/rules/self-learning.mdc`
