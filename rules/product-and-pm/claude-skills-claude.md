...
description: "This guide covers the 17 production-ready product management skills (13 bundled incl. the orchestrator + 4 standalone plugins) and their Python automation tools."
category: product-and-pm
source_repo: alirezarezvani/claude-skills
source_path: "product-team/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/product-team/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `product-team/CLAUDE.md`
