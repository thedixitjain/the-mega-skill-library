---
name: awesome-cursorrules-python-fastapi-scalable-api-cursorrules-prom
description: "Cursor rules for Python FastAPI development with scalable API integration."
category: backend-and-data
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/python-fastapi-scalable-api-cursorrules-prompt-fil.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/python-fastapi-scalable-api-cursorrules-prompt-fil.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/python-fastapi-scalable-api-cursorrules-prompt-fil.mdc`
