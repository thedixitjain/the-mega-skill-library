...
description: "Use when data correctness, durability, or distributed write semantics matter more than local code style."
category: backend-and-data
source_repo: ciembor/agent-rules-books
source_path: "designing-data-intensive-applications/designing-data-intensive-applications.nano.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/designing-data-intensive-applications/designing-data-intensive-applications.nano.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `designing-data-intensive-applications/designing-data-intensive-applications.nano.md`
