---
name: awesome-copilot-ms-sql-dbainstructions
...
source_path: "instructions/ms-sql-dba.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/ms-sql-dba.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/ms-sql-dba.instructions.md`
