---
name: awesome-cursorrules-node-express
description: "Node.js and Express.js best practices for backend development"
category: backend-and-data
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/node-express.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/node-express.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/node-express.mdc`
