---
name: awesome-copilot-sql-sp-generationinstructions
description: "Guidelines for generating SQL statements and stored procedures"
category: backend-and-data
source_repo: github/awesome-copilot
source_path: "instructions/sql-sp-generation.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/sql-sp-generation.instructions.md
---
# SQL Development
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/sql-sp-generation.instructions.md`
