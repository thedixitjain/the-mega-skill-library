---
name: obey-designing-data-intensive-applications-by-martin-kleppmann
description: "This repository follows Designing Data-Intensive Applications in the sense of Martin Kleppmann: design systems around explicit trade-offs in reliability, scalability, maintainability, consistency, and data flow."
category: backend-and-data
source_repo: ciembor/agent-rules-books
source_path: "designing-data-intensive-applications/designing-data-intensive-applications.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/designing-data-intensive-applications/designing-data-intensive-applications.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `designing-data-intensive-applications/designing-data-intensive-applications.md`
