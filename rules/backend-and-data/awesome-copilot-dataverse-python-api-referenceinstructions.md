---
name: awesome-copilot-dataverse-python-api-referenceinstructions
description: "Main client for interacting with Dataverse. Initialize with base URL and Azure credentials."
category: backend-and-data
source_repo: github/awesome-copilot
source_path: "instructions/dataverse-python-api-reference.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/dataverse-python-api-reference.instructions.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/dataverse-python-api-reference.instructions.md`
