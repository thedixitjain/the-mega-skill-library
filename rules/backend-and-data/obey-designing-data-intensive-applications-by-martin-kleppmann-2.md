...
description: "Use for systems where correctness depends on data ownership, consistency, durability, replication, partitioning, schema evolution, event flow, replay, or derived-data maintenance."
category: backend-and-data
source_repo: ciembor/agent-rules-books
source_path: "designing-data-intensive-applications/designing-data-intensive-applications.mini.md"
source_url: https://github.com/ciembor/agent-rules-books/blob/HEAD/designing-data-intensive-applications/designing-data-intensive-applications.mini.md
---
...
**Source:** [`ciembor/agent-rules-books`](https://github.com/ciembor/agent-rules-books) → `designing-data-intensive-applications/designing-data-intensive-applications.mini.md`
