...
source_path: "packages/happy-server/CLAUDE.md"
source_url: https://github.com/slopus/happy/blob/HEAD/packages/happy-server/CLAUDE.md
---
...
**Source:** [`slopus/happy`](https://github.com/slopus/happy) → `packages/happy-server/CLAUDE.md`
