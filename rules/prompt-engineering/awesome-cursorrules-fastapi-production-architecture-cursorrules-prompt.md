---
name: awesome-cursorrules-fastapi-production-architecture-cursorrules
...
source_path: "rules/fastapi-production-architecture-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/fastapi-production-architecture-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/fastapi-production-architecture-cursorrules-prompt-file.mdc`
