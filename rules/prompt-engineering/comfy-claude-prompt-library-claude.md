---
name: comfy-claude-prompt-library-claude
description: "CRITICAL: At the START of any new task (not during execution), you MUST go through this checklist: - [ ] Does this task involve reading/analyzing more than 10 files/webpages? → Follow the process in ~/.claude/commands/utilities/estimate-context-window.md - [ ] Does the request mention \"all\", \"every\", \"entire codebase\", or \"whole project\"? → Follow the process in ~/.claude/commands/utilities/estimate-context-window.md"
category: prompt-engineering
source_repo: Comfy-Org/comfy-claude-prompt-library
source_path: "CLAUDE.md"
source_url: https://github.com/Comfy-Org/comfy-claude-prompt-library/blob/HEAD/CLAUDE.md
---
...
**Source:** [`Comfy-Org/comfy-claude-prompt-library`](https://github.com/Comfy-Org/comfy-claude-prompt-library) → `CLAUDE.md`
