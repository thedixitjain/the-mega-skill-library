---
name: awesome-cursorrules-python-fastapi-best-practices-cursorrules-pr
description: "Cursor rules for Python FastAPI development with best practices."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/python-fastapi-best-practices-cursorrules-prompt-f.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/python-fastapi-best-practices-cursorrules-prompt-f.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/python-fastapi-best-practices-cursorrules-prompt-f.mdc`
