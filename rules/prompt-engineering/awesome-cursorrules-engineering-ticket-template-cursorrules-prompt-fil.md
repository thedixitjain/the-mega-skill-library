---
name: awesome-cursorrules-engineering-ticket-template-cursorrules-prom
description: "Cursor rules for engineering development with ticket template integration."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/engineering-ticket-template-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/engineering-ticket-template-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/engineering-ticket-template-cursorrules-prompt-file.mdc`
