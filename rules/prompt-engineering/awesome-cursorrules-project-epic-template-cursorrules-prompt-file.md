---
name: awesome-cursorrules-project-epic-template-cursorrules-prompt-fil
description: "Cursor rules for project development with epic template integration."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/project-epic-template-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/project-epic-template-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/project-epic-template-cursorrules-prompt-file.mdc`
