---
name: awesome-cursorrules-typescript-nodejs-nextjs-app-cursorrules-pro
description: "Cursor rules for TypeScript development with Node.js and Next.js app integration."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/typescript-nodejs-nextjs-app-cursorrules-prompt-fi.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/typescript-nodejs-nextjs-app-cursorrules-prompt-fi.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/typescript-nodejs-nextjs-app-cursorrules-prompt-fi.mdc`
