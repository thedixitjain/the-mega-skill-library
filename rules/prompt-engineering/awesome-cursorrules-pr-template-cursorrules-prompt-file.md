---
name: awesome-cursorrules-pr-template-cursorrules-prompt-file
description: "Cursor rules for PR development with template integration."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/pr-template-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/pr-template-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/pr-template-cursorrules-prompt-file.mdc`
