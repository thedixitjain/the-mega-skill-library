---
name: awesome-copilot-exclude-prompt-datainstructions
...
source_path: "instructions/exclude-prompt-data.instructions.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/instructions/exclude-prompt-data.instructions.md
---
# Exclude Prompt Data
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `instructions/exclude-prompt-data.instructions.md`
