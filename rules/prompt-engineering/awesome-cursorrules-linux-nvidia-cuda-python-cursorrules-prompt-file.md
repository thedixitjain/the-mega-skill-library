---
name: awesome-cursorrules-linux-nvidia-cuda-python-cursorrules-prompt
description: "Cursor rules for Linux development with NVIDIA CUDA and Python integration."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/linux-nvidia-cuda-python-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/linux-nvidia-cuda-python-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/linux-nvidia-cuda-python-cursorrules-prompt-file.mdc`
