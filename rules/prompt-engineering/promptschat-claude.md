---
name: promptschat-claude
description: "prompts.chat is a social platform for AI prompts built with Next.js 16 App Router, React 19, TypeScript, and PostgreSQL/Prisma. It allows users to share, discover, and collect prompts."
category: prompt-engineering
source_repo: f/prompts.chat
source_path: "CLAUDE.md"
source_url: https://github.com/f/prompts.chat/blob/HEAD/CLAUDE.md
---
# CLAUDE.md
...
**Source:** [`f/prompts.chat`](https://github.com/f/prompts.chat) → `CLAUDE.md`
