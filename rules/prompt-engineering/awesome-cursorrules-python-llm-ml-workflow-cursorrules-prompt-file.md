---
name: awesome-cursorrules-python-llm-ml-workflow-cursorrules-prompt-fi
description: "Cursor rules for Python LLM & ML development with workflow integration."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/python-llm-ml-workflow-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/python-llm-ml-workflow-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/python-llm-ml-workflow-cursorrules-prompt-file.mdc`
