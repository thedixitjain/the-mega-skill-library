---
name: awesome-cursorrules-tauri-svelte-typescript-guide-cursorrules-pr
description: "Cursor rules for Tauri development with Svelte and TypeScript guide integration."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/tauri-svelte-typescript-guide-cursorrules-prompt-f.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/tauri-svelte-typescript-guide-cursorrules-prompt-f.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/tauri-svelte-typescript-guide-cursorrules-prompt-f.mdc`
