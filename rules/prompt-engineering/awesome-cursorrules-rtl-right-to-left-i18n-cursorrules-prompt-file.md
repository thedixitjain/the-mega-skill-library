---
name: awesome-cursorrules-rtl-right-to-left-i18n-cursorrules-prompt-fi
...
source_path: "rules/rtl-right-to-left-i18n-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/rtl-right-to-left-i18n-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/rtl-right-to-left-i18n-cursorrules-prompt-file.mdc`
