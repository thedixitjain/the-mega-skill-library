---
name: awesome-cursorrules-manifest-yaml-cursorrules-prompt-file
description: "Cursor rules for manifest development with YAML integration."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/manifest-yaml-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/manifest-yaml-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/manifest-yaml-cursorrules-prompt-file.mdc`
