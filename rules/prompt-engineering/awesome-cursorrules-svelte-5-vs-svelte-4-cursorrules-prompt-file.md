---
name: awesome-cursorrules-svelte-5-vs-svelte-4-cursorrules-prompt-file
description: "Cursor rules for comparing Svelte 5 and Svelte 4 development."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/svelte-5-vs-svelte-4-cursorrules-prompt-file.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/svelte-5-vs-svelte-4-cursorrules-prompt-file.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/svelte-5-vs-svelte-4-cursorrules-prompt-file.mdc`
