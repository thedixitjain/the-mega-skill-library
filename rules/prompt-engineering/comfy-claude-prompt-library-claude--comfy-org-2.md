...
source_path: ".claude/knowledge/node-editor-performance-optimizations/CLAUDE.md"
source_url: https://github.com/Comfy-Org/comfy-claude-prompt-library/blob/HEAD/.claude/knowledge/node-editor-performance-optimizations/CLAUDE.md
---
...
**Source:** [`Comfy-Org/comfy-claude-prompt-library`](https://github.com/Comfy-Org/comfy-claude-prompt-library) → `.claude/knowledge/node-editor-performance-optimizations/CLAUDE.md`
