---
name: awesome-cursorrules-optimize-rell-blockchain-code-cursorrules-pr
description: "Cursor rules for optimization development with Rell Blockchain code integration."
category: prompt-engineering
source_repo: PatrickJS/awesome-cursorrules
source_path: "rules/optimize-rell-blockchain-code-cursorrules-prompt-f.mdc"
source_url: https://github.com/PatrickJS/awesome-cursorrules/blob/HEAD/rules/optimize-rell-blockchain-code-cursorrules-prompt-f.mdc
---
...
**Source:** [`PatrickJS/awesome-cursorrules`](https://github.com/PatrickJS/awesome-cursorrules) → `rules/optimize-rell-blockchain-code-cursorrules-prompt-f.mdc`
