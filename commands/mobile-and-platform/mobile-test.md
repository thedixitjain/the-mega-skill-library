...
source_path: "plugins/testing/mobile-app-tester/commands/mobile-test.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/mobile-app-tester/commands/mobile-test.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/mobile-app-tester/commands/mobile-test.md`
