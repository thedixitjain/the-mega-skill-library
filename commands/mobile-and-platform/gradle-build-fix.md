...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/gradle-build.md
---
# Gradle Build Fix
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/gradle-build.md`
