...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/resume-session.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/resume-session.md`
