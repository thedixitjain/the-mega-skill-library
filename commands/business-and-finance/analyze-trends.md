...
source_path: "plugins/crypto/market-price-tracker/commands/analyze-trends.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/market-price-tracker/commands/analyze-trends.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/market-price-tracker/commands/analyze-trends.md`
