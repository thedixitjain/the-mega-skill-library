...
source_path: "skills/.curated/backtesting-trading-strategies/commands/walk-forward.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/backtesting-trading-strategies/commands/walk-forward.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/backtesting-trading-strategies/commands/walk-forward.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/crypto/trading-strategy-backtester/skills/backtesting-trading-strategies/commands/walk-forward.md`
