...
source_path: "plugins/crypto/liquidity-pool-analyzer/commands/analyze-pool.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/liquidity-pool-analyzer/commands/analyze-pool.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/liquidity-pool-analyzer/commands/analyze-pool.md`
