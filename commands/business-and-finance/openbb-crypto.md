...
source_path: "plugins/business-tools/openbb-terminal/commands/openbb-crypto.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/business-tools/openbb-terminal/commands/openbb-crypto.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/business-tools/openbb-terminal/commands/openbb-crypto.md`
