...
source_path: "plugins/crypto/options-flow-analyzer/commands/analyze-flow.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/options-flow-analyzer/commands/analyze-flow.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/options-flow-analyzer/commands/analyze-flow.md`
