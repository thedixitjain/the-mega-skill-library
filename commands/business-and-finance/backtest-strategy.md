...
source_path: "plugins/crypto/trading-strategy-backtester/commands/backtest-strategy.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/trading-strategy-backtester/commands/backtest-strategy.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/trading-strategy-backtester/commands/backtest-strategy.md`
