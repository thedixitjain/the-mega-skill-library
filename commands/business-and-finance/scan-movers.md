...
source_path: "plugins/crypto/market-movers-scanner/commands/scan-movers.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/market-movers-scanner/commands/scan-movers.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/market-movers-scanner/commands/scan-movers.md`
