...
source_path: "plugins/crypto/nft-rarity-analyzer/commands/analyze-nft.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/nft-rarity-analyzer/commands/analyze-nft.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/nft-rarity-analyzer/commands/analyze-nft.md`
