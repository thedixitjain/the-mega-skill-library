...
source_path: "plugins/crypto/staking-rewards-optimizer/commands/optimize-staking.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/staking-rewards-optimizer/commands/optimize-staking.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/staking-rewards-optimizer/commands/optimize-staking.md`
