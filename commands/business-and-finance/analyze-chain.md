...
source_path: "plugins/crypto/on-chain-analytics/commands/analyze-chain.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/on-chain-analytics/commands/analyze-chain.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/on-chain-analytics/commands/analyze-chain.md`
