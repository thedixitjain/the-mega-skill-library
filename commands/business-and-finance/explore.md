...
source_path: "plugins/crypto/blockchain-explorer-cli/commands/explore.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/blockchain-explorer-cli/commands/explore.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/blockchain-explorer-cli/commands/explore.md`
