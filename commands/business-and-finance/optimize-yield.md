...
source_path: "plugins/crypto/defi-yield-optimizer/commands/optimize-yield.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/defi-yield-optimizer/commands/optimize-yield.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/defi-yield-optimizer/commands/optimize-yield.md`
