...
source_path: "plugins/crypto/dex-aggregator-router/commands/find-best-route.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/dex-aggregator-router/commands/find-best-route.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/dex-aggregator-router/commands/find-best-route.md`
