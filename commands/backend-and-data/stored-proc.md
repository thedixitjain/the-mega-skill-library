...
source_path: "plugins/database/stored-procedure-generator/commands/stored-proc.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/database/stored-procedure-generator/commands/stored-proc.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/database/stored-procedure-generator/commands/stored-proc.md`
