...
source_path: "plugins/api-development/webhook-handler-creator/commands/create-webhook-handler.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/api-development/webhook-handler-creator/commands/create-webhook-handler.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/api-development/webhook-handler-creator/commands/create-webhook-handler.md`
