...
source_path: "plugins/database/database-health-monitor/commands/health-check.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/database/database-health-monitor/commands/health-check.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/database/database-health-monitor/commands/health-check.md`
