---
name: optimize-query-optimize-sql-query
description: "Analyze and optimize a slow SQL query for better performance."
category: backend-and-data
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/query-optimizer/commands/optimize-query.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/query-optimizer/commands/optimize-query.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/query-optimizer/commands/optimize-query.md`
