---
name: design-schema-design-database-schema
description: "Design a database schema based on application requirements."
category: backend-and-data
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/schema-designer/commands/design-schema.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/schema-designer/commands/design-schema.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/schema-designer/commands/design-schema.md`
