---
name: anti-patterns-backend-engineering
description: "These approaches look like reasonable backend code but consistently lead to outages, data corruption, and unmaintainable systems."
category: backend-and-data
source_repo: vibeforge1111/vibeship-spawner-skills
source_path: "backend/backend/anti-patterns.md"
source_url: https://github.com/vibeforge1111/vibeship-spawner-skills/blob/HEAD/backend/backend/anti-patterns.md
---
...
**Source:** [`vibeforge1111/vibeship-spawner-skills`](https://github.com/vibeforge1111/vibeship-spawner-skills) → `backend/backend/anti-patterns.md`
