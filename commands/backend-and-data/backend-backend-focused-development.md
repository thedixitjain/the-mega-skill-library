---
name: backend-backend-focused-development
...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/multi-backend.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/multi-backend.md`
