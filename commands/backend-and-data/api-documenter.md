---
name: api-documenter
description: "Please help me document all APIs in this codebase systematically:"
category: backend-and-data
source_repo: cassler/awesome-claude-code-setup
source_path: "commands/api-documenter.md"
source_url: https://github.com/cassler/awesome-claude-code-setup/blob/HEAD/commands/api-documenter.md
---
# API Documenter
...
**Source:** [`cassler/awesome-claude-code-setup`](https://github.com/cassler/awesome-claude-code-setup) → `commands/api-documenter.md`
