---
name: sharp-edges-backend-engineering
description: "These are the backend mistakes that cause outages, data corruption, and 3am pages. Each edge represents real incidents, lost data, and careers changed by \"it worked in dev.\""
category: backend-and-data
source_repo: vibeforge1111/vibeship-spawner-skills
source_path: "backend/backend/sharp-edges.md"
source_url: https://github.com/vibeforge1111/vibeship-spawner-skills/blob/HEAD/backend/backend/sharp-edges.md
---
...
**Source:** [`vibeforge1111/vibeship-spawner-skills`](https://github.com/vibeforge1111/vibeship-spawner-skills) → `backend/backend/sharp-edges.md`
