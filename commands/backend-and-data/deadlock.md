...
source_path: "plugins/database/database-deadlock-detector/commands/deadlock.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/database/database-deadlock-detector/commands/deadlock.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/database/database-deadlock-detector/commands/deadlock.md`
