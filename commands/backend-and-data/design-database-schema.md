...
source_path: "plugins/all-commands/commands/design-database-schema.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/design-database-schema.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/design-database-schema.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-database-operations/commands/design-database-schema.md`
