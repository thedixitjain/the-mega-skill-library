---
name: generate-erd-generate-entity-relationship-diagram
description: "Generate a visual ERD from the existing database schema."
category: backend-and-data
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/schema-designer/commands/generate-erd.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/schema-designer/commands/generate-erd.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/schema-designer/commands/generate-erd.md`
