---
name: explain-plan-explain-query-execution-plan
description: "Generate and interpret a SQL query execution plan in plain language."
category: backend-and-data
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/query-optimizer/commands/explain-plan.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/query-optimizer/commands/explain-plan.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/query-optimizer/commands/explain-plan.md`
