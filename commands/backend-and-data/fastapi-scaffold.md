...
source_path: "plugins/packages/fullstack-starter-pack/commands/fastapi-scaffold.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/packages/fullstack-starter-pack/commands/fastapi-scaffold.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/packages/fullstack-starter-pack/commands/fastapi-scaffold.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/packages/fullstack-starter-pack/plugins/02-backend/commands/fastapi-scaffold.md`
