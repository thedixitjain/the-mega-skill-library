...
source_path: "plugins/database/database-schema-designer/commands/design-schema.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/database/database-schema-designer/commands/design-schema.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/database/database-schema-designer/commands/design-schema.md`
