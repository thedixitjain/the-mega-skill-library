---
name: generate-api-ref-generate-api-reference
description: "Generate API reference documentation from source code and route definitions."
category: backend-and-data
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/api-reference/commands/generate-api-ref.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/api-reference/commands/generate-api-ref.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/api-reference/commands/generate-api-ref.md`
