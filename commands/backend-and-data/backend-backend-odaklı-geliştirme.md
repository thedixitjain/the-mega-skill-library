---
name: backend-backend-odaklı-geliştirme
description: "Backend odaklı iş akışı (Research → Ideation → Plan → Execute → Optimize → Review), Codex liderliğinde."
category: backend-and-data
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/multi-backend.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/multi-backend.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/multi-backend.md`
