---
name: benchmark-benchmark-api-endpoints
description: "Run performance benchmarks against API endpoints."
category: backend-and-data
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/api-benchmarker/commands/benchmark.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/api-benchmarker/commands/benchmark.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/api-benchmarker/commands/benchmark.md`
