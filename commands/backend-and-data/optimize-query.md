...
source_path: "plugins/database/sql-query-optimizer/commands/optimize-query.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/database/sql-query-optimizer/commands/optimize-query.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/database/sql-query-optimizer/commands/optimize-query.md`
