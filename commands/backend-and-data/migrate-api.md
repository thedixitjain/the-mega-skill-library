...
source_path: "plugins/api-development/api-migration-tool/commands/migrate-api.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/api-development/api-migration-tool/commands/migrate-api.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/api-development/api-migration-tool/commands/migrate-api.md`
