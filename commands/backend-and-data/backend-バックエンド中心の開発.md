---
name: backend-バックエンド中心の開発
description: "バックエンド中心のワークフロー(調査 → アイデア創出 → 計画 → 実装 → 最適化 → レビュー)、Codex主導。"
category: backend-and-data
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/commands/multi-backend.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/multi-backend.md
---
# Backend - バックエンド中心の開発
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/multi-backend.md`
