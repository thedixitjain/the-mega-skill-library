---
name: patterns-backend-engineering
description: "These are the proven approaches that consistently deliver reliable, scalable, and maintainable backend systems."
category: backend-and-data
source_repo: vibeforge1111/vibeship-spawner-skills
source_path: "backend/backend/patterns.md"
source_url: https://github.com/vibeforge1111/vibeship-spawner-skills/blob/HEAD/backend/backend/patterns.md
---
...
**Source:** [`vibeforge1111/vibeship-spawner-skills`](https://github.com/vibeforge1111/vibeship-spawner-skills) → `backend/backend/patterns.md`
