...
source_path: "plugins/api-development/websocket-server-builder/commands/build-websocket-server.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/api-development/websocket-server-builder/commands/build-websocket-server.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/api-development/websocket-server-builder/commands/build-websocket-server.md`
