---
name: api-architectdesign-api
description: "Design a RESTful or GraphQL API based on the project's domain model and requirements."
category: backend-and-data
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/api-architect/commands/design-api.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/api-architect/commands/design-api.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/api-architect/commands/design-api.md`
