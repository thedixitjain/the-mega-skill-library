...
source_path: "plugins/api-development/api-gateway-builder/commands/build-api-gateway.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/api-development/api-gateway-builder/commands/build-api-gateway.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/api-development/api-gateway-builder/commands/build-api-gateway.md`
