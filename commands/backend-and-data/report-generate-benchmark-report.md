---
name: report-generate-benchmark-report
description: "Generate a comprehensive performance report from benchmark results."
category: backend-and-data
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/api-benchmarker/commands/report.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/api-benchmarker/commands/report.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/api-benchmarker/commands/report.md`
