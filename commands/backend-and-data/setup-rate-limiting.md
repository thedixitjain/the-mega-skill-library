...
source_path: "plugins/all-commands/commands/setup-rate-limiting.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/setup-rate-limiting.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/setup-rate-limiting.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-setup/commands/setup-rate-limiting.md`
