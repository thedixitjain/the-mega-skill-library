...
source_path: "plugins/api-development/graphql-server-builder/commands/build-graphql-server.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/api-development/graphql-server-builder/commands/build-graphql-server.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/api-development/graphql-server-builder/commands/build-graphql-server.md`
