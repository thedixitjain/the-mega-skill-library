...
source_path: ".claude/commands/workflows/research.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/workflows/research.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/workflows/research.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/workflows/research.md`
