...
source_url: https://github.com/nimbalyst/product-manager-claude-code-commands/blob/HEAD/research.md
---
...
**Source:** [`nimbalyst/product-manager-claude-code-commands`](https://github.com/nimbalyst/product-manager-claude-code-commands) → `research.md`
