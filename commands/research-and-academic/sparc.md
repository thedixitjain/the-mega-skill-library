...
source_path: ".claude/commands/sparc.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/sparc.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/sparc.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/sparc.md`
