---
name: runapi-setup
description: ">- Guide the user through RunAPI API key setup for Claude Code and other MCP hosts."
category: mcp-and-integrations
source_repo: wshobson/agents
source_path: "plugins/runapi-mcp/commands/setup.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/runapi-mcp/commands/setup.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/runapi-mcp/commands/setup.md`
