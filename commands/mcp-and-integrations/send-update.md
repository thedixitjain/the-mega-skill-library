...
source_path: "plugins/slack-notifier/commands/send-update.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/slack-notifier/commands/send-update.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/slack-notifier/commands/send-update.md`
