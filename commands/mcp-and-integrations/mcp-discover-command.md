---
name: mcp-discover-command
description: "This command discovers, evaluates, and installs Model Context Protocol servers to extend Claude's capabilities."
category: mcp-and-integrations
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/09-agentic-capabilities/mcp-discover.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/09-agentic-capabilities/mcp-discover.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/09-agentic-capabilities/mcp-discover.md`
