---
name: mcp-configure-advanced-mcp-server-configuration-and-management
description: "/mcp-configure [action] [server] [parameters]"
category: mcp-and-integrations
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/09-agentic-capabilities/mcp-configure.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/09-agentic-capabilities/mcp-configure.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/09-agentic-capabilities/mcp-configure.md`
