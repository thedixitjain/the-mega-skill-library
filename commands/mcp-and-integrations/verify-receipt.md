...
source_path: "plugins/protect-mcp/commands/verify-receipt.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/protect-mcp/commands/verify-receipt.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/protect-mcp/commands/verify-receipt.md`
