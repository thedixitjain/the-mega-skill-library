---
name: quick-generate
description: ">- Quick RunAPI generation. Use when the user runs /runapi:gen with a prompt and wants to skip broad exploration."
category: mcp-and-integrations
source_repo: wshobson/agents
source_path: "plugins/runapi-mcp/commands/gen.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/runapi-mcp/commands/gen.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/runapi-mcp/commands/gen.md`
