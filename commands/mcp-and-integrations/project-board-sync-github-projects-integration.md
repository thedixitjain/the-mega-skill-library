...
source_path: ".claude/commands/github/project-board-sync.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/github/project-board-sync.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/github/project-board-sync.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/github/project-board-sync.md`, `ruvnet/ruflo/.claude/commands/github/project-board-sync.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/github/project-board-sync.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/github/project-board-sync.md`
