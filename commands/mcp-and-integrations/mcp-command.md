---
name: mcp-command
description: "This command provides access to MCP (Model Context Protocol) server configuration and testing prompts."
category: mcp-and-integrations
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/01-project-setup/mcp.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/01-project-setup/mcp.md
---
# MCP Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/01-project-setup/mcp.md`
