---
name: mcp-extend-custom-mcp-server-development-and-extension
...
source_path: ".claude/commands/09-agentic-capabilities/mcp-extend.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/09-agentic-capabilities/mcp-extend.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/09-agentic-capabilities/mcp-extend.md`
