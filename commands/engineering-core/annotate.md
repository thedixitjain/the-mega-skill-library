---
name: annotate
description: "Add inline documentation (JSDoc, docstrings, comments) to under-documented code."
category: engineering-core
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/code-explainer/commands/annotate.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/code-explainer/commands/annotate.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/code-explainer/commands/annotate.md`
