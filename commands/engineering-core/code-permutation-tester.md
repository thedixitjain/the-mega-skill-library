...
source_path: "plugins/all-commands/commands/code-permutation-tester.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/code-permutation-tester.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/code-permutation-tester.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-utilities-debugging/commands/code-permutation-tester.md`
