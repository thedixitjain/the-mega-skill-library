---
name: todo-implementation-program-no-worktrees
...
source_path: "todo-branch.md"
source_url: https://github.com/badlogic/claude-commands/blob/HEAD/todo-branch.md
---
...
**Source:** [`badlogic/claude-commands`](https://github.com/badlogic/claude-commands) → `todo-branch.md`
