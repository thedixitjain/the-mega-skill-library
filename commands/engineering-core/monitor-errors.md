...
source_path: "plugins/performance/error-rate-monitor/commands/monitor-errors.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/performance/error-rate-monitor/commands/monitor-errors.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/performance/error-rate-monitor/commands/monitor-errors.md`
