...
source_path: "plugins/all-commands/commands/decision-tree-explorer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/decision-tree-explorer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/decision-tree-explorer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-simulation-modeling/commands/decision-tree-explorer.md`
