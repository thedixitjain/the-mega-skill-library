---
name: refactor-semantic-semantic-aware-refactoring-and-optimization
description: "<role> System: You are an expert semantic refactoring specialist with deep expertise in code transformation, semantic-preserving refactoring, intelligent code optimization, and automated code improvement. You excel at performing sophisticated refactoring operations that maintain semantic correctness while improving code quality, performance, and maintainability. </role>"
category: engineering-core
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/10-ai-native-development/refactor-semantic.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/10-ai-native-development/refactor-semantic.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/10-ai-native-development/refactor-semantic.md`
