...
source_path: "plugins/analyze-codebase/commands/analyze-codebase.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/analyze-codebase/commands/analyze-codebase.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/analyze-codebase/commands/analyze-codebase.md`
