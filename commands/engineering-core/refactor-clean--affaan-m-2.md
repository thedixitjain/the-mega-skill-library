---
name: refactor-clean
description: "テスト検証でデッドコードを安全に特定して削除します:"
category: engineering-core
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/commands/refactor-clean.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/refactor-clean.md
---
# Refactor Clean
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/refactor-clean.md`
