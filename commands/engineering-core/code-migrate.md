...
source_path: "plugins/migrate-tool/commands/code-migrate.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/migrate-tool/commands/code-migrate.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/migrate-tool/commands/code-migrate.md`
