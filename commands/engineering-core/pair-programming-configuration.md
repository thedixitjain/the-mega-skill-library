---
name: pair-programming-configuration
description: "Complete configuration guide for pair programming sessions."
category: engineering-core
source_repo: ruvnet/ruflo
source_path: ".claude/commands/pair/config.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/pair/config.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/pair/config.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/pair/config.md`
