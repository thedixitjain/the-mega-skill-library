---
name: list-adrs-list-architecture-decision-records
description: "List and summarize all existing Architecture Decision Records."
category: engineering-core
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/adr-writer/commands/list-adrs.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/adr-writer/commands/list-adrs.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/adr-writer/commands/list-adrs.md`
