...
source_path: ".claude/commands/code-simplify.md"
source_url: https://github.com/addyosmani/agent-skills/blob/HEAD/.claude/commands/code-simplify.md
---
...
**Source:** [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills) → `.claude/commands/code-simplify.md`
