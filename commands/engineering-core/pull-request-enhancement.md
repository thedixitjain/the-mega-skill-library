...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/git-pr-workflows/commands/pr-enhance.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/git-pr-workflows/commands/pr-enhance.md`

**Also appears in:** `wshobson/agents/plugins/comprehensive-review/commands/pr-enhance.md`
