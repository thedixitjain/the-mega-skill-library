...
description: "You will execute the following strict phased workflow. Never skip phases. Never hallucinate file paths."
category: engineering-core
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/tasks/1_explore_plan_code.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/tasks/1_explore_plan_code.md
---
# explore_plan_code
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/tasks/1_explore_plan_code.md`
