...
source_path: ".claude/commands/github/code-review-swarm.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/github/code-review-swarm.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/github/code-review-swarm.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/github/code-review-swarm.md`
