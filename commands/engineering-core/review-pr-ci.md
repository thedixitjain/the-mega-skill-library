...
source_path: ".claude/commands/review-pr-ci.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/.claude/commands/review-pr-ci.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `.claude/commands/review-pr-ci.md`
