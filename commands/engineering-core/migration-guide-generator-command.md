---
name: migration-guide-generator-command
description: "Create migration guides for updates"
category: engineering-core
source_repo: davepoon/buildwithclaude
source_path: "plugins/all-commands/commands/migration-guide.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/migration-guide.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/migration-guide.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-documentation-changelogs/commands/migration-guide.md`
