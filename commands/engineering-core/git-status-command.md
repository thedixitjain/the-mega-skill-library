...
source_path: "plugins/all-commands/commands/git-status.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/git-status.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/git-status.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-utilities-debugging/commands/git-status.md`
