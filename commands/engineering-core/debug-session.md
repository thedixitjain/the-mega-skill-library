...
source_path: "plugins/debug-session/commands/debug-session.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/debug-session/commands/debug-session.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/debug-session/commands/debug-session.md`
