...
source_path: "plugins/code-modernization/commands/modernize-preflight.md"
source_url: https://github.com/anthropics/claude-plugins-official/blob/HEAD/plugins/code-modernization/commands/modernize-preflight.md
---
...
**Source:** [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) → `plugins/code-modernization/commands/modernize-preflight.md`
