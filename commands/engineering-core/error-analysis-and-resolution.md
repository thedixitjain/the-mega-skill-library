...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/error-debugging/commands/error-analysis.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/error-debugging/commands/error-analysis.md`

**Also appears in:** `wshobson/agents/plugins/error-diagnostics/commands/error-analysis.md`
