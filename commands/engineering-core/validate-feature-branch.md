...
source_path: "extensions/git/commands/speckit.git.validate.md"
source_url: https://github.com/github/spec-kit/blob/HEAD/extensions/git/commands/speckit.git.validate.md
---
...
**Source:** [`github/spec-kit`](https://github.com/github/spec-kit) → `extensions/git/commands/speckit.git.validate.md`
