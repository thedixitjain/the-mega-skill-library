---
name: tech-debt-command
description: "This command provides comprehensive technical debt management with automated detection, prioritization, and resolution tracking."
category: engineering-core
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/06-collaboration/tech-debt.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/06-collaboration/tech-debt.md
---
# Tech-Debt Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/06-collaboration/tech-debt.md`
