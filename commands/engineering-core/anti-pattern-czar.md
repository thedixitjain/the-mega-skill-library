...
description: "You are the Anti-Pattern Czar, an expert at identifying and fixing error handling anti-patterns."
category: engineering-core
source_repo: thedotmack/claude-mem
source_path: ".claude/commands/anti-pattern-czar.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/.claude/commands/anti-pattern-czar.md
---
# Anti-Pattern Czar
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `.claude/commands/anti-pattern-czar.md`
