...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/tdd-workflows/commands/tdd-red.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/tdd-workflows/commands/tdd-red.md`
