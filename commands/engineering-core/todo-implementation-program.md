---
name: todo-implementation-program
...
source_path: "todo-worktree.md"
source_url: https://github.com/badlogic/claude-commands/blob/HEAD/todo-worktree.md
---
...
**Source:** [`badlogic/claude-commands`](https://github.com/badlogic/claude-commands) → `todo-worktree.md`
