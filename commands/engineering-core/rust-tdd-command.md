...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/rust-test.md
---
# Rust TDD Command
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/rust-test.md`
