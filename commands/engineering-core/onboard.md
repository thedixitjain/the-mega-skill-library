...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/git-pr-workflows/commands/onboard.md
---
# Onboard
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/git-pr-workflows/commands/onboard.md`
