---
name: ai-debug-ai-assisted-debugging-and-error-resolution
description: "/ai-debug [error-type] [scope] [approach]"
category: engineering-core
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/10-ai-native-development/ai-debug.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/10-ai-native-development/ai-debug.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/10-ai-native-development/ai-debug.md`
