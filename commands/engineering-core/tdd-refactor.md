...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/tdd-workflows/commands/tdd-refactor.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/tdd-workflows/commands/tdd-refactor.md`
