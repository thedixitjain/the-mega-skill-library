...
source_path: "plugins/all-commands/commands/create-onboarding-guide.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/create-onboarding-guide.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/create-onboarding-guide.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-documentation-changelogs/commands/create-onboarding-guide.md`
