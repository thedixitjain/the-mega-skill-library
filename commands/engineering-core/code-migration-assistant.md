...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/framework-migration/commands/code-migrate.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/framework-migration/commands/code-migrate.md`
