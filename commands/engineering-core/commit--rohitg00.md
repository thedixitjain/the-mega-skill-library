---
name: commit
description: "Analyze the currently staged changes (git diff --cached) and generate a conventional commit message."
category: engineering-core
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "commands/git/commit.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/commands/git/commit.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `commands/git/commit.md`
