...
source_url: https://github.com/anthropics/claude-code/blob/HEAD/plugins/code-review/commands/code-review.md
---
...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `plugins/code-review/commands/code-review.md`
