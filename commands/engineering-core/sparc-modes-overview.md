---
name: sparc-modes-overview
description: "SPARC (Specification, Planning, Architecture, Review, Code) is a comprehensive development methodology with 17 specialized modes, all integrated with MCP tools for enhanced coordination and execution."
category: engineering-core
source_repo: ruvnet/RuView
source_path: ".claude/commands/sparc/sparc-modes.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/sparc/sparc-modes.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/sparc/sparc-modes.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/sparc/sparc-modes.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/sparc/sparc-modes.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/sparc/sparc-modes.md`
