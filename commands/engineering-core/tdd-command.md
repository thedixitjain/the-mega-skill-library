...
source_path: ".opencode/commands/tdd.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/commands/tdd.md
---
# TDD Command
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/commands/tdd.md`
