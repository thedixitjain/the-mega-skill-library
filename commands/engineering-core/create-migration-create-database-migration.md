---
name: create-migration-create-database-migration
description: "Generate a database migration file for schema changes."
category: engineering-core
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/migration-generator/commands/create-migration.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/migration-generator/commands/create-migration.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/migration-generator/commands/create-migration.md`
