---
name: flow-release
description: "Complete a feature/bugfix/hotfix flow by merging back to the target branch."
category: engineering-core
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/git-flow/commands/flow-release.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/git-flow/commands/flow-release.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/git-flow/commands/flow-release.md`
