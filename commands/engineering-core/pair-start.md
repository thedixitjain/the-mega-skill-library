...
source_path: ".claude/commands/pair/start.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/pair/start.md
---
# pair --start
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/pair/start.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/pair/start.md`
