...
source_path: ".claude/commands/sparc/refinement-optimization-mode.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/sparc/refinement-optimization-mode.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/sparc/refinement-optimization-mode.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/sparc/refinement-optimization-mode.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/sparc/refinement-optimization-mode.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/sparc/refinement-optimization-mode.md`
