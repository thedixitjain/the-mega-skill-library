---
name: pair-programming-session-management
description: "Complete guide to managing pair programming sessions."
category: engineering-core
source_repo: ruvnet/ruflo
source_path: ".claude/commands/pair/session.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/pair/session.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/pair/session.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/pair/session.md`
