...
source_path: ".claude/commands/02-development/refactor.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/02-development/refactor.md
---
# Safe Refactoring
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/02-development/refactor.md`
