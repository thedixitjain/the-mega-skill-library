...
source_path: "plugins/performance/alerting-rule-creator/commands/create-alerts.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/performance/alerting-rule-creator/commands/create-alerts.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/performance/alerting-rule-creator/commands/create-alerts.md`
