...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/code-refactoring/commands/tech-debt.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/code-refactoring/commands/tech-debt.md`

**Also appears in:** `wshobson/agents/plugins/codebase-cleanup/commands/tech-debt.md`
