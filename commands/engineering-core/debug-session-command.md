...
description: "This command provides comprehensive troubleshooting and debugging capabilities for Claude Code issues and session problems."
category: engineering-core
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/02-development/debug-session.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/02-development/debug-session.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/02-development/debug-session.md`
