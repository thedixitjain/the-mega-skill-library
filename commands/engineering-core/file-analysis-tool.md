...
source_path: "plugins/all-commands/commands/check-file.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/check-file.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/check-file.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-utilities-debugging/commands/check-file.md`
