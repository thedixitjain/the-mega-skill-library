...
description: "This command automates comprehensive pre-commit checks and quality gates to ensure code quality before commits."
category: engineering-core
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/05-deployment/pre-commit.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/05-deployment/pre-commit.md
---
# Pre-Commit Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/05-deployment/pre-commit.md`
