...
source_path: ".claude/commands/optimization/parallel-execution.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/optimization/parallel-execution.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/optimization/parallel-execution.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/optimization/parallel-execution.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/optimization/parallel-execution.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/optimization/parallel-execution.md`
