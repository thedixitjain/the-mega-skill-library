---
name: performance-audit-command
description: "Audit application performance metrics"
category: engineering-core
source_repo: davepoon/buildwithclaude
source_path: "plugins/all-commands/commands/performance-audit.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/performance-audit.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/performance-audit.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-performance-optimization/commands/performance-audit.md`
