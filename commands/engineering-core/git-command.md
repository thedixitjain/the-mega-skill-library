---
name: git-command
description: "This command provides access to advanced Git workflow automation and repository management prompts."
category: engineering-core
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/05-deployment/git.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/05-deployment/git.md
---
# Git Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/05-deployment/git.md`
