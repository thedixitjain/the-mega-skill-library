...
source_path: "plugins/claude-code/commands/skillopt-sleep.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/plugins/claude-code/commands/skillopt-sleep.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `plugins/claude-code/commands/skillopt-sleep.md`
