...
source_path: "plugins/all-commands/commands/migration-assistant.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/migration-assistant.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/migration-assistant.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-team-collaboration/commands/migration-assistant.md`
