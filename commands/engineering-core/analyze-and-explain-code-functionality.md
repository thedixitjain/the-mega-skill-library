...
source_path: "plugins/all-commands/commands/explain-code.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/explain-code.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/explain-code.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-utilities-debugging/commands/explain-code.md`
