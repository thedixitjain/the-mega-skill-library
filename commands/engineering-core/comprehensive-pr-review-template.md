---
name: comprehensive-pr-review-template
...
source_path: "plugins/pr-review/commands/pr-review.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/pr-review/commands/pr-review.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/pr-review/commands/pr-review.md`
