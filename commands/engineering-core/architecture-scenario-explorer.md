...
source_path: "plugins/all-commands/commands/architecture-scenario-explorer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/architecture-scenario-explorer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/architecture-scenario-explorer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-utilities-debugging/commands/architecture-scenario-explorer.md`
