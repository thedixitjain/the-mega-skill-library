...
source_path: "plugins/all-commands/commands/pr-review.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/pr-review.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/pr-review.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-version-control-git/commands/pr-review.md`
