...
source_path: "plugins/performance/apm-dashboard-creator/commands/create-dashboard.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/performance/apm-dashboard-creator/commands/create-dashboard.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/performance/apm-dashboard-creator/commands/create-dashboard.md`
