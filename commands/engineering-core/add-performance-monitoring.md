...
source_path: "plugins/all-commands/commands/add-performance-monitoring.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/add-performance-monitoring.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/add-performance-monitoring.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-monitoring-observability/commands/add-performance-monitoring.md`
