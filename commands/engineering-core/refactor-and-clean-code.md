...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/code-refactoring/commands/refactor-clean.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/code-refactoring/commands/refactor-clean.md`

**Also appears in:** `wshobson/agents/plugins/codebase-cleanup/commands/refactor-clean.md`
