---
name: debug-pod
description: "Debug a failing or unhealthy Kubernetes pod by analyzing events, logs, and configuration."
category: engineering-core
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/k8s-helper/commands/debug-pod.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/k8s-helper/commands/debug-pod.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/k8s-helper/commands/debug-pod.md`
