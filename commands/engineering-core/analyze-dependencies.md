...
description: "Please perform a comprehensive dependency analysis of this codebase:"
category: engineering-core
source_repo: cassler/awesome-claude-code-setup
source_path: "commands/analyze-dependencies.md"
source_url: https://github.com/cassler/awesome-claude-code-setup/blob/HEAD/commands/analyze-dependencies.md
---
...
**Source:** [`cassler/awesome-claude-code-setup`](https://github.com/cassler/awesome-claude-code-setup) → `commands/analyze-dependencies.md`
