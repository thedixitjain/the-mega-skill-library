---
name: setup-linting-command
description: "Setup code linting and quality tools"
allowed-tools: "Bash(npm *)"
category: engineering-core
source_repo: davepoon/buildwithclaude
source_path: "plugins/all-commands/commands/setup-linting.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/setup-linting.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/setup-linting.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-setup/commands/setup-linting.md`
