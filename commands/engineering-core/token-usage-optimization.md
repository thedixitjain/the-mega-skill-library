...
source_path: ".claude/commands/analysis/token-efficiency.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/analysis/token-efficiency.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/analysis/token-efficiency.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/analysis/token-efficiency.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/analysis/token-efficiency.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/analysis/token-efficiency.md`
