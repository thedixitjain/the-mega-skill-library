...
source_path: "engineering/karpathy-coder/commands/karpathy-check.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/karpathy-coder/commands/karpathy-check.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/karpathy-coder/commands/karpathy-check.md`
