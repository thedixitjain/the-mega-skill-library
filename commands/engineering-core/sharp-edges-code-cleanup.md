---
name: sharp-edges-code-cleanup
description: "Sharp edges are specific gotchas that can bite during code cleanup operations. Each edge represents knowledge earned through broken builds and reverted commits."
category: engineering-core
source_repo: vibeforge1111/vibeship-spawner-skills
source_path: "development/code-cleanup/sharp-edges.md"
source_url: https://github.com/vibeforge1111/vibeship-spawner-skills/blob/HEAD/development/code-cleanup/sharp-edges.md
---
...
**Source:** [`vibeforge1111/vibeship-spawner-skills`](https://github.com/vibeforge1111/vibeship-spawner-skills) → `development/code-cleanup/sharp-edges.md`
