---
name: explain
description: "Explain a code file, function, or concept in clear, structured language."
category: engineering-core
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/code-explainer/commands/explain.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/code-explainer/commands/explain.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/code-explainer/commands/explain.md`
