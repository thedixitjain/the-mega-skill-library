---
name: refactor-clean
description: "Her adımda test doğrulaması ile ölü kodu güvenle tanımla ve kaldır."
category: engineering-core
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/refactor-clean.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/refactor-clean.md
---
# Refactor Clean
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/refactor-clean.md`
