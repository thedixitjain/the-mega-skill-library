...
source_path: "extensions/git/commands/speckit.git.commit.md"
source_url: https://github.com/github/spec-kit/blob/HEAD/extensions/git/commands/speckit.git.commit.md
---
# Auto-Commit Changes
...
**Source:** [`github/spec-kit`](https://github.com/github/spec-kit) → `extensions/git/commands/speckit.git.commit.md`
