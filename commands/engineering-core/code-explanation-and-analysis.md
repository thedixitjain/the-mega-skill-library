...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/code-documentation/commands/code-explain.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/code-documentation/commands/code-explain.md`
