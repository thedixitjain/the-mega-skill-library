...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/python-review.md
---
# Python Code Review
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/python-review.md`
