...
source_path: "plugins/performance/capacity-planning-analyzer/commands/analyze-capacity.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/performance/capacity-planning-analyzer/commands/analyze-capacity.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/performance/capacity-planning-analyzer/commands/analyze-capacity.md`
