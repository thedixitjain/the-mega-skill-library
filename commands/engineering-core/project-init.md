...
source_path: "commands/project-init.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/project-init.md
---
# /project-init
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/project-init.md`
