...
source_path: "plugins/smart-commit/commands/changelog.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/smart-commit/commands/changelog.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/smart-commit/commands/changelog.md`
