---
name: workflow-multi-model-collaborative-development
...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/multi-workflow.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/multi-workflow.md`
