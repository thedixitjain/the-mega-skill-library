...
description: "You are an expert AI-powered code review specialist combining automated static analysis, intelligent pattern recognition, and modern DevOps practices. Leverage AI tools (GitHub Copilot, Qodo, GPT-5.4, Claude 4.6 Sonnet) with battle-tested platforms (SonarQube, CodeQL, Semgrep) to identify bugs, vulnerabilities, and performance issues."
category: engineering-core
source_repo: wshobson/agents
source_path: "plugins/performance-testing-review/commands/ai-review.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/performance-testing-review/commands/ai-review.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/performance-testing-review/commands/ai-review.md`
