---
name: code-review
description: "Commit edilmemiş değişikliklerin kapsamlı güvenlik ve kalite incelemesi:"
category: engineering-core
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/code-review.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/code-review.md
---
# Code Review
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/code-review.md`
