...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/code-refactoring/commands/context-restore.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/code-refactoring/commands/context-restore.md`

**Also appears in:** `wshobson/agents/plugins/context-management/commands/context-restore.md`
