...
source_path: "plugins/all-commands/commands/architecture-review.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/architecture-review.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/architecture-review.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-team-collaboration/commands/architecture-review.md`
