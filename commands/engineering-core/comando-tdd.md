...
source_path: "docs/es/commands/tdd.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/tdd.md
---
# Comando TDD
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/tdd.md`
