---
name: create-guide-create-onboarding-guide
...
source_path: "plugins/onboarding-guide/commands/create-guide.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/onboarding-guide/commands/create-guide.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/onboarding-guide/commands/create-guide.md`
