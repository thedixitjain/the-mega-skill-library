---
name: post-init-onboarding-setup
description: "Complete the onboarding process for this codebase:"
category: engineering-core
source_repo: cassler/awesome-claude-code-setup
source_path: "commands/post-init-onboarding.md"
source_url: https://github.com/cassler/awesome-claude-code-setup/blob/HEAD/commands/post-init-onboarding.md
---
...
**Source:** [`cassler/awesome-claude-code-setup`](https://github.com/cassler/awesome-claude-code-setup) → `commands/post-init-onboarding.md`
