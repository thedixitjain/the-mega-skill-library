---
name: analyze-and-resolve-suggested-changes-in-github-pull-request
...
source_path: "plugins/pr-issue-resolve/commands/pr-issue-resolve.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/pr-issue-resolve/commands/pr-issue-resolve.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/pr-issue-resolve/commands/pr-issue-resolve.md`
