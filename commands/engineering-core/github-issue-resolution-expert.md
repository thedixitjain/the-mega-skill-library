...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/team-collaboration/commands/issue.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/team-collaboration/commands/issue.md`
