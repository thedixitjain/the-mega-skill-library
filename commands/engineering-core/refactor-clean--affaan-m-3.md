---
name: refactor-clean
description: "사용하지 않는 코드를 안전하게 식별하고 매 단계마다 테스트 검증을 수행하여 제거합니다."
category: engineering-core
source_repo: affaan-m/ECC
source_path: "docs/ko-KR/commands/refactor-clean.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/commands/refactor-clean.md
---
# Refactor Clean
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/commands/refactor-clean.md`
