...
source_path: "commands/prp-pr.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/prp-pr.md
---
# Create Pull Request
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/prp-pr.md`
