---
name: create-cron-create-cron-job
description: "Configure a cron job with proper scheduling and error handling."
category: engineering-core
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/cron-scheduler/commands/create-cron.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/cron-scheduler/commands/create-cron.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/cron-scheduler/commands/create-cron.md`
