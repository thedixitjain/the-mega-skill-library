---
name: workflow-builder-command
description: "This command provides an interactive workflow creation and management interface for chaining multiple prompts."
category: prompt-engineering
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/08-extras/workflow-builder.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/08-extras/workflow-builder.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/08-extras/workflow-builder.md`
