...
source_path: ".claude/commands/webperf.md"
source_url: https://github.com/addyosmani/agent-skills/blob/HEAD/.claude/commands/webperf.md
---
...
**Source:** [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills) → `.claude/commands/webperf.md`
