---
name: smart-suggest-command
description: "This command provides AI-powered prompt recommendations based on current project state and development context."
category: prompt-engineering
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/07-utilities/smart-suggest.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/07-utilities/smart-suggest.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/07-utilities/smart-suggest.md`
