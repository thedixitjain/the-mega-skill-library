...
source_path: ".claude/commands/stream-chain/run.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/stream-chain/run.md
---
# stream-chain run
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/stream-chain/run.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/stream-chain/run.md`
