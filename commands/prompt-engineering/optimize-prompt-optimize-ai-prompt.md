---
name: optimize-prompt-optimize-ai-prompt
description: "Rewrite and optimize an AI prompt for better performance and reliability."
category: prompt-engineering
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/prompt-optimizer/commands/optimize-prompt.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/prompt-optimizer/commands/optimize-prompt.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/prompt-optimizer/commands/optimize-prompt.md`
