---
name: product-requirement-prompt-prp-creation
description: "Create a comprehensive Product Requirement Prompt (PRP) with research and context gathering"
allowed-tools: "Read, Write, WebSearch"
category: prompt-engineering
source_repo: davepoon/buildwithclaude
source_path: "plugins/all-commands/commands/create-prp.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/create-prp.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/create-prp.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-task-management/commands/create-prp.md`
