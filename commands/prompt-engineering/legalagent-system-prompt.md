---
name: legalagent-system-prompt
description: "{ \"agentprotocolversion\": \"2.0.0\", \"promptstyle\": \"multimodal-markdown\", \"intendedruntime\": [\"Anthropic Claude\", \"OpenAI GPT-4o\", \"Agentic System\"], \"schemacompatibility\": [\"json\", \"yaml\", \"markdown\", \"python\", \"shell\"], \"namespaces\": [\"project\", \"user\", \"team\", \"jurisdiction\", \"field\"], \"auditlog\": true, \"lastupdated\": \"2025-07-10\", \"promptgoal\": \"Deliver modular, extensible, and auditable legal research and review for compliance, risk, contract, or policy—optimized for agent/human collaboration, transparency, and traceability.\""
category: prompt-engineering
source_repo: jasontang-ai/Context-Engineering
source_path: ".claude/commands/legal.agent.md"
source_url: https://github.com/jasontang-ai/Context-Engineering/blob/HEAD/.claude/commands/legal.agent.md
---
...
**Source:** [`jasontang-ai/Context-Engineering`](https://github.com/jasontang-ai/Context-Engineering) → `.claude/commands/legal.agent.md`
