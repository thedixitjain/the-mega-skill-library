---
name: promptschatprompts
description: "Search and discover AI prompts from prompts.chat"
category: prompt-engineering
source_repo: f/prompts.chat
source_path: "plugins/claude/prompts.chat/commands/prompts.md"
source_url: https://github.com/f/prompts.chat/blob/HEAD/plugins/claude/prompts.chat/commands/prompts.md
---
...
**Source:** [`f/prompts.chat`](https://github.com/f/prompts.chat) → `plugins/claude/prompts.chat/commands/prompts.md`
