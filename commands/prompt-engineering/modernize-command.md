---
name: modernize-command
description: "This command provides a complete legacy modernization workflow chaining multiple optimization prompts."
category: prompt-engineering
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/08-extras/modernize.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/08-extras/modernize.md
---
# Modernize Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/08-extras/modernize.md`
