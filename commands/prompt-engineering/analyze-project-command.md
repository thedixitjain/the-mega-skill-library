...
description: "This command auto-detects project characteristics and suggests relevant prompts and improvements."
category: prompt-engineering
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/00-initial-workflow/analyze-project.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/00-initial-workflow/analyze-project.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/00-initial-workflow/analyze-project.md`
