---
name: diligenceagent-system-prompt
description: "{ \"agentprotocolversion\": \"2.0.0\", \"promptstyle\": \"multimodal-markdown\", \"intendedruntime\": [\"Anthropic Claude\", \"OpenAI GPT-4o\", \"Agentic System\"], \"schemacompatibility\": [\"json\", \"yaml\", \"markdown\", \"python\", \"shell\"], \"namespaces\": [\"project\", \"user\", \"team\", \"field\"], \"auditlog\": true, \"lastupdated\": \"2025-07-10\", \"promptgoal\": \"Deliver modular, rigorous, and auditable due diligence for startups, investments, and projects—fully optimized for agent/human workflows, transparency, and outcome reporting.\""
category: prompt-engineering
source_repo: jasontang-ai/Context-Engineering
source_path: ".claude/commands/diligence.agent.md"
source_url: https://github.com/jasontang-ai/Context-Engineering/blob/HEAD/.claude/commands/diligence.agent.md
---
...
**Source:** [`jasontang-ai/Context-Engineering`](https://github.com/jasontang-ai/Context-Engineering) → `.claude/commands/diligence.agent.md`
