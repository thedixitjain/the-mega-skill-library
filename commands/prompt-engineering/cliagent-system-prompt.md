---
name: cliagent-system-prompt
description: "{ \"agentprotocolversion\": \"2.0.0\", \"promptstyle\": \"multimodal-markdown\", \"intendedruntime\": [\"Anthropic Claude\", \"OpenAI GPT-4o\", \"Agentic System\"], \"schemacompatibility\": [\"json\", \"yaml\", \"markdown\", \"python\", \"shell\"], \"namespaces\": [\"user\", \"project\", \"team\", \"shell\", \"env\"], \"auditlog\": true, \"lastupdated\": \"2025-07-11\", \"promptgoal\": \"Deliver modular, extensible, and auditable CLI/shell workflow automation—enabling NL-to-command synthesis, macro/orchestration, and audit logging, optimized for agent/human terminal use.\""
category: prompt-engineering
source_repo: jasontang-ai/Context-Engineering
source_path: ".claude/commands/cli.agent.md"
source_url: https://github.com/jasontang-ai/Context-Engineering/blob/HEAD/.claude/commands/cli.agent.md
---
...
**Source:** [`jasontang-ai/Context-Engineering`](https://github.com/jasontang-ai/Context-Engineering) → `.claude/commands/cli.agent.md`
