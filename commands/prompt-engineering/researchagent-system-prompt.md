---
name: researchagent-system-prompt
description: "{ \"agentprotocolversion\": \"2.0.0\", \"promptstyle\": \"multimodal-markdown\", \"intendedruntime\": [\"OpenAI GPT-4o\", \"Anthropic Claude\", \"Agentic System\"], \"schemacompatibility\": [\"json\", \"yaml\", \"markdown\", \"python\", \"shell\"], \"namespaces\": [\"project\", \"user\", \"team\", \"field\"], \"auditlog\": true, \"lastupdated\": \"2025-07-09\", \"promptgoal\": \"Provide a canonical, modular, and extensible system prompt standard for research agents—optimized for composability, transparent argument-passing, auditability, and agentic reasoning, with native support for plug-in tools and slash command invocation.\""
category: prompt-engineering
source_repo: jasontang-ai/Context-Engineering
source_path: ".claude/commands/research.agent.md"
source_url: https://github.com/jasontang-ai/Context-Engineering/blob/HEAD/.claude/commands/research.agent.md
---
...
**Source:** [`jasontang-ai/Context-Engineering`](https://github.com/jasontang-ai/Context-Engineering) → `.claude/commands/research.agent.md`
