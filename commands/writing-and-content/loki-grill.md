...
source_path: ".claude/commands/loki-grill.md"
source_url: https://github.com/asklokesh/loki-mode/blob/HEAD/.claude/commands/loki-grill.md
---
...
**Source:** [`asklokesh/loki-mode`](https://github.com/asklokesh/loki-mode) → `.claude/commands/loki-grill.md`

**Also appears in:** `asklokesh/loki-mode/plugins/loki-mode/commands/loki-grill.md`
