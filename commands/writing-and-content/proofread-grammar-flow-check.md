---
name: proofread-grammar-flow-check
description: "Check grammar, logic, and flow in any text — targeted fixes without rewriting"
category: writing-and-content
source_repo: phuryn/pm-skills
source_path: "pm-toolkit/commands/proofread.md"
source_url: https://github.com/phuryn/pm-skills/blob/HEAD/pm-toolkit/commands/proofread.md
---
...
**Source:** [`phuryn/pm-skills`](https://github.com/phuryn/pm-skills) → `pm-toolkit/commands/proofread.md`
