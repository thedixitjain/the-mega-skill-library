---
name: profile-memory-profile-memory-usage
description: "Capture and analyze memory usage of the application."
category: rag-memory-knowledge
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/memory-profiler/commands/profile-memory.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/memory-profiler/commands/profile-memory.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/memory-profiler/commands/profile-memory.md`
