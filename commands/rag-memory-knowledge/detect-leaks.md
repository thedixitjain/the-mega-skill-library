...
source_path: "plugins/performance/memory-leak-detector/commands/detect-leaks.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/performance/memory-leak-detector/commands/detect-leaks.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/performance/memory-leak-detector/commands/detect-leaks.md`
