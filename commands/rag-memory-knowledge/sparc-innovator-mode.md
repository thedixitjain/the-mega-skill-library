---
name: sparc-innovator-mode
description: "Creative problem solving with WebSearch and Memory integration."
category: rag-memory-knowledge
source_repo: ruvnet/RuView
source_path: ".claude/commands/sparc/innovator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/sparc/innovator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/sparc/innovator.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/sparc/innovator.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/sparc/innovator.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/sparc/innovator.md`
