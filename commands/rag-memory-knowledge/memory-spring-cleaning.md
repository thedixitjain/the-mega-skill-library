...
source_path: "plugins/all-commands/commands/memory-spring-cleaning.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/memory-spring-cleaning.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/memory-spring-cleaning.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-team-collaboration/commands/memory-spring-cleaning.md`
