---
name: generate-embeddings-generate-vector-embeddings
description: "Generate vector embeddings for text data using embedding models."
category: rag-memory-knowledge
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/embedding-manager/commands/generate-embeddings.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/embedding-manager/commands/generate-embeddings.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/embedding-manager/commands/generate-embeddings.md`
