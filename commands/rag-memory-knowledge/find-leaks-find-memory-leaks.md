---
name: find-leaks-find-memory-leaks
description: "Detect and diagnose memory leaks in the application."
category: rag-memory-knowledge
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/memory-profiler/commands/find-leaks.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/memory-profiler/commands/find-leaks.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/memory-profiler/commands/find-leaks.md`
