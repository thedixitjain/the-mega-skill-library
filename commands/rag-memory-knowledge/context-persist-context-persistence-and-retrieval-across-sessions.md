---
name: context-persist-context-persistence-and-retrieval-across-session
description: "/context-persist [action] [scope] [session-id] [parameters]"
category: rag-memory-knowledge
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/09-agentic-capabilities/context-persist.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/09-agentic-capabilities/context-persist.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/09-agentic-capabilities/context-persist.md`
