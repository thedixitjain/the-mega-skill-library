---
name: project-memory
description: "Update the project's CLAUDE.md memory bank with current session learnings."
category: rag-memory-knowledge
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "commands/documentation/memory-bank.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/commands/documentation/memory-bank.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `commands/documentation/memory-bank.md`
