...
source_path: "productivity/email/commands/cs-inbox-setup.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/productivity/email/commands/cs-inbox-setup.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `productivity/email/commands/cs-inbox-setup.md`
