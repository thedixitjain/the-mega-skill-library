---
name: run-load-test-execute-load-test
description: "Run load and stress tests against API endpoints or web pages."
category: testing-and-qa
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/load-tester/commands/run-load-test.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/load-tester/commands/run-load-test.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/load-tester/commands/run-load-test.md`
