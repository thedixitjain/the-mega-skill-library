---
name: record-test-record-new-e2e-test
description: "Record user interactions to generate an end-to-end test file."
category: testing-and-qa
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/e2e-runner/commands/record-test.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/e2e-runner/commands/record-test.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/e2e-runner/commands/record-test.md`
