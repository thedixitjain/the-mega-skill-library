...
source_path: "extensions/bug/commands/speckit.bug.assess.md"
source_url: https://github.com/github/spec-kit/blob/HEAD/extensions/bug/commands/speckit.bug.assess.md
---
# Assess Bug
...
**Source:** [`github/spec-kit`](https://github.com/github/spec-kit) → `extensions/bug/commands/speckit.bug.assess.md`
