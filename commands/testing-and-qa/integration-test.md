...
description: "Generate integration tests for a module, testing real interactions between components."
category: testing-and-qa
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "commands/testing/integration-test.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/commands/testing/integration-test.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `commands/testing/integration-test.md`
