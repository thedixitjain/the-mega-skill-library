...
source_path: ".claude/commands/04-testing/test.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/04-testing/test.md
---
# Test Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/04-testing/test.md`
