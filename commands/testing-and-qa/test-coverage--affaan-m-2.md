---
name: test-coverage
description: "Test coverage'ını analiz et, eksiklikleri tanımla ve 80%+ coverage'a ulaşmak için eksik test'leri oluştur."
category: testing-and-qa
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/test-coverage.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/test-coverage.md
---
# Test Coverage
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/test-coverage.md`
