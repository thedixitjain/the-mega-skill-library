---
name: test-responsive-test-responsive-design
description: "Test responsive design across multiple device sizes and orientations."
category: testing-and-qa
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/responsive-designer/commands/test-responsive.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/responsive-designer/commands/test-responsive.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/responsive-designer/commands/test-responsive.md`
