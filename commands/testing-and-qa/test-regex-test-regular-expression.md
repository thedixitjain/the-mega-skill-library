---
name: test-regex-test-regular-expression
description: "Test a regular expression against sample inputs and edge cases."
category: testing-and-qa
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/regex-builder/commands/test-regex.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/regex-builder/commands/test-regex.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/regex-builder/commands/test-regex.md`
