...
source_path: "docs/ko-KR/commands/test-coverage.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/commands/test-coverage.md
---
# 테스트 커버리지
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/commands/test-coverage.md`
