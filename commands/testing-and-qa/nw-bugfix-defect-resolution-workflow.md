---
name: nw-bugfix-defect-resolution-workflow
description: "Bug fix workflow: root cause analysis → user review → regression test + fix via TDD"
category: testing-and-qa
source_repo: nWave-ai/nWave
source_path: "plugins/nw/commands/bugfix.md"
source_url: https://github.com/nWave-ai/nWave/blob/HEAD/plugins/nw/commands/bugfix.md
---
...
**Source:** [`nWave-ai/nWave`](https://github.com/nWave-ai/nWave) → `plugins/nw/commands/bugfix.md`
