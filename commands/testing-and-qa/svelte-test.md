...
source_path: "plugins/all-commands/commands/svelte-test.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/svelte-test.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/svelte-test.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-framework-svelte/commands/svelte-test.md`
