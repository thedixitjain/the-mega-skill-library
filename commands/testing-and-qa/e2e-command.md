...
source_path: ".opencode/commands/e2e.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/commands/e2e.md
---
# E2E Command
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/commands/e2e.md`
