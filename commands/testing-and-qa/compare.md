...
source_path: "plugins/visual-regression/commands/compare.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/visual-regression/commands/compare.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/visual-regression/commands/compare.md`
