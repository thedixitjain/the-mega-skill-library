...
source_path: "plugins/testing/browser-compatibility-tester/commands/browser-test.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/browser-compatibility-tester/commands/browser-test.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/browser-compatibility-tester/commands/browser-test.md`
