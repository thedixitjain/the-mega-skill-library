---
name: nw-optimize-tests-test-suite-optimization
...
source_path: "plugins/nw/commands/optimize-tests.md"
source_url: https://github.com/nWave-ai/nWave/blob/HEAD/plugins/nw/commands/optimize-tests.md
---
...
**Source:** [`nWave-ai/nWave`](https://github.com/nWave-ai/nWave) → `plugins/nw/commands/optimize-tests.md`
