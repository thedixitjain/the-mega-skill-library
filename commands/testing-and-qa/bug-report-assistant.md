...
description: "You are helping a product manager create a detailed, actionable bug report for developers. Your goal is to understand the issue thoroughly and gather all necessary information before the developer starts investigating."
category: testing-and-qa
source_repo: nimbalyst/product-manager-claude-code-commands
source_path: "bug-report.md"
source_url: https://github.com/nimbalyst/product-manager-claude-code-commands/blob/HEAD/bug-report.md
---
...
**Source:** [`nimbalyst/product-manager-claude-code-commands`](https://github.com/nimbalyst/product-manager-claude-code-commands) → `bug-report.md`
