...
source_path: "plugins/screen-reader-tester/commands/test-sr.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/screen-reader-tester/commands/test-sr.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/screen-reader-tester/commands/test-sr.md`
