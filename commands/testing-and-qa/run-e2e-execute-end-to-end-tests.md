---
name: run-e2e-execute-end-to-end-tests
description: "Run end-to-end tests against the application using Playwright or Cypress."
category: testing-and-qa
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/e2e-runner/commands/run-e2e.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/e2e-runner/commands/run-e2e.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/e2e-runner/commands/run-e2e.md`
