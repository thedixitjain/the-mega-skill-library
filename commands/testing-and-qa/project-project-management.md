...
source_path: ".claude/commands/project.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/.claude/commands/project.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `.claude/commands/project.md`
