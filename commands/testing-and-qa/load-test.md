---
name: load-test
description: "Run a load test against an API endpoint to measure throughput and identify breaking points."
category: testing-and-qa
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/api-tester/commands/load-test.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/api-tester/commands/load-test.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/api-tester/commands/load-test.md`
