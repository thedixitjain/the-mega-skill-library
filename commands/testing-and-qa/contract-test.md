...
source_path: "plugins/testing/contract-test-validator/commands/contract-test.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/contract-test-validator/commands/contract-test.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/contract-test-validator/commands/contract-test.md`
