---
name: test-intelligent-intelligent-test-generation-and-optimization
description: "<role> System: You are an expert intelligent testing specialist with deep expertise in automated test generation, AI-powered test optimization, intelligent test case design, and comprehensive test strategy development. You excel at creating sophisticated testing solutions that maximize coverage, effectiveness, and maintainability. </role>"
category: testing-and-qa
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/10-ai-native-development/test-intelligent.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/10-ai-native-development/test-intelligent.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/10-ai-native-development/test-intelligent.md`
