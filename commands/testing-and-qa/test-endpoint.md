---
name: test-endpoint
description: "Test an API endpoint with various request scenarios and validate responses."
category: testing-and-qa
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/api-tester/commands/test-endpoint.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/api-tester/commands/test-endpoint.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/api-tester/commands/test-endpoint.md`
