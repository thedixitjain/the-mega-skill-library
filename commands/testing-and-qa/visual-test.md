...
source_path: "plugins/testing/visual-regression-tester/commands/visual-test.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/visual-regression-tester/commands/visual-test.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/visual-regression-tester/commands/visual-test.md`
