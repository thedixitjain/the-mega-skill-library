...
source_path: "plugins/testing/test-orchestrator/commands/orchestrate.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/test-orchestrator/commands/orchestrate.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/test-orchestrator/commands/orchestrate.md`
