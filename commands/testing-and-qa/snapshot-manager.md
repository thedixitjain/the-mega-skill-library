...
source_path: "plugins/testing/snapshot-test-manager/commands/snapshot-manager.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/snapshot-test-manager/commands/snapshot-manager.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/snapshot-test-manager/commands/snapshot-manager.md`
