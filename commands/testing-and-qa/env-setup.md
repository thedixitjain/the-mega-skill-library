...
source_path: "plugins/testing/test-environment-manager/commands/env-setup.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/test-environment-manager/commands/env-setup.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/test-environment-manager/commands/env-setup.md`
