...
description: "Use Playwright to visually test your recent UI changes."
category: testing-and-qa
source_repo: cassler/awesome-claude-code-setup
source_path: "commands/visual-test.md"
source_url: https://github.com/cassler/awesome-claude-code-setup/blob/HEAD/commands/visual-test.md
---
...
**Source:** [`cassler/awesome-claude-code-setup`](https://github.com/cassler/awesome-claude-code-setup) → `commands/visual-test.md`
