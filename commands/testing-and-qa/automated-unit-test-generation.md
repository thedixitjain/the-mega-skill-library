...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/unit-testing/commands/test-generate.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/unit-testing/commands/test-generate.md`
