...
source_path: "plugins/testing/unit-test-generator/commands/generate-tests.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/unit-test-generator/commands/generate-tests.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/unit-test-generator/commands/generate-tests.md`
