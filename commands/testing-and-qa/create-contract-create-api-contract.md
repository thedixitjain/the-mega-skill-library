---
name: create-contract-create-api-contract
description: "Create a Pact contract definition for consumer-driven contract testing."
category: testing-and-qa
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/contract-tester/commands/create-contract.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/contract-tester/commands/create-contract.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/contract-tester/commands/create-contract.md`
