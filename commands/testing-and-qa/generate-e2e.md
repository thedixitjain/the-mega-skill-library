...
source_path: "plugins/testing/e2e-test-framework/commands/generate-e2e.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/e2e-test-framework/commands/generate-e2e.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/e2e-test-framework/commands/generate-e2e.md`
