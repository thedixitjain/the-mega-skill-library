...
source_path: "plugins/visual-regression/commands/capture-baseline.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/visual-regression/commands/capture-baseline.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/visual-regression/commands/capture-baseline.md`
