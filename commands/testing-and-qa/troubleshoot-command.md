---
name: troubleshoot-command
description: "Provides systematic debugging assistance and troubleshooting guidance for software development issues. Uses intelligent analysis to identify problems, guide resolution steps, and build team debugging capabilities."
category: testing-and-qa
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/04-testing/troubleshoot.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/04-testing/troubleshoot.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/04-testing/troubleshoot.md`
