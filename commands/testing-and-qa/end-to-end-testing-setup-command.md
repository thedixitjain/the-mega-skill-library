---
name: end-to-end-testing-setup-command
description: "Configure end-to-end testing suite"
allowed-tools: "Bash(npm *)"
category: testing-and-qa
source_repo: davepoon/buildwithclaude
source_path: "plugins/all-commands/commands/e2e-setup.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/e2e-setup.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/e2e-setup.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-code-analysis-testing/commands/e2e-setup.md`
