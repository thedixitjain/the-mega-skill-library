---
name: game-development-anti-patterns
description: "Approaches that seem reasonable in game development but lead to unmaintainable code, poor performance, or failed projects."
category: media-and-creative
source_repo: vibeforge1111/vibeship-spawner-skills
source_path: "game-dev/game-development/anti-patterns.md"
source_url: https://github.com/vibeforge1111/vibeship-spawner-skills/blob/HEAD/game-dev/game-development/anti-patterns.md
---
...
**Source:** [`vibeforge1111/vibeship-spawner-skills`](https://github.com/vibeforge1111/vibeship-spawner-skills) → `game-dev/game-development/anti-patterns.md`
