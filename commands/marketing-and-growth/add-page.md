...
source_path: "plugins/web-dev/commands/add-page.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/web-dev/commands/add-page.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/web-dev/commands/add-page.md`
