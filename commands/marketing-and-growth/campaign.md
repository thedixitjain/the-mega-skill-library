...
source_path: "plugins/productivity/content-multiplier/commands/campaign.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/productivity/content-multiplier/commands/campaign.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/productivity/content-multiplier/commands/campaign.md`
