...
description: "This command provides structured incident response workflows for production issues and system failures."
category: security-and-compliance
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/03-security/incident-response.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/03-security/incident-response.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/03-security/incident-response.md`
