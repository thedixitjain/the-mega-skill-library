...
source_path: "plugins/security/severity1-marketplace/commands/severity-classify.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/security/severity1-marketplace/commands/severity-classify.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/security/severity1-marketplace/commands/severity-classify.md`
