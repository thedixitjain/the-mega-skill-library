...
source_path: "plugins/database/database-security-scanner/commands/security-scan.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/database/database-security-scanner/commands/security-scan.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/database/database-security-scanner/commands/security-scan.md`
