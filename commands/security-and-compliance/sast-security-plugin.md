...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/security-scanning/commands/security-sast.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/security-scanning/commands/security-sast.md`
