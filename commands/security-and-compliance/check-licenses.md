...
source_path: "plugins/license-checker/commands/check-licenses.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/license-checker/commands/check-licenses.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/license-checker/commands/check-licenses.md`
