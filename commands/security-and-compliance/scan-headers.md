...
source_path: "plugins/security/penetration-tester/commands/scan-headers.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/security/penetration-tester/commands/scan-headers.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/security/penetration-tester/commands/scan-headers.md`
