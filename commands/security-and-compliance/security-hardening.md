...
source_path: "plugins/all-commands/commands/security-hardening.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/security-hardening.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/security-hardening.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-security-audit/commands/security-hardening.md`
