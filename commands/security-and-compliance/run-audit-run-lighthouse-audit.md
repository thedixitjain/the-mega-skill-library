---
name: run-audit-run-lighthouse-audit
description: "Execute a Lighthouse performance audit on web pages."
category: security-and-compliance
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/lighthouse-runner/commands/run-audit.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/lighthouse-runner/commands/run-audit.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/lighthouse-runner/commands/run-audit.md`
