...
source_path: "plugins/security/dependency-checker/commands/check-deps.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/security/dependency-checker/commands/check-deps.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/security/dependency-checker/commands/check-deps.md`
