...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/codebase-cleanup/commands/deps-audit.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/codebase-cleanup/commands/deps-audit.md`

**Also appears in:** `wshobson/agents/plugins/dependency-management/commands/deps-audit.md`
