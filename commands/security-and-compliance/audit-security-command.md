---
name: audit-security-command
description: "This command provides quick access to comprehensive security and quality audit prompts."
category: security-and-compliance
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/03-security/audit-security.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/03-security/audit-security.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/03-security/audit-security.md`
