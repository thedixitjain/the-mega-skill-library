---
name: fix-issues-fix-lighthouse-issues
description: "Apply fixes for Lighthouse audit failures to improve scores."
category: security-and-compliance
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/lighthouse-runner/commands/fix-issues.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/lighthouse-runner/commands/fix-issues.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/lighthouse-runner/commands/fix-issues.md`
