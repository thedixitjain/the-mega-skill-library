...
source_path: "skills/.curated/databricks-uc-migration-pilot/commands/audit-hms-readiness.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/databricks-uc-migration-pilot/commands/audit-hms-readiness.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/databricks-uc-migration-pilot/commands/audit-hms-readiness.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/databricks-pack/skills/databricks-uc-migration-pilot/commands/audit-hms-readiness.md`
