---
name: comply-command
description: "This command provides access to comprehensive compliance automation and security hardening prompts."
category: security-and-compliance
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/03-security/comply.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/03-security/comply.md
---
# Comply Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/03-security/comply.md`
