---
name: analysis-commands-compliance-report
description: "Reviewed all command files in .claude/commands/analysis/ directory to ensure proper usage of: - mcpclaude-flow tools (preferred) - npx claude-flow commands (as fallback) - No direct implementation calls"
category: security-and-compliance
source_repo: ruvnet/RuView
source_path: ".claude/commands/analysis/COMMAND_COMPLIANCE_REPORT.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/analysis/COMMAND_COMPLIANCE_REPORT.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/analysis/COMMAND_COMPLIANCE_REPORT.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/analysis/COMMAND_COMPLIANCE_REPORT.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/analysis/COMMAND_COMPLIANCE_REPORT.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/analysis/COMMAND_COMPLIANCE_REPORT.md`
