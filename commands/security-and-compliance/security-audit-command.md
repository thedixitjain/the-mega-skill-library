...
source_path: "plugins/all-commands/commands/security-audit.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/security-audit.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/security-audit.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-security-audit/commands/security-audit.md`
