...
source_path: "skills/.curated/databricks-cluster-forensics/commands/dbr-upgrade-check.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/databricks-cluster-forensics/commands/dbr-upgrade-check.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/databricks-cluster-forensics/commands/dbr-upgrade-check.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/databricks-pack/skills/databricks-cluster-forensics/commands/dbr-upgrade-check.md`
