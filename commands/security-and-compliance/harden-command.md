---
name: harden-command
description: "This command provides an end-to-end security hardening workflow implementing defense-in-depth strategies."
category: security-and-compliance
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/03-security/harden.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/03-security/harden.md
---
# Harden Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/03-security/harden.md`
