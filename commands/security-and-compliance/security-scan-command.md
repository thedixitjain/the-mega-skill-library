...
source_path: "commands/security-scan.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/security-scan.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/security-scan.md`

**Also appears in:** `affaan-m/ECC/.opencode/commands/security-scan.md`
