...
source_path: ".claude/commands/ship.md"
source_url: https://github.com/addyosmani/agent-skills/blob/HEAD/.claude/commands/ship.md
---
...
**Source:** [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills) → `.claude/commands/ship.md`
