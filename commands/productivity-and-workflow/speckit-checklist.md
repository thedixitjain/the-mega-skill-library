...
source_path: "plugins/spec-kit/commands/speckit-checklist.md"
source_url: https://github.com/athola/claude-night-market/blob/HEAD/plugins/spec-kit/commands/speckit-checklist.md
---
...
3. **Understand user request**: Combine `$ARGUMENTS` and clarifying answers:
...
**Source:** [`athola/claude-night-market`](https://github.com/athola/claude-night-market) → `plugins/spec-kit/commands/speckit-checklist.md`
