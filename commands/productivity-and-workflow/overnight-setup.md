...
source_path: "plugins/productivity/overnight-dev/commands/overnight-setup.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/productivity/overnight-dev/commands/overnight-setup.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/productivity/overnight-dev/commands/overnight-setup.md`
