---
name: workflow-automate-multi-step-workflow-automation-with-agent-coor
...
source_path: ".claude/commands/09-agentic-capabilities/workflow-automate.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/09-agentic-capabilities/workflow-automate.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/09-agentic-capabilities/workflow-automate.md`
