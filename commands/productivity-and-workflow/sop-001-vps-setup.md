...
source_path: "plugins/community/fairdb-ops-manager/commands/sop-001-vps-setup.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/community/fairdb-ops-manager/commands/sop-001-vps-setup.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/community/fairdb-ops-manager/commands/sop-001-vps-setup.md`
