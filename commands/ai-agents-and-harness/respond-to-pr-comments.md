...
source_path: ".agents/commands/respond-to-pr-comments.md"
source_url: https://github.com/superset-sh/superset/blob/HEAD/.agents/commands/respond-to-pr-comments.md
---
...
**Source:** [`superset-sh/superset`](https://github.com/superset-sh/superset) → `.agents/commands/respond-to-pr-comments.md`

**Also appears in:** `per-simmons/damon-ade/.agents/commands/respond-to-pr-comments.md`
