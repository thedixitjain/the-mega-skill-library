---
name: validate-environment-command
description: "This command checks if the development environment is properly configured for executing Claude Code prompts."
category: ai-agents-and-harness
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/07-utilities/validate-environment.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/07-utilities/validate-environment.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/07-utilities/validate-environment.md`
