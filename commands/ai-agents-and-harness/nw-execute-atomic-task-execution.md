---
name: nw-execute-atomic-task-execution
...
source_path: "plugins/nw/commands/execute.md"
source_url: https://github.com/nWave-ai/nWave/blob/HEAD/plugins/nw/commands/execute.md
---
...
**Source:** [`nWave-ai/nWave`](https://github.com/nWave-ai/nWave) → `plugins/nw/commands/execute.md`
