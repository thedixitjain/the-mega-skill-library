---
name: multi-platform-feature-development-orchestrator
...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/multi-platform-apps/commands/multi-platform.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/multi-platform-apps/commands/multi-platform.md`
