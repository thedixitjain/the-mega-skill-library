---
name: agent-learn-agent-learning-and-adaptation-from-project-patterns
description: "/agent-learn [learning-type] [agent] [data-source] [parameters]"
category: ai-agents-and-harness
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/09-agentic-capabilities/agent-learn.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/09-agentic-capabilities/agent-learn.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/09-agentic-capabilities/agent-learn.md`
