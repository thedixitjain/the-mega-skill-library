...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/harness-audit.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/harness-audit.md`

**Also appears in:** `affaan-m/ECC/.opencode/commands/harness-audit.md`
