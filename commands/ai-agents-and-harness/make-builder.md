...
source_path: "plugins/ai-agency/make-scenario-builder/commands/make-builder.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/ai-agency/make-scenario-builder/commands/make-builder.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/ai-agency/make-scenario-builder/commands/make-builder.md`
