...
source_url: https://github.com/superset-sh/superset/blob/HEAD/.agents/commands/deslop.md
---
...
**Source:** [`superset-sh/superset`](https://github.com/superset-sh/superset) → `.agents/commands/deslop.md`
