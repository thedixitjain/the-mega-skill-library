---
name: multi-repo-swarm-cross-repository-swarm-orchestration
...
source_path: ".claude/commands/github/multi-repo-swarm.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/github/multi-repo-swarm.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/github/multi-repo-swarm.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/github/multi-repo-swarm.md`, `ruvnet/ruflo/.claude/commands/github/multi-repo-swarm.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/github/multi-repo-swarm.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/github/multi-repo-swarm.md`
