...
source_path: ".claude/commands/triage-prs.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/.claude/commands/triage-prs.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `.claude/commands/triage-prs.md`
