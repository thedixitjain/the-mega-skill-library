...
source_path: "plugins/ruflo-agent/commands/managed-agent.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-agent/commands/managed-agent.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-agent/commands/managed-agent.md`
