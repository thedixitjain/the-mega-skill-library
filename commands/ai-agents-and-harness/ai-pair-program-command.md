---
name: ai-pair-program-command
description: "This command enables advanced AI pair programming with deep context awareness and collaborative development capabilities."
category: ai-agents-and-harness
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/10-ai-native-development/ai-pair-program.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/10-ai-native-development/ai-pair-program.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/10-ai-native-development/ai-pair-program.md`
