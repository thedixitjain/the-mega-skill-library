---
name: agent-orchestrate-command
description: "This command coordinates multiple AI agents to work collaboratively on complex, multi-faceted tasks."
category: ai-agents-and-harness
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/09-agentic-capabilities/agent-orchestrate.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/09-agentic-capabilities/agent-orchestrate.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/09-agentic-capabilities/agent-orchestrate.md`
