...
source_path: "engineering/workflow-builder/commands/cs-workflow-build.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/workflow-builder/commands/cs-workflow-build.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/workflow-builder/commands/cs-workflow-build.md`
