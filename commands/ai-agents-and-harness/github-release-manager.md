...
source_path: ".claude/commands/github/release-manager.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/github/release-manager.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/github/release-manager.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/github/release-manager.md`
