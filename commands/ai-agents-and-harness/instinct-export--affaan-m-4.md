...
source_path: "docs/zh-CN/commands/instinct-export.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/instinct-export.md
---
# 本能导出命令
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/instinct-export.md`
