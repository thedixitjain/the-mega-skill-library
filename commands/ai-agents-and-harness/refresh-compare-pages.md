...
source_path: ".agents/commands/refresh-compare-pages.md"
source_url: https://github.com/superset-sh/superset/blob/HEAD/.agents/commands/refresh-compare-pages.md
---
...
**Source:** [`superset-sh/superset`](https://github.com/superset-sh/superset) → `.agents/commands/refresh-compare-pages.md`
