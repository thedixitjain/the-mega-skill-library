...
source_path: ".claude/commands/hooks/post-task.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/hooks/post-task.md
---
# hook post-task
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/hooks/post-task.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/hooks/post-task.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/hooks/post-task.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/hooks/post-task.md`
