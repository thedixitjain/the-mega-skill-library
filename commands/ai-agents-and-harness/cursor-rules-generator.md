...
description: "Prompt Title: Repository Exploration and .cursor Rules Generation with Parallelized Subagents"
category: ai-agents-and-harness
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/tasks/cursor_rules_generator.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/tasks/cursor_rules_generator.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/tasks/cursor_rules_generator.md`
