---
name: create-cognitive-patterns
description: "This tool coordinates Claude Code's actions. It does NOT write code or create content."
category: ai-agents-and-harness
source_repo: ruvnet/ruflo
source_path: ".claude/commands/coordination/spawn.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/coordination/spawn.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/coordination/spawn.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/coordination/spawn.md`
