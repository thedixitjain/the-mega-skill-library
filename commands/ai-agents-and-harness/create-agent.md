...
source_path: "plugins/productivity/004-jeremy-google-cloud-agent-sdk/commands/create-agent.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/productivity/004-jeremy-google-cloud-agent-sdk/commands/create-agent.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/productivity/004-jeremy-google-cloud-agent-sdk/commands/create-agent.md`
