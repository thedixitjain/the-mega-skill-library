---
name: workflow-visual-visual-workflow-builder-for-agent-orchestration
description: "/workflow-visual [action] [workflow-type] [complexity] [parameters]"
category: ai-agents-and-harness
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/09-agentic-capabilities/workflow-visual.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/09-agentic-capabilities/workflow-visual.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/09-agentic-capabilities/workflow-visual.md`
