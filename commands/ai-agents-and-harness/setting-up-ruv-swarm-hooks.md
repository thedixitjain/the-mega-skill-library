---
name: setting-up-ruv-swarm-hooks
description: "npx claude-flow init --hooks"
category: ai-agents-and-harness
source_repo: ruvnet/RuView
source_path: ".claude/commands/hooks/setup.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/hooks/setup.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/hooks/setup.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/hooks/setup.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/hooks/setup.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/hooks/setup.md`
