---
name: initialize-coordination-framework
description: "This tool coordinates Claude Code's actions. It does NOT write code or create content."
category: ai-agents-and-harness
source_repo: ruvnet/ruflo
source_path: ".claude/commands/coordination/init.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/coordination/init.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/coordination/init.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/coordination/init.md`
