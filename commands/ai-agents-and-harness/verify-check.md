...
source_path: ".claude/commands/verify/check.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/verify/check.md
---
# verify check
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/verify/check.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/verify/check.md`
