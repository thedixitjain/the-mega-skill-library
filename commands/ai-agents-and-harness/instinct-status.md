...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/instinct-status.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/instinct-status.md`
