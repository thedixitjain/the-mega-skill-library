...
source_path: "plugins/security/agent-safety-preflight/commands/agent-preflight.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/security/agent-safety-preflight/commands/agent-preflight.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/security/agent-safety-preflight/commands/agent-preflight.md`
