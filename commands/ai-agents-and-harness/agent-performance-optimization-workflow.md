...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/agent-orchestration/commands/improve-agent.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/agent-orchestration/commands/improve-agent.md`
