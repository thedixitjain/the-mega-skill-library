...
source_path: "plugins/community/jeremy-firestore/commands/firestore-setup.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/community/jeremy-firestore/commands/firestore-setup.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/community/jeremy-firestore/commands/firestore-setup.md`
