...
source_path: ".claude/commands/hooks/pre-edit.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/hooks/pre-edit.md
---
# hook pre-edit
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/hooks/pre-edit.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/hooks/pre-edit.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/hooks/pre-edit.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/hooks/pre-edit.md`
