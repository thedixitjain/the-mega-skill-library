---
name: development-swarm-strategy
description: "Coordinated development through specialized agent teams."
category: ai-agents-and-harness
source_repo: ruvnet/ruflo
source_path: ".claude/commands/swarm/development.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/swarm/development.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/swarm/development.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/swarm/development.md`
