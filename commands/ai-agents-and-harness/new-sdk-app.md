...
source_path: "plugins/agent-sdk-dev/commands/new-sdk-app.md"
source_url: https://github.com/anthropics/claude-code/blob/HEAD/plugins/agent-sdk-dev/commands/new-sdk-app.md
---
...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `plugins/agent-sdk-dev/commands/new-sdk-app.md`

**Also appears in:** `anthropics/claude-plugins-official/plugins/agent-sdk-dev/commands/new-sdk-app.md`, `ccplugins/awesome-claude-code-plugins/plugins/agent-sdk-dev/commands/new-sdk-app.md`
