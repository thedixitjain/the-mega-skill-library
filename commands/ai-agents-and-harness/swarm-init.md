...
source_path: ".claude/commands/coordination/swarm-init.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/coordination/swarm-init.md
---
# swarm init
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/coordination/swarm-init.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/coordination/swarm-init.md`
