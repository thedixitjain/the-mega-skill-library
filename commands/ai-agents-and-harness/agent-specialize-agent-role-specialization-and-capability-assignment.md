---
name: agent-specialize-agent-role-specialization-and-capability-assign
description: "/agent-specialize [domain] [role] [capabilities] [parameters]"
category: ai-agents-and-harness
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/09-agentic-capabilities/agent-specialize.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/09-agentic-capabilities/agent-specialize.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/09-agentic-capabilities/agent-specialize.md`
