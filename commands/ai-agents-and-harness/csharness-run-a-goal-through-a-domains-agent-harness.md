---
name: csharness-run-a-goal-through-a-domains-agent-harness
...
source_path: "engineering/agent-harness/commands/cs-harness.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/agent-harness/commands/cs-harness.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/agent-harness/commands/cs-harness.md`
