...
source_path: "commands/plan-loop.md"
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/commands/plan-loop.md
---
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `commands/plan-loop.md`
