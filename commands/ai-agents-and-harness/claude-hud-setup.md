...
source_path: "plugins/claude-hud/commands/setup.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/claude-hud/commands/setup.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/claude-hud/commands/setup.md`
