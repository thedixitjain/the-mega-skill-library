...
source_path: "plugins/productivity/agent-context-manager/commands/sync-agent-context.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/productivity/agent-context-manager/commands/sync-agent-context.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/productivity/agent-context-manager/commands/sync-agent-context.md`
