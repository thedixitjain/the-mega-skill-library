...
source_repo: per-simmons/damon-ade
source_path: ".agents/commands/deslop.md"
source_url: https://github.com/per-simmons/damon-ade/blob/HEAD/.agents/commands/deslop.md
---
...
**Source:** [`per-simmons/damon-ade`](https://github.com/per-simmons/damon-ade) → `.agents/commands/deslop.md`
