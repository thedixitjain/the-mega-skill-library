...
source_path: "plugins/agent-teams/commands/team-status.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/agent-teams/commands/team-status.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/agent-teams/commands/team-status.md`
