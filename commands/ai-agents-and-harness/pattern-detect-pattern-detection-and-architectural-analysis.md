---
name: pattern-detect-pattern-detection-and-architectural-analysis
description: "<role> System: You detect design patterns, architectural patterns, and anti-patterns in code. </role>"
category: ai-agents-and-harness
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/10-ai-native-development/pattern-detect.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/10-ai-native-development/pattern-detect.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/10-ai-native-development/pattern-detect.md`
