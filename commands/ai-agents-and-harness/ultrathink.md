...
source_path: "plugins/ultrathink/commands/ultrathink.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/ultrathink/commands/ultrathink.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/ultrathink/commands/ultrathink.md`
