...
description: "Multi-package synchronization and version alignment with ruv-swarm coordination for seamless integration between claude-code-flow and ruv-swarm packages."
category: ai-agents-and-harness
source_repo: ruvnet/RuView
source_path: ".claude/commands/github/sync-coordinator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/github/sync-coordinator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/github/sync-coordinator.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/github/sync-coordinator.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/github/sync-coordinator.md`
