---
name: context-manager-advanced-context-management-and-semantic-underst
description: "/context-manager [scope] [action] [parameters]"
category: ai-agents-and-harness
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/09-agentic-capabilities/context-manager.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/09-agentic-capabilities/context-manager.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/09-agentic-capabilities/context-manager.md`
