...
source_path: ".agents/commands/pr/create-pr.md"
source_url: https://github.com/superset-sh/superset/blob/HEAD/.agents/commands/pr/create-pr.md
---
...
**Source:** [`superset-sh/superset`](https://github.com/superset-sh/superset) → `.agents/commands/pr/create-pr.md`
