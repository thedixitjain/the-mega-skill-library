...
source_path: "plugins/agent-teams/commands/team-shutdown.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/agent-teams/commands/team-shutdown.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/agent-teams/commands/team-shutdown.md`
