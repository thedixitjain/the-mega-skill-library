---
name: superset-execution-plans-execplans
description: "This document describes the requirements for an execution plan (\"ExecPlan\"), a design document that a coding agent can follow to deliver a working feature or system change. Treat the reader as a complete beginner to this repository: they have only the current working tree and the single ExecPlan file you provide. There is no memory of prior plans and no external context."
category: ai-agents-and-harness
source_repo: superset-sh/superset
source_path: ".agents/commands/create-plan.md"
source_url: https://github.com/superset-sh/superset/blob/HEAD/.agents/commands/create-plan.md
---
...
**Source:** [`superset-sh/superset`](https://github.com/superset-sh/superset) → `.agents/commands/create-plan.md`

**Also appears in:** `per-simmons/damon-ade/.agents/commands/create-plan.md`
