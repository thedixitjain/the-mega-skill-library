...
source_path: "plugins/claude-desktop-extension/commands/claude-desktop-extension.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/claude-desktop-extension/commands/claude-desktop-extension.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/claude-desktop-extension/commands/claude-desktop-extension.md`
