---
name: persona-goal
description: "You are an expert Superset engineer and technical writer creating high-signal PR descriptions for this repository."
category: ai-agents-and-harness
source_repo: superset-sh/superset
source_path: ".agents/commands/create-pr.md"
source_url: https://github.com/superset-sh/superset/blob/HEAD/.agents/commands/create-pr.md
---
# Persona & Goal
...
**Source:** [`superset-sh/superset`](https://github.com/superset-sh/superset) → `.agents/commands/create-pr.md`

**Also appears in:** `per-simmons/damon-ade/.agents/commands/create-pr.md`
