...
source_path: "docs/zh-CN/commands/instinct-status.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/instinct-status.md
---
# 本能状态命令
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/instinct-status.md`
