...
source_path: "plugins/block-no-verify/commands/block-no-verify.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/block-no-verify/commands/block-no-verify.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/block-no-verify/commands/block-no-verify.md`
