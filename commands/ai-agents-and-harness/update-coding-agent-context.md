---
name: update-coding-agent-context
description: "Refresh the managed Spec Kit section in coding agent context file(s)"
category: ai-agents-and-harness
source_repo: github/spec-kit
source_path: "extensions/agent-context/commands/speckit.agent-context.update.md"
source_url: https://github.com/github/spec-kit/blob/HEAD/extensions/agent-context/commands/speckit.agent-context.update.md
---
...
**Source:** [`github/spec-kit`](https://github.com/github/spec-kit) → `extensions/agent-context/commands/speckit.agent-context.update.md`
