...
source_path: "plugins/ship-mate/commands/setup.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/ship-mate/commands/setup.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/ship-mate/commands/setup.md`
