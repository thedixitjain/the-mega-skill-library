...
source_path: "docs/es/commands/instinct-status.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/instinct-status.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/instinct-status.md`
