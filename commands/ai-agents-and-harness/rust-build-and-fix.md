...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/rust-build.md
---
# Rust Build and Fix
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/rust-build.md`
