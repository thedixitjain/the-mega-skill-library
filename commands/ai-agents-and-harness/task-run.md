...
source_path: ".agents/commands/task-run.md"
source_url: https://github.com/superset-sh/superset/blob/HEAD/.agents/commands/task-run.md
---
...
**Source:** [`superset-sh/superset`](https://github.com/superset-sh/superset) → `.agents/commands/task-run.md`

**Also appears in:** `per-simmons/damon-ade/.agents/commands/task-run.md`
