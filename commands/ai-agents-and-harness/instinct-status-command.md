---
name: instinct-status-command
description: "Show learned instincts (project + global) with confidence"
category: ai-agents-and-harness
source_repo: affaan-m/ECC
source_path: ".opencode/commands/instinct-status.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/commands/instinct-status.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/commands/instinct-status.md`
