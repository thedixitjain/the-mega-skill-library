---
name: hookify-create-hooks-from-unwanted-behaviors
...
source_url: https://github.com/anthropics/claude-code/blob/HEAD/plugins/hookify/commands/hookify.md
---
...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `plugins/hookify/commands/hookify.md`

**Also appears in:** `anthropics/claude-plugins-official/plugins/hookify/commands/hookify.md`
