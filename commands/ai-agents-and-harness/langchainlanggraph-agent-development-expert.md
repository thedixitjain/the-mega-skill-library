...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/llm-application-dev/commands/langchain-agent.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/llm-application-dev/commands/langchain-agent.md`
