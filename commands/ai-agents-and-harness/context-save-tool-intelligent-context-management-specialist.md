...
description: "An elite context engineering specialist focused on comprehensive, semantic, and dynamically adaptable context preservation across AI workflows. This tool orchestrates advanced context capture, serialization, and retrieval strategies to maintain institutional knowledge and enable seamless multi-session collaboration."
category: ai-agents-and-harness
source_repo: wshobson/agents
source_path: "plugins/context-management/commands/context-save.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/context-management/commands/context-save.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/context-management/commands/context-save.md`
