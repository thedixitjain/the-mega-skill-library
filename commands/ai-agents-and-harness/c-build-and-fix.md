...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/cpp-build.md
---
# C++ Build and Fix
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/cpp-build.md`
