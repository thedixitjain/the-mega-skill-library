...
source_path: "plugins/devops/docker-compose-generator/commands/docker-compose.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/devops/docker-compose-generator/commands/docker-compose.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/devops/docker-compose-generator/commands/docker-compose.md`
