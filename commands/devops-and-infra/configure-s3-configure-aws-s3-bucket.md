---
name: configure-s3-configure-aws-s3-bucket
description: "Create and configure an S3 bucket with security best practices."
category: devops-and-infra
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/aws-helper/commands/configure-s3.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/aws-helper/commands/configure-s3.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/aws-helper/commands/configure-s3.md`
