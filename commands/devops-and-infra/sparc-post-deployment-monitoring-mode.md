...
source_path: ".claude/commands/sparc/post-deployment-monitoring-mode.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/sparc/post-deployment-monitoring-mode.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/sparc/post-deployment-monitoring-mode.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/sparc/post-deployment-monitoring-mode.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/sparc/post-deployment-monitoring-mode.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/sparc/post-deployment-monitoring-mode.md`
