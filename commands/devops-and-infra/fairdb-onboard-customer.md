...
source_path: "plugins/devops/fairdb-operations-kit/commands/fairdb-onboard-customer.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/devops/fairdb-operations-kit/commands/fairdb-onboard-customer.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/devops/fairdb-operations-kit/commands/fairdb-onboard-customer.md`
