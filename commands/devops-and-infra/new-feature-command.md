...
description: "This command provides a complete feature development workflow from planning to deployment."
category: devops-and-infra
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/08-extras/new-feature.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/08-extras/new-feature.md
---
# New-Feature Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/08-extras/new-feature.md`
