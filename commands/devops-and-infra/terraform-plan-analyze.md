...
source_path: "plugins/packages/devops-automation-pack/plugins/05-terraform/commands/terraform-plan-analyze.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/packages/devops-automation-pack/plugins/05-terraform/commands/terraform-plan-analyze.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/packages/devops-automation-pack/plugins/05-terraform/commands/terraform-plan-analyze.md`
