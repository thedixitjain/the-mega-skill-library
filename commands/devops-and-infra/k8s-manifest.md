---
name: k8s-manifest
description: "Generate Kubernetes manifests for deploying the current application."
category: devops-and-infra
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "commands/devops/k8s-manifest.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/commands/devops/k8s-manifest.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `commands/devops/k8s-manifest.md`
