...
source_path: "plugins/deploy-pilot/commands/k8s-manifest.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/deploy-pilot/commands/k8s-manifest.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/deploy-pilot/commands/k8s-manifest.md`
