...
description: "Generate production-ready Kubernetes manifests from application configuration."
category: devops-and-infra
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/k8s-helper/commands/generate-manifest.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/k8s-helper/commands/generate-manifest.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/k8s-helper/commands/generate-manifest.md`
