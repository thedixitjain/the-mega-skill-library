...
source_path: ".claude/commands/05-deployment/setup-ci.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/05-deployment/setup-ci.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/05-deployment/setup-ci.md`
