...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/deployment-validation/commands/config-validate.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/deployment-validation/commands/config-validate.md`
