...
description: "Please help me ensure we're ready to deploy to ${ENVIRONMENT:-production}."
category: devops-and-infra
source_repo: cassler/awesome-claude-code-setup
source_path: "commands/pre-deploy-check.md"
source_url: https://github.com/cassler/awesome-claude-code-setup/blob/HEAD/commands/pre-deploy-check.md
---
...
**Source:** [`cassler/awesome-claude-code-setup`](https://github.com/cassler/awesome-claude-code-setup) → `commands/pre-deploy-check.md`
