...
source_path: "plugins/all-commands/commands/setup-kubernetes-deployment.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/setup-kubernetes-deployment.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/setup-kubernetes-deployment.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-ci-deployment/commands/setup-kubernetes-deployment.md`
