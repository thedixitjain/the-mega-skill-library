...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/observability-monitoring/commands/monitor-setup.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/observability-monitoring/commands/monitor-setup.md`
