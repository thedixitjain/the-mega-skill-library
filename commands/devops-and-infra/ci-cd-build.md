...
source_path: "plugins/devops/ci-cd-pipeline-builder/commands/ci-cd-build.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/devops/ci-cd-pipeline-builder/commands/ci-cd-build.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/devops/ci-cd-pipeline-builder/commands/ci-cd-build.md`
