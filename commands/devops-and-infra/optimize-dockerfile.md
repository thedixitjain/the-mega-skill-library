...
source_path: "plugins/docker-helper/commands/optimize-dockerfile.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/docker-helper/commands/optimize-dockerfile.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/docker-helper/commands/optimize-dockerfile.md`
