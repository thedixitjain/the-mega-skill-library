...
source_path: ".claude/commands/06-collaboration/monitor.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/06-collaboration/monitor.md
---
# Monitor
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/06-collaboration/monitor.md`
