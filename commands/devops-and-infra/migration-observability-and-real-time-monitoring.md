...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/database-migrations/commands/migration-observability.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/database-migrations/commands/migration-observability.md`
