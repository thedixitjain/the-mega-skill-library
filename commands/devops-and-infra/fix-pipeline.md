...
source_path: "plugins/ci-debugger/commands/fix-pipeline.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/ci-debugger/commands/fix-pipeline.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/ci-debugger/commands/fix-pipeline.md`
