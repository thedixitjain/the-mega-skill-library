...
source_path: "plugins/devops/kubernetes-deployment-creator/commands/k8s-deploy.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/devops/kubernetes-deployment-creator/commands/k8s-deploy.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/devops/kubernetes-deployment-creator/commands/k8s-deploy.md`
