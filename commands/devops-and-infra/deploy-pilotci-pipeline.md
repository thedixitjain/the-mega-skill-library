---
name: deploy-pilotci-pipeline
description: "Generate a GitHub Actions CI/CD workflow tailored to the current project."
category: devops-and-infra
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/deploy-pilot/commands/ci-pipeline.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/deploy-pilot/commands/ci-pipeline.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/deploy-pilot/commands/ci-pipeline.md`
