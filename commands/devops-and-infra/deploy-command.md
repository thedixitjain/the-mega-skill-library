---
name: deploy-command
description: "This command provides access to comprehensive CI/CD pipeline and Infrastructure as Code prompts."
category: devops-and-infra
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/05-deployment/deploy.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/05-deployment/deploy.md
---
# Deploy Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/05-deployment/deploy.md`
