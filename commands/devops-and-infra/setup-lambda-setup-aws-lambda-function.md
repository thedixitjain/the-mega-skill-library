---
name: setup-lambda-setup-aws-lambda-function
description: "Configure and deploy an AWS Lambda function with proper settings."
category: devops-and-infra
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/aws-helper/commands/setup-lambda.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/aws-helper/commands/setup-lambda.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/aws-helper/commands/setup-lambda.md`
