...
source_path: "plugins/performance/infrastructure-metrics-collector/commands/collect-metrics.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/performance/infrastructure-metrics-collector/commands/collect-metrics.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/performance/infrastructure-metrics-collector/commands/collect-metrics.md`
