---
name: create-module-create-terraform-module
description: "Create a reusable Terraform module for infrastructure provisioning."
category: devops-and-infra
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/terraform-helper/commands/create-module.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/terraform-helper/commands/create-module.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/terraform-helper/commands/create-module.md`
