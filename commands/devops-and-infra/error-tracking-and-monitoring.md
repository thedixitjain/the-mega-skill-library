...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/error-debugging/commands/error-trace.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/error-debugging/commands/error-trace.md`

**Also appears in:** `wshobson/agents/plugins/error-diagnostics/commands/error-trace.md`
