---
name: rollback-deploy-command
description: "Rollback deployment to previous version"
allowed-tools: "Bash(npm *)"
category: devops-and-infra
source_repo: davepoon/buildwithclaude
source_path: "plugins/all-commands/commands/rollback-deploy.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/rollback-deploy.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/rollback-deploy.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-ci-deployment/commands/rollback-deploy.md`
