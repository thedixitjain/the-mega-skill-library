...
source_path: "plugins/all-commands/commands/containerize-application.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/containerize-application.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/containerize-application.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-ci-deployment/commands/containerize-application.md`
