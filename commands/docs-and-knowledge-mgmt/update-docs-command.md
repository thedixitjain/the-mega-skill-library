...
source_path: ".opencode/commands/update-docs.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/commands/update-docs.md
---
# Update Docs Command
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/commands/update-docs.md`
