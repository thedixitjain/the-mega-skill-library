---
name: execute-マルチモデル協調実装
description: "マルチモデル協調実装 - 計画からプロトタイプを取得 → Claudeがリファクタリングして実装 → マルチモデル監査と配信。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/commands/multi-execute.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/multi-execute.md
---
# Execute - マルチモデル協調実装
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/multi-execute.md`
