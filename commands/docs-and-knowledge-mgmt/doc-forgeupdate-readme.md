---
name: doc-forgeupdate-readme
description: "Update or create a README.md that accurately reflects the current state of the project."
category: docs-and-knowledge-mgmt
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/doc-forge/commands/update-readme.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/doc-forge/commands/update-readme.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/doc-forge/commands/update-readme.md`
