---
name: sessions-komutu
description: "Claude Code session geçmişini, aliasları ve session metadata'sını yönet."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/sessions.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/sessions.md
---
# Sessions Komutu
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/sessions.md`
