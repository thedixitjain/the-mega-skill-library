---
name: plan-multi-model-işbirlikçi-planlama
description: "Multi-model işbirlikçi planlama - Context retrieval + Dual-model analiz → Adım adım implementation planı oluştur."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/multi-plan.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/multi-plan.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/multi-plan.md`
