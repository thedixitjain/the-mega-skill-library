...
source_path: "plugins/database/database-documentation-gen/commands/db-docs.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/database/database-documentation-gen/commands/db-docs.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/database/database-documentation-gen/commands/db-docs.md`
