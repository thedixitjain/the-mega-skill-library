...
source_path: "docs/ko-KR/commands/update-docs.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/commands/update-docs.md
---
# 문서 업데이트
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/commands/update-docs.md`
