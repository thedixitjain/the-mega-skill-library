...
description: "This command provides access to comprehensive documentation generation and knowledge management prompts."
category: docs-and-knowledge-mgmt
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/01-project-setup/document.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/01-project-setup/document.md
---
# Document Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/01-project-setup/document.md`
