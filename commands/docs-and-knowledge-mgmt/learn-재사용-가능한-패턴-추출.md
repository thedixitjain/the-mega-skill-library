---
name: learn-재사용-가능한-패턴-추출
description: "현재 세션을 분석하고 스킬로 저장할 가치가 있는 패턴을 추출합니다."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ko-KR/commands/learn.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/commands/learn.md
---
# /learn - 재사용 가능한 패턴 추출
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/commands/learn.md`
