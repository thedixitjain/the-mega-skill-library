...
source_path: "docs/zh-TW/commands/setup-pm.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-TW/commands/setup-pm.md
---
# 套件管理器設定
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-TW/commands/setup-pm.md`
