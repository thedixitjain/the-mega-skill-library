---
name: execute-multi-model-işbirlikçi-execution
description: "Multi-model işbirlikçi execution - Plandan prototype al → Claude refactor edip implement eder → Multi-model audit ve teslimat."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/multi-execute.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/multi-execute.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/multi-execute.md`
