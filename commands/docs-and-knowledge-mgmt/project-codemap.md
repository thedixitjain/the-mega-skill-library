...
description: "Update the project codemap to reflect the current state of the codebase."
category: docs-and-knowledge-mgmt
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "commands/documentation/update-codemap.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/commands/documentation/update-codemap.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `commands/documentation/update-codemap.md`
