...
source_path: "docs/es/commands/build-fix.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/build-fix.md
---
# Build y Corrección
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/build-fix.md`
