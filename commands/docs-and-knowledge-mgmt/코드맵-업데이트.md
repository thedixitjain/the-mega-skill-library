---
name: 코드맵-업데이트
description: "코드베이스 구조를 분석하고 토큰 효율적인 아키텍처 문서를 생성합니다."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ko-KR/commands/update-codemaps.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/commands/update-codemaps.md
---
# 코드맵 업데이트
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/commands/update-codemaps.md`
