---
name: evalコマンド
description: "評価駆動開発ワークフローを管理します。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/commands/eval.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/eval.md
---
# Evalコマンド
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/eval.md`
