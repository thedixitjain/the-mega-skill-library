---
name: 更新文档
description: "将文档与代码库同步，从单一事实来源文件生成。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/update-docs.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/update-docs.md
---
# 更新文档
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/update-docs.md`
