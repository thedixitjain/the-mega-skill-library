...
source_path: "engineering/llm-wiki/commands/wiki-query.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/llm-wiki/commands/wiki-query.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/llm-wiki/commands/wiki-query.md`
