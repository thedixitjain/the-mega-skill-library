...
source_path: "docs/zh-CN/commands/gan-build.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/gan-build.md
---
从 $ARGUMENTS 中解析以下内容：
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/gan-build.md`
