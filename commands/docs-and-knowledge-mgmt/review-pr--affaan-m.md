...
source_path: "docs/zh-CN/commands/review-pr.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/review-pr.md
---
对拉取请求进行全面的多视角审查。
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/review-pr.md`
