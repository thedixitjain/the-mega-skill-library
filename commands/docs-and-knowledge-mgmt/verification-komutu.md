---
name: verification-komutu
description: "Mevcut kod tabanı durumu üzerinde kapsamlı doğrulama çalıştır."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/verify.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/verify.md
---
# Verification Komutu
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/verify.md`
