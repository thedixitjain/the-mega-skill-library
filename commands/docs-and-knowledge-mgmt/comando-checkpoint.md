...
source_path: "docs/es/commands/checkpoint.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/checkpoint.md
---
# Comando Checkpoint
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/checkpoint.md`
