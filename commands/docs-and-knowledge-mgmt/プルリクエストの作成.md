...
source_path: "docs/ja-JP/commands/pr.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/pr.md
---
# プルリクエストの作成
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/pr.md`
