---
name: pm2-初始化
description: "自动分析项目并生成 PM2 服务命令。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/pm2.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/pm2.md
---
# PM2 初始化
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/pm2.md`
