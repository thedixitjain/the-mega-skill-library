---
name: 更新代码地图
description: "分析代码库结构并生成简洁的架构文档。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/update-codemaps.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/update-codemaps.md
---
# 更新代码地图
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/update-codemaps.md`
