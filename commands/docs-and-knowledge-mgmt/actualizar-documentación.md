...
source_path: "docs/es/commands/update-docs.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/update-docs.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/update-docs.md`
