...
source_path: "docs/ko-KR/commands/setup-pm.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/commands/setup-pm.md
---
# 패키지 매니저 설정
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/commands/setup-pm.md`
