---
name: learn-eval-抽出評価そして保存
description: "セッションから再利用可能なパターンを抽出し、保存前に品質を自己評価し、適切な保存場所（グローバル vs プロジェクト）を決定します。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/commands/learn-eval.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/learn-eval.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/learn-eval.md`
