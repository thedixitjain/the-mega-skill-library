---
name: 后端-后端导向开发
description: "后端导向的工作流程（研究 → 构思 → 规划 → 执行 → 优化 → 评审），由 Codex 主导。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/multi-backend.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/multi-backend.md
---
# 后端 - 后端导向开发
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/multi-backend.md`
