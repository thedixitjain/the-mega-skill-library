...
source_path: ".claude/commands/update-docs.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/.claude/commands/update-docs.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `.claude/commands/update-docs.md`
