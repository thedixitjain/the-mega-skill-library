---
name: comando-eval
description: "Gestionar el flujo de trabajo de desarrollo orientado a evals."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/es/commands/eval.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/eval.md
---
# Comando Eval
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/eval.md`
