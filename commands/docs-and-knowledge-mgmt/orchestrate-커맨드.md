---
name: orchestrate-커맨드
description: "복잡한 작업을 위한 순차적 에이전트 워크플로우입니다."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ko-KR/commands/orchestrate.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/commands/orchestrate.md
---
# Orchestrate 커맨드
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/commands/orchestrate.md`
