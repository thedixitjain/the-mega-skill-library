...
source_path: "docs/zh-CN/commands/setup-pm.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/setup-pm.md
---
# 包管理器设置
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/setup-pm.md`
