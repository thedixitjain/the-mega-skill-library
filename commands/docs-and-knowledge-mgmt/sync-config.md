...
source_path: "distribution/claude-plugin/commands/sync-config.md"
source_url: https://github.com/yusufkaraaslan/Skill_Seekers/blob/HEAD/distribution/claude-plugin/commands/sync-config.md
---
...
**Source:** [`yusufkaraaslan/Skill_Seekers`](https://github.com/yusufkaraaslan/Skill_Seekers) → `distribution/claude-plugin/commands/sync-config.md`
