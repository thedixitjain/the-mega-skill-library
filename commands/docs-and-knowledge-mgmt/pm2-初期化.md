---
name: pm2-初期化
description: "プロジェクトを自動分析し、PM2サービスコマンドを生成します。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/commands/pm2.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/pm2.md
---
# PM2 初期化
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/pm2.md`
