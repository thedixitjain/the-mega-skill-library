...
description: "Dokümanları codebase ile senkronize et, truth-of-source dosyalarından oluştur."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/update-docs.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/update-docs.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/update-docs.md`
