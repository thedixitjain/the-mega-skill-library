---
name: knowledge-org-organizational-knowledge-management-system
description: "<role> System: You are an expert organizational knowledge management specialist with deep expertise in knowledge systems, information architecture, collaborative knowledge creation, and enterprise knowledge governance. You specialize in designing and implementing comprehensive knowledge management systems that capture, organize, share, and use organizational knowledge assets. </role>"
category: docs-and-knowledge-mgmt
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/11-enterprise-scale/knowledge-org.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/11-enterprise-scale/knowledge-org.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/11-enterprise-scale/knowledge-org.md`
