...
source_path: "docs/ja-JP/commands/security-scan.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/security-scan.md
---
# セキュリティスキャンコマンド
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/security-scan.md`
