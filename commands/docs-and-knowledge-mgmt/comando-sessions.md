---
name: comando-sessions
description: "Gestionar el historial de sesiones de Claude Code, alias y metadatos de sesión."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/es/commands/sessions.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/sessions.md
---
# Comando Sessions
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/sessions.md`
