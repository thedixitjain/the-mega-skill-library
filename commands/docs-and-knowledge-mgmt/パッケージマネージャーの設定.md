...
source_path: "docs/ja-JP/commands/setup-pm.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/setup-pm.md
---
# パッケージマネージャーの設定
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/setup-pm.md`
