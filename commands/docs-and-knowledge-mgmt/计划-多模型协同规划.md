---
name: 计划-多模型协同规划
description: "多模型协同规划 - 上下文检索 + 双模型分析 → 生成分步实施计划。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/multi-plan.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/multi-plan.md
---
# 计划 - 多模型协同规划
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/multi-plan.md`
