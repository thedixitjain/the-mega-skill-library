---
name: atualizar-codemaps
description: "Analise a estrutura do codebase e gere documentação arquitetural enxuta em tokens."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/pt-BR/commands/update-codemaps.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/commands/update-codemaps.md
---
# Atualizar Codemaps
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/commands/update-codemaps.md`
