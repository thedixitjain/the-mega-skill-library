---
name: comando-verify
description: "Ejecutar verificación exhaustiva sobre el estado actual del código base."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/es/commands/verify.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/verify.md
---
# Comando Verify
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/verify.md`
