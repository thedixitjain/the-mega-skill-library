...
source_path: "docs/ja-JP/commands/gradle-build.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/gradle-build.md
---
# Gradleビルド修正
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/gradle-build.md`
