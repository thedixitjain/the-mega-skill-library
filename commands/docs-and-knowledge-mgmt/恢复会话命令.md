...
source_path: "docs/zh-CN/commands/resume-session.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/resume-session.md
---
# 恢复会话命令
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/resume-session.md`
