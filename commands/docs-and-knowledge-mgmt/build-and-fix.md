---
name: build-and-fix
description: "Build ve tip hatalarını minimal, güvenli değişikliklerle aşamalı olarak düzelt."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/build-fix.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/build-fix.md
---
# Build and Fix
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/build-fix.md`
