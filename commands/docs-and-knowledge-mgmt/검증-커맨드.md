...
source_path: "docs/ko-KR/commands/verify.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/commands/verify.md
---
# 검증 커맨드
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/commands/verify.md`
