---
name: configuração-de-package-manager
description: "Configure seu package manager preferido (npm/pnpm/yarn/bun)"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/pt-BR/commands/setup-pm.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/commands/setup-pm.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/commands/setup-pm.md`
