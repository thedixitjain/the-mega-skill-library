...
source_path: "docs/es/commands/code-review.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/code-review.md
---
# Revisión de Código
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/code-review.md`
