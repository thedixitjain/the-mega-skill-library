...
description: "Analise cobertura de testes, identifique lacunas e gere testes faltantes para alcançar cobertura de 80%+."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/pt-BR/commands/test-coverage.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/commands/test-coverage.md
---
# Cobertura de Testes
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/commands/test-coverage.md`
