---
name: learn-再利用可能なパターンの抽出
description: "現在のセッションを分析し、スキルとして保存する価値のあるパターンを抽出します。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/commands/learn.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/learn.md
---
# /learn - 再利用可能なパターンの抽出
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/learn.md`
