...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/code-documentation/commands/doc-generate.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/code-documentation/commands/doc-generate.md`

**Also appears in:** `wshobson/agents/plugins/documentation-generation/commands/doc-generate.md`
