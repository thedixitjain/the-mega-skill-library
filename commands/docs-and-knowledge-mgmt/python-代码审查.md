...
source_path: "docs/zh-CN/commands/python-review.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/python-review.md
---
# Python 代码审查
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/python-review.md`
