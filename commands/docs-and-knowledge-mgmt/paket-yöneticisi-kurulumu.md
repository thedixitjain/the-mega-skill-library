---
name: paket-yöneticisi-kurulumu
description: "Tercih ettiğiniz paket yöneticisini yapılandırın (npm/pnpm/yarn/bun)"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/setup-pm.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/setup-pm.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/setup-pm.md`
