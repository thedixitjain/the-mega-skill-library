---
name: コードマップの更新
description: "コードベース構造を分析してアーキテクチャドキュメントを更新します。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/commands/update-codemaps.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/update-codemaps.md
---
# コードマップの更新
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/update-codemaps.md`
