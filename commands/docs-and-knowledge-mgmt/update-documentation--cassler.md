...
description: "Please update the project documentation to reflect recent changes:"
category: docs-and-knowledge-mgmt
source_repo: cassler/awesome-claude-code-setup
source_path: "commands/update-docs.md"
source_url: https://github.com/cassler/awesome-claude-code-setup/blob/HEAD/commands/update-docs.md
---
...
**Source:** [`cassler/awesome-claude-code-setup`](https://github.com/cassler/awesome-claude-code-setup) → `commands/update-docs.md`
