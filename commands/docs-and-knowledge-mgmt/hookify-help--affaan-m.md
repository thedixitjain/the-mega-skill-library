...
source_path: "docs/zh-CN/commands/hookify-help.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/hookify-help.md
---
显示完整的 hookify 文档。
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/hookify-help.md`
