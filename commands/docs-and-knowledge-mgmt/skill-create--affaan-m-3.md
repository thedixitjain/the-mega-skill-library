...
source_path: "docs/zh-CN/commands/skill-create.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/skill-create.md
---
# /skill-create - 本地技能生成
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/skill-create.md`
