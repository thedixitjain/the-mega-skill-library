...
source_path: "docs/es/commands/plan.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/plan.md
---
# Comando Plan
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/plan.md`
