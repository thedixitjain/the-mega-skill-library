---
name: sessionsコマンド
description: "Claude Codeセッション履歴を管理 - ~/.claude/session-data/ に保存されたセッションのリスト表示、読み込み、エイリアス設定、編集を行います。旧 ~/.claude/sessions/ のファイルも後方互換のために読み取ります。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/commands/sessions.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/sessions.md
---
# Sessionsコマンド
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/sessions.md`
