---
name: comando-orchestrate
description: "Orientação de orquestração sequencial e tmux/worktree para fluxos multiagente."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/pt-BR/commands/orchestrate.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/commands/orchestrate.md
---
# Comando Orchestrate
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/commands/orchestrate.md`
