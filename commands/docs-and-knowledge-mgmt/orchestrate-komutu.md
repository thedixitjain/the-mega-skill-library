---
name: orchestrate-komutu
description: "Multi-agent iş akışları için sıralı ve tmux/worktree orkestrasyon rehberi."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/orchestrate.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/orchestrate.md
---
# Orchestrate Komutu
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/orchestrate.md`
