---
name: 前端-前端聚焦开发
description: "前端聚焦的工作流（研究 → 构思 → 规划 → 执行 → 优化 → 评审），由 Gemini 主导。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/multi-frontend.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/multi-frontend.md
---
# 前端 - 前端聚焦开发
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/multi-frontend.md`
