...
source_path: "docs/ja-JP/commands/gan-build.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/gan-build.md
---
$ARGUMENTSから以下を解析:
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/gan-build.md`
