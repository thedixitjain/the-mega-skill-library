---
name: deep-wiki-deploy-to-github-pages
description: "Generate a GitHub Actions workflow to deploy the VitePress wiki site to GitHub Pages"
category: docs-and-knowledge-mgmt
source_repo: microsoft/skills
source_path: ".github/plugins/deep-wiki/commands/deploy.md"
source_url: https://github.com/microsoft/skills/blob/HEAD/.github/plugins/deep-wiki/commands/deploy.md
---
...
**Source:** [`microsoft/skills`](https://github.com/microsoft/skills) → `.github/plugins/deep-wiki/commands/deploy.md`
