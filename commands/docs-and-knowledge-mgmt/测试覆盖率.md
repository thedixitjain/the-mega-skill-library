---
name: 测试覆盖率
description: "分析测试覆盖率，识别缺口，并生成缺失的测试以达到 80%+ 的覆盖率。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/test-coverage.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/test-coverage.md
---
# 测试覆盖率
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/test-coverage.md`
