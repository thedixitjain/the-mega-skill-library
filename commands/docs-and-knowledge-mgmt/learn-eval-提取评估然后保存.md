---
name: learn-eval-提取评估然后保存
description: "从会话中提取可重用模式，在保存前自我评估质量，并确定正确的保存位置（全局与项目）。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/learn-eval.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/learn-eval.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/learn-eval.md`
