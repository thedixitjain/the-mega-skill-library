...
source_path: "docs/es/commands/test-coverage.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/test-coverage.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/test-coverage.md`
