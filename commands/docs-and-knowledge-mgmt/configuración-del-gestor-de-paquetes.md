---
name: configuración-del-gestor-de-paquetes
description: "Configurar tu gestor de paquetes preferido (npm/pnpm/yarn/bun)"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/es/commands/setup-pm.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/setup-pm.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/setup-pm.md`
