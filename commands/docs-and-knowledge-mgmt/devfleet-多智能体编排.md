---
name: devfleet-多智能体编排
description: "通过Claude DevFleet协调并行Claude Code代理——从自然语言规划项目，在隔离的工作树中调度代理，监控进度，并读取结构化报告。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/devfleet.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/devfleet.md
---
# DevFleet — 多智能体编排
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/devfleet.md`
