...
source_path: "docs/zh-CN/commands/rust-test.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/rust-test.md
---
# Rust TDD 命令
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/rust-test.md`
