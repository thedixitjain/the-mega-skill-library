...
source_path: "docs/ja-JP/commands/project-init.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/project-init.md
---
# /project-init
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/project-init.md`
