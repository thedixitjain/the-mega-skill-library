---
name: comando-verification
description: "Rode verificação abrangente no estado atual do codebase."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/pt-BR/commands/verify.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/commands/verify.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/commands/verify.md`
