---
name: 코드-리뷰
description: "커밋되지 않은 변경사항에 대한 포괄적인 보안 및 품질 리뷰를 수행합니다:"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/ko-KR/commands/code-review.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/commands/code-review.md
---
# 코드 리뷰
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/commands/code-review.md`
