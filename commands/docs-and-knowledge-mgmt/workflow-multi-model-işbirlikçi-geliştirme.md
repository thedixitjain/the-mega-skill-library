---
name: workflow-multi-model-işbirlikçi-geliştirme
description: "Multi-model işbirlikçi geliştirme iş akışı (Research → Ideation → Plan → Execute → Optimize → Review), akıllı yönlendirme ile: Frontend → Gemini, Backend → Codex."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/multi-workflow.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/multi-workflow.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/multi-workflow.md`
