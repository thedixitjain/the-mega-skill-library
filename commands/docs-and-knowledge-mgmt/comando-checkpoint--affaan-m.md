---
name: comando-checkpoint
description: "Crie ou verifique um checkpoint no seu fluxo."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/pt-BR/commands/checkpoint.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/commands/checkpoint.md
---
# Comando Checkpoint
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/commands/checkpoint.md`
