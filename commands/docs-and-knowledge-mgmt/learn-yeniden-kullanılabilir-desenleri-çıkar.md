---
name: learn-yeniden-kullanılabilir-desenleri-çıkar
description: "Mevcut oturumu analiz et ve skill olarak kaydetmeye değer desenleri çıkar."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/learn.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/learn.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/learn.md`
