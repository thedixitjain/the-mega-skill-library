---
name: build-e-correção
description: "Corrija erros de build e de tipos incrementalmente com mudanças mínimas e seguras."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/pt-BR/commands/build-fix.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/commands/build-fix.md
---
# Build e Correção
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/commands/build-fix.md`
