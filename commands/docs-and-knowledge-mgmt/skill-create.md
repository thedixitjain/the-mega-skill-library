...
source_path: "docs/es/commands/skill-create.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/skill-create.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/skill-create.md`
