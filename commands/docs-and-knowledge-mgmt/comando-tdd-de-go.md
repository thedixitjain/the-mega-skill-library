...
source_path: "docs/es/commands/go-test.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/go-test.md
---
# Comando TDD de Go
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/go-test.md`
