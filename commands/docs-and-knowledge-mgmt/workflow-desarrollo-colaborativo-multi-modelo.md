---
name: workflow-desarrollo-colaborativo-multi-modelo
...
source_path: "docs/es/commands/multi-workflow.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/multi-workflow.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/multi-workflow.md`
