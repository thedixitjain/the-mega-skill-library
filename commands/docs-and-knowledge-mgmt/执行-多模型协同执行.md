---
name: 执行-多模型协同执行
description: "多模型协同执行 - 从计划获取原型 → Claude 重构并实施 → 多模型审计与交付。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/multi-execute.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/multi-execute.md
---
# 执行 - 多模型协同执行
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/multi-execute.md`
