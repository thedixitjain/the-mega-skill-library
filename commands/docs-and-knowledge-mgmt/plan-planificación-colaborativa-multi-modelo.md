---
name: plan-planificación-colaborativa-multi-modelo
...
source_path: "docs/es/commands/multi-plan.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/commands/multi-plan.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/commands/multi-plan.md`
