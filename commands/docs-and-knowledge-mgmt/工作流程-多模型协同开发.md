---
name: 工作流程-多模型协同开发
description: "多模型协同开发工作流程（研究 → 构思 → 规划 → 执行 → 优化 → 审查），带有智能路由：前端 → Gemini，后端 → Codex。"
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: "docs/zh-CN/commands/multi-workflow.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/commands/multi-workflow.md
---
# 工作流程 - 多模型协同开发
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/commands/multi-workflow.md`
