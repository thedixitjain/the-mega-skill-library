...
source_path: "docs/ko-KR/commands/eval.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/commands/eval.md
---
# Eval 커맨드
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/commands/eval.md`
