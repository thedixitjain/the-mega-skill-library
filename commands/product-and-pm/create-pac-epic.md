...
source_path: "plugins/all-commands/commands/pac-create-epic.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/pac-create-epic.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/pac-create-epic.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-task-management/commands/pac-create-epic.md`
