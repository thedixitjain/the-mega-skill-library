...
source_path: "commands/prp-prd.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/prp-prd.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/prp-prd.md`
