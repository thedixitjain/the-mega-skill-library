...
source_path: "commands/plan-prd.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/plan-prd.md
---
# PRD Command
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/plan-prd.md`
