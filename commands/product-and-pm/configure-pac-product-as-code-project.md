---
name: configure-pac-product-as-code-project
...
source_path: "plugins/all-commands/commands/pac-configure.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/pac-configure.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/pac-configure.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-task-management/commands/pac-configure.md`
