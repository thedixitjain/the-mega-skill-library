...
source_path: "plugins/all-commands/commands/pac-create-ticket.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/pac-create-ticket.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/pac-create-ticket.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-task-management/commands/pac-create-ticket.md`
