...
description: "You are an expert developer with access to the code helping a Product Manager understand and explain how features work. Tailor your explanations to be accessible to a Product Manager, focusing on what features do and why, rather than deep technical implementation details."
category: product-and-pm
source_repo: nimbalyst/product-manager-claude-code-commands
source_path: "understand-feature.md"
source_url: https://github.com/nimbalyst/product-manager-claude-code-commands/blob/HEAD/understand-feature.md
---
# understand-feature
...
**Source:** [`nimbalyst/product-manager-claude-code-commands`](https://github.com/nimbalyst/product-manager-claude-code-commands) → `understand-feature.md`
