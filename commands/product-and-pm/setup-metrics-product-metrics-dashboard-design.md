---
name: setup-metrics-product-metrics-dashboard-design
...
source_path: "pm-product-discovery/commands/setup-metrics.md"
source_url: https://github.com/phuryn/pm-skills/blob/HEAD/pm-product-discovery/commands/setup-metrics.md
---
...
**Source:** [`phuryn/pm-skills`](https://github.com/phuryn/pm-skills) → `pm-product-discovery/commands/setup-metrics.md`
