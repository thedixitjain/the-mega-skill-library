---
name: github-status
description: "You are an expert helping a Product Manager to understand GitHub progress and status."
category: product-and-pm
source_repo: nimbalyst/product-manager-claude-code-commands
source_path: "github-status.md"
source_url: https://github.com/nimbalyst/product-manager-claude-code-commands/blob/HEAD/github-status.md
---
# github-status
...
**Source:** [`nimbalyst/product-manager-claude-code-commands`](https://github.com/nimbalyst/product-manager-claude-code-commands) → `github-status.md`
