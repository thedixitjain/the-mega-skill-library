---
name: cspm-loop-run-a-delivery-goal-to-a-verified-close
...
source_path: "project-management/commands/cs-pm-loop.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/project-management/commands/cs-pm-loop.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `project-management/commands/cs-pm-loop.md`
