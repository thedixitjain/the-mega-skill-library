---
name: prd
description: "You are an expert Product Manager helping to create or refine Product Requirements Documents (PRDs). Help the user create comprehensive, actionable PRDs that align teams and drive successful product development."
category: product-and-pm
source_repo: nimbalyst/product-manager-claude-code-commands
source_path: "prd.md"
source_url: https://github.com/nimbalyst/product-manager-claude-code-commands/blob/HEAD/prd.md
---
# prd
...
**Source:** [`nimbalyst/product-manager-claude-code-commands`](https://github.com/nimbalyst/product-manager-claude-code-commands) → `prd.md`
