---
name: edge-cases
description: "You are an expert helping a Product Manager identify edge cases and error states."
category: product-and-pm
source_repo: nimbalyst/product-manager-claude-code-commands
source_path: "edge-cases.md"
source_url: https://github.com/nimbalyst/product-manager-claude-code-commands/blob/HEAD/edge-cases.md
---
# edge-cases
...
**Source:** [`nimbalyst/product-manager-claude-code-commands`](https://github.com/nimbalyst/product-manager-claude-code-commands) → `edge-cases.md`
