---
name: create-prd-generate-product-requirements-document
...
source_path: ".claude/commands/create-prd.md"
source_url: https://github.com/coleam00/ai-transformation-workshop/blob/HEAD/.claude/commands/create-prd.md
---
...
**Source:** [`coleam00/ai-transformation-workshop`](https://github.com/coleam00/ai-transformation-workshop) → `.claude/commands/create-prd.md`
