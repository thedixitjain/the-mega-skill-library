---
name: setup-package-manager-command
description: "Configure package manager preference"
category: product-and-pm
source_repo: affaan-m/ECC
source_path: ".opencode/commands/setup-pm.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/commands/setup-pm.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/commands/setup-pm.md`
