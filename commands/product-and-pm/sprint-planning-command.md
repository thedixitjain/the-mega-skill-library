...
description: "This command automates comprehensive sprint planning with intelligent capacity management and goal optimization."
category: product-and-pm
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/07-utilities/sprint-planning.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/07-utilities/sprint-planning.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/07-utilities/sprint-planning.md`
