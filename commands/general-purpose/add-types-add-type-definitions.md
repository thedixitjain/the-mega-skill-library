---
name: add-types-add-type-definitions
description: "Add TypeScript type definitions to existing TypeScript files with weak typing."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/type-migrator/commands/add-types.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/type-migrator/commands/add-types.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/type-migrator/commands/add-types.md`
