---
name: analyze-complexity-analyze-code-complexity
description: "Calculate cyclomatic complexity and identify overly complex functions."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/complexity-reducer/commands/analyze-complexity.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/complexity-reducer/commands/analyze-complexity.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/complexity-reducer/commands/analyze-complexity.md`
