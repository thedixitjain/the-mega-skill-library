...
description: "This command provides comprehensive project health assessment across multiple dimensions."
category: general-purpose
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/08-extras/health-check.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/08-extras/health-check.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/08-extras/health-check.md`
