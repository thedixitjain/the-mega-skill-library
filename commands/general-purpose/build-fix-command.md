...
source_path: ".opencode/commands/build-fix.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/commands/build-fix.md
---
# Build Fix Command
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/commands/build-fix.md`
