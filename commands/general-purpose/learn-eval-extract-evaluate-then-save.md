---
name: learn-eval-extract-evaluate-then-save
description: "Extract reusable patterns from the session, self-evaluate quality before saving, and determine the right save location (Global vs Project)."
category: general-purpose
source_repo: affaan-m/ECC
source_path: "commands/learn-eval.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/learn-eval.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/learn-eval.md`
