...
source_path: "connect-apps-plugin/commands/setup.md"
source_url: https://github.com/ComposioHQ/awesome-claude-skills/blob/HEAD/connect-apps-plugin/commands/setup.md
---
...
**Source:** [`ComposioHQ/awesome-claude-skills`](https://github.com/ComposioHQ/awesome-claude-skills) → `connect-apps-plugin/commands/setup.md`
