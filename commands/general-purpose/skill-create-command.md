---
name: skill-create-command
description: "Generate skills from git history analysis"
category: general-purpose
source_repo: affaan-m/ECC
source_path: ".opencode/commands/skill-create.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/commands/skill-create.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/commands/skill-create.md`
