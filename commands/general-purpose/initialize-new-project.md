...
source_path: "plugins/all-commands/commands/init-project.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/init-project.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/init-project.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-task-management/commands/init-project.md`
