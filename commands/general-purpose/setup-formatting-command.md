---
name: setup-formatting-command
description: "Configure code formatting tools"
allowed-tools: "Bash(npm *)"
category: general-purpose
source_repo: davepoon/buildwithclaude
source_path: "plugins/all-commands/commands/setup-formatting.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/setup-formatting.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/setup-formatting.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-setup/commands/setup-formatting.md`
