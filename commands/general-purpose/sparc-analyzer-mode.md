---
name: sparc-analyzer-mode
description: "Deep code and data analysis with batch processing capabilities."
category: general-purpose
source_repo: ruvnet/RuView
source_path: ".claude/commands/sparc/analyzer.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/commands/sparc/analyzer.md
---
# SPARC Analyzer Mode
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/commands/sparc/analyzer.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/sparc/analyzer.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/sparc/analyzer.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/commands/sparc/analyzer.md`
