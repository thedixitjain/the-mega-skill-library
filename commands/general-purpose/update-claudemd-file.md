...
source_path: "plugins/update-claudemd/commands/update-claudemd.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/update-claudemd/commands/update-claudemd.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/update-claudemd/commands/update-claudemd.md`
