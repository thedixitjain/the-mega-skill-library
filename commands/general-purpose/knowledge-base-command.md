---
name: knowledge-base-command
description: "/knowledge-base [action] [scope] [format]"
category: general-purpose
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/07-utilities/knowledge-base.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/07-utilities/knowledge-base.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/07-utilities/knowledge-base.md`
