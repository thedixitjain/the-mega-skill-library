...
source_path: "extensions/bug/commands/speckit.bug.fix.md"
source_url: https://github.com/github/spec-kit/blob/HEAD/extensions/bug/commands/speckit.bug.fix.md
---
# Fix Bug
...
**Source:** [`github/spec-kit`](https://github.com/github/spec-kit) → `extensions/bug/commands/speckit.bug.fix.md`
