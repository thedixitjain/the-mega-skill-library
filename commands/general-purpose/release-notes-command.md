---
name: release-notes-command
description: "This command automates comprehensive release note generation with intelligent content curation and multi-audience formatting."
category: general-purpose
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/07-utilities/release-notes.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/07-utilities/release-notes.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/07-utilities/release-notes.md`
