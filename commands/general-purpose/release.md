...
source_path: ".opencode/commands/release.md"
source_url: https://github.com/different-ai/openwork/blob/HEAD/.opencode/commands/release.md
---
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `.opencode/commands/release.md`
