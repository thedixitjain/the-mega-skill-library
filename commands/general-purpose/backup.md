...
source_path: ".claude/commands/02-development/backup.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/02-development/backup.md
---
# Backup
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/02-development/backup.md`
