...
source_path: "plugins/all-commands/commands/project-to-linear.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/project-to-linear.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/project-to-linear.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-task-management/commands/project-to-linear.md`
