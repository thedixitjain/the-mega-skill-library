...
source_path: "plugins/all-commands/commands/bidirectional-sync.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/bidirectional-sync.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/bidirectional-sync.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-integration-sync/commands/bidirectional-sync.md`
