...
source_url: https://github.com/anthropics/claude-code/blob/HEAD/plugins/hookify/commands/configure.md
---
...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `plugins/hookify/commands/configure.md`

**Also appears in:** `anthropics/claude-plugins-official/plugins/hookify/commands/configure.md`
