...
source_path: ".claude/commands/review-issue.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/.claude/commands/review-issue.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `.claude/commands/review-issue.md`
