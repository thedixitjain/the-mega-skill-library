...
source_path: "customer-interview-simulate.md"
source_url: https://github.com/nimbalyst/product-manager-claude-code-commands/blob/HEAD/customer-interview-simulate.md
---
...
**Source:** [`nimbalyst/product-manager-claude-code-commands`](https://github.com/nimbalyst/product-manager-claude-code-commands) → `customer-interview-simulate.md`
