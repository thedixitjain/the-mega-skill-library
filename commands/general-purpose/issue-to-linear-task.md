...
source_path: "plugins/all-commands/commands/issue-to-linear-task.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/issue-to-linear-task.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/issue-to-linear-task.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-integration-sync/commands/issue-to-linear-task.md`
