---
name: create-ticket-create-linear-ticket
description: "Create a structured Linear issue with proper workflow configuration."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/linear-helper/commands/create-ticket.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/linear-helper/commands/create-ticket.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/linear-helper/commands/create-ticket.md`
