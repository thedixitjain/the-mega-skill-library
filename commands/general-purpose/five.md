...
source_path: ".claude/commands/five.md"
source_url: https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/HEAD/.claude/commands/five.md
---
...
**Source:** [`wesammustafa/Claude-Code-Everything-You-Need-to-Know`](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know) → `.claude/commands/five.md`
