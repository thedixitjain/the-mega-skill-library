...
source_path: "plugins/bundle-analyzer/commands/tree-shake.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/bundle-analyzer/commands/tree-shake.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/bundle-analyzer/commands/tree-shake.md`
