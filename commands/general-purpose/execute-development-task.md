...
source_path: "claude/commands/execute-task.md"
source_url: https://github.com/croffasia/cc-blueprint-toolkit/blob/HEAD/claude/commands/execute-task.md
---
...
**Source:** [`croffasia/cc-blueprint-toolkit`](https://github.com/croffasia/cc-blueprint-toolkit) → `claude/commands/execute-task.md`
