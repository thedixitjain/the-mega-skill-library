...
source_path: ".claude/commands/triage-issue.md"
source_url: https://github.com/anthropics/claude-code/blob/HEAD/.claude/commands/triage-issue.md
---
...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `.claude/commands/triage-issue.md`
