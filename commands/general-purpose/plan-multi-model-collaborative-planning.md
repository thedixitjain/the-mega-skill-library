---
name: plan-multi-model-collaborative-planning
...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/multi-plan.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/multi-plan.md`
