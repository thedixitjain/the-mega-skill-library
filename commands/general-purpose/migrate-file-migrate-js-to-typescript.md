---
name: migrate-file-migrate-js-to-typescript
description: "Convert a JavaScript file to TypeScript with proper type annotations."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/type-migrator/commands/migrate-file.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/type-migrator/commands/migrate-file.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/type-migrator/commands/migrate-file.md`
