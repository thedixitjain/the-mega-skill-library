...
source_path: "plugins/conductor/commands/status.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/conductor/commands/status.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/conductor/commands/status.md`
