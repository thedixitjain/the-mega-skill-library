...
source_url: https://github.com/anthropics/claude-code/blob/HEAD/plugins/hookify/commands/help.md
---
# Hookify Plugin Help
...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `plugins/hookify/commands/help.md`

**Also appears in:** `anthropics/claude-plugins-official/plugins/hookify/commands/help.md`
