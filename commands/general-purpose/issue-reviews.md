---
name: issue-reviews
description: "Review open GitHub issues for priority, feasibility, project alignment, and risks."
category: general-purpose
source_repo: jayminwest/overstory
source_path: ".claude/commands/issue-reviews.md"
source_url: https://github.com/jayminwest/overstory/blob/HEAD/.claude/commands/issue-reviews.md
---
## intro
...
**Source:** [`jayminwest/overstory`](https://github.com/jayminwest/overstory) → `.claude/commands/issue-reviews.md`
