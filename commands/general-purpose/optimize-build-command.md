...
source_path: "plugins/all-commands/commands/optimize-build.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/optimize-build.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/optimize-build.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-performance-optimization/commands/optimize-build.md`
