---
name: add-feature
description: "Add a new feature module to an existing project with all supporting files."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/project-scaffold/commands/add-feature.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/project-scaffold/commands/add-feature.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/project-scaffold/commands/add-feature.md`
