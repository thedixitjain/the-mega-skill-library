...
source_url: https://github.com/anthropics/claude-code/blob/HEAD/plugins/plugin-dev/commands/create-plugin.md
---
...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `plugins/plugin-dev/commands/create-plugin.md`
