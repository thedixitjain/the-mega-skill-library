...
source_path: "plugins/all-commands/commands/directory-deep-dive.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/directory-deep-dive.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/directory-deep-dive.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-utilities-debugging/commands/directory-deep-dive.md`
