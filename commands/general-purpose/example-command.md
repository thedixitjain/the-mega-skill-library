...
allowed-tools: "'example-mcp-server/example_tool'"
category: general-purpose
source_repo: github/spec-kit
source_path: "extensions/template/commands/example.md"
source_url: https://github.com/github/spec-kit/blob/HEAD/extensions/template/commands/example.md
---
# Example Command
...
**Source:** [`github/spec-kit`](https://github.com/github/spec-kit) → `extensions/template/commands/example.md`
