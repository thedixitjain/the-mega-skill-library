...
description: "Please help me start working on a new feature: $FEATURENAME"
category: general-purpose
source_repo: cassler/awesome-claude-code-setup
source_path: "commands/start-feature.md"
source_url: https://github.com/cassler/awesome-claude-code-setup/blob/HEAD/commands/start-feature.md
---
# Start New Feature
...
**Source:** [`cassler/awesome-claude-code-setup`](https://github.com/cassler/awesome-claude-code-setup) → `commands/start-feature.md`
