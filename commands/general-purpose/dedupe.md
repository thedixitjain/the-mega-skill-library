...
source_path: ".claude/commands/dedupe.md"
source_url: https://github.com/anthropics/claude-code/blob/HEAD/.claude/commands/dedupe.md
---
...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `.claude/commands/dedupe.md`
