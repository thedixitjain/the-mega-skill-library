---
name: intelligent-command-chain
description: "/intelligent-chain [workflow-description]"
category: general-purpose
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/00-initial-workflow/intelligent-chain.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/00-initial-workflow/intelligent-chain.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/00-initial-workflow/intelligent-chain.md`
