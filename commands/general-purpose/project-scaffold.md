...
source_path: "plugins/packages/fullstack-starter-pack/commands/project-scaffold.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/packages/fullstack-starter-pack/commands/project-scaffold.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/packages/fullstack-starter-pack/commands/project-scaffold.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/packages/fullstack-starter-pack/plugins/04-integration/commands/project-scaffold.md`
