---
name: scaffold
description: "Scaffold a new project with a complete, production-ready structure."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/project-scaffold/commands/scaffold.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/project-scaffold/commands/scaffold.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/project-scaffold/commands/scaffold.md`
