...
source_path: "plugins/conductor/commands/setup.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/conductor/commands/setup.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/conductor/commands/setup.md`
