---
name: learn-command
description: "/learn [topic] [level] [format]"
category: general-purpose
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/01-project-setup/learn.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/01-project-setup/learn.md
---
# Learn Command
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/01-project-setup/learn.md`
