---
name: sync-env-sync-environment-variables
description: "Synchronize environment variables across development, staging, and production."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/env-sync/commands/sync-env.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/env-sync/commands/sync-env.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/env-sync/commands/sync-env.md`
