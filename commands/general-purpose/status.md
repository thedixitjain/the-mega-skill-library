...
source_path: "commands/status.md"
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/commands/status.md
---
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `commands/status.md`
