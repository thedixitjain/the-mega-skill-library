...
source_path: "plugins/all-commands/commands/cross-reference-manager.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/cross-reference-manager.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/cross-reference-manager.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-integration-sync/commands/cross-reference-manager.md`
