---
name: update-status-update-linear-status
description: "Update the status and progress of Linear tickets."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/linear-helper/commands/update-status.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/linear-helper/commands/update-status.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/linear-helper/commands/update-status.md`
