---
name: hotfix-deploy-command
description: "Deploy critical hotfixes quickly"
allowed-tools: "Bash(git *), Bash(npm *)"
category: general-purpose
source_repo: davepoon/buildwithclaude
source_path: "plugins/all-commands/commands/hotfix-deploy.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/hotfix-deploy.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/hotfix-deploy.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-ci-deployment/commands/hotfix-deploy.md`
