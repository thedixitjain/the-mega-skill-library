...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `plugins/hookify/commands/list.md`

**Also appears in:** `anthropics/claude-plugins-official/plugins/hookify/commands/list.md`
