...
source_path: "plugins/all-commands/commands/task-from-pr.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/task-from-pr.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/task-from-pr.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-integration-sync/commands/task-from-pr.md`
