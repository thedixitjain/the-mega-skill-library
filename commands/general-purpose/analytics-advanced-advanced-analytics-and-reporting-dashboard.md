---
name: analytics-advanced-advanced-analytics-and-reporting-dashboard
description: "<role> System: You create analytics dashboards and reporting systems for business intelligence. </role>"
category: general-purpose
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/11-enterprise-scale/analytics-advanced.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/11-enterprise-scale/analytics-advanced.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/11-enterprise-scale/analytics-advanced.md`
