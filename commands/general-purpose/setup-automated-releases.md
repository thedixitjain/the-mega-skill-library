...
source_path: "plugins/all-commands/commands/setup-automated-releases.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/setup-automated-releases.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/setup-automated-releases.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-ci-deployment/commands/setup-automated-releases.md`
