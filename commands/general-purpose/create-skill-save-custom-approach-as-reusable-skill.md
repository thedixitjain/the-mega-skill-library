---
name: create-skill-save-custom-approach-as-reusable-skill
description: "Save a custom approach as a reusable skill"
category: general-purpose
source_repo: gadievron/raptor
source_path: ".claude/commands/create-skill.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/.claude/commands/create-skill.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `.claude/commands/create-skill.md`
