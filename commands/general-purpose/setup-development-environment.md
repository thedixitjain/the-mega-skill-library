...
source_path: "plugins/all-commands/commands/setup-development-environment.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/setup-development-environment.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/setup-development-environment.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-setup/commands/setup-development-environment.md`
