---
name: best-practices-command
description: "/best-practices [domain] [technology] [scope]"
category: general-purpose
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/07-utilities/best-practices.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/07-utilities/best-practices.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/07-utilities/best-practices.md`
