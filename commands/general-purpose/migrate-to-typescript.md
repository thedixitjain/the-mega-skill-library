...
source_path: "plugins/all-commands/commands/migrate-to-typescript.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/migrate-to-typescript.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/migrate-to-typescript.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-typescript-migration/commands/migrate-to-typescript.md`
