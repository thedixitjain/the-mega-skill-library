...
source_path: "presets/lean/commands/speckit.constitution.md"
source_url: https://github.com/github/spec-kit/blob/HEAD/presets/lean/commands/speckit.constitution.md
---
## User Input
...
**Source:** [`github/spec-kit`](https://github.com/github/spec-kit) → `presets/lean/commands/speckit.constitution.md`
