---
name: execute-multi-model-collaborative-execution
...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/multi-execute.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/multi-execute.md`
