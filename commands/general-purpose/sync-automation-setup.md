...
source_path: "plugins/all-commands/commands/sync-automation-setup.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/sync-automation-setup.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/sync-automation-setup.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-integration-sync/commands/sync-automation-setup.md`
