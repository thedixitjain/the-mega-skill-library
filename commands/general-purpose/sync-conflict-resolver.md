...
source_path: "plugins/all-commands/commands/sync-conflict-resolver.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/sync-conflict-resolver.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/sync-conflict-resolver.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-integration-sync/commands/sync-conflict-resolver.md`
