---
name: validate-schedule-validate-cron-schedule
description: "Validate and explain a cron schedule expression."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/cron-scheduler/commands/validate-schedule.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/cron-scheduler/commands/validate-schedule.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/cron-scheduler/commands/validate-schedule.md`
