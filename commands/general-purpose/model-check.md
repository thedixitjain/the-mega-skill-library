...
source_path: ".claude/commands/model-check.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/.claude/commands/model-check.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `.claude/commands/model-check.md`
