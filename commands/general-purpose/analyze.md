...
source_path: "templates/commands/analyze.md"
source_url: https://github.com/github/spec-kit/blob/HEAD/templates/commands/analyze.md
---
## User Input
...
**Source:** [`github/spec-kit`](https://github.com/github/spec-kit) → `templates/commands/analyze.md`
