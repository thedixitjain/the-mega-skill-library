...
source_path: "plugins/all-commands/commands/project-health-check.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/project-health-check.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/project-health-check.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-task-management/commands/project-health-check.md`
