...
source_path: "plugins/all-commands/commands/sync-pr-to-task.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/sync-pr-to-task.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/sync-pr-to-task.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-integration-sync/commands/sync-pr-to-task.md`
