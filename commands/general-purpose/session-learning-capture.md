...
source_path: "plugins/all-commands/commands/session-learning-capture.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/session-learning-capture.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/session-learning-capture.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-team-collaboration/commands/session-learning-capture.md`
