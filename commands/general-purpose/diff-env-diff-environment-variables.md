---
name: diff-env-diff-environment-variables
description: "Compare environment variables between two environments."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/env-sync/commands/diff-env.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/env-sync/commands/diff-env.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/env-sync/commands/diff-env.md`
