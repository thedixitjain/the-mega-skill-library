...
source_path: "plugins/conductor/commands/new-track.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/conductor/commands/new-track.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/conductor/commands/new-track.md`
