...
source_path: "plugins/all-commands/commands/milestone-tracker.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/milestone-tracker.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/milestone-tracker.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-project-task-management/commands/milestone-tracker.md`
