...
source_path: "plugins/all-commands/commands/linear-task-to-issue.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/linear-task-to-issue.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/linear-task-to-issue.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-integration-sync/commands/linear-task-to-issue.md`
