...
source_path: "plugins/dependency-manager/commands/update-deps.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/dependency-manager/commands/update-deps.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/dependency-manager/commands/update-deps.md`
