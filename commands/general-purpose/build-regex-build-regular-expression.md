---
name: build-regex-build-regular-expression
description: "Build a regular expression pattern from a natural language description."
category: general-purpose
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/regex-builder/commands/build-regex.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/regex-builder/commands/build-regex.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/regex-builder/commands/build-regex.md`
