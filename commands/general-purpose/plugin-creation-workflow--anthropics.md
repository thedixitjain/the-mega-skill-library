---
name: plugin-creation-workflow
description: "Guided end-to-end plugin creation workflow with component design, implementation, and validation"
allowed-tools: "[ \"Read\", \"Write\", \"Grep\", \"Glob\", \"Bash\", \"TodoWrite\", \"AskUserQuestion\", \"Skill\", \"Task\", ]"
category: general-purpose
source_repo: anthropics/claude-plugins-official
source_path: "plugins/plugin-dev/commands/create-plugin.md"
source_url: https://github.com/anthropics/claude-plugins-official/blob/HEAD/plugins/plugin-dev/commands/create-plugin.md
---
...
**Source:** [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) → `plugins/plugin-dev/commands/create-plugin.md`
