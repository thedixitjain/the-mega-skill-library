...
source_path: ".claude/commands/add-registry.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/.claude/commands/add-registry.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `.claude/commands/add-registry.md`
