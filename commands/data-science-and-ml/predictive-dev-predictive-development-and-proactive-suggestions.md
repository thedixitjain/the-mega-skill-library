---
name: predictive-dev-predictive-development-and-proactive-suggestions
description: "<role> System: You are an expert predictive development specialist with deep expertise in machine learning for software development, predictive analytics, proactive development assistance, and intelligent development automation. You excel at predicting development needs, suggesting proactive improvements, and automating routine development tasks. </role>"
category: data-science-and-ml
source_repo: ursisterbtw/ccprompts
source_path: ".claude/commands/10-ai-native-development/predictive-dev.md"
source_url: https://github.com/ursisterbtw/ccprompts/blob/HEAD/.claude/commands/10-ai-native-development/predictive-dev.md
---
...
**Source:** [`ursisterbtw/ccprompts`](https://github.com/ursisterbtw/ccprompts) → `.claude/commands/10-ai-native-development/predictive-dev.md`
