---
name: neural-train
description: "Train neural patterns with SONA (Self-Optimizing Neural Architecture) for adaptive learning and pattern recognition."
category: data-science-and-ml
source_repo: ruvnet/ruflo
source_path: "v3/@claude-flow/cli/.claude/commands/training/neural-train.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/v3/@claude-flow/cli/.claude/commands/training/neural-train.md
---
# neural-train
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `v3/@claude-flow/cli/.claude/commands/training/neural-train.md`
