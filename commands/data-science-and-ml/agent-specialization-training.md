...
source_path: ".claude/commands/training/specialization.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/commands/training/specialization.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/commands/training/specialization.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/training/specialization.md`
