...
description: "Continuously improve coordination through neural network learning with SONA (Self-Optimizing Neural Architecture)."
category: data-science-and-ml
source_repo: ruvnet/ruflo
source_path: "v3/@claude-flow/cli/.claude/commands/training/neural-patterns.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/v3/@claude-flow/cli/.claude/commands/training/neural-patterns.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `v3/@claude-flow/cli/.claude/commands/training/neural-patterns.md`
