---
name: run-audit-run-accessibility-audit
description: "Execute a comprehensive accessibility audit against WCAG guidelines."
category: frontend-and-design
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/a11y-audit/commands/run-audit.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/a11y-audit/commands/run-audit.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/a11y-audit/commands/run-audit.md`
