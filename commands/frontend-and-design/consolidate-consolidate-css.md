---
name: consolidate-consolidate-css
description: "Merge and consolidate duplicate CSS rules and redundant stylesheets."
category: frontend-and-design
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/css-cleaner/commands/consolidate.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/css-cleaner/commands/consolidate.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/css-cleaner/commands/consolidate.md`
