---
name: suggest-colors-suggest-accessible-colors
description: "Suggest alternative colors that meet WCAG contrast requirements."
category: frontend-and-design
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/color-contrast/commands/suggest-colors.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/color-contrast/commands/suggest-colors.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/color-contrast/commands/suggest-colors.md`
