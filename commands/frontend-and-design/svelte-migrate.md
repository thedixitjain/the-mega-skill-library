...
source_path: "plugins/all-commands/commands/svelte-migrate.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-commands/commands/svelte-migrate.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-commands/commands/svelte-migrate.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/commands-framework-svelte/commands/svelte-migrate.md`
