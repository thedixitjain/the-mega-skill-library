---
name: generate-report-generate-accessibility-report
description: "Generate a detailed accessibility audit report with remediation steps."
category: frontend-and-design
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/a11y-audit/commands/generate-report.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/a11y-audit/commands/generate-report.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/a11y-audit/commands/generate-report.md`
