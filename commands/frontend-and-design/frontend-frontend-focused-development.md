---
name: frontend-frontend-focused-development
...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/multi-frontend.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/multi-frontend.md`
