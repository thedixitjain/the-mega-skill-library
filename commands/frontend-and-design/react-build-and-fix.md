...
source_path: "commands/react-build.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/commands/react-build.md
---
# React Build and Fix
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `commands/react-build.md`
