---
name: add-authentication-to-nextjs-app
...
source_path: "plugins/nextjs-expert/commands/add-auth.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/nextjs-expert/commands/add-auth.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/nextjs-expert/commands/add-auth.md`
