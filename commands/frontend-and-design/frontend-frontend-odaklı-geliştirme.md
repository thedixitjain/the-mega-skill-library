---
name: frontend-frontend-odaklı-geliştirme
description: "Frontend odaklı iş akışı (Research → Ideation → Plan → Execute → Optimize → Review), Gemini liderliğinde."
category: frontend-and-design
source_repo: affaan-m/ECC
source_path: "docs/tr/commands/multi-frontend.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/commands/multi-frontend.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/commands/multi-frontend.md`
