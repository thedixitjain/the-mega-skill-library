---
name: sharp-edges-frontend-engineering
description: "These are the frontend mistakes that ship broken experiences, kill performance, and create technical debt that haunts teams for years. Each edge represents real production incidents, accessibility lawsuits, and careers derailed by \"it works on my machine.\""
category: frontend-and-design
source_repo: vibeforge1111/vibeship-spawner-skills
source_path: "frontend/frontend/sharp-edges.md"
source_url: https://github.com/vibeforge1111/vibeship-spawner-skills/blob/HEAD/frontend/frontend/sharp-edges.md
---
...
**Source:** [`vibeforge1111/vibeship-spawner-skills`](https://github.com/vibeforge1111/vibeship-spawner-skills) → `frontend/frontend/sharp-edges.md`
