---
name: add-breakpoints-add-responsive-breakpoints
description: "Implement responsive design breakpoints for a component or page."
category: frontend-and-design
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/responsive-designer/commands/add-breakpoints.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/responsive-designer/commands/add-breakpoints.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/responsive-designer/commands/add-breakpoints.md`
