---
name: mockup
description: "Create a visual UX mockup for: {{arg1}}"
category: frontend-and-design
source_repo: nimbalyst/product-manager-claude-code-commands
source_path: "mockup.md"
source_url: https://github.com/nimbalyst/product-manager-claude-code-commands/blob/HEAD/mockup.md
---
...
**Source:** [`nimbalyst/product-manager-claude-code-commands`](https://github.com/nimbalyst/product-manager-claude-code-commands) → `mockup.md`
