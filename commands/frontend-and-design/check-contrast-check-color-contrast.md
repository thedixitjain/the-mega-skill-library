---
name: check-contrast-check-color-contrast
description: "Check color contrast ratios against WCAG accessibility requirements."
category: frontend-and-design
source_repo: rohitg00/awesome-claude-code-toolkit
source_path: "plugins/color-contrast/commands/check-contrast.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/plugins/color-contrast/commands/check-contrast.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `plugins/color-contrast/commands/check-contrast.md`
