---
name: frontend-フロントエンド中心の開発
description: "フロントエンド中心のワークフロー(調査 → アイデア創出 → 計画 → 実装 → 最適化 → レビュー)、Gemini主導。"
category: frontend-and-design
source_repo: affaan-m/ECC
source_path: "docs/ja-JP/commands/multi-frontend.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/commands/multi-frontend.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/commands/multi-frontend.md`
