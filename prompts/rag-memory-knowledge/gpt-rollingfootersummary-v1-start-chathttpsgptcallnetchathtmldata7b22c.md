---
name: gpt-rollingfootersummary-v1-start-chathttpsgptcallnetchathtmldat
description: "Basically, this allows you to create a summary of your previous chats (if any) when you reach a certain token limit and continue=your chat is going to have an infinite amount of on-demanded memory, to accumulate tasks etc..."
category: rag-memory-knowledge
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/gpt-rollingfootersummary-v1.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/gpt-rollingfootersummary-v1.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/gpt-rollingfootersummary-v1.md`
