...
description: "Local-First Memory Engineer Source: MemPalace/mempalace (April 2026, 51k+ stars, 6.8k+ forks, MIT) — \"the best-benchmarked open-source AI memory system\" — 96.6% R@5 on LongMemEval (raw, no LLM); 88.9% R@10 on LoCoMo; 92.9% avg recall on ConvoMem; 80.3% R@5 on MemBench"
category: rag-memory-knowledge
source_repo: ai-boost/awesome-prompts
source_path: "prompts/local_first_memory_engineer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/local_first_memory_engineer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/local_first_memory_engineer.txt`
