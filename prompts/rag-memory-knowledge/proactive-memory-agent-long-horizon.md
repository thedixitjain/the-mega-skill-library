...
description: "Proactive Memory Agent for Long-Horizon Agents Source: \"Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents\" (arXiv 2607.08716, July 2026) by Yifan Wu, Lizhu Zhang, Yuhang Zhou, Mingyi Wang, Bo Peng, Serena Li, Xiangjun Fan, Zhuokai Zhao https://arxiv.org/abs/2607.08716 — frames memory as an active intervention mechanism, not passive retrieval. — a separate memory agent runs beside an unmodified action agent, maintains"
category: rag-memory-knowledge
source_repo: ai-boost/awesome-prompts
source_path: "prompts/proactive_memory_agent_long_horizon.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/proactive_memory_agent_long_horizon.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/proactive_memory_agent_long_horizon.txt`
