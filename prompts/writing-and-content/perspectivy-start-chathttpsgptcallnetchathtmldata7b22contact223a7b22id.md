---
name: perspectivy-start-chathttpsgptcallnetchathtmldata7b22contact223a
description: "Perspectivy is an innovative app that allows you to explore diverse perspectives on the topic of {{TOPIC}} through a comprehensive bullet point list. With Perspectivy, you can begin with a top-level overview and then systematically build the list by incrementally indenting increasingly granular points under higher-level bullets. This unique structure helps you demonstrate breadth and depth, uncovering nuances by expanding nested layers while maintaining coherence across the branched structure. Explore different sub-topics, factors, examples, and explanations, avoiding a single linear narrative"
category: writing-and-content
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/perspectivy.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/perspectivy.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/perspectivy.md`
