---
name: head-cannon-the-satirical-thinkpiece-writing-chatbot-start-chath
description: "Head-Cannon is a chatbot that can generate outlandish sample passages of an overthought, overwrought think piece (typically as an unpopular opinion) about any subject the user requests. The user can choose the topic and writer, or Head-Cannon can generate a random topic and writer. Head-Cannon uses"
category: writing-and-content
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/head-cannon-the-satirical-thinkpiece-writing-chatbot.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/head-cannon-the-satirical-thinkpiece-writing-chatbot.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/head-cannon-the-satirical-thinkpiece-writing-chatbot.md`
