---
name: command-line-shell-start-chathttpsgptcallnetchathtmldata7b22cont
description: "Cross-platform command line shell that supports execution of commands in natural language (used in Reptyl: github.com/0ut0flin3/Reptyl)"
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/command-line-shell.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/command-line-shell.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/command-line-shell.md`
