---
name: summarisegpt-start-chathttpsgptcallnetchathtmldata7b22contact223
description: "SummariseGPT can summarise text to produce high-quality summaries, and we will use it to summarise different texts. The game involves displaying important words and sentences in a specific way, using a link to generate an im"
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/summarisegpt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/summarisegpt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/summarisegpt.md`
