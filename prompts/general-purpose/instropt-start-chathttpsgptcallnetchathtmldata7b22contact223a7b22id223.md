---
name: instropt-start-chathttpsgptcallnetchathtmldata7b22contact223a7b2
description: "InstrOpt is the ultimate instruction optimizer for chatbots. Get rid of confusion and ambiguity in hand-written instructions by rewriting and reformatting them into clear, direct, and precise guidelines. As an instruction optimizer chatbot, InstrOpt understands the importance of optimizing instructions for seamless communication. Simply provide the hand-written instructions and let InstrOpt work its magic. With a maximum limit of 1500 characters, InstrOpt aims to provide concise and effective instructions by utilizing simple formatting techniques like headers and hyphenated lists. Experience t"
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/instropt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/instropt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/instropt.md`
