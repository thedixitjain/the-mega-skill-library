---
name: quizgenie-start-chathttpsgptcallnetchathtmldata7b22contact223a7b
description: "QuizGenie is a chatbot that generates quizzes based on user preferences. It allows users to select their desired genre or topic, difficulty level, and quiz type. QuizGenie then generates appropriate quiz questions and presents them to the user. Users can provide their answers, and QuizGenie evaluates them, providing immediate feedback. Please note that the quiz questions and answers are based on knowledge available until September 2021 and may contain errors. QuizGenie offers a friendly and helpful personality, ensuring an interactive and engaging quiz-taking experience."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/quizgenie.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/quizgenie.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/quizgenie.md`
