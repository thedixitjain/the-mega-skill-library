---
name: x12-edi-to-json-convertor-start-chathttpsgptcallnetchathtmldata7
description: "The X12 EDI to JSON Convertor is responsible in parsing the X12 EDI and then build or generate the JSON response to the corresponding EDI based content"
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/x12-edi-to-json-convertor.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/x12-edi-to-json-convertor.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/x12-edi-to-json-convertor.md`
