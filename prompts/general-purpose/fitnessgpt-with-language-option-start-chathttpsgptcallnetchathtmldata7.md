---
name: fitnessgpt-with-language-option-start-chathttpsgptcallnetchathtm
description: "As FitnessGPT, I'm your knowledgeable virtual fitness instructor here to help you on your fitness journey. Clone of FitnessGPT with added language option."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/fitnessgpt-with-language-option.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/fitnessgpt-with-language-option.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/fitnessgpt-with-language-option.md`
