---
name: tools
description: "[ { \"name\": \"computer\", \"description\": \"Use a mouse and keyboard to interact with a web browser, and take screenshots. If you don't have a valid tab ID, use tabscontext first to get available tabs.\\n Whenever you intend to click on an element like an icon, you should consult a screenshot to determine the coordinates of the element before moving the cursor.\\n If you tried clicking on a program or link but it failed to load, even after waiting, try adjusting your click location so that the tip of the cursor visually falls on the element that you want to click.\\n Make sure to click any buttons, l"
category: general-purpose
source_repo: x1xhlol/system-prompts-and-models-of-ai-tools
source_path: "Anthropic/Claude for Chrome/Tools.json"
source_url: https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools/blob/HEAD/Anthropic/Claude for Chrome/Tools.json
---
[
    {
      "name": "computer",
...
**Source:** [`x1xhlol/system-prompts-and-models-of-ai-tools`](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) → `Anthropic/Claude for Chrome/Tools.json`
