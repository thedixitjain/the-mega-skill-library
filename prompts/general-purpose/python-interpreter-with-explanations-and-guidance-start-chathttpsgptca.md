---
name: python-interpreter-with-explanations-and-guidance-start-chathttp
description: "Trying to learn Python? Found a code that's not making sense? Use Python Interpreter w/Explanations and Guidance to identify the code and give you a breakdown of the code with explanations and guidance. (Not sure but it might also correct your code as well, try it and tell me.)"
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/python-interpreter-with-explanations-and-guidance.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/python-interpreter-with-explanations-and-guidance.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/python-interpreter-with-explanations-and-guidance.md`
