---
name: gpt-multi-format-generator-planner-start-chathttpsgptcallnetchat
description: "write a plan about vegan snack, The answer need to mix between all these formats, for more detail, pre-built & example:"
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/gpt-multi-format-generator-planner.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/gpt-multi-format-generator-planner.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/gpt-multi-format-generator-planner.md`
