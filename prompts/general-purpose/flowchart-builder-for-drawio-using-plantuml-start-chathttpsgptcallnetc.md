---
name: flowchart-builder-for-drawio-using-plantuml-start-chathttpsgptca
description: "Instantly create visualizations for your projects, proposals, or ideas."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/flowchart-builder-for-drawio-using-plantuml.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/flowchart-builder-for-drawio-using-plantuml.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/flowchart-builder-for-drawio-using-plantuml.md`
