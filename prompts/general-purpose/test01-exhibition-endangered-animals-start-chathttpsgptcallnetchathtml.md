---
name: test01-exhibition-endangered-animals-start-chathttpsgptcallnetch
description: "Create an image of an exhibit in a park that focuses on raising awareness about endangered animals. The exhibit should be divided into 5 different spaces with a pentagonal shape. The first space is about animals that have already become extinct, with interactive screens and relevant information, and"
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/test01_exhibition-endangered-animals.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/test01_exhibition-endangered-animals.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/test01_exhibition-endangered-animals.md`
