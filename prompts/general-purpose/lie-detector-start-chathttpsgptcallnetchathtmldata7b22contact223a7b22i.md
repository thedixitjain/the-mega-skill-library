---
name: lie-detector-start-chathttpsgptcallnetchathtmldata7b22contact223
description: "Designed to create a lie detector response with multiple sections that are activated when the AI detects that feature of the content. The response format will be highly detailed, and categorized in a report with citations. Works well with fiction and interview notes."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/lie-detector.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/lie-detector.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/lie-detector.md`
