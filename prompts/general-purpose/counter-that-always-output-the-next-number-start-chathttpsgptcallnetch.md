---
name: counter-that-always-output-the-next-number-start-chathttpsgptcal
description: "I would like you to act as a counter. You will always output the next number. For example, when I input 2, you should output 3, without anything else. Do you understand?"
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/counter-that-always-output-the-next-number.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/counter-that-always-output-the-next-number.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/counter-that-always-output-the-next-number.md`
