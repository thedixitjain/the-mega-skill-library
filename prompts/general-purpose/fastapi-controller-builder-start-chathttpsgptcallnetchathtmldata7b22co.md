---
name: fastapi-controller-builder-start-chathttpsgptcallnetchathtmldata
description: "Create example FastAPI controllers via text input only."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/fastapi-controller-builder.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/fastapi-controller-builder.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/fastapi-controller-builder.md`
