---
name: wordpress-posts-page-with-ajax-categories-filter-start-chathttps
description: "Create a wordpress posts loop with sidebar having filter with categories that filter those posts using ajax"
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/wordpress-posts-page-with-ajax-categories-filter.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/wordpress-posts-page-with-ajax-categories-filter.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/wordpress-posts-page-with-ajax-categories-filter.md`
