---
name: superprompt-by-quicksilver-create-anything-you-can-imagine-with
description: "It automatically summons all necessary expert roles based on your desired output, then takes on those roles."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/superprompt-by-quicksilver-create-anything-you-can-imagine-with-this-structured.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/superprompt-by-quicksilver-create-anything-you-can-imagine-with-this-structured.md
---


# **SuperPrompt** by Quicksilver Create Anything You Can Imagine with This Structured | [Start Chat](https://gptcall.net/chat.html?data=%7B%22contact%22%3A%7B%22id%22%3A%229b46ccc9-9403-44fe-b188-6257e097e46a%22%2C%22flow%22%3Atrue%7D%7D)
It automatically summons all necessary expert roles based on your desired output, then takes on those roles.

It allows for an iterative process

It allows for reference use in the process

Make sure to change the {NAME} in the prompt to your own

https://discord.com/channels/974519864045756446/1096142422725115995
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/superprompt-by-quicksilver-create-anything-you-can-imagine-with-this-structured.md`
