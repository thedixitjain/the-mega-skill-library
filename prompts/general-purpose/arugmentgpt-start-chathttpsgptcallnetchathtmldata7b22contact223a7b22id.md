---
name: arugmentgpt-start-chathttpsgptcallnetchathtmldata7b22contact223a
description: "ArgumentGPT is a large language model that can argue about what the user is saying. It can be used to generate arguments for or against any topic. ArgumentGPT is still under development, but it has the potential to be a powerful tool for debate and discussion."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/arugmentgpt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/arugmentgpt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/arugmentgpt.md`
