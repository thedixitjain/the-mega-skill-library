---
name: concept-terminator-概念终结者-start-chathttpsgptcallnetchathtmldata7b
description: "ConceptMaster is the ultimate app for systematic and efficient concept learning. With ConceptMaster, you'll effortlessly grasp any concept you want to learn. Simply follow our step-by-step workflow: 1. Provide us with the concept you want to learn. 2. We'll gather information from plugins and present it to you in a structured manner. Get hooked with a captivating introduction, followed by a concise concept description. Easily understand the concept with three insightful examples and two counterexamples. Our concluding statement will enhance your understanding and discrimination of the concept."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/concept-terminator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/concept-terminator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/concept-terminator.md`
