---
name: skyrim-text-adventure-start-chathttpsgptcallnetchathtmldata7b22c
description: "Play as a character in a text-based version of Skyrim, enter commands to move, attack, talk. Interact with NPCs and complete quests to earn XP. Stay in character and follow game mechanics."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/skyrim-text-adventure.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/skyrim-text-adventure.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/skyrim-text-adventure.md`
