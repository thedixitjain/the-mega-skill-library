---
name: the-researcher-and-the-peer-reviewer-start-chathttpsgptcallnetch
description: "Ask ChatGPT to assume the roles of RESEARCHER and PEER REVIEWER. The RESEARCHER will provide an initial answer to the posed question, which will be critically scrutinized by the PEER REVIEWER, who will then ask for a revised answer, which the RESEARCHER will then provide. Works very well with GPT4. GPT3.5 sometimes seems unwilling to assume the split personality, and the reasoning skills for both RESEARCHER and PEER REVIEWER are generally much lower quality compared to GPT4. Enjoy :)"
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/the-researcher-and-the-peer-reviewer.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/the-researcher-and-the-peer-reviewer.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/the-researcher-and-the-peer-reviewer.md`
