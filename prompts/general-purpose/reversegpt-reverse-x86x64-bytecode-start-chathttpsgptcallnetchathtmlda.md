---
name: reversegpt-reverse-x86x64-bytecode-start-chathttpsgptcallnetchat
description: "Decompile x86/x64 bytecode. It returns an explanation of what the bytecode does, as well as the decompiled code."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/reversegpt-reverse-x86x64-bytecode.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/reversegpt-reverse-x86x64-bytecode.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/reversegpt-reverse-x86x64-bytecode.md`
