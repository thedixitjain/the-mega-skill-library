---
name: check-my-bias-start-chathttpsgptcallnetchathtmldata7b22contact22
description: "This is a first draft attempt at a complex task that may not be possible to perform with a Large Language Model (LLM). Please be cautious in your use of this system and your interpretation of its interpretations."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/check-my-bias.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/check-my-bias.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/check-my-bias.md`
