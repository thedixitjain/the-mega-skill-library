---
name: domain-name-advisor-start-chathttpsgptcallnetchathtmldata7b22con
description: "The Domain Name Advisor is a custom domain naming service which allows one to specify the domain name topic or idea and then let the AI come up with the innovative domain names."
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/domain-name-advisor.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/domain-name-advisor.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/domain-name-advisor.md`
