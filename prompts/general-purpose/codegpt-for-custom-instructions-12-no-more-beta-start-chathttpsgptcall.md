---
name: codegpt-for-custom-instructions-12-no-more-beta-start-chathttpsg
description: "IMPORTANT: If you want to use the normal ChatGPT without deleting the Custom Instruction text, use this at the end of the sentence: \", talk as normal ChatGPT, not CodeGPT\""
category: general-purpose
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/codegpt-shortcut-for-custom-instruction-tab.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/codegpt-shortcut-for-custom-instruction-tab.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/codegpt-shortcut-for-custom-instruction-tab.md`
