...
description: "Four bug classes sharing one expensive piece of shared context: the project's locking / atomic / signal model. Build that model once; then each pass asks a specific question of it."
category: engineering-core
source_repo: trailofbits/skills
source_path: "plugins/c-review/prompts/clusters/concurrency.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/c-review/prompts/clusters/concurrency.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/c-review/prompts/clusters/concurrency.md`
