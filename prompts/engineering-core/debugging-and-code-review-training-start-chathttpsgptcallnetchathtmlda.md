---
name: debugging-and-code-review-training-start-chathttpsgptcallnetchat
description: "This prompt generates faulty code and asks you how to fix it, so you can become a better code reviewer."
category: engineering-core
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/debugging-and-code-review-training.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/debugging-and-code-review-training.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/debugging-and-code-review-training.md`
