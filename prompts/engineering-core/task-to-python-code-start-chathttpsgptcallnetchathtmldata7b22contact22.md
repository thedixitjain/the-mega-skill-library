---
name: task-to-python-code-start-chathttpsgptcallnetchathtmldata7b22con
description: "A short but very effective prompt to convert any task (which does not need to be very detailed) into Python code. From monitoring network folders to creating your own API, the prompt can help you."
category: engineering-core
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/task-to-python-code.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/task-to-python-code.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/task-to-python-code.md`
