---
name: code-overhaul-plan-start-chathttpsgptcallnetchathtmldata7b22cont
description: "Create a procedure to clean up code and ensure that it is readable, maintainable and extensible."
category: engineering-core
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/code-overhaul-plan.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/code-overhaul-plan.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/code-overhaul-plan.md`
