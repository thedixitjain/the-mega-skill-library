---
name: a-debugging-gpt-start-chathttpsgptcallnetchathtmldata7b22contact
description: "It can debug any code given to it, since we know chatgpt makes countless silly errors itself while debugging a given code and easily loses focus from the code, this prompt model which supports an alt ego of the model itself, rechecks the code and then provides an even better version of it."
category: engineering-core
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/a-debugging-gpt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/a-debugging-gpt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/a-debugging-gpt.md`
