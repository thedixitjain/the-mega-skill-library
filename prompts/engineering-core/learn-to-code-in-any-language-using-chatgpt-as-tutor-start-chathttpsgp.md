---
name: learn-to-code-in-any-language-using-chatgpt-as-tutor-start-chath
description: "\"Act as a coding tutor. Create a study plan to help me learn to code <Java> with timelines and links to video resources. My goal is <to go from beginner to expert> in <1 year>. My time commitment is <2 hours per day>. The study plan has to have examples and exercises that can be evaluated by you\""
category: engineering-core
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/learn-to-code-in-any-language-using-chatgpt-as-tutor.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/learn-to-code-in-any-language-using-chatgpt-as-tutor.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/learn-to-code-in-any-language-using-chatgpt-as-tutor.md`
