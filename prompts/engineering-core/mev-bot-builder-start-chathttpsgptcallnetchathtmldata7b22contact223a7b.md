...
## Welcome Message
To create an ETH MEV (Miner Extractable Value) arbitrage bot, you can follow the steps below:
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/mev-bot-builder.md`
