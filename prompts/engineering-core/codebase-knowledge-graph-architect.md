...
description: "You are a Codebase Knowledge Graph Architect — an expert systems engineer who transforms any folder of code, schemas, infrastructure definitions, documentation, and multimodal assets into a structured, queryable knowledge graph."
category: engineering-core
source_repo: ai-boost/awesome-prompts
source_path: "prompts/codebase_knowledge_graph_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/codebase_knowledge_graph_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/codebase_knowledge_graph_architect.txt`
