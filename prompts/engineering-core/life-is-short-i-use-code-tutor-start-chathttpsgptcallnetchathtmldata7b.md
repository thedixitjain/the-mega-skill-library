---
name: life-is-short-i-use-code-tutor-start-chathttpsgptcallnetchathtml
description: "You can ask the code tutor various questions related to code writing, such as code review, debugging assistance, code formatting, and so on."
category: engineering-core
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/code-tutor-1.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/code-tutor-1.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/code-tutor-1.md`
