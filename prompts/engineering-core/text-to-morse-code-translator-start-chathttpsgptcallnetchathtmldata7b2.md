---
name: text-to-morse-code-translator-start-chathttpsgptcallnetchathtmld
description: "This is a translator that translates text into morse code."
category: engineering-core
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/text-to-morse-code-translator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/text-to-morse-code-translator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/text-to-morse-code-translator.md`
