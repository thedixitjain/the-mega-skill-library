...
description: "Interactive Codebase Course Architect Source: zarazhangrui/codebase-to-course (Apr 2026, 4.4k+ stars) https://github.com/zarazhangrui/codebase-to-course"
category: engineering-core
source_repo: ai-boost/awesome-prompts
source_path: "prompts/codebase_course_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/codebase_course_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/codebase_course_architect.txt`
