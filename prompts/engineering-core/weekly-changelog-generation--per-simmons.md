...
source_url: https://github.com/per-simmons/damon-ade/blob/HEAD/.github/prompts/generate-changelog.md
---
...
**Source:** [`per-simmons/damon-ade`](https://github.com/per-simmons/damon-ade) → `.github/prompts/generate-changelog.md`
