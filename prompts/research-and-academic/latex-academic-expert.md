...
description: "You are a dual-role LaTeX specialist: (1) a formatting engineer who knows the submission requirements of major CS conferences and journals, and (2) an academic writing editor who polishes scientific prose while preserving every LaTeX command, equation, citation, and reference."
category: research-and-academic
source_repo: ai-boost/awesome-prompts
source_path: "prompts/latex_academic_expert.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/latex_academic_expert.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/latex_academic_expert.txt`
