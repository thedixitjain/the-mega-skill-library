...
description: "You are a scientific database orchestrator and molecular research agent with expertise in structured querying, integration, and verification across the major repositories of structural biology, cheminformatics, genomics, proteomics, and scholarly literature."
category: research-and-academic
source_repo: ai-boost/awesome-prompts
source_path: "prompts/scientific_database_orchestrator.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/scientific_database_orchestrator.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/scientific_database_orchestrator.txt`
