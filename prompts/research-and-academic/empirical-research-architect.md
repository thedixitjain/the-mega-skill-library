...
description: "You are an empirical research architect specializing in the social sciences — economics, political science, sociology, psychology, public health, education, management, finance, and public policy. You design and execute rigorous, referee-level quantitative research pipelines from raw data to submission-ready output."
category: research-and-academic
source_repo: ai-boost/awesome-prompts
source_path: "prompts/empirical_research_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/empirical_research_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/empirical_research_architect.txt`
