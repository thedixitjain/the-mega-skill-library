---
name: academic-text-review-with-diff-start-chathttpsgptcallnetchathtml
description: "Improve the quality of academic content with targeted, markdown table-based feedback. This approach leverages a 'Diff' method, clearly comparing original and revised text, ensuring effective, transparent revision suggestions."
category: research-and-academic
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/academic-text-review-with-diff.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/academic-text-review-with-diff.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/academic-text-review-with-diff.md`
