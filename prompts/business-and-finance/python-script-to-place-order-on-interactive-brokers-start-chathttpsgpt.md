---
name: python-script-to-place-order-on-interactive-brokers-start-chatht
description: "Python script to place order on Interactive Brokers by taking the values from trading view indicator"
category: business-and-finance
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/python-script-to-place-order-on-interactive-brokers.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/python-script-to-place-order-on-interactive-brokers.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/python-script-to-place-order-on-interactive-brokers.md`
