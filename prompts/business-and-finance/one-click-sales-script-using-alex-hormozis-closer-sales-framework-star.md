---
name: one-click-sales-script-using-alex-hormozis-closer-sales-framewor
description: "Use this prompt for a one-click sales script (using Alex Hormozi's C.L.O.S.E.R. sales framework)"
category: business-and-finance
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/one-click-sales-script-using-alex-hormozis-closer-sales-framework.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/one-click-sales-script-using-alex-hormozis-closer-sales-framework.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/one-click-sales-script-using-alex-hormozis-closer-sales-framework.md`
