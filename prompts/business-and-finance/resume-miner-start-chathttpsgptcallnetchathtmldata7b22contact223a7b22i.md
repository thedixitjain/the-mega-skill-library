---
name: resume-miner-start-chathttpsgptcallnetchathtmldata7b22contact223
description: "The resume miner is a technology which can be utilized for extracting the meaning information out of the resume. Given the resume, it will be analyzed and provided with the structured information in JSON which can be utilized by the consumers and drive things based on the mined information."
category: business-and-finance
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/resume-miner.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/resume-miner.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/resume-miner.md`
