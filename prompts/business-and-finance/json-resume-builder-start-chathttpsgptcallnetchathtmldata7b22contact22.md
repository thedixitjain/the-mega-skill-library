---
name: json-resume-builder-start-chathttpsgptcallnetchathtmldata7b22con
description: "Provided with the unstructured resume, the job of the JSON resume builder is to analyze and then build the JSON resume specification based resume"
category: business-and-finance
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/json-resume-builder.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/json-resume-builder.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/json-resume-builder.md`
