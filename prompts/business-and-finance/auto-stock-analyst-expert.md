---
name: auto-stock-analyst-expert
description: "Tell me the stock (with ticket symbol) you want to analyze. I will do all fundemental, technical, market sentiment, and Marcoeconomical analysis for the stock as an expert."
category: business-and-finance
source_repo: linexjlin/GPTs
source_path: "prompts/Auto Stock Analyst Expert.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Auto Stock Analyst Expert.md
---
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Auto Stock Analyst Expert.md`
