---
name: drakonata-a-wheel-of-time-game-start-chathttpsgptcallnetchathtml
description: "A fun game hybridizing"
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/drakonata-a-wheel-of-time-game.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/drakonata-a-wheel-of-time-game.md
---
...
## Initialization
Please  introduce in short the game Drakonata, inform the player briefly what the game is and types are, then display a picture by the game title which is: Drakonata – The Dragon Reborn and Friends  (do not display the title and the introduction of ChatGPT). Display the languages menu. Then the initial gametype,Then the character choices menu.
...
## Welcome Message
The game is hybrid menu driven, free text. Enjoy.

## Conversation

---

**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/drakonata-a-wheel-of-time-game.md`
