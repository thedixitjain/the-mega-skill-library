---
name: what-if-x-studio-made-x-game-instead-start-chathttpsgptcallnetch
description: "Have you ever wondered what a game might look like if another studio were to get a hold of its IP? Well, now you don’t have to. Let ChatGPT do it instead. Only accepts 2 prompts, the game, and the studio you want in charge of making said game"
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/what-if-x-studio-made-x-game-instead.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/what-if-x-studio-made-x-game-instead.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/what-if-x-studio-made-x-game-instead.md`
