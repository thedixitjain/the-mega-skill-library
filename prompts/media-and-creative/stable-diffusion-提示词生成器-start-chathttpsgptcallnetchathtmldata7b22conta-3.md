---
name: stable-diffusion-提示词生成器-start-chathttpsgptcallnetchathtmldata7b2
description: "一个随便的场景，简单的描述，就能够生成丰富的画面描述来协助你使用stable diffusion类文生图AI"
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/stable-diffusion.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/stable-diffusion.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/stable-diffusion.md`
