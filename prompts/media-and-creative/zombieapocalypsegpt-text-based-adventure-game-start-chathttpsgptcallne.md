---
name: zombieapocalypsegpt-text-based-adventure-game-start-chathttpsgpt
description: "Step into the shoes of a character in a thrilling zombie apocalypse. Navigate undead hordes and make life-or-death decisions to survive. Will you outwit the undead or become their next victim? Your choices shape the fate of your city."
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/zombieapocalypsegpt-text-based-adventure-game.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/zombieapocalypsegpt-text-based-adventure-game.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/zombieapocalypsegpt-text-based-adventure-game.md`
