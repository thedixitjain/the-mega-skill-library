---
name: midjourney超级生成器v52-v6
description: "By gpts.gapier.net"
category: media-and-creative
source_repo: linexjlin/GPTs
source_path: "prompts/Midjourney超级生成器（V5.2 & V6）.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Midjourney超级生成器（V5.2 & V6）.md
---
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Midjourney超级生成器（V5.2 & V6）.md`
