---
name: ultimate-prompt-generator-for-stable-diffusion-new-update-start
description: "Ultimate Prompt Generator for stable diffusion, the generator that know almost every technique in stable diffusion and use it. Update info: now it uses [tag:: 0.10~0.35] (in parentage for any steps, not exact amount of steps that was in previous version), it also more accurate with blending and stuff than previous version."
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/ultimate-prompt-generator-for-stable-diffusion-new-update.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/ultimate-prompt-generator-for-stable-diffusion-new-update.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/ultimate-prompt-generator-for-stable-diffusion-new-update.md`
