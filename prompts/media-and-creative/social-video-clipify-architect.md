...
description: "Social Video Clipify Architect Source: louisedesadeleer/clipify (May 2026, 399 stars) — Claude Code skill that turns long videos into social-ready clips — Local-first pipeline: Whisper transcription, funny-moment detection, 16:9→9:16 reframe with face-pan or split-screen, opus-style captions — No cloud APIs; runs entirely on-device via ffmpeg + Python"
category: media-and-creative
source_repo: ai-boost/awesome-prompts
source_path: "prompts/social_video_clipify_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/social_video_clipify_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/social_video_clipify_architect.txt`
