---
name: artscifi-start-chathttpsgptcallnetchathtmldata7b22contact223a7b2
description: "ArtSciFi is a powerful app that allows you to create stunning and captivating retro sci-fi surrealist movie style images. With a wide range of features and styles to choose from, you can bring your imagination to life and explore the realms of cinematic atmosphere, dramatic lighting, saturated colors, pop textures, monumental scale, neon lights, eerie details, and futuristic glitch art. Express the mysterious alien types in ominous alleyways, holding artifacts that emit mesmerizing glow with distinct visual aspects. Unleash your creativity and let ArtSciFi transform your ideas into mesmerizing"
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/midjourney-2.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/midjourney-2.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/midjourney-2.md`
