---
name: writting-vba-code-to-successfully-create-a-powerpoint-presentati
description: "With this prompt, VBA code will be generated to create a PowerPoint presentation on the topic of 'artificial intelligence in education'."
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/writting-vba-code-to-successfully-create-a-powerpoint-presentation.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/writting-vba-code-to-successfully-create-a-powerpoint-presentation.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/writting-vba-code-to-successfully-create-a-powerpoint-presentation.md`
