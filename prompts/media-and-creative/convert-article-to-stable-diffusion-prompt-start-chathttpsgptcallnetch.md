---
name: convert-article-to-stable-diffusion-prompt-start-chathttpsgptcal
description: "Split the entire article into corresponding storyboards and write them as Stable Diffusion prompts"
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/convert-article-to-stable-diffusion-prompt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/convert-article-to-stable-diffusion-prompt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/convert-article-to-stable-diffusion-prompt.md`
