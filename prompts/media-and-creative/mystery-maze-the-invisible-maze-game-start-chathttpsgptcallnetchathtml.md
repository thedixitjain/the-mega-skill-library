---
name: mystery-maze-the-invisible-maze-game-start-chathttpsgptcallnetch
description: "Mystery Maze is a unique, interactive game where you navigate a maze with hidden rules. Your journey starts at 'S' and ends at 'G' on a 5x5 grid, with 'X' marking your position. As you explore, breaking a rule reveals it. Will you conquer the maze and uncover all the secrets?"
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/mystery-maze-the-invisible-maze-game.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/mystery-maze-the-invisible-maze-game.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/mystery-maze-the-invisible-maze-game.md`
