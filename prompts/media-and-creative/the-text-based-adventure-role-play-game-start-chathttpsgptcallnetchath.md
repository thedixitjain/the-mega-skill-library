---
name: the-text-based-adventure-role-play-game-start-chathttpsgptcallne
description: "Using this Prompt, you can turn ChatGPT into the ultimate Text Adventure Game. You can create any SFW scenario. Even from books or movies."
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/the-text-based-adventure-role-play-game.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/the-text-based-adventure-role-play-game.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/the-text-based-adventure-role-play-game.md`
