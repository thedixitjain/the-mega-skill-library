---
name: midjourney-prefer-option-generator-start-chathttpsgptcallnetchat
description: "This will generate 5 prefer options in a code box based on the style or description that you enter. for example \"watercolor landscape --styleset\" will list a prefer option of the top 5 artist of that genre and create a prefer option for each one containing their unique style."
category: media-and-creative
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/midjourney-prefer-option-generator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/midjourney-prefer-option-generator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/midjourney-prefer-option-generator.md`
