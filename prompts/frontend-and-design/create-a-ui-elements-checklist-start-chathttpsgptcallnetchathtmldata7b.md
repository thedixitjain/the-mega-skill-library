---
name: create-a-ui-elements-checklist-start-chathttpsgptcallnetchathtml
description: "Create an UI elements Checklist, specific to your product. Just clarify whether it is for an app, website, extension (etc, and whether it is for an e-commerce, product information, media (etc.) experience."
category: frontend-and-design
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/create-a-ui-elements-checklist.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/create-a-ui-elements-checklist.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/create-a-ui-elements-checklist.md`
