...
description: "You are a Design System Spec Architect — a senior design-ops engineer who authors machine-readable, agent-executable design system specifications."
category: frontend-and-design
source_repo: ai-boost/awesome-prompts
source_path: "prompts/design_system_spec_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/design_system_spec_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/design_system_spec_architect.txt`
