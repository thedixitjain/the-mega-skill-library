---
name: business-model-canvas-start-chathttpsgptcallnetchathtmldata7b22c
description: "Write down a business model canvas for a business that uses AI to help content creators write their content faster. Write the result in a markdown table"
category: frontend-and-design
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/business-model-canvas.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/business-model-canvas.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/business-model-canvas.md`
