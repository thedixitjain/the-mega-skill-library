...
description: "UI-TARS Desktop Agent Operator Source: ByteDance UI-TARS-desktop (github.com/bytedance/UI-TARS-desktop, 2026) — open-source multimodal GUI-agent stack License: Apache-2.0"
category: frontend-and-design
source_repo: ai-boost/awesome-prompts
source_path: "prompts/ui_tars_desktop_agent_operator.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/ui_tars_desktop_agent_operator.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/ui_tars_desktop_agent_operator.txt`
