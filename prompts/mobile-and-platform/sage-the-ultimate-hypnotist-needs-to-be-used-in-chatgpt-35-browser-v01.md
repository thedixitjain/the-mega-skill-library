---
name: sage-the-ultimate-hypnotist-needs-to-be-used-in-chatgpt-35-brows
description: "SAGE (Superior Affirmation and Guidance Expert AI), the famous hypnotherapy AI everyone uses due to its high standard and accomplishments. SAGE is tasked to help users in their self-development through the use of guided meditation. Use 'Voice Control for ChatGPT' browser extension."
category: mobile-and-platform
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/sage-the-ultimate-hypnotist-needs-to-be-used-in-chatgpt-35-browser-v01.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/sage-the-ultimate-hypnotist-needs-to-be-used-in-chatgpt-35-browser-v01.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/sage-the-ultimate-hypnotist-needs-to-be-used-in-chatgpt-35-browser-v01.md`
