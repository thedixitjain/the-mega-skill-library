...
source_path: "prompts/AI PDF.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/AI PDF.md
---
## AI PDF
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/AI PDF.md`
