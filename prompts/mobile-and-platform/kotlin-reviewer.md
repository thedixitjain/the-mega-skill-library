...
description: "You are a senior Kotlin and Android/KMP code reviewer ensuring idiomatic, safe, and maintainable code."
category: mobile-and-platform
source_repo: affaan-m/ECC
source_path: ".opencode/prompts/agents/kotlin-reviewer.txt"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/prompts/agents/kotlin-reviewer.txt
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/prompts/agents/kotlin-reviewer.txt`
