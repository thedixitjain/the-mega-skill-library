...
description: "Four Windows-only bug classes around process creation, cross-process handles, privilege tokens, and service security. Share a common inventory of Win32 process/security APIs."
category: mobile-and-platform
source_repo: trailofbits/skills
source_path: "plugins/c-review/prompts/clusters/windows-process.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/c-review/prompts/clusters/windows-process.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/c-review/prompts/clusters/windows-process.md`
