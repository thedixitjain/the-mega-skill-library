---
name: analyze-costs
description: "You are helping analyze costs and token usage. Follow this approach:"
category: mcp-and-integrations
source_repo: vllora/vllora
source_path: "core/src/mcp/server/prompts/analyze_costs.txt"
source_url: https://github.com/vllora/vllora/blob/HEAD/core/src/mcp/server/prompts/analyze_costs.txt
---
You are helping analyze costs and token usage. Follow this approach:
...
**Source:** [`vllora/vllora`](https://github.com/vllora/vllora) → `core/src/mcp/server/prompts/analyze_costs.txt`
