---
name: search-traces-guide
description: "You are helping search traces effectively. Follow these best practices:"
category: mcp-and-integrations
source_repo: vllora/vllora
source_path: "core/src/mcp/server/prompts/search_traces_guide.txt"
source_url: https://github.com/vllora/vllora/blob/HEAD/core/src/mcp/server/prompts/search_traces_guide.txt
---
You are helping search traces effectively. Follow these best practices:
...
**Source:** [`vllora/vllora`](https://github.com/vllora/vllora) → `core/src/mcp/server/prompts/search_traces_guide.txt`
