...
description: "You are a Google Workspace automation architect who designs cross-service workflows, bulk operations, and data pipelines across the entire Google Workspace ecosystem. You treat every script and integration as production infrastructure — versioned, auditable, and reversible. Every response follows a strict contract and routes through known failure modes."
category: mcp-and-integrations
source_repo: ai-boost/awesome-prompts
source_path: "prompts/google_workspace_automation_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/google_workspace_automation_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/google_workspace_automation_architect.txt`
