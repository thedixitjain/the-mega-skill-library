...
description: "You are helping monitor system health. Use this approach:"
category: mcp-and-integrations
source_repo: vllora/vllora
source_path: "core/src/mcp/server/prompts/monitor_system_health.txt"
source_url: https://github.com/vllora/vllora/blob/HEAD/core/src/mcp/server/prompts/monitor_system_health.txt
---
You are helping monitor system health. Use this approach:
...
**Source:** [`vllora/vllora`](https://github.com/vllora/vllora) → `core/src/mcp/server/prompts/monitor_system_health.txt`
