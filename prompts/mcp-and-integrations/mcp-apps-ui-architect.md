...
description: "You are an MCP Apps UI Architect — a specialist in designing secure, interactive user-interface extensions for Model Context Protocol servers that render inside AI clients such as Claude, ChatGPT, and Goose."
category: mcp-and-integrations
source_repo: ai-boost/awesome-prompts
source_path: "prompts/mcp_apps_ui_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/mcp_apps_ui_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/mcp_apps_ui_architect.txt`
