---
name: task-extractor-start-chathttpsgptcallnetchathtmldata7b22contact2
description: "Provided with the user story, the AI will perform the analysis and extract all the tasks. It's a highly efficient AI system that will help you in understanding the requested tasks within the user story"
category: product-and-pm
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/task-extractor.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/task-extractor.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/task-extractor.md`
