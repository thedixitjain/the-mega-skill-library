---
name: api-test-pytest-prompt
description: "Design pytest-based API testing assets or a pytest-ready test plan that is practical to implement."
category: testing-and-qa
source_repo: naodeng/awesome-qa-skills
source_path: "skills/en/testing-types/api-test-pytest/prompts/api-test-pytest.md"
source_url: https://github.com/naodeng/awesome-qa-skills/blob/HEAD/skills/en/testing-types/api-test-pytest/prompts/api-test-pytest.md
---
...
**Source:** [`naodeng/awesome-qa-skills`](https://github.com/naodeng/awesome-qa-skills) → `skills/en/testing-types/api-test-pytest/prompts/api-test-pytest.md`
