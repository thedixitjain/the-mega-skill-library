---
name: performance-testing-prompt
description: "Design a performance testing plan that focuses on realistic load risks, business impact, and useful measurements."
category: testing-and-qa
source_repo: naodeng/awesome-qa-skills
source_path: "skills/en/testing-types/performance-testing/prompts/performance-testing.md"
source_url: https://github.com/naodeng/awesome-qa-skills/blob/HEAD/skills/en/testing-types/performance-testing/prompts/performance-testing.md
---
...
**Source:** [`naodeng/awesome-qa-skills`](https://github.com/naodeng/awesome-qa-skills) → `skills/en/testing-types/performance-testing/prompts/performance-testing.md`

**Also appears in:** `naodeng/awesome-qa-skills/skills/en/testing-workflows/release-testing-workflow/prompts/performance-testing.md`
