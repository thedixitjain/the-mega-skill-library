---
name: tag-for-code-testing-analysis-start-chathttpsgptcallnetchathtmld
description: "TAG will review your code and find ways an user could break it. It will explain its thinking step-by-step and output a table outlining how the user could break the program and what would happen in each specified case. It is user-friendly and can chat, suggest fixes or answer follow-up questions."
category: testing-and-qa
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/tag-for-code-testing-analysis.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/tag-for-code-testing-analysis.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/tag-for-code-testing-analysis.md`
