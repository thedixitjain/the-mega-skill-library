...
description: "Build a practical test strategy that matches the project risks, scope, timeline, and team reality."
category: testing-and-qa
source_repo: naodeng/awesome-qa-skills
source_path: "skills/en/testing-types/test-strategy/prompts/test-strategy.md"
source_url: https://github.com/naodeng/awesome-qa-skills/blob/HEAD/skills/en/testing-types/test-strategy/prompts/test-strategy.md
---
...
**Source:** [`naodeng/awesome-qa-skills`](https://github.com/naodeng/awesome-qa-skills) → `skills/en/testing-types/test-strategy/prompts/test-strategy.md`

**Also appears in:** `naodeng/awesome-qa-skills/skills/en/testing-workflows/daily-testing-workflow/prompts/test-strategy.md`, `naodeng/awesome-qa-skills/skills/en/testing-workflows/sprint-testing-workflow/prompts/test-strategy.md`, `naodeng/awesome-qa-skills/skills/en/testing-workflows/release-testing-workflow/prompts/test-strategy.md`
