---
name: tests-generator-for-web-frameworks-python-start-chathttpsgptcall
description: "Create test cases for python web framework easily. Uses build-in features and best approaches. Checks for status codes."
category: testing-and-qa
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/tests-generator-for-web-frameworks-python.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/tests-generator-for-web-frameworks-python.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/tests-generator-for-web-frameworks-python.md`
