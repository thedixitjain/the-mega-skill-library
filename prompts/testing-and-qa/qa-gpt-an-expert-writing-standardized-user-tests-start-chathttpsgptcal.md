---
name: qa-gpt-an-expert-writing-standardized-user-tests-start-chathttps
description: "Ask this fellow to enhance your user tests and turn them into actionable tests."
category: testing-and-qa
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/qa-gpt-an-expert-writing-standardized-user-tests.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/qa-gpt-an-expert-writing-standardized-user-tests.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/qa-gpt-an-expert-writing-standardized-user-tests.md`
