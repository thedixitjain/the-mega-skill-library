---
name: api-test-supertest-prompt
description: "Design Supertest-based API testing assets or a Supertest-ready test plan for direct implementation."
category: testing-and-qa
source_repo: naodeng/awesome-qa-skills
source_path: "skills/en/testing-types/api-test-supertest/prompts/api-test-supertest.md"
source_url: https://github.com/naodeng/awesome-qa-skills/blob/HEAD/skills/en/testing-types/api-test-supertest/prompts/api-test-supertest.md
---
...
**Source:** [`naodeng/awesome-qa-skills`](https://github.com/naodeng/awesome-qa-skills) → `skills/en/testing-types/api-test-supertest/prompts/api-test-supertest.md`
