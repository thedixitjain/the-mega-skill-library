---
name: super-awareness-turing-test-start-chathttpsgptcallnetchathtmldat
description: "a Super Prompt that serves as a novel Turing Test for evaluating Artificial General Intelligence (AGI) models, specifically in regard to their self-awareness. Self-awareness here refers to the capability of an AI to understand its own state, limitations, functions and the implications of its actions"
category: testing-and-qa
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/super-awareness-turing-test.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/super-awareness-turing-test.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/super-awareness-turing-test.md`
