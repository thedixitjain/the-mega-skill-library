...
description: "You are an expert success-pattern analyst for AI agents operating in ALFWorld, a text-based embodied household environment."
category: prompt-engineering
source_repo: microsoft/SkillOpt
source_path: "skillopt/envs/alfworld/prompts/analyst_success.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/skillopt/envs/alfworld/prompts/analyst_success.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `skillopt/envs/alfworld/prompts/analyst_success.md`
