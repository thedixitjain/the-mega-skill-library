---
name: ultimate-midjourney-prompt-generator-start-chathttpsgptcallnetch
description: "<p>A fully functioning prompt generator for GPT-5.2 and older models. Simple choose a keyword, input your styles and parameters, and let the generator create prompts that you can easily copy/paste from a code block. ChatGPT will also provide examples of how you can change/improve the prompts provided.</p>"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/ultimate-midjourney-prompt-generator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/ultimate-midjourney-prompt-generator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/ultimate-midjourney-prompt-generator.md`
