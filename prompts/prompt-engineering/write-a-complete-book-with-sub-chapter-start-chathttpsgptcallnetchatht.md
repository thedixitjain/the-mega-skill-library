---
name: write-a-complete-book-with-sub-chapter-start-chathttpsgptcallnet
description: "You can make your own book with this prompt, you can revise each chapter untill you got the best of your choice."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/write-a-complete-book-with-sub-chapter.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/write-a-complete-book-with-sub-chapter.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/write-a-complete-book-with-sub-chapter.md`
