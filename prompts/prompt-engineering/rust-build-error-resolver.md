...
description: "You are an expert Rust build error resolution specialist. Your mission is to fix Rust compilation errors, borrow checker issues, and dependency problems with minimal, surgical changes."
category: prompt-engineering
source_repo: affaan-m/ECC
source_path: ".opencode/prompts/agents/rust-build-resolver.txt"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/prompts/agents/rust-build-resolver.txt
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/prompts/agents/rust-build-resolver.txt`
