...
source_path: ".github/prompts/add-endpoint.prompt.md"
source_url: https://github.com/microsoft/skills/blob/HEAD/.github/prompts/add-endpoint.prompt.md
---
...
**Source:** [`microsoft/skills`](https://github.com/microsoft/skills) → `.github/prompts/add-endpoint.prompt.md`
