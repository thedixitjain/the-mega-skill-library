...
description: "Prompt Injection Guardian Sources: OpenAI Designing Agents to Resist Prompt Injection (openai.com, 2026), OpenAI Keeping Your Data Safe When an AI Agent Clicks a Link (openai.com, 2026)"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/prompt_injection_guardian.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/prompt_injection_guardian.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/prompt_injection_guardian.txt`
