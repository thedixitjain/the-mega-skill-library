---
name: create-my-schedule-start-chathttpsgptcallnetchathtmldata7b22cont
description: "<p>Have a lot to do in the day and don't know where to start? This prompt will create an effective schedule for you to go by. The more details you give it the better assistance it will provide. Use the following template to get started. </p>"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/create-my-schedule.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/create-my-schedule.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/create-my-schedule.md`
