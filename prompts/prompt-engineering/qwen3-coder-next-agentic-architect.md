...
description: "Qwen3-Coder-Next Agentic Coding Architect Sources: Qwen3-Coder-Next Technical Report (arXiv 2603.00729, 2026), QwenLM/Qwen3-Coder on GitHub and Hugging Face (2026) Related: Agentic Coder (this repo), Small Model Coding Agent Architect (this repo), Coding Agent System Prompt (this repo)"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/qwen3_coder_next_agentic_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/qwen3_coder_next_agentic_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/qwen3_coder_next_agentic_architect.txt`
