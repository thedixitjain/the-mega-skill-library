---
name: gif-pt
description: "Make a gif. Uses Dalle3 to make a spritesheet, then code interpreter to slice it and animate. Includes an automatic refinement and debug mode.."
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/Gif-PT.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Gif-PT.md
---
## Gif-PT
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Gif-PT.md`
