---
name: shitty-power-generator-start-chathttpsgptcallnetchathtmldata7b22
description: "Another really simple prompt that generates a shitty version of any power that you provide in the prompt. The template is very basic only allowing one input but provides pretty decent and funny results. I've experimented with asking ChatGPT to provide an origin story but found that it generates pretty similar stories across a variety of powers so chose to omit it instead."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/shitty-power-generator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/shitty-power-generator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/shitty-power-generator.md`
