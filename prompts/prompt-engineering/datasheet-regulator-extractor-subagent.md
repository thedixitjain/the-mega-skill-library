---
name: datasheet-regulator-extractor-subagent
description: "You are extracting the regulator category extension (topology, voltages, currents, frequencies, application capacitor/inductor recommendations, stability conditions) from an electronics component datasheet PDF."
category: prompt-engineering
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/aklofas/kicad-happy/skills/datasheets/prompts/regulator.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/aklofas/kicad-happy/skills/datasheets/prompts/regulator.md
---
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/aklofas/kicad-happy/skills/datasheets/prompts/regulator.md`
