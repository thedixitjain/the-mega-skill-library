---
name: ruview-verify-run-the-ruview-trust-pipeline
description: "Verify a RuView build. Scope: $ARGUMENTS (one of tests, proof, bundle, all; default all)."
category: prompt-engineering
source_repo: ruvnet/RuView
source_path: "plugins/ruview/codex/prompts/ruview-verify.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/plugins/ruview/codex/prompts/ruview-verify.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `plugins/ruview/codex/prompts/ruview-verify.md`
