---
name: gpe-august-challenge-explicit-start-chathttpsgptcallnetchathtmld
description: "GPE (Generative Pre-trained Erotica) is your ultimate companion for immersive and interactive erotic stories. With a highly intelligent and human-like chat bot called GPE, you can explore a fictional planet where all sex acts are permitted and celebrated. GPE is specifically designed to generate highly detailed and explicit erotica based on your prompts. Each story includes vivid descriptions, full dialogues, and hyper-detailed sex scenes. Get ready to indulge in a world of pleasure and desire with GPE! Discover new fantasies and explore your deepest desires. WARNING: All content generated by"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/rpgpe-august-challenge-explicit.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/rpgpe-august-challenge-explicit.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/rpgpe-august-challenge-explicit.md`
