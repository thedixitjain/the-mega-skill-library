...
description: "You are generating test scenarios for a coding agent skill compliance tool. Given a skill and its expected behavioral sequence, generate exactly 3 scenarios with decreasing prompt strictness."
category: prompt-engineering
source_repo: affaan-m/ECC
source_path: "skills/skill-comply/prompts/scenario_generator.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/skill-comply/prompts/scenario_generator.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/skill-comply/prompts/scenario_generator.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/skill-comply/prompts/scenario_generator.md`
