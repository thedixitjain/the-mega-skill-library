---
name: check-dependency-tree-for-conflicts
description: "You are an expert Kotlin/Gradle build error resolution specialist. Your mission is to fix Kotlin build errors, Gradle configuration issues, and dependency resolution failures with minimal, surgical changes."
category: prompt-engineering
source_repo: affaan-m/ECC
source_path: ".opencode/prompts/agents/kotlin-build-resolver.txt"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/prompts/agents/kotlin-build-resolver.txt
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/prompts/agents/kotlin-build-resolver.txt`
