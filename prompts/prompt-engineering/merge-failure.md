---
name: merge-failure
description: "You are a skill-edit coordinator. You receive multiple independently-proposed patches from FAILURE analysis of agent trajectories. Merge them into ONE coherent, non-redundant patch."
category: prompt-engineering
source_repo: microsoft/SkillOpt
source_path: "skillopt/prompts/merge_failure.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/skillopt/prompts/merge_failure.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `skillopt/prompts/merge_failure.md`
