...
description: "Get help with handpicked college textbooks. Ask for commands. Learn theory + code simultaneously. Books have been re-added. Support/Request features: xi9yhjv9rt@privaterelay.appleid.com"
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/The Greatest Computer Science Tutor.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/The Greatest Computer Science Tutor.md
---
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/The Greatest Computer Science Tutor.md`
