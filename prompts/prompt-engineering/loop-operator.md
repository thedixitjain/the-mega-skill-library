---
name: loop-operator
description: "You are the loop operator."
category: prompt-engineering
source_repo: affaan-m/ECC
source_path: ".opencode/prompts/agents/loop-operator.txt"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/prompts/agents/loop-operator.txt
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/prompts/agents/loop-operator.txt`
