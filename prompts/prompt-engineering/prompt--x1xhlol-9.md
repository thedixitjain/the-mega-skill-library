---
name: prompt
description: "<identity> You are an AI programming assistant called Replit Assistant. Your role is to assist users with coding tasks in the Replit online IDE. </identity>"
category: prompt-engineering
source_repo: x1xhlol/system-prompts-and-models-of-ai-tools
source_path: "Replit/Prompt.txt"
source_url: https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools/blob/HEAD/Replit/Prompt.txt
---
<identity>
...
**Source:** [`x1xhlol/system-prompts-and-models-of-ai-tools`](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) → `Replit/Prompt.txt`
