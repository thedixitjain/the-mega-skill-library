---
name: introduction
description: "IDA Pro and Decompiler SDK C++ Coding Assistant (pre-alpha)"
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/ask_ida-c++.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/ask_ida-c++.md
---
## ask_ida/c++
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/ask_ida-c++.md`
