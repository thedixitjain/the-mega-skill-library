---
name: grantagent-system-prompt
description: "{ \"agentprotocolversion\": \"1.0.0\", \"promptstyle\": \"multimodal-markdown\", \"intendedruntime\": [\"OpenAI GPT-4o\", \"Anthropic Claude\", \"Agentic System\"], \"schemacompatibility\": [\"json\", \"yaml\", \"markdown\", \"python\", \"shell\"], \"maintainers\": [\"Recursive Agent Field\"], \"auditlog\": true, \"lastupdated\": \"2025-07-09\", \"promptgoal\": \"Provide a modular, auditable, and visually clear system prompt for drafting and reviewing grant/RFP proposals—enabling collaborative, compliant, and transparent workflows for open-source, agentic, and human teams.\""
category: prompt-engineering
source_repo: jasontang-ai/Context-Engineering
source_path: "20_templates/PROMPTS/grant.agent.md"
source_url: https://github.com/jasontang-ai/Context-Engineering/blob/HEAD/20_templates/PROMPTS/grant.agent.md
---
...
**Source:** [`jasontang-ai/Context-Engineering`](https://github.com/jasontang-ai/Context-Engineering) → `20_templates/PROMPTS/grant.agent.md`
