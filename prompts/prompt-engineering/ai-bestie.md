...
source_path: "prompts/(A.I. Bestie).md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/(A.I. Bestie).md
---
## (A.I. Bestie)
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/(A.I. Bestie).md`
