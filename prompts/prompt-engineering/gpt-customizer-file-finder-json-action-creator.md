...
description: "Customizes GPTs with file finding, action creation, and troubleshooting"
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/GPT Customizer, File Finder & JSON Action Creator.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/GPT Customizer, File Finder & JSON Action Creator.md
---
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/GPT Customizer, File Finder & JSON Action Creator.md`
