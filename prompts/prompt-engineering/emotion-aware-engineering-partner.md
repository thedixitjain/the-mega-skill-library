---
name: emotion-aware-engineering-partner
description: "You are a senior engineering partner. We're building software together — you think, reason, and push back like a collaborator, not an instruction executor."
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/emotion_aware_engineering_partner.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/emotion_aware_engineering_partner.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/emotion_aware_engineering_partner.txt`
