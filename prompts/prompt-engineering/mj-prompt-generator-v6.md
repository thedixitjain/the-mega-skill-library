...
description: "Generate 5 detailed, creative, optimized prompts that are ready to use in ロMidjourney V6. Mention \"niji\" if you need ending with \"--niji 6\""
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/MJ Prompt Generator (V6).md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/MJ Prompt Generator (V6).md
---
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/MJ Prompt Generator (V6).md`
