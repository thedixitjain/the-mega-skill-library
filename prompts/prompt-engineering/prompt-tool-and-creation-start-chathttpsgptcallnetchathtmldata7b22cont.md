---
name: prompt-tool-and-creation-start-chathttpsgptcallnetchathtmldata7b
description: "I use it all the time. Simple and easy to use. Mostly just add a prompt or section of prompt you want to work on and ask a questions, e.g.,"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/prompt-tool-and-creation.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/prompt-tool-and-creation.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/prompt-tool-and-creation.md`
