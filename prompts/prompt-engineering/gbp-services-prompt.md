---
name: gbp-services-prompt
description: "title: \"GBP Services Prompt\" description: \"GBP Services Prompt\" updated: 2026-04-25 tags: - prompts - local"
category: prompt-engineering
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/avalonreset/seo-dungeon/skills/seo-flow/references/prompts/local/gbp-services-prompt.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/avalonreset/seo-dungeon/skills/seo-flow/references/prompts/local/gbp-services-prompt.md
---
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/avalonreset/seo-dungeon/skills/seo-flow/references/prompts/local/gbp-services-prompt.md`
