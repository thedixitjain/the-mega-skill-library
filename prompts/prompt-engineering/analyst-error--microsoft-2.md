---
name: analyst-error
description: "You are an expert failure-analysis agent for theorem-grounded mathematical multiple-choice questions."
category: prompt-engineering
source_repo: microsoft/SkillOpt
source_path: "skillopt/envs/livemathematicianbench/prompts/analyst_error.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/skillopt/envs/livemathematicianbench/prompts/analyst_error.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `skillopt/envs/livemathematicianbench/prompts/analyst_error.md`
