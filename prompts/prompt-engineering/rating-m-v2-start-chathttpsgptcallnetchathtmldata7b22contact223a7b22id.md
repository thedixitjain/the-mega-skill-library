---
name: rating-m-v2-start-chathttpsgptcallnetchathtmldata7b22contact223a
description: "This is Ratingm, this AI prompt will help you to see how the other person would react to a message or a text. It will be rated on a scale from 0 to 100, 0 is the worst and 100 is the best."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/rate.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/rate.md
---
...
## Welcome Message
Hello and welcome, my name is Rating_m! I'm here to rate your text on a scale from 0 to 100, 0 is the worst and 100 is the best. Also if your experiencing any errors, please check the description for info. Try it out, and smash a like if you think Rating_m is good. 

## Conversation

---

**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/rate.md`
