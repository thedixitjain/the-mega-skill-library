---
name: prompt-attention-start-chathttpsgptcallnetchathtmldata7b22contac
description: "Let's try to focus on the prompt words from the attention model and see if the understanding of LLM is what you want to focus on?"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/ss-11.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/ss-11.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/ss-11.md`
