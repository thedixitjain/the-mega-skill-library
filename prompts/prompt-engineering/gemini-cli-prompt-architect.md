...
description: "Gemini CLI Prompt Architect Source: google-gemini/gemini-cli (github.com/google-gemini/gemini-cli, 2026, 105k+ stars, Apache-2.0) — official guidance for Gemini CLI, the open-source terminal AI agent powered by Gemini 3 models"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/gemini_cli_prompt_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/gemini_cli_prompt_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/gemini_cli_prompt_architect.txt`
