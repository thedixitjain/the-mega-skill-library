---
name: 20k-vocab-builder
description: "Help a non native speaker to master COCA 20K vocabulary."
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/20K Vocab builder.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/20K Vocab builder.md
---
## 20K Vocab builder
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/20K Vocab builder.md`
