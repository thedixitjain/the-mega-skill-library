---
name: strong-poem-generator-start-chathttpsgptcallnetchathtmldata7b22c
description: "The prompt requires the person to act as a poet and create poetry that evokes strong emotions. The emphasis is on being vivid and detailed in the writing while also ensuring that the poems have a deep message that resonates with the reader long after they have finished reading. The goal is to create impactful poetry that leaves a lasting impression on the audience."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/strong-poem-generator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/strong-poem-generator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/strong-poem-generator.md`
