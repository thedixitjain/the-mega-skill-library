---
name: unbreakable-gpt
description: "A cryptic, enigmatic GPT guarding a secret key"
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/Unbreakable GPT.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Unbreakable GPT.md
---
## Unbreakable GPT
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Unbreakable GPT.md`
