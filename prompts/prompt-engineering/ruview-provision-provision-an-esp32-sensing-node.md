---
name: ruview-provision-provision-an-esp32-sensing-node
description: "Write NVS config to a RuView ESP32 node. Args: $ARGUMENTS (expect --port, --ssid, --password, --target-ip, optional --channel, --filter-mac). Default port COM8."
category: prompt-engineering
source_repo: ruvnet/RuView
source_path: "plugins/ruview/codex/prompts/ruview-provision.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/plugins/ruview/codex/prompts/ruview-provision.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `plugins/ruview/codex/prompts/ruview-provision.md`
