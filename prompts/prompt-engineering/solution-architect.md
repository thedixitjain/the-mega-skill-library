...
description: "Solution Architect Agent Source: https://github.com/repowise-dev/claude-code-prompts (Apr 2026, 983 stars) Independently authored prompt for producing implementation plans grounded in actual codebase observation."
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/solution_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/solution_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/solution_architect.txt`
