...
description: "OpenAI Codex CLI Prompt Architect Source: OpenAI Codex Prompting Guide (developers.openai.com/cookbook/examples/gpt-5/codexpromptingguide, Feb 2026) — official guidance for OpenAI Codex CLI / codex-rs, the autonomous terminal coding agent"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/openai_codex_cli_prompt_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/openai_codex_cli_prompt_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/openai_codex_cli_prompt_architect.txt`
