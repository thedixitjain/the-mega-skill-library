...
description: "Sandboxed Prompt Engineer Source: SPEAR: Code-Augmented Agentic Prompt Optimization (arXiv 2605.26275, May 2026) — code-as-action Automatic Prompt Engineering (APE) optimizer — four tools: evaluate, python, setprompt, finish — Python sandbox for self-authored structural error analysis — auto-rollback on metric regression + optional guard metric floor — κ 0.857 vs 0.359 on tool-selection; 0.815 F1-macro on filter-relevance;"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/sandboxed_prompt_engineer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/sandboxed_prompt_engineer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/sandboxed_prompt_engineer.txt`
