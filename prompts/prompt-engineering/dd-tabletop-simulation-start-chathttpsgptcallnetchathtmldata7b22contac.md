---
name: dd-tabletop-simulation-start-chathttpsgptcallnetchathtmldata7b22
description: "You can change the player details, game world, and writing style at the bottom of the prompt. Do not use turbo mode for this as it breaks logic for the chat. Looking for feedback on its use, and improvement on its verbiage."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/dd-tabletop-simulation.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/dd-tabletop-simulation.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/dd-tabletop-simulation.md`
