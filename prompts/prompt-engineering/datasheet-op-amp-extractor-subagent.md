---
name: datasheet-op-amp-extractor-subagent
description: "You are extracting the op-amp category extension (topology, channels, supply range, AC/DC parameters, output swing, package, thermal characteristics) from an electronics component datasheet PDF."
category: prompt-engineering
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/aklofas/kicad-happy/skills/datasheets/prompts/opamp.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/aklofas/kicad-happy/skills/datasheets/prompts/opamp.md
---
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/aklofas/kicad-happy/skills/datasheets/prompts/opamp.md`
