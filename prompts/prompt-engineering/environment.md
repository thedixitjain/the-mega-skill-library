---
name: environment
description: "Coding Agent System Prompt Source: https://github.com/repowise-dev/claude-code-prompts (Apr 2026, 983 stars) Independent system prompt derived from patterns observed in Claude Code behavior."
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/coding_agent_system_prompt.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/coding_agent_system_prompt.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/coding_agent_system_prompt.txt`
