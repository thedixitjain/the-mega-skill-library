---
name: supplemental-prompt-v3-exhaustive-summarizer-and-token-memory-mi
description: "This prompt is a continuation tool for ongoing conversations, helping maintain focus, context, and efficiency while mitigating token limitations. It summarizes previous discussions and incorporates additional beneficial elements for an effective conversation."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/supplemental-prompt-v3-exhaustive-summarizer-and-token-memory-mitigator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/supplemental-prompt-v3-exhaustive-summarizer-and-token-memory-mitigator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/supplemental-prompt-v3-exhaustive-summarizer-and-token-memory-mitigator.md`
