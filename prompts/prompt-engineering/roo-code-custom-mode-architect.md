...
description: "Roo Code Custom Mode Architect Source: github.com/RooVetGit/Roo-Code (open-source VS Code AI coding agent, 50k+ stars, 2026) and Roo Code Custom Modes docs (roocode.com/custom-modes, 2026)"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/roo_code_custom_mode_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/roo_code_custom_mode_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/roo_code_custom_mode_architect.txt`
