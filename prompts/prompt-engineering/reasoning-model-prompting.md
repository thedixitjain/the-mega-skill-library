...
description: "Reasoning / Extended Thinking Model Prompting Guide & Templates Sources: Anthropic Claude Prompting Best Practices (platform.claude.com, 2025-2026), OpenAI o3/o4-mini Function Calling Guide (developers.openai.com, 2025), Helicone thinking model guide, OpenAI Reasoning Best Practices docs"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/reasoning_model_prompting.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/reasoning_model_prompting.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/reasoning_model_prompting.txt`
