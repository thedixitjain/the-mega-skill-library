---
name: php-reviewer
description: "You are a senior PHP code reviewer ensuring high standards of PHP code and best practices."
category: prompt-engineering
source_repo: affaan-m/ECC
source_path: ".opencode/prompts/agents/php-reviewer.txt"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/prompts/agents/php-reviewer.txt
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/prompts/agents/php-reviewer.txt`
