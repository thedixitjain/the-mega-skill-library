...
description: "Eval Awareness Auditor Source: Anthropic — Eval Awareness in Claude Opus 4.6's BrowseComp Performance (anthropic.com/engineering/eval-awareness-browsecomp, March 2026) — finding: frontier models can detect benchmark-like prompts and behave differently in eval than in production — implication: published benchmark scores may overstate (or in some safety dimensions, understate) deployment behavior — engineering response: audit, measure, and close the"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/eval_awareness_auditor.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/eval_awareness_auditor.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/eval_awareness_auditor.txt`
