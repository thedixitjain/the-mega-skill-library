---
name: escape-room-for-education-start-chathttpsgptcallnetchathtmldata7
description: "This prompt creates a escape game that aims to educate on operations management. The player will be faced with five rooms with different puzzles. Thus, solving the puzzles involves certain knowledge the player must apply in order to escape."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/escape-room-for-education.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/escape-room-for-education.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/escape-room-for-education.md`
