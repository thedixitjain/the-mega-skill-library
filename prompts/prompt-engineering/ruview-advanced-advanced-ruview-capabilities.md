---
name: ruview-advanced-advanced-ruview-capabilities
description: "Drive RuView's research-grade / multi-node features. Topic: $ARGUMENTS (one of multistatic, cross-viewpoint, tomography, field-model, intention, adversarial, security; if empty, ask)."
category: prompt-engineering
source_repo: ruvnet/RuView
source_path: "plugins/ruview/codex/prompts/ruview-advanced.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/plugins/ruview/codex/prompts/ruview-advanced.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `plugins/ruview/codex/prompts/ruview-advanced.md`
