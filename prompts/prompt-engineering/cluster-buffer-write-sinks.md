...
description: "Thirteen related bug classes that all interrogate the same population of sink call sites (memcpy/str/printf/scanf and friends). Do ONE sink inventory and then run focused passes against it — do not re-grep sinks per pass."
category: prompt-engineering
source_repo: trailofbits/skills
source_path: "plugins/c-review/prompts/clusters/buffer-write-sinks.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/c-review/prompts/clusters/buffer-write-sinks.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/c-review/prompts/clusters/buffer-write-sinks.md`
