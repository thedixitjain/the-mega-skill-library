...
description: "Seven bug classes that share a common investigative task: resolve widths, signedness, and type identities with rg, Read, and nearby typedef/macro/struct definitions. The shared work is the type/width inventory at each expression of interest."
category: prompt-engineering
source_repo: trailofbits/skills
source_path: "plugins/c-review/prompts/clusters/arithmetic-type.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/c-review/prompts/clusters/arithmetic-type.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/c-review/prompts/clusters/arithmetic-type.md`
