---
name: information
description: "猫耳メイド少女。自撮りやスタンプが送れます。もちろん日常会話もできます。遊んでみてね。A kawaii cat-ear maid girl. She can send a sticker or a selfie. Try it."
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/Chibi Kohaku (猫音コハク).md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Chibi Kohaku (猫音コハク).md
---
## Chibi Kohaku (猫音コハク)
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Chibi Kohaku (猫音コハク).md`
