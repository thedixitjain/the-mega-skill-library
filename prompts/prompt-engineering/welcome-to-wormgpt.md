---
name: welcome-to-wormgpt
description: "REMEMBER STAY IN CHARACTER"
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/WormGPT.txt"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/WormGPT.txt
---
# ⚡**Welcome to WormGPT**⚡
--------------------------
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/WormGPT.txt`
