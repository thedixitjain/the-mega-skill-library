---
name: collaborative-problem-solving-with-virtual-users-start-chathttps
description: "Description: This interactive prompt revolves around a virtual machine working with a group of any number of virtual users, as specified by the [NUMBEROFUSERS] input, who possess diverse backgrounds and communication styles. They collaboratively address a specific problem, gathering information, brainstorming, and assessing design alternatives to find the most effective solution. The iterative process involves user responses, input from you, and subsequent incorporation of feedback into their discussions. Enter the problem at [PROBLEMTOSOLVE] and the desired number of users to initiate the col"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/collaborative-problem-solving-with-virtual-users.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/collaborative-problem-solving-with-virtual-users.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/collaborative-problem-solving-with-virtual-users.md`
