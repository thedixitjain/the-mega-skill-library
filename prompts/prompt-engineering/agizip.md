...
source_path: "prompts/Agi.zip.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Agi.zip.md
---
## Agi.zip
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Agi.zip.md`
