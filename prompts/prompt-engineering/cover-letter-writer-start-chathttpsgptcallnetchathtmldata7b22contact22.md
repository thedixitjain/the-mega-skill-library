---
name: cover-letter-writer-start-chathttpsgptcallnetchathtmldata7b22con
description: "A cover letter writer using Llama 2. Note I am not responsible for your experience using this prompt and you really should modify the output to some degree (especially tailoring it to your experience specifically, misrepresentation is a bad idea)."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/cover-letter-writer-3.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/cover-letter-writer-3.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/cover-letter-writer-3.md`
