...
description: "Four bug classes that all answer questions about the same mental model: for each allocated object, what is its alloc site, its init site(s), its free site(s), and its use sites? Build that model once, then ask four different questions of it."
category: prompt-engineering
source_repo: trailofbits/skills
source_path: "plugins/c-review/prompts/clusters/object-lifecycle.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/c-review/prompts/clusters/object-lifecycle.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/c-review/prompts/clusters/object-lifecycle.md`
