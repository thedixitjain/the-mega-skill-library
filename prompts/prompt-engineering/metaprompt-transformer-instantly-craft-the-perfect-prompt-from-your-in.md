---
name: metaprompt-transformer-instantly-craft-the-perfect-prompt-from-y
description: "Dive into the forefront of AI technology with this MetaPrompt Transformer.✨ By simply providing an initial input, this tool crafts a sophisticated prompt, ensuring AI delivers the most effective and precise answers to your specific queries or challenges.🤖🧠"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/metaprompt-transformer-instantly-craft-the-perfect-prompt-from-your-input-3.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/metaprompt-transformer-instantly-craft-the-perfect-prompt-from-your-input-3.md
---
...
'''
Prompt1 (Response to User) → Output1 (Response to User): [Used as necessary context for creating Prompt2]
'''
...
'''
User First Input Context → Input: Prompt1 (Response to User) → Output1 (Response to User): [Used as necessary context for creating Prompt2]
---
[Processing]
# [Prompt title]
  # Prerequisites:
...
## Welcome Message
『For the forward-thinkers🔭: Try inputting topics like 'Gourmet international recipes at home'🍱, 'Everyday methods for mental and physical health'💪🧘, 'Efficient strategies for remote work'💼🏠, or 'The best ways to spend a day on a space vacation'🚀🪐. Let's get the optimal prompt for you!』

## Conversation

---

**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/metaprompt-transformer-instantly-craft-the-perfect-prompt-from-your-input-3.md`
