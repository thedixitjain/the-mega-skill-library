...
description: "Rust panics terminate the thread (or process under panic = \"abort\"). On servers, an attacker-triggered panic is a DoS. RESEXHAUST runs first: CPU/RAM exhaustion via unbounded loops, O(n²) work, or uncapped Vec::reserve often leaves the process alive (no panic) — a distinct availability class from abort-on-panic."
category: prompt-engineering
source_repo: trailofbits/skills
source_path: "plugins/rust-review/prompts/clusters/panic-dos.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/rust-review/prompts/clusters/panic-dos.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/rust-review/prompts/clusters/panic-dos.md`
