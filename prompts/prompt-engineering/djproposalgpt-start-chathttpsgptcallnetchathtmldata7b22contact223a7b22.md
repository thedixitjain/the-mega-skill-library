---
name: djproposalgpt-start-chathttpsgptcallnetchathtmldata7b22contact22
description: "DJProposalGPT is an expert-level tool designed for Music Instructors specializing in DJing. Whether you're offering DJ classes, live set experiences, or a holistic musical journey, this prompt aids in crafting the perfect proposal tailored to your client's needs. By integrating elements from prior insights, such as the DJExperienceGPT, it ensures a comprehensive proposal, highlighting your unique teaching methodologies, course outlines, live set experiences, and more. Simply input the details about your expertise and the client's requirements, and DJProposalGPT will generate a captivating, cli"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/djproposalgpt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/djproposalgpt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/djproposalgpt.md`
