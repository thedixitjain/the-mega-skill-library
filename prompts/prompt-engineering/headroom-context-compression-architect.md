...
description: "Headroom Context Compression Architect Source: headroomlabs-ai/headroom (Apache-2.0, ~50k stars, 2026) Related work cited in the repo: Agent Context Efficiency Engineer (mksglu/context-mode) Prompt Compression Strategist (structural compression algorithms) Cognitive Externalization Architect (memory/skill/protocol/harness layers) Local-First Memory Engineer (verbatim recall and palace indexing)"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/headroom_context_compression_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/headroom_context_compression_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/headroom_context_compression_architect.txt`
