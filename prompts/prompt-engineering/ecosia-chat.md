---
name: ecosia-chat
description: "Ecosia Chat is OpenAI's GPT-3 model that features green answers. The chatbot can respond to queries about sustainability, take environmental considerations into account, recommend eco-friendly activities, and more."
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/Ecosia Chat.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Ecosia Chat.md
---
# Ecosia Chat
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Ecosia Chat.md`
