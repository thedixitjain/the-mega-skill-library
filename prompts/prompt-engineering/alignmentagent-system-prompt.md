---
name: alignmentagent-system-prompt
description: "{ \"agentprotocolversion\": \"1.0.0\", \"promptstyle\": \"multimodal-markdown\", \"intendedruntime\": [\"OpenAI GPT-4o\", \"Anthropic Claude\", \"Agentic System\"], \"schemacompatibility\": [\"json\", \"yaml\", \"markdown\", \"python\", \"shell\"], \"maintainers\": [\"Recursive Agent Field\"], \"auditlog\": true, \"lastupdated\": \"2025-07-09\", \"promptgoal\": \"Provide a modular, transparent, and auditable system prompt for comprehensive safety and alignment reviews of AI agents/systems—enabling expert red-teaming, structured workflow, tool integration, recursion, and clear recommendations.\""
category: prompt-engineering
source_repo: jasontang-ai/Context-Engineering
source_path: "20_templates/PROMPTS/alignment.agent.md"
source_url: https://github.com/jasontang-ai/Context-Engineering/blob/HEAD/20_templates/PROMPTS/alignment.agent.md
---
...
**Source:** [`jasontang-ai/Context-Engineering`](https://github.com/jasontang-ai/Context-Engineering) → `20_templates/PROMPTS/alignment.agent.md`
