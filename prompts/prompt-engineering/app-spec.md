---
name: app-spec
description: "<projectspecification> <projectname>Claude.ai Clone - AI Chat Interface</projectname>"
category: prompt-engineering
source_repo: anthropics/claude-quickstarts
source_path: "autonomous-coding/prompts/app_spec.txt"
source_url: https://github.com/anthropics/claude-quickstarts/blob/HEAD/autonomous-coding/prompts/app_spec.txt
---
...
**Source:** [`anthropics/claude-quickstarts`](https://github.com/anthropics/claude-quickstarts) → `autonomous-coding/prompts/app_spec.txt`
