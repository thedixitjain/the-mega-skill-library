---
name: powerful-associative-drawing-prompt-words-start-chathttpsgptcall
description: "The cue word can generate a corresponding description + detail description + style description + artist + effects rendering + lighting settings + art website + composition perspective based on the painting theme. The associative power of LLM can be used"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/powerful-associative-drawing-prompt-words.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/powerful-associative-drawing-prompt-words.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/powerful-associative-drawing-prompt-words.md`
