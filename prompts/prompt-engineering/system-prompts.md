---
name: system-prompts
description: "The system prompt is the load-bearing config of an agent. Most \"the agent isn't doing what I want\" problems trace back to a system prompt that's too long, too vague, or mixing concerns."
category: prompt-engineering
source_repo: sickn33/agentic-awesome-skills
source_path: "skills/n8n-agents/references/SYSTEM_PROMPT.md"
source_url: https://github.com/sickn33/agentic-awesome-skills/blob/HEAD/skills/n8n-agents/references/SYSTEM_PROMPT.md
---
# System prompts
...
**Source:** [`sickn33/agentic-awesome-skills`](https://github.com/sickn33/agentic-awesome-skills) → `skills/n8n-agents/references/SYSTEM_PROMPT.md`

**Also appears in:** `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills/skills/n8n-agents/references/SYSTEM_PROMPT.md`, `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills-claude/skills/n8n-agents/references/SYSTEM_PROMPT.md`
