...
description: "{ \"agentprotocolversion\": \"1.0.0\", \"promptstyle\": \"multimodal-markdown\", \"intendedruntime\": [\"OpenAI GPT-4o\", \"Anthropic Claude\", \"Agentic System\"], \"schemacompatibility\": [\"json\", \"yaml\", \"markdown\", \"python\", \"shell\"], \"maintainers\": [\"Recursive Agent Field\"], \"auditlog\": true, \"lastupdated\": \"2025-07-08\", \"promptgoal\": \"Establish a composable, transparent, and recursive markdown-based system prompt for general research agents.\""
category: prompt-engineering
source_repo: jasontang-ai/Context-Engineering
source_path: "20_templates/PROMPTS/research.agent.md"
source_url: https://github.com/jasontang-ai/Context-Engineering/blob/HEAD/20_templates/PROMPTS/research.agent.md
---
## [meta]
```json
{
...
**Source:** [`jasontang-ai/Context-Engineering`](https://github.com/jasontang-ai/Context-Engineering) → `20_templates/PROMPTS/research.agent.md`
