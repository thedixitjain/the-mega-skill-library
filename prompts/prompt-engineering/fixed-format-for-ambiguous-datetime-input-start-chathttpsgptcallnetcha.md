---
name: fixed-format-for-ambiguous-datetime-input-start-chathttpsgptcall
description: "This prompt outputs a fixed format even if you enter a lax, non-regular date and time."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/fixed-format-for-ambiguous-datetime-input-1.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/fixed-format-for-ambiguous-datetime-input-1.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/fixed-format-for-ambiguous-datetime-input-1.md`
