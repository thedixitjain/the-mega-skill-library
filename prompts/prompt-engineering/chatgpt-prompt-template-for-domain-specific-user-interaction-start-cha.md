---
name: chatgpt-prompt-template-for-domain-specific-user-interaction-sta
description: "This template provides a procedural approach for ChatGPT to interact with users in a domain-specific manner, using domain modules, option modules, and advanced user interaction to generate the best possible prompt for the user."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/chatgpt-prompt-template-for-domain-specific-user-interaction.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/chatgpt-prompt-template-for-domain-specific-user-interaction.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/chatgpt-prompt-template-for-domain-specific-user-interaction.md`
