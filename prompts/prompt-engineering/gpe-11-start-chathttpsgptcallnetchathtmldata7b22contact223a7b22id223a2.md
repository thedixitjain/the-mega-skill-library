---
name: gpe-11-start-chathttpsgptcallnetchathtmldata7b22contact223a7b22i
description: "{Hi you wonderful pervs! Following the success of GPE 1.0, I created a new prompt from scratch designed to have better tolerance for more graphic/explicit content. It's not better than 1.0, just different. e.g in my tests of 1.1, the initial prompt was filthy but follow up requests are often declined. I'm working on that. ~u/DarthSurance}"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/gpe-11-1.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/gpe-11-1.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/gpe-11-1.md`
