...
source_path: ".continue/prompts/planning-with-files.prompt"
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/.continue/prompts/planning-with-files.prompt
---
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `.continue/prompts/planning-with-files.prompt`
