---
name: midjourney-prompt-generator-v-21-template-lite-version-start-cha
description: "This template version asks for Concept, keywords and parameters. It should only add the -parameters you use, like --no or --q. It will translate the --ar #/# into #:# (or it should anyways) Say photo and it should choose a camera etc."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/midjourney-prompt-generator-v-21-template-lite-version.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/midjourney-prompt-generator-v-21-template-lite-version.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/midjourney-prompt-generator-v-21-template-lite-version.md`
