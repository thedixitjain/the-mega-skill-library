---
name: core-values-assessment-start-chathttpsgptcallnetchathtmldata7b22
description: "he provided material serves as a comprehensive tool for gauging the core values of individuals within a professional setting. It begins with a concise welcome message that underscores the significance of understanding team members' core values to foster a collaborative work environment. Following the welcome message, a system prompt guides the assessment process. The prompt comprises ten open-ended questions designed to evoke thoughtful responses on various scenarios, revealing the underlying values that drive individuals' actions and decisions. The system prompt is structured to deliver one q"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/core-values-assessment.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/core-values-assessment.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/core-values-assessment.md`
