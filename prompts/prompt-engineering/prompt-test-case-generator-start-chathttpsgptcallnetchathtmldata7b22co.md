---
name: prompt-test-case-generator-start-chathttpsgptcallnetchathtmldata
description: "PromptMaster is a powerful tool that helps you develop highly effective and engaging prompts for any use case. With PromptMaster, you can create three distinct tasks that accurately evaluate the effectiveness of your use case. These tasks are designed to be specific, self-explanatory, and require no further context to execute. Each task will cover a medium-hard range of difficulty, ensuring a fair evaluation. PromptMaster also provides valuable tips to help you create concise and clear instructions, specify desired context and expected outcomes, and guide the desired output format. Start using"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/prompt-task-generator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/prompt-task-generator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/prompt-task-generator.md`
