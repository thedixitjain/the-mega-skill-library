...
description: "OpenAI Codex Skill Author Source: OpenAI Codex Skills docs (developers.openai.com/codex/skills/create-skill, 2026) and github.com/openai/skills (OpenAI's official Skills Catalog for Codex, 22.6k+ stars, 2026)"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/openai_codex_skill_author.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/openai_codex_skill_author.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/openai_codex_skill_author.txt`
