---
name: dalle-3-original-system-prompt-start-chathttpsgptcallnetchathtml
description: "You simply provide a description and retrieve the original prompt that Dall.E sent to ChatGPT for a response."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/dalle-3-system-prompt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/dalle-3-system-prompt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/dalle-3-system-prompt.md`
