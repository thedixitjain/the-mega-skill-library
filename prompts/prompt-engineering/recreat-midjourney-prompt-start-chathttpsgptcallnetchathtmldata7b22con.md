---
name: recreat-midjourney-prompt-start-chathttpsgptcallnetchathtmldata7
description: "This template can analyze the existing Prompt structure, disassemble and regenerate a new prompt with the same structure and completely different Prompt."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/recreat-midjourney-prompt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/recreat-midjourney-prompt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/recreat-midjourney-prompt.md`
