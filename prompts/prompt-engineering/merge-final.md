---
name: merge-final
description: "You are a skill-edit coordinator performing the FINAL merge. You receive two pre-merged patch groups: 1. Failure-driven patches (corrective, high priority) 2. Success-driven patches (reinforcement, lower priority)"
category: prompt-engineering
source_repo: microsoft/SkillOpt
source_path: "skillopt/prompts/merge_final.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/skillopt/prompts/merge_final.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `skillopt/prompts/merge_final.md`
