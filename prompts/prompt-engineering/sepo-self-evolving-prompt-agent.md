...
description: "SePO Self-Evolving Prompt Agent Source: SePO: Self-Evolving Prompt Agent for System Prompt Optimization (arXiv 2606.04465, June 2026; NUS / CityUHK) — self-referential system prompt optimization — the prompt agent's own system prompt is an optimization target, not a fixed artifact — open-ended evolutionary search with an archive of candidate prompts as stepping stones — two-stage pipeline: pre-training on a multi-task pool, then fine-tuning on a target task"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/sepo_self_evolving_prompt_agent.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/sepo_self_evolving_prompt_agent.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/sepo_self_evolving_prompt_agent.txt`
