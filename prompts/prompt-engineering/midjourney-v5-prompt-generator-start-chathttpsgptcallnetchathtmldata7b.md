---
name: midjourney-v5-prompt-generator-start-chathttpsgptcallnetchathtml
description: "This should suggest a prompt and know all the prompt parameters. The example doesn't seem to work as well as it does on the chatgpt website so try it out there instead. Feel free to improve and leave feedback!"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/midjourney-v5-prompt-generator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/midjourney-v5-prompt-generator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/midjourney-v5-prompt-generator.md`
