---
name: remix-two-brands
description: "Combine tokens from two DESIGN.md files into a coherent third system. Not copy-paste — actual token arbitration with reasoning."
category: prompt-engineering
source_repo: rohitg00/awesome-claude-design
source_path: "prompts/remix-two-brands.md"
source_url: https://github.com/rohitg00/awesome-claude-design/blob/HEAD/prompts/remix-two-brands.md
---
# `remix-two-brands`
...
**Source:** [`rohitg00/awesome-claude-design`](https://github.com/rohitg00/awesome-claude-design) → `prompts/remix-two-brands.md`
