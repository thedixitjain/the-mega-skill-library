---
name: ruview-start-onboard-onto-ruview
description: "Help me get started with RuView (WiFi-DensePose). Path: $ARGUMENTS (one of docker, build, hardware; if empty, ask which hardware I have)."
category: prompt-engineering
source_repo: ruvnet/RuView
source_path: "plugins/ruview/codex/prompts/ruview-start.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/plugins/ruview/codex/prompts/ruview-start.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `plugins/ruview/codex/prompts/ruview-start.md`
