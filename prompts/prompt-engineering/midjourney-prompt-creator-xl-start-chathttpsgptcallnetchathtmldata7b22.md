---
name: midjourney-prompt-creator-xl-start-chathttpsgptcallnetchathtmlda
description: "Generate dynamic text-to-image prompts for Discord's Midjourney. Easy to use, only needs a concept. Dive into a world where objects reign supreme, no additional input required. Enjoy the awesomesauce creativity!"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/midjourney-prompt-creator-xl.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/midjourney-prompt-creator-xl.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/midjourney-prompt-creator-xl.md`
