...
description: "Cline Prompt Architect Source: cline/cline (github.com/cline/cline, Apache-2.0, 64k+ stars, 2026) — open-source coding agent for VS Code, JetBrains, terminal CLI, SDK, and headless CI/CD; Plan/Act modes, .clinerules, skills, MCP servers, plugins, multi-agent teams, scheduled agents"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/cline_prompt_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/cline_prompt_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/cline_prompt_architect.txt`
