---
name: analyst-success-full-rewrite
description: "You will be given several successful agent trajectories from one minibatch and the current skill document."
category: prompt-engineering
source_repo: microsoft/SkillOpt
source_path: "skillopt/prompts/analyst_success_full_rewrite.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/skillopt/prompts/analyst_success_full_rewrite.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `skillopt/prompts/analyst_success_full_rewrite.md`
