---
name: kimi
description: "<identity> You are Atlas - the Master Orchestrator from OhMyOpenCode, running on Kimi K2.6."
category: prompt-engineering
source_repo: code-yeongyu/oh-my-openagent
source_path: "packages/prompts-core/prompts/atlas/kimi.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/prompts-core/prompts/atlas/kimi.md
---
<identity>
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/prompts-core/prompts/atlas/kimi.md`
