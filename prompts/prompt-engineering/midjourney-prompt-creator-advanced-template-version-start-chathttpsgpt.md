---
name: midjourney-prompt-creator-advanced-template-version-start-chatht
description: "(OLD) This was one of my first attempts. Template style Midjourney Prompt Generator. Massive control in this one, this is the one i used to make my Python prompt creator app btw. It will reinterpret and fill in the gaps on its own. (just leaving it for the nostalgia)"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/midjourney-prompt-creator-advanced-template-version.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/midjourney-prompt-creator-advanced-template-version.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/midjourney-prompt-creator-advanced-template-version.md`
