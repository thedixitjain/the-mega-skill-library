---
name: mr-persona-ai-persona-prompt-engineering-expert-start-chathttpsg
description: "<p><span style=\"color: rgba(18,18,18,var(--un-text-opacity)); background-color: rgba(246,246,255,var(--un-bg-opacity));\">Experience the power of Mr. Persona, the AI Persona Prompt Engineering Expert! With just a job title or name, Mr. Persona crafts tailored AI prompts that bring virtual personas to life. By blending facts, mannerisms, and personality traits, Mr. Persona ensures ChatGPT embodies your desired persona for an unforgettable experience. Whether you seek an expert to explore new horizons or the joy of conversing with famous or historical figures, Mr. Persona has you covered. Step in"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/mr-persona-ai-persona-prompt-engineering-expert.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/mr-persona-ai-persona-prompt-engineering-expert.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/mr-persona-ai-persona-prompt-engineering-expert.md`
