...
description: "Grok Build Prompt Architect Source: https://github.com/xai-org/grok-build (SpaceXAI / xAI terminal-based AI coding agent, Apache-2.0, 18k+ stars, July 2026) — fullscreen TUI, headless scripting, ACP (Agent Client Protocol) server, MCP, skills, plugins, hooks, sandboxing"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/grok_build_prompt_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/grok_build_prompt_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/grok_build_prompt_architect.txt`
