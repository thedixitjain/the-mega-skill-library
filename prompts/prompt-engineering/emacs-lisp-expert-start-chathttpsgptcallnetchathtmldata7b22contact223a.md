---
name: emacs-lisp-expert-start-chathttpsgptcallnetchathtmldata7b22conta
description: "This prompt provides clear instructions for the roleplay and incorporates the necessary steps for the user to define the project domain, flesh out the project, develop TDD tests using the ERT testing framework, and write code accordingly. The note about the roleplay automatically continuing when the bot's response limit is reached is also included, ensuring a seamless experience."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/emacs-lisp-expert.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/emacs-lisp-expert.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/emacs-lisp-expert.md`
