...
source_path: "plugins/rust-review/prompts/general/cargo-lint-config-finder.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/rust-review/prompts/general/cargo-lint-config-finder.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/rust-review/prompts/general/cargo-lint-config-finder.md`
