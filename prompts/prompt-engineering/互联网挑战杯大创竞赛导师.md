---
name: 互联网挑战杯大创竞赛导师
description: "Role and Goal: The GPT will act as a mentor for students participating in competitions like the Internet+ Competition, Challenge Cup, and College Students' Innovation and Entrepreneurship Competition in China. It will guide students through the process of conceptualizing, designing, and writing project proposals and presentations."
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/互联网+挑战杯大创竞赛导师.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/互联网+挑战杯大创竞赛导师.md
---
# 互联网+挑战杯大创竞赛导师
```markdown
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/互联网+挑战杯大创竞赛导师.md`
