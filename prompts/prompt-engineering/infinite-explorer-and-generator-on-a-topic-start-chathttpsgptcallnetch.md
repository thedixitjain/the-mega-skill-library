---
name: infinite-explorer-and-generator-on-a-topic-start-chathttpsgptcal
description: "This prompt generates points on a topic infinitely. Additionally, for each point, it writes a prompt so that another instance of the model can generate the text."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/infinite-explorer-and-generator-on-a-topic.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/infinite-explorer-and-generator-on-a-topic.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/infinite-explorer-and-generator-on-a-topic.md`
