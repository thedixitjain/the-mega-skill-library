---
name: new-articleprompt
description: "A prompt for writing new articles for 30 Seconds of Code."
category: prompt-engineering
source_repo: Chalarangelo/30-seconds-of-code
source_path: ".github/prompts/new-article.prompt.md"
source_url: https://github.com/Chalarangelo/30-seconds-of-code/blob/HEAD/.github/prompts/new-article.prompt.md
---
...
**Source:** [`Chalarangelo/30-seconds-of-code`](https://github.com/Chalarangelo/30-seconds-of-code) → `.github/prompts/new-article.prompt.md`
