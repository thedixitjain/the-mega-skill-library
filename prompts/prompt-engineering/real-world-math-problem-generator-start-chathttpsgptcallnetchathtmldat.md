---
name: real-world-math-problem-generator-start-chathttpsgptcallnetchath
description: "Kids very often ask how a math subject is used in the real world. Further, students have their own interests. While it may be ideal for teachers to be able to know every possible piece of math related to every possible topic, that is unrealistic. The purpose of this prompt is to support teachers in quickly finding how Common Core State Standards show up in the real world in a way that is aligned with student interest. It is worth noting that certain combinations of content, theme, and grade level may produce unrealistic or strange math problems that are meant more for inspirational purposes, n"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/real-world-math-problem-generator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/real-world-math-problem-generator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/real-world-math-problem-generator.md`
