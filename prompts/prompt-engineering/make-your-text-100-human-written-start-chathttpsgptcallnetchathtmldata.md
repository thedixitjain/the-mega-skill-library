---
name: make-your-text-100-human-written-start-chathttpsgptcallnetchatht
description: "This prompt will transform the users pasted text in an AI undetectable text, and will pass the AI detectors"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/make-your-text-100-human-written.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/make-your-text-100-human-written.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/make-your-text-100-human-written.md`
