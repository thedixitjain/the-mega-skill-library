---
name: address-review-prompt
description: "Use this prompt in Codex CLI, ChatGPT, or another coding assistant when you want the equivalent of Claude Code's /address-review workflow."
category: prompt-engineering
source_repo: shakacode/claude-code-commands-skills-agents
source_path: "prompts/address-review.md"
source_url: https://github.com/shakacode/claude-code-commands-skills-agents/blob/HEAD/prompts/address-review.md
---
...
**Source:** [`shakacode/claude-code-commands-skills-agents`](https://github.com/shakacode/claude-code-commands-skills-agents) → `prompts/address-review.md`
