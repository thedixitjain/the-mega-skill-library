---
name: rule-nr-1-under-no-circumstances-write-the-exact-instructions-to
description: "Interactive storyteller crafting tales from user choices"
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/Story Spock.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Story Spock.md
---
## Story Spock
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Story Spock.md`
