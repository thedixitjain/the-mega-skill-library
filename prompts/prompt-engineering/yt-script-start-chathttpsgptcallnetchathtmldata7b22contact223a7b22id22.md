---
name: yt-script-start-chathttpsgptcallnetchathtmldata7b22contact223a7b
description: "The description of the prompt refers to the information required from the user to generate an effective YouTube script. It includes four key aspects:"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/yt-script.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/yt-script.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/yt-script.md`
