---
name: 3-designer-debate
description: "Three-voice design critique. Claude roleplays three senior designers with different philosophies, debates the same brief live, then synthesizes a unified recommendation. Port of NicholasSpisak's gist."
category: prompt-engineering
source_repo: rohitg00/awesome-claude-design
source_path: "prompts/3-designer-debate.md"
source_url: https://github.com/rohitg00/awesome-claude-design/blob/HEAD/prompts/3-designer-debate.md
---
# `3-designer-debate`
...
**Source:** [`rohitg00/awesome-claude-design`](https://github.com/rohitg00/awesome-claude-design) → `prompts/3-designer-debate.md`
