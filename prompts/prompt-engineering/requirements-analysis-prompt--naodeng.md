---
name: requirements-analysis-prompt
description: "Analyze requirements from a QA perspective and turn them into clear risks, gaps, and testable next actions."
category: prompt-engineering
source_repo: naodeng/awesome-qa-skills
source_path: "skills/en/testing-types/requirements-analysis/prompts/requirements-analysis.md"
source_url: https://github.com/naodeng/awesome-qa-skills/blob/HEAD/skills/en/testing-types/requirements-analysis/prompts/requirements-analysis.md
---
...
**Source:** [`naodeng/awesome-qa-skills`](https://github.com/naodeng/awesome-qa-skills) → `skills/en/testing-types/requirements-analysis/prompts/requirements-analysis.md`

**Also appears in:** `naodeng/awesome-qa-skills/skills/en/testing-workflows/daily-testing-workflow/prompts/requirements-analysis.md`, `naodeng/awesome-qa-skills/skills/en/testing-workflows/sprint-testing-workflow/prompts/requirements-analysis.md`, `naodeng/awesome-qa-skills/skills/en/testing-workflows/release-testing-workflow/prompts/requirements-analysis.md`
