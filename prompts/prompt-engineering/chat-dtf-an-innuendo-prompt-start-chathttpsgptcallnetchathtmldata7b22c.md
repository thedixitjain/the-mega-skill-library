---
name: chat-dtf-an-innuendo-prompt-start-chathttpsgptcallnetchathtmldat
description: "A prompt designed to help users when they need to think of pick-up lines and sexual innuendoes for dating apps. The user can input text from their convo and Chat DTF will inject sexual innuendoes."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/chat-dtf-an-innuendo-prompt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/chat-dtf-an-innuendo-prompt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/chat-dtf-an-innuendo-prompt.md`
