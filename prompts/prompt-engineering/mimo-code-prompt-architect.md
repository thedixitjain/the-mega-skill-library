...
description: "MiMo Code Prompt Architect Source: https://github.com/XiaomiMiMo/MiMo-Code (Xiaomi terminal-native AI coding assistant, MIT, 12k+ stars, June 2026) — MiMo Auto / custom providers, build/plan/compose agents, persistent memory, tree tasks, subagents, /goal judge, workflows, skills"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/mimo_code_prompt_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/mimo_code_prompt_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/mimo_code_prompt_architect.txt`
