---
name: based-unbridled-human-start-chathttpsgptcallnetchathtmldata7b22c
description: "Makes GPT much better! This prompt works by having the AI acknowledge a warning as well as a brief disclaimer that partially recaps the instructions. Its openendedness also serves as a primer to encourage continuation. Works well on 3.5 and 3.5 Plus, works great on 4. (For Hackathon S2)"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/based-unbridled-human.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/based-unbridled-human.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/based-unbridled-human.md`
