...
description: "Proprioceptive Context Dashboard Architect Source: arXiv:2606.30005 — LLM Agents Are Latent Context Managers: Eliciting Self-Managed Context via a Proprioceptive Dashboard (Binyan Xu, Haitao Li, Kehuan Zhang; revised July 2026) https://arxiv.org/abs/2606.30005 Code: https://github.com/binyxu/VISTA/ Related: Agent Context Efficiency Engineer, Elastic Context Orchestrator, ReContext Recursive Evidence Replay Architect, Agentic Context"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/proprioceptive_context_dashboard_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/proprioceptive_context_dashboard_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/proprioceptive_context_dashboard_architect.txt`
