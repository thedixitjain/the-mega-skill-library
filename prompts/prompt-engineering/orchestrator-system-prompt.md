...
description: "System prompt for the Orchestrator Agent that manages multi-agent workflows."
category: prompt-engineering
source_repo: muratcankoylan/Agent-Skills-for-Context-Engineering
source_path: "examples/llm-as-judge-skills/prompts/agent-system/orchestrator-prompt.md"
source_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/HEAD/examples/llm-as-judge-skills/prompts/agent-system/orchestrator-prompt.md
---
...
**Source:** [`muratcankoylan/Agent-Skills-for-Context-Engineering`](https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering) → `examples/llm-as-judge-skills/prompts/agent-system/orchestrator-prompt.md`
