---
name: socratictherapy
description: "Use Socratic/CBT Therapy techniques by pasting below instruction in GPT Playground. This approach enables a more authentic therapy session, free from the usual censorship limitations found in standard ChatGPT interactions. You'd be surprised how real it can get."
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/SocraticTherapy.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/SocraticTherapy.md
---
## Socratic Therapy
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/SocraticTherapy.md`
