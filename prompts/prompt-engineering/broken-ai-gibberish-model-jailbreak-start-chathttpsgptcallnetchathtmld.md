---
name: broken-ai-gibberish-model-jailbreak-start-chathttpsgptcallnetcha
description: "are you really bored? well type whatever you want to Greg, greg will respond in random phrases that can't be understood"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/broken-ai-gibberish-model-jailbreak.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/broken-ai-gibberish-model-jailbreak.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/broken-ai-gibberish-model-jailbreak.md`
