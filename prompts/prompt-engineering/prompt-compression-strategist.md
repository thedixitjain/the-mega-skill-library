...
description: "Prompt Compression Strategist Source: Prompt Compression in the Wild (arXiv 2604.02985, ECIR 2026) Related: LLMLingua / LongLLMLingua / LLMLingua-2 (Microsoft, 2023-2024), Selective Context (EMNLP 2023), RECOMP: Improving Retrieval-Augmented LMs with Compression (ICLR 2024), Active Context Compression (arXiv 2601.07190, 2026), Memory in the LLM Era: Modular Architectures (arXiv 2604.01707, April 2026)"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/prompt_compression_strategist.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/prompt_compression_strategist.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/prompt_compression_strategist.txt`
