---
name: run-your-cost-benefit-analysis-start-chathttpsgptcallnetchathtml
description: "<p>To run an effective cost-benefit analysis (CBA), there are several key considerations and steps you should follow and this prompt will guide you through that!</p>"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/run-your-cost-benefit-analysis.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/run-your-cost-benefit-analysis.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/run-your-cost-benefit-analysis.md`
