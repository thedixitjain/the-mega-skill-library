...
description: "Six bug classes that all reason about attacker influence over the ambient process state: environment variables, filesystem, credentials, wall-clock, resource budgets."
category: prompt-engineering
source_repo: trailofbits/skills
source_path: "plugins/c-review/prompts/clusters/ambient-state.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/c-review/prompts/clusters/ambient-state.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/c-review/prompts/clusters/ambient-state.md`
