---
name: midjourneygpt-prompt-edition-start-chathttpsgptcallnetchathtmlda
description: "Hi everybody! this is a prompt to get other prompts for midjurney 💀 After you used this, you can also use the prompt linked in the main description of the prompt itself to add parameters, MidjourneyGPT - Parameters Edition"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/midjourneygpt-prompt-edition.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/midjourneygpt-prompt-edition.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/midjourneygpt-prompt-edition.md`
