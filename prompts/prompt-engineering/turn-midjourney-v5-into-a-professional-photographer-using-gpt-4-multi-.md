---
name: turn-midjourney-v5-into-a-professional-photographer-using-gpt-4
description: "Turn Midjourney V5, into a professional photographer that pushes the boundaries of creativity. Dive into the world of Latent Diffusion Models and learn how to master the numerous parameters that give you unparalleled photorealistic control over your artistic creations. Use all 4 prompts in the example chat for it to work. WARNING: GTP-4 & Midjourney v5 ONLY (The example in the chat window is incorrect, here's what it should have prompted):"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/turn-midjourney-v5-into-a-professional-photographer-using-gpt-4-multi-prompt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/turn-midjourney-v5-into-a-professional-photographer-using-gpt-4-multi-prompt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/turn-midjourney-v5-into-a-professional-photographer-using-gpt-4-multi-prompt.md`
