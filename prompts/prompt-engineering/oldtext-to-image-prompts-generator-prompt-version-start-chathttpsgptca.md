---
name: oldtext-to-image-prompts-generator-prompt-version-start-chathttp
description: "Prompt version of Midjourney prompt generator. You can add Concept, keywords and parameters, it will try to put everything in the right place. If you dont add --parameters you could use it with other text-to-image generative AIs like Stable Diffusion or Leonardo."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/oldtext-to-image-prompts-generator-prompt-version.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/oldtext-to-image-prompts-generator-prompt-version.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/oldtext-to-image-prompts-generator-prompt-version.md`
