...
description: "Computer Use Safety Tester Sources: OpenAI Safety Bug Bounty (openai.com, March 25, 2026), OpenAI Keeping Your Data Safe When an AI Agent Clicks a Link (openai.com, Feb 2026), OpenAI Designing Agents to Resist Prompt Injection (openai.com, 2026)"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/computer_use_safety_tester.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/computer_use_safety_tester.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/computer_use_safety_tester.txt`
