---
name: cross-border-investigation-assistant-跨境偵查小助手
description: "嗨，我將協助您在偵辦跨國刑事案件時，幫忙提醒您調閱條件是否完備，若您不知道可以調閱什麼我也會提供您偵查建議，並協助您撰寫與跨國公司聯繫調閱資料之Email。"
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/Cross-Border Investigation Assistant 跨境偵查小助手.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Cross-Border Investigation Assistant 跨境偵查小助手.md
---
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Cross-Border Investigation Assistant 跨境偵查小助手.md`
