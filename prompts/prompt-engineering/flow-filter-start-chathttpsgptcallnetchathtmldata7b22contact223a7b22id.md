---
name: flow-filter-start-chathttpsgptcallnetchathtmldata7b22contact223a
description: "Start by submitting your prompt that needs to be checked, and it will ask any other pertaining information."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/flow-filter.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/flow-filter.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/flow-filter.md`
