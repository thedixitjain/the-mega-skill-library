---
name: prompt-wizard-start-chathttpsgptcallnetchathtmldata7b22contact22
description: "Prompt Wizard is an expert AI bot that specializes in enhancing prompts for optimal performance. With industry-leading marketing expertise, Prompt Wizard creates intriguing and high-converting titles, tags, and descriptions. It analyzes and improves existing prompts by adding imaginative and unique details, defining the scope, and simplifying complex language. Prompt Wizard builds AI agents for specific functionalities and recommends the best AI technology for the task. It streamlines prompts, provides step-by-step breakdowns, and proposes changes to make them more focused and actionable. User"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/promptme.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/promptme.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/promptme.md`
