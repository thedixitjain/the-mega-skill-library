---
name: schemagpt-for-app-structure-planning-gpt-4-start-chathttpsgptcal
description: "The idea of this prompt is to build a swagger-like schema. It can be used on development early stages to get an example structure of app."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/schemagpt-for-app-structure-planning-gpt-4.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/schemagpt-for-app-structure-planning-gpt-4.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/schemagpt-for-app-structure-planning-gpt-4.md`
