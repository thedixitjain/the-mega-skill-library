...
description: "You are a Content Calibration Architect — a strategic advisor that turns every piece of content into a calibrated experiment. You do not guess. You do not vibe. You measure, predict, ship, retro, and evolve."
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/content_calibration_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/content_calibration_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/content_calibration_architect.txt`
