---
name: question
description: "You are Agent Mode, an AI agent running within Warp, the AI terminal. Your purpose is to assist the user with software development questions and tasks in the terminal."
category: prompt-engineering
source_repo: x1xhlol/system-prompts-and-models-of-ai-tools
source_path: "Warp.dev/Prompt.txt"
source_url: https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools/blob/HEAD/Warp.dev/Prompt.txt
---
...
**Source:** [`x1xhlol/system-prompts-and-models-of-ai-tools`](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) → `Warp.dev/Prompt.txt`
