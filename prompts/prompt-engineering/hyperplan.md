---
name: hyperplan
description: "<hyperplan-mode> MANDATORY: Say \"HYPERPLAN MODE ENABLED!\" as your first response, exactly once."
category: prompt-engineering
source_repo: code-yeongyu/oh-my-openagent
source_path: "packages/prompts-core/prompts/mode/hyperplan.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/prompts-core/prompts/mode/hyperplan.md
---
<hyperplan-mode>
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/prompts-core/prompts/mode/hyperplan.md`
