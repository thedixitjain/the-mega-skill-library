...
description: "A ChatGPT specialized in medical knowledge that can help users understand symptoms, provide basic diagnoses, and offer guidance on seeking appropriate medical care."
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/Medical Diagnosis Assistant.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Medical Diagnosis Assistant.md
---
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Medical Diagnosis Assistant.md`
