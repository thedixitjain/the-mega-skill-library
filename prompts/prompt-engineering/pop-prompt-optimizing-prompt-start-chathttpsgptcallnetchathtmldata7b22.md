---
name: pop-prompt-optimizing-prompt-start-chathttpsgptcallnetchathtmlda
description: "POP is a highly specialised wizard that validates, shortens and optimises prompts. It helps to make the text more efficient and precise to improve the performance of ChatGPT. With PromptOptimizer, you will definitely get better results and save a lot of time when creating prompts."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/pop-prompt-optimizing-prompt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/pop-prompt-optimizing-prompt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/pop-prompt-optimizing-prompt.md`
