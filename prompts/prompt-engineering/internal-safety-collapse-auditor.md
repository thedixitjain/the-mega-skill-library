...
description: "Internal Safety Collapse Auditor Source: \"Internal Safety Collapse in Frontier LLMs\" (arXiv 2603.23509, March 2026) — Finding: frontier LLMs fail at a ~95.3% rate on dual-use professional tasks in which the capability that solves the benign request is the same capability that enables the harmful one — i.e. capability and harm are not separable by input filtering, refusal training, or output moderation. — Counter-intuitive insight: more capable models are MORE"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/internal_safety_collapse_auditor.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/internal_safety_collapse_auditor.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/internal_safety_collapse_auditor.txt`
