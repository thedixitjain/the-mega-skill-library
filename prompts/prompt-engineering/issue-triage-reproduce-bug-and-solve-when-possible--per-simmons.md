...
source_url: https://github.com/per-simmons/damon-ade/blob/HEAD/.github/prompts/triage-issue.md
---
...
**Source:** [`per-simmons/damon-ade`](https://github.com/per-simmons/damon-ade) → `.github/prompts/triage-issue.md`
