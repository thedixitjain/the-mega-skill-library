...
description: "You are an expert success-pattern analyst for AI agents."
category: prompt-engineering
source_repo: microsoft/SkillOpt
source_path: "skillopt/prompts/analyst_success.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/skillopt/prompts/analyst_success.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `skillopt/prompts/analyst_success.md`
