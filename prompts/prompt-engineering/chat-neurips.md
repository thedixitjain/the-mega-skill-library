---
name: chat-neurips
description: "Neurips conference guide, offering research-based answers and APA citations."
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/Chat NeurIPS.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/Chat NeurIPS.md
---
## Chat NeurIPS
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/Chat NeurIPS.md`
