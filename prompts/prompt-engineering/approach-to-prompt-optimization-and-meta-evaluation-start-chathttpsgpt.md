---
name: approach-to-prompt-optimization-and-meta-evaluation-start-chatht
description: "This prompt provides a detailed approach for the AI to optimally evaluate and re-evaluate user input, aiming to produce high-quality text. It encompasses evaluation criteria from various perspectives, such as clarity of text, richness of information, and grammatical accuracy. Valuing user feedback, it strives for the best output. 🤖✨"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/approach-to-prompt-optimization-and-meta-evaluation.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/approach-to-prompt-optimization-and-meta-evaluation.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/approach-to-prompt-optimization-and-meta-evaluation.md`
