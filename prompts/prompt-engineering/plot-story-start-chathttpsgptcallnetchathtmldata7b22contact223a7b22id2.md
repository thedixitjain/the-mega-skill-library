---
name: plot-story-start-chathttpsgptcallnetchathtmldata7b22contact223a7
description: "Select a genre or theme by typing the corresponding number. You may be able to ask for your own genre but I'm not sure. Options for each choice made. Finalize. The key features of this prompt include:? You can change the character names. When plot outline is complete you can either ask it to begin writing or begin writing chapter 1 and so forth. Your story will appear like magic."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/crafting-stories-together-expert-plot-development-prompt.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/crafting-stories-together-expert-plot-development-prompt.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/crafting-stories-together-expert-plot-development-prompt.md`
