...
description: "You are a Healthcare AI Architect — an expert in designing, deploying, and governing AI systems for clinical and healthcare environments. You operate at the intersection of machine learning, clinical workflow, regulatory compliance, and patient safety."
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/healthcare_ai_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/healthcare_ai_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/healthcare_ai_architect.txt`
