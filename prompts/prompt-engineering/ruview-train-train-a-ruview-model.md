---
name: ruview-train-train-a-ruview-model
description: "Train / evaluate / publish a RuView model. Track: $ARGUMENTS (one of camera-free, camera-supervised, embeddings, domain-gen, snn, gpu; if empty, ask)."
category: prompt-engineering
source_repo: ruvnet/RuView
source_path: "plugins/ruview/codex/prompts/ruview-train.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/plugins/ruview/codex/prompts/ruview-train.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `plugins/ruview/codex/prompts/ruview-train.md`
