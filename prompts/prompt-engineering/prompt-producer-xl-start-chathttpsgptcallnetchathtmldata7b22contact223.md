---
name: prompt-producer-xl-start-chathttpsgptcallnetchathtmldata7b22cont
description: "This prompts creates prompts for use with ChatGPT. You can specify a lot, or have it create something random. Use with normal ChatGPT-3.5, text-davinci-003 or ChatGPT-4 for better results, not the best results here."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/prompt-producer-xl.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/prompt-producer-xl.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/prompt-producer-xl.md`
