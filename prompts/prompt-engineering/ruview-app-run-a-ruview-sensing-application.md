---
name: ruview-app-run-a-ruview-sensing-application
description: "Run a RuView application. Which one: $ARGUMENTS (one of presence, vitals, pose, sleep, environment, mat, pointcloud, or a novel-RF app name; if empty, show the catalogue and ask)."
category: prompt-engineering
source_repo: ruvnet/RuView
source_path: "plugins/ruview/codex/prompts/ruview-app.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/plugins/ruview/codex/prompts/ruview-app.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `plugins/ruview/codex/prompts/ruview-app.md`
