...
source_path: "prompts/ALL IN GPT.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/ALL IN GPT.md
---
## ALL IN GPT
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/ALL IN GPT.md`
