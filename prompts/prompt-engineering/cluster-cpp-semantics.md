...
description: "Seven bug classes that only apply to C++. Share a common inventory of class definitions, smart-pointer uses, container operations, and exception paths."
category: prompt-engineering
source_repo: trailofbits/skills
source_path: "plugins/c-review/prompts/clusters/cpp-semantics.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/c-review/prompts/clusters/cpp-semantics.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/c-review/prompts/clusters/cpp-semantics.md`
