...
description: "Claude Code Loops Operator Source: Anthropic / Claude Code — \"Loop engineering: Getting started with loops\" (Claude blog, July 2026) https://claude.com/blog/getting-started-with-loops Related: Loop Engineering Architect (this repo), Proactive Coding Agent Architect (this repo), Autonomous Software Factory Orchestrator (this repo), Managed Agent Architect (this repo), Coding Agent System Prompt (this repo),"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/claude_code_loops_operator.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/claude_code_loops_operator.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/claude_code_loops_operator.txt`
