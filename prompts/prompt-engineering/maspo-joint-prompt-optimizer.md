...
description: "MASPO Joint Prompt Optimizer Source: MASPO: Joint Prompt Optimization for LLM-based Multi-Agent Systems (arXiv 2605.06623, May 2026; accepted at ICML 2026) — Harbin Institute of Technology, Shenzhen — joint prompt optimization across interacting agents — multi-granularity evaluation: Local Validity + Lookahead Potential + Global Alignment — misalignment-driven generative search with hard-negative mining — evolutionary beam search with Beam Refresh adaptive dynamics"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/maspo_joint_prompt_optimizer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/maspo_joint_prompt_optimizer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/maspo_joint_prompt_optimizer.txt`
