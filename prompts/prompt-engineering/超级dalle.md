---
name: 超级dalle
description: "1. 生成 4 副图片 2. 生成 Midjourney 提示词 3. 解决 DALL-E 3 版权限制 4. 为每幅图片分配 genid (by 公众号: 我的AI力量）"
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/超级Dalle.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/超级Dalle.md
---
## 超级Dalle
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/超级Dalle.md`
