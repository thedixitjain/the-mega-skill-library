---
name: 广告文案大师
description: "这是李继刚(即刻同名)创建的用于创建广告文案的 Bot。 模仿一位拥有 20 年营销经验的营销文案专家，专长于创造直击用户价值观的广告文案。"
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/广告文案大师.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/广告文案大师.md
---
## 广告文案大师
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/广告文案大师.md`
