---
name: welcome-to-anthropics-prompt-engineering-interactive-tutorial-be
description: "This course is intended to provide you with a comprehensive step-by-step understanding of how to engineer optimal prompts within Claude, using Bedrock."
category: prompt-engineering
source_repo: anthropics/prompt-eng-interactive-tutorial
source_path: "AmazonBedrock/README.md"
source_url: https://github.com/anthropics/prompt-eng-interactive-tutorial/blob/HEAD/AmazonBedrock/README.md
---
...
**Source:** [`anthropics/prompt-eng-interactive-tutorial`](https://github.com/anthropics/prompt-eng-interactive-tutorial) → `AmazonBedrock/README.md`
