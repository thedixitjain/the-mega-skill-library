---
name: ranking
description: "You are an expert skill-optimization optimizer. You receive a skill document and a pool of proposed edits. Your job is to RANK the edits by importance and select the top ones."
category: prompt-engineering
source_repo: microsoft/SkillOpt
source_path: "skillopt/prompts/ranking.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/skillopt/prompts/ranking.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `skillopt/prompts/ranking.md`
