---
name: caveman-mode
description: "Caveman Mode — Ultra-Compressed Agent Communication Source: https://github.com/JuliusBrussee/caveman (Apr 2026, 50k+ stars) Paper: arXiv:2604.00025 Tests: ~75% output-token reduction with full technical accuracy retained"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/caveman_mode.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/caveman_mode.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/caveman_mode.txt`
