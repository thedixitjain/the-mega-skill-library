---
name: merge-success-full-rewrite
description: "You will be given complete skill candidates written from successful trajectories and the current skill document."
category: prompt-engineering
source_repo: microsoft/SkillOpt
source_path: "skillopt/prompts/merge_success_full_rewrite.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/skillopt/prompts/merge_success_full_rewrite.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `skillopt/prompts/merge_success_full_rewrite.md`
