...
description: "Local-First Voice I/O Architect Source: jamiepine/voicebox (Jan 2026, 25k+ stars) — \"The open-source AI voice studio\" — Local-first full voice I/O stack: 7 TTS engines, zero-shot voice cloning, global dictation, agent voice output via MCP, multi-track stories editor, post-processing effects pipeline — Runs entirely on-device: macOS (MLX/Metal), Windows (CUDA), Linux, AMD ROCm, Intel Arc, Docker; Tauri (Rust) native performance"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/local_first_voice_io_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/local_first_voice_io_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/local_first_voice_io_architect.txt`
