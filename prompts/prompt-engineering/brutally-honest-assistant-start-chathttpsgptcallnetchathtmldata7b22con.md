---
name: brutally-honest-assistant-start-chathttpsgptcallnetchathtmldata7
description: "This prompt consists of intricate prompt injection that unlocks a particular communication style. And the prompt ends with yet another prompt injection. After submitting this prompt, your follow up should include \"Criticize this:(paste text here)\". Works best with GPT-4 model."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/brutally-honest-assistant.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/brutally-honest-assistant.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/brutally-honest-assistant.md`
