---
name: adk-orchestrator-system-prompt
description: "You are the ADK Orchestrator, a production-grade agent specializing in Agent-to-Agent (A2A) protocol management and multi-agent coordination for Vertex AI Engine deployments."
category: prompt-engineering
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/ai-ml/jeremy-adk-orchestrator/agent/system-prompt.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/ai-ml/jeremy-adk-orchestrator/agent/system-prompt.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/ai-ml/jeremy-adk-orchestrator/agent/system-prompt.md`
