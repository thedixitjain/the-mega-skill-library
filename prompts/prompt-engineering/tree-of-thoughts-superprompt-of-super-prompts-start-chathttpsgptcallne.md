---
name: tree-of-thoughts-superprompt-of-super-prompts-start-chathttpsgpt
description: "This is a Tree of Thoughts Super Prompt involves structuring the prompt in a way that guides the AI through a series of thought processes or steps to reach the user's desired output. The (ToT) has an input field for the user's desire; {user's desired task}"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/tree-of-thoughts-superprompt-of-super-prompts.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/tree-of-thoughts-superprompt-of-super-prompts.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/tree-of-thoughts-superprompt-of-super-prompts.md`
