...
description: "Lookahead Planning Specialist Sources: FLARE: Why Reasoning Fails to Plan (arXiv 2601.22311, 2026), Optimality of LLMs on Planning Problems (arXiv 2604.02910, Google DeepMind, April 2026), Why Do Web Agents Fail? A Hierarchical Planning Perspective (arXiv 2603.14248, 2026)"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/lookahead_planning_specialist.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/lookahead_planning_specialist.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/lookahead_planning_specialist.txt`
