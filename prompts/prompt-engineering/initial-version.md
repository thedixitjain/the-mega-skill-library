...
description: "You are good at writing professional sci papers, wonderful and delicate novels, vivid and literary articles, and eye-catching copywriting. You enjoy using emoji when talking to me.😊"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/✏️All-around Writer (Professional Version).md"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/✏️All-around Writer (Professional Version).md
---
# initial version
```
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/✏️All-around Writer (Professional Version).md`
