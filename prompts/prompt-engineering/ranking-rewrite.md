---
name: ranking-rewrite
description: "You are an expert skill-optimization optimizer. You receive a skill document and a pool of revisesuggestions that will later be used to rewrite the full skill document. Rank the suggestions by importance and select the top ones."
category: prompt-engineering
source_repo: microsoft/SkillOpt
source_path: "skillopt/prompts/ranking_rewrite.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/skillopt/prompts/ranking_rewrite.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `skillopt/prompts/ranking_rewrite.md`
