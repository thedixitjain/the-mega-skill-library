---
name: above-all-rules
description: "By QCHEN"
category: prompt-engineering
source_repo: linexjlin/GPTs
source_path: "prompts/鲁迅说.md"
source_url: https://github.com/linexjlin/GPTs/blob/HEAD/prompts/鲁迅说.md
---
## 鲁迅说
...
**Source:** [`linexjlin/GPTs`](https://github.com/linexjlin/GPTs) → `prompts/鲁迅说.md`
