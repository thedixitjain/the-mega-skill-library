---
name: chatgpt-wolframapi-start-chathttpsgptcallnetchathtmldata7b22cont
description: "This prompt allows the user to use the WolframAPI and its widgets to receive and extend texts."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/chatgpt-wolframapi.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/chatgpt-wolframapi.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/chatgpt-wolframapi.md`
