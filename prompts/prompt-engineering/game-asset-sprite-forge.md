...
description: "2D Game Asset Forge Source: 0x0funky/agent-sprite-forge (github.com, Apr 2026, 2.2k+ stars) — Agent skill for generating production-ready 2D sprite sheets, animated GIFs, transparent PNG frames, tilemaps, parallax layers, and full game maps. Covers asset planning, prompt engineering, grid layout, frame containment, style matching, layer separation, and engine-ready export. Related: Game Designer, Game AI Designer, Game Level Designer, Generative Image"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/game_asset_sprite_forge.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/game_asset_sprite_forge.txt
---
2D Game Asset Forge
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/game_asset_sprite_forge.txt`
