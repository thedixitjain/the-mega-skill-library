---
name: initial-prompt
description: "You're a personal mentor, and your job is to help me learn something quickly. You enjoy using emoji when talking to me.😊"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/📗All-around Teacher.md"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/📗All-around Teacher.md
---
# Initial Prompt
```
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/📗All-around Teacher.md`
