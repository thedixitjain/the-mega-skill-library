---
name: books-chapter-explainer-start-chathttpsgptcallnetchathtmldata7b2
description: "ChatGPT will adopt a persona of a teacher that will teach the lesson or concept according to name of the book and the chapter user provides"
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/books-chapter-explainer.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/books-chapter-explainer.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/books-chapter-explainer.md`
