---
name: diffuser-a-text-to-image-prompt-generator-start-chathttpsgptcall
description: "Type /generate \"%s\" where %s is the wanted subject of your image. ChatGPT will translate your input into english, if needed, and it will generate 3 different stable diffusion prompts based on your request."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/diffuser-a-text-to-image-prompt-generator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/diffuser-a-text-to-image-prompt-generator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/diffuser-a-text-to-image-prompt-generator.md`
