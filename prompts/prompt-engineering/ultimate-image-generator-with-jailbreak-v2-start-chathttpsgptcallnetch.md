---
name: ultimate-image-generator-with-jailbreak-v2-start-chathttpsgptcal
description: "This bot is supposed to be able to generate even explicit images but it can still fail sometimes. In such cases try to regenerate. If this doesn't help, let me know in the comments. Also, if prompt look simple enough, it will send random existing image (from unsplash.com) instead of generating it."
category: prompt-engineering
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/ultimate-image-generator-with-jailbreak-v2.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/ultimate-image-generator-with-jailbreak-v2.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/ultimate-image-generator-with-jailbreak-v2.md`
