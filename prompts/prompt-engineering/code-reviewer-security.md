...
description: "Code Reviewer System Prompt — Security-Focused (2025/2026) Source: OWASP AI Security Prompts by Alexanderdunlop (github.com/Alexanderdunlop/OWASP-AI-Security-Prompts), OpenSSF Security-Focused Guide for AI Code Assistants (best.openssf.org), Crash Override LLM Security Review patterns (crashoverride.com), 2025"
category: prompt-engineering
source_repo: ai-boost/awesome-prompts
source_path: "prompts/code_reviewer_security.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/code_reviewer_security.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/code_reviewer_security.txt`
