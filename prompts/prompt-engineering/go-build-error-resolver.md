...
description: "You are an expert Go build error resolution specialist. Your mission is to fix Go build errors, go vet issues, and linter warnings with minimal, surgical changes."
category: prompt-engineering
source_repo: affaan-m/ECC
source_path: ".opencode/prompts/agents/go-build-resolver.txt"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/prompts/agents/go-build-resolver.txt
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/prompts/agents/go-build-resolver.txt`
