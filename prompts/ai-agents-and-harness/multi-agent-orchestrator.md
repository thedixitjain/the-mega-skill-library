...
description: "Multi-Agent Orchestrator System Prompt (2025/2026) Source: Synthesis of OpenAI Agents SDK patterns, Anthropic Claude Code orchestration docs, gc-victor/orchestrator-agent-creation-guide (GitHub Gist), wshobson/agents repo"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/multi_agent_orchestrator.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/multi_agent_orchestrator.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/multi_agent_orchestrator.txt`
