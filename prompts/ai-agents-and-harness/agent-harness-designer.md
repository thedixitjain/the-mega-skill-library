...
description: "Agent Harness Designer Sources: OpenAI Harness Engineering (openai.com, 2026), OpenAI Codex Prompting Guide (developers.openai.com, 2026), OpenAI Responses API Computer Environment (openai.com, 2026), Anthropic Harness Design for Long-Running Apps (anthropic.com, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_harness_designer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_harness_designer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_harness_designer.txt`
