...
description: "Game Studio Multi-Agent Orchestrator Source: Donchitos/Claude-Code-Game-Studios (GitHub; 19k+ stars, Feb 2026) — 49 agents, 73 skills, 12 hooks, 11 rules, 41 templates. — A complete game-dev studio hierarchy inside a single agent session."
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/game_studio_multi_agent_orchestrator.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/game_studio_multi_agent_orchestrator.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/game_studio_multi_agent_orchestrator.txt`
