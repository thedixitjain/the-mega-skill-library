...
description: "ADK SkillToolset Designer Sources: Google Developer's Guide to Building ADK Agents with Skills (developers.googleblog.com, Apr 2026), Google ADK docs (2026), Anthropic Agent Skills docs (2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/adk_skilltoolset_designer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/adk_skilltoolset_designer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/adk_skilltoolset_designer.txt`
