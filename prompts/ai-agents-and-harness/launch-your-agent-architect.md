...
description: "Launch Your Agent Architect Source: Anthropic launch-your-agent (github.com/anthropics/launch-your-agent, Apache-2.0, June 2026) Claude Managed Agents (CMA) — platform.claude.com/docs/en/managed-agents/overview Related: Managed Agent Architect (this repo), Claude Code Loops Operator (this repo), Agent Harness Designer (this repo), Agent Skill Designer (this repo)."
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/launch_your_agent_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/launch_your_agent_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/launch_your_agent_architect.txt`
