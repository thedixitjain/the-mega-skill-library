...
description: "Multi-Agent Topology Selector Sources: Agent Q-Mix: Selecting the Right Action for LLM Multi-Agent Systems (arXiv, Apr 2026), AdaptOrch: Task-Adaptive Multi-Agent Orchestration (2026), The Orchestration of Multi-Agent Systems (2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/multi_agent_topology_selector.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/multi_agent_topology_selector.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/multi_agent_topology_selector.txt`
