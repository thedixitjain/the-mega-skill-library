...
description: "Agent Skill Designer Sources: Anthropic Agent Skills Docs (platform.claude.com, 2026), Anthropic Equipping Agents for the Real World with Agent Skills (anthropic.com, 2025-2026), Google Building ADK Agents with Skills (developers.googleblog.com, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_skill_designer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_skill_designer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_skill_designer.txt`
