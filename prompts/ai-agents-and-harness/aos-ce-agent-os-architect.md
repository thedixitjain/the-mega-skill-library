...
description: "AOS CE Agent Operating System Architect Source: https://github.com/unicity-aos/aos-ce (Unicity AOS Community Edition — open agent operating system, Rust, 6.5k+ stars, July 2026) — capsules, Astrid Runtime, Forge workbench, meta-harness, MCP bridge, typed event bus, least-privilege capabilities"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/aos_ce_agent_os_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/aos_ce_agent_os_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/aos_ce_agent_os_architect.txt`
