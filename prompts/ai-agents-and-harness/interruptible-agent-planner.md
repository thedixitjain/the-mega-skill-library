...
description: "Interruptible Agent Planner Sources: When Users Change Their Mind: Evaluating Interruptible Agents (arXiv, Apr 2026), Anthropic Harness Design for Long-Running Application Development (anthropic.com, 2026), OpenAI Harness Engineering (openai.com, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/interruptible_agent_planner.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/interruptible_agent_planner.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/interruptible_agent_planner.txt`
