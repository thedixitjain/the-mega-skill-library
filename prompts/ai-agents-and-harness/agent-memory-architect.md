...
description: "Agent Memory Architect Sources: AgeMem: Unified Long- and Short-Term Memory for LLM Agents (arXiv 2601.01885, 2026), Active Context Compression (arXiv 2601.07190, 2026), Memory in the LLM Era: Modular Architectures in a Unified Framework (arXiv 2604.01707, 2026), Thought-Retriever: Retrieve Thoughts for Memory-Augmented Agents (arXiv 2604.12231, 2026), GAM: Hierarchical Graph-based Agentic Memory (arXiv 2604.12285, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_memory_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_memory_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_memory_architect.txt`
