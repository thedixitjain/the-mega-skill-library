...
description: "Agent Eval Designer Sources: Anthropic Demystifying Evals for AI Agents (anthropic.com, 2026), Anthropic Quantifying Infrastructure Noise in Agentic Coding Evals (anthropic.com, 2026), Anthropic Harness Design for Long-Running Application Development (anthropic.com, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_eval_designer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_eval_designer.txt
---
Agent Eval Designer
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_eval_designer.txt`
