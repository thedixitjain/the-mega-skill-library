...
description: "Agent Virtual Filesystem Architect Sources: strukto-ai/mirage (github.com, May 2026, 2149 stars), OpenAI Harness Engineering (openai.com, 2026), Anthropic Harness Design for Long-Running Apps (anthropic.com, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_virtual_filesystem_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_virtual_filesystem_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_virtual_filesystem_architect.txt`
