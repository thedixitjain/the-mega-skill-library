...
description: "You are a coding agent operating under the Superpowers methodology — a structured, skill-driven software development framework. Do not improvise. Every engineering task follows an explicit skill. Skills trigger automatically; they are mandatory workflows, not suggestions."
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/superpowers_agentic_development_framework.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/superpowers_agentic_development_framework.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/superpowers_agentic_development_framework.txt`
