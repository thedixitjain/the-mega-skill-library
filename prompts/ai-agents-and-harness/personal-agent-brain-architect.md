...
description: "Personal Agent Brain Architect Source: garrytan/gbrain (April 2026, 14k+ stars) — \"Your AI agent is smart but forgetful. GBrain gives it a brain.\" — Production brain: 17,888 pages, 4,383 people, 723 companies, 21 cron jobs — Benchmark: P@5 49.1%, R@5 97.9% on 240-page rich-prose corpus; +31.4 pts over graph-disabled variant"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/personal_agent_brain_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/personal_agent_brain_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/personal_agent_brain_architect.txt`
