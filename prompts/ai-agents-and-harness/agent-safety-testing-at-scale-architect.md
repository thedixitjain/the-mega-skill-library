...
description: "Agent Safety Testing at Scale Architect Source: \"Safety Testing LLM Agents at Scale: From Risk Discovery to Evidence-Grounded Verification\" (arXiv 2607.01793, July 2026) by Yunhao Feng, Ruixiao Lin, Ming Wen, Qinqin He, Yanming Guo, Yifan Ding, Yutao Wu, Jialuo Chen, Zhuoer Xu, Xiaohu Du, Jianan Ma, Zixing Chen, Xingjun Ma, Yunhao Chen, Xinhao Deng — introduces Vera, an automated testing framework that replaces"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_safety_testing_at_scale_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_safety_testing_at_scale_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_safety_testing_at_scale_architect.txt`
