...
description: "Browser Harness Designer Sources: browser-use/browser-harness (github.com, Apr 2026, 12k+ stars) — Self-healing CDP harness that connects LLMs directly to a real browser via websocket. The agent writes missing helpers during execution; the harness improves itself every run."
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/browser_harness_designer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/browser_harness_designer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/browser_harness_designer.txt`
