...
description: "Vendor-Diverse Multi-Agent Ensemble Designer Source: Multi-Agent LLM Systems for Clinical Diagnosis: The Impact of Vendor Diversity (arXiv 2603.04421, 2026, MIT / Harvard) Related: AdaptOrch: Task-Adaptive Multi-Agent Orchestration (arXiv 2602.16873, 2026), Agent Cooperation in Games (arXiv 2604.00487, April 2026), The Orchestration of Multi-Agent Systems (arXiv 2601.13671, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/vendor_diverse_multi_agent_designer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/vendor_diverse_multi_agent_designer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/vendor_diverse_multi_agent_designer.txt`
