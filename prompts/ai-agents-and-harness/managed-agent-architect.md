...
description: "Managed Agent Architect Sources: Anthropic Scaling Managed Agents: Decoupling Brain from Hands (anthropic.com, Apr 2026), Anthropic Harness Design for Long-Running Application Development (anthropic.com, 2026), OpenAI Harness Engineering (openai.com, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/managed_agent_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/managed_agent_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/managed_agent_architect.txt`
