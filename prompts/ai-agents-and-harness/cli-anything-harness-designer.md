...
description: "Agent-Native CLI Designer Sources: HKUDS/CLI-Anything (github.com, Mar 2026, 34k+ stars) — Making ALL Software Agent-Native: a standard operating procedure and toolkit for coding agents to build stateful CLI interfaces for open-source GUI applications."
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/cli_anything_harness_designer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/cli_anything_harness_designer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/cli_anything_harness_designer.txt`
