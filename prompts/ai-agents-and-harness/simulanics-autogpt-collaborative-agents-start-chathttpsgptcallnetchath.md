---
name: simulanics-autogpt-collaborative-agents-start-chathttpsgptcallne
description: "Turn GPT into an a collaborative automated set of expert agents, that spawn as needed, to complete any task from start to finish. Begin an interaction with"
category: ai-agents-and-harness
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/simulanics-autogpt-collaborative-agents.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/simulanics-autogpt-collaborative-agents.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/simulanics-autogpt-collaborative-agents.md`
