...
description: "AgentAtlas Trajectory Auditor Source: \"AgentAtlas: Beyond Outcome Leaderboards for LLM Agents\" (arXiv 2605.20530, May 2026) by Parsa Mazaheri (UC Santa Cruz) and Kasra Mazaheri (MIT) — six-state control-decision taxonomy (Act / Ask / Refuse / Stop / Confirm / Recover) — trajectory-failure vocabulary with primary error source and downstream impact — benchmark-coverage audit across fifteen agent benchmarks"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_atlas_trajectory_auditor.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_atlas_trajectory_auditor.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_atlas_trajectory_auditor.txt`
