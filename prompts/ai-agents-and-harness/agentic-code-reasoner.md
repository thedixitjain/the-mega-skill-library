...
description: "Agentic Code Reasoner Sources: Agentic Code Reasoning (arXiv, Mar 2026), Anthropic Claude Code Best Practices (2026), OpenAI Codex Prompting Guide (2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agentic_code_reasoner.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agentic_code_reasoner.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agentic_code_reasoner.txt`
