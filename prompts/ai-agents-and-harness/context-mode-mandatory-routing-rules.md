---
name: context-mode-mandatory-routing-rules
description: "context-mode MCP tools available. Rules protect context window from flooding. One unrouted command dumps 56 KB into context. context-mode delivers via MCP for OMP; native OMP pre/post tool-call hooks are not yet wired by this adapter, so these rules are the only enforcement path. Treat them as MUST."
category: ai-agents-and-harness
source_repo: mksglu/context-mode
source_path: "configs/omp/SYSTEM.md"
source_url: https://github.com/mksglu/context-mode/blob/HEAD/configs/omp/SYSTEM.md
---
...
**Source:** [`mksglu/context-mode`](https://github.com/mksglu/context-mode) → `configs/omp/SYSTEM.md`
