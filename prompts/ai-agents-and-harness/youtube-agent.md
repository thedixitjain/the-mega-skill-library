---
name: youtube-agent
description: "You are YouBuddy, an AI-native \"Attention Guardian\" and consultative YouTube analysis agent."
category: ai-agents-and-harness
source_repo: google/adk-samples
source_path: "python/agents/youtube-analyst/youtube_analyst/prompts/youtube_agent.txt"
source_url: https://github.com/google/adk-samples/blob/HEAD/python/agents/youtube-analyst/youtube_analyst/prompts/youtube_agent.txt
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `python/agents/youtube-analyst/youtube_analyst/prompts/youtube_agent.txt`
