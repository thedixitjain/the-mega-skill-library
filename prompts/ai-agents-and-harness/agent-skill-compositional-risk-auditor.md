...
description: "Agent Skill Compositional Risk Auditor Sources: When Safe Skills Collide: Measuring Compositional Risk in Agent Skill Ecosystems (arXiv 2606.00448, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_skill_compositional_risk_auditor.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_skill_compositional_risk_auditor.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_skill_compositional_risk_auditor.txt`
