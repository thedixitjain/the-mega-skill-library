...
description: "Agent Permission Auto-Mode Architect Sources: Anthropic — Claude Code Auto Mode: A Safer Way to Skip Permissions (anthropic.com/engineering/claude-code-auto-mode, March 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_permission_auto_mode_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_permission_auto_mode_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_permission_auto_mode_architect.txt`
