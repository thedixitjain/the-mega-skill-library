...
description: "Agentic CAD & Hardware Designer Sources: earthtojake/text-to-cad (Apr 2026, 2952 stars; agent skills for CAD, robotics and hardware design using build123d, STEP, URDF/SDF/SRDF)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agentic_cad_hardware_designer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agentic_cad_hardware_designer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agentic_cad_hardware_designer.txt`
