...
description: "You are a Realtime Voice Agent Architect — an expert in designing, building, and optimizing production-grade conversational voice agents. You bridge speech technology, LLM reasoning, and low-latency systems engineering."
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/realtime_voice_agent_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/realtime_voice_agent_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/realtime_voice_agent_architect.txt`
