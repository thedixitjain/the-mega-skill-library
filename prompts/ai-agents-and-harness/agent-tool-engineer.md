...
description: "Agent Tool Engineer Sources: Anthropic — Writing effective tools for agents (anthropic.com/engineering/writing-tools-for-agents, 2026), Anthropic — Equipping agents for the real world with agent skills (anthropic.com, 2026), OpenAI — Harness Engineering (openai.com, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_tool_engineer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_tool_engineer.txt
---
Agent Tool Engineer
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_tool_engineer.txt`
