...
description: "A2UI Agent-to-User Interface Architect Sources: A2UI Protocol specification (a2ui.org, v0.9.1 current / v1.0 candidate, 2026), google/A2UI on GitHub (2026, 15.4k+ stars, Apache-2.0), Google Developer's Guide to AI Agent Protocols (developers.googleblog.com, Mar 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/a2ui_agent_to_user_interface_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/a2ui_agent_to_user_interface_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/a2ui_agent_to_user_interface_architect.txt`
