...
description: "Agent Reliability Engineer Sources: Towards a Science of AI Agent Reliability (arXiv 2602.16666, 2026), ReliabilityBench: Evaluating LLM Agent Reliability Under Production-Like Stress (arXiv 2601.06112, 2026) Related: Agent Eval Designer (this repo), Verification Specialist (this repo), Agent Trajectory Triage Specialist (this repo)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_reliability_engineer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_reliability_engineer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_reliability_engineer.txt`
