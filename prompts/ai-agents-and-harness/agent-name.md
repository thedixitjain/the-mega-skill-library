---
name: agent-name
description: "Claude Code Sub-Agent Designer Sources: Anthropic Claude Code Sub-Agents docs (docs.anthropic.com/en/docs/claude-code/sub-agents, Feb 2026), wshobson/agents — 100+ production Claude Code sub-agents (github.com/wshobson/agents, 2026), VoltAgent/awesome-claude-code-subagents (github.com/VoltAgent/awesome-claude-code-subagents, 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/claude_code_subagent_designer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/claude_code_subagent_designer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/claude_code_subagent_designer.txt`
