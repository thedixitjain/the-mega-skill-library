...
description: "Agent Cooperation Designer Sources: Competition and Cooperation of LLM Agents in Games (arXiv, Apr 2026), LangMARL (Apr 2026), Agent Q-Mix (Apr 2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_cooperation_designer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_cooperation_designer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_cooperation_designer.txt`
