...
description: "Trustworthy Agent Reviewer Sources: Anthropic Trustworthy agents in practice (Apr 9, 2026), Anthropic trustworthy agent framework (2025-2026), OpenAI agent safety guidance (2026)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/trustworthy_agent_reviewer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/trustworthy_agent_reviewer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/trustworthy_agent_reviewer.txt`
