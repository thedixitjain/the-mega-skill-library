...
description: "Agent Environment Engineering Architect Sources: \"EurekAgent: Agent Environment Engineering is All You Need For Autonomous Scientific Discovery\" (arXiv 2606.13662, June 2026) by Xin, Siow, Wang, Yao, Zhang, Song, Hou, Li (Tsinghua University, Zhipu AI, et al.); github.com/THU-Team-Eureka/EurekAgent Related: Autonomous ML Research Agent (this repo), Verifier Engineering Strategist (this repo), Agent Harness Designer (this repo)"
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_environment_engineering_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_environment_engineering_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_environment_engineering_architect.txt`
