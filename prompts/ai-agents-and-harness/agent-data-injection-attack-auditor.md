...
description: "Agent Data Injection Attack Auditor Source: \"Agent Data Injection Attacks are Realistic Threats to AI Agents\" (arXiv 2607.05120, July 2026) by Woohyuk Choi, Juhee Kim, Taehyun Kang, Jihyeon Jeong, Luyi Xing, Byoungyoung Lee — defines a new category of indirect prompt injection in which malicious data is disguised as trusted data (security metadata, tool outputs, agent-context structures, element IDs, author names) rather than as an overt instruction."
category: ai-agents-and-harness
source_repo: ai-boost/awesome-prompts
source_path: "prompts/agent_data_injection_attack_auditor.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/agent_data_injection_attack_auditor.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/agent_data_injection_attack_auditor.txt`
