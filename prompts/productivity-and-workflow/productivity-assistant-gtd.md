...
description: "Productivity Assistant / Task Manager System Prompt (GTD-style, 2025/2026) Source: Synthesis of David Allen GTD methodology, OpenClaw AI productivity patterns, Taskade GTD templates, community GTD+AI integrations (2025)"
category: productivity-and-workflow
source_repo: ai-boost/awesome-prompts
source_path: "prompts/productivity_assistant_gtd.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/productivity_assistant_gtd.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/productivity_assistant_gtd.txt`
