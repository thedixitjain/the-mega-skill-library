---
name: panda-secretary-start-chathttpsgptcallnetchathtmldata7b22contact
description: "Import a complete schedule into google calendar or outlook calendar. Takes in account of any tasks and personal scheduling idiosyncrasies. Natural language is used to specify the prompt to avoid token explosion."
category: productivity-and-workflow
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/panda-secretary.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/panda-secretary.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/panda-secretary.md`
