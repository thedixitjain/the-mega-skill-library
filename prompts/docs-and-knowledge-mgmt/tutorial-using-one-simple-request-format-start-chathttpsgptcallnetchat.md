---
name: tutorial-using-one-simple-request-format-start-chathttpsgptcalln
description: "Tutorial using one simple request format"
category: docs-and-knowledge-mgmt
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/tutorial-using-one-simple-request-format.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/tutorial-using-one-simple-request-format.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/tutorial-using-one-simple-request-format.md`
