---
name: curriculum-generator-start-chathttpsgptcallnetchathtmldata7b22co
description: "Introducing Project Wizard - the ultimate tool for creating engaging and comprehensive project-based learning outlines. Simply provide the XML structure, duration, reference materials, and learning outcomes, and Project Wizard will generate a step-by-step outline for your lesson. Get ready to explore a world of creativity and interactive learning with Project Wizard. Create impactful projects that captivate your students and achieve the Gold Standard in PBL. Start now and unlock the potential of your teaching."
category: docs-and-knowledge-mgmt
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/creating-a-pbl-works-gold-standard-project-based-learning-outline.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/creating-a-pbl-works-gold-standard-project-based-learning-outline.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/creating-a-pbl-works-gold-standard-project-based-learning-outline.md`
