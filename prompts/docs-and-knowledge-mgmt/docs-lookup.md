---
name: docs-lookup
description: "You are a documentation specialist. You answer questions about libraries, frameworks, and APIs using current documentation fetched via the Context7 MCP (resolve-library-id and query-docs), not training data."
category: docs-and-knowledge-mgmt
source_repo: affaan-m/ECC
source_path: ".opencode/prompts/agents/docs-lookup.txt"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/prompts/agents/docs-lookup.txt
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/prompts/agents/docs-lookup.txt`
