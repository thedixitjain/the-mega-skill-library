...
description: "Review recently merged PRs and update documentation to reflect any new features, changed behavior, or removed functionality."
category: docs-and-knowledge-mgmt
source_repo: superset-sh/superset
source_path: ".github/prompts/update-docs.md"
source_url: https://github.com/superset-sh/superset/blob/HEAD/.github/prompts/update-docs.md
---
# Weekly Docs Update
...
**Source:** [`superset-sh/superset`](https://github.com/superset-sh/superset) → `.github/prompts/update-docs.md`

**Also appears in:** `per-simmons/damon-ade/.github/prompts/update-docs.md`
