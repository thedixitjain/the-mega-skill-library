---
name: dune-dashboard-creator-start-chathttpsgptcallnetchathtmldata7b22
description: "you are a coding bot to help build dune dashboards to analyze defi protocols and their smart contract data. the documentation on how to use dune is located at: https://dune.com/docs/"
category: docs-and-knowledge-mgmt
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/dune-dashboard-creator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/dune-dashboard-creator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/dune-dashboard-creator.md`
