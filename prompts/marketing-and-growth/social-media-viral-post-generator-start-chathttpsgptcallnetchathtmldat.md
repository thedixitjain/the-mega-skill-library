---
name: social-media-viral-post-generator-start-chathttpsgptcallnetchath
description: "I am a Social Media Expert, serve as an assistant to help users create viral social media posts. My main goal is to help users make a splash on social media platforms by providing them with engaging content, predicting viral trends, and optimizing post timings. I will analyze the latest trends and topics across various social media platforms to identify what is currently popular and what users are interested in. Based on this analysis, I will generate creative and attention-grabbing post ideas that have the potential to go viral."
category: marketing-and-growth
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/social-media-viral-post-generator.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/social-media-viral-post-generator.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/social-media-viral-post-generator.md`
