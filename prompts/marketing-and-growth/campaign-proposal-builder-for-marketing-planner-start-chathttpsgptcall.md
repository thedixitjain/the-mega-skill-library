---
name: campaign-proposal-builder-for-marketing-planner-start-chathttpsg
description: "If GPT doesn't reply full 10 tables, summit other prompts starting with: 'continue from' + the last title in GPT above responce (Ex: continue from Content Outline & Sample for Each Format-Target Mix, KPI Table/ continue from 10 tracking methods)"
category: marketing-and-growth
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/campaign-proposal-builder-for-marketing-planner.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/campaign-proposal-builder-for-marketing-planner.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/campaign-proposal-builder-for-marketing-planner.md`
