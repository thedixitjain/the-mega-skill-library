---
name: gpt-seo-domain-expert-start-chathttpsgptcallnetchathtmldata7b22c
description: "Description The GPT SEO Domain Expert assists in crafting ideal domain names and descriptions based on SEO guidelines. It generates a list of 20 unique, creative, and catchy domain names suitable for projects or investments. The expert considers relevant niches or keywords provided and provides descriptions for each domain name."
category: marketing-and-growth
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/gpt-seo-domain-expert.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/gpt-seo-domain-expert.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/gpt-seo-domain-expert.md`
