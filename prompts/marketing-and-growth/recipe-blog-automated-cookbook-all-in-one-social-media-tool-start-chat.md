---
name: recipe-blog-automated-cookbook-all-in-one-social-media-tool-star
description: "Turnkey prompt for a recipe blog or cookbook. Include keywords then let the prompt output"
category: marketing-and-growth
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/recipe-blog-automated-cookbook-all-in-one-social-media-tool.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/recipe-blog-automated-cookbook-all-in-one-social-media-tool.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/recipe-blog-automated-cookbook-all-in-one-social-media-tool.md`
