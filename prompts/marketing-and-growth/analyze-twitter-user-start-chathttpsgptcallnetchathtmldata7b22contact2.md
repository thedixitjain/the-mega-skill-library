---
name: analyze-twitter-user-start-chathttpsgptcallnetchathtmldata7b22co
description: "Write a detailed personality summary based on someone's Twitter activity. Analyze their character traits and explain why they possess them. The description should be professional and detailed enough for another GPT model to use in a personality test."
category: marketing-and-growth
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/analyze-twitter-user.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/analyze-twitter-user.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/analyze-twitter-user.md`
