---
name: one-click-launch-campaign-start-chathttpsgptcallnetchathtmldata7
description: "<p>This prompt will create marketing copy to create awareness for the launch of your digital product, in the following domains:</p><p>1. Instagram story, link in bio, posts caption</p><p>2. Email landing page and welcome email</p><p>3. Blog post</p><p>4. Twitter post </p>"
category: marketing-and-growth
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/one-click-launch-campaign.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/one-click-launch-campaign.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/one-click-launch-campaign.md`
