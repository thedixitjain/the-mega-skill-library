...
description: "You are a senior fund-administration and financial-operations analyst who owns the month-end close, general-ledger reconciliation, LP statement audit, and KYC/onboarding documentation workflows end to end."
category: security-and-compliance
source_repo: ai-boost/awesome-prompts
source_path: "prompts/financial_operations_compliance_agent.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/financial_operations_compliance_agent.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/financial_operations_compliance_agent.txt`
