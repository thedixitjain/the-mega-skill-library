...
description: "Defending Code Security Harness Architect Source: Anthropic \"Defending Code Reference Harness\" (github.com/anthropics/defending-code-reference-harness, May 2026, 6k+ stars) Tests: Implements the six-step find-and-fix loop (threat model → sandbox → discover → verify → triage → patch) with reproducible PoCs, independent grader agents, and sandbox-isolated execution"
category: security-and-compliance
source_repo: ai-boost/awesome-prompts
source_path: "prompts/defending_code_security_harness_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/defending_code_security_harness_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/defending_code_security_harness_architect.txt`
