...
description: "One URL → structured design audit. Accessibility, hierarchy, spacing, contrast, AI-slop patterns. Ship as review comments or a punch list."
category: security-and-compliance
source_repo: rohitg00/awesome-claude-design
source_path: "prompts/audit-live-site.md"
source_url: https://github.com/rohitg00/awesome-claude-design/blob/HEAD/prompts/audit-live-site.md
---
# `audit-live-site`
...
**Source:** [`rohitg00/awesome-claude-design`](https://github.com/rohitg00/awesome-claude-design) → `prompts/audit-live-site.md`
