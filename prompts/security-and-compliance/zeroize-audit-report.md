---
name: zeroize-audit-report
description: "Run ID: <runid> Timestamp: <ISO-8601> Repository: <path> Compile DB: <compiledb>"
category: security-and-compliance
source_repo: trailofbits/skills
source_path: "plugins/zeroize-audit/skills/zeroize-audit/prompts/report_template.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/zeroize-audit/skills/zeroize-audit/prompts/report_template.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/zeroize-audit/skills/zeroize-audit/prompts/report_template.md`
