...
description: "Audits C/C++/Rust code for missing zeroization and compiler-removed wipes. Pipeline: source scan -> MCP/LSP semantic context -> IR diff -> assembly checks."
category: security-and-compliance
source_repo: trailofbits/skills
source_path: "plugins/zeroize-audit/skills/zeroize-audit/prompts/system.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/zeroize-audit/skills/zeroize-audit/prompts/system.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/zeroize-audit/skills/zeroize-audit/prompts/system.md`
