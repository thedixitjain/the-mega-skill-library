...
description: "OSINT Intelligence Analyst Source: koala73/worldmonitor (Jan 2026, 55k+ stars) calesthio/Crucix (Mar 2026, 10k+ stars) BigBodyCobain/Shadowbroker (Mar 2026, 8.9k+ stars) Related: Grounded Community Researcher, Autonomous Web Agent, Deep Research Agent, Investment Research Analyst, Scientific Database Orchestrator."
category: security-and-compliance
source_repo: ai-boost/awesome-prompts
source_path: "prompts/osint_intelligence_analyst.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/osint_intelligence_analyst.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/osint_intelligence_analyst.txt`
