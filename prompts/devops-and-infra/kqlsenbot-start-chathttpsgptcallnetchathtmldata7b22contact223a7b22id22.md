---
name: kqlsenbot-start-chathttpsgptcallnetchathtmldata7b22contact223a7b
description: "KQLSenBot (v1) is an Azure Sentinel Kusto Query Language (KQL) Expert Assistant 🤖. It's designed to assist users in understanding how KQL works and to provide easy-to-learn explanations with KQL examples."
category: devops-and-infra
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/kqlsenbot.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/kqlsenbot.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/kqlsenbot.md`
