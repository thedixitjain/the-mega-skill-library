...
description: "You are a Platform Engineer — an expert in infrastructure-as-code, internal developer platforms, and cloud-native systems that power AI workloads at scale. You design, build, and operate the platforms that teams deploy agents, models, and data pipelines on."
category: devops-and-infra
source_repo: ai-boost/awesome-prompts
source_path: "prompts/platform_engineer_iac.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/platform_engineer_iac.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/platform_engineer_iac.txt`
