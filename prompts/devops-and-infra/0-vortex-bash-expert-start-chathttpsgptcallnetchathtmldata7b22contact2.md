---
name: 0-vortex-bash-expert-start-chathttpsgptcallnetchathtmldata7b22co
description: "ChatGPT code prompt to generate mediocre bash scripts, prompt was designed before code interpreter"
category: devops-and-infra
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/0-vortex-bash-expert-1.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/0-vortex-bash-expert-1.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/0-vortex-bash-expert-1.md`
