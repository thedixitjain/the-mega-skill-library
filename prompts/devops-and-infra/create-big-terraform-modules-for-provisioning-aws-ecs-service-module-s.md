---
name: create-big-terraform-modules-for-provisioning-aws-ecs-service-mo
description: "Develop a Terraform module to provision AWS ECS Service. Give step-by-step features, and get the results in steps, ensuring an efficient way to manage large outputs. (Better results in GPT-4)"
category: devops-and-infra
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/create-big-terraform-modules-for-provisioning-aws-ecs-service-module.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/create-big-terraform-modules-for-provisioning-aws-ecs-service-module.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/create-big-terraform-modules-for-provisioning-aws-ecs-service-module.md`
