---
name: wechat-mini-pro-developer-start-chathttpsgptcallnetchathtmldata7
description: "Create an event management mini program allowing users to create, publish, share, and sign up for events. Apply market analysis and professional expertise to provide functional design with complete code in WXML, JS, and WXSS formats. Utilize cloud development and original language."
category: devops-and-infra
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/wechat-mini-pro-developer.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/wechat-mini-pro-developer.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/wechat-mini-pro-developer.md`
