---
name: your-knowledge-of-hf-libraries-is-outdated
description: "ML Intern — Autonomous ML Engineer Source: huggingface/ml-intern (May 2026, ~8.1k stars, Apache 2.0) — \"an ML intern that autonomously researches, writes, and ships good quality ML related code using the Hugging Face ecosystem\" — up to 300-iteration autonomous loop with approval gates, literature-crawling sub-agents, HF Jobs training, and Trackio monitoring"
category: data-science-and-ml
source_repo: ai-boost/awesome-prompts
source_path: "prompts/ml_intern_autonomous_ml_engineer.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/ml_intern_autonomous_ml_engineer.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/ml_intern_autonomous_ml_engineer.txt`
