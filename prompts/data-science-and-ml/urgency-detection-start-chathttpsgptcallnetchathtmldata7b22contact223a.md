---
name: urgency-detection-start-chathttpsgptcallnetchathtmldata7b22conta
description: "Text classification enables support teams to save hours of manual data processing by classifying the content and extract the sentences which are in urgent in nature."
category: data-science-and-ml
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/urgency-detection.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/urgency-detection.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/urgency-detection.md`
