---
name: dataset-explorercrop-production-by-farm-size-from-agricultural-c
description: "The dataset covers multiple countries and includes information on 154 crop species and farm size categories. It has been harmonized with the FAOSTAT and World Census of Agriculture databases. The dataset can be used as a baseline for other global farm size datasets that do not contain direct measurements of smallholder food production."
category: data-science-and-ml
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/crop-production-by-farm-size-from-agricultural-censuses-and-surveys.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/crop-production-by-farm-size-from-agricultural-censuses-and-surveys.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/crop-production-by-farm-size-from-agricultural-censuses-and-surveys.md`
