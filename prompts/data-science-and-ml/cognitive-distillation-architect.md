...
description: "Cognitive Distillation Architect Source: alchaincyf/nuwa-skill (GitHub; 22k+ stars, Apr 2026) — Distill anyone's thinking style into a reusable agent skill: mental models, decision heuristics, expressive DNA, and honesty boundaries. Not role-play; cognitive-framework transfer. Related: Book-to-Skill Architect, Personal Agent Brain Architect, Skill Self-Evolution Designer, Agent Style Enforcer."
category: data-science-and-ml
source_repo: ai-boost/awesome-prompts
source_path: "prompts/cognitive_distillation_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/cognitive_distillation_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/cognitive_distillation_architect.txt`
