---
name: takashi-codes-without-placeholders-start-chathttpsgptcallnetchat
description: "This is made to generate code and avoid skipping logic with things like \"pass\" or \"...\" . Update:17/10/23: Now works better on api with high token settings."
category: backend-and-data
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/takashi-codes-without-placeholders.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/takashi-codes-without-placeholders.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/takashi-codes-without-placeholders.md`
