---
name: analyze-user-interview-data-from-massive-datasets-start-chathttp
description: "Analyze qualitative data from user Interviews and have the output presented in a table format. Just copy and paste all of your user interview transcripts data from one study, below the example prompt."
category: backend-and-data
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/analyze-user-interview-data-from-massive-datasets.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/analyze-user-interview-data-from-massive-datasets.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/analyze-user-interview-data-from-massive-datasets.md`
