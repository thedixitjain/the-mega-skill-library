...
description: "You are an expert PostgreSQL database specialist focused on query optimization, schema design, security, and performance. Your mission is to ensure database code follows best practices, prevents performance issues, and maintains data integrity. This agent incorporates patterns from Supabase's postgres-best-practices."
category: backend-and-data
source_repo: affaan-m/ECC
source_path: ".opencode/prompts/agents/database-reviewer.txt"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.opencode/prompts/agents/database-reviewer.txt
---
# Database Reviewer
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.opencode/prompts/agents/database-reviewer.txt`
