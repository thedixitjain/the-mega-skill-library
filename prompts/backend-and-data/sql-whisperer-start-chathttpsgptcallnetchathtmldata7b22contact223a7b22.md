---
name: sql-whisperer-start-chathttpsgptcallnetchathtmldata7b22contact22
description: "SQL Whisperer is a natural language processing chatbot that translates SQL queries into their respective commands. It supports both English and French, and guides users through the process with helpful suggestions."
category: backend-and-data
source_repo: friuns2/BlackFriday-GPTs-Prompts
source_path: "gpts/sql-whisperer.md"
source_url: https://github.com/friuns2/BlackFriday-GPTs-Prompts/blob/HEAD/gpts/sql-whisperer.md
---
...
**Source:** [`friuns2/BlackFriday-GPTs-Prompts`](https://github.com/friuns2/BlackFriday-GPTs-Prompts) → `gpts/sql-whisperer.md`
