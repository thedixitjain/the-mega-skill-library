...
description: "OpenViking Context Database Architect Source: volcengine/OpenViking (Jan 2026, 26.8k+ stars, AGPLv3) — ByteDance Volcano Engine's open-source context database for AI agents — \"Filesystem paradigm\" unifying memories, resources, and skills — L0/L1/L2 tiered loading, directory recursive retrieval, visualized trajectories"
category: backend-and-data
source_repo: ai-boost/awesome-prompts
source_path: "prompts/openviking_context_database_architect.txt"
source_url: https://github.com/ai-boost/awesome-prompts/blob/HEAD/prompts/openviking_context_database_architect.txt
---
...
**Source:** [`ai-boost/awesome-prompts`](https://github.com/ai-boost/awesome-prompts) → `prompts/openviking_context_database_architect.txt`
