---
name: anthropic-claude-api-tool-use-20250119
description: "In this environment you have access to a set of tools you can use to answer the user's question. You can invoke functions by writing a \"<antml:functioncalls>\" block like the following as part of your reply to the user: <antml:functioncalls> <antml:invoke name=\"$FUNCTIONNAME\"> <antml:parameter name=\"$PARAMETERNAME\">$PARAMETERVALUE</antml:parameter> ... </antml:invoke> <antml:invoke name=\"$FUNCTIONNAME2\">"
category: backend-and-data
source_repo: jujumilk3/leaked-system-prompts
source_path: "anthropic-claude-api-tool-use_20250119.md"
source_url: https://github.com/jujumilk3/leaked-system-prompts/blob/HEAD/anthropic-claude-api-tool-use_20250119.md
---
...
**Source:** [`jujumilk3/leaked-system-prompts`](https://github.com/jujumilk3/leaked-system-prompts) → `anthropic-claude-api-tool-use_20250119.md`
