<!-- Harvested from https://github.com/NirantK/awesome-project-ideas/blob/HEAD/README.md -->
> **Source:** [`NirantK/awesome-project-ideas`](https://github.com/NirantK/awesome-project-ideas) → `README.md`
