<!-- Harvested from https://github.com/hesreallyhim/awesome-claude-code/blob/HEAD/README_ALTERNATIVES/README_CLASSIC.md -->
> **Source:** [`hesreallyhim/awesome-claude-code`](https://github.com/hesreallyhim/awesome-claude-code) → `README_ALTERNATIVES/README_CLASSIC.md`
