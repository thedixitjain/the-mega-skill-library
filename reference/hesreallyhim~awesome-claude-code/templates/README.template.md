<!-- Harvested from https://github.com/hesreallyhim/awesome-claude-code/blob/HEAD/templates/README.template.md -->
> **Source:** [`hesreallyhim/awesome-claude-code`](https://github.com/hesreallyhim/awesome-claude-code) → `templates/README.template.md`
