<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/README.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `README.md`
