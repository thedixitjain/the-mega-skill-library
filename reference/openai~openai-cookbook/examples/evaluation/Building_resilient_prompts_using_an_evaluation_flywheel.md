<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/examples/evaluation/Building_resilient_prompts_using_an_evaluation_flywheel.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `examples/evaluation/Building_resilient_prompts_using_an_evaluation_flywheel.md`
