<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/examples/third_party/Code_quality_and_security_scan_with_GitHub_Actions.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `examples/third_party/Code_quality_and_security_scan_with_GitHub_Actions.md`
