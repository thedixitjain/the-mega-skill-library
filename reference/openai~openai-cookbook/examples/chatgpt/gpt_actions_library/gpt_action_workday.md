<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/examples/chatgpt/gpt_actions_library/gpt_action_workday.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `examples/chatgpt/gpt_actions_library/gpt_action_workday.md`
