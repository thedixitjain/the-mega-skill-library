<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/examples/codex/code_modernization.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `examples/codex/code_modernization.md`
