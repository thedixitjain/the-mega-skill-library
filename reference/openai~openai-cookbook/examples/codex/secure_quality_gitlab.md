<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/examples/codex/secure_quality_gitlab.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `examples/codex/secure_quality_gitlab.md`
