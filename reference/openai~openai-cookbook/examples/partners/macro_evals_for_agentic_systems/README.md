<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/examples/partners/macro_evals_for_agentic_systems/README.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `examples/partners/macro_evals_for_agentic_systems/README.md`
