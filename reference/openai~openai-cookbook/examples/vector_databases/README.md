<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/examples/vector_databases/README.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `examples/vector_databases/README.md`
