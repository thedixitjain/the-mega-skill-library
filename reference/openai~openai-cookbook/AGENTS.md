<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/AGENTS.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `AGENTS.md`
