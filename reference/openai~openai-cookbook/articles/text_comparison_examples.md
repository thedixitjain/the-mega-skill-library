<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/articles/text_comparison_examples.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `articles/text_comparison_examples.md`
