<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/articles/related_resources.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `articles/related_resources.md`
