<!-- Harvested from https://github.com/openai/openai-cookbook/blob/HEAD/.codex/skills/docs-editor/resources/style-guide.md -->
> **Source:** [`openai/openai-cookbook`](https://github.com/openai/openai-cookbook) → `.codex/skills/docs-editor/resources/style-guide.md`
