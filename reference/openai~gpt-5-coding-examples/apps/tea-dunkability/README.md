<!-- Harvested from https://github.com/openai/gpt-5-coding-examples/blob/HEAD/apps/tea-dunkability/README.md -->
> **Source:** [`openai/gpt-5-coding-examples`](https://github.com/openai/gpt-5-coding-examples) → `apps/tea-dunkability/README.md`
