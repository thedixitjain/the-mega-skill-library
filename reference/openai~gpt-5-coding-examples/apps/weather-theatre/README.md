<!-- Harvested from https://github.com/openai/gpt-5-coding-examples/blob/HEAD/apps/weather-theatre/README.md -->
> **Source:** [`openai/gpt-5-coding-examples`](https://github.com/openai/gpt-5-coding-examples) → `apps/weather-theatre/README.md`
