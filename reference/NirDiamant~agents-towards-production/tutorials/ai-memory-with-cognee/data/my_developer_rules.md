<!-- Harvested from https://github.com/NirDiamant/agents-towards-production/blob/HEAD/tutorials/ai-memory-with-cognee/data/my_developer_rules.md -->
> **Source:** [`NirDiamant/agents-towards-production`](https://github.com/NirDiamant/agents-towards-production) → `tutorials/ai-memory-with-cognee/data/my_developer_rules.md`
