<!-- Harvested from https://github.com/NirDiamant/agents-towards-production/blob/HEAD/tutorials/arcade-secure-tool-calling/README.md -->
> **Source:** [`NirDiamant/agents-towards-production`](https://github.com/NirDiamant/agents-towards-production) → `tutorials/arcade-secure-tool-calling/README.md`
