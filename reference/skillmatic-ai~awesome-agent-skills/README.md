<!-- Harvested from https://github.com/skillmatic-ai/awesome-agent-skills/blob/HEAD/README.md -->
> **Source:** [`skillmatic-ai/awesome-agent-skills`](https://github.com/skillmatic-ai/awesome-agent-skills) → `README.md`
