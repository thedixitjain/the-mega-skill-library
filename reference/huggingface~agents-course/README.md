<!-- Harvested from https://github.com/huggingface/agents-course/blob/HEAD/README.md -->
> **Source:** [`huggingface/agents-course`](https://github.com/huggingface/agents-course) → `README.md`
