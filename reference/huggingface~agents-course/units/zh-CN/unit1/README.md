<!-- Harvested from https://github.com/huggingface/agents-course/blob/HEAD/units/zh-CN/unit1/README.md -->
> **Source:** [`huggingface/agents-course`](https://github.com/huggingface/agents-course) → `units/zh-CN/unit1/README.md`
