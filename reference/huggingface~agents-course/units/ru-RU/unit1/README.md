<!-- Harvested from https://github.com/huggingface/agents-course/blob/HEAD/units/ru-RU/unit1/README.md -->
> **Source:** [`huggingface/agents-course`](https://github.com/huggingface/agents-course) → `units/ru-RU/unit1/README.md`
