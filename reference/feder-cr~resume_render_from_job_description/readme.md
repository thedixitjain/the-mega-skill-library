<!-- Harvested from https://github.com/feder-cr/resume_render_from_job_description/blob/HEAD/readme.md -->
> **Source:** [`feder-cr/resume_render_from_job_description`](https://github.com/feder-cr/resume_render_from_job_description) → `readme.md`
