<!-- Harvested from https://github.com/i-am-bee/acp/blob/HEAD/examples/python/beeai-canvas/README.md -->
> **Source:** [`i-am-bee/acp`](https://github.com/i-am-bee/acp) → `examples/python/beeai-canvas/README.md`
