<!-- Harvested from https://github.com/NirDiamant/GenAI_Agents/blob/HEAD/README.md -->
> **Source:** [`NirDiamant/GenAI_Agents`](https://github.com/NirDiamant/GenAI_Agents) → `README.md`
