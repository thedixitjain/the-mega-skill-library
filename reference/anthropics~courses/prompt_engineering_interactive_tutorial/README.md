<!-- Harvested from https://github.com/anthropics/courses/blob/HEAD/prompt_engineering_interactive_tutorial/README.md -->
> **Source:** [`anthropics/courses`](https://github.com/anthropics/courses) → `prompt_engineering_interactive_tutorial/README.md`
