<!-- Harvested from https://github.com/anthropics/courses/blob/HEAD/prompt_evaluations/README.md -->
> **Source:** [`anthropics/courses`](https://github.com/anthropics/courses) → `prompt_evaluations/README.md`
