<!-- Harvested from https://github.com/anthropics/courses/blob/HEAD/real_world_prompting/README.md -->
> **Source:** [`anthropics/courses`](https://github.com/anthropics/courses) → `real_world_prompting/README.md`
