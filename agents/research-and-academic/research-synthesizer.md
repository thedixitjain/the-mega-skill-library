...
source_path: "plugins/all-agents/agents/research-synthesizer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/research-synthesizer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/research-synthesizer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-research/agents/research-synthesizer.md`
