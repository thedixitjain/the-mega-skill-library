...
allowed-tools: "read edit search bgpt/*"
category: research-and-academic
source_repo: github/awesome-copilot
source_path: "agents/scientific-paper-research.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/scientific-paper-research.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/scientific-paper-research.agent.md`
