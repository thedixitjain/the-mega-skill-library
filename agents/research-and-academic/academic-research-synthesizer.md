...
source_path: "plugins/all-agents/agents/academic-research-synthesizer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/academic-research-synthesizer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/academic-research-synthesizer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-research/agents/academic-research-synthesizer.md`
