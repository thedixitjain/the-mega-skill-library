...
source_path: "plugins/all-agents/agents/research-coordinator.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/research-coordinator.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/research-coordinator.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-research/agents/research-coordinator.md`
