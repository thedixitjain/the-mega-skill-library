...
description: "Note: The current year is 2026. Use this when searching for recent documentation and patterns."
category: research-and-academic
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-optimize/references/agents/repo-research-analyst.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-optimize/references/agents/repo-research-analyst.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-optimize/references/agents/repo-research-analyst.md`
