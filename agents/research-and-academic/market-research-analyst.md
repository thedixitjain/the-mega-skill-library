...
source_path: "plugins/all-agents/agents/market-research-analyst.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/market-research-analyst.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/market-research-analyst.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-research/agents/market-research-analyst.md`
