...
description: "> Use proactively for PRP generation and codebase pattern analysis. Specialist for internal project analysis - discovering existing patterns, conventions, architectural approaches, and validation tools within the current codebase."
allowed-tools: "Read, Grep, Glob, LS, Bash"
category: research-and-academic
source_repo: croffasia/cc-blueprint-toolkit
source_path: "claude/agents/codebase-research.md"
source_url: https://github.com/croffasia/cc-blueprint-toolkit/blob/HEAD/claude/agents/codebase-research.md
---
...
**Source:** [`croffasia/cc-blueprint-toolkit`](https://github.com/croffasia/cc-blueprint-toolkit) → `claude/agents/codebase-research.md`
