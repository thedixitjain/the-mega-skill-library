...
source_path: "compliance-os/agents/cs-fda-qsr-auditor.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/compliance-os/agents/cs-fda-qsr-auditor.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `compliance-os/agents/cs-fda-qsr-auditor.md`
