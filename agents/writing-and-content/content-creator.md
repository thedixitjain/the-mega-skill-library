...
source_path: "plugins/content-creator/agents/content-creator.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/content-creator/agents/content-creator.md
---
# Content Creator
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/content-creator/agents/content-creator.md`
