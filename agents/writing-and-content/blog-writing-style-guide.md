...
description: "- Conversational but authoritative — write like you're explaining to a smart colleague - Use \"you\" and \"we\" — never \"one should\" - Share opinions backed by experience: \"I've found that...\" or \"In practice...\""
category: writing-and-content
source_repo: google/adk-samples
source_path: "python/agents/agent-skills-tutorial/app/skills/blog-writer/references/style-guide.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/python/agents/agent-skills-tutorial/app/skills/blog-writer/references/style-guide.md
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `python/agents/agent-skills-tutorial/app/skills/blog-writer/references/style-guide.md`
