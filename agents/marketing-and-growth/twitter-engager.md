...
source_path: "plugins/twitter-engager/agents/twitter-engager.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/twitter-engager/agents/twitter-engager.md
---
# Twitter Engager
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/twitter-engager/agents/twitter-engager.md`
