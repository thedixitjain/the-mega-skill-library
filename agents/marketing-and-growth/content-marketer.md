...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/content-marketing/agents/content-marketer.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/content-marketing/agents/content-marketer.md`
