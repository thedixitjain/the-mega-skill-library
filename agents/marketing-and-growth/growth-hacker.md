...
source_path: "plugins/growth-hacker/agents/growth-hacker.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/growth-hacker/agents/growth-hacker.md
---
# Growth Hacker
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/growth-hacker/agents/growth-hacker.md`
