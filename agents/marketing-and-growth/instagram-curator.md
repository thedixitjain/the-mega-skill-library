...
source_path: "plugins/instagram-curator/agents/instagram-curator.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/instagram-curator/agents/instagram-curator.md
---
# Instagram Curator
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/instagram-curator/agents/instagram-curator.md`
