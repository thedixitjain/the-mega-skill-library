...
source_path: "plugins/all-agents/agents/seo-podcast-optimizer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/seo-podcast-optimizer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/seo-podcast-optimizer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-media-content/agents/seo-podcast-optimizer.md`
