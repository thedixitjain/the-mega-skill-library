...
source_path: "agents/marketing/cs-aeo.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/agents/marketing/cs-aeo.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `agents/marketing/cs-aeo.md`
