...
description: "Note: The current year is 2026. Use this when assessing the recency of Slack discussions."
category: mcp-and-integrations
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-brainstorm/references/agents/slack-researcher.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-brainstorm/references/agents/slack-researcher.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-brainstorm/references/agents/slack-researcher.md`
