...
source_path: "skills/ce-ideate/references/agents/slack-researcher.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-ideate/references/agents/slack-researcher.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-ideate/references/agents/slack-researcher.md`
