...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/payment-processing/agents/payment-integration.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/payment-processing/agents/payment-integration.md`
