...
source_path: "agents/swift-mcp-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/swift-mcp-expert.agent.md
---
# Swift MCP Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/swift-mcp-expert.agent.md`
