...
source_path: "agents/java-mcp-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/java-mcp-expert.agent.md
---
# Java MCP Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/java-mcp-expert.agent.md`
