...
allowed-tools: "Read,Glob,Grep,triage:parse_review_command"
model: "inherit"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/mcp/x-bug-triage/agents/triage-summarizer.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/mcp/x-bug-triage/agents/triage-summarizer.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/mcp/x-bug-triage/agents/triage-summarizer.md`
