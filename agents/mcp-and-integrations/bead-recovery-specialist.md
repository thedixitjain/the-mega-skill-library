...
allowed-tools: "Read, Bash(bd export:*), Bash(bd version:*), Bash(bd dolt show:*), Bash(bd dolt status:*), Bash(bd config get:*), Bash(bd config list:*), Bash(bd --help:*), Bash(bd dolt --help:*), Bash(dolt status:*), Bash(curl:*), Bash(bash ${CLAUDE_PLUGIN_ROOT}/scripts/server-health.sh:*), Bash(bash ${CLAUDE_PLUGIN_ROOT}/scripts/dolt-idle-reaper.sh:*)"
model: "opus"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/mcp/dolt-mcp-vcs/agents/bead-recovery-specialist.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/mcp/dolt-mcp-vcs/agents/bead-recovery-specialist.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/mcp/dolt-mcp-vcs/agents/bead-recovery-specialist.md`
