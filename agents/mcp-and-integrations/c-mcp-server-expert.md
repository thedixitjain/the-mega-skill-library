...
source_path: "agents/csharp-mcp-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/csharp-mcp-expert.agent.md
---
# C# MCP Server Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/csharp-mcp-expert.agent.md`
