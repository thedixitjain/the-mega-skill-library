...
source_path: "agents/power-platform-mcp-integration-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/power-platform-mcp-integration-expert.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/power-platform-mcp-integration-expert.agent.md`
