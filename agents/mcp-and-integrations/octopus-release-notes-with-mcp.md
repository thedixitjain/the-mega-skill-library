...
source_path: "agents/octopus-deploy-release-notes-mcp.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/octopus-deploy-release-notes-mcp.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/octopus-deploy-release-notes-mcp.agent.md`
