...
source_path: "agents/ruby-mcp-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/ruby-mcp-expert.agent.md
---
# Ruby MCP Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/ruby-mcp-expert.agent.md`
