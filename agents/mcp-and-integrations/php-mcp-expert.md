...
source_path: "agents/php-mcp-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/php-mcp-expert.agent.md
---
# PHP MCP Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/php-mcp-expert.agent.md`
