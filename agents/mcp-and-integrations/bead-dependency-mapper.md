...
allowed-tools: "Read, Bash(bash ${CLAUDE_PLUGIN_ROOT}/scripts/dep-graph.sh:*), mcp__dolt-mcp-vcs__query, mcp__dolt-mcp-vcs__list_databases"
model: "opus"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/mcp/dolt-mcp-vcs/agents/bead-dependency-mapper.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/mcp/dolt-mcp-vcs/agents/bead-dependency-mapper.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/mcp/dolt-mcp-vcs/agents/bead-dependency-mapper.md`
