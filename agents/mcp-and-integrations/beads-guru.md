...
allowed-tools: "Read, Bash(bd list:*), Bash(bd show:*), Bash(bd ready:*), Bash(bd memories:*), Bash(bd search:*), Bash(bd stats:*), Bash(bd-sync status:*), Bash(git status:*), Bash(git log:*)"
model: "sonnet"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/mcp/dolt-mcp-vcs/agents/beads-guru.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/mcp/dolt-mcp-vcs/agents/beads-guru.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/mcp/dolt-mcp-vcs/agents/beads-guru.md`
