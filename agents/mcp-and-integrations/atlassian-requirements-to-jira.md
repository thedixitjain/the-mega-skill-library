...
allowed-tools: "['atlassian']"
category: mcp-and-integrations
source_repo: github/awesome-copilot
source_path: "agents/atlassian-requirements-to-jira.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/atlassian-requirements-to-jira.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/atlassian-requirements-to-jira.agent.md`
