...
allowed-tools: "Read, Bash(bd dolt show:*), Bash(bd dolt remote list:*), Bash(bd dolt status:*), Bash(bd dolt --help:*), Bash(bd init --help:*), Bash(bd backup --help:*), Bash(dolt remote -v:*), Bash(curl:*), Bash(bash ${CLAUDE_PLUGIN_ROOT}/scripts/server-health.sh:*), Bash(bash ${CLAUDE_PLUGIN_ROOT}/scripts/dolt-idle-reaper.sh:*)"
model: "sonnet"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/mcp/dolt-mcp-vcs/agents/dolt-sync-advisor.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/mcp/dolt-mcp-vcs/agents/dolt-sync-advisor.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/mcp/dolt-mcp-vcs/agents/dolt-sync-advisor.md`
