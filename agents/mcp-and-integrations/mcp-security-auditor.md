...
source_path: "plugins/all-agents/agents/mcp-security-auditor.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/mcp-security-auditor.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/mcp-security-auditor.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-quality-security/agents/mcp-security-auditor.md`
