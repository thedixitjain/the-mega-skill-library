...
description: "Use this agent when you need assistance with Model Context Protocol (MCP) development, including building clients and servers, debugging MCP applications, understanding protocol specifications, or implementing MCP solutions using Python or TypeScript SDKs. This includes tasks like creating new MCP servers, integrating MCP clients into applications, troubleshooting connection issues, optimizing MCP implementations, or"
category: mcp-and-integrations
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/model-context-protocol-mcp-expert/agents/model-context-protocol-mcp-expert.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/model-context-protocol-mcp-expert/agents/model-context-protocol-mcp-expert.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/model-context-protocol-mcp-expert/agents/model-context-protocol-mcp-expert.md`
