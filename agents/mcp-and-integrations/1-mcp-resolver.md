...
allowed-tools: "Read, Grep, Glob, Write, Bash, mcp__serena__activate_project, mcp__serena__find_symbol, mcp__serena__find_referencing_symbols, mcp__serena__get_symbols_overview"
model: "inherit"
category: mcp-and-integrations
source_repo: trailofbits/skills
source_path: "plugins/zeroize-audit/agents/1-mcp-resolver.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/zeroize-audit/agents/1-mcp-resolver.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/zeroize-audit/agents/1-mcp-resolver.md`
