...
allowed-tools: "Read,Glob,Grep,triage:fetch_mentions,triage:search_recent,triage:fetch_conversation"
model: "inherit"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/mcp/x-bug-triage/agents/bug-clusterer.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/mcp/x-bug-triage/agents/bug-clusterer.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/mcp/x-bug-triage/agents/bug-clusterer.md`
