...
source_path: "agents/rust-mcp-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/rust-mcp-expert.agent.md
---
# Rust MCP Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/rust-mcp-expert.agent.md`
