...
source_path: "plugins/all-agents/agents/mcp-server-architect.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/mcp-server-architect.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/mcp-server-architect.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-quality-security/agents/mcp-server-architect.md`
