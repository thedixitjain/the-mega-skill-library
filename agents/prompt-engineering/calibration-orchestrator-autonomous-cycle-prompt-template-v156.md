---
name: calibration-orchestrator-autonomous-cycle-prompt-template-v156
description: "Prompt template for the AI session driving an end-to-end QPB calibration cycle. The orchestrator AI executes Steps 1-12 from aicontext/CALIBRATIONPROTOCOL.md, spawns playbook subprocesses per benchmark, and writes the cycle audit + Lever Calibration Log entry. Designed for Claude Code sessions but will work in any tool with bash + file tools."
category: prompt-engineering
source_repo: github/awesome-copilot
source_path: "skills/quality-playbook/agents/calibration_orchestrator.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/quality-playbook/agents/calibration_orchestrator.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/quality-playbook/agents/calibration_orchestrator.md`
