...
allowed-tools: "['codebase', 'edit/editFiles', 'web/fetch', 'githubRepo', 'problems', 'runCommands', 'search', 'searchResults', 'terminalLastCommand', 'terminalSelection', 'usages', 'terraform', 'Microsoft Docs', 'context7']"
category: prompt-engineering
source_repo: github/awesome-copilot
source_path: "agents/prompt-builder.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/prompt-builder.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/prompt-builder.agent.md`
