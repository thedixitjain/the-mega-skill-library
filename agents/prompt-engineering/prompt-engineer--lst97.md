...
allowed-tools: "Read, Write, Edit, Grep, Glob, Bash, LS, mcp__context7__resolve-library-id, Task, mcp__context7__get-library-docs, mcp__sequential-thinking__sequentialthinking"
model: "sonnet"
category: prompt-engineering
source_repo: lst97/claude-code-sub-agents
source_path: "agents/data-ai/prompt-engineer.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/data-ai/prompt-engineer.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/data-ai/prompt-engineer.md`
