...
source_path: "plugins/claude/prompts.chat/agents/prompt-manager.md"
source_url: https://github.com/f/prompts.chat/blob/HEAD/plugins/claude/prompts.chat/agents/prompt-manager.md
---
...
**Source:** [`f/prompts.chat`](https://github.com/f/prompts.chat) → `plugins/claude/prompts.chat/agents/prompt-manager.md`
