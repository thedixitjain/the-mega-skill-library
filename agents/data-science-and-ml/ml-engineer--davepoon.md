...
source_path: "plugins/all-agents/agents/ml-engineer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/ml-engineer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/ml-engineer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-data-ai/agents/ml-engineer.md`
