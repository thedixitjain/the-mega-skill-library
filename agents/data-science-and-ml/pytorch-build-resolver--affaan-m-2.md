...
source_path: "docs/es/agents/pytorch-build-resolver.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/agents/pytorch-build-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/agents/pytorch-build-resolver.md`
