...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/cloud-infrastructure/agents/deployment-engineer.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/cloud-infrastructure/agents/deployment-engineer.md`

**Also appears in:** `wshobson/agents/plugins/deployment-strategies/agents/deployment-engineer.md`, `wshobson/agents/plugins/full-stack-orchestration/agents/deployment-engineer.md`
