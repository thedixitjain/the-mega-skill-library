...
source_path: "plugins/cloud-infrastructure/agents/service-mesh-expert.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/cloud-infrastructure/agents/service-mesh-expert.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/cloud-infrastructure/agents/service-mesh-expert.md`
