...
source_path: "agents/platform-sre-kubernetes.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/platform-sre-kubernetes.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/platform-sre-kubernetes.agent.md`
