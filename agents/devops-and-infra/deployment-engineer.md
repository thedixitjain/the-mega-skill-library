...
source_path: "plugins/all-agents/agents/deployment-engineer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/deployment-engineer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/deployment-engineer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-infrastructure-operations/agents/deployment-engineer.md`
