...
source_path: "plugins/all-agents/agents/cloud-architect.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/cloud-architect.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/cloud-architect.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-infrastructure-operations/agents/cloud-architect.md`
