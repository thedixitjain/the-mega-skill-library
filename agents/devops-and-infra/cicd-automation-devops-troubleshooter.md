...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/cicd-automation/agents/devops-troubleshooter.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/cicd-automation/agents/devops-troubleshooter.md`

**Also appears in:** `wshobson/agents/plugins/incident-response/agents/devops-troubleshooter.md`, `wshobson/agents/plugins/distributed-debugging/agents/devops-troubleshooter.md`
