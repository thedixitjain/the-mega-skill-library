...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/cicd-automation/agents/cloud-architect.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/cicd-automation/agents/cloud-architect.md`

**Also appears in:** `wshobson/agents/plugins/cloud-infrastructure/agents/cloud-architect.md`, `wshobson/agents/plugins/deployment-validation/agents/cloud-architect.md`, `wshobson/agents/plugins/database-cloud-optimization/agents/cloud-architect.md`
