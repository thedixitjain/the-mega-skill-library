...
allowed-tools: "Read, Write, MultiEdit, Bash, Grep, Glob, WebFetch"
category: devops-and-infra
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/monitoring-observability-specialist/agents/monitoring-observability-specialist.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/monitoring-observability-specialist/agents/monitoring-observability-specialist.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/monitoring-observability-specialist/agents/monitoring-observability-specialist.md`
