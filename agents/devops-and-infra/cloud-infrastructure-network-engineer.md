...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/cloud-infrastructure/agents/network-engineer.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/cloud-infrastructure/agents/network-engineer.md`

**Also appears in:** `wshobson/agents/plugins/observability-monitoring/agents/network-engineer.md`
