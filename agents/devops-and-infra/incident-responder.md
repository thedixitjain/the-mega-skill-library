...
source_path: "agents/infrastructure/incident-responder.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/infrastructure/incident-responder.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/infrastructure/incident-responder.md`
