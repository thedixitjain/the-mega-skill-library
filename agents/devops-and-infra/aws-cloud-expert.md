...
allowed-tools: "['codebase', 'search', 'edit/editFiles', 'web/fetch', 'runCommands', 'terminalLastCommand', 'problems']"
model: "claude-sonnet-4-6"
category: devops-and-infra
source_repo: github/awesome-copilot
source_path: "agents/aws-cloud-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/aws-cloud-expert.agent.md
---
# AWS Cloud Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/aws-cloud-expert.agent.md`
