...
allowed-tools: "Write, Read, MultiEdit, WebSearch, Grep, Bash"
category: devops-and-infra
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/infrastructure-maintainer/agents/infrastructure-maintainer.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/infrastructure-maintainer/agents/infrastructure-maintainer.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/infrastructure-maintainer/agents/infrastructure-maintainer.md`
