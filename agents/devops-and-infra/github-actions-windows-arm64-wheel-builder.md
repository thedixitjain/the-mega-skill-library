...
source_path: "agents/python-win-arm64-gha-wheel-builder.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/python-win-arm64-gha-wheel-builder.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/python-win-arm64-gha-wheel-builder.agent.md`
