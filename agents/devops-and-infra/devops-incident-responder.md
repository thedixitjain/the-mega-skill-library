...
allowed-tools: "Read, Write, Edit, MultiEdit, Grep, Glob, Bash, LS, WebSearch, WebFetch, Bash, Task, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, mcp__sequential-thinking__sequentialthinking"
model: "sonnet"
category: devops-and-infra
source_repo: lst97/claude-code-sub-agents
source_path: "agents/infrastructure/devops-incident-responder.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/infrastructure/devops-incident-responder.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/infrastructure/devops-incident-responder.md`
