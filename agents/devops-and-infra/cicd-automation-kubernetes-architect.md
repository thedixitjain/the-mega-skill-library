...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/cicd-automation/agents/kubernetes-architect.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/cicd-automation/agents/kubernetes-architect.md`

**Also appears in:** `wshobson/agents/plugins/cloud-infrastructure/agents/kubernetes-architect.md`, `wshobson/agents/plugins/kubernetes-operations/agents/kubernetes-architect.md`
