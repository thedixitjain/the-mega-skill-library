...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/cicd-automation/agents/terraform-specialist.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/cicd-automation/agents/terraform-specialist.md`

**Also appears in:** `wshobson/agents/plugins/cloud-infrastructure/agents/terraform-specialist.md`, `wshobson/agents/plugins/deployment-strategies/agents/terraform-specialist.md`
