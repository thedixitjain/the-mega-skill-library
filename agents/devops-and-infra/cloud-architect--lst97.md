...
source_path: "agents/infrastructure/cloud-architect.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/infrastructure/cloud-architect.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/infrastructure/cloud-architect.md`
