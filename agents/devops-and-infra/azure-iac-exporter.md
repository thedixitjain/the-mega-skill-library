...
allowed-tools: "['read', 'edit', 'search', 'web', 'execute', 'todo', 'runSubagent', 'azure-mcp/*', 'ms-azuretools.vscode-azure-github-copilot/azure_query_azure_resource_graph']"
model: "Claude Sonnet 4.5"
category: devops-and-infra
source_repo: github/awesome-copilot
source_path: "agents/azure-iac-exporter.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/azure-iac-exporter.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/azure-iac-exporter.agent.md`
