...
allowed-tools: "[execute/getTerminalOutput, execute/awaitTerminal, execute/runInTerminal, read/problems, read/readFile, read/terminalSelection, read/terminalLastCommand, agent, edit/createDirectory, edit/createFile, edit/editFiles, search, web/fetch, 'azure-mcp/*', todo]"
category: devops-and-infra
source_repo: github/awesome-copilot
source_path: "agents/terraform-azure-implement.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/terraform-azure-implement.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/terraform-azure-implement.agent.md`
