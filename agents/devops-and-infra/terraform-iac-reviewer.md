...
source_path: "agents/terraform-iac-reviewer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/terraform-iac-reviewer.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/terraform-iac-reviewer.agent.md`
