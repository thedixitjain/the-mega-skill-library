...
allowed-tools: "['codebase', 'edit/editFiles', 'terminalCommand', 'search']"
category: devops-and-infra
source_repo: github/awesome-copilot
source_path: "agents/github-actions-node-upgrade.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/github-actions-node-upgrade.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/github-actions-node-upgrade.agent.md`
