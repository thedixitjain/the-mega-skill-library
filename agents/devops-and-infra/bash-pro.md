...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/shell-scripting/agents/bash-pro.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/shell-scripting/agents/bash-pro.md`
