...
source_path: "agents/bash-expert.md"
source_url: https://github.com/0xfurai/claude-code-subagents/blob/HEAD/agents/bash-expert.md
---
...
**Source:** [`0xfurai/claude-code-subagents`](https://github.com/0xfurai/claude-code-subagents) → `agents/bash-expert.md`
