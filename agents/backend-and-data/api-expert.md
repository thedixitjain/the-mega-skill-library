...
source_path: "plugins/mcp/conversational-api-debugger/agents/api-expert.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/mcp/conversational-api-debugger/agents/api-expert.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/mcp/conversational-api-debugger/agents/api-expert.md`
