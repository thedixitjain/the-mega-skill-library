...
source_path: "plugins/all-agents/agents/api-documenter.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/api-documenter.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/api-documenter.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-documentation/agents/api-documenter.md`
