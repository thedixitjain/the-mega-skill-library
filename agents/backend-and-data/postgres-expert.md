...
source_path: "agents/postgres-expert.md"
source_url: https://github.com/0xfurai/claude-code-subagents/blob/HEAD/agents/postgres-expert.md
---
...
**Source:** [`0xfurai/claude-code-subagents`](https://github.com/0xfurai/claude-code-subagents) → `agents/postgres-expert.md`
