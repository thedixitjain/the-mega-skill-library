...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/api-scaffolding/agents/graphql-architect.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/api-scaffolding/agents/graphql-architect.md`

**Also appears in:** `wshobson/agents/plugins/backend-development/agents/graphql-architect.md`
