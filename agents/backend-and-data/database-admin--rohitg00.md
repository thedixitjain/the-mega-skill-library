...
source_path: "agents/infrastructure/database-admin.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/agents/infrastructure/database-admin.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `agents/infrastructure/database-admin.md`
