...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/database-migrations/agents/database-optimizer.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/database-migrations/agents/database-optimizer.md`

**Also appears in:** `wshobson/agents/plugins/observability-monitoring/agents/database-optimizer.md`, `wshobson/agents/plugins/database-cloud-optimization/agents/database-optimizer.md`
