...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/api-scaffolding/agents/backend-architect.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/api-scaffolding/agents/backend-architect.md`

**Also appears in:** `wshobson/agents/plugins/data-engineering/agents/backend-architect.md`, `wshobson/agents/plugins/backend-development/agents/backend-architect.md`, `wshobson/agents/plugins/multi-platform-apps/agents/backend-architect.md`, `wshobson/agents/plugins/backend-api-security/agents/backend-architect.md`, `wshobson/agents/plugins/database-cloud-optimization/agents/backend-architect.md`
