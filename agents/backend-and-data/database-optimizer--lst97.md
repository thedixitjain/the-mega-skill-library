...
allowed-tools: "Read, Write, Edit, Grep, Glob, Bash, LS, WebFetch, WebSearch, Task, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, mcp__sequential-thinking__sequentialthinking"
model: "sonnet"
category: backend-and-data
source_repo: lst97/claude-code-sub-agents
source_path: "agents/data-ai/database-optimizer.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/data-ai/database-optimizer.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/data-ai/database-optimizer.md`
