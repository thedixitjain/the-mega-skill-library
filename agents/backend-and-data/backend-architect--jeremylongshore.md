...
source_path: "plugins/packages/fullstack-starter-pack/agents/backend-architect.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/packages/fullstack-starter-pack/agents/backend-architect.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/packages/fullstack-starter-pack/agents/backend-architect.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/packages/fullstack-starter-pack/plugins/02-backend/agents/backend-architect.md`
