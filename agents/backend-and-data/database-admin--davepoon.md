...
source_path: "plugins/all-agents/agents/database-admin.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/database-admin.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/database-admin.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-infrastructure-operations/agents/database-admin.md`
