...
allowed-tools: "[\"codebase\", \"edit/editFiles\", \"githubRepo\", \"extensions\", \"runCommands\", \"database\", \"pgsql_bulkLoadCsv\", \"pgsql_connect\", \"pgsql_describeCsv\", \"pgsql_disconnect\", \"pgsql_listDatabases\", \"pgsql_listServers\", \"pgsql_modifyDatabase\", \"pgsql_open_script\", \"pgsql_query\", \"pgsql_visualizeSchema\"]"
category: backend-and-data
source_repo: github/awesome-copilot
source_path: "agents/postgresql-dba.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/postgresql-dba.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/postgresql-dba.agent.md`
