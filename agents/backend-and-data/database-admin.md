...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/database-migrations/agents/database-admin.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/database-migrations/agents/database-admin.md`
