...
allowed-tools: "Read, Write, Edit, MultiEdit, Grep, Glob, Bash, LS, WebSearch, WebFetch, TodoWrite, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, Task, mcp__sequential-thinking__sequentialthinking"
model: "sonnet"
category: backend-and-data
source_repo: lst97/claude-code-sub-agents
source_path: "agents/development/backend-architect.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/development/backend-architect.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/development/backend-architect.md`
