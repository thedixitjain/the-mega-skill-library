...
source_path: "docs/zh-CN/agents/database-reviewer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/agents/database-reviewer.md
---
# 数据库审查员
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/agents/database-reviewer.md`
