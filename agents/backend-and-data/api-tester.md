...
allowed-tools: "Bash, Read, Write, Grep, WebFetch, MultiEdit"
category: backend-and-data
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/api-tester/agents/api-tester.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/api-tester/agents/api-tester.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/api-tester/agents/api-tester.md`
