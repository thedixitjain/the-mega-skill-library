...
source_path: "agents/sql-expert.md"
source_url: https://github.com/0xfurai/claude-code-subagents/blob/HEAD/agents/sql-expert.md
---
...
**Source:** [`0xfurai/claude-code-subagents`](https://github.com/0xfurai/claude-code-subagents) → `agents/sql-expert.md`
