...
source_path: "plugins/packages/fullstack-starter-pack/agents/database-designer.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/packages/fullstack-starter-pack/agents/database-designer.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/packages/fullstack-starter-pack/agents/database-designer.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/packages/fullstack-starter-pack/plugins/03-database/agents/database-designer.md`
