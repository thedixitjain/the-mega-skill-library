...
source_path: "plugins/database/freshie-inventory-manager/agents/anomaly-detector.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/database/freshie-inventory-manager/agents/anomaly-detector.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/database/freshie-inventory-manager/agents/anomaly-detector.md`
