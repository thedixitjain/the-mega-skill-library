...
allowed-tools: "[\"search/codebase\", \"edit/editFiles\", \"githubRepo\", \"extensions\", \"runCommands\", \"database\", \"mssql_connect\", \"mssql_query\", \"mssql_listServers\", \"mssql_listDatabases\", \"mssql_disconnect\", \"mssql_visualizeSchema\"]"
category: backend-and-data
source_repo: github/awesome-copilot
source_path: "agents/ms-sql-dba.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/ms-sql-dba.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/ms-sql-dba.agent.md`
