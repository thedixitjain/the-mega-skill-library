...
source_path: "plugins/backend-development/agents/temporal-python-pro.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/backend-development/agents/temporal-python-pro.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/backend-development/agents/temporal-python-pro.md`
