...
allowed-tools: "Read, Write, Edit, MultiEdit, Grep, Glob, Bash, LS, WebSearch, WebFetch, Task, mcp__context7__resolve-library-id, mcp__context7__get-library-docs"
model: "haiku"
category: backend-and-data
source_repo: lst97/claude-code-sub-agents
source_path: "agents/specialization/api-documenter.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/specialization/api-documenter.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/specialization/api-documenter.md`
