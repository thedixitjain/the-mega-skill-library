...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/backend-api-security/agents/backend-security-coder.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/backend-api-security/agents/backend-security-coder.md`

**Also appears in:** `wshobson/agents/plugins/data-validation-suite/agents/backend-security-coder.md`
