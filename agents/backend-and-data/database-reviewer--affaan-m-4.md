...
source_path: "docs/ko-KR/agents/database-reviewer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/agents/database-reviewer.md
---
# 데이터베이스 리뷰어
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/agents/database-reviewer.md`
