...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/database-design/agents/database-architect.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/database-design/agents/database-architect.md`

**Also appears in:** `wshobson/agents/plugins/database-cloud-optimization/agents/database-architect.md`
