...
source_path: "plugins/all-agents/agents/backend-architect.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/backend-architect.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/backend-architect.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-development-architecture/agents/backend-architect.md`
