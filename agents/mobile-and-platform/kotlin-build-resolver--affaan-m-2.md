...
source_path: "docs/es/agents/kotlin-build-resolver.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/agents/kotlin-build-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/agents/kotlin-build-resolver.md`
