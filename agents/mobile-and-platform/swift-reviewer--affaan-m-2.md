...
source_path: "docs/ja-JP/agents/swift-reviewer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/agents/swift-reviewer.md
---
## プロンプト防御ベースライン
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/agents/swift-reviewer.md`
