...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/swift-build-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/swift-build-resolver.md`
