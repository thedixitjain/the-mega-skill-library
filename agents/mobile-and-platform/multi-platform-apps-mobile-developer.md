...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/multi-platform-apps/agents/mobile-developer.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/multi-platform-apps/agents/mobile-developer.md`

**Also appears in:** `wshobson/agents/plugins/frontend-mobile-development/agents/mobile-developer.md`
