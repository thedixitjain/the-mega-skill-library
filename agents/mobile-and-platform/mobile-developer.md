...
source_path: "plugins/all-agents/agents/mobile-developer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/mobile-developer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/mobile-developer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-development-architecture/agents/mobile-developer.md`
