...
allowed-tools: "[\"changes\", \"codebase\", \"editFiles\", \"extensions\", \"fetch\", \"findTestFiles\", \"githubRepo\", \"new\", \"openSimpleBrowser\", \"problems\", \"runCommands\", \"runTasks\", \"runTests\", \"search\", \"searchResults\", \"terminalLastCommand\", \"terminalSelection\", \"testFailure\", \"usages\", \"vscodeAPI\", \"microsoft.docs.mcp\"]"
model: "gpt-4.1"
category: mobile-and-platform
source_repo: github/awesome-copilot
source_path: "agents/power-bi-performance-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/power-bi-performance-expert.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/power-bi-performance-expert.agent.md`
