...
source_path: "plugins/mobile-app-builder/agents/mobile-app-builder.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/mobile-app-builder/agents/mobile-app-builder.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/mobile-app-builder/agents/mobile-app-builder.md`
