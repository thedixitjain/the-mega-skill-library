...
source_path: "plugins/flutter-mobile-app-dev/agents/flutter-mobile-app-dev.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/flutter-mobile-app-dev/agents/flutter-mobile-app-dev.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/flutter-mobile-app-dev/agents/flutter-mobile-app-dev.md`
