...
source_path: "docs/tr/agents/python-reviewer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/agents/python-reviewer.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/agents/python-reviewer.md`
