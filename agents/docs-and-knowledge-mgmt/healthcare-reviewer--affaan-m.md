...
source_path: "docs/zh-CN/agents/healthcare-reviewer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/agents/healthcare-reviewer.md
---
# 医疗评审员 — 临床安全与PHI合规
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/agents/healthcare-reviewer.md`
