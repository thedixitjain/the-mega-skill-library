...
source_path: "docs/tr/agents/java-build-resolver.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/agents/java-build-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/agents/java-build-resolver.md`
