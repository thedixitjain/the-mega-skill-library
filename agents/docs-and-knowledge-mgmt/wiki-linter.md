...
source_path: "engineering/llm-wiki/agents/wiki-linter.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/llm-wiki/agents/wiki-linter.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/llm-wiki/agents/wiki-linter.md`
