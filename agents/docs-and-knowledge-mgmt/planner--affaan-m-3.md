...
source_path: "docs/pt-BR/agents/planner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/agents/planner.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/agents/planner.md`
