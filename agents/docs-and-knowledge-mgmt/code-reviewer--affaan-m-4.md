...
source_path: "docs/tr/agents/code-reviewer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/agents/code-reviewer.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/agents/code-reviewer.md`
