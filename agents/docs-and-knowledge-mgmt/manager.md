...
allowed-tools: "Read, Write, Edit, Bash, TodoWrite, AskUserQuestion, Glob, Grep"
model: "sonnet"
category: docs-and-knowledge-mgmt
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/productivity/obsidian-project-documentation/agents/manager.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/productivity/obsidian-project-documentation/agents/manager.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/productivity/obsidian-project-documentation/agents/manager.md`
