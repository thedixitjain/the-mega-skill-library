...
source_path: "docs/zh-TW/agents/doc-updater.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-TW/agents/doc-updater.md
---
# 文件與程式碼地圖專家
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-TW/agents/doc-updater.md`
