...
allowed-tools: "Read, Write, Edit, MultiEdit, Grep, Glob, Bash, LS, Task, mcp__context7__resolve-library-id, mcp__context7__get-library-docs"
model: "haiku"
category: docs-and-knowledge-mgmt
source_repo: lst97/claude-code-sub-agents
source_path: "agents/specialization/documentation-expert.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/specialization/documentation-expert.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/specialization/documentation-expert.md`
