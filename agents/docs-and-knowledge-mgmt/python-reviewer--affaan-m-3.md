...
source_path: "docs/zh-CN/agents/python-reviewer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/agents/python-reviewer.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/agents/python-reviewer.md`
