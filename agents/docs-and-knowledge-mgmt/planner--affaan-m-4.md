...
source_path: "docs/tr/agents/planner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/agents/planner.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/agents/planner.md`
