...
source_path: "docs/tr/agents/docs-lookup.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/agents/docs-lookup.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/agents/docs-lookup.md`
