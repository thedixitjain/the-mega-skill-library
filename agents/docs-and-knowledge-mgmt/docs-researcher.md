...
source_path: "plugins/claude/context7/agents/docs-researcher.md"
source_url: https://github.com/upstash/context7/blob/HEAD/plugins/claude/context7/agents/docs-researcher.md
---
...
**Source:** [`upstash/context7`](https://github.com/upstash/context7) → `plugins/claude/context7/agents/docs-researcher.md`

**Also appears in:** `upstash/context7/plugins/cursor/context7/agents/docs-researcher.md`, `upstash/context7/plugins/copilot/context7/agents/docs-researcher.agent.md`
