...
source_path: "docs/es/agents/doc-updater.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/agents/doc-updater.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/agents/doc-updater.md`
