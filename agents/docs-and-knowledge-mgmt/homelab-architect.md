...
source_path: "docs/ja-JP/agents/homelab-architect.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/agents/homelab-architect.md
---
## プロンプト防御ベースライン
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/agents/homelab-architect.md`
