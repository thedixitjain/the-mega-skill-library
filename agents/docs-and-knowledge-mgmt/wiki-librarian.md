...
source_path: "engineering/llm-wiki/agents/wiki-librarian.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/llm-wiki/agents/wiki-librarian.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/llm-wiki/agents/wiki-librarian.md`
