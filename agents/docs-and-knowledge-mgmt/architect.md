...
source_path: "docs/es/agents/architect.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/agents/architect.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/agents/architect.md`
