...
source_path: "docs/zh-CN/agents/rust-build-resolver.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/agents/rust-build-resolver.md
---
# Rust 构建错误解决器
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/agents/rust-build-resolver.md`
