...
source_path: "docs/pt-BR/agents/build-error-resolver.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/agents/build-error-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/agents/build-error-resolver.md`
