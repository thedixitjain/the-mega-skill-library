...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/documentation-generation/agents/api-documenter.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/documentation-generation/agents/api-documenter.md`

**Also appears in:** `wshobson/agents/plugins/api-testing-observability/agents/api-documenter.md`
