...
allowed-tools: "task sem_search fs_search read write undo remove patch multi_patch shell fetch skill todo_write todo_read mcp_*"
category: productivity-and-workflow
source_repo: tailcallhq/forgecode
source_path: "crates/forge_repo/src/agents/forge.md"
source_url: https://github.com/tailcallhq/forgecode/blob/HEAD/crates/forge_repo/src/agents/forge.md
---
...
**Source:** [`tailcallhq/forgecode`](https://github.com/tailcallhq/forgecode) → `crates/forge_repo/src/agents/forge.md`
