...
source_path: ".claude/agents/unity-shader-specialist.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/.claude/agents/unity-shader-specialist.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `.claude/agents/unity-shader-specialist.md`
