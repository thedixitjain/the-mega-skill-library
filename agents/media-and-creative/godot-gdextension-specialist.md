...
source_path: ".claude/agents/godot-gdextension-specialist.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/.claude/agents/godot-gdextension-specialist.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `.claude/agents/godot-gdextension-specialist.md`
