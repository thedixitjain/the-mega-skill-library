---
name: powerpoint-template-blueprint-guide
description: "This guide explains how to create a PPTX template that allows the Presentation Expert Agent to generate flawless slides with less manual adjustment."
category: media-and-creative
source_repo: google/adk-samples
source_path: "python/agents/brand-aligned-presentations/docs/pptx_template_guide.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/python/agents/brand-aligned-presentations/docs/pptx_template_guide.md
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `python/agents/brand-aligned-presentations/docs/pptx_template_guide.md`
