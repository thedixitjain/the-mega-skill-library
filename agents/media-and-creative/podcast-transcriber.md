...
source_path: "plugins/all-agents/agents/podcast-transcriber.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/podcast-transcriber.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/podcast-transcriber.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-media-content/agents/podcast-transcriber.md`
