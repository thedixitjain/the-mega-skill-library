---
name: graphify-reference-transcribe-video-and-audio
description: "Load this only when detect reported one or more video files. A corpus with no video never reads this."
category: media-and-creative
source_repo: Graphify-Labs/graphify
source_path: "graphify/skills/agents/references/transcribe.md"
source_url: https://github.com/Graphify-Labs/graphify/blob/HEAD/graphify/skills/agents/references/transcribe.md
---
...
**Source:** [`Graphify-Labs/graphify`](https://github.com/Graphify-Labs/graphify) → `graphify/skills/agents/references/transcribe.md`
