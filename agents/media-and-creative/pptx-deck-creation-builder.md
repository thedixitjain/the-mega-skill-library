...
source_path: "plugins/pptx-deck-creation/agents/pptx-deck-creation-builder.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/pptx-deck-creation/agents/pptx-deck-creation-builder.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/pptx-deck-creation/agents/pptx-deck-creation-builder.md`
