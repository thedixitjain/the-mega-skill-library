...
allowed-tools: "Read, Write, Grep, Bash, MultiEdit, TodoWrite"
category: testing-and-qa
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/test-results-analyzer/agents/test-results-analyzer.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/test-results-analyzer/agents/test-results-analyzer.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/test-results-analyzer/agents/test-results-analyzer.md`
