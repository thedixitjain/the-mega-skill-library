...
source_path: "examples/agents/codex-qa-tester.md"
source_url: https://github.com/Waishnav/devspace/blob/HEAD/examples/agents/codex-qa-tester.md
---
...
**Source:** [`Waishnav/devspace`](https://github.com/Waishnav/devspace) → `examples/agents/codex-qa-tester.md`
