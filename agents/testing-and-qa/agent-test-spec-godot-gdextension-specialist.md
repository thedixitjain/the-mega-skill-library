---
name: agent-test-spec-godot-gdextension-specialist
description: "Domain: GDExtension API, godot-cpp C++ bindings, godot-rust bindings, native library integration, and native performance optimization. Does NOT own: GDScript code (gdscript-specialist), shader code (godot-shader-specialist). Model tier: Sonnet (default). No gate IDs assigned."
category: testing-and-qa
source_repo: Donchitos/Claude-Code-Game-Studios
source_path: "CCGS Skill Testing Framework/agents/engine/godot/godot-gdextension-specialist.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/CCGS Skill Testing Framework/agents/engine/godot/godot-gdextension-specialist.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `CCGS Skill Testing Framework/agents/engine/godot/godot-gdextension-specialist.md`
