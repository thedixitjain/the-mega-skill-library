---
name: agent-test-spec-technical-director
description: "Domain owned: System architecture decisions, technical feasibility assessment, ADR oversight and approval, engine risk evaluation, technical phase gate. Does NOT own: Game design decisions (creative-director / game-designer), creative direction, visual art style, production scheduling (producer). Model tier: Opus (multi-document synthesis, high-stakes architecture and phase gate verdicts)."
category: testing-and-qa
source_repo: Donchitos/Claude-Code-Game-Studios
source_path: "CCGS Skill Testing Framework/agents/directors/technical-director.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/CCGS Skill Testing Framework/agents/directors/technical-director.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `CCGS Skill Testing Framework/agents/directors/technical-director.md`
