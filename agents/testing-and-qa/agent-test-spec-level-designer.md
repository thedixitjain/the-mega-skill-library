---
name: agent-test-spec-level-designer
description: "Domain owned: Level layouts, encounter design, pacing and tension arc, environmental storytelling, spatial puzzles. Does NOT own: Narrative dialogue (writer / narrative-director), visual art style (art-director), code implementation (lead-programmer / ai-programmer), enemy AI behavior logic (ai-programmer / gameplay-programmer). Model tier: Sonnet (individual system analysis — level design review and encounter assessment)."
category: testing-and-qa
source_repo: Donchitos/Claude-Code-Game-Studios
source_path: "CCGS Skill Testing Framework/agents/leads/level-designer.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/CCGS Skill Testing Framework/agents/leads/level-designer.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `CCGS Skill Testing Framework/agents/leads/level-designer.md`
