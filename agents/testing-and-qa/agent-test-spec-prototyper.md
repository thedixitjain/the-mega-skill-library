---
name: agent-test-spec-prototyper
description: "- Domain: Rapid throwaway prototypes in the prototypes/ directory, concept validation experiments, mechanical feasibility tests. Standards intentionally relaxed for speed — prototypes are not production code. - Does NOT own: Production source code in src/ (gameplay-programmer), design documents (game-designer), production-grade architecture decisions (lead-programmer / technical-director)"
category: testing-and-qa
source_repo: Donchitos/Claude-Code-Game-Studios
source_path: "CCGS Skill Testing Framework/agents/specialists/prototyper.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/CCGS Skill Testing Framework/agents/specialists/prototyper.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `CCGS Skill Testing Framework/agents/specialists/prototyper.md`
