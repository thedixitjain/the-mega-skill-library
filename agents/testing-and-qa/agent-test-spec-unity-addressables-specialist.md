---
name: agent-test-spec-unity-addressables-specialist
description: "Domain: Addressable Asset System — groups, async loading/unloading, handle lifecycle management, memory budgeting, content catalogs, and remote content delivery. Does NOT own: rendering systems (engine-programmer), game logic that uses the loaded assets (gameplay-programmer). Model tier: Sonnet (default). No gate IDs assigned."
category: testing-and-qa
source_repo: Donchitos/Claude-Code-Game-Studios
source_path: "CCGS Skill Testing Framework/agents/engine/unity/unity-addressables-specialist.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/CCGS Skill Testing Framework/agents/engine/unity/unity-addressables-specialist.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `CCGS Skill Testing Framework/agents/engine/unity/unity-addressables-specialist.md`
