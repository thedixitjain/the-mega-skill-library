...
source_path: "docs/tr/agents/e2e-runner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/agents/e2e-runner.md
---
# E2E Test Runner
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/agents/e2e-runner.md`
