...
source_path: "docs/zh-CN/agents/e2e-runner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/agents/e2e-runner.md
---
# E2E 测试运行器
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/agents/e2e-runner.md`
