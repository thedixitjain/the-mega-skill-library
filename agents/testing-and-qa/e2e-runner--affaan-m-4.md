...
source_path: "docs/ko-KR/agents/e2e-runner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/agents/e2e-runner.md
---
# E2E 테스트 러너
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/agents/e2e-runner.md`
