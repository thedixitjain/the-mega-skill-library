...
source_path: "agents/quality-testing/test-automator.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/quality-testing/test-automator.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/quality-testing/test-automator.md`
