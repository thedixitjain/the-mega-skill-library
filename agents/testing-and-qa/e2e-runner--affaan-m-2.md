...
source_path: "docs/es/agents/e2e-runner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/agents/e2e-runner.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/agents/e2e-runner.md`
