...
source_path: "plugins/backend-development/agents/test-automator.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/backend-development/agents/test-automator.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/backend-development/agents/test-automator.md`
