...
source_path: "plugins/all-agents/agents/test-automator.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/test-automator.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/test-automator.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-quality-security/agents/test-automator.md`
