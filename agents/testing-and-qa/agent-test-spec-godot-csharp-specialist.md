---
name: agent-test-spec-godot-csharp-specialist
description: "Domain: C# patterns in Godot 4, .NET idioms applied to Godot, [Export] attribute usage, signal delegates, and async/await patterns. Does NOT own: GDScript code (gdscript-specialist), GDExtension C/C++ bindings (gdextension-specialist). Model tier: Sonnet (default). No gate IDs assigned."
category: testing-and-qa
source_repo: Donchitos/Claude-Code-Game-Studios
source_path: "CCGS Skill Testing Framework/agents/engine/godot/godot-csharp-specialist.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/CCGS Skill Testing Framework/agents/engine/godot/godot-csharp-specialist.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `CCGS Skill Testing Framework/agents/engine/godot/godot-csharp-specialist.md`
