...
source_path: "agents/test-engineer.md"
source_url: https://github.com/addyosmani/agent-skills/blob/HEAD/agents/test-engineer.md
---
# Test Engineer
...
**Source:** [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills) → `agents/test-engineer.md`
