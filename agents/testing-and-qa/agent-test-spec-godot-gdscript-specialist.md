---
name: agent-test-spec-godot-gdscript-specialist
description: "Domain: GDScript static typing, design patterns in GDScript, signal architecture, coroutine/await patterns, and GDScript performance. Does NOT own: shader code (godot-shader-specialist), GDExtension bindings (godot-gdextension-specialist). Model tier: Sonnet (default). No gate IDs assigned."
category: testing-and-qa
source_repo: Donchitos/Claude-Code-Game-Studios
source_path: "CCGS Skill Testing Framework/agents/engine/godot/godot-gdscript-specialist.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/CCGS Skill Testing Framework/agents/engine/godot/godot-gdscript-specialist.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `CCGS Skill Testing Framework/agents/engine/godot/godot-gdscript-specialist.md`
