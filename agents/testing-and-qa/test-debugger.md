...
allowed-tools: "Read Grep Glob LS Bash(npx playwright test *) Bash(npx playwright show-trace *) Bash(npx playwright codegen *) Bash(node *) Bash(npm test *) Bash(npm run *)"
model: "inherit"
category: testing-and-qa
source_repo: alirezarezvani/claude-skills
source_path: "engineering-team/playwright-pro/agents/test-debugger.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering-team/playwright-pro/agents/test-debugger.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering-team/playwright-pro/agents/test-debugger.md`
