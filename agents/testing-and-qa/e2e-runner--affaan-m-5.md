...
source_path: "docs/pt-BR/agents/e2e-runner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/pt-BR/agents/e2e-runner.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/pt-BR/agents/e2e-runner.md`
