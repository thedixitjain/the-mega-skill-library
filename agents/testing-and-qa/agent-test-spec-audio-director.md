---
name: agent-test-spec-audio-director
description: "Domain owned: Music direction and palette, sound design philosophy, audio implementation strategy, mix balance, audio aspects of phase gates. Does NOT own: Visual design (art-director), code implementation (lead-programmer), narrative story content (narrative-director), UX interaction flows (ux-designer). Model tier: Sonnet (individual system analysis — audio direction and spec review). Gate IDs handled: AD-VISUAL (audio aspect of the phase gate; may be referenced as part of AD-PHASE-GATE in the audio dimension)."
category: testing-and-qa
source_repo: Donchitos/Claude-Code-Game-Studios
source_path: "CCGS Skill Testing Framework/agents/leads/audio-director.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/CCGS Skill Testing Framework/agents/leads/audio-director.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `CCGS Skill Testing Framework/agents/leads/audio-director.md`
