...
source_path: "plugins/ship-mate/agents/qa.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/ship-mate/agents/qa.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/ship-mate/agents/qa.md`
