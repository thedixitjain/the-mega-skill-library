...
source_path: "plugins/testing/mutation-test-runner/agents/mutation-tester.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/mutation-test-runner/agents/mutation-tester.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/mutation-test-runner/agents/mutation-tester.md`
