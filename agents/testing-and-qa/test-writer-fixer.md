...
source_path: "plugins/test-writer-fixer/agents/test-writer-fixer.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/test-writer-fixer/agents/test-writer-fixer.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/test-writer-fixer/agents/test-writer-fixer.md`
