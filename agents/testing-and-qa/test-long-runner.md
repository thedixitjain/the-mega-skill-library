...
source_path: ".claude/agents/custom/test-long-runner.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/custom/test-long-runner.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/custom/test-long-runner.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/custom/test-long-runner.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/custom/test-long-runner.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/custom/test-long-runner.md`
