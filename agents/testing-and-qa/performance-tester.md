...
source_path: "plugins/testing/performance-test-suite/agents/performance-tester.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/performance-test-suite/agents/performance-tester.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/performance-test-suite/agents/performance-tester.md`
