...
source_path: "plugins/finance-tracker/agents/finance-tracker.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/finance-tracker/agents/finance-tracker.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/finance-tracker/agents/finance-tracker.md`
