...
source_path: "plugins/business-tools/general-legal-assistant/agents/legal-risks.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/business-tools/general-legal-assistant/agents/legal-risks.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/business-tools/general-legal-assistant/agents/legal-risks.md`
