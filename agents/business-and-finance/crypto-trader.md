...
source_path: "plugins/all-agents/agents/crypto-trader.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/crypto-trader.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/crypto-trader.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-crypto-trading/agents/crypto-trader.md`
