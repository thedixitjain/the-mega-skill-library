...
source_path: "agents/c-level/cs-cto-advisor.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/agents/c-level/cs-cto-advisor.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `agents/c-level/cs-cto-advisor.md`
