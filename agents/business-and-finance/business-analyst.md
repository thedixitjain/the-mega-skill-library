...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/business-analytics/agents/business-analyst.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/business-analytics/agents/business-analyst.md`
