...
source_path: "plugins/business-tools/openbb-terminal/agents/equity-analyst.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/business-tools/openbb-terminal/agents/equity-analyst.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/business-tools/openbb-terminal/agents/equity-analyst.md`
