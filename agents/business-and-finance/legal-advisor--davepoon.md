...
source_path: "plugins/all-agents/agents/legal-advisor.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/legal-advisor.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/legal-advisor.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-business-finance/agents/legal-advisor.md`
