...
source_path: "plugins/all-agents/agents/sales-automator.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/sales-automator.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/sales-automator.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-sales-marketing/agents/sales-automator.md`
