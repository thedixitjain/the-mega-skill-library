...
allowed-tools: "Read, Write, MultiEdit, WebSearch, Grep, Glob"
category: business-and-finance
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/product-sales-specialist/agents/product-sales-specialist.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/product-sales-specialist/agents/product-sales-specialist.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/product-sales-specialist/agents/product-sales-specialist.md`
