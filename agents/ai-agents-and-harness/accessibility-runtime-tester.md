...
source_path: "agents/accessibility-runtime-tester.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/accessibility-runtime-tester.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/accessibility-runtime-tester.agent.md`
