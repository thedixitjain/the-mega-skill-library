...
allowed-tools: "Read, Grep, Glob, Bash, Bash(git status:*)"
category: ai-agents-and-harness
source_repo: anthropics/claude-cookbooks
source_path: ".claude/agents/code-reviewer.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/.claude/agents/code-reviewer.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `.claude/agents/code-reviewer.md`
