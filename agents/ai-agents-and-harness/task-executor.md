...
allowed-tools: "mcp__runapi__create_task, mcp__runapi__get_task"
model: "inherit"
category: ai-agents-and-harness
source_repo: wshobson/agents
source_path: "plugins/runapi-mcp/agents/task-executor.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/runapi-mcp/agents/task-executor.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/runapi-mcp/agents/task-executor.md`
