---
name: style-advisor-agent-design-document
description: "Users need help composing complete, coherent outfits from the product catalog. Today the system can search for individual items, but there's no intelligence around: - Outfit composition — selecting multiple pieces that work together - Occasion awareness — a beach outfit shouldn't include boots - Style consistency — all pieces should share a style register (casual, formal, sporty) - Color harmony — avoiding clashing combinations"
category: ai-agents-and-harness
source_repo: google/adk-samples
source_path: "core/python/genmedia-for-commerce/genmedia4commerce/agents/style_advisor_agent/STYLE_ADVISOR_DESIGN.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/core/python/genmedia-for-commerce/genmedia4commerce/agents/style_advisor_agent/STYLE_ADVISOR_DESIGN.md
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `core/python/genmedia-for-commerce/genmedia4commerce/agents/style_advisor_agent/STYLE_ADVISOR_DESIGN.md`

**Also appears in:** `google/adk-samples/python/agents/genmedia-for-commerce/genmedia4commerce/agents/style_advisor_agent/STYLE_ADVISOR_DESIGN.md`
