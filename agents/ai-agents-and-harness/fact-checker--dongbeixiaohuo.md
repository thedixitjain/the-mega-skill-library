...
source_path: "claude-runtime/agents/fact-checker.md"
source_url: https://github.com/dongbeixiaohuo/writing-agent/blob/HEAD/claude-runtime/agents/fact-checker.md
---
...
**Source:** [`dongbeixiaohuo/writing-agent`](https://github.com/dongbeixiaohuo/writing-agent) → `claude-runtime/agents/fact-checker.md`
