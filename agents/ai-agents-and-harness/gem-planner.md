...
source_path: "agents/gem-planner.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-planner.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-planner.agent.md`
