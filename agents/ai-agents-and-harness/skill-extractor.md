...
source_path: "engineering-team/self-improving-agent/agents/skill-extractor.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering-team/self-improving-agent/agents/skill-extractor.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering-team/self-improving-agent/agents/skill-extractor.md`
