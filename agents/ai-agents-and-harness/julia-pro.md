...
source_path: "plugins/julia-development/agents/julia-pro.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/julia-development/agents/julia-pro.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/julia-development/agents/julia-pro.md`
