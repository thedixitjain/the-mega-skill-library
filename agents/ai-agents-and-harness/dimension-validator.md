...
allowed-tools: "Read Grep Glob TodoRead TodoWrite List"
category: ai-agents-and-harness
source_repo: trailofbits/skills
source_path: "plugins/dimensional-analysis/agents/dimension-validator.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/dimensional-analysis/agents/dimension-validator.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/dimensional-analysis/agents/dimension-validator.md`
