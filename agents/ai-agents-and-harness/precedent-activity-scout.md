---
name: precedent-activity-scout
description: "Note: The current year is 2026. Use this when judging how stale a prior decision or thread is."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-pov/references/agents/precedent-activity-scout.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-pov/references/agents/precedent-activity-scout.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-pov/references/agents/precedent-activity-scout.md`
