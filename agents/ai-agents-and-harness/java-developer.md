...
source_path: "plugins/all-agents/agents/java-developer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/java-developer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/java-developer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-language-specialists/agents/java-developer.md`
