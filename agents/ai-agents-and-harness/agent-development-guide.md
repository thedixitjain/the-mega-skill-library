...
description: "This guide provides comprehensive instructions for creating cs- prefixed agents that seamlessly integrate with the 346 production skills in this repository (count derived via scripts/derivecounters.py)."
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "agents/CLAUDE.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/agents/CLAUDE.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `agents/CLAUDE.md`
