...
source_path: "plugins/crypto/crypto-derivatives-tracker/agents/derivatives-agent.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/crypto-derivatives-tracker/agents/derivatives-agent.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/crypto-derivatives-tracker/agents/derivatives-agent.md`
