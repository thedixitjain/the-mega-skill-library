...
source_path: "plugins/support-responder/agents/support-responder.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/support-responder/agents/support-responder.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/support-responder/agents/support-responder.md`
