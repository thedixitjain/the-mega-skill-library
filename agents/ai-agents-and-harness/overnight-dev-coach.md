...
source_path: "plugins/productivity/overnight-dev/agents/overnight-dev-coach.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/productivity/overnight-dev/agents/overnight-dev-coach.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/productivity/overnight-dev/agents/overnight-dev-coach.md`
