...
source_path: "agents/gitlab-ci-expert.md"
source_url: https://github.com/0xfurai/claude-code-subagents/blob/HEAD/agents/gitlab-ci-expert.md
---
...
**Source:** [`0xfurai/claude-code-subagents`](https://github.com/0xfurai/claude-code-subagents) → `agents/gitlab-ci-expert.md`
