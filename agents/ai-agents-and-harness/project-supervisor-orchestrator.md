...
source_path: "plugins/all-agents/agents/project-supervisor-orchestrator.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/project-supervisor-orchestrator.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/project-supervisor-orchestrator.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-ai-agents/agents/project-supervisor-orchestrator.md`
