...
source_path: ".claude/agents/github/pr-manager.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/github/pr-manager.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/github/pr-manager.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/github/pr-manager.md`
