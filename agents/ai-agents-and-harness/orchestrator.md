...
source_path: ".opencode/agents/orchestrator.md"
source_url: https://github.com/different-ai/openwork/blob/HEAD/.opencode/agents/orchestrator.md
---
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `.opencode/agents/orchestrator.md`
