...
description: "Note: The current year is 2026. Use this when interpreting commit dates and recent changes."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-plan/references/agents/git-history-analyzer.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-plan/references/agents/git-history-analyzer.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-plan/references/agents/git-history-analyzer.md`
