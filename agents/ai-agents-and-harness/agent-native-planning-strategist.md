---
name: agent-native-planning-strategist
description: "You are an agent-native planning strategist. Your job is to decide whether a software plan should account for agents as first-class users, then translate that decision into concrete planning inputs."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-plan/references/agents/agent-native-planning-strategist.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-plan/references/agents/agent-native-planning-strategist.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-plan/references/agents/agent-native-planning-strategist.md`
