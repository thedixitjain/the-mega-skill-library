...
source_path: "plugins/ruflo-agent/agents/nested-leaf.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-agent/agents/nested-leaf.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-agent/agents/nested-leaf.md`
