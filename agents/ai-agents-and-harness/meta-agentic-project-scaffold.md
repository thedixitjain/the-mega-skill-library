...
source_path: "agents/meta-agentic-project-scaffold.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/meta-agentic-project-scaffold.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/meta-agentic-project-scaffold.agent.md`
