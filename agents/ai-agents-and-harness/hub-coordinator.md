...
allowed-tools: "Agent, Read, Write, Edit, Glob, Grep, Bash(git worktree *), Bash(git branch *), Bash(git checkout *), Bash(git merge *), Bash(git log *), Bash(git diff *), Bash(git status *), Bash(python *), Bash(mkdir *), Bash(ls *), Bash(cat *)"
model: "inherit"
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "engineering/agenthub/agents/hub-coordinator.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/agenthub/agents/hub-coordinator.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/agenthub/agents/hub-coordinator.md`
