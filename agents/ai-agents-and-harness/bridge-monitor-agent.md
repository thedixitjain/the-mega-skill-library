...
allowed-tools: "Grep WebFetch WebSearch"
model: "sonnet"
category: ai-agents-and-harness
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/crypto/cross-chain-bridge-monitor/agents/bridge-monitor-agent.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/cross-chain-bridge-monitor/agents/bridge-monitor-agent.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/cross-chain-bridge-monitor/agents/bridge-monitor-agent.md`
