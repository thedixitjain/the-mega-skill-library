...
source_path: "plugins/all-agents/agents/task-decomposition-expert.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/task-decomposition-expert.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/task-decomposition-expert.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-data-ai/agents/task-decomposition-expert.md`
