...
allowed-tools: "['codebase', 'edit/editFiles', 'search']"
model: "GPT-5"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/se-responsible-ai-code.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/se-responsible-ai-code.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/se-responsible-ai-code.agent.md`
