...
source_path: "agents/development/golang-pro.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/development/golang-pro.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/development/golang-pro.md`
