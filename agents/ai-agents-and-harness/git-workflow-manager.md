...
source_path: "agents/developer-experience/git-workflow-manager.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/agents/developer-experience/git-workflow-manager.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `agents/developer-experience/git-workflow-manager.md`
