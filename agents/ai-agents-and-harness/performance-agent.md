...
source_path: "plugins/database/query-performance-analyzer/agents/performance-agent.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/database/query-performance-analyzer/agents/performance-agent.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/database/query-performance-analyzer/agents/performance-agent.md`
