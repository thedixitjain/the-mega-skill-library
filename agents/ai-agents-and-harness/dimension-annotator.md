...
allowed-tools: "Read Write Grep List Glob TodoRead TodoWrite Edit"
category: ai-agents-and-harness
source_repo: trailofbits/skills
source_path: "plugins/dimensional-analysis/agents/dimension-annotator.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/dimensional-analysis/agents/dimension-annotator.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/dimensional-analysis/agents/dimension-annotator.md`
