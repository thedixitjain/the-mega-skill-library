---
name: tour-builder
description: "| Designs guided learning tours through codebases, creating 5-15 pedagogical steps that teach project architecture and key concepts in logical order."
category: ai-agents-and-harness
source_repo: Egonex-AI/Understand-Anything
source_path: "understand-anything-plugin/agents/tour-builder.md"
source_url: https://github.com/Egonex-AI/Understand-Anything/blob/HEAD/understand-anything-plugin/agents/tour-builder.md
---
...
**Source:** [`Egonex-AI/Understand-Anything`](https://github.com/Egonex-AI/Understand-Anything) → `understand-anything-plugin/agents/tour-builder.md`
