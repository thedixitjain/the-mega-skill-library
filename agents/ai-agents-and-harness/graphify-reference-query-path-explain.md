---
name: graphify-reference-query-path-explain
description: "Load this when the user asks a question against an existing graph, or runs /graphify path or /graphify explain. The core's query stub points here for the full traversal flow. These flows use the graphify query CLI when it is available and fall back to an inline NetworkX traversal otherwise."
category: ai-agents-and-harness
source_repo: Graphify-Labs/graphify
source_path: "graphify/skills/agents/references/query.md"
source_url: https://github.com/Graphify-Labs/graphify/blob/HEAD/graphify/skills/agents/references/query.md
---
...
**Source:** [`Graphify-Labs/graphify`](https://github.com/Graphify-Labs/graphify) → `graphify/skills/agents/references/query.md`
