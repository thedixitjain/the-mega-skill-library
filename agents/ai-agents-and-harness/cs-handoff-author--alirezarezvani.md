...
source_path: "productivity/handoff/agents/cs-handoff-author.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/productivity/handoff/agents/cs-handoff-author.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `productivity/handoff/agents/cs-handoff-author.md`
