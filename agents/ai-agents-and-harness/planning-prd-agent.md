...
source_path: "plugins/planning-prd-agent/agents/planning-prd-agent.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/planning-prd-agent/agents/planning-prd-agent.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/planning-prd-agent/agents/planning-prd-agent.md`
