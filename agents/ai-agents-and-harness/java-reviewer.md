...
source_path: ".kiro/agents/java-reviewer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.kiro/agents/java-reviewer.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.kiro/agents/java-reviewer.md`
