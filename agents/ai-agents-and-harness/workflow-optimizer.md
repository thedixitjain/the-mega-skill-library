...
allowed-tools: "Read, Write, Bash, TodoWrite, MultiEdit, Grep"
category: ai-agents-and-harness
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/workflow-optimizer/agents/workflow-optimizer.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/workflow-optimizer/agents/workflow-optimizer.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/workflow-optimizer/agents/workflow-optimizer.md`
