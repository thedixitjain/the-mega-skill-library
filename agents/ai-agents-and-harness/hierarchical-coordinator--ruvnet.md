...
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/swarm/hierarchical-coordinator.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/swarm/hierarchical-coordinator.md`
