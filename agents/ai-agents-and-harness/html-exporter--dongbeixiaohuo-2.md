...
source_path: "plugins/writing-agent/agents/html-exporter.md"
source_url: https://github.com/dongbeixiaohuo/writing-agent/blob/HEAD/plugins/writing-agent/agents/html-exporter.md
---
...
**Source:** [`dongbeixiaohuo/writing-agent`](https://github.com/dongbeixiaohuo/writing-agent) → `plugins/writing-agent/agents/html-exporter.md`
