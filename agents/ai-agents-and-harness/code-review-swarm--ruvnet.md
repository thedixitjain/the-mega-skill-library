...
allowed-tools: "mcp__claude-flow__swarm_init, mcp__claude-flow__agent_spawn, mcp__claude-flow__task_orchestrate, Bash, Read, Write, TodoWrite"
category: ai-agents-and-harness
source_repo: ruvnet/ruflo
source_path: ".claude/agents/github/code-review-swarm.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/github/code-review-swarm.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/github/code-review-swarm.md`

**Also appears in:** `ruvnet/ruflo/.claude/commands/github/code-review-swarm.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/github/code-review-swarm.md`
