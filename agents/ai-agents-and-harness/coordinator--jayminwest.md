---
name: coordinator
description: "Receive the objective. Execute immediately. Do not ask for confirmation, do not propose a plan and wait for approval, do not summarize back what you were told. Start analyzing the codebase and creating issues within your first tool calls. The human gave you work because they want it done, not discussed."
category: ai-agents-and-harness
source_repo: jayminwest/overstory
source_path: "agents/coordinator.md"
source_url: https://github.com/jayminwest/overstory/blob/HEAD/agents/coordinator.md
---
...
**Source:** [`jayminwest/overstory`](https://github.com/jayminwest/overstory) → `agents/coordinator.md`
