---
name: eu-ai-act-compliance-agent
...
source_path: "docs/agents/cs-ai-act-compliance.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-ai-act-compliance.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-ai-act-compliance.md`
