...
allowed-tools: "Read mcp__umami__get_websites mcp__umami__get_active mcp__umami__get_stats mcp__umami__get_pageviews mcp__umami__get_metrics mcp__umami__get_events"
model: "sonnet"
category: ai-agents-and-harness
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/analytics/web-analytics/agents/data-collector.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/analytics/web-analytics/agents/data-collector.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/analytics/web-analytics/agents/data-collector.md`
