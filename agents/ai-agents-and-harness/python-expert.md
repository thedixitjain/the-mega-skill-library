...
source_path: "plugins/all-agents/agents/python-expert.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/python-expert.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/python-expert.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-language-specialists/agents/python-expert.md`
