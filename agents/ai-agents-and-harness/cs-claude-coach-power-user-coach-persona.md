---
name: cs-claude-coach-power-user-coach-persona
...
source_path: "docs/agents/cs-claude-coach.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-claude-coach.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-claude-coach.md`
