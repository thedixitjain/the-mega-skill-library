...
source_path: "plugins/crypto/flash-loan-simulator/agents/flashloan-agent.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/flash-loan-simulator/agents/flashloan-agent.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/flash-loan-simulator/agents/flashloan-agent.md`
