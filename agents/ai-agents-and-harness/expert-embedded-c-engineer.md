...
allowed-tools: "['edit/editFiles', 'search/codebase', 'search/usages', 'execute/runInTerminal', 'read/terminalLastCommand', 'read/terminalSelection', 'read/problems', 'web/fetch']"
model: "claude-sonnet-4"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/expert-embedded-c-engineer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/expert-embedded-c-engineer.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/expert-embedded-c-engineer.agent.md`
