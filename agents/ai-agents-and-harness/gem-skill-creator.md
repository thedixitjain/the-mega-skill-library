...
source_path: "agents/gem-skill-creator.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-skill-creator.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-skill-creator.agent.md`
