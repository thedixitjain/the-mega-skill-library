...
source_path: "agents/gem-reviewer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-reviewer.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-reviewer.agent.md`
