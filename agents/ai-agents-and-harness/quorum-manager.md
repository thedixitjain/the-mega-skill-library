...
source_path: ".claude/agents/consensus/quorum-manager.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/consensus/quorum-manager.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/consensus/quorum-manager.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/consensus/quorum-manager.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/consensus/quorum-manager.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/consensus/quorum-manager.md`
