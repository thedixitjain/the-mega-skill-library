...
source_path: "plugins/project-curator/agents/project-curator.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/project-curator/agents/project-curator.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/project-curator/agents/project-curator.md`
