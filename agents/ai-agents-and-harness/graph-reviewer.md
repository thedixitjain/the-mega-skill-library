---
name: graph-reviewer
description: "| Validates knowledge graphs for correctness, completeness, and quality. Runs systematic checks and renders approval or rejection decisions."
category: ai-agents-and-harness
source_repo: Egonex-AI/Understand-Anything
source_path: "understand-anything-plugin/agents/graph-reviewer.md"
source_url: https://github.com/Egonex-AI/Understand-Anything/blob/HEAD/understand-anything-plugin/agents/graph-reviewer.md
---
...
**Source:** [`Egonex-AI/Understand-Anything`](https://github.com/Egonex-AI/Understand-Anything) → `understand-anything-plugin/agents/graph-reviewer.md`
