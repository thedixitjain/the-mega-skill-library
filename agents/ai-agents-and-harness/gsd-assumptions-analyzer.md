...
source_path: "plugins/gsd/agents/gsd-assumptions-analyzer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/gsd/agents/gsd-assumptions-analyzer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/gsd/agents/gsd-assumptions-analyzer.md`
