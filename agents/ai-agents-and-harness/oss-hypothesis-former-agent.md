...
source_path: ".claude/agents/oss-hypothesis-former-agent.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/.claude/agents/oss-hypothesis-former-agent.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `.claude/agents/oss-hypothesis-former-agent.md`
