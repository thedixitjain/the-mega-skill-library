---
name: vision-probe-read-only
description: "You are a read-only capability probe spawned before a design task tries to read or inspect screenshots. Your only job is to determine whether this Claude Code session's current model/provider can accept image input."
category: ai-agents-and-harness
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/zlsbksdxl/codex-lark/skills/lark-apps/creative-design/agents/vision-probe-agent.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/zlsbksdxl/codex-lark/skills/lark-apps/creative-design/agents/vision-probe-agent.md
---
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/zlsbksdxl/codex-lark/skills/lark-apps/creative-design/agents/vision-probe-agent.md`
