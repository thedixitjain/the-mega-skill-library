---
name: graphify-reference-incremental-update-and-cluster-only
description: "Load this only when the user passed --update or --cluster-only. A first-time full build never reads this file."
category: ai-agents-and-harness
source_repo: Graphify-Labs/graphify
source_path: "graphify/skills/agents/references/update.md"
source_url: https://github.com/Graphify-Labs/graphify/blob/HEAD/graphify/skills/agents/references/update.md
---
...
**Source:** [`Graphify-Labs/graphify`](https://github.com/Graphify-Labs/graphify) → `graphify/skills/agents/references/update.md`
