---
name: project-grounding-scout
description: "Note: The current year is 2026. Use this when judging how recent a file or commit is."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-pov/references/agents/project-grounding-scout.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-pov/references/agents/project-grounding-scout.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-pov/references/agents/project-grounding-scout.md`
