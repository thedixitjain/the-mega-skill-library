...
source_path: ".claude/agents/coder-reviewer.md"
source_url: https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/HEAD/.claude/agents/coder-reviewer.md
---
...
**Source:** [`wesammustafa/Claude-Code-Everything-You-Need-to-Know`](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know) → `.claude/agents/coder-reviewer.md`
