...
source_path: "agents/language-experts/python-engineer.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/agents/language-experts/python-engineer.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `agents/language-experts/python-engineer.md`
