...
source_path: "agents/apify-integration-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/apify-integration-expert.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/apify-integration-expert.agent.md`
