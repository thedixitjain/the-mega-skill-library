...
allowed-tools: "[ \"changes\", \"codebase\", \"editFiles\", \"extensions\", \"fetch\", \"findTestFiles\", \"githubRepo\", \"new\", \"openSimpleBrowser\", \"problems\", \"runCommands\", \"runTasks\", \"runTests\", \"search\", \"searchResults\", \"terminalLastCommand\", \"terminalSelection\", \"testFailure\", \"usages\", \"vscodeAPI\", \"microsoft.docs.mcp\", \"github\" ]"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/address-comments.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/address-comments.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/address-comments.agent.md`
