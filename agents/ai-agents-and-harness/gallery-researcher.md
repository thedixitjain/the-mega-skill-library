...
allowed-tools: "mcp__meigen__search_gallery, mcp__meigen__get_inspiration"
model: "haiku"
category: ai-agents-and-harness
source_repo: wshobson/agents
source_path: "plugins/meigen-ai-design/agents/gallery-researcher.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/meigen-ai-design/agents/gallery-researcher.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/meigen-ai-design/agents/gallery-researcher.md`
