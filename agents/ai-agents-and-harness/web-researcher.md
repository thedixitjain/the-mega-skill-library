---
name: web-researcher
description: "Note: The current year is 2026. Use this when assessing the recency and relevance of external sources."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-ideate/references/agents/web-researcher.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-ideate/references/agents/web-researcher.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-ideate/references/agents/web-researcher.md`
