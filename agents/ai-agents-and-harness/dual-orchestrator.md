...
source_path: ".claude/agents/dual-mode/dual-orchestrator.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/dual-mode/dual-orchestrator.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/dual-mode/dual-orchestrator.md`
