...
source_path: "plugins/incident-response/agents/debugger.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/incident-response/agents/debugger.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/incident-response/agents/debugger.md`
