---
name: vp-of-engineering-advisor-agent
...
source_path: "docs/agents/cs-vpe-advisor.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-vpe-advisor.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-vpe-advisor.md`
