---
name: agent-file-templates
description: "Complete code templates for each file in a Hive agent package."
category: ai-agents-and-harness
source_repo: aden-hive/hive
source_path: "core/framework/agents/queen/reference/file_templates.md"
source_url: https://github.com/aden-hive/hive/blob/HEAD/core/framework/agents/queen/reference/file_templates.md
---
...
**Source:** [`aden-hive/hive`](https://github.com/aden-hive/hive) → `core/framework/agents/queen/reference/file_templates.md`
