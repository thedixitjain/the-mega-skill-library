...
source_path: "agents/specialized-domains/media-streaming.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/agents/specialized-domains/media-streaming.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `agents/specialized-domains/media-streaming.md`
