...
source_path: "Anthropic/Claude Code/agents/statusline-setup.md"
source_url: https://github.com/asgeirtj/system_prompts_leaks/blob/HEAD/Anthropic/Claude Code/agents/statusline-setup.md
---
...
**Source:** [`asgeirtj/system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks) → `Anthropic/Claude Code/agents/statusline-setup.md`
