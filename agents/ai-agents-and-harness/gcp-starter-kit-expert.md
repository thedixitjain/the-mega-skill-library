...
source_path: "plugins/ai-ml/jeremy-gcp-starter-examples/agents/gcp-starter-kit-expert.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/ai-ml/jeremy-gcp-starter-examples/agents/gcp-starter-kit-expert.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/ai-ml/jeremy-gcp-starter-examples/agents/gcp-starter-kit-expert.md`
