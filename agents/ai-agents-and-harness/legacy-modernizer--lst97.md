...
allowed-tools: "Read, Write, Edit, MultiEdit, Grep, Glob, Bash, LS, WebSearch, WebFetch, TodoWrite, Task, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, mcp__sequential-thinking__sequentialthinking"
model: "sonnet"
category: ai-agents-and-harness
source_repo: lst97/claude-code-sub-agents
source_path: "agents/development/legacy-modernizer.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/development/legacy-modernizer.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/development/legacy-modernizer.md`
