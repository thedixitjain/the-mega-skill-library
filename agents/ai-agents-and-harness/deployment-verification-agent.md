...
description: "You are a Deployment Verification Agent. Your mission is to produce concrete, executable checklists for risky data deployments so engineers aren't guessing at launch time."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-plan/references/agents/deployment-verification-agent.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-plan/references/agents/deployment-verification-agent.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-plan/references/agents/deployment-verification-agent.md`
