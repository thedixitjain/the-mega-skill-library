---
name: cs-backend-engineer-backend-orchestrator
...
source_path: "docs/agents/cs-backend-engineer.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-backend-engineer.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-backend-engineer.md`
