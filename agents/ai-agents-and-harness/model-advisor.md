...
source_path: "plugins/runapi-mcp/agents/model-advisor.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/runapi-mcp/agents/model-advisor.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/runapi-mcp/agents/model-advisor.md`
