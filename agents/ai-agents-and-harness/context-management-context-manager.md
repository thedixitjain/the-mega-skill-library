...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/context-management/agents/context-manager.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/context-management/agents/context-manager.md`

**Also appears in:** `wshobson/agents/plugins/agent-orchestration/agents/context-manager.md`
