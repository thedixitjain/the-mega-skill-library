...
source_path: "plugins/ruflo-agent/agents/nested-reviewer.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-agent/agents/nested-reviewer.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-agent/agents/nested-reviewer.md`
