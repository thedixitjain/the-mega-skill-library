...
source_path: "productivity/email/agents/cs-inbox-triage.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/productivity/email/agents/cs-inbox-triage.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `productivity/email/agents/cs-inbox-triage.md`
