...
source_path: "plugins/analytics/web-analytics/agents/reporting-narrative.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/analytics/web-analytics/agents/reporting-narrative.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/analytics/web-analytics/agents/reporting-narrative.md`
