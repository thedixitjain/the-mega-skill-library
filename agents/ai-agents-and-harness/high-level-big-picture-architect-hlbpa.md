...
allowed-tools: "'search/codebase' 'changes' 'edit/editFiles' 'web/fetch' 'findTestFiles' 'githubRepo' 'runCommands' 'runTests' 'search' 'search/searchResults' 'testFailure' 'usages' 'activePullRequest' 'copilotCodingAgent'"
model: "claude-sonnet-4"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/hlbpa.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/hlbpa.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/hlbpa.agent.md`
