...
source_path: "engineering/claude-coach/agents/cs-claude-coach.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/claude-coach/agents/cs-claude-coach.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/claude-coach/agents/cs-claude-coach.md`
