...
allowed-tools: "Read, Grep, Glob, Bash, LS, WebFetch, WebSearch, Task, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, mcp__sequential-thinking__sequentialthinking"
model: "haiku"
category: ai-agents-and-harness
source_repo: lst97/claude-code-sub-agents
source_path: "agents/quality-testing/code-reviewer.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/quality-testing/code-reviewer.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/quality-testing/code-reviewer.md`
