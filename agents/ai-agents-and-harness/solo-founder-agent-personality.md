---
name: solo-founder-agent-personality
...
source_path: "docs/agents/solo-founder.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/solo-founder.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/solo-founder.md`
