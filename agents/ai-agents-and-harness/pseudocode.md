...
source_path: ".claude/agents/sparc/pseudocode.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/sparc/pseudocode.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/sparc/pseudocode.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/sparc/pseudocode.md`
