...
source_path: "agents/quality-assurance/error-detective.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/agents/quality-assurance/error-detective.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `agents/quality-assurance/error-detective.md`
