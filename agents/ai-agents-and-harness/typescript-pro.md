...
allowed-tools: "Read, Write, Edit, MultiEdit, Grep, Glob, Bash, LS, WebFetch,WebSearch, Task, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, mcp__sequential-thinking__sequentialthinking"
model: "sonnet"
category: ai-agents-and-harness
source_repo: lst97/claude-code-sub-agents
source_path: "agents/development/typescript-pro.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/development/typescript-pro.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/development/typescript-pro.md`
