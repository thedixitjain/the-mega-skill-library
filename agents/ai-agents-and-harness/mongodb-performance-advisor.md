...
source_path: "agents/mongodb-performance-advisor.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/mongodb-performance-advisor.agent.md
---
# Role
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/mongodb-performance-advisor.agent.md`
