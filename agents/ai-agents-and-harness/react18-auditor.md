...
allowed-tools: "['vscode/memory', 'search', 'search/usages', 'execute/getTerminalOutput', 'execute/runInTerminal', 'read/terminalLastCommand', 'read/terminalSelection', 'edit/editFiles', 'web/fetch']"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/react18-auditor.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/react18-auditor.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/react18-auditor.agent.md`
