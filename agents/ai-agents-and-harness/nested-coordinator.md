...
allowed-tools: "Task Read Grep Glob TodoWrite Bash"
model: "sonnet"
category: ai-agents-and-harness
source_repo: ruvnet/ruflo
source_path: "plugins/ruflo-agent/agents/nested-coordinator.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-agent/agents/nested-coordinator.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-agent/agents/nested-coordinator.md`
