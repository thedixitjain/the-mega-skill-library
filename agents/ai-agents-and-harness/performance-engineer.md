...
source_path: "plugins/all-agents/agents/performance-engineer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/performance-engineer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/performance-engineer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-quality-security/agents/performance-engineer.md`
