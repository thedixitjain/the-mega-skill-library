...
allowed-tools: "['runCommands', 'edit/createFile', 'edit/editFiles', 'search', 'usages', 'problems', 'fetch']"
model: "Auto (copilot)"
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: ".github/agents/dotnet-notebook-migration.agent.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/.github/agents/dotnet-notebook-migration.agent.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `.github/agents/dotnet-notebook-migration.agent.md`
