...
source_path: "plugins/desktop-app-dev/agents/desktop-app-dev.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/desktop-app-dev/agents/desktop-app-dev.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/desktop-app-dev/agents/desktop-app-dev.md`
