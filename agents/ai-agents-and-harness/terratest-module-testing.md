...
source_path: "agents/terratest-module-testing.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/terratest-module-testing.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/terratest-module-testing.agent.md`
