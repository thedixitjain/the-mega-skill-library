...
source_path: "agents/specialized-domains/blockchain-developer.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/agents/specialized-domains/blockchain-developer.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `agents/specialized-domains/blockchain-developer.md`
