...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/opensource-forker.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/opensource-forker.md`
