...
source_path: "agents/markdown-accessibility-assistant.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/markdown-accessibility-assistant.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/markdown-accessibility-assistant.agent.md`
