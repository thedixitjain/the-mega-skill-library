...
allowed-tools: "mcp__claude-flow__swarm_init mcp__claude-flow__agent_spawn mcp__claude-flow__task_orchestrate mcp__agentic-flow__agentdb_pattern_store mcp__agentic-flow__agentdb_pattern_search mcp__agentic-flow__agentdb_pattern_stats Bash Read Write TodoWrite"
category: ai-agents-and-harness
source_repo: ruvnet/RuView
source_path: ".claude/agents/github/code-review-swarm.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/github/code-review-swarm.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/github/code-review-swarm.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/github/code-review-swarm.md`
