...
allowed-tools: "[\"codebase\", \"githubRepo\", \"search\", \"usages\", \"web/fetch\", \"findTestFiles\"]"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/one-shot-feature-issue-planner.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/one-shot-feature-issue-planner.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/one-shot-feature-issue-planner.agent.md`
