...
allowed-tools: "['search/codebase', 'search/usages', 'edit/editFiles', 'vscode/extensions', 'web/fetch', 'vscode/openSimpleBrowser', 'read/problems', 'execute/runTests', 'read/terminalLastCommand', 'read/terminalSelection', 'execute/testFailure', 'vscode/vscodeAPI']"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/specification.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/specification.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/specification.agent.md`
