...
source_path: ".claude/agents/offsec-specialist.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/.claude/agents/offsec-specialist.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `.claude/agents/offsec-specialist.md`
