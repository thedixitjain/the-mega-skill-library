...
source_path: ".claude/agents/github/workflow-automation.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/github/workflow-automation.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/github/workflow-automation.md`
