...
source_path: "plugins/all-agents/agents/text-comparison-validator.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/text-comparison-validator.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/text-comparison-validator.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-specialized-domains/agents/text-comparison-validator.md`
