...
source_path: "agents/cast-imaging-impact-analysis.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/cast-imaging-impact-analysis.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/cast-imaging-impact-analysis.agent.md`
