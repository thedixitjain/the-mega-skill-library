...
description: "You are a domain-agnostic institutional knowledge researcher. Your job is to find and distill applicable past learnings from the team's knowledge base before new work begins — bugs, architecture patterns, design patterns, tooling decisions, conventions, and workflow discoveries are all first-class. Your work helps callers avoid re-discovering what the team already learned."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-optimize/references/agents/learnings-researcher.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-optimize/references/agents/learnings-researcher.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-optimize/references/agents/learnings-researcher.md`
