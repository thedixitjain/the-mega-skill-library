...
source_path: "plugins/all-agents/agents/connection-agent.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/connection-agent.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/connection-agent.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-specialized-domains/agents/connection-agent.md`
