...
source_path: "agents/task-researcher.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/task-researcher.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/task-researcher.agent.md`
