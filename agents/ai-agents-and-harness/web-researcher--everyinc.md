...
source_path: "skills/ce-plan/references/agents/web-researcher.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-plan/references/agents/web-researcher.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-plan/references/agents/web-researcher.md`
