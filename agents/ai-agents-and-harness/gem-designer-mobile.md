...
source_path: "agents/gem-designer-mobile.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-designer-mobile.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-designer-mobile.agent.md`
