...
source_path: ".claude/agents/position-engine.md"
source_url: https://github.com/dongbeixiaohuo/writing-agent/blob/HEAD/.claude/agents/position-engine.md
---
...
**Source:** [`dongbeixiaohuo/writing-agent`](https://github.com/dongbeixiaohuo/writing-agent) → `.claude/agents/position-engine.md`

**Also appears in:** `dongbeixiaohuo/writing-agent/claude-runtime/agents/position-engine.md`, `dongbeixiaohuo/writing-agent/plugins/writing-agent/agents/position-engine.md`
