...
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/github/release-manager.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/github/release-manager.md`
