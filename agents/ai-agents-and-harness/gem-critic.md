...
source_path: "agents/gem-critic.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-critic.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-critic.agent.md`
