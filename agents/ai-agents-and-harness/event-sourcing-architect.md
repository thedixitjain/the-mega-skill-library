...
source_path: "plugins/backend-development/agents/event-sourcing-architect.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/backend-development/agents/event-sourcing-architect.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/backend-development/agents/event-sourcing-architect.md`
