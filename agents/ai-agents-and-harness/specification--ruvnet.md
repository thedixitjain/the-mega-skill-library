...
source_path: ".claude/agents/sparc/specification.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/sparc/specification.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/sparc/specification.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/sparc/specification.md`
