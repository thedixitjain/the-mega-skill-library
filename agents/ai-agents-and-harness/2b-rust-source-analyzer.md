...
source_path: "plugins/zeroize-audit/agents/2b-rust-source-analyzer.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/zeroize-audit/agents/2b-rust-source-analyzer.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/zeroize-audit/agents/2b-rust-source-analyzer.md`
