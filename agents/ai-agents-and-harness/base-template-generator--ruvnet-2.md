...
source_path: "v3/@claude-flow/mcp/.claude/agents/templates/base-template-generator.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/v3/@claude-flow/mcp/.claude/agents/templates/base-template-generator.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `v3/@claude-flow/mcp/.claude/agents/templates/base-template-generator.md`
