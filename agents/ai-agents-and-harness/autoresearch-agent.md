...
source_path: "agents/data-ai/autoresearch-agent.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/agents/data-ai/autoresearch-agent.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `agents/data-ai/autoresearch-agent.md`
