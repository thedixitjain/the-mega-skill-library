...
source_path: "agents/defender-scout-kql.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/defender-scout-kql.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/defender-scout-kql.agent.md`
