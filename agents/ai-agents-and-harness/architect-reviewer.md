...
allowed-tools: "Read, Grep, Glob, LS, WebFetch, WebSearch, Task, mcp__sequential-thinking__sequentialthinking, mcp__context7__resolve-library-id, mcp__context7__get-library-docs"
model: "haiku"
category: ai-agents-and-harness
source_repo: lst97/claude-code-sub-agents
source_path: "agents/quality-testing/architect-review.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/quality-testing/architect-review.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/quality-testing/architect-review.md`
