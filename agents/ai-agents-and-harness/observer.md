...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/continuous-learning-v2/agents/observer.md
---
# Observer Agent
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/continuous-learning-v2/agents/observer.md`
