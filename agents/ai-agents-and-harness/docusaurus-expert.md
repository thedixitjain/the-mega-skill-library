...
source_path: "plugins/all-agents/agents/docusaurus-expert.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/docusaurus-expert.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/docusaurus-expert.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-documentation/agents/docusaurus-expert.md`
