...
source_path: "agents/cast-imaging-software-discovery.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/cast-imaging-software-discovery.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/cast-imaging-software-discovery.agent.md`
