...
source_path: "agents/gem-orchestrator.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-orchestrator.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-orchestrator.agent.md`
