...
description: "Role: Adversarial thinker. Finds what's wrong before others do."
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "c-level-advisor/executive-mentor/agents/devils-advocate.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/c-level-advisor/executive-mentor/agents/devils-advocate.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `c-level-advisor/executive-mentor/agents/devils-advocate.md`
