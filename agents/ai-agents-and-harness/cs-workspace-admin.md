...
source_path: "agents/engineering-team/cs-workspace-admin.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/agents/engineering-team/cs-workspace-admin.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `agents/engineering-team/cs-workspace-admin.md`
