...
source_path: ".claude/agents/v3/collective-intelligence-coordinator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/v3/collective-intelligence-coordinator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/v3/collective-intelligence-coordinator.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/v3/collective-intelligence-coordinator.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/v3/collective-intelligence-coordinator.md`
