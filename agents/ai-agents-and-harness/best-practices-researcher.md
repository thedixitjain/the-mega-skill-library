...
description: "Note: The current year is 2026. Use this when searching for recent documentation and best practices."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-compound/references/agents/best-practices-researcher.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-compound/references/agents/best-practices-researcher.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-compound/references/agents/best-practices-researcher.md`
