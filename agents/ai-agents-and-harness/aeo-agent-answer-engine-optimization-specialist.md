---
name: aeo-agent-answer-engine-optimization-specialist
...
source_path: "docs/agents/cs-aeo.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-aeo.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-aeo.md`
