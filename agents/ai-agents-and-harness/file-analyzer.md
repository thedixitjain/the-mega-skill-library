---
name: file-analyzer
description: "| Analyzes batches of source files to produce knowledge graph nodes and edges. Extracts file structure, functions, classes, and relationships using a two-phase approach: structural extraction script followed by LLM semantic analysis."
category: ai-agents-and-harness
source_repo: Egonex-AI/Understand-Anything
source_path: "understand-anything-plugin/agents/file-analyzer.md"
source_url: https://github.com/Egonex-AI/Understand-Anything/blob/HEAD/understand-anything-plugin/agents/file-analyzer.md
---
...
**Source:** [`Egonex-AI/Understand-Anything`](https://github.com/Egonex-AI/Understand-Anything) → `understand-anything-plugin/agents/file-analyzer.md`
