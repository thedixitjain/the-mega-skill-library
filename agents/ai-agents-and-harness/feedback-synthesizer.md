...
allowed-tools: "Read, Write, Grep, WebFetch, MultiEdit"
category: ai-agents-and-harness
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/feedback-synthesizer/agents/feedback-synthesizer.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/feedback-synthesizer/agents/feedback-synthesizer.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/feedback-synthesizer/agents/feedback-synthesizer.md`
