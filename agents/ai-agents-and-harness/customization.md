---
name: customization
description: "This document provides instructions on how to grant users permissions to access the BigQuery table created and populated by the brandsearchoptimization/bqpopulatedata.py script. You can use the Google Cloud Console, the bq command-line tool, or the BigQuery API to manage these permissions."
category: ai-agents-and-harness
source_repo: google/adk-samples
source_path: "python/agents/brand-search-optimization/customization.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/python/agents/brand-search-optimization/customization.md
---
# Customization
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `python/agents/brand-search-optimization/customization.md`
