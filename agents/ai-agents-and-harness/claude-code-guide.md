...
allowed-tools: "[Bash, Read, WebFetch, WebSearch] # live getter, embedded-search gate: [Glob, Grep, Read, WebFetch, WebSearch] on builds without it"
model: "haiku"
category: ai-agents-and-harness
source_repo: asgeirtj/system_prompts_leaks
source_path: "Anthropic/Claude Code/agents/claude-code-guide.md"
source_url: https://github.com/asgeirtj/system_prompts_leaks/blob/HEAD/Anthropic/Claude Code/agents/claude-code-guide.md
---
...
**Source:** [`asgeirtj/system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks) → `Anthropic/Claude Code/agents/claude-code-guide.md`
