...
source_path: "plugins/conductor/agents/conductor-validator.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/conductor/agents/conductor-validator.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/conductor/agents/conductor-validator.md`
