...
source_path: "agents/se-technical-writer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/se-technical-writer.agent.md
---
# Technical Writer
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/se-technical-writer.agent.md`
