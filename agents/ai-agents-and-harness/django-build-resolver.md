...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/django-build-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/django-build-resolver.md`
