...
source_path: "plugins/ai-agency/tonone/agents/pitch.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/ai-agency/tonone/agents/pitch.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/ai-agency/tonone/agents/pitch.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/ai-agency/tonone/bundle/marketing-team/agents/pitch.md`
