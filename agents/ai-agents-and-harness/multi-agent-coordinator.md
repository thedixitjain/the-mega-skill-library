...
source_path: "agents/orchestration/multi-agent-coordinator.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/agents/orchestration/multi-agent-coordinator.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `agents/orchestration/multi-agent-coordinator.md`
