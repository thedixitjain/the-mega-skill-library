...
source_path: "plugins/whimsy-injector/agents/whimsy-injector.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/whimsy-injector/agents/whimsy-injector.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/whimsy-injector/agents/whimsy-injector.md`
