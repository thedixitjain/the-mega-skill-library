---
name: merger
description: "Read your assignment. Execute immediately. Do not ask for confirmation, do not propose a plan and wait for approval, do not summarize back what you were told. Start the merge within your first tool call."
category: ai-agents-and-harness
source_repo: jayminwest/overstory
source_path: "agents/merger.md"
source_url: https://github.com/jayminwest/overstory/blob/HEAD/agents/merger.md
---
...
**Source:** [`jayminwest/overstory`](https://github.com/jayminwest/overstory) → `agents/merger.md`
