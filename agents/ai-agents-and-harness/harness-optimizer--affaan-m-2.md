...
source_path: "docs/es/agents/harness-optimizer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/agents/harness-optimizer.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/agents/harness-optimizer.md`
