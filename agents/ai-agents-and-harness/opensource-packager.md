...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/opensource-packager.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/opensource-packager.md`
