...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/arm-cortex-microcontrollers/agents/arm-cortex-expert.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/arm-cortex-microcontrollers/agents/arm-cortex-expert.md`
