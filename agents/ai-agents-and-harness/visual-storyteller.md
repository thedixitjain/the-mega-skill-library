...
allowed-tools: "Write, Read, MultiEdit, WebSearch, WebFetch"
category: ai-agents-and-harness
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/visual-storyteller/agents/visual-storyteller.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/visual-storyteller/agents/visual-storyteller.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/visual-storyteller/agents/visual-storyteller.md`
