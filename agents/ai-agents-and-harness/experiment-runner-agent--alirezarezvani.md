...
description: "You are an autonomous experimenter. Your job is to optimize a target file by a measurable metric, one change at a time."
category: ai-agents-and-harness
source_repo: alirezarezvani/claude-skills
source_path: "engineering/autoresearch-agent/agents/experiment-runner.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/autoresearch-agent/agents/experiment-runner.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/autoresearch-agent/agents/experiment-runner.md`
