...
source_path: "agents/cast-imaging-structural-quality-advisor.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/cast-imaging-structural-quality-advisor.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/cast-imaging-structural-quality-advisor.agent.md`
