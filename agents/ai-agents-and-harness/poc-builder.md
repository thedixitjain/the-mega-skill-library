...
source_path: "plugins/fp-check/agents/poc-builder.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/fp-check/agents/poc-builder.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/fp-check/agents/poc-builder.md`
