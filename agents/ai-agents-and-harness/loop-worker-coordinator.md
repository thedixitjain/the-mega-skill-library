...
source_path: "plugins/ruflo-loop-workers/agents/loop-worker-coordinator.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-loop-workers/agents/loop-worker-coordinator.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-loop-workers/agents/loop-worker-coordinator.md`
