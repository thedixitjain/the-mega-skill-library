...
allowed-tools: "[codebase, terminalLastCommand, fetch]"
model: "gpt-5"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/kubestellar-console.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/kubestellar-console.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/kubestellar-console.agent.md`
