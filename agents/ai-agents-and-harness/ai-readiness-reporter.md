...
allowed-tools: "['execute', 'read', 'search', 'search/codebase', 'editFiles']"
model: "Claude Sonnet 4.5"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/ai-readiness-reporter.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/ai-readiness-reporter.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/ai-readiness-reporter.agent.md`
