...
source_path: "skills/lead-intelligence/agents/enrichment-agent.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/lead-intelligence/agents/enrichment-agent.md
---
# Enrichment Agent
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/lead-intelligence/agents/enrichment-agent.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/lead-intelligence/agents/enrichment-agent.md`
