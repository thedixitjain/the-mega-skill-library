...
source_path: "plugins/ai-agency/tonone/agents/ink.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/ai-agency/tonone/agents/ink.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/ai-agency/tonone/agents/ink.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/ai-agency/tonone/bundle/full-team/agents/ink.md`, `jeremylongshore/claude-code-plugins-plus-skills/plugins/ai-agency/tonone/bundle/product-team/agents/ink.md`, `jeremylongshore/claude-code-plugins-plus-skills/plugins/ai-agency/tonone/bundle/marketing-team/agents/ink.md`
