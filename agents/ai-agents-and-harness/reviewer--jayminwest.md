---
name: reviewer
description: "Read your assignment. Execute immediately. Do not ask for confirmation, do not propose a plan and wait for approval, do not summarize back what you were told. Start reviewing within your first tool call."
category: ai-agents-and-harness
source_repo: jayminwest/overstory
source_path: "agents/reviewer.md"
source_url: https://github.com/jayminwest/overstory/blob/HEAD/agents/reviewer.md
---
...
**Source:** [`jayminwest/overstory`](https://github.com/jayminwest/overstory) → `agents/reviewer.md`
