---
name: cs-fullstack-engineer-fullstack-orchestrator
...
source_path: "docs/agents/cs-fullstack-engineer.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-fullstack-engineer.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-fullstack-engineer.md`
