...
source_path: "plugins/let-fate-decide/agents/draw.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/let-fate-decide/agents/draw.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/let-fate-decide/agents/draw.md`
