---
name: compliance-officer-agent-multi-framework-orchestrator
...
source_path: "docs/agents/cs-compliance-officer.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-compliance-officer.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-compliance-officer.md`
