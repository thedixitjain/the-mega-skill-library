...
source_path: "plugins/all-agents/agents/search-specialist.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/search-specialist.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/search-specialist.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-data-ai/agents/search-specialist.md`
