...
source_path: ".claude/agents/templates/performance-analyzer.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/templates/performance-analyzer.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/templates/performance-analyzer.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/templates/performance-analyzer.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/templates/performance-analyzer.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/templates/performance-analyzer.md`
