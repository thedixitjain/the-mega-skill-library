...
source_path: ".claude/agents/payments/agentic-payments.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/payments/agentic-payments.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/payments/agentic-payments.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/payments/agentic-payments.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/payments/agentic-payments.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/payments/agentic-payments.md`
