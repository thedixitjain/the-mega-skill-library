...
source_path: "plugins/analytics-reporter/agents/analytics-reporter.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/analytics-reporter/agents/analytics-reporter.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/analytics-reporter/agents/analytics-reporter.md`
