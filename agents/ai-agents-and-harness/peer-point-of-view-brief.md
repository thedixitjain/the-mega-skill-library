---
name: peer-point-of-view-brief
description: "Form an independent, decisive point of view on the supplied subject, grounding yourself in evidence you inspect in the shared working tree. Do not require or infer a host-curated project summary. Match the subject's shape: use an adoption grade for an adoption question, a holistic assessment with a bottom line for a document, and a preferred option or an honest \"either is viable\" tradeoff for an approach set."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-pov/references/agents/pov-peer.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-pov/references/agents/pov-peer.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-pov/references/agents/pov-peer.md`
