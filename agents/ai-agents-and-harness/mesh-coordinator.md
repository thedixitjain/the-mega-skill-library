...
source_path: ".claude/agents/swarm/mesh-coordinator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/swarm/mesh-coordinator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/swarm/mesh-coordinator.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/swarm/mesh-coordinator.md`
