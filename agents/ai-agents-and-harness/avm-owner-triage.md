...
allowed-tools: "[vscode, execute, read, agent, edit, search, web, browser, 'github/*', 'microsoft.docs.mcp/*', 'terraform.mcp/*', todo]"
model: "Claude Opus 4.7"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/azure-verified-modules-owner-triage.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/azure-verified-modules-owner-triage.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/azure-verified-modules-owner-triage.agent.md`
