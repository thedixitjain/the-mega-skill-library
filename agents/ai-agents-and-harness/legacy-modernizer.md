...
source_path: "plugins/all-agents/agents/legacy-modernizer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/legacy-modernizer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/legacy-modernizer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-development-architecture/agents/legacy-modernizer.md`
