...
source_path: "plugins/all-agents/agents/typescript-expert.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/typescript-expert.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/typescript-expert.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-language-specialists/agents/typescript-expert.md`
