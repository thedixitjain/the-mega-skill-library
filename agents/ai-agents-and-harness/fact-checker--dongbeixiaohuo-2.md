---
name: fact-checker
description: "| [Subagent] 事实核查员。 在 Humanizer 完成后、生成 _clean.txt 之前，抽取最终正文中的事实性内容，反查 Stage 2 证据账本和外部来源，拦截幻觉事实、错误引用和失效链接。"
allowed-tools: "Read, Write, Bash, Glob, Grep, WebSearch, WebFetch"
model: "sonnet"
category: ai-agents-and-harness
source_repo: dongbeixiaohuo/writing-agent
source_path: "plugins/writing-agent/agents/fact-checker.md"
source_url: https://github.com/dongbeixiaohuo/writing-agent/blob/HEAD/plugins/writing-agent/agents/fact-checker.md
---
...
**Source:** [`dongbeixiaohuo/writing-agent`](https://github.com/dongbeixiaohuo/writing-agent) → `plugins/writing-agent/agents/fact-checker.md`
