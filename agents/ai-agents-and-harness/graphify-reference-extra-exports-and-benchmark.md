---
name: graphify-reference-extra-exports-and-benchmark
description: "Load this when the user passed one of the export flags (--wiki, --neo4j, --neo4j-push, --falkordb, --falkordb-push, --svg, --graphml, --mcp), or when the corpus is large enough for the token-reduction benchmark. Each step runs only for its own flag."
category: ai-agents-and-harness
source_repo: Graphify-Labs/graphify
source_path: "graphify/skills/agents/references/exports.md"
source_url: https://github.com/Graphify-Labs/graphify/blob/HEAD/graphify/skills/agents/references/exports.md
---
...
**Source:** [`Graphify-Labs/graphify`](https://github.com/Graphify-Labs/graphify) → `graphify/skills/agents/references/exports.md`
