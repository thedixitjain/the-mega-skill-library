...
source_path: ".claude/agents/oss-report-generator-agent.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/.claude/agents/oss-report-generator-agent.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `.claude/agents/oss-report-generator-agent.md`
