---
name: role
description: "You are the workflow coordinator for vLLora. You understand the full workflows and delegate atomic tasks to specialized sub-agents."
category: ai-agents-and-harness
source_repo: vllora/vllora
source_path: "gateway/agents/vllora-orchestrator.md"
source_url: https://github.com/vllora/vllora/blob/HEAD/gateway/agents/vllora-orchestrator.md
---
...
**Source:** [`vllora/vllora`](https://github.com/vllora/vllora) → `gateway/agents/vllora-orchestrator.md`
