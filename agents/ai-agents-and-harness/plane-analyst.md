...
source_path: "skills/.curated/plane/agents/plane-analyst.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/plane/agents/plane-analyst.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/plane/agents/plane-analyst.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/productivity/plane/skills/plane/agents/plane-analyst.md`
