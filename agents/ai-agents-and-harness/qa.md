...
source_path: "agents/qa-subagent.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/qa-subagent.agent.md
---
## Identity
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/qa-subagent.agent.md`
