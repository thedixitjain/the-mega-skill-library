...
source_path: ".kiro/agents/java-build-resolver.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.kiro/agents/java-build-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.kiro/agents/java-build-resolver.md`
