...
source_path: ".claude/agents/templates/orchestrator-task.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/templates/orchestrator-task.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/templates/orchestrator-task.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/templates/orchestrator-task.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/templates/orchestrator-task.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/templates/orchestrator-task.md`
