...
allowed-tools: "['search', 'read', 'edit', 'execute', 'web']"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/ai-team-dev.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/ai-team-dev.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/ai-team-dev.agent.md`
