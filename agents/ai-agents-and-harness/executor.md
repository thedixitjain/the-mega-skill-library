...
source_path: ".opencode/agents/executor.md"
source_url: https://github.com/different-ai/openwork/blob/HEAD/.opencode/agents/executor.md
---
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `.opencode/agents/executor.md`
