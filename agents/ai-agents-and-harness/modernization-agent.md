...
allowed-tools: "search read edit execute agent todo read/problems execute/runTask execute/runInTerminal execute/createAndRunTask execute/getTaskOutput web/fetch"
model: "GPT-5"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/modernization.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/modernization.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/modernization.agent.md`
