...
source_path: "agents/drupal-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/drupal-expert.agent.md
---
# Drupal Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/drupal-expert.agent.md`
