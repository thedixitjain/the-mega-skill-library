...
source_path: "agents/declarative-agents-architect.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/declarative-agents-architect.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/declarative-agents-architect.agent.md`
