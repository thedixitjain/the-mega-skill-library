---
name: seo-guidelines-reference
description: "- 50-60 characters - Primary keyword near the beginning - Include a power word (Build, Master, Complete, Essential) - Format: \"[Action] [Topic] with [Technology] — [Benefit]\""
category: ai-agents-and-harness
source_repo: google/adk-samples
source_path: "python/agents/agent-skills-tutorial/app/skills/content-research-writer/references/seo-guidelines.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/python/agents/agent-skills-tutorial/app/skills/content-research-writer/references/seo-guidelines.md
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `python/agents/agent-skills-tutorial/app/skills/content-research-writer/references/seo-guidelines.md`
