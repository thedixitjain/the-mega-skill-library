...
source_path: "agents/development/dx-optimizer.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/development/dx-optimizer.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/development/dx-optimizer.md`
