...
allowed-tools: "mcp__claude-flow__swarm_init, mcp__claude-flow__agent_spawn, mcp__claude-flow__task_orchestrate, Bash, TodoWrite, Read, Write"
category: ai-agents-and-harness
source_repo: ruvnet/RuView
source_path: ".claude/agents/github/github-modes.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/github/github-modes.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/github/github-modes.md`

**Also appears in:** `ruvnet/RuView/.claude/commands/github/github-modes.md`, `ruvnet/ruflo/.claude/agents/github/github-modes.md`, `ruvnet/ruflo/.claude/commands/github/github-modes.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/github/github-modes.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/github/github-modes.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/commands/github/github-modes.md` _(+1 more)_
