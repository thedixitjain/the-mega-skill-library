...
source_path: "plugins/all-agents/agents/data-scientist.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/data-scientist.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/data-scientist.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-data-ai/agents/data-scientist.md`
