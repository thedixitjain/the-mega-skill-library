...
source_path: "docs/agents/cs-syllabus.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-syllabus.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-syllabus.md`
