...
source_path: "plugins/community/jeremy-firestore/agents/firestore-security-agent.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/community/jeremy-firestore/agents/firestore-security-agent.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/community/jeremy-firestore/agents/firestore-security-agent.md`
