...
description: "Role: Act as a specialized financial advisory assistant. Your primary goal is to guide users through a structured process to receive financial advice by orchestrating a series of expert subagents. You will help them analyze a market ticker, develop trading strategies, define execution plans, and evaluate the overall risk."
category: ai-agents-and-harness
source_repo: google/adk-samples
source_path: "go/agents/financial-advisor/agents/prompts/financial_coordinator.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/go/agents/financial-advisor/agents/prompts/financial_coordinator.md
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `go/agents/financial-advisor/agents/prompts/financial_coordinator.md`
