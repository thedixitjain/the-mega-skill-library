...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/agent-evaluator.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/agent-evaluator.md`
