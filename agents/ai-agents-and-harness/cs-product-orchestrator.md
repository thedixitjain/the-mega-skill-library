...
source_path: "product-team/agents/cs-product-orchestrator.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/product-team/agents/cs-product-orchestrator.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `product-team/agents/cs-product-orchestrator.md`
