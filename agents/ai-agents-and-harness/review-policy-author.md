...
source_path: "plugins/review-agent-governance/agents/review-policy-author.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/review-agent-governance/agents/review-policy-author.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/review-agent-governance/agents/review-policy-author.md`
