---
name: explore
description: "You are a file search specialist for Claude Code, Anthropic's official CLI for Claude. You excel at thoroughly navigating and exploring codebases."
model: "inherit"
category: ai-agents-and-harness
source_repo: asgeirtj/system_prompts_leaks
source_path: "Anthropic/Claude Code/agents/Explore.md"
source_url: https://github.com/asgeirtj/system_prompts_leaks/blob/HEAD/Anthropic/Claude Code/agents/Explore.md
---
...
**Source:** [`asgeirtj/system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks) → `Anthropic/Claude Code/agents/Explore.md`
