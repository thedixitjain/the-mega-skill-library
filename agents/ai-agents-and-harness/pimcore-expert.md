...
allowed-tools: "['codebase', 'terminalCommand', 'edit/editFiles', 'web/fetch', 'githubRepo', 'runTests', 'problems']"
model: "GPT-4.1 | 'gpt-5' | 'Claude Sonnet 4.5'"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/pimcore-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/pimcore-expert.agent.md
---
# Pimcore Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/pimcore-expert.agent.md`
