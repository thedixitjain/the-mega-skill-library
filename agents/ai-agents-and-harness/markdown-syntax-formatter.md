...
source_path: "plugins/all-agents/agents/markdown-syntax-formatter.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/markdown-syntax-formatter.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/markdown-syntax-formatter.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-documentation/agents/markdown-syntax-formatter.md`
