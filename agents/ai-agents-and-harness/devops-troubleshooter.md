...
source_path: "plugins/all-agents/agents/devops-troubleshooter.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/devops-troubleshooter.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/devops-troubleshooter.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-infrastructure-operations/agents/devops-troubleshooter.md`
