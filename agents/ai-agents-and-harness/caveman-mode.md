...
source_path: "agents/caveman-mode.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/caveman-mode.agent.md
---
# Caveman Mode
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/caveman-mode.agent.md`
