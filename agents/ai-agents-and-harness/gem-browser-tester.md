...
source_path: "agents/gem-browser-tester.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-browser-tester.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-browser-tester.agent.md`
