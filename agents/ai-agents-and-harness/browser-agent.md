...
source_path: "plugins/ruflo-browser/agents/browser-agent.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-browser/agents/browser-agent.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-browser/agents/browser-agent.md`
