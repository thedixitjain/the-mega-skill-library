---
name: growth-marketer-agent-personality
...
source_path: "docs/agents/growth-marketer.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/growth-marketer.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/growth-marketer.md`
