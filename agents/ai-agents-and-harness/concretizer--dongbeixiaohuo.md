...
source_path: "claude-runtime/agents/concretizer.md"
source_url: https://github.com/dongbeixiaohuo/writing-agent/blob/HEAD/claude-runtime/agents/concretizer.md
---
...
**Source:** [`dongbeixiaohuo/writing-agent`](https://github.com/dongbeixiaohuo/writing-agent) → `claude-runtime/agents/concretizer.md`
