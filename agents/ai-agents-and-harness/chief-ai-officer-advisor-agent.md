---
name: chief-ai-officer-advisor-agent
...
source_path: "docs/agents/cs-caio-advisor.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-caio-advisor.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-caio-advisor.md`
