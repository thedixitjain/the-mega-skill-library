...
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/swarm/adaptive-coordinator.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/swarm/adaptive-coordinator.md`
