...
allowed-tools: "['edit', 'search', 'shell', 'web/fetch', 'runTasks', 'githubRepo', 'todos', 'runSubagent']"
model: "Claude Sonnet 4.5 (copilot)"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/technical-content-evaluator.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/technical-content-evaluator.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/technical-content-evaluator.agent.md`
