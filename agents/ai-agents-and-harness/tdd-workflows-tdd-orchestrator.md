...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/tdd-workflows/agents/tdd-orchestrator.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/tdd-workflows/agents/tdd-orchestrator.md`

**Also appears in:** `wshobson/agents/plugins/backend-development/agents/tdd-orchestrator.md`
