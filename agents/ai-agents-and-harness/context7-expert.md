...
allowed-tools: "['read', 'search', 'web', 'context7/*', 'agent/runSubagent']"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/context7.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/context7.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/context7.agent.md`
