...
source_path: "agents/doublecheck.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/doublecheck.agent.md
---
# Doublecheck Agent
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/doublecheck.agent.md`
