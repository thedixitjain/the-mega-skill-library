...
source_path: "agents/swe-subagent.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/swe-subagent.agent.md
---
## Identity
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/swe-subagent.agent.md`
