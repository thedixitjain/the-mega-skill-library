...
source_path: ".claude/agents/swarm/hierarchical-coordinator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/swarm/hierarchical-coordinator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/swarm/hierarchical-coordinator.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/swarm/hierarchical-coordinator.md`
