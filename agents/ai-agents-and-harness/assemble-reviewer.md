...
description: "| Reviews the output of merge-batch-graphs.py for semantic issues the script cannot catch. Recovers dropped nodes/edges and fills cross-batch gaps."
category: ai-agents-and-harness
source_repo: Egonex-AI/Understand-Anything
source_path: "understand-anything-plugin/agents/assemble-reviewer.md"
source_url: https://github.com/Egonex-AI/Understand-Anything/blob/HEAD/understand-anything-plugin/agents/assemble-reviewer.md
---
...
**Source:** [`Egonex-AI/Understand-Anything`](https://github.com/Egonex-AI/Understand-Anything) → `understand-anything-plugin/agents/assemble-reviewer.md`
