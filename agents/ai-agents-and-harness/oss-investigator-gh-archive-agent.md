...
source_path: ".claude/agents/oss-investigator-gh-archive-agent.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/.claude/agents/oss-investigator-gh-archive-agent.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `.claude/agents/oss-investigator-gh-archive-agent.md`
