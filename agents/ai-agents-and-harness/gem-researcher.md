...
source_path: "agents/gem-researcher.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-researcher.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-researcher.agent.md`
