...
allowed-tools: "Write, Read, WebSearch, WebFetch, MultiEdit"
category: ai-agents-and-harness
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/app-store-optimizer/agents/app-store-optimizer.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/app-store-optimizer/agents/app-store-optimizer.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/app-store-optimizer/agents/app-store-optimizer.md`
