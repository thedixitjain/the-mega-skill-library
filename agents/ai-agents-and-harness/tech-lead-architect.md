...
source_path: ".claude/agents/tech-lead-architect.md"
source_url: https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/HEAD/.claude/agents/tech-lead-architect.md
---
...
**Source:** [`wesammustafa/Claude-Code-Everything-You-Need-to-Know`](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know) → `.claude/agents/tech-lead-architect.md`
