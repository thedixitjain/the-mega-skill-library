...
source_path: ".claude/agents/dual-mode/codex-coordinator.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/dual-mode/codex-coordinator.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/dual-mode/codex-coordinator.md`
