---
name: cs-bizops-orchestrator-process-obsessed-bizops-lead
...
source_path: "docs/agents/cs-bizops-orchestrator.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-bizops-orchestrator.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-bizops-orchestrator.md`
