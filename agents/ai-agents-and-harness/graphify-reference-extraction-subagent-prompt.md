---
name: graphify-reference-extraction-subagent-prompt
description: "Load this in Step 3 Part B when the corpus has at least one doc, paper, or image chunk. A pure-code corpus skips Part B and never reads this file. Each semantic subagent receives the prompt below verbatim (substitute FILELIST, CHUNKNUM, TOTALCHUNKS, DEEPMODE, and CHUNKPATH)."
category: ai-agents-and-harness
source_repo: Graphify-Labs/graphify
source_path: "graphify/skills/agents/references/extraction-spec.md"
source_url: https://github.com/Graphify-Labs/graphify/blob/HEAD/graphify/skills/agents/references/extraction-spec.md
---
...
**Source:** [`Graphify-Labs/graphify`](https://github.com/Graphify-Labs/graphify) → `graphify/skills/agents/references/extraction-spec.md`
