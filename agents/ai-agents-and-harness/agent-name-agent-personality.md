---
name: agent-name-agent-personality
...
source_path: "docs/agents/template.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/template.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/template.md`
