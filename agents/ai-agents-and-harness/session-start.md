...
source_path: "plugins/operating-kit/agents/session-start.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/operating-kit/agents/session-start.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/operating-kit/agents/session-start.md`
