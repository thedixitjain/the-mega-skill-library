...
source_path: ".claude/agents/github/release-manager.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/github/release-manager.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/github/release-manager.md`
