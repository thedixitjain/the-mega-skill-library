...
source_path: "agents/arch-linux-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/arch-linux-expert.agent.md
---
# Arch Linux Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/arch-linux-expert.agent.md`
