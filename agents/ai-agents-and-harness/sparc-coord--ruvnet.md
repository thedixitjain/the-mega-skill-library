...
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/templates/sparc-coordinator.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/templates/sparc-coordinator.md`
