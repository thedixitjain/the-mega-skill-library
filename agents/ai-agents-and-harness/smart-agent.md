...
source_path: ".claude/agents/templates/automation-smart-agent.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/templates/automation-smart-agent.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/templates/automation-smart-agent.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/templates/automation-smart-agent.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/templates/automation-smart-agent.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/templates/automation-smart-agent.md`
