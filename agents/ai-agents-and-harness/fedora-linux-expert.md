...
source_path: "agents/fedora-linux-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/fedora-linux-expert.agent.md
---
# Fedora Linux Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/fedora-linux-expert.agent.md`
