...
source_path: "agents/code-tour.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/code-tour.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/code-tour.agent.md`
