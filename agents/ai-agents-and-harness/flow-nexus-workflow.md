...
source_path: ".claude/agents/flow-nexus/workflow.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/flow-nexus/workflow.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/flow-nexus/workflow.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/flow-nexus/workflow.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/flow-nexus/workflow.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/flow-nexus/workflow.md`
