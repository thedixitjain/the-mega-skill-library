...
source_path: "agents/tdd-red.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/tdd-red.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/tdd-red.agent.md`
