...
source_path: "agents/taxcore-technical-writer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/taxcore-technical-writer.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/taxcore-technical-writer.agent.md`
