...
allowed-tools: "[\"changes\", \"codebase\", \"edit/editFiles\", \"extensions\", \"fetch\", \"findTestFiles\", \"githubRepo\", \"new\", \"openSimpleBrowser\", \"problems\", \"runCommands\", \"runNotebooks\", \"runTasks\", \"runTests\", \"search\", \"searchResults\", \"terminalLastCommand\", \"terminalSelection\", \"testFailure\", \"usages\", \"vscodeAPI\", \"microsoft.docs.mcp\"]"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/expert-dotnet-software-engineer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/expert-dotnet-software-engineer.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/expert-dotnet-software-engineer.agent.md`
