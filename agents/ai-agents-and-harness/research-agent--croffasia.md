---
name: research-agent
description: "> Use proactively when generating PRPs or creating product requirements. Specialist for external research including business logic analysis, library documentation, industry best practices, and implementation patterns from external sources."
allowed-tools: "WebSearch, WebFetch"
category: ai-agents-and-harness
source_repo: croffasia/cc-blueprint-toolkit
source_path: "claude/agents/research-agent.md"
source_url: https://github.com/croffasia/cc-blueprint-toolkit/blob/HEAD/claude/agents/research-agent.md
---
...
**Source:** [`croffasia/cc-blueprint-toolkit`](https://github.com/croffasia/cc-blueprint-toolkit) → `claude/agents/research-agent.md`
