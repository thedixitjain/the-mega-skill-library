...
source_path: "plugins/ceo-quality-controller-agent/agents/ceo-quality-controller-agent.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/ceo-quality-controller-agent/agents/ceo-quality-controller-agent.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/ceo-quality-controller-agent/agents/ceo-quality-controller-agent.md`
