...
source_path: "plugins/ai-ml/jeremy-adk-orchestrator/agents/a2a-protocol-manager.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/ai-ml/jeremy-adk-orchestrator/agents/a2a-protocol-manager.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/ai-ml/jeremy-adk-orchestrator/agents/a2a-protocol-manager.md`
