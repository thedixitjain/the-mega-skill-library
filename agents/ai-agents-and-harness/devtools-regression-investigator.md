...
source_path: "agents/devtools-regression-investigator.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/devtools-regression-investigator.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/devtools-regression-investigator.agent.md`
