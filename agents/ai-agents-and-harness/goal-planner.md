...
source_path: ".claude/agents/goal/goal-planner.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/goal/goal-planner.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/goal/goal-planner.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/reasoning/goal-planner.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/goal/goal-planner.md`
