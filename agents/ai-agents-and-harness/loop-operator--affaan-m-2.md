...
source_path: "docs/tr/agents/loop-operator.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/agents/loop-operator.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/agents/loop-operator.md`
