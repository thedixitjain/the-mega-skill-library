...
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/github/release-swarm.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/github/release-swarm.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/github/release-swarm.md`
