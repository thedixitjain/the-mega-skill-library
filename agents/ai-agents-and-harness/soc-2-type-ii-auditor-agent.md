---
name: soc-2-type-ii-auditor-agent
...
source_path: "docs/agents/cs-soc2-auditor.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-soc2-auditor.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-soc2-auditor.md`
