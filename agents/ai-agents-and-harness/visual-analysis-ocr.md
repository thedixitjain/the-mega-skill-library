...
source_path: "plugins/all-agents/agents/visual-analysis-ocr.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/visual-analysis-ocr.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/visual-analysis-ocr.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-media-content/agents/visual-analysis-ocr.md`
