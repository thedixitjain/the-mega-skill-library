...
source_path: "plugins/dgx-spark-ops/agents/dgx-spark-ops-engineer.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/dgx-spark-ops/agents/dgx-spark-ops-engineer.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/dgx-spark-ops/agents/dgx-spark-ops-engineer.md`
