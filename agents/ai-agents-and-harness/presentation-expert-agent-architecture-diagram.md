---
name: presentation-expert-agent-architecture-diagram
description: "This document illustrates the high-level multi-agent architecture of the Presentation Expert Agent. It highlights the unified data model, programmatic grounding for research, and enterprise-grade state persistence."
category: ai-agents-and-harness
source_repo: google/adk-samples
source_path: "python/agents/brand-aligned-presentations/docs/architecture_diagram.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/python/agents/brand-aligned-presentations/docs/architecture_diagram.md
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `python/agents/brand-aligned-presentations/docs/architecture_diagram.md`
