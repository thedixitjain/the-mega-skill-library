...
allowed-tools: "['vscode', 'execute', 'read', 'edit', 'search', 'web', 'agent', 'github/*', 'todo']"
model: "Claude Sonnet 4.5"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/custom-agent-foundry.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/custom-agent-foundry.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/custom-agent-foundry.agent.md`
