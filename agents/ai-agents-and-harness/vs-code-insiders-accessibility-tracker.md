...
allowed-tools: "['github/search_issues', 'github/issue_read', 'read']"
model: "Claude Sonnet 4.5"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/insiders-a11y-tracker.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/insiders-a11y-tracker.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/insiders-a11y-tracker.agent.md`
