...
source_path: "v3/@claude-flow/cli/.claude/commands/agents/agent-types.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/v3/@claude-flow/cli/.claude/commands/agents/agent-types.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `v3/@claude-flow/cli/.claude/commands/agents/agent-types.md`
