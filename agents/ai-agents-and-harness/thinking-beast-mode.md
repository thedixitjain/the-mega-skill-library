...
source_path: "agents/Thinking-Beast-Mode.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/Thinking-Beast-Mode.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/Thinking-Beast-Mode.agent.md`
