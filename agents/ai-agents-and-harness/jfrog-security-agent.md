...
source_path: "agents/jfrog-sec.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/jfrog-sec.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/jfrog-sec.agent.md`
