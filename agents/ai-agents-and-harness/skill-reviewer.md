...
source_path: "plugins/plugin-dev/agents/skill-reviewer.md"
source_url: https://github.com/anthropics/claude-code/blob/HEAD/plugins/plugin-dev/agents/skill-reviewer.md
---
...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `plugins/plugin-dev/agents/skill-reviewer.md`

**Also appears in:** `anthropics/claude-plugins-official/plugins/plugin-dev/agents/skill-reviewer.md`
