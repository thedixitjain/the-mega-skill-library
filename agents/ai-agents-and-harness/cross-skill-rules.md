...
description: "Reference for the skill-auditor agent. These rules define how skills must relate to each other within the Quality-Engineering-Skills framework. Violations are Major Findings."
category: ai-agents-and-harness
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/RBraga01/Quality-Engineering-Skills/skills/agents/skill-auditor/references/cross-skill-rules.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/RBraga01/Quality-Engineering-Skills/skills/agents/skill-auditor/references/cross-skill-rules.md
---
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/RBraga01/Quality-Engineering-Skills/skills/agents/skill-auditor/references/cross-skill-rules.md`
