...
source_path: "plugins/all-agents/agents/hackathon-ai-strategist.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/hackathon-ai-strategist.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/hackathon-ai-strategist.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-data-ai/agents/hackathon-ai-strategist.md`
