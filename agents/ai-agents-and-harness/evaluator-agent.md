...
description: "The Evaluator Agent assesses the quality of LLM-generated responses using configurable evaluation criteria. It implements the LLM-as-a-Judge pattern with support for both direct scoring and pairwise comparison."
category: ai-agents-and-harness
source_repo: muratcankoylan/Agent-Skills-for-Context-Engineering
source_path: "examples/llm-as-judge-skills/agents/evaluator-agent/evaluator-agent.md"
source_url: https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering/blob/HEAD/examples/llm-as-judge-skills/agents/evaluator-agent/evaluator-agent.md
---
# Evaluator Agent
...
**Source:** [`muratcankoylan/Agent-Skills-for-Context-Engineering`](https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering) → `examples/llm-as-judge-skills/agents/evaluator-agent/evaluator-agent.md`
