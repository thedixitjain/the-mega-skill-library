...
description: "Note: The current year is 2026. Use this when evaluating issue recency and trends."
category: ai-agents-and-harness
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-ideate/references/agents/issue-intelligence-analyst.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-ideate/references/agents/issue-intelligence-analyst.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-ideate/references/agents/issue-intelligence-analyst.md`
