...
source_path: "agents/salesforce-flow.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/salesforce-flow.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/salesforce-flow.agent.md`
