...
source_path: ".claude/agents/core/tester.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/core/tester.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/core/tester.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/core/tester.md`
