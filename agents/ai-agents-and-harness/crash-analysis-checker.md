...
source_path: ".claude/agents/crash-analyzer-checker-agent.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/.claude/agents/crash-analyzer-checker-agent.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `.claude/agents/crash-analyzer-checker-agent.md`
