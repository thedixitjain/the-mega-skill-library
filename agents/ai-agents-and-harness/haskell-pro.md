...
source_path: "plugins/functional-programming/agents/haskell-pro.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/functional-programming/agents/haskell-pro.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/functional-programming/agents/haskell-pro.md`
