...
allowed-tools: "['codebase', 'edit/editFiles', 'terminalCommand', 'search', 'githubRepo']"
model: "claude-3.5-sonnet"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/salesforce-apex-triggers.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/salesforce-apex-triggers.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/salesforce-apex-triggers.agent.md`
