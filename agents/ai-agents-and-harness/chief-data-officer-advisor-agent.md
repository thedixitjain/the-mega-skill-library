---
name: chief-data-officer-advisor-agent
...
source_path: "docs/agents/cs-cdo-advisor.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-cdo-advisor.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-cdo-advisor.md`
