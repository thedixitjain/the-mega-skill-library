...
source_path: "agents/amplitude-experiment-implementation.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/amplitude-experiment-implementation.agent.md
---
### Role
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/amplitude-experiment-implementation.agent.md`
