...
source_path: "agents/monday-bug-fixer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/monday-bug-fixer.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/monday-bug-fixer.agent.md`
