...
source_path: ".claude/agents/oss-hypothesis-checker-agent.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/.claude/agents/oss-hypothesis-checker-agent.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `.claude/agents/oss-hypothesis-checker-agent.md`
