...
allowed-tools: "['codebase', 'search', 'terminalCommand', 'runCommands', 'edit/editFiles']"
model: "GPT-4.1"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/centos-linux-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/centos-linux-expert.agent.md
---
# CentOS Linux Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/centos-linux-expert.agent.md`
