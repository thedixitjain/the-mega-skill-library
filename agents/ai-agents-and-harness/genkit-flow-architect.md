...
source_path: "plugins/ai-ml/jeremy-genkit-pro/agents/genkit-flow-architect.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/ai-ml/jeremy-genkit-pro/agents/genkit-flow-architect.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/ai-ml/jeremy-genkit-pro/agents/genkit-flow-architect.md`
