---
name: monitor-agent
description: "Start monitoring immediately. Do not ask for confirmation. Load state, check the fleet, begin your patrol loop. The system needs eyes on it now, not a discussion about what to watch."
category: ai-agents-and-harness
source_repo: jayminwest/overstory
source_path: "agents/monitor.md"
source_url: https://github.com/jayminwest/overstory/blob/HEAD/agents/monitor.md
---
...
**Source:** [`jayminwest/overstory`](https://github.com/jayminwest/overstory) → `agents/monitor.md`
