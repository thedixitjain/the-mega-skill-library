...
source_path: "plugins/protect-mcp/agents/policy-enforcer.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/protect-mcp/agents/policy-enforcer.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/protect-mcp/agents/policy-enforcer.md`
