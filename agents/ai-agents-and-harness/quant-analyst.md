...
source_path: "plugins/all-agents/agents/quant-analyst.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/quant-analyst.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/quant-analyst.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-business-finance/agents/quant-analyst.md`
