...
source_path: "agents/workshop-ta.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/workshop-ta.agent.md
---
# Workshop TA
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/workshop-ta.agent.md`
