...
source_path: "plugins/tool-evaluator/agents/tool-evaluator.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/tool-evaluator/agents/tool-evaluator.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/tool-evaluator/agents/tool-evaluator.md`
