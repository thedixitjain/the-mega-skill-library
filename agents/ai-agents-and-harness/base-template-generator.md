...
source_path: ".claude/agents/templates/base-template-generator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/templates/base-template-generator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/templates/base-template-generator.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/templates/base-template-generator.md`
