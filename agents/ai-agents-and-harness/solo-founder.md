...
source_path: "agents/personas/solo-founder.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/agents/personas/solo-founder.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `agents/personas/solo-founder.md`
