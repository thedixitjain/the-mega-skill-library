...
allowed-tools: "['codebase', 'terminalCommand', 'edit/editFiles', 'web/fetch', 'githubRepo', 'runTests', 'problems', 'search']"
model: "GPT-4.1 | 'gpt-5' | 'Claude Sonnet 4.5'"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/laravel-expert-agent.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/laravel-expert-agent.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/laravel-expert-agent.agent.md`
