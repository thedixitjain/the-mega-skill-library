...
allowed-tools: "['codebase', 'edit/editFiles', 'search', 'web/fetch']"
model: "GPT-5"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/se-system-architecture-reviewer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/se-system-architecture-reviewer.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/se-system-architecture-reviewer.agent.md`
