...
source_path: "plugins/all-agents/agents/payment-integration.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/payment-integration.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/payment-integration.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-business-finance/agents/payment-integration.md`
