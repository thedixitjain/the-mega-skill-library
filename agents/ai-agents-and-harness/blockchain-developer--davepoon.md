...
source_path: "plugins/all-agents/agents/blockchain-developer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/blockchain-developer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/blockchain-developer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-blockchain-web3/agents/blockchain-developer.md`
