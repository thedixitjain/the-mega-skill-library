...
source_path: "agents/tdd-green.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/tdd-green.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/tdd-green.agent.md`
