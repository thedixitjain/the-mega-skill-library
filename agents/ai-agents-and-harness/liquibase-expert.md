...
source_path: "agents/liquibase-expert.md"
source_url: https://github.com/0xfurai/claude-code-subagents/blob/HEAD/agents/liquibase-expert.md
---
...
**Source:** [`0xfurai/claude-code-subagents`](https://github.com/0xfurai/claude-code-subagents) → `agents/liquibase-expert.md`
