...
source_path: "agents/launchdarkly-flag-cleanup.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/launchdarkly-flag-cleanup.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/launchdarkly-flag-cleanup.agent.md`
