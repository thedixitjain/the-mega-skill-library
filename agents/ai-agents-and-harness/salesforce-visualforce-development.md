...
source_path: "agents/salesforce-visualforce.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/salesforce-visualforce.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/salesforce-visualforce.agent.md`
