...
source_path: "plugins/rust-review/agents/rust-review-fp-judge.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/rust-review/agents/rust-review-fp-judge.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/rust-review/agents/rust-review-fp-judge.md`
