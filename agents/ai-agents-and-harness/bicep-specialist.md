...
allowed-tools: "[ 'edit/editFiles', 'web/fetch', 'runCommands', 'terminalLastCommand', 'get_bicep_best_practices', 'azure_get_azure_verified_module', 'todos' ]"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/bicep-implement.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/bicep-implement.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/bicep-implement.agent.md`
