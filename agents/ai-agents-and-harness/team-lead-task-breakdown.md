...
allowed-tools: "Read, Glob, Write, TodoWrite"
category: ai-agents-and-harness
source_repo: croffasia/cc-blueprint-toolkit
source_path: "claude/agents/team-lead-task-breakdown.md"
source_url: https://github.com/croffasia/cc-blueprint-toolkit/blob/HEAD/claude/agents/team-lead-task-breakdown.md
---
...
**Source:** [`croffasia/cc-blueprint-toolkit`](https://github.com/croffasia/cc-blueprint-toolkit) → `claude/agents/team-lead-task-breakdown.md`
