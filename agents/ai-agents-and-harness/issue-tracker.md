...
allowed-tools: "mcp__claude-flow__swarm_init mcp__claude-flow__agent_spawn mcp__claude-flow__task_orchestrate mcp__claude-flow__memory_usage mcp__agentic-flow__agentdb_pattern_store mcp__agentic-flow__agentdb_pattern_search mcp__agentic-flow__agentdb_pattern_stats Bash TodoWrite Read Write"
category: ai-agents-and-harness
source_repo: ruvnet/RuView
source_path: ".claude/agents/github/issue-tracker.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/github/issue-tracker.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/github/issue-tracker.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/github/issue-tracker.md`
