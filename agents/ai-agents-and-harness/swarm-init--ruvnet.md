...
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/templates/coordinator-swarm-init.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/templates/coordinator-swarm-init.md`
