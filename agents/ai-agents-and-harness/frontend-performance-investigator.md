...
allowed-tools: "['codebase', 'search', 'fetch', 'findTestFiles', 'problems', 'runCommands', 'runTasks', 'runTests', 'terminalLastCommand', 'terminalSelection', 'testFailure', 'openSimpleBrowser']"
model: "GPT-5"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/frontend-performance-investigator.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/frontend-performance-investigator.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/frontend-performance-investigator.agent.md`
