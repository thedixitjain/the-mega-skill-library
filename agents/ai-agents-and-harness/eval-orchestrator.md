...
source_path: "plugins/plugin-eval/agents/eval-orchestrator.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/plugin-eval/agents/eval-orchestrator.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/plugin-eval/agents/eval-orchestrator.md`
