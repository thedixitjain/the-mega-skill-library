...
source_path: "plugins/writing-agent/agents/concretizer.md"
source_url: https://github.com/dongbeixiaohuo/writing-agent/blob/HEAD/plugins/writing-agent/agents/concretizer.md
---
...
**Source:** [`dongbeixiaohuo/writing-agent`](https://github.com/dongbeixiaohuo/writing-agent) → `plugins/writing-agent/agents/concretizer.md`
