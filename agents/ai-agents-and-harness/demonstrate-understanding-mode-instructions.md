...
allowed-tools: "['codebase', 'web/fetch', 'findTestFiles', 'githubRepo', 'search', 'usages']"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/demonstrate-understanding.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/demonstrate-understanding.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/demonstrate-understanding.agent.md`
