...
source_path: ".claude/agents/oss-investigator-wayback-agent.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/.claude/agents/oss-investigator-wayback-agent.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `.claude/agents/oss-investigator-wayback-agent.md`
