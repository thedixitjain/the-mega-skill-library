...
source_path: "agents/CSharpExpert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/CSharpExpert.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/CSharpExpert.agent.md`
