...
source_path: "agents/debian-linux-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/debian-linux-expert.agent.md
---
# Debian Linux Expert
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/debian-linux-expert.agent.md`
