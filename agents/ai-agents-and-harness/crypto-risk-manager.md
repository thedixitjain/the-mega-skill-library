...
source_path: "plugins/all-agents/agents/crypto-risk-manager.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/crypto-risk-manager.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/crypto-risk-manager.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-crypto-trading/agents/crypto-risk-manager.md`
