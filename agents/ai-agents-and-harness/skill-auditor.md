...
source_path: ".claude/agents/skill-auditor.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/.claude/agents/skill-auditor.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `.claude/agents/skill-auditor.md`
