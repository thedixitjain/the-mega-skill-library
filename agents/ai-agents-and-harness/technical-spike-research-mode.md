...
allowed-tools: "['vscode', 'execute', 'read', 'edit', 'search', 'web', 'agent', 'todo']"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/research-technical-spike.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/research-technical-spike.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/research-technical-spike.agent.md`
