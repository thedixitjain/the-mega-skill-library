...
source_path: "agents/gem-mobile-tester.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-mobile-tester.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-mobile-tester.agent.md`
