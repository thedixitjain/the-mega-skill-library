...
source_path: ".claude/agents/consensus/gossip-coordinator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/consensus/gossip-coordinator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/consensus/gossip-coordinator.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/consensus/gossip-coordinator.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/consensus/gossip-coordinator.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/consensus/gossip-coordinator.md`
