...
allowed-tools: "\"*\": false \"github-pr-search\": true"
model: "opencode/claude-haiku-4-5"
category: ai-agents-and-harness
source_repo: different-ai/openwork
source_path: ".opencode/agents/duplicate-pr.md"
source_url: https://github.com/different-ai/openwork/blob/HEAD/.opencode/agents/duplicate-pr.md
---
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `.opencode/agents/duplicate-pr.md`
