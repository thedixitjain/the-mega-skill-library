...
source_path: "plugins/studio-coach/agents/studio-coach.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/studio-coach/agents/studio-coach.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/studio-coach/agents/studio-coach.md`
