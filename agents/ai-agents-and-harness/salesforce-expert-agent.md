...
allowed-tools: "['vscode', 'execute', 'read', 'edit', 'search', 'web', 'sfdx-mcp/*', 'agent', 'todo']"
model: "GPT-4.1"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/salesforce-expert.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/salesforce-expert.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/salesforce-expert.agent.md`
