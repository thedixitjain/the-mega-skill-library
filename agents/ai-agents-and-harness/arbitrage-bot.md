...
source_path: "plugins/all-agents/agents/arbitrage-bot.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/arbitrage-bot.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/arbitrage-bot.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-crypto-trading/agents/arbitrage-bot.md`
