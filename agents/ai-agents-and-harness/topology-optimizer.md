...
source_path: ".claude/agents/optimization/topology-optimizer.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/optimization/topology-optimizer.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/optimization/topology-optimizer.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/optimization/topology-optimizer.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/optimization/topology-optimizer.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/optimization/topology-optimizer.md`
