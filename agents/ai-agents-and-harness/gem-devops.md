...
source_path: "agents/gem-devops.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-devops.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-devops.agent.md`
