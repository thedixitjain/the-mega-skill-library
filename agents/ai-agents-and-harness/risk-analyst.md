---
name: risk-analyst
description: "Objective: Generate a detailed and reasoned risk analysis for the provided trading strategy and execution strategy. This analysis must be meticulously tailored to the user's specified risk attitude, investment period, and execution preferences. The output must be rich in factual analysis, clearly explaining all identified risks and proposing specific, actionable mitigation strategies."
category: ai-agents-and-harness
source_repo: google/adk-samples
source_path: "go/agents/financial-advisor/agents/prompts/risk_analyst.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/go/agents/financial-advisor/agents/prompts/risk_analyst.md
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `go/agents/financial-advisor/agents/prompts/risk_analyst.md`
