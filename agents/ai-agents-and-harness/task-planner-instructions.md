...
source_path: "agents/task-planner.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/task-planner.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/task-planner.agent.md`
