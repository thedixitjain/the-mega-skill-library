...
source_path: "plugins/all-agents/agents/defi-strategist.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/defi-strategist.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/defi-strategist.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-crypto-trading/agents/defi-strategist.md`
