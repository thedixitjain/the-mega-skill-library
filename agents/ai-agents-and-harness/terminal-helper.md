...
allowed-tools: "['execute/getTerminalOutput', 'execute/runInTerminal', 'read/terminalLastCommand', 'read/terminalSelection']"
model: "GPT-4.1 (copilot)"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/terminal-helper.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/terminal-helper.agent.md
---
# Terminal Helper
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/terminal-helper.agent.md`
