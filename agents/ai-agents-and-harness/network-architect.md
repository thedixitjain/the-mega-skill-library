...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/network-architect.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/network-architect.md`
