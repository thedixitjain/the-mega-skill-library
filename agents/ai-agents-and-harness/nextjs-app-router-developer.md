...
source_path: "plugins/all-agents/agents/nextjs-app-router-developer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/nextjs-app-router-developer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/nextjs-app-router-developer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-development-architecture/agents/nextjs-app-router-developer.md`
