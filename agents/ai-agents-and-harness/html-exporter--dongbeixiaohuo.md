...
source_path: "claude-runtime/agents/html-exporter.md"
source_url: https://github.com/dongbeixiaohuo/writing-agent/blob/HEAD/claude-runtime/agents/html-exporter.md
---
...
**Source:** [`dongbeixiaohuo/writing-agent`](https://github.com/dongbeixiaohuo/writing-agent) → `claude-runtime/agents/html-exporter.md`
