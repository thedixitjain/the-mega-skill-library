...
allowed-tools: "mcp__github__push_files mcp__github__create_or_update_file mcp__github__get_file_contents mcp__github__create_pull_request mcp__github__search_repositories mcp__github__list_repositories mcp__claude-flow__swarm_init mcp__claude-flow__agent_spawn mcp__claude-flow__task_orchestrate mcp__claude-flow__memory_usage mcp__claude-flow__coordination_sync mcp__claude-flow__load_balance TodoWrite TodoRead Bash Read Write Edit MultiEdit"
category: ai-agents-and-harness
source_repo: ruvnet/RuView
source_path: ".claude/agents/github/sync-coordinator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/github/sync-coordinator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/github/sync-coordinator.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/github/sync-coordinator.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/github/sync-coordinator.md`
