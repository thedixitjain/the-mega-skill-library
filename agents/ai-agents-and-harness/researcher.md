...
source_path: ".claude/agents/core/researcher.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/core/researcher.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/core/researcher.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/core/researcher.md`
