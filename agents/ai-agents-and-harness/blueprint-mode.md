...
source_path: "agents/blueprint-mode.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/blueprint-mode.agent.md
---
# Blueprint Mode v39
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/blueprint-mode.agent.md`
