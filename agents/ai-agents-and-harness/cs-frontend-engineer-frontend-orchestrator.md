---
name: cs-frontend-engineer-frontend-orchestrator
...
source_path: "docs/agents/cs-frontend-engineer.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-frontend-engineer.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-frontend-engineer.md`
