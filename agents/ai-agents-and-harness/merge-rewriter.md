...
source_path: "skills/.curated/databricks-streaming-guardian/agents/merge-rewriter.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/databricks-streaming-guardian/agents/merge-rewriter.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/databricks-streaming-guardian/agents/merge-rewriter.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/databricks-pack/skills/databricks-streaming-guardian/agents/merge-rewriter.md`
