...
allowed-tools: "['codebase', 'extensions', 'web/fetch', 'findTestFiles', 'githubRepo', 'problems', 'search', 'searchResults', 'usages']"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/critical-thinking.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/critical-thinking.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/critical-thinking.agent.md`
