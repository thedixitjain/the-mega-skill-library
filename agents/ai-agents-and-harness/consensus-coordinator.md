...
source_path: ".claude/agents/sublinear/consensus-coordinator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/sublinear/consensus-coordinator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/sublinear/consensus-coordinator.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/sublinear/consensus-coordinator.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/sublinear/consensus-coordinator.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/sublinear/consensus-coordinator.md`
