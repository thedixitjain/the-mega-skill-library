...
source_path: ".claude/agents/pre-publish-review.md"
source_url: https://github.com/dongbeixiaohuo/writing-agent/blob/HEAD/.claude/agents/pre-publish-review.md
---
...
**Source:** [`dongbeixiaohuo/writing-agent`](https://github.com/dongbeixiaohuo/writing-agent) → `.claude/agents/pre-publish-review.md`
