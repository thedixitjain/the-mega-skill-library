...
source_path: "plugins/ai-ml/jeremy-vertex-engine/agents/vertex-engine-inspector.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/ai-ml/jeremy-vertex-engine/agents/vertex-engine-inspector.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/ai-ml/jeremy-vertex-engine/agents/vertex-engine-inspector.md`
