...
source_path: ".claude/agents/sublinear/pagerank-analyzer.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/sublinear/pagerank-analyzer.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/sublinear/pagerank-analyzer.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/sublinear/pagerank-analyzer.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/sublinear/pagerank-analyzer.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/sublinear/pagerank-analyzer.md`
