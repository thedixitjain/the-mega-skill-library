...
allowed-tools: "['search', 'search/codebase', 'edit/editFiles', 'fetch', 'runCommands', 'runTasks']"
model: "GPT-5.3-Codex"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/azure-smart-city-iot-architect.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/azure-smart-city-iot-architect.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/azure-smart-city-iot-architect.agent.md`
