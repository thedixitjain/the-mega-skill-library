...
source_path: "plugins/agent-teams/agents/team-debugger.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/agent-teams/agents/team-debugger.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/agent-teams/agents/team-debugger.md`
