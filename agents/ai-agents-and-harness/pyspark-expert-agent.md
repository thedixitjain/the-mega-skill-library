...
source_path: "agents/spark-performance.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/spark-performance.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/spark-performance.agent.md`
