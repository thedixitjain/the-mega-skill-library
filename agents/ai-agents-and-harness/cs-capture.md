...
source_path: "productivity/capture/agents/cs-capture.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/productivity/capture/agents/cs-capture.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `productivity/capture/agents/cs-capture.md`
