...
source_path: "plugins/all-agents/agents/content-marketer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/content-marketer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/content-marketer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-sales-marketing/agents/content-marketer.md`
