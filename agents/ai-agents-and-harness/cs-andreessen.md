...
source_path: "productivity/andreessen/agents/cs-andreessen.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/productivity/andreessen/agents/cs-andreessen.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `productivity/andreessen/agents/cs-andreessen.md`
