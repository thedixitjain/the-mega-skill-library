...
source_path: ".claude/agents/templates/sparc-coordinator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/templates/sparc-coordinator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/templates/sparc-coordinator.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/templates/sparc-coordinator.md`
