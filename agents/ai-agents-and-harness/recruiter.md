...
source_path: "claude_agent_sdk/chief_of_staff_agent/.claude/agents/recruiter.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/claude_agent_sdk/chief_of_staff_agent/.claude/agents/recruiter.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `claude_agent_sdk/chief_of_staff_agent/.claude/agents/recruiter.md`
