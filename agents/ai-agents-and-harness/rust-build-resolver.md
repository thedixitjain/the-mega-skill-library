...
source_path: ".kiro/agents/rust-build-resolver.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.kiro/agents/rust-build-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.kiro/agents/rust-build-resolver.md`
