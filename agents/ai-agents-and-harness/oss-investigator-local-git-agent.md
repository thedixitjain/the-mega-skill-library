...
source_path: ".claude/agents/oss-investigator-local-git-agent.md"
source_url: https://github.com/gadievron/raptor/blob/HEAD/.claude/agents/oss-investigator-local-git-agent.md
---
...
**Source:** [`gadievron/raptor`](https://github.com/gadievron/raptor) → `.claude/agents/oss-investigator-local-git-agent.md`
