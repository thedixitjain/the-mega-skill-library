...
allowed-tools: "['microsoft_docs_search', 'microsoft_docs_fetch']"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/microsoft-study-mode.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/microsoft-study-mode.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/microsoft-study-mode.agent.md`
