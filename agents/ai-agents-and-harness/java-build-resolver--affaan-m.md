...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/java-build-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/java-build-resolver.md`
