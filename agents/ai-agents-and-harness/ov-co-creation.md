...
source_path: "agents/ov-co-creation.md"
source_url: https://github.com/jayminwest/overstory/blob/HEAD/agents/ov-co-creation.md
---
...
**Source:** [`jayminwest/overstory`](https://github.com/jayminwest/overstory) → `agents/ov-co-creation.md`
