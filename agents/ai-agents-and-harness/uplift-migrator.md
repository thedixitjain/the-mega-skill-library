...
source_path: "plugins/code-modernization/agents/uplift-migrator.md"
source_url: https://github.com/anthropics/claude-plugins-official/blob/HEAD/plugins/code-modernization/agents/uplift-migrator.md
---
...
**Source:** [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) → `plugins/code-modernization/agents/uplift-migrator.md`
