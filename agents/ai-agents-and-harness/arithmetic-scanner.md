...
allowed-tools: "Read Write Grep Glob TodoRead TodoWrite List"
category: ai-agents-and-harness
source_repo: trailofbits/skills
source_path: "plugins/dimensional-analysis/agents/arithmetic-scanner.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/dimensional-analysis/agents/arithmetic-scanner.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/dimensional-analysis/agents/arithmetic-scanner.md`
