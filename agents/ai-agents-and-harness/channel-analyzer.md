...
source_path: "plugins/productivity/youtube-strategy/agents/channel-analyzer.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/productivity/youtube-strategy/agents/channel-analyzer.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/productivity/youtube-strategy/agents/channel-analyzer.md`
