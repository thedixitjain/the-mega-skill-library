...
source_path: ".claude/agents/optimization/load-balancer.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/optimization/load-balancer.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/optimization/load-balancer.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/optimization/load-balancer.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/optimization/load-balancer.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/optimization/load-balancer.md`
