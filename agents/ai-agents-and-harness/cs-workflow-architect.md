...
source_path: "engineering/workflow-builder/agents/cs-workflow-architect.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/workflow-builder/agents/cs-workflow-architect.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/workflow-builder/agents/cs-workflow-architect.md`
