...
source_path: "plugins/gsd/agents/gsd-framework-selector.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/gsd/agents/gsd-framework-selector.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/gsd/agents/gsd-framework-selector.md`
