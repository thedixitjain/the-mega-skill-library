...
allowed-tools: "['codebase', 'terminalCommand']"
model: "gpt-4o"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/agent-governance-reviewer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/agent-governance-reviewer.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/agent-governance-reviewer.agent.md`
