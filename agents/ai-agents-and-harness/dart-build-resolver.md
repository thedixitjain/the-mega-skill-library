...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/dart-build-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/dart-build-resolver.md`
