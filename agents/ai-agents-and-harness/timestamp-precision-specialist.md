...
source_path: "plugins/all-agents/agents/timestamp-precision-specialist.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/timestamp-precision-specialist.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/timestamp-precision-specialist.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-media-content/agents/timestamp-precision-specialist.md`
