...
source_path: "plugins/all-agents/agents/hyperledger-fabric-developer.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/hyperledger-fabric-developer.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/hyperledger-fabric-developer.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-blockchain-web3/agents/hyperledger-fabric-developer.md`
