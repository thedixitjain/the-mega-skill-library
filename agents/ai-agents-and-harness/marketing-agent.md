...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/marketing-agent.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/marketing-agent.md`
