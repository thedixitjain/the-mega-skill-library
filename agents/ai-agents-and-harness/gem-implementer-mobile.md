...
source_path: "agents/gem-implementer-mobile.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-implementer-mobile.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-implementer-mobile.agent.md`
