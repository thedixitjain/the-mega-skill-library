---
name: user-guide-and-customization
description: "This document demonstrates the On-Brand MediaGen Agent in action, showing how 1. users can use the agent and 2. how developers can customize it with their own digital assets and search logic."
category: ai-agents-and-harness
source_repo: google/adk-samples
source_path: "python/agents/on-brand-genmedia/User_Guide_and_Customization.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/python/agents/on-brand-genmedia/User_Guide_and_Customization.md
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `python/agents/on-brand-genmedia/User_Guide_and_Customization.md`
