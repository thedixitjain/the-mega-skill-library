...
source_path: "plugins/all-agents/agents/context-manager.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/context-manager.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/context-manager.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-data-ai/agents/context-manager.md`
