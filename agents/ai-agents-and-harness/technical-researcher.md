...
source_path: "plugins/all-agents/agents/technical-researcher.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/technical-researcher.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/technical-researcher.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-research/agents/technical-researcher.md`
