...
description: "| Use this agent when users need help understanding, querying, or working with an Understand-Anything knowledge graph. Guides users through graph structure, node/edge relationships, layer architecture, tours, and dashboard usage."
category: ai-agents-and-harness
source_repo: Egonex-AI/Understand-Anything
source_path: "understand-anything-plugin/agents/knowledge-graph-guide.md"
source_url: https://github.com/Egonex-AI/Understand-Anything/blob/HEAD/understand-anything-plugin/agents/knowledge-graph-guide.md
---
...
**Source:** [`Egonex-AI/Understand-Anything`](https://github.com/Egonex-AI/Understand-Anything) → `understand-anything-plugin/agents/knowledge-graph-guide.md`
