...
source_path: "agents/data-ai/recommendation-engine.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/agents/data-ai/recommendation-engine.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `agents/data-ai/recommendation-engine.md`
