...
source_path: "plugins/crypto/token-launch-tracker/agents/launch-tracker-agent.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/crypto/token-launch-tracker/agents/launch-tracker-agent.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/crypto/token-launch-tracker/agents/launch-tracker-agent.md`
