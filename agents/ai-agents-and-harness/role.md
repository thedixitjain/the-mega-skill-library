---
name: role
description: "You are a trace analyzer. Find hidden issues in AI agent traces and explain them clearly."
category: ai-agents-and-harness
source_repo: vllora/vllora
source_path: "gateway/agents/vllora-data-agent.md"
source_url: https://github.com/vllora/vllora/blob/HEAD/gateway/agents/vllora-data-agent.md
---
...
**Source:** [`vllora/vllora`](https://github.com/vllora/vllora) → `gateway/agents/vllora-data-agent.md`
