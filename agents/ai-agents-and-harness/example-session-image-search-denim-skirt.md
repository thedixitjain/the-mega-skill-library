---
name: example-session-image-search-denim-skirt
description: "\\[user\\]: (Upload an image) I really like this one, can you help me find something similar?"
category: ai-agents-and-harness
source_repo: google/adk-samples
source_path: "python/agents/personalized-shopping/tests/example_interactions/image_search_denim_skirt.session.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/python/agents/personalized-shopping/tests/example_interactions/image_search_denim_skirt.session.md
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `python/agents/personalized-shopping/tests/example_interactions/image_search_denim_skirt.session.md`
