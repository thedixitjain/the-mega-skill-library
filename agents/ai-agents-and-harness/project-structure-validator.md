...
source_path: ".claude/agents/project-structure-validator.md"
source_url: https://github.com/superset-sh/superset/blob/HEAD/.claude/agents/project-structure-validator.md
---
...
**Source:** [`superset-sh/superset`](https://github.com/superset-sh/superset) → `.claude/agents/project-structure-validator.md`
