...
source_path: "plugins/ruflo-knowledge-graph/agents/graph-navigator.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-knowledge-graph/agents/graph-navigator.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-knowledge-graph/agents/graph-navigator.md`
