...
allowed-tools: "Read Grep Glob TodoRead TodoWrite List Edit"
category: ai-agents-and-harness
source_repo: trailofbits/skills
source_path: "plugins/dimensional-analysis/agents/dimension-propagator.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/dimensional-analysis/agents/dimension-propagator.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/dimensional-analysis/agents/dimension-propagator.md`
