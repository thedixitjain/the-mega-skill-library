...
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/core/researcher.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/core/researcher.md`
