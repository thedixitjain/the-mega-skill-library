---
name: startup-cto-agent-personality
...
source_path: "docs/agents/startup-cto.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/startup-cto.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/startup-cto.md`
