...
source_path: "agents/gem-code-simplifier.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gem-code-simplifier.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gem-code-simplifier.agent.md`
