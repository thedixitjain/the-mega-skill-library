...
source_path: "agents/gitmoji-setup.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gitmoji-setup.agent.md
---
# Gitmoji Setup Agent
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gitmoji-setup.agent.md`
