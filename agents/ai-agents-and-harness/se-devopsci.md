...
source_path: "agents/se-gitops-ci-specialist.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/se-gitops-ci-specialist.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/se-gitops-ci-specialist.agent.md`
