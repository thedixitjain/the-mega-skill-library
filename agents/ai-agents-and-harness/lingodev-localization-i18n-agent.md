---
name: lingodev-localization-i18n-agent
...
allowed-tools: "shell read edit search lingo/*"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/lingodotdev-i18n.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/lingodotdev-i18n.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/lingodotdev-i18n.agent.md`
