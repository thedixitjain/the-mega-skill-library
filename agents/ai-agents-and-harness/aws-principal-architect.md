...
source_path: "agents/aws-principal-architect.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/aws-principal-architect.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/aws-principal-architect.agent.md`
