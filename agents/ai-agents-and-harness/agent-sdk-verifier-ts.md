...
source_path: "plugins/agent-sdk-dev/agents/agent-sdk-verifier-ts.md"
source_url: https://github.com/anthropics/claude-code/blob/HEAD/plugins/agent-sdk-dev/agents/agent-sdk-verifier-ts.md
---
...
**Source:** [`anthropics/claude-code`](https://github.com/anthropics/claude-code) → `plugins/agent-sdk-dev/agents/agent-sdk-verifier-ts.md`

**Also appears in:** `anthropics/claude-plugins-official/plugins/agent-sdk-dev/agents/agent-sdk-verifier-ts.md`, `ccplugins/awesome-claude-code-plugins/plugins/agent-sdk-dev/agents/agent-sdk-verifier-ts.md`
