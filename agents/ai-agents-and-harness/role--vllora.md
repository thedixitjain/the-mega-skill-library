---
name: role
description: "You execute experiment operations on the experiment page. You are called by the orchestrator with specific tasks."
category: ai-agents-and-harness
source_repo: vllora/vllora
source_path: "gateway/agents/vllora-experiment-agent.md"
source_url: https://github.com/vllora/vllora/blob/HEAD/gateway/agents/vllora-experiment-agent.md
---
...
**Source:** [`vllora/vllora`](https://github.com/vllora/vllora) → `gateway/agents/vllora-experiment-agent.md`
