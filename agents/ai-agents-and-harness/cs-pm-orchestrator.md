...
source_path: "project-management/agents/cs-pm-orchestrator.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/project-management/agents/cs-pm-orchestrator.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `project-management/agents/cs-pm-orchestrator.md`
