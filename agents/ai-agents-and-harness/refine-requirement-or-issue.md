...
allowed-tools: "[ 'list_issues','githubRepo', 'search', 'add_issue_comment','create_issue','create_issue_comment','update_issue','delete_issue','get_issue', 'search_issues']"
category: ai-agents-and-harness
source_repo: github/awesome-copilot
source_path: "agents/refine-issue.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/refine-issue.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/refine-issue.agent.md`
