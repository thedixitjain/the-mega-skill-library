...
source_path: "plugins/gsd/agents/gsd-user-profiler.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/gsd/agents/gsd-user-profiler.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/gsd/agents/gsd-user-profiler.md`
