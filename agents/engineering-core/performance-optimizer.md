...
source_path: ".kiro/agents/performance-optimizer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.kiro/agents/performance-optimizer.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.kiro/agents/performance-optimizer.md`
