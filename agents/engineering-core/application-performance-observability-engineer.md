...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/application-performance/agents/observability-engineer.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/application-performance/agents/observability-engineer.md`

**Also appears in:** `wshobson/agents/plugins/observability-monitoring/agents/observability-engineer.md`
