...
source_path: ".claude/agents/sublinear/performance-optimizer.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/sublinear/performance-optimizer.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/sublinear/performance-optimizer.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/sublinear/performance-optimizer.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/sublinear/performance-optimizer.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/sublinear/performance-optimizer.md`
