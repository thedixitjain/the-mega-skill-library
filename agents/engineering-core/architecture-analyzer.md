...
description: "| Analyzes a codebase's file structure, summaries, and import relationships to identify logical architectural layers and assign every file to exactly one layer."
category: engineering-core
source_repo: Egonex-AI/Understand-Anything
source_path: "understand-anything-plugin/agents/architecture-analyzer.md"
source_url: https://github.com/Egonex-AI/Understand-Anything/blob/HEAD/understand-anything-plugin/agents/architecture-analyzer.md
---
...
**Source:** [`Egonex-AI/Understand-Anything`](https://github.com/Egonex-AI/Understand-Anything) → `understand-anything-plugin/agents/architecture-analyzer.md`
