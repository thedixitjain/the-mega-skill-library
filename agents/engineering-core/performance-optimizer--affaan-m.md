...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/performance-optimizer.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/performance-optimizer.md`
