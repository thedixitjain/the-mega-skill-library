...
source_url: https://github.com/addyosmani/agent-skills/blob/HEAD/agents/code-reviewer.md
---
...
**Source:** [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills) → `agents/code-reviewer.md`
