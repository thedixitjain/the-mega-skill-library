...
source_path: "plugins/dotnet-contribution/agents/dotnet-architect.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/dotnet-contribution/agents/dotnet-architect.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/dotnet-contribution/agents/dotnet-architect.md`
