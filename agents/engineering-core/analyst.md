...
source_path: ".claude/agents/analysis/code-analyzer.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/analysis/code-analyzer.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/analysis/code-analyzer.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/analysis/code-analyzer.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/analysis/code-analyzer.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/analysis/code-analyzer.md`
