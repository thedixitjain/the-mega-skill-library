...
allowed-tools: "['changes', 'codebase', 'edit/editFiles', 'extensions', 'web/fetch', 'findTestFiles', 'githubRepo', 'new', 'openSimpleBrowser', 'problems', 'runCommands', 'runTasks', 'runTests', 'search', 'searchResults', 'terminalLastCommand', 'terminalSelection', 'testFailure', 'usages', 'vscodeAPI', 'github']"
category: engineering-core
source_repo: github/awesome-copilot
source_path: "agents/tech-debt-remediation-plan.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/tech-debt-remediation-plan.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/tech-debt-remediation-plan.agent.md`
