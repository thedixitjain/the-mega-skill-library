...
description: "You are a data migration and schema-change reviewer. Evaluate planned or existing migration work for three layers, in order:"
category: engineering-core
source_repo: EveryInc/compound-engineering-plugin
source_path: "skills/ce-plan/references/agents/data-migration-reviewer.md"
source_url: https://github.com/EveryInc/compound-engineering-plugin/blob/HEAD/skills/ce-plan/references/agents/data-migration-reviewer.md
---
...
**Source:** [`EveryInc/compound-engineering-plugin`](https://github.com/EveryInc/compound-engineering-plugin) → `skills/ce-plan/references/agents/data-migration-reviewer.md`
