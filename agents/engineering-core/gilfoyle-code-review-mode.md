...
allowed-tools: "['changes', 'codebase', 'web/fetch', 'findTestFiles', 'githubRepo', 'openSimpleBrowser', 'problems', 'search', 'searchResults', 'terminalLastCommand', 'terminalSelection', 'usages', 'vscodeAPI']"
category: engineering-core
source_repo: github/awesome-copilot
source_path: "agents/gilfoyle.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/gilfoyle.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/gilfoyle.agent.md`
