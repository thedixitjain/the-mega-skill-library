...
source_path: "docs/ko-KR/agents/refactor-cleaner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/agents/refactor-cleaner.md
---
# 리팩토링 & 데드 코드 클리너
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/agents/refactor-cleaner.md`
