...
allowed-tools: "Task, Bash, Glob, Grep, LS, ExitPlanMode, Read, Edit, MultiEdit, Write, NotebookEdit, WebFetch, TodoWrite, WebSearch, BashOutput, KillBash, mcp__ide__getDiagnostics, mcp__ide__executeCode"
model: "sonnet"
category: engineering-core
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/codebase-documenter/agents/codebase-documenter.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/codebase-documenter/agents/codebase-documenter.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/codebase-documenter/agents/codebase-documenter.md`
