...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/application-performance/agents/performance-engineer.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/application-performance/agents/performance-engineer.md`

**Also appears in:** `wshobson/agents/plugins/full-stack-orchestration/agents/performance-engineer.md`, `wshobson/agents/plugins/observability-monitoring/agents/performance-engineer.md`, `wshobson/agents/plugins/performance-testing-review/agents/performance-engineer.md`
