...
source_path: ".claude/agents/MIGRATION_SUMMARY.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/MIGRATION_SUMMARY.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/MIGRATION_SUMMARY.md`
