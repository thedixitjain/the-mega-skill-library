...
source_path: ".claude/agents/sparc/architecture.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/sparc/architecture.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/sparc/architecture.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/sparc/architecture.md`
