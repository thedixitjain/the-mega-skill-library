...
source_path: "docs/tr/agents/refactor-cleaner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/tr/agents/refactor-cleaner.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/tr/agents/refactor-cleaner.md`
