...
source_path: "docs/zh-TW/agents/refactor-cleaner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-TW/agents/refactor-cleaner.md
---
# 重構與無用程式碼清理專家
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-TW/agents/refactor-cleaner.md`
