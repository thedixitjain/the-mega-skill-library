...
source_path: "docs/zh-CN/agents/refactor-cleaner.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/agents/refactor-cleaner.md
---
# 重构与死代码清理器
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/agents/refactor-cleaner.md`
