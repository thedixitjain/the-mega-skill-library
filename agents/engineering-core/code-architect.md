...
source_path: "plugins/code-architect/agents/code-architect.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/code-architect/agents/code-architect.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/code-architect/agents/code-architect.md`
