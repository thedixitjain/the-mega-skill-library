...
source_path: "plugins/code-modernization/agents/business-rules-extractor.md"
source_url: https://github.com/anthropics/claude-plugins-official/blob/HEAD/plugins/code-modernization/agents/business-rules-extractor.md
---
...
**Source:** [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) → `plugins/code-modernization/agents/business-rules-extractor.md`
