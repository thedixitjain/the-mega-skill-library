...
source_path: "plugins/gsd/agents/gsd-debug-session-manager.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/gsd/agents/gsd-debug-session-manager.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/gsd/agents/gsd-debug-session-manager.md`
