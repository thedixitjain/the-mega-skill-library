...
source_path: "plugins/zeroize-audit/agents/3b-rust-compiler-analyzer.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/zeroize-audit/agents/3b-rust-compiler-analyzer.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/zeroize-audit/agents/3b-rust-compiler-analyzer.md`
