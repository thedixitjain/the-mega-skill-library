...
source_path: "docs/es/agents/tdd-guide.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/agents/tdd-guide.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/agents/tdd-guide.md`
