...
source_path: ".claude/agents/templates/migration-plan.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/agents/templates/migration-plan.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/agents/templates/migration-plan.md`
