...
source_path: "engineering-team/playwright-pro/agents/migration-planner.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering-team/playwright-pro/agents/migration-planner.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering-team/playwright-pro/agents/migration-planner.md`
