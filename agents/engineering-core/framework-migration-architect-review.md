...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/framework-migration/agents/architect-review.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/framework-migration/agents/architect-review.md`

**Also appears in:** `wshobson/agents/plugins/comprehensive-review/agents/architect-review.md`
