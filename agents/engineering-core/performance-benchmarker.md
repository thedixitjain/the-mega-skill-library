...
source_path: ".claude/agents/consensus/performance-benchmarker.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/consensus/performance-benchmarker.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/consensus/performance-benchmarker.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/consensus/performance-benchmarker.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/consensus/performance-benchmarker.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/consensus/performance-benchmarker.md`
