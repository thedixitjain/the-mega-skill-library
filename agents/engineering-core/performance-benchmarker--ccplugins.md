...
allowed-tools: "Bash, Read, Write, Grep, MultiEdit, WebFetch"
category: engineering-core
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/performance-benchmarker/agents/performance-benchmarker.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/performance-benchmarker/agents/performance-benchmarker.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/performance-benchmarker/agents/performance-benchmarker.md`
