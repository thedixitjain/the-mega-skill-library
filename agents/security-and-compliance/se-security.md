...
allowed-tools: "['codebase', 'edit/editFiles', 'search', 'problems']"
model: "GPT-5"
category: security-and-compliance
source_repo: github/awesome-copilot
source_path: "agents/se-security-reviewer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/se-security-reviewer.agent.md
---
# Security Reviewer
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/se-security-reviewer.agent.md`
