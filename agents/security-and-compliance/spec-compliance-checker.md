...
source_path: "plugins/spec-to-code-compliance/agents/spec-compliance-checker.md"
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/spec-to-code-compliance/agents/spec-compliance-checker.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/spec-to-code-compliance/agents/spec-compliance-checker.md`
