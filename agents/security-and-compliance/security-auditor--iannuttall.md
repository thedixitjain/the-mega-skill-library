...
allowed-tools: "Task, Bash, Edit, MultiEdit, Write, NotebookEdit"
category: security-and-compliance
source_repo: iannuttall/claude-agents
source_path: "agents/security-auditor.md"
source_url: https://github.com/iannuttall/claude-agents/blob/HEAD/agents/security-auditor.md
---
...
**Source:** [`iannuttall/claude-agents`](https://github.com/iannuttall/claude-agents) → `agents/security-auditor.md`
