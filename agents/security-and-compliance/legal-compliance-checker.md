...
allowed-tools: "Write, Read, MultiEdit, WebSearch, Grep"
category: security-and-compliance
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/legal-compliance-checker/agents/legal-compliance-checker.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/legal-compliance-checker/agents/legal-compliance-checker.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/legal-compliance-checker/agents/legal-compliance-checker.md`
