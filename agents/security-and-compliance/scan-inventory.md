...
source_path: "plugins/claude-security/agents/scan-inventory.md"
source_url: https://github.com/anthropics/claude-plugins-official/blob/HEAD/plugins/claude-security/agents/scan-inventory.md
---
...
**Source:** [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) → `plugins/claude-security/agents/scan-inventory.md`
