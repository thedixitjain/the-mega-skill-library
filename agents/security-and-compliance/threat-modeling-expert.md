...
source_path: "plugins/security-scanning/agents/threat-modeling-expert.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/security-scanning/agents/threat-modeling-expert.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/security-scanning/agents/threat-modeling-expert.md`
