...
source_path: "docs/zh-TW/agents/security-reviewer.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-TW/agents/security-reviewer.md
---
# 安全性審查員
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-TW/agents/security-reviewer.md`
