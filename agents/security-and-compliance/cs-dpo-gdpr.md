...
source_path: "compliance-os/agents/cs-dpo-gdpr.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/compliance-os/agents/cs-dpo-gdpr.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `compliance-os/agents/cs-dpo-gdpr.md`
