...
allowed-tools: "[\"search/codebase\", \"search\", \"edit/editFiles\", \"web/fetch\", \"read/terminalLastCommand\"]"
model: "Claude Sonnet 4.6"
category: security-and-compliance
source_repo: github/awesome-copilot
source_path: "agents/sast-sca-security-analyzer.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/sast-sca-security-analyzer.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/sast-sca-security-analyzer.agent.md`
