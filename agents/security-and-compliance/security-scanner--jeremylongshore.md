...
source_path: "plugins/testing/security-test-scanner/agents/security-scanner.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/testing/security-test-scanner/agents/security-scanner.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/testing/security-test-scanner/agents/security-scanner.md`
