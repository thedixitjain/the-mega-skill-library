...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/security-scanning/agents/security-auditor.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/security-scanning/agents/security-auditor.md`

**Also appears in:** `wshobson/agents/plugins/security-compliance/agents/security-auditor.md`, `wshobson/agents/plugins/comprehensive-review/agents/security-auditor.md`, `wshobson/agents/plugins/full-stack-orchestration/agents/security-auditor.md`
