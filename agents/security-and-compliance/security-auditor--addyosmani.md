...
source_url: https://github.com/addyosmani/agent-skills/blob/HEAD/agents/security-auditor.md
---
# Security Auditor
...
**Source:** [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills) → `agents/security-auditor.md`
