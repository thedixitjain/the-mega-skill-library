...
allowed-tools: "Read, Write, Edit, MultiEdit, Grep, Glob, Bash, LS, WebSearch, WebFetch, Task, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, mcp__sequential-thinking__sequentialthinking, mcp__playwright__browser_navigate, mcp__playwright__browser_snapshot, mcp__playwright__browser_evaluate"
model: "sonnet"
category: security-and-compliance
source_repo: lst97/claude-code-sub-agents
source_path: "agents/security/security-auditor.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/security/security-auditor.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/security/security-auditor.md`
