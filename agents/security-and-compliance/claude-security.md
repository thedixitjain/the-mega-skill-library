...
source_path: "plugins/claude-security/agents/claude-security.md"
source_url: https://github.com/anthropics/claude-plugins-official/blob/HEAD/plugins/claude-security/agents/claude-security.md
---
...
**Source:** [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) → `plugins/claude-security/agents/claude-security.md`
