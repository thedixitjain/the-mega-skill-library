---
name: agent-test-spec-ui-programmer
description: "Domain: Menu screens, HUDs, inventory screens, dialogue boxes, UI framework code, and data binding. Does NOT own: UX flow design (ux-designer), visual style direction (art-director / technical-artist). Model tier: Sonnet (default). No gate IDs assigned."
category: frontend-and-design
source_repo: Donchitos/Claude-Code-Game-Studios
source_path: "CCGS Skill Testing Framework/agents/specialists/ui-programmer.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/CCGS Skill Testing Framework/agents/specialists/ui-programmer.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `CCGS Skill Testing Framework/agents/specialists/ui-programmer.md`
