...
allowed-tools: "['codebase', 'edit/editFiles', 'web/fetch', 'githubRepo', 'figma-dev-mode-mcp-server']"
model: "GPT-4.1"
category: frontend-and-design
source_repo: github/awesome-copilot
source_path: "agents/aem-frontend-specialist.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/aem-frontend-specialist.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/aem-frontend-specialist.agent.md`
