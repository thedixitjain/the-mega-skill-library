...
source_path: "plugins/ux-researcher/agents/ux-researcher.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/ux-researcher/agents/ux-researcher.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/ux-researcher/agents/ux-researcher.md`
