...
source_path: "agents/language-experts/nextjs-developer.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/agents/language-experts/nextjs-developer.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `agents/language-experts/nextjs-developer.md`
