...
source_path: "plugins/all-agents/agents/accessibility-specialist.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-agents/agents/accessibility-specialist.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-agents/agents/accessibility-specialist.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/agents-design-experience/agents/accessibility-specialist.md`
