...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/agents/react-build-resolver.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `agents/react-build-resolver.md`
