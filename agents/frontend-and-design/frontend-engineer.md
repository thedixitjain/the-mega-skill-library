...
source_path: ".claude/agents/frontend-engineer.md"
source_url: https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know/blob/HEAD/.claude/agents/frontend-engineer.md
---
...
**Source:** [`wesammustafa/Claude-Code-Everything-You-Need-to-Know`](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know) → `.claude/agents/frontend-engineer.md`
