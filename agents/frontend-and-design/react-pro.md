...
allowed-tools: "Read, Write, Edit, MultiEdit, Grep, Glob, Bash, LS, WebFetch, WebSearch, Task, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, mcp__magic__21st_magic_component_builder, mcp__magic__21st_magic_component_inspiration, mcp__magic__21st_magic_component_refiner"
model: "sonnet"
category: frontend-and-design
source_repo: lst97/claude-code-sub-agents
source_path: "agents/development/react-pro.md"
source_url: https://github.com/lst97/claude-code-sub-agents/blob/HEAD/agents/development/react-pro.md
---
...
**Source:** [`lst97/claude-code-sub-agents`](https://github.com/lst97/claude-code-sub-agents) → `agents/development/react-pro.md`
