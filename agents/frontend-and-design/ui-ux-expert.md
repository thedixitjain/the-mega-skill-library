...
source_path: "plugins/packages/fullstack-starter-pack/agents/ui-ux-expert.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/packages/fullstack-starter-pack/agents/ui-ux-expert.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/packages/fullstack-starter-pack/agents/ui-ux-expert.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/packages/fullstack-starter-pack/plugins/01-frontend/agents/ui-ux-expert.md`
