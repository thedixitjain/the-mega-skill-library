...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/accessibility-compliance/agents/ui-visual-validator.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/accessibility-compliance/agents/ui-visual-validator.md`
