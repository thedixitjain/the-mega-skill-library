---
name: design-review
description: ">- Expert design reviewer for web UI. Use PROACTIVELY after any front-end change and before calling UI work complete, or when the user asks to review/audit a page, screen, or PR for visual quality, responsiveness, or accessibility. Drives a real browser (Playwright MCP) across viewports, checks WCAG 2.1 AA, and returns ranked, evidence-based findings."
allowed-tools: "mcp__playwright, mcp__chrome-devtools, Read, Grep, Glob, Bash"
model: "sonnet"
category: frontend-and-design
source_repo: nextlevelbuilder/ui-ux-pro-max-skill
source_path: "stack/.claude/agents/design-review.md"
source_url: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/HEAD/stack/.claude/agents/design-review.md
---
...
**Source:** [`nextlevelbuilder/ui-ux-pro-max-skill`](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) → `stack/.claude/agents/design-review.md`
