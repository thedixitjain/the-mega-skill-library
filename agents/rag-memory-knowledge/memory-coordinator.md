...
source_path: ".claude/agents/templates/memory-coordinator.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/agents/templates/memory-coordinator.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/agents/templates/memory-coordinator.md`

**Also appears in:** `ruvnet/ruflo/.claude/agents/templates/memory-coordinator.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/agents/templates/memory-coordinator.md`, `ruvnet/ruflo/v3/@claude-flow/mcp/.claude/agents/templates/memory-coordinator.md`
