...
source_path: "plugins/llm-application-dev/agents/vector-database-engineer.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/llm-application-dev/agents/vector-database-engineer.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/llm-application-dev/agents/vector-database-engineer.md`
