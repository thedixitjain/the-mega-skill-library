...
allowed-tools: "['codebase', 'githubRepo', 'create_issue', 'update_issue', 'list_issues', 'search_issues']"
model: "GPT-5"
category: product-and-pm
source_repo: github/awesome-copilot
source_path: "agents/se-product-manager-advisor.agent.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/agents/se-product-manager-advisor.agent.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `agents/se-product-manager-advisor.agent.md`
