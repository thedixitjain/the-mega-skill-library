...
source_path: "docs/agents/cs-product-manager.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-product-manager.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-product-manager.md`
