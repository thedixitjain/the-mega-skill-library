...
source_path: "agents/product/cs-product-analyst.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/agents/product/cs-product-analyst.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `agents/product/cs-product-analyst.md`
