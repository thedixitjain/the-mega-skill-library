...
source_path: "agents/product/cs-agile-product-owner.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/agents/product/cs-agile-product-owner.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `agents/product/cs-agile-product-owner.md`
