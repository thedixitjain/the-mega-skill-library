---
name: agile-product-owner-agent
...
source_path: "docs/agents/cs-agile-product-owner.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/docs/agents/cs-agile-product-owner.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `docs/agents/cs-agile-product-owner.md`
