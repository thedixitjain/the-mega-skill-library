...
allowed-tools: "Task, Bash, Grep, LS, Read, Write, WebSearch, Glob"
category: product-and-pm
source_repo: iannuttall/claude-agents
source_path: "agents/prd-writer.md"
source_url: https://github.com/iannuttall/claude-agents/blob/HEAD/agents/prd-writer.md
---
...
**Source:** [`iannuttall/claude-agents`](https://github.com/iannuttall/claude-agents) → `agents/prd-writer.md`
