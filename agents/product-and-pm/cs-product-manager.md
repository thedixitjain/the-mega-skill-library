...
source_path: "agents/product/cs-product-manager.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/agents/product/cs-product-manager.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `agents/product/cs-product-manager.md`
