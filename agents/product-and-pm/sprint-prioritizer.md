...
allowed-tools: "Write, Read, TodoWrite, Grep"
category: product-and-pm
source_repo: ccplugins/awesome-claude-code-plugins
source_path: "plugins/sprint-prioritizer/agents/sprint-prioritizer.md"
source_url: https://github.com/ccplugins/awesome-claude-code-plugins/blob/HEAD/plugins/sprint-prioritizer/agents/sprint-prioritizer.md
---
...
**Source:** [`ccplugins/awesome-claude-code-plugins`](https://github.com/ccplugins/awesome-claude-code-plugins) → `plugins/sprint-prioritizer/agents/sprint-prioritizer.md`
