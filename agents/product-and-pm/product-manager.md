...
source_path: "agents/personas/product-manager.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/agents/personas/product-manager.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `agents/personas/product-manager.md`
