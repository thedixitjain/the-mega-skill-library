...
source_path: "docs/ja-JP/skills/agent-architecture-audit/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/agent-architecture-audit/SKILL.md
---
# エージェントアーキテクチャ監査
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/agent-architecture-audit/SKILL.md`
