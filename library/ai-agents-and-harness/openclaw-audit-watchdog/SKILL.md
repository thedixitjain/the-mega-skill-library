...
source_path: "skills/openclaw-audit-watchdog/SKILL.md"
source_url: https://github.com/prompt-security/clawsec/blob/HEAD/skills/openclaw-audit-watchdog/SKILL.md
---
...
**Source:** [`prompt-security/clawsec`](https://github.com/prompt-security/clawsec) → `skills/openclaw-audit-watchdog/SKILL.md`
