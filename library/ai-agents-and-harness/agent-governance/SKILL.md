...
source_path: "skills/agent-governance/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/agent-governance/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/agent-governance/SKILL.md`
