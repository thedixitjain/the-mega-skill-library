...
source_path: "plugins/agent-teams/skills/team-communication-protocols/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/agent-teams/skills/team-communication-protocols/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/agent-teams/skills/team-communication-protocols/SKILL.md`
