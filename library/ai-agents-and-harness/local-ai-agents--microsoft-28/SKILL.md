...
description: "Aktivera denna färdighet när en lärande vill: - Köra en agent helt på enheten för integritet, kostnad eller offline-anledningar. - Servera en modell lokalt med Foundry Local och anslut via OpenAI-kompatibel endpoint. - Använda en Qwen funktionsanropsmodell för att driva pålitliga lokala verktygsanrop. - Lägga till lokal RAG (Chroma) eller en lokal MCP-server. - Designa en hybrid lokal/molnruttstrategi."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/sv/.agents/skills/local-ai-agents/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/sv/.agents/skills/local-ai-agents/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/sv/.agents/skills/local-ai-agents/SKILL.md`
