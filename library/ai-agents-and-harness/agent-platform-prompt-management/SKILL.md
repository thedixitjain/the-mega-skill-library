...
source_path: "skills/cloud/agent-platform-prompt-management/SKILL.md"
source_url: https://github.com/google/skills/blob/HEAD/skills/cloud/agent-platform-prompt-management/SKILL.md
---
...
**Source:** [`google/skills`](https://github.com/google/skills) → `skills/cloud/agent-platform-prompt-management/SKILL.md`
