...
source_path: "skills/gateguard/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/gateguard/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/gateguard/SKILL.md`
