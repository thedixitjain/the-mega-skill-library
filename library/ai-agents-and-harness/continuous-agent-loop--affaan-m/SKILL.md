...
source_path: "docs/zh-CN/skills/continuous-agent-loop/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/continuous-agent-loop/SKILL.md
---
# 持续代理循环
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/continuous-agent-loop/SKILL.md`
