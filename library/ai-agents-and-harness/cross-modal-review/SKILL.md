...
allowed-tools: "search query get_page"
category: ai-agents-and-harness
source_repo: garrytan/gbrain
source_path: "skills/cross-modal-review/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/cross-modal-review/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/cross-modal-review/SKILL.md`
