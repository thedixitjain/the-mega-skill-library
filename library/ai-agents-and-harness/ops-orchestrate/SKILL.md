...
allowed-tools: "Bash Read Write Edit Grep Glob Agent AskUserQuestion TeamCreate SendMessage TaskCreate TaskUpdate TaskGet TaskList TaskStop TaskOutput Monitor WebFetch WebSearch EnterPlanMode ExitPlanMode CronCreate CronList LSP mcp__sentry__search_issues mcp__linear__list_issues mcp__linear__update_issue mcp__linear__create_issue"
model: "claude-opus-4-6"
category: ai-agents-and-harness
source_repo: davepoon/buildwithclaude
source_path: "plugins/claude-ops/skills/ops-orchestrate/SKILL.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/claude-ops/skills/ops-orchestrate/SKILL.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/claude-ops/skills/ops-orchestrate/SKILL.md`
