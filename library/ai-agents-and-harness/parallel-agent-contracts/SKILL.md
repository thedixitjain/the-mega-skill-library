...
source_path: ".claude/skills/parallel-agent-contracts/SKILL.md"
source_url: https://github.com/parcadei/Continuous-Claude-v3/blob/HEAD/.claude/skills/parallel-agent-contracts/SKILL.md
---
...
**Source:** [`parcadei/Continuous-Claude-v3`](https://github.com/parcadei/Continuous-Claude-v3) → `.claude/skills/parallel-agent-contracts/SKILL.md`
