...
source_path: ".agents/skills/dev/SKILL.md"
source_url: https://github.com/slopus/happy/blob/HEAD/.agents/skills/dev/SKILL.md
---
...
**Source:** [`slopus/happy`](https://github.com/slopus/happy) → `.agents/skills/dev/SKILL.md`
