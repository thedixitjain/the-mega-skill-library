...
source_path: "docs/ja-JP/skills/data-scraper-agent/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/data-scraper-agent/SKILL.md
---
# データスクレイパーエージェント
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/data-scraper-agent/SKILL.md`
