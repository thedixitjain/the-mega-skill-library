...
source_path: ".claude/skills/context-mode-ops/SKILL.md"
source_url: https://github.com/mksglu/context-mode/blob/HEAD/.claude/skills/context-mode-ops/SKILL.md
---
...
**Source:** [`mksglu/context-mode`](https://github.com/mksglu/context-mode) → `.claude/skills/context-mode-ops/SKILL.md`
