...
description: "| Always-on ambient signal capture. Fires on every inbound message to detect original thinking and entity mentions. Spawn as a cheap sub-agent in parallel, never block the main response."
allowed-tools: "search query get_page put_page add_link add_timeline_entry"
category: ai-agents-and-harness
source_repo: garrytan/gbrain
source_path: "skills/signal-detector/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/signal-detector/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/signal-detector/SKILL.md`
