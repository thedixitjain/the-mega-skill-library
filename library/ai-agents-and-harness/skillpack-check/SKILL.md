...
source_path: "skills/skillpack-check/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/skillpack-check/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/skillpack-check/SKILL.md`
