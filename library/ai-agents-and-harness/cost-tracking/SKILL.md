...
source_path: "skills/cost-tracking/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/cost-tracking/SKILL.md
---
# Cost Tracking
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/cost-tracking/SKILL.md`
