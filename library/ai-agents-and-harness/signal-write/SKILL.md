...
source_path: "skills/signal-write/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/signal-write/SKILL.md
---
# Agent Signals
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/signal-write/SKILL.md`
