...
source_path: "skills/folder-specific-claude-and-agents-md/SKILL.md"
source_url: https://github.com/sickn33/agentic-awesome-skills/blob/HEAD/skills/folder-specific-claude-and-agents-md/SKILL.md
---
...
**Source:** [`sickn33/agentic-awesome-skills`](https://github.com/sickn33/agentic-awesome-skills) → `skills/folder-specific-claude-and-agents-md/SKILL.md`

**Also appears in:** `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills/skills/folder-specific-claude-and-agents-md/SKILL.md`, `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills-claude/skills/folder-specific-claude-and-agents-md/SKILL.md`
