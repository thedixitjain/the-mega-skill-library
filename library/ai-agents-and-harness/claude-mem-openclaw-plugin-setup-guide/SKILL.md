...
description: "This guide walks through setting up the claude-mem plugin on an OpenClaw gateway. By the end, your agents will have persistent memory across sessions via system prompt context injection, and optionally a real-time observation feed streaming to a messaging channel."
category: ai-agents-and-harness
source_repo: thedotmack/claude-mem
source_path: "openclaw/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/openclaw/SKILL.md
---
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `openclaw/SKILL.md`
