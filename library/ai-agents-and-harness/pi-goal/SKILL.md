...
source_path: "packages/pi-goal/SKILL.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/pi-goal/SKILL.md
---
# pi-goal
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/pi-goal/SKILL.md`
