...
source_path: "skills/cloud/gemini-agents-api/SKILL.md"
source_url: https://github.com/google/skills/blob/HEAD/skills/cloud/gemini-agents-api/SKILL.md
---
...
**Source:** [`google/skills`](https://github.com/google/skills) → `skills/cloud/gemini-agents-api/SKILL.md`
