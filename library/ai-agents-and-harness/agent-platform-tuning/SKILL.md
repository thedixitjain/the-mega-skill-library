...
source_path: "skills/cloud/agent-platform-tuning/SKILL.md"
source_url: https://github.com/google/skills/blob/HEAD/skills/cloud/agent-platform-tuning/SKILL.md
---
...
**Source:** [`google/skills`](https://github.com/google/skills) → `skills/cloud/agent-platform-tuning/SKILL.md`
