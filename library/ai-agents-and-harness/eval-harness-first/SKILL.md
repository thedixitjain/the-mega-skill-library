...
source_path: "plugins/llm-finetuning/skills/eval-harness-first/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/llm-finetuning/skills/eval-harness-first/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/llm-finetuning/skills/eval-harness-first/SKILL.md`
