...
source_path: "optional-skills/migration/openclaw-migration/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/optional-skills/migration/openclaw-migration/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `optional-skills/migration/openclaw-migration/SKILL.md`
