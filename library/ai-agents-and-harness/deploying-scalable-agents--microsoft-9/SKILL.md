...
description: "Aktiveerige see oskus, kui õppija soovib: - Juurutada agent Microsoft Foundry’s hostitud agent-ina ja muuta see versioonihaldatavaks/jälgitavaks. - Valida kliendipoolse hostimise, hostitud agendi ja agentide töövoo vahel. - Lisada mudeli marsruutimine, vastuse vahemällu salvestamine või piiratud paralleelsus latentsuse ja kulude juhtimiseks. - Lisada hinnangukontrollpunkt, et halb agentide versioon ei saaks välja tulla."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/et/.agents/skills/deploying-scalable-agents/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/et/.agents/skills/deploying-scalable-agents/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/et/.agents/skills/deploying-scalable-agents/SKILL.md`
