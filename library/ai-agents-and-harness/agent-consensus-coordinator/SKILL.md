...
source_path: ".agents/skills/agent-consensus-coordinator/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.agents/skills/agent-consensus-coordinator/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.agents/skills/agent-consensus-coordinator/SKILL.md`
