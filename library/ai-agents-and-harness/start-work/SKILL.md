...
source_path: "packages/shared-skills/skills/start-work/SKILL.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/shared-skills/skills/start-work/SKILL.md
---
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/shared-skills/skills/start-work/SKILL.md`
