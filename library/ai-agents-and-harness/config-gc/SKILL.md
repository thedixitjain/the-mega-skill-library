...
source_path: "skills/config-gc/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/config-gc/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/config-gc/SKILL.md`
