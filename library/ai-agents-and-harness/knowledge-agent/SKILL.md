...
source_path: "plugin/skills/knowledge-agent/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/knowledge-agent/SKILL.md
---
# Knowledge Agent
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/knowledge-agent/SKILL.md`
