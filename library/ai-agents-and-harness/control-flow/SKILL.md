...
source_path: ".agents/skills/control-flow/SKILL.md"
source_url: https://github.com/slopus/happy/blob/HEAD/.agents/skills/control-flow/SKILL.md
---
...
**Source:** [`slopus/happy`](https://github.com/slopus/happy) → `.agents/skills/control-flow/SKILL.md`
