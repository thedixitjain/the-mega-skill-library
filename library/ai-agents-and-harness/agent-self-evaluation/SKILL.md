...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/agent-self-evaluation/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/agent-self-evaluation/SKILL.md`
