...
source_path: ".agents/skills/agent-matrix-optimizer/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.agents/skills/agent-matrix-optimizer/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.agents/skills/agent-matrix-optimizer/SKILL.md`
