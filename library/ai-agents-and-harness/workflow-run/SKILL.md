...
source_path: "plugins/ruflo-workflows/skills/workflow-run/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-workflows/skills/workflow-run/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-workflows/skills/workflow-run/SKILL.md`
