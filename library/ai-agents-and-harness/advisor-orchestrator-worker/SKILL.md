...
source_path: "agent_skills/advisor-orchestrator-worker/SKILL.md"
source_url: https://github.com/Shubhamsaboo/awesome-llm-apps/blob/HEAD/agent_skills/advisor-orchestrator-worker/SKILL.md
---
...
**Source:** [`Shubhamsaboo/awesome-llm-apps`](https://github.com/Shubhamsaboo/awesome-llm-apps) → `agent_skills/advisor-orchestrator-worker/SKILL.md`
