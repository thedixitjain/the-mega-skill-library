...
source_path: "plugins/openclaw/SKILL.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/plugins/openclaw/SKILL.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `plugins/openclaw/SKILL.md`
