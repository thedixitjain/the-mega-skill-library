...
source_path: "skills/swarm-planner/SKILL.md"
source_url: https://github.com/am-will/codex-skills/blob/HEAD/skills/swarm-planner/SKILL.md
---
...
**Source:** [`am-will/codex-skills`](https://github.com/am-will/codex-skills) → `skills/swarm-planner/SKILL.md`
