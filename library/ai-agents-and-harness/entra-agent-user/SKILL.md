...
source_path: "skills/entra-agent-user/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/entra-agent-user/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/entra-agent-user/SKILL.md`
