...
allowed-tools: "search query get_page put_page add_link add_timeline_entry sync_brain"
category: ai-agents-and-harness
source_repo: garrytan/gbrain
source_path: "skills/cold-start/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/cold-start/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/cold-start/SKILL.md`
