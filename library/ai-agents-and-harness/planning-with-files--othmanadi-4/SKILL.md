...
source_path: ".factory/skills/planning-with-files/SKILL.md"
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/.factory/skills/planning-with-files/SKILL.md
---
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `.factory/skills/planning-with-files/SKILL.md`
