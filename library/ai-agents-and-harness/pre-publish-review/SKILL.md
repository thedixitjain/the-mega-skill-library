...
source_path: ".agents/skills/pre-publish-review/SKILL.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/.agents/skills/pre-publish-review/SKILL.md
---
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `.agents/skills/pre-publish-review/SKILL.md`

**Also appears in:** `code-yeongyu/oh-my-openagent/.opencode/skills/pre-publish-review/SKILL.md`
