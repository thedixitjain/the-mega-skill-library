...
description: "Activează această competență când un cursant dorește să: - Implementeze un agent în Microsoft Foundry ca agent găzduit și să-l facă versionat/observabil. - Aleagă între modele de implementare client-hosted, hosted-agent și agent-workflow. - Adauge routare de model, stocare în cache a răspunsurilor, sau concurență limitată pentru a controla latența și costul. - Adauge o poartă de evaluare pentru ca o versiune proastă a agentului să nu fie livrată."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ro/.agents/skills/deploying-scalable-agents/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ro/.agents/skills/deploying-scalable-agents/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ro/.agents/skills/deploying-scalable-agents/SKILL.md`
