...
source_path: "plugin/skills/weekly-digests/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/weekly-digests/SKILL.md
---
# Weekly Digests
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/weekly-digests/SKILL.md`
