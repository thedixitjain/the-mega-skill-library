...
source_path: "plugins/agent-teams/skills/task-coordination-strategies/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/agent-teams/skills/task-coordination-strategies/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/agent-teams/skills/task-coordination-strategies/SKILL.md`
