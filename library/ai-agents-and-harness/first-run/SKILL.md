...
source_path: "computer-use-best-practices/.claude/skills/first-run/SKILL.md"
source_url: https://github.com/anthropics/claude-quickstarts/blob/HEAD/computer-use-best-practices/.claude/skills/first-run/SKILL.md
---
...
**Source:** [`anthropics/claude-quickstarts`](https://github.com/anthropics/claude-quickstarts) → `computer-use-best-practices/.claude/skills/first-run/SKILL.md`
