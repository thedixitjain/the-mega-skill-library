...
source_path: ".cursor/skills/planning-with-files/SKILL.md"
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/.cursor/skills/planning-with-files/SKILL.md
---
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `.cursor/skills/planning-with-files/SKILL.md`
