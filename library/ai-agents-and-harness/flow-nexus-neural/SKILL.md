...
source_path: ".agents/skills/flow-nexus-neural/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.agents/skills/flow-nexus-neural/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.agents/skills/flow-nexus-neural/SKILL.md`
