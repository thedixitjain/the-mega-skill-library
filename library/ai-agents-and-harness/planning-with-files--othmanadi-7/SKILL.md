...
source_path: ".opencode/skills/planning-with-files/SKILL.md"
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/.opencode/skills/planning-with-files/SKILL.md
---
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `.opencode/skills/planning-with-files/SKILL.md`
