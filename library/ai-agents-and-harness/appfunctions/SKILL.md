...
source_path: "device-ai/appfunctions/SKILL.md"
source_url: https://github.com/android/skills/blob/HEAD/device-ai/appfunctions/SKILL.md
---
...
**Source:** [`android/skills`](https://github.com/android/skills) → `device-ai/appfunctions/SKILL.md`
