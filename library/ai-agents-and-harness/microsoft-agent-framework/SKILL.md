...
source_path: "skills/microsoft-agent-framework/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/microsoft-agent-framework/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/microsoft-agent-framework/SKILL.md`
