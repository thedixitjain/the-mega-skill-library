...
source_path: "docs/zh-CN/skills/agent-payment-x402/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/agent-payment-x402/SKILL.md
---
# 代理支付执行 (x402)
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/agent-payment-x402/SKILL.md`
