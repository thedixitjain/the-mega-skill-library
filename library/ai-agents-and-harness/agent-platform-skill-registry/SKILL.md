...
source_path: "skills/cloud/agent-platform-skill-registry/SKILL.md"
source_url: https://github.com/google/skills/blob/HEAD/skills/cloud/agent-platform-skill-registry/SKILL.md
---
...
**Source:** [`google/skills`](https://github.com/google/skills) → `skills/cloud/agent-platform-skill-registry/SKILL.md`
