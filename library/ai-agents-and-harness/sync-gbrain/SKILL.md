...
source_path: "sync-gbrain/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/sync-gbrain/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `sync-gbrain/SKILL.md`
