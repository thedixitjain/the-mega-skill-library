...
source_path: "docs/zh-CN/skills/llm-trading-agent-security/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/llm-trading-agent-security/SKILL.md
---
# LLM 交易代理安全
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/llm-trading-agent-security/SKILL.md`
