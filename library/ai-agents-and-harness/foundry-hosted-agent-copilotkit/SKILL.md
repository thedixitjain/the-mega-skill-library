...
source_path: "skills/foundry-hosted-agent-copilotkit/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/foundry-hosted-agent-copilotkit/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/foundry-hosted-agent-copilotkit/SKILL.md`
