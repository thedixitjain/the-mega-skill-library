...
source_path: "pair-agent/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/pair-agent/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `pair-agent/SKILL.md`
