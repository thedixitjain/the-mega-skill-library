...
source_path: "docs/zh-CN/skills/agent-eval/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/agent-eval/SKILL.md
---
# Agent Eval 技能
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/agent-eval/SKILL.md`
