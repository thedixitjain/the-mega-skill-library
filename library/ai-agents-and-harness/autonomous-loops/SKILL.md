...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/autonomous-loops/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/autonomous-loops/SKILL.md`

**Also appears in:** `affaan-m/ECC/.kiro/skills/autonomous-loops/SKILL.md`, `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/autonomous-loops/SKILL.md`
