...
description: "Aktiveeri see oskus, kui õppija soovib: - Käivitada agent täielikult seadmes privaatsuse, kulu või võrguühenduseta tööks. - Teenindada mudelit lokaalselt Foundry Localiga ja ühenduda OpenAI-ühilduva lõpp-punkti kaudu. - Kasutada Qweni funktsioonikutsumise mudelit usaldusväärsete kohalike tööriistakutsete jaoks. - Lisada kohalik RAG (Chroma) või kohalik MCP server. - Kujundada hübriidne lokaalse/pilve marsruutimise strateegia."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/et/.agents/skills/local-ai-agents/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/et/.agents/skills/local-ai-agents/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/et/.agents/skills/local-ai-agents/SKILL.md`
