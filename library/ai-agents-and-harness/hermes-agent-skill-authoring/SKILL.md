...
source_path: "skills/software-development/hermes-agent-skill-authoring/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/skills/software-development/hermes-agent-skill-authoring/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `skills/software-development/hermes-agent-skill-authoring/SKILL.md`
