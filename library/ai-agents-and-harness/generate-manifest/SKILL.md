...
source_path: ".agents/skills/generate-manifest/SKILL.md"
source_url: https://github.com/google/adk-samples/blob/HEAD/.agents/skills/generate-manifest/SKILL.md
---
...
**Source:** [`google/adk-samples`](https://github.com/google/adk-samples) → `.agents/skills/generate-manifest/SKILL.md`
