...
source_path: ".claude/skills/wrap-up/SKILL.md"
source_url: https://github.com/anthropics/launch-your-agent/blob/HEAD/.claude/skills/wrap-up/SKILL.md
---
...
**Source:** [`anthropics/launch-your-agent`](https://github.com/anthropics/launch-your-agent) → `.claude/skills/wrap-up/SKILL.md`
