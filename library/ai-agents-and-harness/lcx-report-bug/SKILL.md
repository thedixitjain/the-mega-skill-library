...
source_path: "packages/omo-codex/plugin/components/lcx/skills/lcx-report-bug/SKILL.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/omo-codex/plugin/components/lcx/skills/lcx-report-bug/SKILL.md
---
# lcx-report-bug
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/omo-codex/plugin/components/lcx/skills/lcx-report-bug/SKILL.md`
