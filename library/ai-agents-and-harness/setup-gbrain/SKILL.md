...
source_path: "setup-gbrain/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/setup-gbrain/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `setup-gbrain/SKILL.md`
