...
source_path: "skills/hierarchical-agent-memory/SKILL.md"
source_url: https://github.com/sickn33/agentic-awesome-skills/blob/HEAD/skills/hierarchical-agent-memory/SKILL.md
---
...
**Source:** [`sickn33/agentic-awesome-skills`](https://github.com/sickn33/agentic-awesome-skills) → `skills/hierarchical-agent-memory/SKILL.md`

**Also appears in:** `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills-claude/skills/hierarchical-agent-memory/SKILL.md`
