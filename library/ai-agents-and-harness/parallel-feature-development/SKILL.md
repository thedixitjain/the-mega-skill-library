...
source_path: "plugins/agent-teams/skills/parallel-feature-development/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/agent-teams/skills/parallel-feature-development/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/agent-teams/skills/parallel-feature-development/SKILL.md`
