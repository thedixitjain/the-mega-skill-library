...
source_path: ".github/skills/entra-agent-id/SKILL.md"
source_url: https://github.com/microsoft/skills/blob/HEAD/.github/skills/entra-agent-id/SKILL.md
---
...
**Source:** [`microsoft/skills`](https://github.com/microsoft/skills) → `.github/skills/entra-agent-id/SKILL.md`
