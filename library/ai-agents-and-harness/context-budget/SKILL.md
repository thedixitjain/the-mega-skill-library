...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/context-budget/SKILL.md
---
# Context Budget
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/context-budget/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/context-budget/SKILL.md`
