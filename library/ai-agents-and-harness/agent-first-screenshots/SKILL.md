...
source_path: ".opencode/skills/agent-first-screenshots/SKILL.md"
source_url: https://github.com/different-ai/openwork/blob/HEAD/.opencode/skills/agent-first-screenshots/SKILL.md
---
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `.opencode/skills/agent-first-screenshots/SKILL.md`
