...
source_path: "plugins/scribe/skills/session-replay/SKILL.md"
source_url: https://github.com/athola/claude-night-market/blob/HEAD/plugins/scribe/skills/session-replay/SKILL.md
---
...
**Source:** [`athola/claude-night-market`](https://github.com/athola/claude-night-market) → `plugins/scribe/skills/session-replay/SKILL.md`
