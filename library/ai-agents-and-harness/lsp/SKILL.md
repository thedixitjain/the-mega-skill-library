...
source_path: "packages/omo-codex/plugin/components/lsp/skills/lsp/SKILL.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/omo-codex/plugin/components/lsp/skills/lsp/SKILL.md
---
# Codex LSP
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/omo-codex/plugin/components/lsp/skills/lsp/SKILL.md`
