...
source_path: "plugins/session-report/skills/session-report/SKILL.md"
source_url: https://github.com/anthropics/claude-plugins-official/blob/HEAD/plugins/session-report/skills/session-report/SKILL.md
---
...
**Source:** [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) → `plugins/session-report/skills/session-report/SKILL.md`
