...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/skill-stocktake/SKILL.md
---
# skill-stocktake
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/skill-stocktake/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/skill-stocktake/SKILL.md`
