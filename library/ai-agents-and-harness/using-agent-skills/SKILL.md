...
source_url: https://github.com/addyosmani/agent-skills/blob/HEAD/skills/using-agent-skills/SKILL.md
---
# Using Agent Skills
...
**Source:** [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills) → `skills/using-agent-skills/SKILL.md`
