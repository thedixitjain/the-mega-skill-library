...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/dmux-workflows/SKILL.md
---
# dmux Workflows
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/dmux-workflows/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/dmux-workflows/SKILL.md`
