...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/data-scraper-agent/SKILL.md
---
# Data Scraper Agent
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/data-scraper-agent/SKILL.md`
