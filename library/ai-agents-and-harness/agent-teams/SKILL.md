...
source_path: "plugins/conjure/skills/agent-teams/SKILL.md"
source_url: https://github.com/athola/claude-night-market/blob/HEAD/plugins/conjure/skills/agent-teams/SKILL.md
---
...
**Source:** [`athola/claude-night-market`](https://github.com/athola/claude-night-market) → `plugins/conjure/skills/agent-teams/SKILL.md`
