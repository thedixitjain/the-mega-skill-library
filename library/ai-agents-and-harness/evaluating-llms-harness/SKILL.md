...
source_path: "skills/mlops/evaluation/evaluating-llms-harness/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/skills/mlops/evaluation/evaluating-llms-harness/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `skills/mlops/evaluation/evaluating-llms-harness/SKILL.md`
