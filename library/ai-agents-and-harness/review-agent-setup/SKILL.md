...
source_path: "plugins/review-agent-governance/skills/review-agent-setup/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/review-agent-governance/skills/review-agent-setup/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/review-agent-governance/skills/review-agent-setup/SKILL.md`
