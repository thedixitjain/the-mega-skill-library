...
source_path: "skills/foundry-agent-sync/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/foundry-agent-sync/SKILL.md
---
# Foundry Agent Sync
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/foundry-agent-sync/SKILL.md`
