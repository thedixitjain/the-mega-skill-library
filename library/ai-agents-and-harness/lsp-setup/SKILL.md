...
source_path: "packages/shared-skills/skills/lsp-setup/SKILL.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/shared-skills/skills/lsp-setup/SKILL.md
---
# LSP Setup
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/shared-skills/skills/lsp-setup/SKILL.md`
