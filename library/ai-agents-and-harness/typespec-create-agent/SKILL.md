...
source_path: "skills/typespec-create-agent/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/typespec-create-agent/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/typespec-create-agent/SKILL.md`
