...
source_path: "Anthropic/Claude Code/bundled-skills/claude-code-docs/SKILL.md"
source_url: https://github.com/asgeirtj/system_prompts_leaks/blob/HEAD/Anthropic/Claude Code/bundled-skills/claude-code-docs/SKILL.md
---
...
**Source:** [`asgeirtj/system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks) → `Anthropic/Claude Code/bundled-skills/claude-code-docs/SKILL.md`
