...
source_url: https://github.com/FrancyJGLisboa/agent-skill-creator/blob/HEAD/SKILL.md
---
...
**Source:** [`FrancyJGLisboa/agent-skill-creator`](https://github.com/FrancyJGLisboa/agent-skill-creator) → `SKILL.md`
