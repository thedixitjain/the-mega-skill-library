...
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/skills/swarm-orchestration/SKILL.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/skills/swarm-orchestration/SKILL.md`
