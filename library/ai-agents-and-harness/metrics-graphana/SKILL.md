...
source_path: ".agents/skills/metrics-graphana/SKILL.md"
source_url: https://github.com/slopus/happy/blob/HEAD/.agents/skills/metrics-graphana/SKILL.md
---
...
**Source:** [`slopus/happy`](https://github.com/slopus/happy) → `.agents/skills/metrics-graphana/SKILL.md`
