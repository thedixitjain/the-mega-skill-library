...
source_path: ".forge/skills/create-agent/SKILL.md"
source_url: https://github.com/tailcallhq/forgecode/blob/HEAD/.forge/skills/create-agent/SKILL.md
---
...
**Source:** [`tailcallhq/forgecode`](https://github.com/tailcallhq/forgecode) → `.forge/skills/create-agent/SKILL.md`
