...
source_path: "skills/agent-architecture-audit/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/agent-architecture-audit/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/agent-architecture-audit/SKILL.md`
