...
source_path: "plugins/analytics/web-analytics/skills/web-analytics/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/analytics/web-analytics/skills/web-analytics/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/analytics/web-analytics/skills/web-analytics/SKILL.md`
