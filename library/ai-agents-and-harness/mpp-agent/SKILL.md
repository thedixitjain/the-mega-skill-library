...
source_path: "optional-skills/payments/mpp-agent/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/optional-skills/payments/mpp-agent/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `optional-skills/payments/mpp-agent/SKILL.md`
