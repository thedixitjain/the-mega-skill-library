...
description: "Attiva questa competenza quando un apprendente vuole: - Eseguire un agente completamente sul dispositivo per motivi di privacy, costo o offline. - Servire un modello localmente con Foundry Local e connettersi tramite l'endpoint compatibile OpenAI. - Usare un modello Qwen per chiamata di funzioni per guidare chiamate affidabili a strumenti locali. - Aggiungere RAG locale (Chroma) o un server MCP locale."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/it/.agents/skills/local-ai-agents/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/it/.agents/skills/local-ai-agents/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/it/.agents/skills/local-ai-agents/SKILL.md`
