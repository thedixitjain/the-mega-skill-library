...
source_path: "docs/ja-JP/skills/agent-payment-x402/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/agent-payment-x402/SKILL.md
---
# エージェント決済実行（x402）
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/agent-payment-x402/SKILL.md`
