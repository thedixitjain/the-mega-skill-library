...
source_path: "skills/extracting-config-from-agent-tesla-rat/SKILL.md"
source_url: https://github.com/mukul975/Anthropic-Cybersecurity-Skills/blob/HEAD/skills/extracting-config-from-agent-tesla-rat/SKILL.md
---
...
**Source:** [`mukul975/Anthropic-Cybersecurity-Skills`](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) → `skills/extracting-config-from-agent-tesla-rat/SKILL.md`
