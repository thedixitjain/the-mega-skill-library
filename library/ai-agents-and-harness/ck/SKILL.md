...
source_path: "skills/ck/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/ck/SKILL.md
---
# ck — Context Keeper
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/ck/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/ck/SKILL.md`
