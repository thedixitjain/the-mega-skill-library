...
allowed-tools: "get_stats get_health sync_brain put_page"
category: ai-agents-and-harness
source_repo: garrytan/gbrain
source_path: "skills/setup/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/setup/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/setup/SKILL.md`
