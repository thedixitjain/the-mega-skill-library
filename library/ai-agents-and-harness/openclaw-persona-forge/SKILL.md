...
source_path: "docs/ja-JP/skills/openclaw-persona-forge/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/openclaw-persona-forge/SKILL.md
---
# 龙虾灵魂锻造炉
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/openclaw-persona-forge/SKILL.md`
