...
source_path: "skills/finalize-agent-prompt/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/finalize-agent-prompt/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/finalize-agent-prompt/SKILL.md`
