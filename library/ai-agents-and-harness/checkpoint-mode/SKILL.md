...
source_path: "agent-skills/checkpoint-mode/SKILL.md"
source_url: https://github.com/asklokesh/loki-mode/blob/HEAD/agent-skills/checkpoint-mode/SKILL.md
---
...
**Source:** [`asklokesh/loki-mode`](https://github.com/asklokesh/loki-mode) → `agent-skills/checkpoint-mode/SKILL.md`
