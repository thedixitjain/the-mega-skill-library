...
source_path: "skills/update-codex/SKILL.md"
source_url: https://github.com/am-will/codex-skills/blob/HEAD/skills/update-codex/SKILL.md
---
...
**Source:** [`am-will/codex-skills`](https://github.com/am-will/codex-skills) → `skills/update-codex/SKILL.md`
