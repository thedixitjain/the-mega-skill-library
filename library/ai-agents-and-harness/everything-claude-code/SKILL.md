...
source_path: ".agents/skills/everything-claude-code/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.agents/skills/everything-claude-code/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.agents/skills/everything-claude-code/SKILL.md`
