...
source_path: "skills/agent-sort/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/agent-sort/SKILL.md
---
# Agent Sort
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/agent-sort/SKILL.md`

**Also appears in:** `affaan-m/ECC/.agents/skills/agent-sort/SKILL.md`
