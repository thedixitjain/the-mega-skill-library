...
source_path: ".agents/skills/dmux-workflows/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.agents/skills/dmux-workflows/SKILL.md
---
# dmux Workflows
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.agents/skills/dmux-workflows/SKILL.md`
