...
source_path: "plugins/incident-response/skills/on-call-handoff-patterns/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/incident-response/skills/on-call-handoff-patterns/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/incident-response/skills/on-call-handoff-patterns/SKILL.md`
