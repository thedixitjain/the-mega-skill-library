...
source_path: ".agents/skills/work-with-pr/SKILL.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/.agents/skills/work-with-pr/SKILL.md
---
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `.agents/skills/work-with-pr/SKILL.md`

**Also appears in:** `code-yeongyu/oh-my-openagent/.opencode/skills/work-with-pr/SKILL.md`
