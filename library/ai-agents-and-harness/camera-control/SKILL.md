---
name: camera-control
description: "> CRITICAL WHILE ARMED: capture, understand NEW image, USE in reasoning, turn-gate record+ready. Blind or theater answers INVALID. Topic irrelevant. Off to disarm."
category: ai-agents-and-harness
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/zfifteen/agent-vision/skills/camera-control/SKILL.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/zfifteen/agent-vision/skills/camera-control/SKILL.md
---
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/zfifteen/agent-vision/skills/camera-control/SKILL.md`
