...
source_path: "plugins/skill-forge-essentials/skills/ai-debt-detector/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/skill-forge-essentials/skills/ai-debt-detector/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/skill-forge-essentials/skills/ai-debt-detector/SKILL.md`
