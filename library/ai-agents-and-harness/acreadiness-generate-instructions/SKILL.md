...
source_path: "skills/acreadiness-generate-instructions/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/acreadiness-generate-instructions/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/acreadiness-generate-instructions/SKILL.md`
