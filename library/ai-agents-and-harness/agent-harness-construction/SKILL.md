...
source_path: "docs/ja-JP/skills/agent-harness-construction/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/agent-harness-construction/SKILL.md
---
# エージェントハーネス構築
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/agent-harness-construction/SKILL.md`
