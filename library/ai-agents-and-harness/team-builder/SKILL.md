...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/team-builder/SKILL.md
---
# Team Builder
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/team-builder/SKILL.md`
