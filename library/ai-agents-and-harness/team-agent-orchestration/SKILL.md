...
source_path: "skills/team-agent-orchestration/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/team-agent-orchestration/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/team-agent-orchestration/SKILL.md`
