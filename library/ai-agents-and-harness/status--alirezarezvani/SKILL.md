...
source_path: "engineering/autoresearch-agent/skills/status/SKILL.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/autoresearch-agent/skills/status/SKILL.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/autoresearch-agent/skills/status/SKILL.md`
