...
source_path: "skills/openclaw-traffic-guardian/SKILL.md"
source_url: https://github.com/prompt-security/clawsec/blob/HEAD/skills/openclaw-traffic-guardian/SKILL.md
---
...
**Source:** [`prompt-security/clawsec`](https://github.com/prompt-security/clawsec) → `skills/openclaw-traffic-guardian/SKILL.md`
