...
source_path: "engineering/autoresearch-agent/skills/loop/SKILL.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/autoresearch-agent/skills/loop/SKILL.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/autoresearch-agent/skills/loop/SKILL.md`
