...
source_path: "plugins/backend-development/skills/saga-orchestration/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/backend-development/skills/saga-orchestration/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/backend-development/skills/saga-orchestration/SKILL.md`
