...
source_path: "examples/skillpack-reference/skills/reference-pack/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/examples/skillpack-reference/skills/reference-pack/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `examples/skillpack-reference/skills/reference-pack/SKILL.md`
