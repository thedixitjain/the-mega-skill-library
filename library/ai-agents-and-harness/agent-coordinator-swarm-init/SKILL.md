...
source_path: ".agents/skills/agent-coordinator-swarm-init/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.agents/skills/agent-coordinator-swarm-init/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.agents/skills/agent-coordinator-swarm-init/SKILL.md`
