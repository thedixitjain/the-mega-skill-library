...
source_path: ".claude/plugins/braintrust-tracing/skills/trace-claude-code/SKILL.md"
source_url: https://github.com/parcadei/Continuous-Claude-v3/blob/HEAD/.claude/plugins/braintrust-tracing/skills/trace-claude-code/SKILL.md
---
...
**Source:** [`parcadei/Continuous-Claude-v3`](https://github.com/parcadei/Continuous-Claude-v3) → `.claude/plugins/braintrust-tracing/skills/trace-claude-code/SKILL.md`
