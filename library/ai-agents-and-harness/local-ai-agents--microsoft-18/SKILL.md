...
description: "Aktiver denne ferdigheten når en lærer ønsker å: - Kjøre en agent helt på enheten for personvern, kostnad eller offline grunner. - Tjene en modell lokalt med Foundry Local og koble til via OpenAI-kompatibelt endepunkt. - Bruke en Qwen-funksjonskall-modell for å drive pålitelige lokale verktøysanrop. - Legge til lokal RAG (Chroma) eller en lokal MCP-server. - Designe en hybrid lokal/sky rutingsstrategi."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/no/.agents/skills/local-ai-agents/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/no/.agents/skills/local-ai-agents/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/no/.agents/skills/local-ai-agents/SKILL.md`
