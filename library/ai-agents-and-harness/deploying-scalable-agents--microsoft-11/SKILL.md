...
description: "Activez cette compétence lorsqu'un apprenant souhaite : - Déployer un agent sur Microsoft Foundry en tant qu'agent hébergé et le rendre versionné/observable. - Choisir entre les modèles de déploiement client-hébergé, agent hébergé et agent-workflow. - Ajouter le routage de modèle, le caching des réponses ou la concurrence limitée pour contrôler la latence et les coûts. - Ajouter une porte d'évaluation afin qu'une mauvaise version d'agent ne puisse pas être mise en production."
category: ai-agents-and-harness
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/fr/.agents/skills/deploying-scalable-agents/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/fr/.agents/skills/deploying-scalable-agents/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/fr/.agents/skills/deploying-scalable-agents/SKILL.md`
