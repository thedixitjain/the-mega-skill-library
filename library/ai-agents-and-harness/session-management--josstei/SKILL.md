...
source_path: "src/skills/shared/session-management/SKILL.md"
source_url: https://github.com/josstei/maestro-orchestrate/blob/HEAD/src/skills/shared/session-management/SKILL.md
---
...
**Source:** [`josstei/maestro-orchestrate`](https://github.com/josstei/maestro-orchestrate) → `src/skills/shared/session-management/SKILL.md`

**Also appears in:** `josstei/maestro-orchestrate/claude/src/skills/shared/session-management/SKILL.md`, `josstei/maestro-orchestrate/plugins/maestro/src/skills/shared/session-management/SKILL.md`
