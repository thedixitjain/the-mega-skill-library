...
source_path: "skills/agent-memory-systems/SKILL.md"
source_url: https://github.com/sickn33/agentic-awesome-skills/blob/HEAD/skills/agent-memory-systems/SKILL.md
---
...
**Source:** [`sickn33/agentic-awesome-skills`](https://github.com/sickn33/agentic-awesome-skills) → `skills/agent-memory-systems/SKILL.md`

**Also appears in:** `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills/skills/agent-memory-systems/SKILL.md`, `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills-claude/skills/agent-memory-systems/SKILL.md`, `sickn33/agentic-awesome-skills/plugins/agentic-bundle-agent-architect/skills/agent-memory-systems/SKILL.md`
