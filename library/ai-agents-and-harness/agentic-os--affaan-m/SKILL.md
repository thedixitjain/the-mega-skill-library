...
source_path: "skills/agentic-os/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/agentic-os/SKILL.md
---
# Agentic OS
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/agentic-os/SKILL.md`
