...
source_path: "plugins/plugin-dev/skills/command-development/SKILL.md"
source_url: https://github.com/anthropics/claude-plugins-official/blob/HEAD/plugins/plugin-dev/skills/command-development/SKILL.md
---
...
**Source:** [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) → `plugins/plugin-dev/skills/command-development/SKILL.md`
