...
source_path: "codex/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/codex/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `codex/SKILL.md`
