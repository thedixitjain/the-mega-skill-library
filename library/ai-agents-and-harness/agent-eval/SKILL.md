...
source_path: "docs/ja-JP/skills/agent-eval/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/agent-eval/SKILL.md
---
# エージェント評価スキル
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/agent-eval/SKILL.md`
