...
source_path: "skills/dynamic-workflow-mode/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/dynamic-workflow-mode/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/dynamic-workflow-mode/SKILL.md`
