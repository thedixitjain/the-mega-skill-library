...
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/skills/reasoningbank-intelligence/SKILL.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/skills/reasoningbank-intelligence/SKILL.md`
