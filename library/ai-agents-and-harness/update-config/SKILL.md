...
source_path: "skills/update-config/SKILL.md"
source_url: https://github.com/Mizoreww/awesome-claude-code-config/blob/HEAD/skills/update-config/SKILL.md
---
...
**Source:** [`Mizoreww/awesome-claude-code-config`](https://github.com/Mizoreww/awesome-claude-code-config) → `skills/update-config/SKILL.md`
