...
source_path: "packages/omo-codex/plugin/components/ulw-loop/skills/ulw-loop/SKILL.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/omo-codex/plugin/components/ulw-loop/skills/ulw-loop/SKILL.md
---
# ulw-loop
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/omo-codex/plugin/components/ulw-loop/skills/ulw-loop/SKILL.md`
