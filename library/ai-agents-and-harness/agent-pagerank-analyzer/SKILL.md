...
source_path: ".agents/skills/agent-pagerank-analyzer/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.agents/skills/agent-pagerank-analyzer/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.agents/skills/agent-pagerank-analyzer/SKILL.md`
