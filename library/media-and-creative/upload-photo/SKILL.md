...
source_path: ".opencode/skills/upload-photo/SKILL.md"
source_url: https://github.com/different-ai/openwork/blob/HEAD/.opencode/skills/upload-photo/SKILL.md
---
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `.opencode/skills/upload-photo/SKILL.md`
