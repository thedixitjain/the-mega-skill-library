...
source_path: "skills/game-engine/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/game-engine/SKILL.md
---
# Game Engine Skill
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/game-engine/SKILL.md`
