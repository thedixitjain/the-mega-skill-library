...
source_path: "skills/publish-to-pages/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/publish-to-pages/SKILL.md
---
# publish-to-pages
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/publish-to-pages/SKILL.md`
