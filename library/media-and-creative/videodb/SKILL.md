...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/videodb/SKILL.md
---
# VideoDB Skill
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/videodb/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/videodb/SKILL.md`
