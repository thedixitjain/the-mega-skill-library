...
source_path: "plugins/saas-packs/klingai-pack/skills/klingai-usage-analytics/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/klingai-pack/skills/klingai-usage-analytics/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/klingai-pack/skills/klingai-usage-analytics/SKILL.md`
