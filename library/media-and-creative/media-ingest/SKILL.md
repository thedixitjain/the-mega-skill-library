---
name: media-ingest
description: "| Ingest video, audio, PDF, book, screenshot, and GitHub repo content into the brain. Multi-format handling with entity extraction and backlink propagation. Covers video-ingest, youtube-ingest, and book-ingest subtypes."
allowed-tools: "search query get_page put_page add_link add_timeline_entry file_upload"
category: media-and-creative
source_repo: garrytan/gbrain
source_path: "skills/media-ingest/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/media-ingest/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/media-ingest/SKILL.md`
