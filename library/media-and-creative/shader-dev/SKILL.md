...
source_path: "skills/shader-dev/SKILL.md"
source_url: https://github.com/MiniMax-AI/skills/blob/HEAD/skills/shader-dev/SKILL.md
---
...
**Source:** [`MiniMax-AI/skills`](https://github.com/MiniMax-AI/skills) → `skills/shader-dev/SKILL.md`
