...
description: "'Implement production pre-recorded speech-to-text with Deepgram. Use when building audio transcription, batch processing, or implementing diarization and intelligence features. Trigger: \"deepgram transcription\", \"speech to text\", \"transcribe audio\", \"batch transcription\", \"deepgram nova\", \"diarize audio\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(pip:*), Grep"
category: media-and-creative
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/deepgram-core-workflow-a/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/deepgram-core-workflow-a/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/deepgram-core-workflow-a/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/deepgram-pack/skills/deepgram-core-workflow-a/SKILL.md`
