...
source_path: "plugin/skills/wowerpoint/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/wowerpoint/SKILL.md
---
# Wowerpoint
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/wowerpoint/SKILL.md`
