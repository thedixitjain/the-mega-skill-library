...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/manim-video/SKILL.md
---
# Manim Video
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/manim-video/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/manim-video/SKILL.md`
