...
source_path: "skills/java-add-graalvm-native-image-support/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/java-add-graalvm-native-image-support/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/java-add-graalvm-native-image-support/SKILL.md`
