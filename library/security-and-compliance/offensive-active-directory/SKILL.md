...
source_url: https://github.com/SnailSploit/Claude-Red/blob/HEAD/Skills/active-directory/offensive-active-directory/SKILL.md
---
...
**Source:** [`SnailSploit/Claude-Red`](https://github.com/SnailSploit/Claude-Red) → `Skills/active-directory/offensive-active-directory/SKILL.md`
