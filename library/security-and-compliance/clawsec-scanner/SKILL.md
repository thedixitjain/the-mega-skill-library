...
source_path: "skills/clawsec-scanner/SKILL.md"
source_url: https://github.com/prompt-security/clawsec/blob/HEAD/skills/clawsec-scanner/SKILL.md
---
# ClawSec Scanner
...
**Source:** [`prompt-security/clawsec`](https://github.com/prompt-security/clawsec) → `skills/clawsec-scanner/SKILL.md`
