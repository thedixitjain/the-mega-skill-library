...
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/insecure-defaults/skills/insecure-defaults/SKILL.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/insecure-defaults/skills/insecure-defaults/SKILL.md`
