...
source_path: "skills/homelab-vlan-segmentation/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/homelab-vlan-segmentation/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/homelab-vlan-segmentation/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/homelab-vlan-segmentation/SKILL.md`
