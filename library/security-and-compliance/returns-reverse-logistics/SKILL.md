...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/returns-reverse-logistics/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/returns-reverse-logistics/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/returns-reverse-logistics/SKILL.md`
