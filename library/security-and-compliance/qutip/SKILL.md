...
source_url: https://github.com/K-Dense-AI/scientific-agent-skills/blob/HEAD/skills/qutip/SKILL.md
---
...
**Source:** [`K-Dense-AI/scientific-agent-skills`](https://github.com/K-Dense-AI/scientific-agent-skills) → `skills/qutip/SKILL.md`
