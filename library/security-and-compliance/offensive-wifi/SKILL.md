...
source_url: https://github.com/SnailSploit/Claude-Red/blob/HEAD/Skills/wireless/offensive-wifi/SKILL.md
---
...
**Source:** [`SnailSploit/Claude-Red`](https://github.com/SnailSploit/Claude-Red) → `Skills/wireless/offensive-wifi/SKILL.md`
