...
source_path: "docs/zh-CN/skills/click-path-audit/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/click-path-audit/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/click-path-audit/SKILL.md`
