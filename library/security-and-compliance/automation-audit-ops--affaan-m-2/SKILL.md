...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/automation-audit-ops/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/automation-audit-ops/SKILL.md`
