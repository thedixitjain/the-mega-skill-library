...
source_path: "engineering/skills/env-secrets-manager/SKILL.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/skills/env-secrets-manager/SKILL.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/skills/env-secrets-manager/SKILL.md`
