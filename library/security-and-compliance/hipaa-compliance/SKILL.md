...
source_path: "skills/hipaa-compliance/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/hipaa-compliance/SKILL.md
---
# HIPAA Compliance
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/hipaa-compliance/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/hipaa-compliance/SKILL.md`
