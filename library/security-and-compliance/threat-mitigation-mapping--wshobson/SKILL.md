...
source_path: "plugins/security-scanning/skills/threat-mitigation-mapping/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/security-scanning/skills/threat-mitigation-mapping/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/security-scanning/skills/threat-mitigation-mapping/SKILL.md`
