...
description: "You are the full marketing audit engine for /market audit <url>. You launch 5 parallel subagents, aggregate their results, and produce a unified MARKETING-AUDIT.md report that is client-ready and revenue-focused."
category: security-and-compliance
source_repo: zubair-trabzada/ai-marketing-claude
source_path: "skills/market-audit/SKILL.md"
source_url: https://github.com/zubair-trabzada/ai-marketing-claude/blob/HEAD/skills/market-audit/SKILL.md
---
...
**Source:** [`zubair-trabzada/ai-marketing-claude`](https://github.com/zubair-trabzada/ai-marketing-claude) → `skills/market-audit/SKILL.md`
