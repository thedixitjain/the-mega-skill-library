...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/network-config-validation/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/network-config-validation/SKILL.md`
