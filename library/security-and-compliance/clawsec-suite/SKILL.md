...
source_path: "skills/clawsec-suite/SKILL.md"
source_url: https://github.com/prompt-security/clawsec/blob/HEAD/skills/clawsec-suite/SKILL.md
---
# ClawSec Suite
...
**Source:** [`prompt-security/clawsec`](https://github.com/prompt-security/clawsec) → `skills/clawsec-suite/SKILL.md`
