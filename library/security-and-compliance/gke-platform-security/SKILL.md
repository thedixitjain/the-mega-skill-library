...
source_path: "skills/cloud/gke-platform-security/SKILL.md"
source_url: https://github.com/google/skills/blob/HEAD/skills/cloud/gke-platform-security/SKILL.md
---
...
**Source:** [`google/skills`](https://github.com/google/skills) → `skills/cloud/gke-platform-security/SKILL.md`
