...
source_path: "plugins/signed-audit-trails/skills/signed-audit-trails-recipe/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/signed-audit-trails/skills/signed-audit-trails-recipe/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/signed-audit-trails/skills/signed-audit-trails-recipe/SKILL.md`
