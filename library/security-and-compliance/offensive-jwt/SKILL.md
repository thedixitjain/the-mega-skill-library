...
source_url: https://github.com/SnailSploit/Claude-Red/blob/HEAD/Skills/auth/offensive-jwt/SKILL.md
---
...
**Source:** [`SnailSploit/Claude-Red`](https://github.com/SnailSploit/Claude-Red) → `Skills/auth/offensive-jwt/SKILL.md`
