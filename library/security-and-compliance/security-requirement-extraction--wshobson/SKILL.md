...
source_path: "plugins/security-scanning/skills/security-requirement-extraction/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/security-scanning/skills/security-requirement-extraction/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/security-scanning/skills/security-requirement-extraction/SKILL.md`
