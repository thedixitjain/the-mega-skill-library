...
source_path: "skills/delivery-gate/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/delivery-gate/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/delivery-gate/SKILL.md`
