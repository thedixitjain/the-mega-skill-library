...
source_path: "plugins/saas-packs/juicebox-pack/skills/juicebox-security-basics/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/juicebox-pack/skills/juicebox-security-basics/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/juicebox-pack/skills/juicebox-security-basics/SKILL.md`
