...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/production-audit/SKILL.md
---
# Production Audit
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/production-audit/SKILL.md`
