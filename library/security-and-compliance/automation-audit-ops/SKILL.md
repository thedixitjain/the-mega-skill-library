...
source_path: "docs/ja-JP/skills/automation-audit-ops/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/automation-audit-ops/SKILL.md
---
# 自動化監査オペレーション
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/automation-audit-ops/SKILL.md`
