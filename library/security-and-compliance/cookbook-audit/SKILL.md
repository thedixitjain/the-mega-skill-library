...
source_path: ".claude/skills/cookbook-audit/SKILL.md"
source_url: https://github.com/anthropics/claude-cookbooks/blob/HEAD/.claude/skills/cookbook-audit/SKILL.md
---
...
**Source:** [`anthropics/claude-cookbooks`](https://github.com/anthropics/claude-cookbooks) → `.claude/skills/cookbook-audit/SKILL.md`
