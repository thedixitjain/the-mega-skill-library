...
description: "\"Implement Webflow data handling \\u2014 CMS content delivery patterns,\\ \\ PII redaction in\\nform submissions, GDPR/CCPA compliance for ecommerce data, and\\ \\ data retention policies.\\nTrigger with phrases like \\\"webflow data\\\", \\\"webflow\\ \\ PII\\\", \\\"webflow GDPR\\\",\\n\\\"webflow data retention\\\", \\\"webflow privacy\\\", \\\"\\ webflow CCPA\\\", \\\"webflow forms data\\\".\\n\""
allowed-tools: "Read, Write, Edit"
category: security-and-compliance
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/webflow-pack/skills/webflow-data-handling/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/webflow-pack/skills/webflow-data-handling/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/webflow-pack/skills/webflow-data-handling/SKILL.md`
