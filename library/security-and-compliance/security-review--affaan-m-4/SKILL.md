...
source_path: "docs/ko-KR/skills/security-review/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/skills/security-review/SKILL.md
---
# 보안 리뷰 스킬
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/skills/security-review/SKILL.md`
