...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/laravel-security/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/laravel-security/SKILL.md`
