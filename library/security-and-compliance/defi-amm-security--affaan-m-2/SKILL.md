...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/defi-amm-security/SKILL.md
---
# DeFi AMM Security
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/defi-amm-security/SKILL.md`
