...
source_path: "plugins/ruflo-browser/skills/browser-auth-flow/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-browser/skills/browser-auth-flow/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-browser/skills/browser-auth-flow/SKILL.md`
