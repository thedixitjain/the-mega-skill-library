...
description: "'Apply security best practices for Apple Notes automation scripts. Trigger: \"apple notes security\". '"
allowed-tools: "Read, Write, Edit, Bash(osascript:*), Grep"
category: security-and-compliance
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/apple-notes-pack/skills/apple-notes-security-basics/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/apple-notes-pack/skills/apple-notes-security-basics/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/apple-notes-pack/skills/apple-notes-security-basics/SKILL.md`
