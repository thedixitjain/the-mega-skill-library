...
source_path: "plugins/saas-packs/replit-pack/skills/replit-install-auth/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/replit-pack/skills/replit-install-auth/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/replit-pack/skills/replit-install-auth/SKILL.md`
