...
source_path: ".opencode/skills/daytona-secrets-volume/SKILL.md"
source_url: https://github.com/different-ai/openwork/blob/HEAD/.opencode/skills/daytona-secrets-volume/SKILL.md
---
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `.opencode/skills/daytona-secrets-volume/SKILL.md`
