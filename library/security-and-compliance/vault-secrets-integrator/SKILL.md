...
description: "'Configure vault secrets integrator operations. Auto-activating skill for DevOps Advanced. Triggers on: vault secrets integrator, vault secrets integrator Part of the DevOps Advanced skill category. Use when working with vault secrets integrator functionality. Trigger with phrases like \"vault secrets integrator\", \"vault integrator\", \"vault\". '"
allowed-tools: "Read, Write, Edit, Bash(cmd:*), Grep"
category: security-and-compliance
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/02-devops-advanced/vault-secrets-integrator/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/02-devops-advanced/vault-secrets-integrator/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/02-devops-advanced/vault-secrets-integrator/SKILL.md`
