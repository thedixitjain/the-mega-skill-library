...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/django-security/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/django-security/SKILL.md`
