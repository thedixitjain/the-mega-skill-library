...
source_url: https://github.com/TheDecipherist/claude-code-mastery/blob/HEAD/skills/security-audit/SKILL.md
---
...
**Source:** [`TheDecipherist/claude-code-mastery`](https://github.com/TheDecipherist/claude-code-mastery) → `skills/security-audit/SKILL.md`
