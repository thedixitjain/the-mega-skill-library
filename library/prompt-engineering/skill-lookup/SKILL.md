...
source_path: "plugins/claude/prompts.chat/skills/skill-lookup/SKILL.md"
source_url: https://github.com/f/prompts.chat/blob/HEAD/plugins/claude/prompts.chat/skills/skill-lookup/SKILL.md
---
...
**Source:** [`f/prompts.chat`](https://github.com/f/prompts.chat) → `plugins/claude/prompts.chat/skills/skill-lookup/SKILL.md`
