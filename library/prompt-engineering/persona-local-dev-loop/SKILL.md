...
description: "'Local development with Persona sandbox, ngrok for webhooks, mock verifications. Use when working with Persona identity verification. Trigger with phrases like \"persona local-dev-loop\", \"persona local-dev-loop\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Grep"
category: prompt-engineering
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/persona-local-dev-loop/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/persona-local-dev-loop/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/persona-local-dev-loop/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/persona-pack/skills/persona-local-dev-loop/SKILL.md`
