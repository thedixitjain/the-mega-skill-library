...
source_path: "skills/noob-mode/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/noob-mode/SKILL.md
---
# Noob Mode
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/noob-mode/SKILL.md`
