...
source_path: "agent-skills/prompt-optimization/SKILL.md"
source_url: https://github.com/asklokesh/loki-mode/blob/HEAD/agent-skills/prompt-optimization/SKILL.md
---
...
**Source:** [`asklokesh/loki-mode`](https://github.com/asklokesh/loki-mode) → `agent-skills/prompt-optimization/SKILL.md`
