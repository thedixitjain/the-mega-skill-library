...
source_path: "ios-debugger-agent/SKILL.md"
source_url: https://github.com/Dimillian/Skills/blob/HEAD/ios-debugger-agent/SKILL.md
---
...
**Source:** [`Dimillian/Skills`](https://github.com/Dimillian/Skills) → `ios-debugger-agent/SKILL.md`
