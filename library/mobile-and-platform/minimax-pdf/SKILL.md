...
source_path: "skills/minimax-pdf/SKILL.md"
source_url: https://github.com/MiniMax-AI/skills/blob/HEAD/skills/minimax-pdf/SKILL.md
---
...
**Source:** [`MiniMax-AI/skills`](https://github.com/MiniMax-AI/skills) → `skills/minimax-pdf/SKILL.md`
