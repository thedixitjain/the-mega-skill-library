...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/kotlin-patterns/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/kotlin-patterns/SKILL.md`

**Also appears in:** `affaan-m/ECC/.kiro/skills/kotlin-patterns/SKILL.md`, `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/kotlin-patterns/SKILL.md`
