...
source_path: "skills/create-spring-boot-kotlin-project/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/create-spring-boot-kotlin-project/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/create-spring-boot-kotlin-project/SKILL.md`
