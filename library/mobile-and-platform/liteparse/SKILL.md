...
source_url: https://github.com/K-Dense-AI/scientific-agent-skills/blob/HEAD/skills/liteparse/SKILL.md
---
...
**Source:** [`K-Dense-AI/scientific-agent-skills`](https://github.com/K-Dense-AI/scientific-agent-skills) → `skills/liteparse/SKILL.md`
