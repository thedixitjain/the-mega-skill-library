...
source_path: "docs/ja-JP/skills/android-clean-architecture/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/android-clean-architecture/SKILL.md
---
# Android クリーンアーキテクチャ
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/android-clean-architecture/SKILL.md`
