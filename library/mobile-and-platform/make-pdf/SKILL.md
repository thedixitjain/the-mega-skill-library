...
source_path: "make-pdf/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/make-pdf/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `make-pdf/SKILL.md`
