...
source_path: "skills/flutter-dev/SKILL.md"
source_url: https://github.com/MiniMax-AI/skills/blob/HEAD/skills/flutter-dev/SKILL.md
---
...
**Source:** [`MiniMax-AI/skills`](https://github.com/MiniMax-AI/skills) → `skills/flutter-dev/SKILL.md`
