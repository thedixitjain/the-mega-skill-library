...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/foundation-models-on-device/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/foundation-models-on-device/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/foundation-models-on-device/SKILL.md`, `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/foundation-models-on-device/SKILL.md`
