...
source_path: "ios-fix/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/ios-fix/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `ios-fix/SKILL.md`
