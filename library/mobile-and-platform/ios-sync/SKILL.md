...
source_path: "ios-sync/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/ios-sync/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `ios-sync/SKILL.md`
