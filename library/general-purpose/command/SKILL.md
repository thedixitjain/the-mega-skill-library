...
source_repo: jaywcjlove/linux-command
source_path: "command/skill.md"
source_url: https://github.com/jaywcjlove/linux-command/blob/HEAD/command/skill.md
---
skill
===
...
**Source:** [`jaywcjlove/linux-command`](https://github.com/jaywcjlove/linux-command) → `command/skill.md`
