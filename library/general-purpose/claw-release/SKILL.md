...
source_path: "skills/claw-release/SKILL.md"
source_url: https://github.com/prompt-security/clawsec/blob/HEAD/skills/claw-release/SKILL.md
---
# Claw Release
...
**Source:** [`prompt-security/clawsec`](https://github.com/prompt-security/clawsec) → `skills/claw-release/SKILL.md`
