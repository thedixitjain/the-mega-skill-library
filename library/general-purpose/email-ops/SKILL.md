...
source_path: "skills/email-ops/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/email-ops/SKILL.md
---
# Email Ops
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/email-ops/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/email-ops/SKILL.md`
