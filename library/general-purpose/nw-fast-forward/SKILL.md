...
source_path: "nWave/skills/nw-fast-forward/SKILL.md"
source_url: https://github.com/nWave-ai/nWave/blob/HEAD/nWave/skills/nw-fast-forward/SKILL.md
---
...
**Source:** [`nWave-ai/nWave`](https://github.com/nWave-ai/nWave) → `nWave/skills/nw-fast-forward/SKILL.md`
