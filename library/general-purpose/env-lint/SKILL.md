...
source_path: "plugins/mturac/env-lint/skills/env-lint/SKILL.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/mturac/env-lint/skills/env-lint/SKILL.md
---
