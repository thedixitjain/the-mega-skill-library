...
source_path: ".claude/skills/consistency-check/SKILL.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/.claude/skills/consistency-check/SKILL.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `.claude/skills/consistency-check/SKILL.md`
