...
source_path: ".claude/skills/llm-tuning-patterns/SKILL.md"
source_url: https://github.com/parcadei/Continuous-Claude-v3/blob/HEAD/.claude/skills/llm-tuning-patterns/SKILL.md
---
...
**Source:** [`parcadei/Continuous-Claude-v3`](https://github.com/parcadei/Continuous-Claude-v3) → `.claude/skills/llm-tuning-patterns/SKILL.md`
