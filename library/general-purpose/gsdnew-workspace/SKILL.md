---
name: gsdnew-workspace
description: "Create an isolated workspace with repo copies and independent .planning/"
allowed-tools: "Read Bash Write AskUserQuestion"
category: general-purpose
source_repo: davepoon/buildwithclaude
source_path: "plugins/gsd/skills/new-workspace/SKILL.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/gsd/skills/new-workspace/SKILL.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/gsd/skills/new-workspace/SKILL.md`
