...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/hookify-rules/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/hookify-rules/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/hookify-rules/SKILL.md`
