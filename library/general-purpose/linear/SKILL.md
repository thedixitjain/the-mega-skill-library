...
source_url: https://github.com/openai/skills/blob/HEAD/skills/.curated/linear/SKILL.md
---
...
**Source:** [`openai/skills`](https://github.com/openai/skills) → `skills/.curated/linear/SKILL.md`

**Also appears in:** `composio-community/awesome-codex-skills/linear/SKILL.md`
