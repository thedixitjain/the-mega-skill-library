...
description: "'Master Cursor keyboard shortcuts and customize keybindings for AI features and editor commands. Triggers on \"cursor shortcuts\", \"cursor keybindings\", \"cursor keyboard\", \"cursor hotkeys\", \"cursor commands\", \"Cmd+K\", \"Cmd+L\", \"Cmd+I\". '"
allowed-tools: "Read, Write, Edit, Bash(cmd:*)"
category: general-purpose
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/cursor-pack/skills/cursor-keybindings/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/cursor-pack/skills/cursor-keybindings/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/cursor-pack/skills/cursor-keybindings/SKILL.md`
