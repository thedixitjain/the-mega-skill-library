...
description: "'Full CRUD on Attio records -- create, read, update, delete, and search across people, companies, deals, and custom objects. Trigger: \"attio records\", \"attio CRUD\", \"create attio record\", \"update attio person\", \"search attio companies\", \"attio objects\". '"
allowed-tools: "Read, Write, Edit, Bash(curl:*), Grep"
category: general-purpose
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/attio-pack/skills/attio-core-workflow-a/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/attio-pack/skills/attio-core-workflow-a/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/attio-pack/skills/attio-core-workflow-a/SKILL.md`
