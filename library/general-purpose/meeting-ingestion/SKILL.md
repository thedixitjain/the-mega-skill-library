...
description: "| Ingest meeting transcripts into brain pages with attendee enrichment, entity propagation, and timeline merge. A meeting is NOT fully ingested until the enrich skill has processed every entity."
allowed-tools: "search query get_page put_page add_link add_timeline_entry"
category: general-purpose
source_repo: garrytan/gbrain
source_path: "skills/meeting-ingestion/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/meeting-ingestion/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/meeting-ingestion/SKILL.md`
