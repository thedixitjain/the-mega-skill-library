...
source_path: ".claude/skills/search-tools/SKILL.md"
source_url: https://github.com/parcadei/Continuous-Claude-v3/blob/HEAD/.claude/skills/search-tools/SKILL.md
---
...
**Source:** [`parcadei/Continuous-Claude-v3`](https://github.com/parcadei/Continuous-Claude-v3) → `.claude/skills/search-tools/SKILL.md`

**Also appears in:** `parcadei/Continuous-Claude-v3/.claude/skills/archive/search-tools/SKILL.md`
