...
source_path: "skills/homelab-network-setup/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/homelab-network-setup/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/homelab-network-setup/SKILL.md`
