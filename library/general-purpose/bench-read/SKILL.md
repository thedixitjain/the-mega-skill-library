...
source_path: "skills/bench-read/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/bench-read/SKILL.md
---
# Bench Read
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/bench-read/SKILL.md`
