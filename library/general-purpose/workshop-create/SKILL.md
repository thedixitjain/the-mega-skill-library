...
source_path: "skills/workshop-create/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/workshop-create/SKILL.md
---
# Create a Workshop
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/workshop-create/SKILL.md`
