...
source_path: ".claude/skills/math/real-analysis/convergence/SKILL.md"
source_url: https://github.com/parcadei/Continuous-Claude-v3/blob/HEAD/.claude/skills/math/real-analysis/convergence/SKILL.md
---
...
**Source:** [`parcadei/Continuous-Claude-v3`](https://github.com/parcadei/Continuous-Claude-v3) → `.claude/skills/math/real-analysis/convergence/SKILL.md`
