...
source_path: "gstack-upgrade/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/gstack-upgrade/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `gstack-upgrade/SKILL.md`
