...
description: "'Understand Finta usage limits and plan tiers. Trigger with phrases like \"finta limits\", \"finta plan limits\". '"
allowed-tools: "Read"
category: general-purpose
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/finta-pack/skills/finta-rate-limits/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/finta-pack/skills/finta-rate-limits/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/finta-pack/skills/finta-rate-limits/SKILL.md`
