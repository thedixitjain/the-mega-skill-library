...
source_path: ".claude/skills/flow-nexus-neural/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.claude/skills/flow-nexus-neural/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.claude/skills/flow-nexus-neural/SKILL.md`

**Also appears in:** `ruvnet/ruflo/v3/@claude-flow/cli/.claude/skills/flow-nexus-neural/SKILL.md`
