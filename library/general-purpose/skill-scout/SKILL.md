...
source_path: "skills/skill-scout/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/skill-scout/SKILL.md
---
# Skill Scout
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/skill-scout/SKILL.md`
