...
allowed-tools: "[claude, cursor, codex, gemini, copilot, windsurf, antigravity]"
category: general-purpose
source_repo: sickn33/agentic-awesome-skills
source_path: "skills/tool-use-guardian/SKILL.md"
source_url: https://github.com/sickn33/agentic-awesome-skills/blob/HEAD/skills/tool-use-guardian/SKILL.md
---
...
**Source:** [`sickn33/agentic-awesome-skills`](https://github.com/sickn33/agentic-awesome-skills) → `skills/tool-use-guardian/SKILL.md`

**Also appears in:** `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills/skills/tool-use-guardian/SKILL.md`, `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills-claude/skills/tool-use-guardian/SKILL.md`
