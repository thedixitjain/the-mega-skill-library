...
source_path: "skills/voice-note-ingest/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/voice-note-ingest/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/voice-note-ingest/SKILL.md`
