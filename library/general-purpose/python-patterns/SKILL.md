...
source_path: ".kiro/skills/python-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.kiro/skills/python-patterns/SKILL.md
---
# Python Patterns
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.kiro/skills/python-patterns/SKILL.md`
