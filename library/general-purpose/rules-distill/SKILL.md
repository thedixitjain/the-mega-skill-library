...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/rules-distill/SKILL.md
---
# Rules Distill
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/rules-distill/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/rules-distill/SKILL.md`
