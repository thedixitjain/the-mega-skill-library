...
description: "'Handle Apple Notes automation rate limits and iCloud sync throttling. Trigger: \"apple notes rate limit\". '"
allowed-tools: "Read, Write, Edit, Bash(osascript:*), Grep"
category: general-purpose
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/apple-notes-pack/skills/apple-notes-rate-limits/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/apple-notes-pack/skills/apple-notes-rate-limits/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/apple-notes-pack/skills/apple-notes-rate-limits/SKILL.md`
