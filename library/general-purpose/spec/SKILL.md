...
source_path: "spec/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/spec/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `spec/SKILL.md`
