...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/dotnet-patterns/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/dotnet-patterns/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/dotnet-patterns/SKILL.md`
