...
source_path: "skills/network-bgp-diagnostics/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/network-bgp-diagnostics/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/network-bgp-diagnostics/SKILL.md`
