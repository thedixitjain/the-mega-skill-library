...
source_path: "plugins/community/skills-janitor/skills/janitor-fix/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/community/skills-janitor/skills/janitor-fix/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/community/skills-janitor/skills/janitor-fix/SKILL.md`
