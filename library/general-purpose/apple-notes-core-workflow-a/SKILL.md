...
source_path: "plugins/saas-packs/apple-notes-pack/skills/apple-notes-core-workflow-a/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/apple-notes-pack/skills/apple-notes-core-workflow-a/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/apple-notes-pack/skills/apple-notes-core-workflow-a/SKILL.md`
