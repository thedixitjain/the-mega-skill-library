...
source_path: "skills/terminal-ops/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/terminal-ops/SKILL.md
---
# Terminal Ops
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/terminal-ops/SKILL.md`
