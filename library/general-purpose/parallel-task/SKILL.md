...
source_path: "skills/parallel-task/SKILL.md"
source_url: https://github.com/am-will/codex-skills/blob/HEAD/skills/parallel-task/SKILL.md
---
...
**Source:** [`am-will/codex-skills`](https://github.com/am-will/codex-skills) → `skills/parallel-task/SKILL.md`
