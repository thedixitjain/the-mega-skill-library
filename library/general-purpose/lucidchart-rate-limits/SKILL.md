...
description: "'Rate Limits for Lucidchart. Trigger: \"lucidchart rate limits\". '"
allowed-tools: "Read, Write, Edit"
category: general-purpose
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/lucidchart-pack/skills/lucidchart-rate-limits/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/lucidchart-pack/skills/lucidchart-rate-limits/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/lucidchart-pack/skills/lucidchart-rate-limits/SKILL.md`
