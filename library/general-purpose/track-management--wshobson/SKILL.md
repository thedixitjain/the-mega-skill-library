...
source_path: "plugins/conductor/skills/track-management/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/conductor/skills/track-management/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/conductor/skills/track-management/SKILL.md`
