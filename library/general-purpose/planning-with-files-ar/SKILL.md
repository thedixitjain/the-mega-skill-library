...
source_path: "skills/planning-with-files-ar/SKILL.md"
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/skills/planning-with-files-ar/SKILL.md
---
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `skills/planning-with-files-ar/SKILL.md`
