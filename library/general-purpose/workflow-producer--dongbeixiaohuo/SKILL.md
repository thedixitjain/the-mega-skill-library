...
source_path: "claude-runtime/skills/workflow-producer/SKILL.md"
source_url: https://github.com/dongbeixiaohuo/writing-agent/blob/HEAD/claude-runtime/skills/workflow-producer/SKILL.md
---
...
**Source:** [`dongbeixiaohuo/writing-agent`](https://github.com/dongbeixiaohuo/writing-agent) → `claude-runtime/skills/workflow-producer/SKILL.md`
