...
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/static-analysis/skills/sarif-parsing/SKILL.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/static-analysis/skills/sarif-parsing/SKILL.md`
