...
source_path: "skills/capture/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/capture/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/capture/SKILL.md`
