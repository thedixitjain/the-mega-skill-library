...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/laravel-tdd/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/laravel-tdd/SKILL.md`
