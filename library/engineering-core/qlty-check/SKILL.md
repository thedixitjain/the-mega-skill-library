...
source_path: ".claude/skills/qlty-check/SKILL.md"
source_url: https://github.com/parcadei/Continuous-Claude-v3/blob/HEAD/.claude/skills/qlty-check/SKILL.md
---
...
**Source:** [`parcadei/Continuous-Claude-v3`](https://github.com/parcadei/Continuous-Claude-v3) → `.claude/skills/qlty-check/SKILL.md`
