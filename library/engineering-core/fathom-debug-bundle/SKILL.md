...
description: "'Collect Fathom API diagnostics for support cases. Trigger with phrases like \"fathom debug\", \"fathom diagnostics\". '"
allowed-tools: "Read, Bash(curl:*), Grep"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/fathom-pack/skills/fathom-debug-bundle/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/fathom-pack/skills/fathom-debug-bundle/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/fathom-pack/skills/fathom-debug-bundle/SKILL.md`
