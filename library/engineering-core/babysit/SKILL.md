...
source_path: "plugin/skills/babysit/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/babysit/SKILL.md
---
# Babysit PR
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/babysit/SKILL.md`
