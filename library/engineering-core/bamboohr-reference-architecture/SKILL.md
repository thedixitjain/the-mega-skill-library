...
description: "'Implement BambooHR reference architecture for production HR data pipelines. Use when designing new BambooHR integrations, building employee sync systems, or establishing architecture standards for BambooHR-powered applications. Trigger with phrases like \"bamboohr architecture\", \"bamboohr design\", \"bamboohr project structure\", \"bamboohr system design\", \"bamboohr pipeline\". '"
allowed-tools: "Read, Grep"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/bamboohr-pack/skills/bamboohr-reference-architecture/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/bamboohr-pack/skills/bamboohr-reference-architecture/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/bamboohr-pack/skills/bamboohr-reference-architecture/SKILL.md`
