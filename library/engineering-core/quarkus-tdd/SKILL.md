...
source_path: "docs/es/skills/quarkus-tdd/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/skills/quarkus-tdd/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/skills/quarkus-tdd/SKILL.md`
