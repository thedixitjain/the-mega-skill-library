...
source_path: "skills/semantic-kernel/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/semantic-kernel/SKILL.md
---
# Semantic Kernel
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/semantic-kernel/SKILL.md`
