...
description: "'Implement BambooHR rate limiting, backoff, and request optimization. Use when handling 429/503 rate limit errors, implementing retry logic, or optimizing API request throughput for BambooHR. Trigger with phrases like \"bamboohr rate limit\", \"bamboohr throttling\", \"bamboohr 429\", \"bamboohr 503\", \"bamboohr retry\", \"bamboohr backoff\". '"
allowed-tools: "Read, Write, Edit"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/bamboohr-pack/skills/bamboohr-rate-limits/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/bamboohr-pack/skills/bamboohr-rate-limits/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/bamboohr-pack/skills/bamboohr-rate-limits/SKILL.md`
