...
description: "'Migrate from OpenAI/Anthropic/other LLM providers to Cohere, or vice versa. Use when switching LLM providers, migrating embeddings between models, or re-platforming existing AI integrations to Cohere API v2. Trigger with phrases like \"migrate to cohere\", \"switch from openai to cohere\", \"cohere migration\", \"replace openai with cohere\", \"cohere replatform\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(node:*), Bash(kubectl:*)"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/cohere-pack/skills/cohere-migration-deep-dive/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/cohere-pack/skills/cohere-migration-deep-dive/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/cohere-pack/skills/cohere-migration-deep-dive/SKILL.md`
