...
source_path: "skills/power-apps-code-app-scaffold/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/power-apps-code-app-scaffold/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/power-apps-code-app-scaffold/SKILL.md`
