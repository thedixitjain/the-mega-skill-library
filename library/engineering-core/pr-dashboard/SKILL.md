...
source_path: "skills/pr-dashboard/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/pr-dashboard/SKILL.md
---
# PR Dashboard
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/pr-dashboard/SKILL.md`
