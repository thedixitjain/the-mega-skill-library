...
source_path: "plugins/claude-code/skills/skillopt-sleep/SKILL.md"
source_url: https://github.com/microsoft/SkillOpt/blob/HEAD/plugins/claude-code/skills/skillopt-sleep/SKILL.md
---
...
**Source:** [`microsoft/SkillOpt`](https://github.com/microsoft/SkillOpt) → `plugins/claude-code/skills/skillopt-sleep/SKILL.md`
