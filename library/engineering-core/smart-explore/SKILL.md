...
source_path: "plugin/skills/smart-explore/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/smart-explore/SKILL.md
---
# Smart Explore
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/smart-explore/SKILL.md`
