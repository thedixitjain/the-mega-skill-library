...
description: "\"Safely upgrade OCI Python SDK and Terraform provider \\u2014 version\\ \\ pinning, breaking change detection, and rollback.\\nUse when upgrading oci pip\\ \\ packages, updating the Terraform OCI provider, or debugging post-upgrade failures.\\n\\ Trigger with \\\"oraclecloud upgrade\\\", \\\"oci sdk upgrade\\\", \\\"oci terraform provider\\ \\ update\\\", \\\"oci version migration\\\".\\n\""
allowed-tools: "Read, Write, Edit, Bash(pip:*), Bash(oci:*), Bash(terraform:*), Bash(python3:*), Grep"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/oraclecloud-upgrade-migration/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/oraclecloud-upgrade-migration/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/oraclecloud-upgrade-migration/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/oraclecloud-pack/skills/oraclecloud-upgrade-migration/SKILL.md`
