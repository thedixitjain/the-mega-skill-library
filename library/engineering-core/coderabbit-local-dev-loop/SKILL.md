...
description: "'Configure CodeRabbit CLI for local pre-commit code reviews and fast iteration. Use when setting up local development with CodeRabbit CLI reviews, integrating AI review into your commit workflow, or testing config changes. Trigger with phrases like \"coderabbit dev setup\", \"coderabbit local development\", \"coderabbit CLI workflow\", \"coderabbit pre-commit review\". '"
allowed-tools: "Read, Write, Edit, Bash(cr:*), Bash(git:*), Bash(npm:*), Grep"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/coderabbit-local-dev-loop/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/coderabbit-local-dev-loop/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/coderabbit-local-dev-loop/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/coderabbit-pack/skills/coderabbit-local-dev-loop/SKILL.md`
