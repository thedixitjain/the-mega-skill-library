...
source_path: "skills/pr-screenshots/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/pr-screenshots/SKILL.md
---
# PR Screenshots
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/pr-screenshots/SKILL.md`
