...
source_path: "skills/creating-oracle-to-postgres-migration-bug-report/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/creating-oracle-to-postgres-migration-bug-report/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/creating-oracle-to-postgres-migration-bug-report/SKILL.md`
