...
source_path: "docs/zh-CN/skills/tdd-workflow/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/tdd-workflow/SKILL.md
---
# 测试驱动开发工作流
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/tdd-workflow/SKILL.md`
