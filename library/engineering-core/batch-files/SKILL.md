...
source_path: "skills/batch-files/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/batch-files/SKILL.md
---
# Batch Files
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/batch-files/SKILL.md`
