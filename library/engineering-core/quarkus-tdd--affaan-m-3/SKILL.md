...
source_path: "skills/quarkus-tdd/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/quarkus-tdd/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/quarkus-tdd/SKILL.md`
