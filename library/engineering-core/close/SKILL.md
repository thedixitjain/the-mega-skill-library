...
source_path: "plugins/aigent-os/skills/close/SKILL.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/aigent-os/skills/close/SKILL.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/aigent-os/skills/close/SKILL.md`
