...
description: "'Execute Mistral AI incident response procedures with triage, mitigation, and postmortem. Use when responding to Mistral AI-related outages, investigating errors, or running post-incident reviews. Trigger with phrases like \"mistral incident\", \"mistral outage\", \"mistral down\", \"mistral on-call\", \"mistral emergency\". '"
allowed-tools: "Read, Grep, Bash(kubectl:*), Bash(curl:*)"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/mistral-pack/skills/mistral-incident-runbook/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/mistral-pack/skills/mistral-incident-runbook/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/mistral-pack/skills/mistral-incident-runbook/SKILL.md`
