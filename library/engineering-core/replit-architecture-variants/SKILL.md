...
description: "'Choose and implement Replit architecture blueprints: single-file script, modular app, and multi-service. Use when designing new Replit apps, choosing the right architecture scale, or planning migration paths as your app grows. Trigger with phrases like \"replit architecture options\", \"replit blueprint\", \"how to structure replit app\", \"replit monolith vs service\", \"replit app scale\". '"
allowed-tools: "Read, Grep"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/replit-pack/skills/replit-architecture-variants/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/replit-pack/skills/replit-architecture-variants/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/replit-pack/skills/replit-architecture-variants/SKILL.md`
