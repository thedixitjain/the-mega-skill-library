...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/plankton-code-quality/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/plankton-code-quality/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/plankton-code-quality/SKILL.md`
