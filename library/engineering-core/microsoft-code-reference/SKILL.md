...
source_path: "skills/microsoft-code-reference/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/microsoft-code-reference/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/microsoft-code-reference/SKILL.md`
