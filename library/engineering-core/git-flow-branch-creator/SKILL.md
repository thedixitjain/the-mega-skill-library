...
source_path: "skills/git-flow-branch-creator/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/git-flow-branch-creator/SKILL.md
---
### Instructions
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/git-flow-branch-creator/SKILL.md`
