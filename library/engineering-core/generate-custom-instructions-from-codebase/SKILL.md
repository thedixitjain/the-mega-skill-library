...
source_path: "skills/generate-custom-instructions-from-codebase/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/generate-custom-instructions-from-codebase/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/generate-custom-instructions-from-codebase/SKILL.md`
