...
source_path: "plugins/semantic-models/skills/power-query/SKILL.md"
source_url: https://github.com/data-goblin/power-bi-agentic-development/blob/HEAD/plugins/semantic-models/skills/power-query/SKILL.md
---
...
**Source:** [`data-goblin/power-bi-agentic-development`](https://github.com/data-goblin/power-bi-agentic-development) → `plugins/semantic-models/skills/power-query/SKILL.md`
