...
description: "\"Procore reference architecture \\u2014 construction management platform\\ \\ integration.\\nUse when working with Procore API for project management, RFIs,\\ \\ or submittals.\\nTrigger with phrases like \\\"procore reference architecture\\\",\\ \\ \\\"procore-reference-architecture\\\".\\n\""
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(pip:*), Bash(curl:*), Grep"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/procore-reference-architecture/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/procore-reference-architecture/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/procore-reference-architecture/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/procore-pack/skills/procore-reference-architecture/SKILL.md`
