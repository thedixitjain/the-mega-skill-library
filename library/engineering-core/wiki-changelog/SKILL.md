...
source_path: ".github/plugins/deep-wiki/skills/wiki-changelog/SKILL.md"
source_url: https://github.com/microsoft/skills/blob/HEAD/.github/plugins/deep-wiki/skills/wiki-changelog/SKILL.md
---
...
**Source:** [`microsoft/skills`](https://github.com/microsoft/skills) → `.github/plugins/deep-wiki/skills/wiki-changelog/SKILL.md`
