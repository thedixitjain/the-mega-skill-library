...
source_path: "plugin/skills/pathfinder/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/pathfinder/SKILL.md
---
# Pathfinder
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/pathfinder/SKILL.md`
