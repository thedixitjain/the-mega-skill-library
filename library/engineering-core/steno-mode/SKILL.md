...
source_path: "skills/steno-mode/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/steno-mode/SKILL.md
---
# Steno Mode
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/steno-mode/SKILL.md`
