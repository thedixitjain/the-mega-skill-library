...
source_path: "plugins/saas-packs/framer-pack/skills/framer-common-errors/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/framer-pack/skills/framer-common-errors/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/framer-pack/skills/framer-common-errors/SKILL.md`
