...
description: "\"Use when planning or executing a migration from SAP Concur or legacy\\ \\ TMC to Navan \\u2014 data migration, user provisioning, policy recreation, and\\ \\ cutover planning.\\nTrigger with \\\"navan migration deep dive\\\" or \\\"migrate to\\ \\ navan from concur\\\".\\n\""
allowed-tools: "Read, Write, Edit, Bash(curl:*), Bash(jq:*), Grep"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/navan-migration-deep-dive/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/navan-migration-deep-dive/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/navan-migration-deep-dive/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/navan-pack/skills/navan-migration-deep-dive/SKILL.md`
