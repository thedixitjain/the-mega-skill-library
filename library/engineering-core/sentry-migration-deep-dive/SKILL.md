...
description: "'Migrate to Sentry from other error tracking tools like Rollbar, Bugsnag, or New Relic. Use when replacing an existing error tracker with Sentry, running tools in parallel during a transition, or mapping API calls between providers. Trigger with phrases like \"migrate to sentry\", \"switch from rollbar to sentry\", \"replace bugsnag with sentry\", \"sentry migration plan\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(npx:*), Bash(node:*), Grep, Glob"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/sentry-migration-deep-dive/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/sentry-migration-deep-dive/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/sentry-migration-deep-dive/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/sentry-pack/skills/sentry-migration-deep-dive/SKILL.md`
