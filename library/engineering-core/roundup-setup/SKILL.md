...
source_path: "skills/roundup-setup/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/roundup-setup/SKILL.md
---
# Roundup Setup
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/roundup-setup/SKILL.md`
