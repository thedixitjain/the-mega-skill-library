...
description: "'Upgrade Replit Nix channels, migrate between database types, and update deployment targets. Use when upgrading Nix channel versions, migrating from Replit DB to PostgreSQL, switching deployment types, or updating system dependencies. Trigger with phrases like \"upgrade replit\", \"replit nix upgrade\", \"migrate replit database\", \"replit version update\", \"replit channel update\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(pip:*)"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/replit-pack/skills/replit-upgrade-migration/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/replit-pack/skills/replit-upgrade-migration/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/replit-pack/skills/replit-upgrade-migration/SKILL.md`
