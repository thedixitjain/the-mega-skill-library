...
source_path: "docs/zh-CN/skills/hexagonal-architecture/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/hexagonal-architecture/SKILL.md
---
# 六边形架构
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/hexagonal-architecture/SKILL.md`
