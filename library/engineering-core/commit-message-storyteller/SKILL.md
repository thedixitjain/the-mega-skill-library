...
source_path: "skills/commit-message-storyteller/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/commit-message-storyteller/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/commit-message-storyteller/SKILL.md`
