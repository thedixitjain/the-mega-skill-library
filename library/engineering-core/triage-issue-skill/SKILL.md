...
description: "Analyze a GitHub issue, verify claims against the codebase, and close invalid issues with a technical response."
category: engineering-core
source_repo: aden-hive/hive
source_path: ".claude/skills/triage-issue/SKILL.md"
source_url: https://github.com/aden-hive/hive/blob/HEAD/.claude/skills/triage-issue/SKILL.md
---
# Triage Issue Skill
...
**Source:** [`aden-hive/hive`](https://github.com/aden-hive/hive) → `.claude/skills/triage-issue/SKILL.md`
