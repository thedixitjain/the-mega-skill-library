...
source_path: "skills/nestjs-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/nestjs-patterns/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/nestjs-patterns/SKILL.md`
