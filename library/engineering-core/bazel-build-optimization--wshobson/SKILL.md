...
source_path: "plugins/developer-essentials/skills/bazel-build-optimization/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/developer-essentials/skills/bazel-build-optimization/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/developer-essentials/skills/bazel-build-optimization/SKILL.md`
