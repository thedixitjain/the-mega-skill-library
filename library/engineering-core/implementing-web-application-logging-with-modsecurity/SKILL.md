...
source_path: "skills/implementing-web-application-logging-with-modsecurity/SKILL.md"
source_url: https://github.com/mukul975/Anthropic-Cybersecurity-Skills/blob/HEAD/skills/implementing-web-application-logging-with-modsecurity/SKILL.md
---
...
**Source:** [`mukul975/Anthropic-Cybersecurity-Skills`](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) → `skills/implementing-web-application-logging-with-modsecurity/SKILL.md`
