...
source_path: "skills/dataverse-python-advanced-patterns/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/dataverse-python-advanced-patterns/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/dataverse-python-advanced-patterns/SKILL.md`
