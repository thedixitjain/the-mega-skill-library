...
source_path: "packages/omo-opencode/src/features/builtin-skills/git-master/SKILL.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/omo-opencode/src/features/builtin-skills/git-master/SKILL.md
---
# Git Master Agent
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/omo-opencode/src/features/builtin-skills/git-master/SKILL.md`

**Also appears in:** `code-yeongyu/oh-my-openagent/packages/skills-loader-core/src/features/builtin-skills/git-master/SKILL.md`
