...
source_path: "skills/software-development/python-debugpy/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/skills/software-development/python-debugpy/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `skills/software-development/python-debugpy/SKILL.md`
