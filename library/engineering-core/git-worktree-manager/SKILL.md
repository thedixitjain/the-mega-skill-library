...
source_path: "engineering/skills/git-worktree-manager/SKILL.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/skills/git-worktree-manager/SKILL.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/skills/git-worktree-manager/SKILL.md`
