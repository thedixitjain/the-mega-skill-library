...
source_path: "skills/dataverse-python-production-code/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/dataverse-python-production-code/SKILL.md
---
# System Instructions
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/dataverse-python-production-code/SKILL.md`
