...
source_path: "optional-skills/communication/one-three-one-rule/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/optional-skills/communication/one-three-one-rule/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `optional-skills/communication/one-three-one-rule/SKILL.md`
