...
description: "\"Use when handling Navan API changes in production \\u2014 defensive coding\\ \\ patterns, schema validation, deprecation monitoring, and gradual rollout strategies\\ \\ for unversioned APIs.\\nTrigger with \\\"navan upgrade migration\\\" or \\\"navan api\\ \\ change handling\\\".\\n\""
allowed-tools: "Read, Write, Edit, Bash(curl:*), Bash(jq:*), Grep"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/navan-upgrade-migration/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/navan-upgrade-migration/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/navan-upgrade-migration/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/navan-pack/skills/navan-upgrade-migration/SKILL.md`
