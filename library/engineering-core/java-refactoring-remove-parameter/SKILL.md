...
source_path: "skills/java-refactoring-remove-parameter/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/java-refactoring-remove-parameter/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/java-refactoring-remove-parameter/SKILL.md`
