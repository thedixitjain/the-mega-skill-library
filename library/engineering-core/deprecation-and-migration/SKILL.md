...
source_url: https://github.com/addyosmani/agent-skills/blob/HEAD/skills/deprecation-and-migration/SKILL.md
---
...
**Source:** [`addyosmani/agent-skills`](https://github.com/addyosmani/agent-skills) → `skills/deprecation-and-migration/SKILL.md`
