...
source_path: "docs/zh-CN/skills/django-tdd/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/django-tdd/SKILL.md
---
# 使用 TDD 进行 Django 测试
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/django-tdd/SKILL.md`
