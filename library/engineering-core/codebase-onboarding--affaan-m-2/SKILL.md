...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/codebase-onboarding/SKILL.md
---
# Codebase Onboarding
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/codebase-onboarding/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/codebase-onboarding/SKILL.md`
