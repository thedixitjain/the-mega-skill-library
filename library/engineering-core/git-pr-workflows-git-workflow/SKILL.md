...
source_path: "skills/git-pr-workflows-git-workflow/SKILL.md"
source_url: https://github.com/sickn33/agentic-awesome-skills/blob/HEAD/skills/git-pr-workflows-git-workflow/SKILL.md
---
...
**Source:** [`sickn33/agentic-awesome-skills`](https://github.com/sickn33/agentic-awesome-skills) → `skills/git-pr-workflows-git-workflow/SKILL.md`

**Also appears in:** `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills/skills/git-pr-workflows-git-workflow/SKILL.md`, `sickn33/agentic-awesome-skills/plugins/agentic-awesome-skills-claude/skills/git-pr-workflows-git-workflow/SKILL.md`
