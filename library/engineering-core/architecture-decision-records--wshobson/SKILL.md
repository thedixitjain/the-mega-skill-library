...
source_path: "plugins/documentation-generation/skills/architecture-decision-records/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/documentation-generation/skills/architecture-decision-records/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/documentation-generation/skills/architecture-decision-records/SKILL.md`
