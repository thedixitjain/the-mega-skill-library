...
source_path: "packages/shared-skills/skills/git-master/SKILL.md"
source_url: https://github.com/code-yeongyu/oh-my-openagent/blob/HEAD/packages/shared-skills/skills/git-master/SKILL.md
---
# Git Master
...
**Source:** [`code-yeongyu/oh-my-openagent`](https://github.com/code-yeongyu/oh-my-openagent) → `packages/shared-skills/skills/git-master/SKILL.md`
