...
description: "'Diagnose and fix AssemblyAI common errors and exceptions. Use when encountering AssemblyAI errors, debugging failed transcriptions, or troubleshooting streaming and LeMUR issues. Trigger with phrases like \"assemblyai error\", \"fix assemblyai\", \"assemblyai not working\", \"debug assemblyai\", \"transcription failed\". '"
allowed-tools: "Read, Grep, Bash(curl:*)"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/assemblyai-pack/skills/assemblyai-common-errors/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/assemblyai-pack/skills/assemblyai-common-errors/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/assemblyai-pack/skills/assemblyai-common-errors/SKILL.md`
