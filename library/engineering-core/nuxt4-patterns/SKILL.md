...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/nuxt4-patterns/SKILL.md
---
# Nuxt 4 Patterns
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/nuxt4-patterns/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/nuxt4-patterns/SKILL.md`
