...
source_repo: TheDecipherist/claude-code-mastery
source_path: "skills/commit-messages/SKILL.md"
source_url: https://github.com/TheDecipherist/claude-code-mastery/blob/HEAD/skills/commit-messages/SKILL.md
---
...
**Source:** [`TheDecipherist/claude-code-mastery`](https://github.com/TheDecipherist/claude-code-mastery) → `skills/commit-messages/SKILL.md`
