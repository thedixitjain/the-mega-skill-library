...
description: "\"Use when designing a production Navan API integration architecture \\u2014\\ \\ API gateway, token management, data sync pipelines, ERP connectors, and monitoring\\ \\ stack.\\nTrigger with \\\"navan reference architecture\\\" or \\\"navan integration architecture\\\"\\ .\\n\""
allowed-tools: "Read, Write, Edit, Bash(curl:*), Bash(jq:*), Grep"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/navan-reference-architecture/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/navan-reference-architecture/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/navan-reference-architecture/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/navan-pack/skills/navan-reference-architecture/SKILL.md`
