...
source_path: ".claude/skills/router-first-architecture/SKILL.md"
source_url: https://github.com/parcadei/Continuous-Claude-v3/blob/HEAD/.claude/skills/router-first-architecture/SKILL.md
---
...
**Source:** [`parcadei/Continuous-Claude-v3`](https://github.com/parcadei/Continuous-Claude-v3) → `.claude/skills/router-first-architecture/SKILL.md`

**Also appears in:** `parcadei/Continuous-Claude-v3/.claude/skills/archive/router-first-architecture/SKILL.md`
