...
source_path: ".claude/skills/v3-performance-optimization/SKILL.md"
source_url: https://github.com/ruvnet/RuView/blob/HEAD/.claude/skills/v3-performance-optimization/SKILL.md
---
...
**Source:** [`ruvnet/RuView`](https://github.com/ruvnet/RuView) → `.claude/skills/v3-performance-optimization/SKILL.md`

**Also appears in:** `ruvnet/ruflo/.agents/skills/v3-performance-optimization/SKILL.md`, `ruvnet/ruflo/.claude/skills/v3-performance-optimization/SKILL.md`, `ruvnet/ruflo/v3/@claude-flow/cli/.claude/skills/v3-performance-optimization/SKILL.md`
