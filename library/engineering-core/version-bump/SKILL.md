...
source_path: "plugin/skills/version-bump/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/version-bump/SKILL.md
---
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/version-bump/SKILL.md`
