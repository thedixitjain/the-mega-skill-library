...
source_path: "plugins/python-development/skills/python-type-safety/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/python-development/skills/python-type-safety/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/python-development/skills/python-type-safety/SKILL.md`
