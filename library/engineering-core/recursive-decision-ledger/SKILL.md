...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/recursive-decision-ledger/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/recursive-decision-ledger/SKILL.md`
