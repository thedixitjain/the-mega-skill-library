...
source_path: "plugins/sanctum/skills/git-workspace-review/SKILL.md"
source_url: https://github.com/athola/claude-night-market/blob/HEAD/plugins/sanctum/skills/git-workspace-review/SKILL.md
---
...
**Source:** [`athola/claude-night-market`](https://github.com/athola/claude-night-market) → `plugins/sanctum/skills/git-workspace-review/SKILL.md`
