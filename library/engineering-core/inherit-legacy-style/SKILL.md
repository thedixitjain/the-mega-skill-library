...
source_path: "skills/inherit-legacy-style/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/inherit-legacy-style/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/inherit-legacy-style/SKILL.md`
