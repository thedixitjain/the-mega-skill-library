...
description: "'Identify and avoid Salesforce anti-patterns including SOQL N+1, governor limit violations, and API waste. Use when reviewing Salesforce code for issues, onboarding new developers, or auditing existing Salesforce integrations for best practices violations. Trigger with phrases like \"salesforce mistakes\", \"salesforce anti-patterns\", \"salesforce pitfalls\", \"salesforce what not to do\", \"salesforce code review\". '"
allowed-tools: "Read, Grep"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/salesforce-pack/skills/salesforce-known-pitfalls/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/salesforce-pack/skills/salesforce-known-pitfalls/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/salesforce-pack/skills/salesforce-known-pitfalls/SKILL.md`
