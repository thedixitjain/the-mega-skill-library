...
source_path: "plugins/agent-teams/skills/parallel-debugging/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/agent-teams/skills/parallel-debugging/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/agent-teams/skills/parallel-debugging/SKILL.md`
