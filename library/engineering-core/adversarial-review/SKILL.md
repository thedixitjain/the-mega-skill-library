...
description: ">- Adversarial code review using the opposite model. Spawns 1–3 reviewers on the opposing model (Claude spawns Codex, Codex spawns Claude) to challenge work from distinct critical lenses. Triggers: \"adversarial review\"."
category: engineering-core
source_repo: Mizoreww/awesome-claude-code-config
source_path: "skills/adversarial-review/SKILL.md"
source_url: https://github.com/Mizoreww/awesome-claude-code-config/blob/HEAD/skills/adversarial-review/SKILL.md
---
...
**Source:** [`Mizoreww/awesome-claude-code-config`](https://github.com/Mizoreww/awesome-claude-code-config) → `skills/adversarial-review/SKILL.md`
