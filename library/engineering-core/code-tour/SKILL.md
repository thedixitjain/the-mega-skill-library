...
source_path: "skills/code-tour/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/code-tour/SKILL.md
---
# Code Tour Skill
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/code-tour/SKILL.md`
