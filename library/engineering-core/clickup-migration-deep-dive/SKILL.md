...
description: "'Migrate to ClickUp from other project management tools (Jira, Asana, Trello) or migrate data between ClickUp workspaces using API v2. Trigger: \"migrate to clickup\", \"clickup migration\", \"jira to clickup\", \"asana to clickup\", \"trello to clickup\", \"clickup data migration\", \"move tasks to clickup\", \"clickup import\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(node:*), Bash(curl:*)"
category: engineering-core
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/clickup-pack/skills/clickup-migration-deep-dive/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/clickup-pack/skills/clickup-migration-deep-dive/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/clickup-pack/skills/clickup-migration-deep-dive/SKILL.md`
