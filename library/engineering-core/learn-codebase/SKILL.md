...
source_path: "plugin/skills/learn-codebase/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/learn-codebase/SKILL.md
---
# Learn Codebase
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/learn-codebase/SKILL.md`
