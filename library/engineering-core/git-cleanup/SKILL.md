...
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/git-cleanup/skills/git-cleanup/SKILL.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/git-cleanup/skills/git-cleanup/SKILL.md`
