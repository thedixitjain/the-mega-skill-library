...
source_path: "docs/ja-JP/skills/codebase-onboarding/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/codebase-onboarding/SKILL.md
---
# コードベースオンボーディング
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/codebase-onboarding/SKILL.md`
