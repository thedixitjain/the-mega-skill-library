...
source_path: "skills/git-advanced/SKILL.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/skills/git-advanced/SKILL.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `skills/git-advanced/SKILL.md`
