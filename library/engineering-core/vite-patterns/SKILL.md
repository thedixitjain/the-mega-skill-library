...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/vite-patterns/SKILL.md
---
# Vite Patterns
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/vite-patterns/SKILL.md`
