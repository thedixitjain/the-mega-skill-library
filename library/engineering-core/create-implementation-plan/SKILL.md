...
source_path: "skills/create-implementation-plan/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/create-implementation-plan/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/create-implementation-plan/SKILL.md`
