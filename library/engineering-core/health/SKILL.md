...
source_path: "health/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/health/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `health/SKILL.md`
