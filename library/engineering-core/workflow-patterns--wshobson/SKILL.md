...
source_path: "plugins/conductor/skills/workflow-patterns/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/conductor/skills/workflow-patterns/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/conductor/skills/workflow-patterns/SKILL.md`
