...
source_path: "docs/ko-KR/skills/tdd-workflow/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/skills/tdd-workflow/SKILL.md
---
# 테스트 주도 개발 워크플로우
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/skills/tdd-workflow/SKILL.md`
