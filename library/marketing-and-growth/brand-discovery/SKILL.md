...
source_path: "skills/brand-discovery/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/brand-discovery/SKILL.md
---
# Brand Discovery
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/brand-discovery/SKILL.md`

**Also appears in:** `affaan-m/ECC/.agents/skills/brand-discovery/SKILL.md`
