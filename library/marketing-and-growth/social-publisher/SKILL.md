...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/social-publisher/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/social-publisher/SKILL.md`
