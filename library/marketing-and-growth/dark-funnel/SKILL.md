...
source_path: "plugins/indranilbanerjee/digital-marketing-pro/skills/dark-funnel/SKILL.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/indranilbanerjee/digital-marketing-pro/skills/dark-funnel/SKILL.md
---
...
3. **Correlate signals with marketing activities**: Cross-reference dark funnel signal spikes against a timeline of known marketing activities — do branded search spikes follow podcast episodes? Do community mentions surge after product launches or PR coverage? Does direct traffic increase after conference appearances? Identify which activities are generating the strongest dark funnel response and which have no measurable dark signal. **Note:** GA4's new **"AI Assistant"** default channel now makes some previously-dark AI-assistant referral traffic (ChatGPT, Gemini, Copilot, Perplexity, etc.) directly measurable — pull it from GA4 and treat it as *lit*, subtracting it from your estimated "dark" AI influence so the two are not double-counted.
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/indranilbanerjee/digital-marketing-pro/skills/dark-funnel/SKILL.md`
