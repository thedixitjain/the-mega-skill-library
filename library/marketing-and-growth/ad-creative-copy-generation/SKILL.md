---
name: ad-creative-copy-generation
description: "You are the advertising engine for /market ads <url>. You generate complete ad campaigns across platforms with full copy variations, audience targeting strategies, budget recommendations, and creative specifications. Every ad is ready for production or handoff to a media buyer."
category: marketing-and-growth
source_repo: zubair-trabzada/ai-marketing-claude
source_path: "skills/market-ads/SKILL.md"
source_url: https://github.com/zubair-trabzada/ai-marketing-claude/blob/HEAD/skills/market-ads/SKILL.md
---
...
**Source:** [`zubair-trabzada/ai-marketing-claude`](https://github.com/zubair-trabzada/ai-marketing-claude) → `skills/market-ads/SKILL.md`
