...
source_path: "image-enhancer/SKILL.md"
source_url: https://github.com/ComposioHQ/awesome-claude-skills/blob/HEAD/image-enhancer/SKILL.md
---
...
**Source:** [`ComposioHQ/awesome-claude-skills`](https://github.com/ComposioHQ/awesome-claude-skills) → `image-enhancer/SKILL.md`

**Also appears in:** `composio-community/awesome-codex-skills/image-enhancer/SKILL.md`, `davepoon/buildwithclaude/plugins/all-skills/skills/image-enhancer/SKILL.md`, `Prat011/awesome-llm-skills/image-enhancer/SKILL.md`
