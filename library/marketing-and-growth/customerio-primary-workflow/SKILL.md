...
description: "'Implement Customer.io primary messaging workflow. Use when setting up campaign triggers, welcome sequences, onboarding flows, or event-driven email automation. Trigger: \"customer.io campaign\", \"customer.io workflow\", \"customer.io email automation\", \"customer.io messaging\", \"customer.io onboarding\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(npx:*), Glob, Grep"
category: marketing-and-growth
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/customerio-primary-workflow/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/customerio-primary-workflow/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/customerio-primary-workflow/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/customerio-pack/skills/customerio-primary-workflow/SKILL.md`
