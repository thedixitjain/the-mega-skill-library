...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/investor-outreach/SKILL.md
---
# Investor Outreach
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/investor-outreach/SKILL.md`

**Also appears in:** `affaan-m/ECC/.agents/skills/investor-outreach/SKILL.md`, `affaan-m/ECC/docs/ja-JP/skills/investor-outreach/SKILL.md`
