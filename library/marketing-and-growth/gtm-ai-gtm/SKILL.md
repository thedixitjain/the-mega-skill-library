...
source_path: "skills/gtm-ai-gtm/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/gtm-ai-gtm/SKILL.md
---
# AI Product GTM
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/gtm-ai-gtm/SKILL.md`
