...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/content-engine/SKILL.md
---
# Content Engine
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/content-engine/SKILL.md`

**Also appears in:** `affaan-m/ECC/.agents/skills/content-engine/SKILL.md`
