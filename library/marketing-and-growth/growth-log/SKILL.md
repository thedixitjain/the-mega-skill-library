...
source_path: "skills/growth-log/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/growth-log/SKILL.md
---
# Growth Log Skill
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/growth-log/SKILL.md`
