...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/crosspost/SKILL.md
---
# Crosspost
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/crosspost/SKILL.md`

**Also appears in:** `affaan-m/ECC/.agents/skills/crosspost/SKILL.md`
