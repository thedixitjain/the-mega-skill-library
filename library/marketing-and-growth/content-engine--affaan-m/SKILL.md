...
source_path: ".cursor/skills/content-engine/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.cursor/skills/content-engine/SKILL.md
---
# Content Engine
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.cursor/skills/content-engine/SKILL.md`
