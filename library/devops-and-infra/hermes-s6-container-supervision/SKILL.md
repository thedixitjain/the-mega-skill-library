...
source_path: "optional-skills/devops/hermes-s6-container-supervision/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/optional-skills/devops/hermes-s6-container-supervision/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `optional-skills/devops/hermes-s6-container-supervision/SKILL.md`
