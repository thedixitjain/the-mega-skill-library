...
source_path: "setup-deploy/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/setup-deploy/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `setup-deploy/SKILL.md`
