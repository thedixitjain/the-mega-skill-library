...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/cloud-infrastructure/skills/multi-cloud-architecture/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/cloud-infrastructure/skills/multi-cloud-architecture/SKILL.md`
