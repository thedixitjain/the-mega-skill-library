...
source_path: ".opencode/skills/product-tutorial-pipeline/SKILL.md"
source_url: https://github.com/different-ai/openwork/blob/HEAD/.opencode/skills/product-tutorial-pipeline/SKILL.md
---
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `.opencode/skills/product-tutorial-pipeline/SKILL.md`
