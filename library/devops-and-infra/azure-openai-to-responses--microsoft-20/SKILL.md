...
description: "Attiva questa skill quando un utente vuole: - Migrare un'app Python da Azure OpenAI Chat Completions all'API Responses - Aggiornare l'uso del Python OpenAI SDK all'ultima forma API contro Azure OpenAI - Preparare codice Python per modelli GPT-5 o più recenti che richiedono Responses su Azure - Passare da AzureOpenAI/AsyncAzureOpenAI al client standard OpenAI/AsyncOpenAI con endpoint v1 - Risolvere avvisi di deprecazione relativi a costruttori AzureOpenAI o apiversion"
category: devops-and-infra
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/it/.agents/skills/azure-openai-to-responses/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/it/.agents/skills/azure-openai-to-responses/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/it/.agents/skills/azure-openai-to-responses/SKILL.md`
