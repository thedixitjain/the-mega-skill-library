...
source_url: https://github.com/SnailSploit/Claude-Red/blob/HEAD/Skills/exploit-dev/offensive-toctou/SKILL.md
---
...
**Source:** [`SnailSploit/Claude-Red`](https://github.com/SnailSploit/Claude-Red) → `Skills/exploit-dev/offensive-toctou/SKILL.md`
