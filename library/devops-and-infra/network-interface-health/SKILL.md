...
source_path: "skills/network-interface-health/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/network-interface-health/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/network-interface-health/SKILL.md`
