...
source_url: https://github.com/SnailSploit/Claude-Red/blob/HEAD/Skills/cloud/offensive-cloud/SKILL.md
---
...
**Source:** [`SnailSploit/Claude-Red`](https://github.com/SnailSploit/Claude-Red) → `Skills/cloud/offensive-cloud/SKILL.md`
