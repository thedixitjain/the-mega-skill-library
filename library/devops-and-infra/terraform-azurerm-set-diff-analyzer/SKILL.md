...
source_path: "skills/terraform-azurerm-set-diff-analyzer/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/terraform-azurerm-set-diff-analyzer/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/terraform-azurerm-set-diff-analyzer/SKILL.md`
