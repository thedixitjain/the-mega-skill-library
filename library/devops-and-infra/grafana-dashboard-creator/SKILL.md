...
description: "'Create grafana dashboard creator operations. Auto-activating skill for DevOps Advanced. Triggers on: grafana dashboard creator, grafana dashboard creator Part of the DevOps Advanced skill category. Use when working with grafana dashboard creator functionality. Trigger with phrases like \"grafana dashboard creator\", \"grafana creator\", \"grafana\". '"
allowed-tools: "Read, Write, Edit, Bash(cmd:*), Grep"
category: devops-and-infra
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/02-devops-advanced/grafana-dashboard-creator/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/02-devops-advanced/grafana-dashboard-creator/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/02-devops-advanced/grafana-dashboard-creator/SKILL.md`
