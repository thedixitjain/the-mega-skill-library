...
source_path: "skills/competitive-platform-analysis/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/competitive-platform-analysis/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/competitive-platform-analysis/SKILL.md`

**Also appears in:** `affaan-m/ECC/.agents/skills/competitive-platform-analysis/SKILL.md`
