...
description: "Ative esta funcionalidade quando o utilizador quiser: - Migrar uma app Python de Azure OpenAI Chat Completions para Responses API - Atualizar utilização do SDK OpenAI em Python para o formato mais recente da API com Azure OpenAI - Preparar código Python para modelos GPT-5 ou superiores que requerem Responses na Azure - Trocar AzureOpenAI/AsyncAzureOpenAI pelo cliente padrão OpenAI/AsyncOpenAI com o endpoint v1"
category: devops-and-infra
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/pt-PT/.agents/skills/azure-openai-to-responses/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/pt-PT/.agents/skills/azure-openai-to-responses/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/pt-PT/.agents/skills/azure-openai-to-responses/SKILL.md`
