...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/shell-scripting/skills/bash-defensive-patterns/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/shell-scripting/skills/bash-defensive-patterns/SKILL.md`
