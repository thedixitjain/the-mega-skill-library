...
source_path: "autoplan/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/autoplan/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `autoplan/SKILL.md`
