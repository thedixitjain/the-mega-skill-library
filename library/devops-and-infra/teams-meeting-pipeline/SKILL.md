...
source_path: "skills/productivity/teams-meeting-pipeline/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/skills/productivity/teams-meeting-pipeline/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `skills/productivity/teams-meeting-pipeline/SKILL.md`
