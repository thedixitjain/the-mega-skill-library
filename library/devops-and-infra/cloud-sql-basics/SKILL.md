...
source_path: "skills/cloud/cloud-sql-basics/SKILL.md"
source_url: https://github.com/google/skills/blob/HEAD/skills/cloud/cloud-sql-basics/SKILL.md
---
...
**Source:** [`google/skills`](https://github.com/google/skills) → `skills/cloud/cloud-sql-basics/SKILL.md`
