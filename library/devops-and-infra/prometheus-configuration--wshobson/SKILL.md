...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/observability-monitoring/skills/prometheus-configuration/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/observability-monitoring/skills/prometheus-configuration/SKILL.md`
