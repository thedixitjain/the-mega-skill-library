...
source_url: https://github.com/openai/skills/blob/HEAD/skills/.curated/netlify-deploy/SKILL.md
---
...
**Source:** [`openai/skills`](https://github.com/openai/skills) → `skills/.curated/netlify-deploy/SKILL.md`
