...
source_path: "plugin/skills/cloud-sync/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/cloud-sync/SKILL.md
---
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/cloud-sync/SKILL.md`
