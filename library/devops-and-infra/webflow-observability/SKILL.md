...
description: "\"Set up observability for Webflow integrations \\u2014 Prometheus metrics\\ \\ for API calls,\\nOpenTelemetry tracing, structured logging with pino, Grafana dashboards,\\n\\ and alerting for rate limits, errors, and latency.\\nTrigger with phrases like \\\"\\ webflow monitoring\\\", \\\"webflow metrics\\\",\\n\\\"webflow observability\\\", \\\"monitor\\ \\ webflow\\\", \\\"webflow alerts\\\", \\\"webflow tracing\\\".\\n\""
allowed-tools: "Read, Write, Edit"
category: devops-and-infra
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/webflow-pack/skills/webflow-observability/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/webflow-pack/skills/webflow-observability/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/webflow-pack/skills/webflow-observability/SKILL.md`
