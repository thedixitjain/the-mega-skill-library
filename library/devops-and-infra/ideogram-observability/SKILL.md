...
description: "'Set up monitoring, metrics, and alerts for Ideogram integrations. Use when implementing observability for Ideogram operations, tracking costs, or configuring alerting for generation health. Trigger with phrases like \"ideogram monitoring\", \"ideogram metrics\", \"ideogram observability\", \"monitor ideogram\", \"ideogram alerts\", \"ideogram dashboard\". '"
allowed-tools: "Read, Write, Edit"
category: devops-and-infra
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/ideogram-pack/skills/ideogram-observability/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/ideogram-pack/skills/ideogram-observability/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/ideogram-pack/skills/ideogram-observability/SKILL.md`
