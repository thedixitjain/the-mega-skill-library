...
source_path: "docs/es/skills/docker-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/skills/docker-patterns/SKILL.md
---
# Patrones Docker
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/skills/docker-patterns/SKILL.md`
