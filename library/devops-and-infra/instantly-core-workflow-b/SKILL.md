...
description: "'Manage Instantly.ai email account warmup, analytics, and deliverability. Use when enabling warmup, monitoring sender reputation, pulling analytics, or troubleshooting deliverability issues. Trigger with phrases like \"instantly warmup\", \"instantly analytics\", \"email warmup instantly\", \"instantly deliverability\", \"instantly account health\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(curl:*), Grep"
category: devops-and-infra
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/instantly-pack/skills/instantly-core-workflow-b/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/instantly-pack/skills/instantly-core-workflow-b/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/instantly-pack/skills/instantly-core-workflow-b/SKILL.md`
