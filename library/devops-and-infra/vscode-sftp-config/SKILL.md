...
source_path: "plugins/vscode-extensions-toolkit/skills/vscode-sftp-config/SKILL.md"
source_url: https://github.com/libukai/awesome-agent-skills/blob/HEAD/plugins/vscode-extensions-toolkit/skills/vscode-sftp-config/SKILL.md
---
...
**Source:** [`libukai/awesome-agent-skills`](https://github.com/libukai/awesome-agent-skills) → `plugins/vscode-extensions-toolkit/skills/vscode-sftp-config/SKILL.md`
