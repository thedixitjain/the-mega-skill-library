...
source_path: "skills/.curated/collecting-infrastructure-metrics/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/collecting-infrastructure-metrics/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/collecting-infrastructure-metrics/SKILL.md`
