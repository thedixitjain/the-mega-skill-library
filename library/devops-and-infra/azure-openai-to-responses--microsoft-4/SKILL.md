...
description: "যখন ব্যবহারকারী চান, এই স্কিল সক্রিয় করুন: - Azure OpenAI চ্যাট সম্পূর্ণতা থেকে Responses API তে একটি পাইথন অ্যাপ মাইগ্রেট করতে - Azure OpenAI এর বিরুদ্ধে সর্বশেষ API আকৃতির জন্য পাইথন OpenAI SDK ব্যবহার আপগ্রেড করতে - Azure এ Responses প্রয়োজন এমন GPT-5 বা নতুন মডেলের জন্য পাইথন কোড প্রস্তুত করতে - AzureOpenAI/AsyncAzureOpenAI থেকে ভি১ এন্ডপয়েন্ট সহ স্ট্যান্ডার্ড OpenAI/AsyncOpenAI ক্লায়েন্টে স্যুইচ করতে"
category: devops-and-infra
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/bn/.agents/skills/azure-openai-to-responses/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/bn/.agents/skills/azure-openai-to-responses/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/bn/.agents/skills/azure-openai-to-responses/SKILL.md`
