...
source_path: "skills/competitive-report-structure/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/competitive-report-structure/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/competitive-report-structure/SKILL.md`

**Also appears in:** `affaan-m/ECC/.agents/skills/competitive-report-structure/SKILL.md`
