...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/dashboard-builder/SKILL.md
---
# Dashboard Builder
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/dashboard-builder/SKILL.md`
