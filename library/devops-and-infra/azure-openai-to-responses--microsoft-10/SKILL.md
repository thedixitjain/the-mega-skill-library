...
description: "Active esta habilidad cuando el usuario quiera: - Migrar una aplicación Python de Azure OpenAI Chat Completions a Responses API - Actualizar el uso del SDK OpenAI en Python a la forma de API más reciente contra Azure OpenAI - Preparar código Python para modelos GPT-5 o más nuevos que requieren Responses en Azure - Cambiar de AzureOpenAI/AsyncAzureOpenAI a cliente estándar OpenAI/AsyncOpenAI con el endpoint v1"
category: devops-and-infra
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/es/.agents/skills/azure-openai-to-responses/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/es/.agents/skills/azure-openai-to-responses/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/es/.agents/skills/azure-openai-to-responses/SKILL.md`
