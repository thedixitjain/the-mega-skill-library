...
source_url: https://github.com/openai/skills/blob/HEAD/skills/.curated/render-deploy/SKILL.md
---
...
**Source:** [`openai/skills`](https://github.com/openai/skills) → `skills/.curated/render-deploy/SKILL.md`
