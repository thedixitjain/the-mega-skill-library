...
source_path: "skills/ci-cd-pipelines/SKILL.md"
source_url: https://github.com/rohitg00/awesome-claude-code-toolkit/blob/HEAD/skills/ci-cd-pipelines/SKILL.md
---
...
**Source:** [`rohitg00/awesome-claude-code-toolkit`](https://github.com/rohitg00/awesome-claude-code-toolkit) → `skills/ci-cd-pipelines/SKILL.md`
