...
description: "Activez cette compétence lorsque l’utilisateur souhaite : - Migrer une application Python d’Azure OpenAI Chat Completions vers l’API Responses - Mettre à jour l’usage du SDK OpenAI Python vers la forme d’API la plus récente contre Azure OpenAI - Préparer du code Python pour GPT-5 ou modèles plus récents nécessitant Responses sur Azure - Passer de AzureOpenAI/AsyncAzureOpenAI au client standard OpenAI/AsyncOpenAI avec le point de terminaison v1"
category: devops-and-infra
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/fr/.agents/skills/azure-openai-to-responses/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/fr/.agents/skills/azure-openai-to-responses/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/fr/.agents/skills/azure-openai-to-responses/SKILL.md`
