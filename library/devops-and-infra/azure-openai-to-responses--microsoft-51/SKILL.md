...
description: "جب صارف چاہتا ہو تو اس قابلیت کو فعال کریں: - Azure OpenAI Chat Completions سے Responses API کی طرف Python ایپ کی مائیگریشن - Azure OpenAI کے خلاف Python OpenAI SDK کے استعمال کو جدید API شکل میں اپ گریڈ کریں - GPT-5 یا نئے ماڈلز کے لیے Python کوڈ تیار کریں جو Azure پر Responses کی ضرورت رکھتے ہوں - AzureOpenAI/AsyncAzureOpenAI سے معیار OpenAI/AsyncOpenAI کلائنٹ کی طرف v1 اینڈپوائنٹ کے ساتھ منتقل ہوں"
category: devops-and-infra
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ur/.agents/skills/azure-openai-to-responses/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ur/.agents/skills/azure-openai-to-responses/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ur/.agents/skills/azure-openai-to-responses/SKILL.md`
