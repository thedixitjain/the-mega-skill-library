...
source_path: "skills/aws-cdk-python-setup/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/aws-cdk-python-setup/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/aws-cdk-python-setup/SKILL.md`
