...
source_path: "skills/sandbox-npm-install/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/sandbox-npm-install/SKILL.md
---
# Sandbox npm Install
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/sandbox-npm-install/SKILL.md`
