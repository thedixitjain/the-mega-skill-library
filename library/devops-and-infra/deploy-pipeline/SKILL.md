...
source_path: "deploy-pipeline/SKILL.md"
source_url: https://github.com/composio-community/awesome-codex-skills/blob/HEAD/deploy-pipeline/SKILL.md
---
...
**Source:** [`composio-community/awesome-codex-skills`](https://github.com/composio-community/awesome-codex-skills) → `deploy-pipeline/SKILL.md`
