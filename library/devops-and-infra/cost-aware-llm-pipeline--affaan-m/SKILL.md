...
source_path: "docs/zh-CN/skills/cost-aware-llm-pipeline/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/cost-aware-llm-pipeline/SKILL.md
---
# 成本感知型 LLM 流水线
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/cost-aware-llm-pipeline/SKILL.md`
