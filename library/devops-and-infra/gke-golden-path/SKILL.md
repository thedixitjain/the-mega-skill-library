...
source_path: "skills/cloud/gke-golden-path/SKILL.md"
source_url: https://github.com/google/skills/blob/HEAD/skills/cloud/gke-golden-path/SKILL.md
---
...
**Source:** [`google/skills`](https://github.com/google/skills) → `skills/cloud/gke-golden-path/SKILL.md`
