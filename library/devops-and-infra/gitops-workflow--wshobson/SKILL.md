...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/kubernetes-operations/skills/gitops-workflow/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/kubernetes-operations/skills/gitops-workflow/SKILL.md`
