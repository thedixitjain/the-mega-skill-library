...
source_path: "plugins/saas-packs/langfuse-pack/skills/langfuse-core-workflow-a/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/langfuse-pack/skills/langfuse-core-workflow-a/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/langfuse-pack/skills/langfuse-core-workflow-a/SKILL.md`
