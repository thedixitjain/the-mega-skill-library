...
source_path: "skills/mle-workflow/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/mle-workflow/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/mle-workflow/SKILL.md`
