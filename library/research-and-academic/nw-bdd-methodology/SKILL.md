...
source_path: "nWave/skills/nw-bdd-methodology/SKILL.md"
source_url: https://github.com/nWave-ai/nWave/blob/HEAD/nWave/skills/nw-bdd-methodology/SKILL.md
---
...
**Source:** [`nWave-ai/nWave`](https://github.com/nWave-ai/nWave) → `nWave/skills/nw-bdd-methodology/SKILL.md`

**Also appears in:** `nWave-ai/nWave/plugins/nw/skills/nw-bdd-methodology/SKILL.md`
