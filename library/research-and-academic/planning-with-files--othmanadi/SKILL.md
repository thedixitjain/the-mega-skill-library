...
source_path: ".gemini/skills/planning-with-files/SKILL.md"
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/.gemini/skills/planning-with-files/SKILL.md
---
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `.gemini/skills/planning-with-files/SKILL.md`
