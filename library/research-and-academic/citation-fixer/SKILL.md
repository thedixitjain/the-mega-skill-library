---
name: citation-fixer
description: "| Audit and fix citation formatting across brain pages. Ensures every fact has an inline [Source: ...] citation matching the standard format. Extended in v0.25.1: scans for broken tweet/post references that lack actual URLs and resolves them via the host's X / Twitter API integration."
allowed-tools: "search get_page put_page list_pages"
category: research-and-academic
source_repo: garrytan/gbrain
source_path: "skills/citation-fixer/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/citation-fixer/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/citation-fixer/SKILL.md`
