...
source_path: "nWave/skills/nw-sa-critique-dimensions/SKILL.md"
source_url: https://github.com/nWave-ai/nWave/blob/HEAD/nWave/skills/nw-sa-critique-dimensions/SKILL.md
---
...
**Source:** [`nWave-ai/nWave`](https://github.com/nWave-ai/nWave) → `nWave/skills/nw-sa-critique-dimensions/SKILL.md`

**Also appears in:** `nWave-ai/nWave/nWave/skills/nw-sar-critique-dimensions/SKILL.md`, `nWave-ai/nWave/plugins/nw/skills/nw-sa-critique-dimensions/SKILL.md`, `nWave-ai/nWave/plugins/nw/skills/nw-sar-critique-dimensions/SKILL.md`
