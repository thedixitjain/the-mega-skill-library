...
allowed-tools: "search query get_page list_pages get_backlinks traverse_graph get_timeline"
category: research-and-academic
source_repo: garrytan/gbrain
source_path: "skills/query/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/query/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/query/SKILL.md`
