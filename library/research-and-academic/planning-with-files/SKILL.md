...
source_path: ".continue/skills/planning-with-files/SKILL.md"
source_url: https://github.com/OthmanAdi/planning-with-files/blob/HEAD/.continue/skills/planning-with-files/SKILL.md
---
...
**Source:** [`OthmanAdi/planning-with-files`](https://github.com/OthmanAdi/planning-with-files) → `.continue/skills/planning-with-files/SKILL.md`
