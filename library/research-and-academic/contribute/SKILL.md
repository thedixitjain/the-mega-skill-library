...
allowed-tools: "Read Write Edit Glob Grep AskUserQuestion Task Bash(gh:*) Bash(git:*) Bash(node:*) Bash(pnpm:*) Bash(yarn:*) Bash(npm:*) Bash(cargo:*) Bash(pytest:*) Bash(python:*) Bash(python3:*) Bash(bash:*) Bash(jq:*) Bash(base64:*)"
category: research-and-academic
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/contribute/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/contribute/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/contribute/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/community/contributing-clanker/skills/contribute/SKILL.md`
