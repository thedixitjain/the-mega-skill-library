...
source_path: "skills/desk-open/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/desk-open/SKILL.md
---
# Open a Desk
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/desk-open/SKILL.md`
