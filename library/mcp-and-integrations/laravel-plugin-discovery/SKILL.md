...
source_path: "skills/laravel-plugin-discovery/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/laravel-plugin-discovery/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/laravel-plugin-discovery/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/laravel-plugin-discovery/SKILL.md`, `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/laravel-plugin-discovery/SKILL.md`
