...
source_path: "skills/homelab-pihole-dns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/homelab-pihole-dns/SKILL.md
---
# Homelab Pi-hole DNS
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/homelab-pihole-dns/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/homelab-pihole-dns/SKILL.md`
