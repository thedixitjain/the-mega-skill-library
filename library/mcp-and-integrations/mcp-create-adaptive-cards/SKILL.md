...
source_path: "skills/mcp-create-adaptive-cards/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/mcp-create-adaptive-cards/SKILL.md
---
````prompt
---
mode: 'agent'
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/mcp-create-adaptive-cards/SKILL.md`
