...
source_path: "skills/mcp-create-declarative-agent/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/mcp-create-declarative-agent/SKILL.md
---
````prompt
---
mode: 'agent'
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/mcp-create-declarative-agent/SKILL.md`
