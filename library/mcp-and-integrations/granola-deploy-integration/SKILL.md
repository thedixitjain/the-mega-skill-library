...
description: "\"Deploy Granola native integrations \\u2014 Slack, Notion, HubSpot, Attio,\\ \\ Affinity, and Zapier.\\nStep-by-step setup for each platform with configuration,\\ \\ testing, and automation chains.\\nTrigger: \\\"granola slack\\\", \\\"granola notion\\\"\\ , \\\"granola hubspot\\\",\\n\\\"granola attio\\\", \\\"connect granola\\\", \\\"granola integration\\\"\\ .\\n\""
allowed-tools: "Read, Write, Edit"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/granola-deploy-integration/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/granola-deploy-integration/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/granola-deploy-integration/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/granola-pack/skills/granola-deploy-integration/SKILL.md`
