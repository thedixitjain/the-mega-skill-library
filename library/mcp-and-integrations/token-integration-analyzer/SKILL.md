...
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/building-secure-contracts/skills/token-integration-analyzer/SKILL.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/building-secure-contracts/skills/token-integration-analyzer/SKILL.md`
