...
description: "'Configure connection pooling config operations. Auto-activating skill for API Integration. Triggers on: connection pooling config, connection pooling config Part of the API Integration skill category. Use when configuring systems or services. Trigger with phrases like \"connection pooling config\", \"connection config\", \"connection\". '"
allowed-tools: "Read, Write, Edit, Bash(cmd:*), Grep"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/16-api-integration/connection-pooling-config/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/16-api-integration/connection-pooling-config/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/16-api-integration/connection-pooling-config/SKILL.md`
