...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/mcp-server-patterns/SKILL.md
---
# MCP Server Patterns
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/mcp-server-patterns/SKILL.md`
