...
source_path: "skills/codebase-memory-mcp/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/codebase-memory-mcp/SKILL.md
---
# Codebase Memory MCP
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/codebase-memory-mcp/SKILL.md`
