...
source_path: "plugins/mcp-server-dev/skills/build-mcpb/SKILL.md"
source_url: https://github.com/anthropics/claude-plugins-official/blob/HEAD/plugins/mcp-server-dev/skills/build-mcpb/SKILL.md
---
...
**Source:** [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) → `plugins/mcp-server-dev/skills/build-mcpb/SKILL.md`
