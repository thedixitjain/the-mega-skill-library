...
source_path: "docs/ja-JP/skills/jira-integration/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/jira-integration/SKILL.md
---
# Jira インテグレーションスキル
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/jira-integration/SKILL.md`
