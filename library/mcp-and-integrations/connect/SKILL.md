...
source_url: https://github.com/ComposioHQ/awesome-claude-skills/blob/HEAD/connect/SKILL.md
---
...
**Source:** [`ComposioHQ/awesome-claude-skills`](https://github.com/ComposioHQ/awesome-claude-skills) → `connect/SKILL.md`
