...
description: "'Deploy Fathom webhook handlers and meeting sync services. Trigger with phrases like \"deploy fathom\", \"fathom webhook server\", \"fathom cloud function\". '"
allowed-tools: "Read, Write, Edit, Bash(gcloud:*)"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/fathom-pack/skills/fathom-deploy-integration/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/fathom-pack/skills/fathom-deploy-integration/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/fathom-pack/skills/fathom-deploy-integration/SKILL.md`
