...
source_url: https://github.com/openai/skills/blob/HEAD/skills/.curated/notion-spec-to-implementation/SKILL.md
---
...
**Source:** [`openai/skills`](https://github.com/openai/skills) → `skills/.curated/notion-spec-to-implementation/SKILL.md`

**Also appears in:** `composio-community/awesome-codex-skills/notion-spec-to-implementation/SKILL.md`
