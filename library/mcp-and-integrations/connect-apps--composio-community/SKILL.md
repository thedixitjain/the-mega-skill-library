...
source_path: "connect-apps/SKILL.md"
source_url: https://github.com/composio-community/awesome-codex-skills/blob/HEAD/connect-apps/SKILL.md
---
...
**Source:** [`composio-community/awesome-codex-skills`](https://github.com/composio-community/awesome-codex-skills) → `connect-apps/SKILL.md`
