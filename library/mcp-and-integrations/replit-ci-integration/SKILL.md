...
description: "'Configure CI/CD for Replit with GitHub Actions, automated testing, and deploy-on-push. Use when setting up automated testing, GitHub integration for Replit, or continuous deployment pipelines that deploy to Replit. Trigger with phrases like \"replit CI\", \"replit GitHub Actions\", \"replit automated deploy\", \"CI replit\", \"replit GitHub\". '"
allowed-tools: "Read, Write, Edit, Bash(gh:*)"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/replit-ci-integration/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/replit-ci-integration/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/replit-ci-integration/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/replit-pack/skills/replit-ci-integration/SKILL.md`
