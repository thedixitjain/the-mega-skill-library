...
description: "'Automate Finta data export and reporting in CI pipelines. Trigger with phrases like \"finta CI\", \"finta automated reporting\". '"
allowed-tools: "Read, Write, Edit"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/finta-pack/skills/finta-ci-integration/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/finta-pack/skills/finta-ci-integration/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/finta-pack/skills/finta-ci-integration/SKILL.md`
