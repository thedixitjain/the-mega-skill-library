...
source_path: "engineering/skills/mcp-server-builder/SKILL.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/engineering/skills/mcp-server-builder/SKILL.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `engineering/skills/mcp-server-builder/SKILL.md`
