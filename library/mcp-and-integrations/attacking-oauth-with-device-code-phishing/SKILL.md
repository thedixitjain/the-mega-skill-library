...
source_path: "skills/attacking-oauth-with-device-code-phishing/SKILL.md"
source_url: https://github.com/mukul975/Anthropic-Cybersecurity-Skills/blob/HEAD/skills/attacking-oauth-with-device-code-phishing/SKILL.md
---
...
**Source:** [`mukul975/Anthropic-Cybersecurity-Skills`](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) → `skills/attacking-oauth-with-device-code-phishing/SKILL.md`
