...
source_path: "plugins/mcp/servicegraph/skills/find-ai-consultancy/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/mcp/servicegraph/skills/find-ai-consultancy/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/mcp/servicegraph/skills/find-ai-consultancy/SKILL.md`
