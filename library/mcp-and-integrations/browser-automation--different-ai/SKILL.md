...
source_path: ".opencode/skills/browser-automation/SKILL.md"
source_url: https://github.com/different-ai/openwork/blob/HEAD/.opencode/skills/browser-automation/SKILL.md
---
