...
source_path: "skills/mcp-deploy-manage-agents/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/mcp-deploy-manage-agents/SKILL.md
---
````prompt
---
mode: 'agent'
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/mcp-deploy-manage-agents/SKILL.md`
