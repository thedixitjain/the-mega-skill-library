...
source_path: "plugins/all-skills/skills/airtable-automation/SKILL.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-skills/skills/airtable-automation/SKILL.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-skills/skills/airtable-automation/SKILL.md`
