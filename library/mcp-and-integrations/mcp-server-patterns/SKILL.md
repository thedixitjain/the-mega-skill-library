...
source_path: ".agents/skills/mcp-server-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.agents/skills/mcp-server-patterns/SKILL.md
---
# MCP Server Patterns
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.agents/skills/mcp-server-patterns/SKILL.md`

**Also appears in:** `affaan-m/ECC/.cursor/skills/mcp-server-patterns/SKILL.md`, `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/mcp-server-patterns/SKILL.md`
