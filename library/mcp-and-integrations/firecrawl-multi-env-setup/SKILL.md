...
source_path: "plugins/saas-packs/firecrawl-pack/skills/firecrawl-multi-env-setup/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/firecrawl-pack/skills/firecrawl-multi-env-setup/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/firecrawl-pack/skills/firecrawl-multi-env-setup/SKILL.md`
