...
source_path: "docs/zh-CN/skills/mcp-server-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/mcp-server-patterns/SKILL.md
---
# MCP 服务器模式
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/mcp-server-patterns/SKILL.md`
