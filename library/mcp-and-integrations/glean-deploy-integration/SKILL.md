...
description: "'Deploy Glean custom connectors as scheduled jobs on Cloud Run, Lambda, or Fly.io. Trigger: \"deploy glean connector\", \"glean connector hosting\", \"schedule glean indexing\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(gcloud:*), Grep"
category: mcp-and-integrations
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/glean-pack/skills/glean-deploy-integration/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/glean-pack/skills/glean-deploy-integration/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/glean-pack/skills/glean-deploy-integration/SKILL.md`
