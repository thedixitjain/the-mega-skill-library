...
source_path: "plugins/claude-code-setting/skills/mcp-config/SKILL.md"
source_url: https://github.com/libukai/awesome-agent-skills/blob/HEAD/plugins/claude-code-setting/skills/mcp-config/SKILL.md
---
...
**Source:** [`libukai/awesome-agent-skills`](https://github.com/libukai/awesome-agent-skills) → `plugins/claude-code-setting/skills/mcp-config/SKILL.md`
