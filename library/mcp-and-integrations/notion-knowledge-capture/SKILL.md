...
source_url: https://github.com/openai/skills/blob/HEAD/skills/.curated/notion-knowledge-capture/SKILL.md
---
...
**Source:** [`openai/skills`](https://github.com/openai/skills) → `skills/.curated/notion-knowledge-capture/SKILL.md`

**Also appears in:** `composio-community/awesome-codex-skills/notion-knowledge-capture/SKILL.md`
