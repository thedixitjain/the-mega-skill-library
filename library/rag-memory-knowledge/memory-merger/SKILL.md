...
source_path: "skills/memory-merger/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/memory-merger/SKILL.md
---
# Memory Merger
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/memory-merger/SKILL.md`
