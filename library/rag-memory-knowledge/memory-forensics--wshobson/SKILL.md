...
source_path: "plugins/reverse-engineering/skills/memory-forensics/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/reverse-engineering/skills/memory-forensics/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/reverse-engineering/skills/memory-forensics/SKILL.md`
