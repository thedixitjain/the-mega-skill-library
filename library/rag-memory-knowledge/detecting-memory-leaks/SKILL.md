...
source_path: "skills/.curated/detecting-memory-leaks/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/detecting-memory-leaks/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/detecting-memory-leaks/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/performance/memory-leak-detector/skills/detecting-memory-leaks/SKILL.md`
