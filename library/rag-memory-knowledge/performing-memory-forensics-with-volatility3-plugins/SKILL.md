...
source_path: "skills/performing-memory-forensics-with-volatility3-plugins/SKILL.md"
source_url: https://github.com/mukul975/Anthropic-Cybersecurity-Skills/blob/HEAD/skills/performing-memory-forensics-with-volatility3-plugins/SKILL.md
---
...
**Source:** [`mukul975/Anthropic-Cybersecurity-Skills`](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) → `skills/performing-memory-forensics-with-volatility3-plugins/SKILL.md`
