...
source_path: "docs/ja-JP/skills/iterative-retrieval/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/iterative-retrieval/SKILL.md
---
# 反復検索パターン
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/iterative-retrieval/SKILL.md`
