...
source_path: "plugins/llm-application-dev/skills/hybrid-search-implementation/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/llm-application-dev/skills/hybrid-search-implementation/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/llm-application-dev/skills/hybrid-search-implementation/SKILL.md`
