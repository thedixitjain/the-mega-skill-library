...
source_path: "skills/knowledge-ops/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/knowledge-ops/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/knowledge-ops/SKILL.md`
