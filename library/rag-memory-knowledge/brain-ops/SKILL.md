---
name: brain-ops
description: "| Brain knowledge base operations. The core read/write cycle: brain-first lookup, read-enrich-write loop, source attribution, ambient enrichment, back-linking. Read this before any brain interaction."
allowed-tools: "search query get_page put_page add_link add_timeline_entry get_backlinks sync_brain"
category: rag-memory-knowledge
source_repo: garrytan/gbrain
source_path: "skills/brain-ops/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/brain-ops/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/brain-ops/SKILL.md`
