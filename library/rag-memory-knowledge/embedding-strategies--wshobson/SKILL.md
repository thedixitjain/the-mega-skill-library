...
source_path: "plugins/llm-application-dev/skills/embedding-strategies/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/llm-application-dev/skills/embedding-strategies/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/llm-application-dev/skills/embedding-strategies/SKILL.md`
