...
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/qdrant-scaling/minimize-latency/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/qdrant-scaling/minimize-latency/SKILL.md`
