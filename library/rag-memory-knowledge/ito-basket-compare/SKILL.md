...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/ito-basket-compare/SKILL.md
---
# Itô Basket Compare
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/ito-basket-compare/SKILL.md`
