...
source_path: "plugins/dgx-spark-ops/skills/spark-memory-thermal-ops/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/dgx-spark-ops/skills/spark-memory-thermal-ops/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/dgx-spark-ops/skills/spark-memory-thermal-ops/SKILL.md`
