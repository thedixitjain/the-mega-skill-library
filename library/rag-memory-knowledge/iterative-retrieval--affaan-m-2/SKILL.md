...
source_path: "docs/zh-CN/skills/iterative-retrieval/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/iterative-retrieval/SKILL.md
---
# 迭代检索模式
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/iterative-retrieval/SKILL.md`
