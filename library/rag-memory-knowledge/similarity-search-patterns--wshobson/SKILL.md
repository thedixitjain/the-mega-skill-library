...
source_path: "plugins/llm-application-dev/skills/similarity-search-patterns/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/llm-application-dev/skills/similarity-search-patterns/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/llm-application-dev/skills/similarity-search-patterns/SKILL.md`
