...
source_path: "plugins/memory-palace/skills/knowledge-intake/SKILL.md"
source_url: https://github.com/athola/claude-night-market/blob/HEAD/plugins/memory-palace/skills/knowledge-intake/SKILL.md
---
...
**Source:** [`athola/claude-night-market`](https://github.com/athola/claude-night-market) → `plugins/memory-palace/skills/knowledge-intake/SKILL.md`
