...
description: "'Google Search scraping with SerpApi -- organic results, knowledge graph, answer boxes. Use when building search-powered features, SEO monitoring, or extracting structured data from Google results. Trigger: \"serpapi google search\", \"scrape google\", \"serpapi organic results\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Grep"
category: rag-memory-knowledge
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/serpapi-core-workflow-a/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/serpapi-core-workflow-a/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/serpapi-core-workflow-a/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/serpapi-pack/skills/serpapi-core-workflow-a/SKILL.md`
