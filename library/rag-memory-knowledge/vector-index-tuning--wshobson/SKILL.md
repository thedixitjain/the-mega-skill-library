...
source_path: "plugins/llm-application-dev/skills/vector-index-tuning/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/llm-application-dev/skills/vector-index-tuning/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/llm-application-dev/skills/vector-index-tuning/SKILL.md`
