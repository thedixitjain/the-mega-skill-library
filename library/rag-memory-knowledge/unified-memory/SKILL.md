...
source_path: "skills/unified-memory/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/unified-memory/SKILL.md
---
# Unified Memory
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/unified-memory/SKILL.md`

**Also appears in:** `affaan-m/ECC/.agents/skills/unified-memory/SKILL.md`, `affaan-m/ECC/.cursor/skills/unified-memory/SKILL.md`
