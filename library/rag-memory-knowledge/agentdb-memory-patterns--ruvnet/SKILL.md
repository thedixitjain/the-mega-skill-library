...
source_path: ".agents/skills/agentdb-memory-patterns/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/.agents/skills/agentdb-memory-patterns/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `.agents/skills/agentdb-memory-patterns/SKILL.md`
