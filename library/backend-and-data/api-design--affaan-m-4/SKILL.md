...
source_path: "docs/zh-CN/skills/api-design/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/api-design/SKILL.md
---
# API 设计模式
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/api-design/SKILL.md`
