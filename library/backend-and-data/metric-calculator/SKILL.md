...
description: "'Configure and manage - Calculate metric calculator operations. Auto-activating skill for Data Analytics. Triggers on: metric calculator, metric calculator Part of the Data Analytics skill category. Use when working with metric calculator functionality. Trigger with phrases like \"metric calculator\", \"metric calculator\", \"metric\". '"
allowed-tools: "Read, Write, Edit, Bash(cmd:*), Grep"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/12-data-analytics/metric-calculator/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/12-data-analytics/metric-calculator/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/12-data-analytics/metric-calculator/SKILL.md`
