---
name: skill-server-side-template-injection-ssti
description: "- Skill Name: ssti - Folder: offensive-ssti - Source: https://github.com/SnailSploit/offensive-checklist/blob/main/ssti.md"
category: backend-and-data
source_repo: SnailSploit/Claude-Red
source_path: "Skills/web/offensive-ssti/SKILL.md"
source_url: https://github.com/SnailSploit/Claude-Red/blob/HEAD/Skills/web/offensive-ssti/SKILL.md
---
...
**Source:** [`SnailSploit/Claude-Red`](https://github.com/SnailSploit/Claude-Red) → `Skills/web/offensive-ssti/SKILL.md`
