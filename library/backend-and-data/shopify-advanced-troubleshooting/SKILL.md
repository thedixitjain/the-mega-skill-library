...
description: "'Debug complex Shopify API issues using cost analysis, request tracing, webhook delivery inspection, and GraphQL introspection. Use when encountering intermittent failures, throttling mysteries, or webhook delivery gaps. Trigger with phrases like \"shopify hard bug\", \"shopify mystery error\", \"shopify deep debug\", \"difficult shopify issue\", \"shopify intermittent failure\". '"
allowed-tools: "Read, Grep, Bash(curl:*), Bash(node:*)"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/shopify-advanced-troubleshooting/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/shopify-advanced-troubleshooting/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/shopify-advanced-troubleshooting/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/shopify-pack/skills/shopify-advanced-troubleshooting/SKILL.md`
