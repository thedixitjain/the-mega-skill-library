...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/evm-token-decimals/SKILL.md
---
# EVM Token Decimals
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/evm-token-decimals/SKILL.md`
