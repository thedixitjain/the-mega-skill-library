...
description: "'Implement content moderation, model selection policy, citation quality enforcement, and per-user usage quotas for Perplexity Sonar API. Trigger with phrases like \"perplexity policy\", \"perplexity guardrails\", \"perplexity content moderation\", \"perplexity usage limits\", \"perplexity safety\". '"
allowed-tools: "Read, Write, Edit, Bash(npx:*)"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/perplexity-pack/skills/perplexity-policy-guardrails/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/perplexity-pack/skills/perplexity-policy-guardrails/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/perplexity-pack/skills/perplexity-policy-guardrails/SKILL.md`
