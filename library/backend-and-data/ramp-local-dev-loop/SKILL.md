...
description: "\"Ramp local dev loop \\u2014 corporate card and expense management API\\ \\ integration.\\nUse when working with Ramp for card management, expenses, or accounting\\ \\ sync.\\nTrigger with phrases like \\\"ramp local dev loop\\\", \\\"ramp-local-dev-loop\\\"\\ , \\\"corporate card API\\\".\\n\""
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(curl:*), Grep"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/ramp-local-dev-loop/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/ramp-local-dev-loop/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/ramp-local-dev-loop/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/ramp-pack/skills/ramp-local-dev-loop/SKILL.md`
