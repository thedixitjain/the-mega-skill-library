...
source_path: "docs/ja-JP/skills/scientific-db-pubmed-database/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/scientific-db-pubmed-database/SKILL.md
---
# PubMed Database
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/scientific-db-pubmed-database/SKILL.md`
