...
source_path: "plugins/saas-packs/salesforce-pack/skills/salesforce-core-workflow-a/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/salesforce-pack/skills/salesforce-core-workflow-a/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/salesforce-pack/skills/salesforce-core-workflow-a/SKILL.md`
