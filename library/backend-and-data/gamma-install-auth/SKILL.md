...
description: "'Set up Gamma API v1.0 authentication and first request. Use when configuring API keys, setting up X-API-KEY header, or initializing Gamma REST API access in a project. Trigger: \"install gamma\", \"setup gamma API\", \"gamma auth\", \"gamma API key\", \"configure gamma\". '"
allowed-tools: "Read, Write, Edit, Bash(curl:*), Bash(npm:*), Bash(pip:*)"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/gamma-install-auth/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/gamma-install-auth/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/gamma-install-auth/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/gamma-pack/skills/gamma-install-auth/SKILL.md`
