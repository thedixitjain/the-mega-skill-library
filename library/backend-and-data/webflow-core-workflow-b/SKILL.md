...
description: "\"Execute Webflow secondary workflows \\u2014 Sites management, Pages API,\\ \\ Forms submissions,\\nEcommerce (products/orders/inventory), and Custom Code via\\ \\ the Data API v2.\\nUse when managing sites, reading pages, handling form data,\\ \\ or working with\\nWebflow Ecommerce products and orders.\\nTrigger with phrases\\ \\ like \\\"webflow sites\\\", \\\"webflow pages\\\", \\\"webflow forms\\\",\\n\\\"webflow ecommerce\\\"\\ , \\\"webflow products\\\", \\\"webflow orders\\\".\\n\""
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(npx:*), Grep"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/webflow-pack/skills/webflow-core-workflow-b/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/webflow-pack/skills/webflow-core-workflow-b/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/webflow-pack/skills/webflow-core-workflow-b/SKILL.md`
