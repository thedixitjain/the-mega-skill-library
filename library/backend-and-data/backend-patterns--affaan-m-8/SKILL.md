...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/backend-patterns/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/backend-patterns/SKILL.md`
