...
source_path: "docs/ko-KR/skills/backend-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/skills/backend-patterns/SKILL.md
---
# 백엔드 개발 패턴
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/skills/backend-patterns/SKILL.md`
