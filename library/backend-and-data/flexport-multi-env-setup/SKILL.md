...
description: "'Configure Flexport API across dev, staging, and production environments with isolated API keys, separate webhook endpoints, and environment guards. Trigger: \"flexport environments\", \"flexport staging\", \"flexport multi-env\". '"
allowed-tools: "Read, Write, Edit, Grep"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/flexport-pack/skills/flexport-multi-env-setup/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/flexport-pack/skills/flexport-multi-env-setup/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/flexport-pack/skills/flexport-multi-env-setup/SKILL.md`
