...
description: "'Implement Perplexity query sanitization, citation validation, result caching, and conversation context management for search workflows. Trigger with phrases like \"perplexity data\", \"perplexity PII\", \"perplexity citations\", \"perplexity cache\", \"perplexity context\". '"
allowed-tools: "Read, Write, Edit"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/perplexity-pack/skills/perplexity-data-handling/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/perplexity-pack/skills/perplexity-data-handling/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/perplexity-pack/skills/perplexity-data-handling/SKILL.md`
