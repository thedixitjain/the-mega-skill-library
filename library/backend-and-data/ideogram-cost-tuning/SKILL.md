...
description: "'Optimize Ideogram costs through model selection, caching, and usage monitoring. Use when analyzing Ideogram billing, reducing API costs, or implementing budget alerts and usage tracking. Trigger with phrases like \"ideogram cost\", \"ideogram billing\", \"reduce ideogram costs\", \"ideogram pricing\", \"ideogram budget\", \"ideogram credits\". '"
allowed-tools: "Read, Write, Edit, Bash(curl:*), Grep"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/ideogram-pack/skills/ideogram-cost-tuning/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/ideogram-pack/skills/ideogram-cost-tuning/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/ideogram-pack/skills/ideogram-cost-tuning/SKILL.md`
