...
description: "'Use multiple AI providers (OpenAI, Anthropic, Google, Meta) through OpenRouter''s unified API. Use when comparing providers, building cross-provider workflows, or maximizing availability. Triggers: ''openrouter providers'', ''multi provider'', ''openrouter openai anthropic'', ''compare models openrouter''. '"
allowed-tools: "Read, Write, Edit, Grep, Bash(python3:*), Bash(curl:*), Bash(jq:*)"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/openrouter-multi-provider/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/openrouter-multi-provider/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/openrouter-multi-provider/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/openrouter-pack/skills/openrouter-multi-provider/SKILL.md`
