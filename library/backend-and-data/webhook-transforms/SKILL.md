...
description: "| Generic framework for converting external events (SMS, meetings, social mentions) into brain-ingestible signals. Define a transform function, register a webhook URL, and incoming events get processed through the brain pipeline."
allowed-tools: "put_page add_timeline_entry search"
category: backend-and-data
source_repo: garrytan/gbrain
source_path: "skills/webhook-transforms/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/webhook-transforms/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/webhook-transforms/SKILL.md`
