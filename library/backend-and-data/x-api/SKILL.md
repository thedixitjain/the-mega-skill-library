...
source_path: ".agents/skills/x-api/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.agents/skills/x-api/SKILL.md
---
# X API
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.agents/skills/x-api/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/x-api/SKILL.md`
