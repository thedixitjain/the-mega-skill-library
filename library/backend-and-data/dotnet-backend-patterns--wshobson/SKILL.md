...
source_path: "plugins/dotnet-contribution/skills/dotnet-backend-patterns/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/dotnet-contribution/skills/dotnet-backend-patterns/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/dotnet-contribution/skills/dotnet-backend-patterns/SKILL.md`
