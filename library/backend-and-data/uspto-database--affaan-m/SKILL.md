...
source_path: "skills/scientific-db-uspto-database/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/scientific-db-uspto-database/SKILL.md
---
# USPTO Database
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/scientific-db-uspto-database/SKILL.md`
