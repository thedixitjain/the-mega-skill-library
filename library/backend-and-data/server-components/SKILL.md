...
source_path: "plugins/nextjs-expert/skills/server-components/SKILL.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/nextjs-expert/skills/server-components/SKILL.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/nextjs-expert/skills/server-components/SKILL.md`
