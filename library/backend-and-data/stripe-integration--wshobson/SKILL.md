...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/payment-processing/skills/stripe-integration/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/payment-processing/skills/stripe-integration/SKILL.md`
