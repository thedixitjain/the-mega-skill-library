...
source_path: "docs/ja-JP/skills/database-migrations/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/database-migrations/SKILL.md
---
# データベースマイグレーションパターン
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/database-migrations/SKILL.md`
