...
description: "'Manage Miro connectors, images, embeds, app cards, and document items via REST API v2. Use for visual workflows, embedding content, and building rich board layouts. Trigger with phrases like \"miro connectors\", \"miro embed\", \"miro app card\", \"miro image upload\", \"connect miro items\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(curl:*), Grep"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/miro-pack/skills/miro-core-workflow-b/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/miro-pack/skills/miro-core-workflow-b/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/miro-pack/skills/miro-core-workflow-b/SKILL.md`
