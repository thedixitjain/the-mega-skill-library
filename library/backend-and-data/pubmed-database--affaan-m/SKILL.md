...
source_path: "skills/scientific-db-pubmed-database/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/scientific-db-pubmed-database/SKILL.md
---
# PubMed Database
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/scientific-db-pubmed-database/SKILL.md`
