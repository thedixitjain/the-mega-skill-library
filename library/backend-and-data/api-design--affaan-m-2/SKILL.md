...
source_path: "docs/ja-JP/skills/api-design/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/api-design/SKILL.md
---
# API デザイン パターン
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/api-design/SKILL.md`
