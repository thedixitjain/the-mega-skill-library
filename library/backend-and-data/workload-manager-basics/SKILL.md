...
source_path: "skills/cloud/workload-manager-basics/SKILL.md"
source_url: https://github.com/google/skills/blob/HEAD/skills/cloud/workload-manager-basics/SKILL.md
---
...
**Source:** [`google/skills`](https://github.com/google/skills) → `skills/cloud/workload-manager-basics/SKILL.md`
