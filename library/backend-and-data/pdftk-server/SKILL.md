...
source_path: "skills/pdftk-server/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/pdftk-server/SKILL.md
---
# PDFtk Server
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/pdftk-server/SKILL.md`
