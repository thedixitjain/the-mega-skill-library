...
source_path: "skills/ssma-console/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/ssma-console/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/ssma-console/SKILL.md`
