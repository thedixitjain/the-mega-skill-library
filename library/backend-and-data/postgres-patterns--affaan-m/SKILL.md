...
source_path: "docs/es/skills/postgres-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/skills/postgres-patterns/SKILL.md
---
# Patrones PostgreSQL
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/skills/postgres-patterns/SKILL.md`
