...
source_url: https://github.com/anthropics/skills/blob/HEAD/skills/claude-api/SKILL.md
---
...
**Source:** [`anthropics/skills`](https://github.com/anthropics/skills) → `skills/claude-api/SKILL.md`
