...
source_path: "skills/contract-first/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/contract-first/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/contract-first/SKILL.md`
