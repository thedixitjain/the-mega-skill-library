...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/laravel-patterns/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/laravel-patterns/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/laravel-patterns/SKILL.md`, `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/laravel-patterns/SKILL.md`
