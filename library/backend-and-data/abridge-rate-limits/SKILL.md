...
description: "'Implement Abridge rate limiting, backoff, and session throttling patterns. Use when handling 429 errors, managing concurrent encounter sessions, or optimizing API throughput for high-volume clinical deployments. Trigger: \"abridge rate limit\", \"abridge 429\", \"abridge throttling\", \"abridge concurrent sessions\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*)"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/abridge-pack/skills/abridge-rate-limits/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/abridge-pack/skills/abridge-rate-limits/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/abridge-pack/skills/abridge-rate-limits/SKILL.md`
