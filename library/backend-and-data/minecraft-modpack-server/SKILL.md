...
source_path: "optional-skills/gaming/minecraft-modpack-server/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/optional-skills/gaming/minecraft-modpack-server/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `optional-skills/gaming/minecraft-modpack-server/SKILL.md`
