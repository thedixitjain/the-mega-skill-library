...
description: "'Build prefect flow builder operations. Auto-activating skill for Data Pipelines. Triggers on: prefect flow builder, prefect flow builder Part of the Data Pipelines skill category. Use when working with prefect flow builder functionality. Trigger with phrases like \"prefect flow builder\", \"prefect builder\", \"prefect\". '"
allowed-tools: "Read, Write, Edit, Bash(cmd:*), Grep"
category: backend-and-data
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/11-data-pipelines/prefect-flow-builder/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/11-data-pipelines/prefect-flow-builder/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/11-data-pipelines/prefect-flow-builder/SKILL.md`
