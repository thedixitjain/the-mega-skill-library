...
source_path: "skills/reviewing-oracle-to-postgres-migration/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/reviewing-oracle-to-postgres-migration/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/reviewing-oracle-to-postgres-migration/SKILL.md`
