...
source_path: "docs/zh-CN/skills/database-migrations/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/database-migrations/SKILL.md
---
# 数据库迁移模式
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/database-migrations/SKILL.md`
