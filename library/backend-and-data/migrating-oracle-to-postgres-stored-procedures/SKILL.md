...
source_path: "skills/migrating-oracle-to-postgres-stored-procedures/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/migrating-oracle-to-postgres-stored-procedures/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/migrating-oracle-to-postgres-stored-procedures/SKILL.md`
