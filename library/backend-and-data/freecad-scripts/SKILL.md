...
source_path: "skills/freecad-scripts/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/freecad-scripts/SKILL.md
---
# FreeCAD Scripts
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/freecad-scripts/SKILL.md`
