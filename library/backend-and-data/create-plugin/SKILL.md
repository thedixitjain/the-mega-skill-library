...
source_path: ".opencode/skills/create-plugin/SKILL.md"
source_url: https://github.com/different-ai/openwork/blob/HEAD/.opencode/skills/create-plugin/SKILL.md
---
...
**Source:** [`different-ai/openwork`](https://github.com/different-ai/openwork) → `.opencode/skills/create-plugin/SKILL.md`
