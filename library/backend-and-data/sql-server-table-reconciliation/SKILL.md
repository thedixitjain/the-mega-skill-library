...
source_path: "skills/sql-server-table-reconciliation/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/sql-server-table-reconciliation/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/sql-server-table-reconciliation/SKILL.md`
