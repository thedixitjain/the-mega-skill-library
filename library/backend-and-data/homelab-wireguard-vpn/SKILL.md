...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/homelab-wireguard-vpn/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/homelab-wireguard-vpn/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/homelab-wireguard-vpn/SKILL.md`
