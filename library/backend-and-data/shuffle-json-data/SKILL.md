...
source_path: "skills/shuffle-json-data/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/shuffle-json-data/SKILL.md
---
# Shuffle JSON Data
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/shuffle-json-data/SKILL.md`
