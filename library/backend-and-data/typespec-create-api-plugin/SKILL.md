...
source_path: "skills/typespec-create-api-plugin/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/typespec-create-api-plugin/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/typespec-create-api-plugin/SKILL.md`
