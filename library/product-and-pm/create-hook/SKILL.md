...
source_path: "skills/create-hook/SKILL.md"
source_url: https://github.com/am-will/codex-skills/blob/HEAD/skills/create-hook/SKILL.md
---
...
**Source:** [`am-will/codex-skills`](https://github.com/am-will/codex-skills) → `skills/create-hook/SKILL.md`
