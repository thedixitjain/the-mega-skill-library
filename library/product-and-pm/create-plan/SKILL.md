...
source_path: ".forge/skills/create-plan/SKILL.md"
source_url: https://github.com/tailcallhq/forgecode/blob/HEAD/.forge/skills/create-plan/SKILL.md
---
...
**Source:** [`tailcallhq/forgecode`](https://github.com/tailcallhq/forgecode) → `.forge/skills/create-plan/SKILL.md`
