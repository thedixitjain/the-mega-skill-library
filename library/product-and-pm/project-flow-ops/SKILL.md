...
source_path: "skills/project-flow-ops/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/project-flow-ops/SKILL.md
---
# Project Flow Ops
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/project-flow-ops/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/project-flow-ops/SKILL.md`
