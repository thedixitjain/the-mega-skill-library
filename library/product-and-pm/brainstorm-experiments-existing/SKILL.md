...
source_path: "pm-product-discovery/skills/brainstorm-experiments-existing/SKILL.md"
source_url: https://github.com/phuryn/pm-skills/blob/HEAD/pm-product-discovery/skills/brainstorm-experiments-existing/SKILL.md
---
...
**Source:** [`phuryn/pm-skills`](https://github.com/phuryn/pm-skills) → `pm-product-discovery/skills/brainstorm-experiments-existing/SKILL.md`
