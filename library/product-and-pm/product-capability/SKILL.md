...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/product-capability/SKILL.md
---
# Product Capability
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/product-capability/SKILL.md`

**Also appears in:** `affaan-m/ECC/.agents/skills/product-capability/SKILL.md`
