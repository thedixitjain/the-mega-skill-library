...
description: "'Configure PostHog across development, staging, and production environments. Separate PostHog projects per environment, environment-specific SDK config, feature flag rollout per env, and session recording controls. Trigger: \"posthog environments\", \"posthog staging\", \"posthog dev prod\", \"posthog environment setup\", \"posthog project per env\". '"
allowed-tools: "Read, Write, Edit, Bash(aws:*), Bash(gcloud:*), Bash(vault:*)"
category: product-and-pm
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/posthog-pack/skills/posthog-multi-env-setup/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/posthog-pack/skills/posthog-multi-env-setup/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/posthog-pack/skills/posthog-multi-env-setup/SKILL.md`
