---
name: gsdreview-backlog
description: "Review and promote backlog items to active milestone"
allowed-tools: "Read Write Bash AskUserQuestion"
category: product-and-pm
source_repo: davepoon/buildwithclaude
source_path: "plugins/gsd/skills/review-backlog/SKILL.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/gsd/skills/review-backlog/SKILL.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/gsd/skills/review-backlog/SKILL.md`
