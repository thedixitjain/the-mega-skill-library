...
source_path: "plugins/productivity/cli-power-skills/skills/python-tooling/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/productivity/cli-power-skills/skills/python-tooling/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/productivity/cli-power-skills/skills/python-tooling/SKILL.md`
