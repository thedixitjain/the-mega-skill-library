...
source_path: "plugins/productivity/intent-labs-pack/skills/validate-skillmd/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/productivity/intent-labs-pack/skills/validate-skillmd/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/productivity/intent-labs-pack/skills/validate-skillmd/SKILL.md`
