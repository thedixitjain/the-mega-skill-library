...
source_path: "plugins/productivity/schedule-after-usage-reset/skills/schedule-after-usage-reset/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/productivity/schedule-after-usage-reset/skills/schedule-after-usage-reset/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/productivity/schedule-after-usage-reset/skills/schedule-after-usage-reset/SKILL.md`
