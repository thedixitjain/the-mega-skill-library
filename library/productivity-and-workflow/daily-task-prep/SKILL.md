...
allowed-tools: "search query get_page list_pages get_timeline"
category: productivity-and-workflow
source_repo: garrytan/gbrain
source_path: "skills/daily-task-prep/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/daily-task-prep/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/daily-task-prep/SKILL.md`
