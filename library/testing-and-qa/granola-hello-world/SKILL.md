...
description: "'Capture your first meeting with Granola and review AI-enhanced notes. Use when testing Granola setup, learning the notepad + transcript flow, or understanding how Enhance Notes and Granola Chat work. Trigger: \"granola hello world\", \"first granola meeting\", \"try granola\", \"granola test\". '"
allowed-tools: "Read, Write, Edit, Bash(pgrep:*), Bash(open:*)"
category: testing-and-qa
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/granola-hello-world/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/granola-hello-world/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/granola-hello-world/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/granola-pack/skills/granola-hello-world/SKILL.md`
