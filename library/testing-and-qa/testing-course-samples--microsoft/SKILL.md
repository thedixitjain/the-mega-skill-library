...
description: "تحقق من أن دفاتر الدروس وعيّنات الأكواد تعمل على إعداد Microsoft Foundry / Azure OpenAI المباشر. يضم المستودع مشغّلًا في scripts/validate-notebooks.ps1 الذي ينفّذ كل دفتر Python بدون واجهة ويطبع مصفوفة النتيجة PASS/FAIL."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ar/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ar/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ar/.agents/skills/testing-course-samples/SKILL.md`
