...
description: "ਪੁਸ਼ਟੀ ਕਰੋ ਕਿ ਲੈਸਨ ਨੋਟਬੁੱਕ ਅਤੇ ਕੋਡ ਸੈਂਪਲਜ਼ ਇੱਕ ਲਾਈਵ Microsoft Foundry / Azure OpenAI ਸੈਟਅੱਪ ਵਿਰੁੱਧ ਚੱਲ ਰਹੇ ਹਨ। ਰਿਪੋ ਵਿੱਚ ਇੱਕ ਰਨਰ ਸ਼ਾਮਿਲ ਹੈ scripts/validate-notebooks.ps1 ਜੋ ਸਾਰੇ ਪਾਇਥਨ ਨੋਟਬੁੱਕ ਨੂੰ ਬਿਨਾਂ ਵਿਖਾਵਟ ਦੇ ਚਲਾਉਂਦਾ ਹੈ ਅਤੇ ਇੱਕ PASS/FAIL ਮੈਟ੍ਰਿਕਸ ਪ੍ਰਿੰਟ ਕਰਦਾ ਹੈ।"
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/pa/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/pa/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/pa/.agents/skills/testing-course-samples/SKILL.md`
