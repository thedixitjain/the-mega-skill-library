...
source_path: "docs/zh-CN/skills/swift-protocol-di-testing/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/swift-protocol-di-testing/SKILL.md
---
# 基于协议的 Swift 依赖注入测试
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/swift-protocol-di-testing/SKILL.md`
