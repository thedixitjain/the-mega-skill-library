...
source_path: ".forge/skills/test-reasoning/SKILL.md"
source_url: https://github.com/tailcallhq/forgecode/blob/HEAD/.forge/skills/test-reasoning/SKILL.md
---
...
**Source:** [`tailcallhq/forgecode`](https://github.com/tailcallhq/forgecode) → `.forge/skills/test-reasoning/SKILL.md`
