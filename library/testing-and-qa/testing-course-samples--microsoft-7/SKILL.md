...
description: "Επαληθεύστε ότι τα τετράδια μαθημάτων και τα δείγματα κώδικα εκτελούνται σε ένα ζωντανό περιβάλλον Microsoft Foundry / Azure OpenAI. Το αποθετήριο παρέχει έναν εκτελεστή στο scripts/validate-notebooks.ps1 που εκτελεί κάθε τετράδιο Python χωρίς περιβάλλον χρήστη και εμφανίζει έναν πίνακα ΔΙΕΛΕΙΨΗ/ΑΠΟΤΥΧΙΑ."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/el/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/el/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/el/.agents/skills/testing-course-samples/SKILL.md`
