...
source_path: "pm-execution/skills/test-scenarios/SKILL.md"
source_url: https://github.com/phuryn/pm-skills/blob/HEAD/pm-execution/skills/test-scenarios/SKILL.md
---
...
**Source:** [`phuryn/pm-skills`](https://github.com/phuryn/pm-skills) → `pm-execution/skills/test-scenarios/SKILL.md`
