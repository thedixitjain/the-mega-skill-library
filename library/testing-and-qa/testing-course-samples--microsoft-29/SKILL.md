...
description: "Valide que os notebooks das lições e os exemplos de código funcionam em uma configuração ativa Microsoft Foundry / Azure OpenAI. O repositório inclui um executor em scripts/validate-notebooks.ps1 que executa todos os notebooks Python de forma headless e imprime uma matriz PASS/FAIL."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/pt-BR/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/pt-BR/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/pt-BR/.agents/skills/testing-course-samples/SKILL.md`
