...
source_path: "skills/javascript-typescript-jest/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/javascript-typescript-jest/SKILL.md
---
### Test Structure
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/javascript-typescript-jest/SKILL.md`
