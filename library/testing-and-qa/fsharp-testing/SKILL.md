...
source_path: "skills/fsharp-testing/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/fsharp-testing/SKILL.md
---
# F# Testing Patterns
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/fsharp-testing/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/fsharp-testing/SKILL.md`
