...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/rust-testing/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/rust-testing/SKILL.md`

**Also appears in:** `affaan-m/ECC/.kiro/skills/rust-testing/SKILL.md`, `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/rust-testing/SKILL.md`
