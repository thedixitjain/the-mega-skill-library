...
description: "'Deploy a GPU workload on CoreWeave with kubectl. Use when running your first GPU job, testing inference, or verifying CoreWeave cluster access. Trigger with phrases like \"coreweave hello world\", \"coreweave first deploy\", \"coreweave gpu test\", \"run on coreweave\". '"
allowed-tools: "Read, Write, Edit, Bash(kubectl:*)"
category: testing-and-qa
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/coreweave-pack/skills/coreweave-hello-world/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/coreweave-pack/skills/coreweave-hello-world/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/coreweave-pack/skills/coreweave-hello-world/SKILL.md`
