...
description: "सत्यापित करें कि पाठ नोटबुक और कोड नमूने एक लाइव Microsoft Foundry / Azure OpenAI सेटअप के खिलाफ चल रहे हैं। रिपो एक रनर भेजता है scripts/validate-notebooks.ps1 जो हर पायथन नोटबुक को हेडलेसली निष्पादित करता है और एक PASS/FAIL मैट्रिक्स प्रिंट करता है।"
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/hi/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/hi/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/hi/.agents/skills/testing-course-samples/SKILL.md`
