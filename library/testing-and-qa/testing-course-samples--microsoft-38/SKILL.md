...
description: "Ders defterlerinin ve kod örneklerinin canlı bir Microsoft Foundry / Azure OpenAI kurulumu üzerinde çalıştığını doğrulayın. Depo, her Python defterini başsız olarak çalıştıran ve PASS/FAIL matrisi yazdıran scripts/validate-notebooks.ps1 adlı bir çalıştırıcı sağlar."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/tr/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/tr/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/tr/.agents/skills/testing-course-samples/SKILL.md`
