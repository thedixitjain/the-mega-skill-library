...
description: "Перевірте, що навчальні зошити та приклади коду працюють з живим налаштуванням Microsoft Foundry / Azure OpenAI. Репозиторій містить утиліту scripts/validate-notebooks.ps1, яка запускає кожен Python-зошит без інтерфейсу та виводить матрицю PASS/FAIL."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/uk/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/uk/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/uk/.agents/skills/testing-course-samples/SKILL.md`
