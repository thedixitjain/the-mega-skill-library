...
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/mutation-testing/skills/mutation-testing/SKILL.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/mutation-testing/skills/mutation-testing/SKILL.md`
