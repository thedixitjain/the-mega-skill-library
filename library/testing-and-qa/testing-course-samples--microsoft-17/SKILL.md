...
description: "Validasi bahwa buku catatan pelajaran dan contoh kode berjalan terhadap pengaturan Microsoft Foundry / Azure OpenAI yang aktif. Repo menyediakan sebuah runner di scripts/validate-notebooks.ps1 yang menjalankan setiap notebook Python tanpa antarmuka dan mencetak matriks PASS/FAIL."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/id/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/id/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/id/.agents/skills/testing-course-samples/SKILL.md`
