...
source_path: ".claude/skills/day-one-patch/SKILL.md"
source_url: https://github.com/Donchitos/Claude-Code-Game-Studios/blob/HEAD/.claude/skills/day-one-patch/SKILL.md
---
...
**Source:** [`Donchitos/Claude-Code-Game-Studios`](https://github.com/Donchitos/Claude-Code-Game-Studios) → `.claude/skills/day-one-patch/SKILL.md`
