...
description: "Ellenőrizze, hogy a leckék jegyzetei és kódmintái működnek-e egy élő Microsoft Foundry / Azure OpenAI környezettel. A repo tartalmaz egy futtatót a scripts/validate-notebooks.ps1 útvonalon, amely fej nélküli futtatással végrehajt minden Python jegyzetfüzetet, és PASS/FAIL mátrixot nyomtat."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/hu/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/hu/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/hu/.agents/skills/testing-course-samples/SKILL.md`
