...
description: "اعتبارسنجی کنید که دفترچه‌های درس و نمونه‌های کد در برابر یک تنظیم زنده Microsoft Foundry / Azure OpenAI اجرا می‌شوند. این مخزن یک اجراکننده را در scripts/validate-notebooks.ps1 ارائه می‌دهد که هر دفترچه پایتون را بدون رابط کاربری گرافیکی اجرا کرده و ماتریس قبول/رد را چاپ می‌کند."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/fa/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/fa/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/fa/.agents/skills/testing-course-samples/SKILL.md`
