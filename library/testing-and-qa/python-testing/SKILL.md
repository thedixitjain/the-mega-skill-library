...
source_path: ".kiro/skills/python-testing/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.kiro/skills/python-testing/SKILL.md
---
# Python Testing
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.kiro/skills/python-testing/SKILL.md`
