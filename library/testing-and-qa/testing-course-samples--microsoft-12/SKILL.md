...
description: "Valider que les notebooks de cours et les exemples de code s'exécutent avec une configuration Microsoft Foundry / Azure OpenAI en direct. Le dépôt propose un script d'exécution dans scripts/validate-notebooks.ps1 qui exécute chaque notebook Python en mode headless et affiche une matrice PASS/FAIL."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/fr/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/fr/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/fr/.agents/skills/testing-course-samples/SKILL.md`
