...
source_url: https://github.com/trailofbits/skills/blob/HEAD/plugins/semgrep-rule-variant-creator/skills/semgrep-rule-variant-creator/SKILL.md
---
...
**Source:** [`trailofbits/skills`](https://github.com/trailofbits/skills) → `plugins/semgrep-rule-variant-creator/skills/semgrep-rule-variant-creator/SKILL.md`
