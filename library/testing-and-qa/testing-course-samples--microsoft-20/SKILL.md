...
description: "Patikrinkite, ar pamokų užrašų knygelės ir kodo pavyzdžiai veikia su veikia Microsoft Foundry / Azure OpenAI konfigūracija. Repozitorijoje pateiktas vykdytojas scripts/validate-notebooks.ps1, kuris vykdo kiekvieną Python užrašų knygelę be sąveikos ir išspausdina PASIŽIŪRĖTI/NEPASIŽIŪRĖTI matricą."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/lt/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/lt/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/lt/.agents/skills/testing-course-samples/SKILL.md`
