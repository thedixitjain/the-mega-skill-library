...
source_path: "plugins/ruflo-browser/skills/browser-screenshot-diff/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-browser/skills/browser-screenshot-diff/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-browser/skills/browser-screenshot-diff/SKILL.md`
