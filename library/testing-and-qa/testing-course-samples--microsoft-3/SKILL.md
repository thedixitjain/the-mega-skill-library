...
description: "নিশ্চিত করুন যে পাঠের নোটবুক এবং কোড নমুনাগুলি লাইভ Microsoft Foundry / Azure OpenAI সেটআপের বিরুদ্ধে চালানো হয়। রিপোতে একটি রানার রয়েছে scripts/validate-notebooks.ps1 যা প্রতিটি পাইথন নোটবুককে হেডলেসলি চালিয়ে পাস/ফেইল ম্যাট্রিক্স প্রিন্ট করে।"
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/bn/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/bn/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/bn/.agents/skills/testing-course-samples/SKILL.md`
