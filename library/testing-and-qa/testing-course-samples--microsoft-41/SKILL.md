...
description: "Xác thực rằng các sổ tay bài học và mẫu mã chạy trên một thiết lập Microsoft Foundry / Azure OpenAI trực tiếp. Kho lưu trữ cung cấp một trình chạy tại scripts/validate-notebooks.ps1 để thực thi mỗi sổ tay Python một cách không đầu cuối và in ra bảng PASS/FAIL."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/vi/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/vi/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/vi/.agents/skills/testing-course-samples/SKILL.md`
