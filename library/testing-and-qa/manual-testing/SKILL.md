...
source_path: "skills/en/testing-types/manual-testing/SKILL.md"
source_url: https://github.com/naodeng/awesome-qa-skills/blob/HEAD/skills/en/testing-types/manual-testing/SKILL.md
---
...
**Source:** [`naodeng/awesome-qa-skills`](https://github.com/naodeng/awesome-qa-skills) → `skills/en/testing-types/manual-testing/SKILL.md`
