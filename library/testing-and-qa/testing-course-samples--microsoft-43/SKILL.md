...
description: "驗證課程筆記本和程式碼範例是否可在即時的 Microsoft Foundry / Azure OpenAI 環境中執行。此倉庫包含一個執行器，位置為 scripts/validate-notebooks.ps1， 該執行器會以無頭模式執行所有 Python 筆記本並列印通過/失敗矩陣。"
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/zh-HK/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/zh-HK/.agents/skills/testing-course-samples/SKILL.md
---
# 測試課程範例
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/zh-HK/.agents/skills/testing-course-samples/SKILL.md`
