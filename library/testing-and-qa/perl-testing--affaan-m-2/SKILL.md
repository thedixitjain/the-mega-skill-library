...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/perl-testing/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/perl-testing/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/perl-testing/SKILL.md`
