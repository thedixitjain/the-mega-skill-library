...
description: "Sprawdź, czy notatniki lekcji i przykładowy kod działają na żywo w konfiguracji Microsoft Foundry / Azure OpenAI. Repozytorium zawiera runner w scripts/validate-notebooks.ps1, który uruchamia każdy notatnik Pythona bez interfejsu i wyświetla macierz PASS/FAIL."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/pl/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/pl/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/pl/.agents/skills/testing-course-samples/SKILL.md`
