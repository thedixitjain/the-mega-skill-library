...
description: "تصدیق کریں کہ اسباق کے نوٹ بکس اور کوڈ کے نمونے ایک فعال Microsoft Foundry / Azure OpenAI سیٹ اپ کے خلاف چل رہے ہیں۔ ریپو میں ایک رنر شامل ہے scripts/validate-notebooks.ps1 جو ہر پائتھن نوٹ بک کو ہیڈلیس طریقے سے چلاتا ہے اور PASS/FAIL ماتریس پرنٹ کرتا ہے۔"
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ur/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ur/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ur/.agents/skills/testing-course-samples/SKILL.md`
