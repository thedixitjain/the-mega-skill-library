...
description: "Проверьте, что тетради уроков и примеры кода запускаются с использованием живой среды Microsoft Foundry / Azure OpenAI. В репозитории есть скрипт запуска по пути scripts/validate-notebooks.ps1, который выполняет каждую Python тетрадь без интерфейса и выводит матрицу PASS/FAIL."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ru/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ru/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ru/.agents/skills/testing-course-samples/SKILL.md`
