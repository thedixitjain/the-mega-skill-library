...
source_path: "skills/csharp-testing/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/csharp-testing/SKILL.md
---
# C# Testing Patterns
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/csharp-testing/SKILL.md`
