...
description: "Kontrolli, kas õppetunni märkmikud ja koodinäited töötavad otse Microsoft Foundry / Azure OpenAI keskkonnas. Repos on kaasas käivitaja fail scripts/validate-notebooks.ps1, mis käivitab kõik Python märkmikud ilma kasutajaliideseta ja kuvab Läbi/Ebaõnnestus tabeli."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/et/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/et/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/et/.agents/skills/testing-course-samples/SKILL.md`
