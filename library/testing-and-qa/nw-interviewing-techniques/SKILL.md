...
source_path: "nWave/skills/nw-interviewing-techniques/SKILL.md"
source_url: https://github.com/nWave-ai/nWave/blob/HEAD/nWave/skills/nw-interviewing-techniques/SKILL.md
---
...
**Source:** [`nWave-ai/nWave`](https://github.com/nWave-ai/nWave) → `nWave/skills/nw-interviewing-techniques/SKILL.md`

**Also appears in:** `nWave-ai/nWave/plugins/nw/skills/nw-interviewing-techniques/SKILL.md`
