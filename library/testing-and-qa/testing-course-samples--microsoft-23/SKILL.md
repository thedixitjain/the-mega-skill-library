...
description: "सिकियौं कि पाठ नोटबुकहरू र कोड नमूनाहरू लाइभ Microsoft Foundry / Azure OpenAI सेटअपमा चल्छन् कि छैनन्। रेपोले एक रनर पठाउँछ scripts/validate-notebooks.ps1 जुन हरेक Python नोटबुकलाई हेडलेस रूपमा चलाउँछ र PASS/FAIL म्याट्रिक्स प्रिन्ट गर्छ।"
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ne/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ne/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ne/.agents/skills/testing-course-samples/SKILL.md`
