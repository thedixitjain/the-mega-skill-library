...
description: "Valide que los cuadernos de lecciones y los ejemplos de código se ejecuten contra una configuración en vivo de Microsoft Foundry / Azure OpenAI. El repositorio incluye un ejecutor en scripts/validate-notebooks.ps1 que ejecuta cada cuaderno de Python sin cabeza y muestra una matriz de APROBADO/FALLADO."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/es/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/es/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/es/.agents/skills/testing-course-samples/SKILL.md`
