...
source_path: "qa-only/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/qa-only/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `qa-only/SKILL.md`
