...
description: "'Set up a fast local development loop for Attio integrations with hot reload, mock server, and integration tests. Trigger: \"attio dev setup\", \"attio local development\", \"attio dev environment\", \"develop with attio\", \"attio project setup\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(pnpm:*), Bash(npx:*), Grep"
category: testing-and-qa
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/attio-pack/skills/attio-local-dev-loop/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/attio-pack/skills/attio-local-dev-loop/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/attio-pack/skills/attio-local-dev-loop/SKILL.md`
