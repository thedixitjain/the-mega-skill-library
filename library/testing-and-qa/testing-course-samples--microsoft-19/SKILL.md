...
description: "レッスンノートブックとコードサンプルがライブの Microsoft Foundry / Azure OpenAI 環境で動作することを検証します。リポジトリには scripts/validate-notebooks.ps1 に すべてのPythonノートブックをヘッドレスで実行し、PASS/FAILマトリックスを表示するランナーが含まれています。"
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ja/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ja/.agents/skills/testing-course-samples/SKILL.md
---
# コースサンプルのテスト
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ja/.agents/skills/testing-course-samples/SKILL.md`
