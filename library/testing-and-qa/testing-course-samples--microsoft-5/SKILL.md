...
description: "Bekræft, at lektions-notebooks og kodeeksempler kører mod en aktiv Microsoft Foundry / Azure OpenAI opsætning. Repoet indeholder en runner i scripts/validate-notebooks.ps1, som eksekverer hver Python-notebook headlessly og udskriver en PASS/FAIL matrix."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/da/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/da/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/da/.agents/skills/testing-course-samples/SKILL.md`
