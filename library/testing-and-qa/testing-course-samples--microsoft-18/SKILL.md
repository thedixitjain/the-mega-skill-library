...
description: "Verifica che i notebook delle lezioni e i campioni di codice funzionino con una configurazione live Microsoft Foundry / Azure OpenAI. Il repo include un runner in scripts/validate-notebooks.ps1 che esegue ogni notebook Python senza interfaccia grafica e stampa una matrice PASS/FAIL."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/it/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/it/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/it/.agents/skills/testing-course-samples/SKILL.md`
