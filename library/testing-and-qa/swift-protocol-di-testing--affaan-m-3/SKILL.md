...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/swift-protocol-di-testing/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/swift-protocol-di-testing/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/swift-protocol-di-testing/SKILL.md`
