...
description: "Validera att lektionernas anteckningsböcker och kodexempel körs mot en live Microsoft Foundry / Azure OpenAI-miljö. Repositoriet levererar en körbar fil på scripts/validate-notebooks.ps1 som exekverar varje Python-anteckningsbok headlessly och skriver ut en PASS/FAIL-matris."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/sv/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/sv/.agents/skills/testing-course-samples/SKILL.md
---
# Testa kursproverna
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/sv/.agents/skills/testing-course-samples/SKILL.md`
