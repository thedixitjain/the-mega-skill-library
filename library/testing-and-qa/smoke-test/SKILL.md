---
name: smoke-test
description: "| Post-restart smoke tests + auto-fix for gbrain and OpenClaw environments. Tests critical services, auto-fixes known issues, extensible via user-defined test scripts in ~/.gbrain/smoke-tests.d/*.sh."
allowed-tools: "exec read"
category: testing-and-qa
source_repo: garrytan/gbrain
source_path: "skills/smoke-test/SKILL.md"
source_url: https://github.com/garrytan/gbrain/blob/HEAD/skills/smoke-test/SKILL.md
---
...
**Source:** [`garrytan/gbrain`](https://github.com/garrytan/gbrain) → `skills/smoke-test/SKILL.md`
