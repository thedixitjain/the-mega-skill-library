...
source_path: "skills/.curated/stackblitz-local-dev-loop/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/stackblitz-local-dev-loop/SKILL.md
---
