...
description: "သင်ခန်းစာစာအုပ်များနှင့် ကုဒ်နမူနာများကို Microsoft Foundry / Azure OpenAI စနစ်တစ်ခုနှင့် ထိတွေ့ပြေးဆွဲထားသည်ကို အတည်ပြုပါ။ Repo သည် scripts/validate-notebooks.ps1 တွင် runner တစ်ခု ပါရှိပြီး Python notebook အားလုံးကို headless ဖြင့် ပြေးဆွဲကာ PASS/FAIL ဇယားကို ပုံထုတ်ပေးသည်။"
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/my/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/my/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/my/.agents/skills/testing-course-samples/SKILL.md`
