...
description: "验证课程笔记本和代码示例是否能在实际运行的 Microsoft Foundry / Azure OpenAI 环境下执行。仓库提供了一个运行脚本位于 scripts/validate-notebooks.ps1， 它可以无头执行每个 Python 笔记本，并打印通过/失败矩阵。"
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/zh-CN/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/zh-CN/.agents/skills/testing-course-samples/SKILL.md
---
# 测试课程样例
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/zh-CN/.agents/skills/testing-course-samples/SKILL.md`
