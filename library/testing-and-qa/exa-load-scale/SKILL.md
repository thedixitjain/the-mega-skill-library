---
name: exa-load-scale
description: "'Implement Exa load testing, capacity planning, and scaling strategies. Use when running performance tests, planning capacity for Exa integrations, or designing high-throughput search architectures. Trigger with phrases like \"exa load test\", \"exa scale\", \"exa capacity\", \"exa k6\", \"exa benchmark\", \"exa throughput\". '"
allowed-tools: "Read, Write, Edit, Bash(k6:*), Bash(node:*)"
category: testing-and-qa
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/exa-pack/skills/exa-load-scale/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/exa-pack/skills/exa-load-scale/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/exa-pack/skills/exa-load-scale/SKILL.md`
