...
source_path: "skills/iso-standards-readiness/SKILL.md"
source_url: https://github.com/K-Dense-AI/scientific-agent-skills/blob/HEAD/skills/iso-standards-readiness/SKILL.md
---
...
**Source:** [`K-Dense-AI/scientific-agent-skills`](https://github.com/K-Dense-AI/scientific-agent-skills) → `skills/iso-standards-readiness/SKILL.md`
