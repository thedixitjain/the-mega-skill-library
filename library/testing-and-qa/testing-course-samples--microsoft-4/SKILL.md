...
description: "Ověřte, že si sešitové lekce a ukázky kódu spustí proti živému Microsoft Foundry / Azure OpenAI prostředí. Repozitář obsahuje spouštěč v scripts/validate-notebooks.ps1, který spustí všechny Python notebooky bez hlavičky a vytiskne matici PASS/FAIL."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/cs/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/cs/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/cs/.agents/skills/testing-course-samples/SKILL.md`
