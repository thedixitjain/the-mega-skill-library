...
description: "Controleer of de lesnotebooks en codevoorbeelden werken met een live Microsoft Foundry / Azure OpenAI setup. De repo bevat een runner bij scripts/validate-notebooks.ps1 die elke Python-notebook hoofdzakelijk headless uitvoert en een PASS/FAIL matrix afdrukt."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/nl/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/nl/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/nl/.agents/skills/testing-course-samples/SKILL.md`
