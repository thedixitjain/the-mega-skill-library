...
description: "Provjerite rade li bilježnice lekcija i primjeri koda uz aktivno Microsoft Foundry / Azure OpenAI okruženje. Repo dolazi s izvršiteljem na scripts/validate-notebooks.ps1 koji izvodi svaku Python bilježnicu bez sučelja i ispisuje PASS/FAIL matricu."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/hr/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/hr/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/hr/.agents/skills/testing-course-samples/SKILL.md`
