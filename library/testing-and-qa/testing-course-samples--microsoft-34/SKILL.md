...
description: "Потврдите да ли бележнице са лекцијама и узорци кода раде са активном Microsoft Foundry / Azure OpenAI конфигурацијом. Репозиторијум обухвата извршни фајл у scripts/validate-notebooks.ps1 који извршава сваку Python бележницу у позадини и приказује PASS/FAIL матрицу."
category: testing-and-qa
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/sr/.agents/skills/testing-course-samples/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/sr/.agents/skills/testing-course-samples/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/sr/.agents/skills/testing-course-samples/SKILL.md`
