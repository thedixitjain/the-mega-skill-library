...
source_path: "plugins/saas-packs/lucidchart-pack/skills/lucidchart-hello-world/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/lucidchart-pack/skills/lucidchart-hello-world/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/lucidchart-pack/skills/lucidchart-hello-world/SKILL.md`
