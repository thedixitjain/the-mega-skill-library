...
source_path: "docs/zh-CN/skills/cpp-testing/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/cpp-testing/SKILL.md
---
# C++ 测试（代理技能）
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/cpp-testing/SKILL.md`
