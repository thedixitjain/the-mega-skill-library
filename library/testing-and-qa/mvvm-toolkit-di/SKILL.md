...
source_path: "skills/mvvm-toolkit-di/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/mvvm-toolkit-di/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/mvvm-toolkit-di/SKILL.md`
