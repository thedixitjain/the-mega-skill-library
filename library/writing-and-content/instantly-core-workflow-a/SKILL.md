...
description: "'Build and launch an Instantly.ai cold email campaign end-to-end. Use when creating campaigns, adding leads, configuring sequences, and launching outreach via the Instantly API v2. Trigger with phrases like \"instantly campaign\", \"launch instantly campaign\", \"create instantly outreach\", \"instantly cold email\", \"instantly send campaign\". '"
allowed-tools: "Read, Write, Edit, Bash(npm:*), Bash(curl:*), Grep"
category: writing-and-content
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/instantly-pack/skills/instantly-core-workflow-a/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/instantly-pack/skills/instantly-core-workflow-a/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/instantly-pack/skills/instantly-core-workflow-a/SKILL.md`
