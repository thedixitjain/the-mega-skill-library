---
name: panews-creator
description: "> Create and manage articles on the PANews platform. All operations require a valid user session. Triggers: write and publish new articles, view / edit / delete drafts, revise and resubmit rejected articles, upload images, search tags, apply for a column, polish or review article content."
category: writing-and-content
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/panewslab/skills/skills/panews-creator/SKILL.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/panewslab/skills/skills/panews-creator/SKILL.md
---
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/panewslab/skills/skills/panews-creator/SKILL.md`
