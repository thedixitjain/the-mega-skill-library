---
name: panews
description: "> Entry point for reading PANews cryptocurrency / blockchain news, market narratives, and Polymarket smart money leaderboards. Triggers: today's headlines, breaking news, trending rankings, article search, reading specific articles, browsing columns / series / community topics, industry events & conferences, event calendar, platform hot searches and editorial picks, latest smart money boards, board highlights, and board comparisons."
category: writing-and-content
source_repo: hashgraph-online/awesome-codex-plugins
source_path: "plugins/panewslab/skills/skills/panews/SKILL.md"
source_url: https://github.com/hashgraph-online/awesome-codex-plugins/blob/HEAD/plugins/panewslab/skills/skills/panews/SKILL.md
---
...
**Source:** [`hashgraph-online/awesome-codex-plugins`](https://github.com/hashgraph-online/awesome-codex-plugins) → `plugins/panewslab/skills/skills/panews/SKILL.md`
