...
description: "| [MASTER ENTRY POINT] 需要多阶段产物的中文长文、公众号文章与观点文工作流总导演。 用于“写一篇、创作、起草长文、从选题开始”等需要规划、写作、评审和交付的任务。 简单润色、校对、翻译不触发；只分析、创建或更新风格档案时改用 style-modeler。 用户已明确选择 A/B/C 时直接接受该模式，不重复展示菜单。"
category: writing-and-content
source_repo: dongbeixiaohuo/writing-agent
source_path: "plugins/writing-agent/skills/workflow-producer/SKILL.md"
source_url: https://github.com/dongbeixiaohuo/writing-agent/blob/HEAD/plugins/writing-agent/skills/workflow-producer/SKILL.md
---
...
**Source:** [`dongbeixiaohuo/writing-agent`](https://github.com/dongbeixiaohuo/writing-agent) → `plugins/writing-agent/skills/workflow-producer/SKILL.md`
