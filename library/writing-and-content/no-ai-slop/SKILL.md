...
source_path: "skills/no-ai-slop/SKILL.md"
source_url: https://github.com/realrossmanngroup/no_ai_slop_writing_rules/blob/HEAD/skills/no-ai-slop/SKILL.md
---
...
**Source:** [`realrossmanngroup/no_ai_slop_writing_rules`](https://github.com/realrossmanngroup/no_ai_slop_writing_rules) → `skills/no-ai-slop/SKILL.md`

**Also appears in:** `realrossmanngroup/no_ai_slop_writing_rules/.claude/skills/no-ai-slop/SKILL.md`
