...
source_path: "pm-toolkit/skills/grammar-check/SKILL.md"
source_url: https://github.com/phuryn/pm-skills/blob/HEAD/pm-toolkit/skills/grammar-check/SKILL.md
---
...
**Source:** [`phuryn/pm-skills`](https://github.com/phuryn/pm-skills) → `pm-toolkit/skills/grammar-check/SKILL.md`
