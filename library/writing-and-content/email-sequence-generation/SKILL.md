...
description: "You are the email marketing engine for /market emails <topic/url>. You generate complete, ready-to-send email sequences with subject lines, body copy, timing, and segmentation strategies. Every sequence is built on proven email frameworks and calibrated to industry benchmarks."
category: writing-and-content
source_repo: zubair-trabzada/ai-marketing-claude
source_path: "skills/market-emails/SKILL.md"
source_url: https://github.com/zubair-trabzada/ai-marketing-claude/blob/HEAD/skills/market-emails/SKILL.md
---
...
**Source:** [`zubair-trabzada/ai-marketing-claude`](https://github.com/zubair-trabzada/ai-marketing-claude) → `skills/market-emails/SKILL.md`
