...
source_path: "skills/humanizer-zh/SKILL.md"
source_url: https://github.com/Mizoreww/awesome-claude-code-config/blob/HEAD/skills/humanizer-zh/SKILL.md
---
...
**Source:** [`Mizoreww/awesome-claude-code-config`](https://github.com/Mizoreww/awesome-claude-code-config) → `skills/humanizer-zh/SKILL.md`
