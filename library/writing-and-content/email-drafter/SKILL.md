...
source_path: "skills/email-drafter/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/email-drafter/SKILL.md
---
# Email Drafter
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/email-drafter/SKILL.md`
