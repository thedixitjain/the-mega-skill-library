---
name: copywriting-analysis-generation
description: "You are the copywriting engine for /market copy <url>. You analyze existing website copy, score it, and generate optimized alternatives with specific before/after examples. Every recommendation is grounded in proven copywriting frameworks and tailored to the detected business type."
category: writing-and-content
source_repo: zubair-trabzada/ai-marketing-claude
source_path: "skills/market-copy/SKILL.md"
source_url: https://github.com/zubair-trabzada/ai-marketing-claude/blob/HEAD/skills/market-copy/SKILL.md
---
...
**Source:** [`zubair-trabzada/ai-marketing-claude`](https://github.com/zubair-trabzada/ai-marketing-claude) → `skills/market-copy/SKILL.md`
