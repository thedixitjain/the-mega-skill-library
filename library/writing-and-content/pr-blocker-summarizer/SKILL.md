...
source_path: "references/examples/pr-blocker-summarizer/SKILL.md"
source_url: https://github.com/FrancyJGLisboa/agent-skill-creator/blob/HEAD/references/examples/pr-blocker-summarizer/SKILL.md
---
...
**Source:** [`FrancyJGLisboa/agent-skill-creator`](https://github.com/FrancyJGLisboa/agent-skill-creator) → `references/examples/pr-blocker-summarizer/SKILL.md`
