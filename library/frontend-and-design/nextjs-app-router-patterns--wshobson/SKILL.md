...
source_path: "plugins/frontend-mobile-development/skills/nextjs-app-router-patterns/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/frontend-mobile-development/skills/nextjs-app-router-patterns/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/frontend-mobile-development/skills/nextjs-app-router-patterns/SKILL.md`
