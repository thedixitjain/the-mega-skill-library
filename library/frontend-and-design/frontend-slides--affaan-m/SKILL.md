...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/frontend-slides/SKILL.md
---
# Frontend Slides
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/frontend-slides/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/frontend-slides/SKILL.md`, `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/frontend-slides/SKILL.md`
