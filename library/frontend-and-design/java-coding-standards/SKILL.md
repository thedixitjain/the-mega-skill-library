...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/java-coding-standards/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/java-coding-standards/SKILL.md`

**Also appears in:** `affaan-m/ECC/.kiro/skills/java-coding-standards/SKILL.md`
