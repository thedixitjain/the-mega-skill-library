...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/ui-demo/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/ui-demo/SKILL.md`

**Also appears in:** `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/ui-demo/SKILL.md`
