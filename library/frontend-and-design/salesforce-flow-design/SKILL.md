...
source_path: "skills/salesforce-flow-design/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/salesforce-flow-design/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/salesforce-flow-design/SKILL.md`
