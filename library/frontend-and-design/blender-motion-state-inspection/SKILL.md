...
source_path: "skills/blender-motion-state-inspection/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/blender-motion-state-inspection/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/blender-motion-state-inspection/SKILL.md`
