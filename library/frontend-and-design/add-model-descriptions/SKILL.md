...
source_path: "ruflo/src/ruvocal/.claude/skills/add-model-descriptions/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/ruflo/src/ruvocal/.claude/skills/add-model-descriptions/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `ruflo/src/ruvocal/.claude/skills/add-model-descriptions/SKILL.md`
