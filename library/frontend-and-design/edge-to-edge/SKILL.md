...
source_path: "system/edge-to-edge/SKILL.md"
source_url: https://github.com/android/skills/blob/HEAD/system/edge-to-edge/SKILL.md
---
...
**Source:** [`android/skills`](https://github.com/android/skills) → `system/edge-to-edge/SKILL.md`
