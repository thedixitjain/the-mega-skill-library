...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/nextjs-turbopack/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/nextjs-turbopack/SKILL.md`

**Also appears in:** `affaan-m/ECC/.kiro/skills/nextjs-turbopack/SKILL.md`
