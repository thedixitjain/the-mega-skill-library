...
source_path: "skills/vision-analysis/SKILL.md"
source_url: https://github.com/MiniMax-AI/skills/blob/HEAD/skills/vision-analysis/SKILL.md
---
...
**Source:** [`MiniMax-AI/skills`](https://github.com/MiniMax-AI/skills) → `skills/vision-analysis/SKILL.md`
