...
source_path: "skills/plan-canvas/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/plan-canvas/SKILL.md
---
# Plan Canvas
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/plan-canvas/SKILL.md`

**Also appears in:** `affaan-m/ECC/.agents/skills/plan-canvas/SKILL.md`
