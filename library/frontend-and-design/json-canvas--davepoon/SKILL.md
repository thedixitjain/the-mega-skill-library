...
source_path: "plugins/all-skills/skills/json-canvas/SKILL.md"
source_url: https://github.com/davepoon/buildwithclaude/blob/HEAD/plugins/all-skills/skills/json-canvas/SKILL.md
---
...
**Source:** [`davepoon/buildwithclaude`](https://github.com/davepoon/buildwithclaude) → `plugins/all-skills/skills/json-canvas/SKILL.md`

**Also appears in:** `davepoon/buildwithclaude/plugins/obsidian-skills/skills/json-canvas/SKILL.md`
