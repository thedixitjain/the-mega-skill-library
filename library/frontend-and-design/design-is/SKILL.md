...
source_path: "plugin/skills/design-is/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/design-is/SKILL.md
---
# Design Is
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/design-is/SKILL.md`
