...
source_path: "jetpack-compose/adaptive/SKILL.md"
source_url: https://github.com/android/skills/blob/HEAD/jetpack-compose/adaptive/SKILL.md
---
...
**Source:** [`android/skills`](https://github.com/android/skills) → `jetpack-compose/adaptive/SKILL.md`
