...
source_path: "docs/ja-JP/skills/accessibility/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/accessibility/SKILL.md
---
# アクセシビリティ（WCAG 2.2）
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/accessibility/SKILL.md`
