...
source_path: ".claude/skills/design-system/SKILL.md"
source_url: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/HEAD/.claude/skills/design-system/SKILL.md
---
...
**Source:** [`nextlevelbuilder/ui-ux-pro-max-skill`](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) → `.claude/skills/design-system/SKILL.md`

**Also appears in:** `nextlevelbuilder/ui-ux-pro-max-skill/cli/assets/skills/design-system/SKILL.md`
