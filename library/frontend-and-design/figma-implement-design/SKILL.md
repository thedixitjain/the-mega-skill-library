...
source_url: https://github.com/openai/skills/blob/HEAD/skills/.curated/figma-implement-design/SKILL.md
---
...
**Source:** [`openai/skills`](https://github.com/openai/skills) → `skills/.curated/figma-implement-design/SKILL.md`
