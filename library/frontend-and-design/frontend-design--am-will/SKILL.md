...
source_url: https://github.com/am-will/codex-skills/blob/HEAD/skills/frontend-design/SKILL.md
---
...
**Source:** [`am-will/codex-skills`](https://github.com/am-will/codex-skills) → `skills/frontend-design/SKILL.md`
