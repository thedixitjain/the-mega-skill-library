...
source_path: "skills/arize-link/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/arize-link/SKILL.md
---
# Arize Link
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/arize-link/SKILL.md`
