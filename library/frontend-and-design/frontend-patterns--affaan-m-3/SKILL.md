...
source_path: "docs/ja-JP/skills/frontend-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/frontend-patterns/SKILL.md
---
# フロントエンド開発パターン
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/frontend-patterns/SKILL.md`
