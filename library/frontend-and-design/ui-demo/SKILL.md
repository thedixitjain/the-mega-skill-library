...
source_path: "docs/ja-JP/skills/ui-demo/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/ui-demo/SKILL.md
---
# UI デモ動画レコーダー
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/ui-demo/SKILL.md`
