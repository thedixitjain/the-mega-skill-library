...
source_path: ".claude/skills/ui-ux-pro-max/SKILL.md"
source_url: https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/HEAD/.claude/skills/ui-ux-pro-max/SKILL.md
---
...
**Source:** [`nextlevelbuilder/ui-ux-pro-max-skill`](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) → `.claude/skills/ui-ux-pro-max/SKILL.md`
