...
source_path: "nWave/skills/nw-domain-driven-design/SKILL.md"
source_url: https://github.com/nWave-ai/nWave/blob/HEAD/nWave/skills/nw-domain-driven-design/SKILL.md
---
...
**Source:** [`nWave-ai/nWave`](https://github.com/nWave-ai/nWave) → `nWave/skills/nw-domain-driven-design/SKILL.md`

**Also appears in:** `nWave-ai/nWave/plugins/nw/skills/nw-domain-driven-design/SKILL.md`
