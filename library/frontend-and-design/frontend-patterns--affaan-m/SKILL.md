...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/frontend-patterns/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/frontend-patterns/SKILL.md`

**Also appears in:** `affaan-m/ECC/.kiro/skills/frontend-patterns/SKILL.md`
