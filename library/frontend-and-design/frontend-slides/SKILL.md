...
source_path: ".agents/skills/frontend-slides/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/.agents/skills/frontend-slides/SKILL.md
---
# Frontend Slides
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `.agents/skills/frontend-slides/SKILL.md`

**Also appears in:** `affaan-m/ECC/.cursor/skills/frontend-slides/SKILL.md`
