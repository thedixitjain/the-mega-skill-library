...
source_path: "skills/web-design-reviewer/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/web-design-reviewer/SKILL.md
---
# Web Design Reviewer
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/web-design-reviewer/SKILL.md`
