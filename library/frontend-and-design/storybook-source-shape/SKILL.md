...
**Source:** [`asgeirtj/system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks) → `Anthropic/Claude Code/bundled-skills/design-sync/storybook/SKILL.md`
