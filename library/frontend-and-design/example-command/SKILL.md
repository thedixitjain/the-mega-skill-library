...
source_path: "plugins/example-plugin/skills/example-command/SKILL.md"
source_url: https://github.com/anthropics/claude-plugins-official/blob/HEAD/plugins/example-plugin/skills/example-command/SKILL.md
---
...
**Source:** [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) → `plugins/example-plugin/skills/example-command/SKILL.md`
