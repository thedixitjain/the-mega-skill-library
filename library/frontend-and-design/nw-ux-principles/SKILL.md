...
source_path: "nWave/skills/nw-ux-principles/SKILL.md"
source_url: https://github.com/nWave-ai/nWave/blob/HEAD/nWave/skills/nw-ux-principles/SKILL.md
---
...
**Source:** [`nWave-ai/nWave`](https://github.com/nWave-ai/nWave) → `nWave/skills/nw-ux-principles/SKILL.md`

**Also appears in:** `nWave-ai/nWave/plugins/nw/skills/nw-ux-principles/SKILL.md`
