...
source_path: "docs/es/skills/nextjs-turbopack/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/es/skills/nextjs-turbopack/SKILL.md
---
# Next.js y Turbopack
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/es/skills/nextjs-turbopack/SKILL.md`
