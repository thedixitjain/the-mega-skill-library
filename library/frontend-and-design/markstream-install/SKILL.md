...
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/markstream-install/SKILL.md
---
# Markstream Install
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/markstream-install/SKILL.md`
