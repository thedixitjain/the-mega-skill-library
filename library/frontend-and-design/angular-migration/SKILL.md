...
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/framework-migration/skills/angular-migration/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/framework-migration/skills/angular-migration/SKILL.md`
