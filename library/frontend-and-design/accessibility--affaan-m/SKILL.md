...
source_path: "docs/zh-CN/skills/accessibility/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/accessibility/SKILL.md
---
# 无障碍性（WCAG 2.2）
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/accessibility/SKILL.md`
