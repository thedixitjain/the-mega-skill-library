...
source_path: "docs/zh-CN/skills/ui-demo/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/ui-demo/SKILL.md
---
# UI 演示视频录制器
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/ui-demo/SKILL.md`
