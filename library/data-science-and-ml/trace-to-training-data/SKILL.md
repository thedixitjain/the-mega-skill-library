...
source_path: "plugins/llm-finetuning/skills/trace-to-training-data/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/llm-finetuning/skills/trace-to-training-data/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/llm-finetuning/skills/trace-to-training-data/SKILL.md`
