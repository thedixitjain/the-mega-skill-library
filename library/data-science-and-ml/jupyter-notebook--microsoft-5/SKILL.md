...
description: "Bruges når brugeren beder om at oprette, opsætte eller redigere Jupyter-notebooks (`.ipynb`) til eksperimenter, udforskninger eller vejledninger; foretræk de medfølgende skabeloner og kør hjælpeskriptet `new_notebook.py` for at generere en ren start-notebook."
category: data-science-and-ml
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/da/.agents/skills/jupyter-notebook/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/da/.agents/skills/jupyter-notebook/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/da/.agents/skills/jupyter-notebook/SKILL.md`
