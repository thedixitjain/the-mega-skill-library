...
source_path: "plugins/ruflo-ruvllm/skills/llm-config/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-ruvllm/skills/llm-config/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-ruvllm/skills/llm-config/SKILL.md`
