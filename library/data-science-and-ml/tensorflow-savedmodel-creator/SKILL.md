...
description: "'Create tensorflow savedmodel creator operations. Auto-activating skill for ML Deployment. Triggers on: tensorflow savedmodel creator, tensorflow savedmodel creator Part of the ML Deployment skill category. Use when working with tensorflow savedmodel creator functionality. Trigger with phrases like \"tensorflow savedmodel creator\", \"tensorflow creator\", \"tensorflow\". '"
allowed-tools: "Read, Write, Edit, Bash(cmd:*), Grep"
category: data-science-and-ml
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/08-ml-deployment/tensorflow-savedmodel-creator/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/08-ml-deployment/tensorflow-savedmodel-creator/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/08-ml-deployment/tensorflow-savedmodel-creator/SKILL.md`
