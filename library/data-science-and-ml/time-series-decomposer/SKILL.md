...
description: "'Manage time series decomposer operations. Auto-activating skill for Data Analytics. Triggers on: time series decomposer, time series decomposer Part of the Data Analytics skill category. Use when working with time series decomposer functionality. Trigger with phrases like \"time series decomposer\", \"time decomposer\", \"time\". '"
allowed-tools: "Read, Write, Edit, Bash(cmd:*), Grep"
category: data-science-and-ml
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/12-data-analytics/time-series-decomposer/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/12-data-analytics/time-series-decomposer/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/12-data-analytics/time-series-decomposer/SKILL.md`
