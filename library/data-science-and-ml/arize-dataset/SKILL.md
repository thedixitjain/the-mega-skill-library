...
source_path: "skills/arize-dataset/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/arize-dataset/SKILL.md
---
# Arize Dataset Skill
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/arize-dataset/SKILL.md`
