...
description: "Tumia wakati mtumiaji anapoomba kuunda, kupanga muundo (scaffold), au kuhariri daftari za Jupyter (`.ipynb`) kwa majaribio, uchunguzi, au mafunzo; pendelea violezo vinavyokuja pamoja na uendeshe skripti ya msaidizi `new_notebook.py` ili kuunda daftari safi la kuanzia."
category: data-science-and-ml
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/sw/.agents/skills/jupyter-notebook/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/sw/.agents/skills/jupyter-notebook/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/sw/.agents/skills/jupyter-notebook/SKILL.md`
