...
description: "'Tune CodeRabbit review configuration: learnings, code guidelines, and noise reduction. Use when fine-tuning review quality, training CodeRabbit with team preferences, adding code guidelines, or reducing false positives. Trigger with phrases like \"coderabbit tune reviews\", \"coderabbit learnings\", \"coderabbit guidelines\", \"reduce coderabbit noise\", \"coderabbit false positives\". '"
allowed-tools: "Read, Write, Edit, Bash(gh:*), Grep"
category: data-science-and-ml
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/coderabbit-core-workflow-b/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/coderabbit-core-workflow-b/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/coderabbit-core-workflow-b/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/coderabbit-pack/skills/coderabbit-core-workflow-b/SKILL.md`
