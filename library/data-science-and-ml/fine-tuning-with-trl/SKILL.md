...
source_path: "optional-skills/mlops/training/trl-fine-tuning/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/optional-skills/mlops/training/trl-fine-tuning/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `optional-skills/mlops/training/trl-fine-tuning/SKILL.md`
