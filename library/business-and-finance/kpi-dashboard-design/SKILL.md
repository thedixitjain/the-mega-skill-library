...
source_path: "plugins/business-analytics/skills/kpi-dashboard-design/SKILL.md"
source_url: https://github.com/wshobson/agents/blob/HEAD/plugins/business-analytics/skills/kpi-dashboard-design/SKILL.md
---
...
**Source:** [`wshobson/agents`](https://github.com/wshobson/agents) → `plugins/business-analytics/skills/kpi-dashboard-design/SKILL.md`
