...
source_url: https://github.com/SnailSploit/Claude-Red/blob/HEAD/Skills/web/offensive-business-logic/SKILL.md
---
...
**Source:** [`SnailSploit/Claude-Red`](https://github.com/SnailSploit/Claude-Red) → `Skills/web/offensive-business-logic/SKILL.md`
