...
source_path: "references/examples/weekly-crm-report/SKILL.md"
source_url: https://github.com/FrancyJGLisboa/agent-skill-creator/blob/HEAD/references/examples/weekly-crm-report/SKILL.md
---
...
**Source:** [`FrancyJGLisboa/agent-skill-creator`](https://github.com/FrancyJGLisboa/agent-skill-creator) → `references/examples/weekly-crm-report/SKILL.md`
