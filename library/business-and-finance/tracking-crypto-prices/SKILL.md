...
source_path: "skills/.curated/tracking-crypto-prices/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/tracking-crypto-prices/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/tracking-crypto-prices/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/crypto/market-price-tracker/skills/tracking-crypto-prices/SKILL.md`
