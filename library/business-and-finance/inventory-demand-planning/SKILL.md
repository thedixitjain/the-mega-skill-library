...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/inventory-demand-planning/SKILL.md
---
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/inventory-demand-planning/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/inventory-demand-planning/SKILL.md`, `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/inventory-demand-planning/SKILL.md`
