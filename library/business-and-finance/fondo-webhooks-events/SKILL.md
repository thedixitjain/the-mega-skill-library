...
source_path: "plugins/saas-packs/fondo-pack/skills/fondo-webhooks-events/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/fondo-pack/skills/fondo-webhooks-events/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/fondo-pack/skills/fondo-webhooks-events/SKILL.md`
