...
source_url: https://github.com/affaan-m/ECC/blob/HEAD/skills/energy-procurement/SKILL.md
---
# Energy Procurement
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `skills/energy-procurement/SKILL.md`

**Also appears in:** `affaan-m/ECC/docs/ja-JP/skills/energy-procurement/SKILL.md`, `hashgraph-online/awesome-codex-plugins/plugins/Colin4k1024/tsp/skills/energy-procurement/SKILL.md`
