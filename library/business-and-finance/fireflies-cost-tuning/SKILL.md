...
description: "'Optimize Fireflies.ai subscription costs through seat auditing, selective recording, and plan sizing. Use when analyzing Fireflies.ai billing, reducing per-seat costs, or implementing usage monitoring and right-sizing. Trigger with phrases like \"fireflies cost\", \"fireflies billing\", \"reduce fireflies costs\", \"fireflies pricing\", \"fireflies expensive\", \"fireflies budget\". '"
allowed-tools: "Read, Bash(curl:*), Grep"
category: business-and-finance
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/fireflies-pack/skills/fireflies-cost-tuning/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/fireflies-pack/skills/fireflies-cost-tuning/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/fireflies-pack/skills/fireflies-cost-tuning/SKILL.md`
