...
source_path: "c-level-advisor/skills/decision-logger/SKILL.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/c-level-advisor/skills/decision-logger/SKILL.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `c-level-advisor/skills/decision-logger/SKILL.md`
