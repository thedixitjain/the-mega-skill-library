...
description: "'Optimize Attio API usage costs -- reduce request volume, select the right plan, monitor usage, and implement budget alerts. Trigger: \"attio cost\", \"attio billing\", \"reduce attio costs\", \"attio pricing\", \"attio expensive\", \"attio budget\", \"attio usage\". '"
allowed-tools: "Read, Grep"
category: business-and-finance
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "plugins/saas-packs/attio-pack/skills/attio-cost-tuning/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/plugins/saas-packs/attio-pack/skills/attio-cost-tuning/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `plugins/saas-packs/attio-pack/skills/attio-cost-tuning/SKILL.md`
