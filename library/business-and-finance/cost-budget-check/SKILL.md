...
source_path: "plugins/ruflo-cost-tracker/skills/cost-budget-check/SKILL.md"
source_url: https://github.com/ruvnet/ruflo/blob/HEAD/plugins/ruflo-cost-tracker/skills/cost-budget-check/SKILL.md
---
...
**Source:** [`ruvnet/ruflo`](https://github.com/ruvnet/ruflo) → `plugins/ruflo-cost-tracker/skills/cost-budget-check/SKILL.md`
