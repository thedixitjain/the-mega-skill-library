...
source_path: "docs/ja-JP/skills/token-budget-advisor/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/token-budget-advisor/SKILL.md
---
# トークンバジェットアドバイザー（TBA）
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/token-budget-advisor/SKILL.md`
