...
source_path: "c-level-advisor/skills/board-meeting/SKILL.md"
source_url: https://github.com/alirezarezvani/claude-skills/blob/HEAD/c-level-advisor/skills/board-meeting/SKILL.md
---
...
**Source:** [`alirezarezvani/claude-skills`](https://github.com/alirezarezvani/claude-skills) → `c-level-advisor/skills/board-meeting/SKILL.md`
