...
source_path: "references/examples/stock-analyzer/SKILL.md"
source_url: https://github.com/FrancyJGLisboa/agent-skill-creator/blob/HEAD/references/examples/stock-analyzer/SKILL.md
---
...
**Source:** [`FrancyJGLisboa/agent-skill-creator`](https://github.com/FrancyJGLisboa/agent-skill-creator) → `references/examples/stock-analyzer/SKILL.md`
