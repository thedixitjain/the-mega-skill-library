---
name: microsoft-docs
description: "Hivatalos Microsoft-dokumentáció lekérdezése a fogalmak, oktatóanyagok és kódpéldák megtalálásához az Azure, .NET, Agent Framework, Aspire, VS Code, GitHub és még sok más területén. Alapértelmezettként a Microsoft Learn MCP-t használja, a learn.microsoft.com-on kívül található tartalmak esetén pedig a Context7-et és az Aspire MCP-t."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/hu/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/hu/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/hu/.agents/skills/microsoft-docs/SKILL.md`
