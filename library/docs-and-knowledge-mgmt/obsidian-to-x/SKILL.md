...
source_path: "skills/obsidian-to-x/SKILL.md"
source_url: https://github.com/libukai/awesome-agent-skills/blob/HEAD/skills/obsidian-to-x/SKILL.md
---
...
**Source:** [`libukai/awesome-agent-skills`](https://github.com/libukai/awesome-agent-skills) → `skills/obsidian-to-x/SKILL.md`
