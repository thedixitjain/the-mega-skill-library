...
source_path: "skills/update-llms/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/update-llms/SKILL.md
---
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/update-llms/SKILL.md`
