---
name: microsoft-docs
description: "Αναζητήστε επίσημη τεκμηρίωση της Microsoft για να βρείτε έννοιες, σεμινάρια και παραδείγματα κώδικα σε Azure, .NET, Agent Framework, Aspire, VS Code, GitHub και άλλα. Χρησιμοποιεί το Microsoft Learn MCP ως προεπιλογή, με το Context7 και το Aspire MCP για περιεχόμενο που βρίσκεται εκτός learn.microsoft.com."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/el/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/el/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/el/.agents/skills/microsoft-docs/SKILL.md`
