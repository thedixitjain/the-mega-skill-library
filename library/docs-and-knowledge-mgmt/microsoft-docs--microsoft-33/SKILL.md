---
name: microsoft-docs
description: "Na to search official Microsoft documentation make you fit find concepts, tutorials, and code examples for Azure, .NET, Agent Framework, Aspire, VS Code, GitHub, and plenty more. E dey use Microsoft Learn MCP as the default, together with Context7 and Aspire MCP for content wey dey outside learn.microsoft.com."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/pcm/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/pcm/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/pcm/.agents/skills/microsoft-docs/SKILL.md`
