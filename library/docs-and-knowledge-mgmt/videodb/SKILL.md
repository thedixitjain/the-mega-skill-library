...
source_path: "docs/ja-JP/skills/videodb/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/videodb/SKILL.md
---
# VideoDBスキル
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/videodb/SKILL.md`
