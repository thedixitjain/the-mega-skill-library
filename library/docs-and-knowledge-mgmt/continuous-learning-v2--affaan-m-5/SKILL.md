...
source_path: "docs/zh-TW/skills/continuous-learning-v2/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-TW/skills/continuous-learning-v2/SKILL.md
---
# 持續學習 v2 - 基於本能的架構
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-TW/skills/continuous-learning-v2/SKILL.md`
