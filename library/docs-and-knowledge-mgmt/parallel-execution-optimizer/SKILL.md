...
source_path: "docs/zh-CN/skills/parallel-execution-optimizer/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/parallel-execution-optimizer/SKILL.md
---
# 并行执行优化器
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/parallel-execution-optimizer/SKILL.md`
