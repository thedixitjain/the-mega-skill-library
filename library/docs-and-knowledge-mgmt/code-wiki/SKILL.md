...
source_path: "optional-skills/software-development/code-wiki/SKILL.md"
source_url: https://github.com/NousResearch/hermes-agent/blob/HEAD/optional-skills/software-development/code-wiki/SKILL.md
---
...
**Source:** [`NousResearch/hermes-agent`](https://github.com/NousResearch/hermes-agent) → `optional-skills/software-development/code-wiki/SKILL.md`
