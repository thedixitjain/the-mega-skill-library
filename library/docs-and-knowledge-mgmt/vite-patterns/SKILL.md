...
source_path: "docs/ja-JP/skills/vite-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/vite-patterns/SKILL.md
---
# Vite パターン
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/vite-patterns/SKILL.md`
