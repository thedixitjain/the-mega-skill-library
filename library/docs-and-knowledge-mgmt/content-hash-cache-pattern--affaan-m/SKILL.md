...
source_path: "docs/zh-CN/skills/content-hash-cache-pattern/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/content-hash-cache-pattern/SKILL.md
---
# 内容哈希文件缓存模式
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/content-hash-cache-pattern/SKILL.md`
