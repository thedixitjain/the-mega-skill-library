---
name: microsoft-docs
description: "Truy vấn tài liệu chính thức của Microsoft để tìm các khái niệm, hướng dẫn và ví dụ mã trên Azure, .NET, Agent Framework, Aspire, VS Code, GitHub và nhiều hơn nữa. Sử dụng Microsoft Learn MCP làm mặc định, với Context7 và Aspire MCP cho nội dung nằm ngoài learn.microsoft.com."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/vi/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/vi/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/vi/.agents/skills/microsoft-docs/SKILL.md`
