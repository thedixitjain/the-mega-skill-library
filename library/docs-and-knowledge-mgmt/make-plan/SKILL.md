...
source_path: "plugin/skills/make-plan/SKILL.md"
source_url: https://github.com/thedotmack/claude-mem/blob/HEAD/plugin/skills/make-plan/SKILL.md
---
# Make Plan
...
**Source:** [`thedotmack/claude-mem`](https://github.com/thedotmack/claude-mem) → `plugin/skills/make-plan/SKILL.md`
