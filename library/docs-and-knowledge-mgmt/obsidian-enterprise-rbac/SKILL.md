...
description: "'Implement team vault access patterns and role-based controls. Use when managing shared vaults, implementing access controls, or building team collaboration features for Obsidian. Trigger with phrases like \"obsidian team\", \"obsidian access control\", \"obsidian enterprise\", \"shared vault permissions\". '"
allowed-tools: "Read, Write, Edit"
category: docs-and-knowledge-mgmt
source_repo: jeremylongshore/claude-code-plugins-plus-skills
source_path: "skills/.curated/obsidian-enterprise-rbac/SKILL.md"
source_url: https://github.com/jeremylongshore/claude-code-plugins-plus-skills/blob/HEAD/skills/.curated/obsidian-enterprise-rbac/SKILL.md
---
...
**Source:** [`jeremylongshore/claude-code-plugins-plus-skills`](https://github.com/jeremylongshore/claude-code-plugins-plus-skills) → `skills/.curated/obsidian-enterprise-rbac/SKILL.md`

**Also appears in:** `jeremylongshore/claude-code-plugins-plus-skills/plugins/saas-packs/obsidian-pack/skills/obsidian-enterprise-rbac/SKILL.md`
