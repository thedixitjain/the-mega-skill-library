---
name: microsoft-docs
description: "Azure, .NET, Agent Framework, Aspire, VS Code, GitHub နှင့် အခြားများအပါအဝင် တရားဝင် Microsoft အထောက်အထားများကို မေးမြန်း၍ အယူအဆများ၊ သင်ခန်းစာများနှင့် ကုဒ် ဥပမာများကို ရှာဖွေပါ။ Microsoft Learn MCP ကို ပုံမှန် အဖြစ် အသုံးပြု၍ learn.microsoft.com ပြင်ပတွင် တည်ရှိသော အကြောင်းအရာများအတွက် Context7 နှင့် Aspire MCP ကို အသုံးပြုသည်။"
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/my/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/my/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/my/.agents/skills/microsoft-docs/SKILL.md`
