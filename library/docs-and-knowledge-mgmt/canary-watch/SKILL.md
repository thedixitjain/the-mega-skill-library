...
source_path: "docs/ja-JP/skills/canary-watch/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/canary-watch/SKILL.md
---
# カナリアウォッチ — デプロイ後の監視
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/canary-watch/SKILL.md`
