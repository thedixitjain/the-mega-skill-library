---
name: microsoft-docs
description: "查询官方 Microsoft 文档，以查找有关 Azure、.NET、Agent Framework、Aspire、VS Code、GitHub 等的概念、教程和代码示例。默认使用 Microsoft Learn MCP，对于存在于 learn.microsoft.com 之外的内容，则使用 Context7 和 Aspire MCP。"
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/zh-CN/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/zh-CN/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft 文档
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/zh-CN/.agents/skills/microsoft-docs/SKILL.md`
