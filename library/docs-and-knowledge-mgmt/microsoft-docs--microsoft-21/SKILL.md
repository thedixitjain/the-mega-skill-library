---
name: microsoft-docs
description: "ស្វែងរកឯកសារផ្លូវការរបស់ Microsoft ដើម្បីរកមើល គំនិត មេរៀន និងឧទាហរណ៍កូដ នៅលើ Azure, .NET, Agent Framework, Aspire, VS Code, GitHub និងផ្សេងទៀត។ ប្រើ Microsoft Learn MCP ជាលំនាំដើម ហើយប្រើ Context7 និង Aspire MCP សម្រាប់មាតិកាដែលស្ថិតនៅខាងក្រៅ learn.microsoft.com។"
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/km/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/km/.agents/skills/microsoft-docs/SKILL.md
---
# ឯកសារ Microsoft
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/km/.agents/skills/microsoft-docs/SKILL.md`
