---
name: microsoft-docs
description: "ಅಧಿಕೃತ Microsoft ಡಾಕ್ಯುಮೆಂಟೇಶನ್ ಅನ್ನು ಪ್ರಶ್ನೆ ಮಾಡಿ Azure, .NET, Agent Framework, Aspire, VS Code, GitHub ಮತ್ತು ಇತರೆ ಸಂಬಂಧಿತ ವಿಷಯಗಳ ಮೇಲೆ ತತ್ವಗಳು, ಟ್ಯುಟೋರಿಯಲ್ಗಳು ಮತ್ತು ಕೋಡ್ ಉದಾಹರಣೆಗಳನ್ನು ಕಂಡುಹಿಡಿಯಿರಿ. ಡೀಫಾಲ್ಟ್‌ವಾಗಿ Microsoft Learn MCP ಅನ್ನು ಬಳಸುತ್ತದೆ; learn.microsoft.com ಹೊರಗಿನ ವಿಷಯಗಳಿಗೆ Context7 ಮತ್ತು Aspire MCP ಅನ್ನು ಬಳಸಲಾಗುತ್ತದೆ."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/kn/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/kn/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/kn/.agents/skills/microsoft-docs/SKILL.md`
