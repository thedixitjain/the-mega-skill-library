---
name: microsoft-docs
description: "Microsoft ਤਕਨਾਲੋਜੀ ਇਕੋਸਿਸਟਮ ਲਈ ਰਿਸਰਚ ਸਕਿਲ। ਇਹ learn.microsoft.com ਅਤੇ ਉਸ ਤੋਂ ਬਾਹਰ ਰਹਿਣ ਵਾਲੀ ਦਸਤਾਵੇਜ਼ੀਕਰਨ ਨੂੰ ਕਵਰ ਕਰਦਾ ਹੈ (VS Code, GitHub, Aspire, Agent Framework ਰੇਪੋਜ਼)."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/pa/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/pa/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/pa/.agents/skills/microsoft-docs/SKILL.md`
