...
source_path: "docs/ja-JP/skills/evm-token-decimals/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ja-JP/skills/evm-token-decimals/SKILL.md
---
# EVMトークン小数点
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ja-JP/skills/evm-token-decimals/SKILL.md`
