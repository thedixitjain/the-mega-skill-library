---
name: markdown-url
description: "| Route any website you need to visit through markdown.new by prefixing the URL. **WHEN TO USE:** You would normally open a website link to read content (docs, blog posts, changelogs, GitHub issues, etc.) You need a cleaner, Markdown-friendly view for copying notes or summarizing"
category: docs-and-knowledge-mgmt
source_repo: am-will/codex-skills
source_path: "skills/markdown-url/SKILL.md"
source_url: https://github.com/am-will/codex-skills/blob/HEAD/skills/markdown-url/SKILL.md
---
...
**Source:** [`am-will/codex-skills`](https://github.com/am-will/codex-skills) → `skills/markdown-url/SKILL.md`
