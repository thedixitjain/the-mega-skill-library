...
source_url: https://github.com/garrytan/gstack/blob/HEAD/document-release/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `document-release/SKILL.md`
