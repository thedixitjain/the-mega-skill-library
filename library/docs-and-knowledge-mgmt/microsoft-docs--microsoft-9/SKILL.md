---
name: microsoft-docs
description: "Consulta la documentación oficial de Microsoft para encontrar conceptos, tutoriales y ejemplos de código en Azure, .NET, Agent Framework, Aspire, VS Code, GitHub y más. Utiliza Microsoft Learn MCP como predeterminado, con Context7 y Aspire MCP para contenido que se encuentra fuera de learn.microsoft.com."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/es/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/es/.agents/skills/microsoft-docs/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/es/.agents/skills/microsoft-docs/SKILL.md`
