...
source_path: "docs/zh-CN/skills/architecture-decision-records/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/architecture-decision-records/SKILL.md
---
# 架构决策记录
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/architecture-decision-records/SKILL.md`
