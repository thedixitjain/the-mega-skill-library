...
source_path: "docs/zh-CN/skills/canary-watch/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/canary-watch/SKILL.md
---
# Canary Watch — 部署后监控
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/canary-watch/SKILL.md`
