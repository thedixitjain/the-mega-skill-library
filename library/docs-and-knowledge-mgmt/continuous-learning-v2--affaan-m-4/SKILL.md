...
source_path: "docs/zh-CN/skills/continuous-learning-v2/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/continuous-learning-v2/SKILL.md
---
# 持续学习 v2.1 - 基于本能
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/continuous-learning-v2/SKILL.md`
