---
name: microsoft-docs
description: "공식 Microsoft 문서를 조회하여 Azure, .NET, Agent Framework, Aspire, VS Code, GitHub 등 다양한 분야의 개념, 튜토리얼 및 코드 예제를 찾습니다. 기본적으로 Microsoft Learn MCP를 사용하며, learn.microsoft.com 외부에 있는 콘텐츠에 대해서는 Context7 및 Aspire MCP를 사용합니다."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ko/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ko/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ko/.agents/skills/microsoft-docs/SKILL.md`
