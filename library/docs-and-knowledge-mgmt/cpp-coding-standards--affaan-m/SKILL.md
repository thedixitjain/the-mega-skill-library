...
source_path: "docs/zh-CN/skills/cpp-coding-standards/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/cpp-coding-standards/SKILL.md
---
# C++ 编码标准（C++ 核心准则）
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/cpp-coding-standards/SKILL.md`
