...
source_path: "plugins/start/skills/document/SKILL.md"
source_url: https://github.com/rsmdt/the-startup/blob/HEAD/plugins/start/skills/document/SKILL.md
---
...
**Source:** [`rsmdt/the-startup`](https://github.com/rsmdt/the-startup) → `plugins/start/skills/document/SKILL.md`
