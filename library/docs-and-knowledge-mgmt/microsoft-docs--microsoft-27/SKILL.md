---
name: microsoft-docs
description: "Kueri dokumentasi rasmi Microsoft untuk mencari konsep, tutorial, dan contoh kod merentas Azure, .NET, Agent Framework, Aspire, VS Code, GitHub, dan banyak lagi. Menggunakan Microsoft Learn MCP sebagai lalai, dengan Context7 dan Aspire MCP untuk kandungan yang berada di luar learn.microsoft.com."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ms/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ms/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ms/.agents/skills/microsoft-docs/SKILL.md`
