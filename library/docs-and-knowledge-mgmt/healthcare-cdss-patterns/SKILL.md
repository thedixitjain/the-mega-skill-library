...
source_path: "docs/zh-CN/skills/healthcare-cdss-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/healthcare-cdss-patterns/SKILL.md
---
# 医疗CDSS开发模式
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/healthcare-cdss-patterns/SKILL.md`
