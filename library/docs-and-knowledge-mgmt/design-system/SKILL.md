...
source_path: "docs/zh-CN/skills/design-system/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/design-system/SKILL.md
---
# 设计系统 — 生成与审查视觉系统
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/design-system/SKILL.md`
