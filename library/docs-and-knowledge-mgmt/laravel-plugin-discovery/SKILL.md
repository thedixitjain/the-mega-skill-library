...
source_path: "docs/zh-CN/skills/laravel-plugin-discovery/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/laravel-plugin-discovery/SKILL.md
---
# Laravel 插件发现
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/laravel-plugin-discovery/SKILL.md`
