---
name: microsoft-docs
description: "Interroga la documentazione ufficiale Microsoft per trovare concetti, tutorial ed esempi di codice relativi ad Azure, .NET, Agent Framework, Aspire, VS Code, GitHub e altro. Usa Microsoft Learn MCP come predefinito, con Context7 e Aspire MCP per i contenuti che si trovano al di fuori di learn.microsoft.com."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/it/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/it/.agents/skills/microsoft-docs/SKILL.md
---
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/it/.agents/skills/microsoft-docs/SKILL.md`
