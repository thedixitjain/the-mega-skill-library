...
source_path: "docs/zh-CN/skills/dotnet-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/dotnet-patterns/SKILL.md
---
# .NET 开发模式
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/dotnet-patterns/SKILL.md`
