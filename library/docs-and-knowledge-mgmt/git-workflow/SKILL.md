...
source_path: "docs/zh-CN/skills/git-workflow/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/git-workflow/SKILL.md
---
# Git 工作流模式
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/git-workflow/SKILL.md`
