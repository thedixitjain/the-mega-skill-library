...
source_path: "docs/ko-KR/skills/verification-loop/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/ko-KR/skills/verification-loop/SKILL.md
---
# 검증 루프 스킬
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/ko-KR/skills/verification-loop/SKILL.md`
