---
name: microsoft-docs
description: "Запрашивайте официальную документацию Microsoft, чтобы находить концепции, учебники и примеры кода по Azure, .NET, Agent Framework, Aspire, VS Code, GitHub и другим. Используется Microsoft Learn MCP по умолчанию, а для контента, размещённого вне learn.microsoft.com, — Context7 и Aspire MCP."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ru/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ru/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ru/.agents/skills/microsoft-docs/SKILL.md`
