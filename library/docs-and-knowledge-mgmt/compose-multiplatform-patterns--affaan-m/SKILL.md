...
source_path: "docs/zh-CN/skills/compose-multiplatform-patterns/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/compose-multiplatform-patterns/SKILL.md
---
# Compose 多平台模式
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/compose-multiplatform-patterns/SKILL.md`
