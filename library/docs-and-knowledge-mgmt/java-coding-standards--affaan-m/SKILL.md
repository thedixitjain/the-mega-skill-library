...
source_path: "docs/zh-CN/skills/java-coding-standards/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/java-coding-standards/SKILL.md
---
# Java 编码规范
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/java-coding-standards/SKILL.md`
