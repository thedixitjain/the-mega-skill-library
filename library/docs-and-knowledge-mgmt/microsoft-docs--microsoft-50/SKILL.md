---
name: microsoft-docs
description: "سرکاری Microsoft دستاویزات میں استفسار کریں تاکہ Azure، .NET، Agent Framework، Aspire، VS Code، GitHub، اور دیگر میں موجود تصورات، ٹیوٹوریلز، اور کوڈ کی مثالیں تلاش کی جا سکیں۔ ڈیفالٹ کے طور پر Microsoft Learn MCP استعمال کیا جاتا ہے، جبکہ learn.microsoft.com کے باہر موجود مواد کے لیے Context7 اور Aspire MCP استعمال ہوتے ہیں۔"
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ur/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ur/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ur/.agents/skills/microsoft-docs/SKILL.md`
