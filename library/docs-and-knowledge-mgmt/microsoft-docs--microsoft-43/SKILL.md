---
name: microsoft-docs
description: "Fanya uchunguzi kwenye nyaraka rasmi za Microsoft ili upate dhana, mafunzo, na mifano ya msimbo katika Azure, .NET, Agent Framework, Aspire, VS Code, GitHub, na zaidi. Inatumia Microsoft Learn MCP kama chaguo-msingi, na Context7 na Aspire MCP kwa maudhui yanayopatikana nje ya learn.microsoft.com."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/sw/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/sw/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/sw/.agents/skills/microsoft-docs/SKILL.md`
