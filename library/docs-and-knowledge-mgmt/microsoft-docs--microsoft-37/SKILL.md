---
name: microsoft-docs
description: "Interoghează documentația oficială Microsoft pentru a găsi concepte, tutoriale și exemple de cod pentru Azure, .NET, Agent Framework, Aspire, VS Code, GitHub și altele. Folosește Microsoft Learn MCP ca implicit, iar pentru conținutul care se află în afara learn.microsoft.com utilizează Context7 și Aspire MCP."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/ro/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/ro/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/ro/.agents/skills/microsoft-docs/SKILL.md`
