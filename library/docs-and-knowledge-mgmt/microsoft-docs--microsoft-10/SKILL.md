---
name: microsoft-docs
description: "Küsib ametlikku Microsofti dokumentatsiooni, et leida mõisteid, juhendeid ja koodinäiteid Azure'i, .NET-i, Agent Frameworki, Aspire'i, VS Code'i, GitHubi ja muu kohta. Vaikimisi kasutatakse Microsoft Learn MCP-i; Context7 ja Aspire MCP-i kasutatakse sisu jaoks, mis asub väljaspool learn.microsoft.com-i."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/et/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/et/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/et/.agents/skills/microsoft-docs/SKILL.md`
