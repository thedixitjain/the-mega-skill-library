...
source_path: "docs/zh-CN/skills/evm-token-decimals/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/evm-token-decimals/SKILL.md
---
# EVM 代币精度
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/evm-token-decimals/SKILL.md`
