...
source_path: "docs/zh-CN/skills/blueprint/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-CN/skills/blueprint/SKILL.md
---
# Blueprint — 施工计划生成器
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-CN/skills/blueprint/SKILL.md`
