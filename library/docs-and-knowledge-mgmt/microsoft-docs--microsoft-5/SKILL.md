---
name: microsoft-docs
description: "Søg i den officielle Microsoft-dokumentation for at finde koncepter, vejledninger og kodeeksempler på tværs af Azure, .NET, Agent Framework, Aspire, VS Code, GitHub og mere. Bruger Microsoft Learn MCP som standard, samt Context7 og Aspire MCP til indhold, der findes uden for learn.microsoft.com."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/da/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/da/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/da/.agents/skills/microsoft-docs/SKILL.md`
