---
name: microsoft-docs
description: "Prehľadávajte oficiálnu dokumentáciu Microsoftu, aby ste našli koncepty, návody a ukážky kódu naprieč Azure, .NET, Agent Framework, Aspire, VS Code, GitHub a ďalšími. Používa Microsoft Learn MCP ako predvolený zdroj, spolu s Context7 a Aspire MCP pre obsah, ktorý sa nachádza mimo learn.microsoft.com."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/sk/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/sk/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/sk/.agents/skills/microsoft-docs/SKILL.md`
