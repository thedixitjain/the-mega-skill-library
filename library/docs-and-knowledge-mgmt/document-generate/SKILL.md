...
source_path: "document-generate/SKILL.md"
source_url: https://github.com/garrytan/gstack/blob/HEAD/document-generate/SKILL.md
---
...
**Source:** [`garrytan/gstack`](https://github.com/garrytan/gstack) → `document-generate/SKILL.md`
