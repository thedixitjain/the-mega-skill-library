...
source_path: "docs/zh-TW/skills/coding-standards/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-TW/skills/coding-standards/SKILL.md
---
# 程式碼標準與最佳實務
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-TW/skills/coding-standards/SKILL.md`
