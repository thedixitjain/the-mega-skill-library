...
source_path: "docs/zh-TW/skills/project-guidelines-example/SKILL.md"
source_url: https://github.com/affaan-m/ECC/blob/HEAD/docs/zh-TW/skills/project-guidelines-example/SKILL.md
---
# 專案指南技能（範例）
...
**Source:** [`affaan-m/ECC`](https://github.com/affaan-m/ECC) → `docs/zh-TW/skills/project-guidelines-example/SKILL.md`
