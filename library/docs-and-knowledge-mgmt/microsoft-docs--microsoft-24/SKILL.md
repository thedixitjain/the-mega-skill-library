---
name: microsoft-docs
description: "Ieškokite oficialioje Microsoft dokumentacijoje sąvokų, pamokų ir kodo pavyzdžių apie Azure, .NET, Agent Framework, Aspire, VS Code, GitHub ir dar daugiau. Naudoja Microsoft Learn MCP kaip numatytąjį, o Context7 ir Aspire MCP — turiniui, esantį už learn.microsoft.com ribų."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/lt/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/lt/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/lt/.agents/skills/microsoft-docs/SKILL.md`
