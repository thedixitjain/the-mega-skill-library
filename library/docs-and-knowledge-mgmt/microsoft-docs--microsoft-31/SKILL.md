---
name: microsoft-docs
description: "Søk i offisiell Microsoft-dokumentasjon for å finne konsepter, veiledninger og kodeeksempler på tvers av Azure, .NET, Agent Framework, Aspire, VS Code, GitHub og mer. Bruker Microsoft Learn MCP som standard, med Context7 og Aspire MCP for innhold som ligger utenfor learn.microsoft.com."
category: docs-and-knowledge-mgmt
source_repo: microsoft/ai-agents-for-beginners
source_path: "translations/no/.agents/skills/microsoft-docs/SKILL.md"
source_url: https://github.com/microsoft/ai-agents-for-beginners/blob/HEAD/translations/no/.agents/skills/microsoft-docs/SKILL.md
---
# Microsoft Docs
...
**Source:** [`microsoft/ai-agents-for-beginners`](https://github.com/microsoft/ai-agents-for-beginners) → `translations/no/.agents/skills/microsoft-docs/SKILL.md`
