---
name: read-github
description: "| Read and search GitHub repository documentation via gitmcp.io MCP service. **WHEN TO USE:** User provides a GitHub URL User mentions a specific repo in owner/repo format User asks \"what does this repo do?\", \"read the docs for X repo\", or similar User wants to search code or docs within a repo"
category: docs-and-knowledge-mgmt
source_repo: am-will/codex-skills
source_path: "skills/read-github/SKILL.md"
source_url: https://github.com/am-will/codex-skills/blob/HEAD/skills/read-github/SKILL.md
---
...
**Source:** [`am-will/codex-skills`](https://github.com/am-will/codex-skills) → `skills/read-github/SKILL.md`
