...
source_path: "skills/create-tldr-page/SKILL.md"
source_url: https://github.com/github/awesome-copilot/blob/HEAD/skills/create-tldr-page/SKILL.md
---
# Create TLDR Page
...
**Source:** [`github/awesome-copilot`](https://github.com/github/awesome-copilot) → `skills/create-tldr-page/SKILL.md`
